...
| `pnpm turbo build --filter=<package-name>...`           | Build the named package and its full dependency tree. Run from anywhere in the repo.                           |
| `npx turbo build`                                       | Alternative when you are already inside the package directory (`sdk/service-name/package-name`).               |
|                                                         |                                                                                                                 |
...
```bash
pnpm run test:node -- --testNamePattern "simple"
```
