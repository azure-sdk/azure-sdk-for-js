...
import { IntegrationAccountMaps } from "../operationsInterfaces/index.js";
...
export class IntegrationAccountMapsImpl implements IntegrationAccountMaps {
  ...
  createOrUpdate(
    ...
    return this.client.sendOperationRequest(
      { resourceGroupName, integrationAccountName, mapName, resource, options },
  ...
  listContentCallbackUrl(
    ...
    return this.client.sendOperationRequest(
      { resourceGroupName, integrationAccountName, mapName, body, options },
