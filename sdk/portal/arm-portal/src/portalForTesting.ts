...
import { PortalForTestingOptionalParams } from "./models";

export class PortalForTesting extends coreClient.ServiceClient {
  $host: string;
  apiVersion: string;
  subscriptionId?: string;

  /**
   * Initializes a new instance of the PortalForTesting class.
  ...
  constructor(
    ...
    subscriptionId: string,
    options?: PortalForTestingOptionalParams,
  );
  constructor(
    credentials: coreAuth.TokenCredential,
    options?: PortalForTestingOptionalParams,
  ...
  constructor(
    credentials: coreAuth.TokenCredential,
    subscriptionIdOrOptions?: PortalForTestingOptionalParams | string,
    options?: PortalForTestingOptionalParams,
  ) {
    ...
    const defaults: PortalForTestingOptionalParams = {
