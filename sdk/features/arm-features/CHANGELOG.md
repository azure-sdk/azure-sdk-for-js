...
### Breaking Changes
  ...
  - Removed operation group SubscriptionFeatureRegistrations
  - Deleted Class FeatureClient
  - Interface ErrorResponse no longer has parameter error
  - Removed Enum KnownSubscriptionFeatureRegistrationApprovalType
  - Removed Enum KnownSubscriptionFeatureRegistrationState
