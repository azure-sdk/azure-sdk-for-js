...
export const AzureDevOpsPermissionProfile: coreClient.CompositeMapper = {
  type: {
    ...
    uberParent: "AzureDevOpsPermissionProfile",
    polymorphicDiscriminator: {
      serializedName: "kind",
      clientName: "kind"
    },
...
export const LogonType: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "LogonType",
    uberParent: "LogonType",
    polymorphicDiscriminator: {
      serializedName: "kind",
      clientName: "kind"
    },
...
export const CreatorOnly: coreClient.CompositeMapper = {
  serializedName: "CreatorOnly",
  type: {
    name: "Composite",
    className: "CreatorOnly",
    uberParent: "AzureDevOpsPermissionProfile",
    polymorphicDiscriminator:
      AzureDevOpsPermissionProfile.type.polymorphicDiscriminator,
    modelProperties: {
      ...AzureDevOpsPermissionProfile.type.modelProperties
    }
  }
};

export const InheritPermissions: coreClient.CompositeMapper = {
  serializedName: "Inherit",
  type: {
    name: "Composite",
    className: "InheritPermissions",
    uberParent: "AzureDevOpsPermissionProfile",
    polymorphicDiscriminator:
      AzureDevOpsPermissionProfile.type.polymorphicDiscriminator,
    modelProperties: {
...
export const SpecificAccounts: coreClient.CompositeMapper = {
  serializedName: "SpecificAccounts",
  type: {
    name: "Composite",
    className: "SpecificAccounts",
    uberParent: "AzureDevOpsPermissionProfile",
    polymorphicDiscriminator:
      AzureDevOpsPermissionProfile.type.polymorphicDiscriminator,
    modelProperties: {
...
export const Interactive: coreClient.CompositeMapper = {
  serializedName: "Interactive",
  type: {
    name: "Composite",
    className: "Interactive",
    uberParent: "LogonType",
    polymorphicDiscriminator: LogonType.type.polymorphicDiscriminator,
    modelProperties: {
      ...LogonType.type.modelProperties
    }
  }
};
...
export let discriminators = {
  ...
  "AzureDevOpsPermissionProfile.CreatorOnly": CreatorOnly,
  "AzureDevOpsPermissionProfile.Inherit": InheritPermissions,
  "AzureDevOpsPermissionProfile.SpecificAccounts": SpecificAccounts,
