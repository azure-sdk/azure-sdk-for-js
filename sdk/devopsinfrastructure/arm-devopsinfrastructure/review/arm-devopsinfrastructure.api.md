...
export interface AzureDevOpsOrganizationProfile extends OrganizationProfile {
    ...
    permissionProfile?: AzureDevOpsPermissionProfileUnion;
}
...
// @public (undocumented)
export type AzureDevOpsPermissionProfileUnion = AzureDevOpsPermissionProfile | CreatorOnly | InheritPermissions | SpecificAccounts;

// @public
export type CreatedByType = string;

// @public
export interface CreatorOnly extends AzureDevOpsPermissionProfile {
    kind: "CreatorOnly";
}
...
// @public
export interface InheritPermissions extends AzureDevOpsPermissionProfile {
    kind: "Inherit";
}

// @public
export interface Interactive extends LogonType {
    kind: "Interactive";
}
...
export interface LogonType {
    kind: "Interactive" | "Service";
}

// @public (undocumented)
export type LogonTypeUnion = LogonType | Interactive | Service;
...
// @public
export interface Service extends LogonType {
    kind: "Service";
}

// @public
export interface SpecificAccounts extends AzureDevOpsPermissionProfile {
    groups?: string[];
