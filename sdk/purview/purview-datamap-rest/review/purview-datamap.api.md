...
// @public
function createClient(endpointParam: string, credentials: TokenCredential, options?: ClientOptions): PurviewDataMapClient;
...
export interface DiscoveryNavigate {
    post(options?: DiscoveryNavigateParameters): StreamableMethod<DiscoveryNavigate200Response | DiscoveryNavigateDefaultResponse>;
}

// @public
export interface DiscoveryNavigate200Response extends HttpResponse {
    // (undocumented)
    body: NavigationResultOutput;
    // (undocumented)
    status: "200";
}

// @public (undocumented)
export interface DiscoveryNavigateBodyParam {
    // (undocumented)
    body?: NavigationRequest;
}

// @public (undocumented)
export interface DiscoveryNavigateDefaultHeaders {
    "x-ms-error-code"?: string;
}

// @public (undocumented)
export interface DiscoveryNavigateDefaultResponse extends HttpResponse {
    // (undocumented)
    body: ErrorResponse;
    // (undocumented)
    headers: RawHttpHeaders & DiscoveryNavigateDefaultHeaders;
    // (undocumented)
    status: string;
}

// @public (undocumented)
export type DiscoveryNavigateParameters = DiscoveryNavigateQueryParam & DiscoveryNavigateBodyParam & RequestParameters;

// @public (undocumented)
export interface DiscoveryNavigateQueryParam {
    // (undocumented)
    queryParameters: DiscoveryNavigateQueryParamProperties;
}

// @public (undocumented)
export interface DiscoveryNavigateQueryParamProperties {
    "api-version": string;
}
...
// @public (undocumented)
export function isUnexpected(response: DiscoveryNavigate200Response | DiscoveryNavigateDefaultResponse): response is DiscoveryNavigateDefaultResponse;
...
// @public
export interface NavigationElementOutput {
    count?: number;
    isEntity?: boolean;
    isLeafNode?: boolean;
...
// @public
export type NavigationMode = string | "assetType" | "azureResourceHierarchy";
...
// @public
export interface NavigationResultOutput {
    continuationToken?: string;
    items?: Array<NavigationElementOutput>;
}
