...
export interface EntityGetSampleBusinessMetadataTemplateDefaultHeaders {
...
export interface EntityGetSampleBusinessMetadataTemplateDefaultResponse
  ...
  headers: RawHttpHeaders &
    EntityGetSampleBusinessMetadataTemplateDefaultHeaders;
}
...
export interface RelationshipDeleteOperationDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponseOutput;
}
