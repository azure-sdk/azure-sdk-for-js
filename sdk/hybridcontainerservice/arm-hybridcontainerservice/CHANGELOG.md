...
## 1.0.0-beta.4 (2023-12-01)
    
**Features**

  - Added Interface KubernetesVersionProfilePropertiesAutoGenerated
  - Added Interface VmSkuProfilePropertiesAutoGenerated
  - Added Type Alias OsSku
  - Added Enum KnownOsSku

**Breaking Changes**

  - Type of parameter values of interface KubernetesVersionProfileProperties is changed from KubernetesVersionProperties[] to KubernetesVersionProfilePropertiesAutoGenerated[]
  - Type of parameter osSku of interface KubernetesVersionReadiness is changed from Ossku to OsSku
  - Type of parameter values of interface VmSkuProfileProperties is changed from VmSkuProperties[] to VmSkuProfilePropertiesAutoGenerated[]
