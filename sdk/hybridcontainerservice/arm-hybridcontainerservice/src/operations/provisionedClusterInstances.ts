...
import {
  ...
  ProvisionedClusterInstancesListUpgradeProfileOptionalParams,
  ProvisionedClusterInstancesListUpgradeProfileResponse,
...
export class ProvisionedClusterInstancesImpl
  ...
  listUpgradeProfile(
    connectedClusterResourceUri: string,
    options?: ProvisionedClusterInstancesListUpgradeProfileOptionalParams
  ): Promise<ProvisionedClusterInstancesListUpgradeProfileResponse> {
    return this.client.sendOperationRequest(
      { connectedClusterResourceUri, options },
      listUpgradeProfileOperationSpec
    );
  }
...
const listUpgradeProfileOperationSpec: coreClient.OperationSpec = {
  path:
    "/{connectedClusterResourceUri}/providers/Microsoft.HybridContainerService/provisionedClusterInstances/default/upgradeProfiles",
  httpMethod: "GET",
  responses: {
    200: {
      bodyMapper: Mappers.ProvisionedClusterUpgradeProfileList
    },
    default: {
      bodyMapper: Mappers.ErrorResponse
    }
