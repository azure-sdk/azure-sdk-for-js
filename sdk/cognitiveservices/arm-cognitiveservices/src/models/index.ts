...
export interface RaiPolicyProperties {
  ...
  /** Rai policy mode. The enum value mapping is as below: Default = 0, Deferred=1, Blocking=2, Asynchronous_filter =3. Please use 'Asynchronous_filter' after 2025-04-01. It is the same as 'Deferred' in previous version. */
  mode?: RaiPolicyMode;
  /** Name of Rai policy. */
