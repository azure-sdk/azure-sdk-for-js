...
export default function createClient(
  ...
  const endpointUrl =
    options.endpoint ?? options.baseUrl ?? `${endpointParam}/speechtotext`;
  const userAgentInfo = `azsdk-js-ai-speech-synchronous-transcription-rest/1.0.0-beta.1`;
