...
export interface TranscriptionFileOutput {
   ...
   * FileKind
   *
   * Possible values: "AcousticDataArchive", "AcousticDataTranscriptionV2", "Audio", "DatasetReport", "EvaluationDetails", "LanguageData", "ModelReport", "OutputFormattingData", "PronunciationData", "Transcription", "TranscriptionReport"
   */
  kind: FileKindOutput;
  /** FileLinks */
...
/** Alias for TranscriptionStatusOutput */
export type TranscriptionStatusOutput = string;
/** Alias for FileKindOutput */
