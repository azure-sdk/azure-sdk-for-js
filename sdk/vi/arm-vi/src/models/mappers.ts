...
export const AccountForGet: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "AccountForGet",
    modelProperties: {
...
export const AccountForPut: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "AccountForPut",
    modelProperties: {
      ...TrackedResource.type.modelProperties,
      identity: {
        serializedName: "identity",
