...
export function elasticSanPropertiesSerializer(
  item: ElasticSanProperties,
): any {
  return {
...
export function elasticSanPropertiesDeserializer(
  item: any,
...
export function autoScalePropertiesDeserializer(
  item: any,
): AutoScaleProperties {
  return {
    scaleUpProperties: !item["scaleUpProperties"]
...
export function elasticSanUpdatePropertiesSerializer(
  item: ElasticSanUpdateProperties,
): any {
  return {
    baseSizeTiB: item["baseSizeTiB"],
    extendedCapacitySizeTiB: item["extendedCapacitySizeTiB"],
...
export function volumeGroupSerializer(item: VolumeGroup): any {
  return {
    identity: !item["identity"]
      ? item["identity"]
      : identitySerializer(item["identity"]),
    properties: !item["properties"]
      ? item["properties"]
...
export function volumeGroupDeserializer(item: any): VolumeGroup {
  return {
    ...
    identity: !item["identity"]
      ? item["identity"]
      : identityDeserializer(item["identity"]),
    properties: !item["properties"]
      ? item["properties"]
...
export function volumeGroupPropertiesSerializer(
  ...
  return {
    ...
    enforceDataIntegrityCheckForIscsi:
      item["enforceDataIntegrityCheckForIscsi"],
...
export function keyVaultPropertiesDeserializer(item: any): KeyVaultProperties {
  return {
    ...
    currentVersionedKeyExpirationTimestamp: !item[
...
export function deleteRetentionPolicySerializer(
  item: DeleteRetentionPolicy,
): any {
  return {
...
export function deleteRetentionPolicyDeserializer(
  item: any,
...
export function volumeGroupUpdatePropertiesSerializer(
  item: VolumeGroupUpdateProperties,
): any {
  return {
    protocolType: item["protocolType"],
    encryption: item["encryption"],
...
export function preValidationResponseDeserializer(
  item: any,
...
export function volumePropertiesSerializer(item: VolumeProperties): any {
  return {
    ...
    managedBy: !item["managedBy"]
      ? item["managedBy"]
      : managedByInfoSerializer(item["managedBy"]),
  };
}
...
export function volumeUpdatePropertiesSerializer(
  item: VolumeUpdateProperties,
): any {
  return {
    sizeGiB: item["sizeGiB"],
    managedBy: !item["managedBy"]
...
export function snapshotCreationDataSerializer(
  item: SnapshotCreationData,
): any {
  return { sourceId: item["sourceId"] };
}

export function snapshotCreationDataDeserializer(
  item: any,
...
export function _skuInformationListDeserializer(
  item: any,
): _SkuInformationList {
  return {
...
export function skuInformationArrayDeserializer(
  result: Array<SkuInformation>,
): any[] {
  return result.map((item) => {
...
export function skuLocationInfoArrayDeserializer(
  result: Array<SkuLocationInfo>,
): any[] {
  return result.map((item) => {
...
export function skuCapabilityArrayDeserializer(
  result: Array<SKUCapability>,
): any[] {
  return result.map((item) => {
