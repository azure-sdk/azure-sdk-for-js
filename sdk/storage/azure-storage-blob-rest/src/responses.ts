...
export interface SetProperties202Headers {
...
export interface SetProperties202Response extends HttpResponse {
  status: "202";
  headers: RawHttpHeaders & SetProperties202Headers;
}
...
export interface ContainerBlobDelete202Headers {
  /** UTC date/time value generated by the service that indicates the time at which the response was initiated */
  date: string;
  /** An opaque, globally-unique, server-generated string identifier for the request. */
  "x-ms-request-id"?: string;
...
export interface ContainerBlobDelete202Response extends HttpResponse {
  status: "202";
  headers: RawHttpHeaders & ContainerBlobDelete202Headers;
}
...
export interface ContainerBlobSetTier200Headers {
  /** An opaque, globally-unique, server-generated string identifier for the request. */
  "x-ms-request-id"?: string;
  /** An opaque, globally-unique, client-generated string identifier for the request. */
  "x-ms-client-request-id"?: string;
...
export interface ContainerBlobSetTier200Response extends HttpResponse {
  status: "200";
  headers: RawHttpHeaders & ContainerBlobSetTier200Headers;
}

export interface ContainerBlobSetTier202Headers {
  /** An opaque, globally-unique, server-generated string identifier for the request. */
  "x-ms-request-id"?: string;
  /** An opaque, globally-unique, client-generated string identifier for the request. */
  "x-ms-client-request-id"?: string;
...
export interface ContainerBlobSetTier202Response extends HttpResponse {
  status: "202";
  headers: RawHttpHeaders & ContainerBlobSetTier202Headers;
}
...
export interface ContainerPageBlobCreate201Headers {
  /** The ETag contains a value that you can use to perform operations conditionally. */
  etag: string;
  /** The date/time that the container was last modified. */
  "last-modified": string;
...
/** The request has succeeded and a new resource has been created as a result. */
export interface ContainerPageBlobCreate201Response extends HttpResponse {
  status: "201";
  headers: RawHttpHeaders & ContainerPageBlobCreate201Headers;
}

export interface ContainerPageBlobCreateDefaultResponse extends HttpResponse {
  status: string;
  body: StorageErrorOutput;
}

export interface ContainerPageBlobUploadPages201Headers {
  /** The ETag contains a value that you can use to perform operations conditionally. */
  etag: string;
  /** The date/time that the container was last modified. */
  "last-modified": string;
...
/** The request has succeeded and a new resource has been created as a result. */
export interface ContainerPageBlobUploadPages201Response extends HttpResponse {
  status: "201";
  headers: RawHttpHeaders & ContainerPageBlobUploadPages201Headers;
}

export interface ContainerPageBlobUploadPagesDefaultResponse extends HttpResponse {
  status: string;
  body: StorageErrorOutput;
}

export interface ContainerPageBlobClearPages201Headers {
  /** The ETag contains a value that you can use to perform operations conditionally. */
  etag: string;
  /** The date/time that the container was last modified. */
  "last-modified": string;
...
/** The request has succeeded and a new resource has been created as a result. */
export interface ContainerPageBlobClearPages201Response extends HttpResponse {
  status: "201";
  headers: RawHttpHeaders & ContainerPageBlobClearPages201Headers;
}

export interface ContainerPageBlobClearPagesDefaultResponse extends HttpResponse {
  status: string;
  body: StorageErrorOutput;
}

export interface ContainerPageBlobUploadPagesFromUrl201Headers {
  /** The ETag contains a value that you can use to perform operations conditionally. */
  etag: string;
  /** The date/time that the container was last modified. */
  "last-modified": string;
...
/** The request has succeeded and a new resource has been created as a result. */
export interface ContainerPageBlobUploadPagesFromUrl201Response extends HttpResponse {
  status: "201";
  headers: RawHttpHeaders & ContainerPageBlobUploadPagesFromUrl201Headers;
}

export interface ContainerPageBlobUploadPagesFromUrlDefaultResponse extends HttpResponse {
  status: string;
  body: StorageErrorOutput;
}

export interface ContainerPageBlobGetPageRanges200Headers {
  /** The date/time that the container was last modified. */
  "last-modified": string;
  /** The ETag contains a value that you can use to perform operations conditionally. */
  etag: string;
...
/** The request has succeeded. */
export interface ContainerPageBlobGetPageRanges200Response extends HttpResponse {
  status: "200";
  body: PageListOutput;
  headers: RawHttpHeaders & ContainerPageBlobGetPageRanges200Headers;
}

export interface ContainerPageBlobGetPageRangesDefaultResponse extends HttpResponse {
  status: string;
  body: StorageErrorOutput;
}

export interface ContainerPageBlobGetPageRangesDiff200Headers {
  /** The date/time that the container was last modified. */
  "last-modified": string;
  /** The ETag contains a value that you can use to perform operations conditionally. */
  etag: string;
...
/** The request has succeeded. */
export interface ContainerPageBlobGetPageRangesDiff200Response extends HttpResponse {
  status: "200";
  body: PageListOutput;
  headers: RawHttpHeaders & ContainerPageBlobGetPageRangesDiff200Headers;
}

export interface ContainerPageBlobGetPageRangesDiffDefaultResponse extends HttpResponse {
  status: string;
  body: StorageErrorOutput;
}

export interface ContainerPageBlobResize200Headers {
  /** The ETag contains a value that you can use to perform operations conditionally. */
  etag: string;
  /** The date/time that the container was last modified. */
  "last-modified": string;
...
/** The request has succeeded. */
export interface ContainerPageBlobResize200Response extends HttpResponse {
  status: "200";
  headers: RawHttpHeaders & ContainerPageBlobResize200Headers;
}

export interface ContainerPageBlobResizeDefaultResponse extends HttpResponse {
  status: string;
  body: StorageErrorOutput;
}

export interface ContainerPageBlobUpdateSequenceNumber200Headers {
  /** The ETag contains a value that you can use to perform operations conditionally. */
  etag: string;
  /** The date/time that the container was last modified. */
  "last-modified": string;
...
/** The request has succeeded. */
export interface ContainerPageBlobUpdateSequenceNumber200Response extends HttpResponse {
  status: "200";
  headers: RawHttpHeaders & ContainerPageBlobUpdateSequenceNumber200Headers;
}

export interface ContainerPageBlobUpdateSequenceNumberDefaultResponse extends HttpResponse {
  status: string;
  body: StorageErrorOutput;
}

export interface ContainerPageBlobCopyIncremental202Headers {
  /** The ETag contains a value that you can use to perform operations conditionally. */
  etag: string;
  /** The date/time that the container was last modified. */
  "last-modified": string;
...
/** The request has been accepted for processing, but processing has not yet completed. */
export interface ContainerPageBlobCopyIncremental202Response extends HttpResponse {
  status: "202";
  headers: RawHttpHeaders & ContainerPageBlobCopyIncremental202Headers;
}

export interface ContainerPageBlobCopyIncrementalDefaultResponse extends HttpResponse {
  status: string;
  body: StorageErrorOutput;
}

export interface ContainerAppendBlobCreate201Headers {
  /** The ETag contains a value that you can use to perform operations conditionally. */
  etag: string;
  /** The date/time that the container was last modified. */
  "last-modified": string;
...
/** The request has succeeded and a new resource has been created as a result. */
export interface ContainerAppendBlobCreate201Response extends HttpResponse {
  status: "201";
  headers: RawHttpHeaders & ContainerAppendBlobCreate201Headers;
}

export interface ContainerAppendBlobCreateDefaultResponse extends HttpResponse {
  status: string;
  body: StorageErrorOutput;
}

export interface ContainerAppendBlobAppendBlock201Headers {
  /** The ETag contains a value that you can use to perform operations conditionally. */
  etag: string;
  /** The date/time that the container was last modified. */
  "last-modified": string;
...
/** The request has succeeded and a new resource has been created as a result. */
export interface ContainerAppendBlobAppendBlock201Response extends HttpResponse {
  status: "201";
  headers: RawHttpHeaders & ContainerAppendBlobAppendBlock201Headers;
}

export interface ContainerAppendBlobAppendBlockDefaultResponse extends HttpResponse {
  status: string;
  body: StorageErrorOutput;
}

export interface ContainerAppendBlobAppendBlockFromUrl201Headers {
  /** The ETag contains a value that you can use to perform operations conditionally. */
  etag: string;
  /** The date/time that the container was last modified. */
  "last-modified": string;
...
/** The request has succeeded and a new resource has been created as a result. */
export interface ContainerAppendBlobAppendBlockFromUrl201Response extends HttpResponse {
  status: "201";
  headers: RawHttpHeaders & ContainerAppendBlobAppendBlockFromUrl201Headers;
}

export interface ContainerAppendBlobAppendBlockFromUrlDefaultResponse extends HttpResponse {
  status: string;
  body: StorageErrorOutput;
}

export interface ContainerAppendBlobSeal200Headers {
  /** The ETag contains a value that you can use to perform operations conditionally. */
  etag: string;
  /** The date/time that the container was last modified. */
  "last-modified": string;
...
/** The request has succeeded. */
export interface ContainerAppendBlobSeal200Response extends HttpResponse {
  status: "200";
  headers: RawHttpHeaders & ContainerAppendBlobSeal200Headers;
}

export interface ContainerAppendBlobSealDefaultResponse extends HttpResponse {
  status: string;
  body: StorageErrorOutput;
}

export interface ContainerBlockBlobUpload201Headers {
  /** The ETag contains a value that you can use to perform operations conditionally. */
  etag: string;
  /** The date/time that the container was last modified. */
  "last-modified": string;
...
/** The request has succeeded and a new resource has been created as a result. */
export interface ContainerBlockBlobUpload201Response extends HttpResponse {
  status: "201";
  headers: RawHttpHeaders & ContainerBlockBlobUpload201Headers;
}

export interface ContainerBlockBlobUploadDefaultResponse extends HttpResponse {
  status: string;
  body: StorageErrorOutput;
}

export interface ContainerBlockBlobPutBlobFromUrl201Headers {
  /** The ETag contains a value that you can use to perform operations conditionally. */
  etag: string;
  /** The date/time that the container was last modified. */
  "last-modified": string;
...
/** The request has succeeded and a new resource has been created as a result. */
export interface ContainerBlockBlobPutBlobFromUrl201Response extends HttpResponse {
  status: "201";
  headers: RawHttpHeaders & ContainerBlockBlobPutBlobFromUrl201Headers;
}

export interface ContainerBlockBlobPutBlobFromUrlDefaultResponse extends HttpResponse {
  status: string;
  body: StorageErrorOutput;
}

export interface ContainerBlockBlobStageBlock201Headers {
  /** UTC date/time value generated by the service that indicates the time at which the response was initiated */
  date: string;
  /** If the blob has an MD5 hash and this operation is to read the full blob, this response header is returned so that the client can check for message content integrity. */
  "content-md5": string;
...
/** The request has succeeded and a new resource has been created as a result. */
export interface ContainerBlockBlobStageBlock201Response extends HttpResponse {
  status: "201";
  headers: RawHttpHeaders & ContainerBlockBlobStageBlock201Headers;
}

export interface ContainerBlockBlobStageBlockDefaultResponse extends HttpResponse {
  status: string;
  body: StorageErrorOutput;
}

export interface ContainerBlockBlobStageBlockFromUrl201Headers {
  /** UTC date/time value generated by the service that indicates the time at which the response was initiated */
  date: string;
  /** If the blob has an MD5 hash and this operation is to read the full blob, this response header is returned so that the client can check for message content integrity. */
  "content-md5": string;
...
/** The request has succeeded and a new resource has been created as a result. */
export interface ContainerBlockBlobStageBlockFromUrl201Response extends HttpResponse {
  status: "201";
  headers: RawHttpHeaders & ContainerBlockBlobStageBlockFromUrl201Headers;
}

export interface ContainerBlockBlobStageBlockFromUrlDefaultResponse extends HttpResponse {
  status: string;
  body: StorageErrorOutput;
}

export interface ContainerBlockBlobCommitBlockList201Headers {
  /** The ETag contains a value that you can use to perform operations conditionally. */
  etag: string;
  /** The date/time that the container was last modified. */
  "last-modified": string;
...
/** The request has succeeded and a new resource has been created as a result. */
export interface ContainerBlockBlobCommitBlockList201Response extends HttpResponse {
  status: "201";
  headers: RawHttpHeaders & ContainerBlockBlobCommitBlockList201Headers;
}

export interface ContainerBlockBlobCommitBlockListDefaultResponse extends HttpResponse {
  status: string;
  body: StorageErrorOutput;
}

export interface ContainerBlockBlobGetBlockList200Headers {
  /** The date/time that the container was last modified. */
  "last-modified": string;
  /** The ETag contains a value that you can use to perform operations conditionally. */
  etag: string;
...
/** The request has succeeded. */
export interface ContainerBlockBlobGetBlockList200Response extends HttpResponse {
  status: "200";
  body: BlockListOutput;
  headers: RawHttpHeaders & ContainerBlockBlobGetBlockList200Headers;
}

export interface ContainerBlockBlobGetBlockListDefaultResponse extends HttpResponse {
  status: string;
  body: StorageErrorOutput;
}

export interface ContainerBlockBlobQuery200Headers {
  /** The metadata headers. */
  "x-ms-meta"?: Record<string, string>;
  /** The date/time that the container was last modified. */
  "last-modified": string;
...
/** The request has succeeded. */
export interface ContainerBlockBlobQuery200Response extends HttpResponse {
  status: "200";
  /** Value may contain any sequence of octets */
  body: Uint8Array;
  headers: RawHttpHeaders & ContainerBlockBlobQuery200Headers;
}

export interface ContainerBlockBlobQuery206Headers {
  /** The metadata headers. */
  "x-ms-meta"?: Record<string, string>;
  /** The date/time that the container was last modified. */
  "last-modified": string;
...
/** Successful */
export interface ContainerBlockBlobQuery206Response extends HttpResponse {
  status: "206";
  /** Value may contain any sequence of octets */
  body: Uint8Array;
  headers: RawHttpHeaders & ContainerBlockBlobQuery206Headers;
}

export interface ContainerBlockBlobQueryDefaultResponse extends HttpResponse {
  status: string;
  body: StorageErrorOutput;
}
