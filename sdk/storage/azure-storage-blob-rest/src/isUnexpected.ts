...
const responseMap: Record<string, string[]> = {
  ...
  "PUT /{containerName}/{blobName}?comp=copy": ["202"],
...
export function isUnexpected(
  response: ContainerPageBlobCreate201Response | ContainerPageBlobCreateDefaultResponse,
): response is ContainerPageBlobCreateDefaultResponse;
export function isUnexpected(
  response: ContainerPageBlobUploadPages201Response | ContainerPageBlobUploadPagesDefaultResponse,
): response is ContainerPageBlobUploadPagesDefaultResponse;
export function isUnexpected(
  response: ContainerPageBlobClearPages201Response | ContainerPageBlobClearPagesDefaultResponse,
): response is ContainerPageBlobClearPagesDefaultResponse;
export function isUnexpected(
  response:
    | ContainerPageBlobUploadPagesFromUrl201Response
    | ContainerPageBlobUploadPagesFromUrlDefaultResponse,
): response is ContainerPageBlobUploadPagesFromUrlDefaultResponse;
export function isUnexpected(
  response:
    | ContainerPageBlobGetPageRanges200Response
    | ContainerPageBlobGetPageRangesDefaultResponse,
): response is ContainerPageBlobGetPageRangesDefaultResponse;
export function isUnexpected(
  response:
    | ContainerPageBlobGetPageRangesDiff200Response
    | ContainerPageBlobGetPageRangesDiffDefaultResponse,
): response is ContainerPageBlobGetPageRangesDiffDefaultResponse;
export function isUnexpected(
  response: ContainerPageBlobResize200Response | ContainerPageBlobResizeDefaultResponse,
): response is ContainerPageBlobResizeDefaultResponse;
export function isUnexpected(
  response:
    | ContainerPageBlobUpdateSequenceNumber200Response
    | ContainerPageBlobUpdateSequenceNumberDefaultResponse,
): response is ContainerPageBlobUpdateSequenceNumberDefaultResponse;
export function isUnexpected(
  response:
    | ContainerPageBlobCopyIncremental202Response
    | ContainerPageBlobCopyIncrementalDefaultResponse,
): response is ContainerPageBlobCopyIncrementalDefaultResponse;
export function isUnexpected(
  response: ContainerAppendBlobCreate201Response | ContainerAppendBlobCreateDefaultResponse,
): response is ContainerAppendBlobCreateDefaultResponse;
export function isUnexpected(
  response:
    | ContainerAppendBlobAppendBlock201Response
    | ContainerAppendBlobAppendBlockDefaultResponse,
): response is ContainerAppendBlobAppendBlockDefaultResponse;
export function isUnexpected(
  response:
    | ContainerAppendBlobAppendBlockFromUrl201Response
    | ContainerAppendBlobAppendBlockFromUrlDefaultResponse,
): response is ContainerAppendBlobAppendBlockFromUrlDefaultResponse;
export function isUnexpected(
  response: ContainerAppendBlobSeal200Response | ContainerAppendBlobSealDefaultResponse,
): response is ContainerAppendBlobSealDefaultResponse;
export function isUnexpected(
  response: ContainerBlockBlobUpload201Response | ContainerBlockBlobUploadDefaultResponse,
): response is ContainerBlockBlobUploadDefaultResponse;
export function isUnexpected(
  response:
    | ContainerBlockBlobPutBlobFromUrl201Response
    | ContainerBlockBlobPutBlobFromUrlDefaultResponse,
): response is ContainerBlockBlobPutBlobFromUrlDefaultResponse;
export function isUnexpected(
  response: ContainerBlockBlobStageBlock201Response | ContainerBlockBlobStageBlockDefaultResponse,
): response is ContainerBlockBlobStageBlockDefaultResponse;
export function isUnexpected(
  response:
    | ContainerBlockBlobStageBlockFromUrl201Response
    | ContainerBlockBlobStageBlockFromUrlDefaultResponse,
): response is ContainerBlockBlobStageBlockFromUrlDefaultResponse;
export function isUnexpected(
  response:
    | ContainerBlockBlobCommitBlockList201Response
    | ContainerBlockBlobCommitBlockListDefaultResponse,
): response is ContainerBlockBlobCommitBlockListDefaultResponse;
export function isUnexpected(
  response:
    | ContainerBlockBlobGetBlockList200Response
    | ContainerBlockBlobGetBlockListDefaultResponse,
): response is ContainerBlockBlobGetBlockListDefaultResponse;
export function isUnexpected(
  response:
    | ContainerBlockBlobQuery200Response
    | ContainerBlockBlobQuery206Response
    | ContainerBlockBlobQueryDefaultResponse,
): response is ContainerBlockBlobQueryDefaultResponse;
export function isUnexpected(
  response:
    | SetProperties202Response
    | SetPropertiesDefaultResponse
