...
export interface ServiceListContainersSegmentQueryParamProperties {
  ...
  include?: ListContainersIncludeType[] | ServiceListContainersSegmentIncludeQueryParam;
}
...
export type ServiceGetUserDelegationKeyParameters = ServiceGetUserDelegationKeyQueryParam &
...
export type BlobSetImmutabilityPolicyParameters = BlobSetImmutabilityPolicyQueryParam &
...
export type BlobDeleteImmutabilityPolicyParameters = BlobDeleteImmutabilityPolicyQueryParam &
...
export interface BlobQueryBodyParam {
  /** The query request */
  body: QueryRequest;
}

export interface BlobQueryQueryParamProperties {
  /** The snapshot parameter is an opaque DateTime value that, when present, specifies the blob snapshot to retrieve. For more information on working with blob snapshots, see <a href="https://docs.microsoft.com/en-us/rest/api/storageservices/fileservices/creating-a-snapshot-of-a-blob">Creating a Snapshot of a Blob.</a> */
  snapshot?: string;
  /** The timeout parameter is expressed in seconds. For more information, see <a href="https://docs.microsoft.com/en-us/rest/api/storageservices/fileservices/setting-timeouts-for-blob-service-operations">Setting Timeouts for Blob Service Operations.</a> */
  timeout?: number;
...
export interface BlobQueryQueryParam {
  queryParameters?: BlobQueryQueryParamProperties;
}

export interface BlobQueryHeaderParam {
  headers: RawHttpHeadersInput & BlobQueryHeaders;
}

export interface BlobQueryMediaTypesParam {
  /** Content-Type header */
  contentType: "application/xml";
}

export type BlobQueryParameters = BlobQueryQueryParam &
  BlobQueryHeaderParam &
  BlobQueryMediaTypesParam &
  BlobQueryBodyParam &
  RequestParameters;
...
export type PageBlobUploadPagesFromUrlParameters = PageBlobUploadPagesFromUrlQueryParam &
...
export type PageBlobCopyIncrementalParameters = PageBlobCopyIncrementalQueryParam &
...
export type AppendBlobAppendBlockFromUrlParameters = AppendBlobAppendBlockFromUrlQueryParam &
...
export type BlockBlobPutBlobFromUrlParameters = BlockBlobPutBlobFromUrlQueryParam &
...
export type BlockBlobStageBlockFromUrlParameters = BlockBlobStageBlockFromUrlQueryParam &
