...
export interface BlobQuery {
  ...
  ): StreamableMethod<BlobQuery200Response | BlobQuery206Response | BlobQueryDefaultResponse>;
}
...
export interface Routes {
  ...
  (path: "/{containerName}/{blob}?comp=query", containerName: string, blob: string): BlobQuery;
