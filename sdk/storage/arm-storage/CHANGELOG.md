...
### Features Added
  ...
  - Added Interface BlobContainerListResult
  - Added Interface BlobContainersObjectLevelWormHeaders
  - Added Interface FileShareListResult
  ...
  - Interface FileServiceUsage has a new optional parameter burstingConstants
  - Interface FileServiceUsage has a new optional parameter fileShareLimits
  - Interface FileServiceUsage has a new optional parameter fileShareRecommendations
  - Interface FileServiceUsage has a new optional parameter storageAccountLimits
  - Interface FileServiceUsage has a new optional parameter storageAccountUsage
  - Interface FileShare has a new optional parameter etag
  - Interface ImmutabilityPolicy has a new optional parameter etag
  ...
  - Enum KnownEncryptionScopeSource has a new value KeyVault
  - Enum KnownEncryptionScopeSource has a new value Storage
...
### Breaking Changes
  ...
  - Interface FileServiceUsage no longer has parameter properties
  - Interface LocalUser no longer has parameter systemData
  - Interface ObjectReplicationPolicy no longer has parameter metrics
  ...
  - Parameter value of interface FileServiceUsages is now required
  ...
  - Type of parameter maxpagesize of interface BlobContainersListOptionalParams is changed from string to number
  - Type of parameter error of interface ErrorResponse is changed from ErrorResponseBody to ErrorDetail
  - Type of parameter maxpagesize of interface FileSharesListOptionalParams is changed from string to number
  - Type of parameter origin of interface Operation is changed from string to Origin
  - Enum KnownEncryptionScopeSource no longer has value MicrosoftKeyVault
  - Enum KnownEncryptionScopeSource no longer has value MicrosoftStorage
