...
### Features Added
  ...
  - Added operation StorageAccounts.checkStorageAccountNameAvailability
  ...
  - Added Interface StorageAccountsCheckStorageAccountNameAvailabilityOptionalParams
  ...
  - Added Type Alias StorageAccountsCheckStorageAccountNameAvailabilityResponse
...
### Breaking Changes
  ...
  - Removed operation StorageAccounts.checkNameAvailability
  ...
  - Type of parameter maxpagesize of interface QueueListOptionalParams is changed from string to number
