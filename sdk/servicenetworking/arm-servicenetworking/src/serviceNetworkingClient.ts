...
export { ServiceNetworkingClientOptionalParams } from "./api/serviceNetworkingContext.js";
...
export class ServiceNetworkingClient {
  ...
  constructor(
    ...
    options: ServiceNetworkingClientOptionalParams = {},
  ) {
    const prefixFromOptions = options?.userAgentOptions?.userAgentPrefix;
    const userAgentPrefix = prefixFromOptions
      ? `${prefixFromOptions} azsdk-js-client`
      : `azsdk-js-client`;
    this._client = createServiceNetworking(credential, {
      ...options,
