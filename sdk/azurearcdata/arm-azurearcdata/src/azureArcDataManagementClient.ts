...
import {
  ...
  SqlAvailabilityGroupsImpl,
  DataControllersImpl,
  ActiveDirectoryConnectorsImpl,
  PostgresInstancesImpl,
  SqlServerDatabasesImpl,
  SqlServerAvailabilityGroupsImpl,
  SqlAvailabilityGroupReplicasImpl,
  SqlAvailabilityGroupDatabasesImpl
} from "./operations";
import {
  Operations,
  SqlManagedInstances,
...
export class AzureArcDataManagementClient extends coreClient.ServiceClient {
  ...
  constructor(
    ...
    this.sqlAvailabilityGroups = new SqlAvailabilityGroupsImpl(this);
    ...
    this.sqlServerAvailabilityGroups = new SqlServerAvailabilityGroupsImpl(
      this
    );
    this.sqlAvailabilityGroupReplicas = new SqlAvailabilityGroupReplicasImpl(
      this
    );
    this.sqlAvailabilityGroupDatabases = new SqlAvailabilityGroupDatabasesImpl(
      this
    );
  ...
  sqlAvailabilityGroups: SqlAvailabilityGroups;
  ...
  sqlAvailabilityGroupReplicas: SqlAvailabilityGroupReplicas;
  sqlAvailabilityGroupDatabases: SqlAvailabilityGroupDatabases;
}
