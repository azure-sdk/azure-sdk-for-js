...
import { AzureArcDataManagementClientOptionalParams } from "./models/index.js";
...
export class AzureArcDataManagementClient extends coreClient.ServiceClient {
  ...
  constructor(
    ...
    this.sqlServerLicenses = new SqlServerLicensesImpl(this);
    ...
    this.sqlServerAvailabilityGroups = new SqlServerAvailabilityGroupsImpl(this);
    this.sqlServerDatabases = new SqlServerDatabasesImpl(this);
    this.sqlServerEsuLicenses = new SqlServerEsuLicensesImpl(this);
