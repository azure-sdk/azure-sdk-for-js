...
export class SqlServerInstancesImpl implements SqlServerInstances {
  ...
  async beginDeleteAndWait(
    ...
    const poller = await this.beginDelete(resourceGroupName, sqlServerInstanceName, options);
    return poller.pollUntilDone();
  }
...
const runManagedInstanceLinkAssessmentOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.SqlServerInstanceManagedInstanceLinkAssessmentResponse,
    },
    201: {
      bodyMapper: Mappers.SqlServerInstanceManagedInstanceLinkAssessmentResponse,
    },
  ...
  requestBody: Parameters.sqlServerInstanceManagedInstanceLinkAssessmentRequest,
  queryParameters: [Parameters.apiVersion],
  urlParameters: [
    Parameters.$host,
    Parameters.subscriptionId,
