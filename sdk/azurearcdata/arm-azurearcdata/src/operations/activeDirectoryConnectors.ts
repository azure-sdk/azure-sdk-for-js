...
import { ActiveDirectoryConnectors } from "../operationsInterfaces/index.js";
...
export class ActiveDirectoryConnectorsImpl implements ActiveDirectoryConnectors {
  ...
  public list(
    ...
    const iter = this.listPagingAll(resourceGroupName, dataControllerName, options);
    return {
      next() {
        return iter.next();
      },
      ...
      byPage: (settings?: PageSettings) => {
        ...
        return this.listPagingPage(resourceGroupName, dataControllerName, options, settings);
      },
    };
  }
  ...
  private async *listPagingAll(
    ...
    for await (const page of this.listPagingPage(resourceGroupName, dataControllerName, options)) {
      yield* page;
    }
  }
  ...
  async beginCreate(
    ...
    SimplePollerLike<
      OperationState<ActiveDirectoryConnectorsCreateResponse>,
      ActiveDirectoryConnectorsCreateResponse
    >
  > {
