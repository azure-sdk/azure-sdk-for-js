...
import { DataControllers } from "../operationsInterfaces/index.js";
...
export class DataControllersImpl implements DataControllers {
  ...
  private async *listInGroupPagingPage(
    ...
    while (continuationToken) {
      result = await this._listInGroupNext(resourceGroupName, continuationToken, options);
      continuationToken = result.nextLink;
      let page = result.value || [];
      setContinuationToken(page, continuationToken);
      yield page;
  ...
  private async *listInGroupPagingAll(
    ...
    for await (const page of this.listInGroupPagingPage(resourceGroupName, options)) {
      yield* page;
    }
  }
