...
export class SqlServerAvailabilityGroupsImpl implements SqlServerAvailabilityGroups {
  ...
  public list(
    ...
    const iter = this.listPagingAll(resourceGroupName, sqlServerInstanceName, options);
    return {
      next() {
        return iter.next();
      },
      ...
      byPage: (settings?: PageSettings) => {
        ...
        return this.listPagingPage(resourceGroupName, sqlServerInstanceName, options, settings);
      },
    };
  }
  ...
  private async *listPagingPage(
    ...
    if (!continuationToken) {
      result = await this._list(resourceGroupName, sqlServerInstanceName, options);
