...
- [Package (NPM)](https://www.npmjs.com/package/@azure/chaos)
- [API reference documentation](https://docs.microsoft.com/javascript/api/@azure/chaos?view=azure-node-preview)
...
```javascript
const { ChaosClient } = require("@azure/chaos");
