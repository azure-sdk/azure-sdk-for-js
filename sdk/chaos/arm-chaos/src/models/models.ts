...
export function privateAccessPropertiesSerializer(
  item: PrivateAccessProperties,
): any {
  return { publicNetworkAccess: item["publicNetworkAccess"] };
}

export function privateAccessPropertiesDeserializer(
  item: any,
...
export function _privateAccessListResultDeserializer(
  item: any,
...
export function privateAccessArraySerializer(
  result: Array<PrivateAccess>,
): any[] {
  return result.map((item) => {
...
export function privateAccessArrayDeserializer(
  result: Array<PrivateAccess>,
): any[] {
  return result.map((item) => {
...
export function customerDataStoragePropertiesSerializer(
  item: CustomerDataStorageProperties,
): any {
  return {
...
export function experimentUpdateSerializer(item: ExperimentUpdate): any {
  return {
    identity: !item["identity"]
      ? item["identity"]
      : resourceIdentitySerializer(item["identity"]),
    tags: item["tags"],
  };
}
