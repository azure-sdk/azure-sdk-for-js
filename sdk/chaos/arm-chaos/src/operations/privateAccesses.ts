...
import { PrivateAccesses } from "../operationsInterfaces/index.js";
...
export class PrivateAccessesImpl implements PrivateAccesses {
  ...
  > {
    ...
    const lro = createLroSpec({
      sendOperationFn,
      args: { resourceGroupName, privateAccessName, resource, options },
  ...
  async beginUpdate(
    ...
    SimplePollerLike<
      OperationState<PrivateAccessesUpdateResponse>,
      PrivateAccessesUpdateResponse
    >
  > {
    const directSendOperation = async (
    ...
    const lro = createLroSpec({
      sendOperationFn,
      args: { resourceGroupName, privateAccessName, properties, options },
