...
/** Defines headers for Devices_downloadUpdates operation. */
export interface DevicesDownloadUpdatesHeaders {
  location?: string;
  /** Accepted the request to download the updates on the device. */
  azureAsyncOperation?: string;
}

/** Defines headers for Devices_installUpdates operation. */
export interface DevicesInstallUpdatesHeaders {
  location?: string;
  /** Accepted the request to install updates on the device. */
  azureAsyncOperation?: string;
}

/** Defines headers for Devices_scanForUpdates operation. */
export interface DevicesScanForUpdatesHeaders {
  location?: string;
  /** Accepted the request to scan for updates on the device. */
  azureAsyncOperation?: string;
}

/** Defines headers for Devices_createOrUpdateSecuritySettings operation. */
export interface DevicesCreateOrUpdateSecuritySettingsHeaders {
  location?: string;
  /** Accepted the request to update the security settings. */
  azureAsyncOperation?: string;
}

/** Defines headers for BandwidthSchedules_delete operation. */
export interface BandwidthSchedulesDeleteHeaders {
  location?: string;
  /** Accepted the request to delete the bandwidth schedule. */
  azureAsyncOperation?: string;
}

/** Defines headers for DeviceCapacityCheck_checkResourceCreationFeasibility operation. */
export interface DeviceCapacityCheckCheckResourceCreationFeasibilityHeaders {
  location?: string;
  /** Accepted the request to check the feasibility of resource creation. */
  azureAsyncOperation?: string;
}

/** Defines headers for Orders_delete operation. */
export interface OrdersDeleteHeaders {
  location?: string;
  /** Accepted the request to delete the order. */
  azureAsyncOperation?: string;
}
...
export interface RolesDeleteHeaders {
  location?: string;
  /** Accepted the request to delete the role. */
  azureAsyncOperation?: string;
}
...
export interface AddonsDeleteHeaders {
  location?: string;
  /** Accepted the request to delete the addon. */
  azureAsyncOperation?: string;
}

/** Defines headers for MonitoringConfig_delete operation. */
export interface MonitoringConfigDeleteHeaders {
  location?: string;
  /** Accepted the request to delete the metrics configuration. */
  azureAsyncOperation?: string;
}

/** Defines headers for Shares_delete operation. */
export interface SharesDeleteHeaders {
  location?: string;
  /** Accepted the request to delete the share. */
  azureAsyncOperation?: string;
}

/** Defines headers for Shares_refresh operation. */
export interface SharesRefreshHeaders {
  location?: string;
  /** Accepted the request to refresh the share on the device. */
  azureAsyncOperation?: string;
}

/** Defines headers for StorageAccountCredentials_delete operation. */
export interface StorageAccountCredentialsDeleteHeaders {
  location?: string;
  /** Accepted the request to delete the storage account credential. */
  azureAsyncOperation?: string;
}

/** Defines headers for StorageAccounts_delete operation. */
export interface StorageAccountsDeleteHeaders {
  location?: string;
  /** Accepted the request to delete the StorageAccount. */
  azureAsyncOperation?: string;
}

/** Defines headers for Containers_delete operation. */
export interface ContainersDeleteHeaders {
  location?: string;
  /** Accepted the request to delete the container. */
  azureAsyncOperation?: string;
}

/** Defines headers for Containers_refresh operation. */
export interface ContainersRefreshHeaders {
  location?: string;
  /** Accepted the request to refresh the container on the device. */
  azureAsyncOperation?: string;
}
...
export interface TriggersDeleteHeaders {
  location?: string;
  /** Accepted the request to delete the trigger. */
  azureAsyncOperation?: string;
}

/** Defines headers for SupportPackages_triggerSupportPackage operation. */
export interface SupportPackagesTriggerSupportPackageHeaders {
  location?: string;
  /** Accepted the request to trigger support package on the device. */
  azureAsyncOperation?: string;
}
...
export interface UsersDeleteHeaders {
  location?: string;
  /** Accepted the request to delete the user. */
  azureAsyncOperation?: string;
}
...
/** Contains response data for the createOrUpdateSecuritySettings operation. */
