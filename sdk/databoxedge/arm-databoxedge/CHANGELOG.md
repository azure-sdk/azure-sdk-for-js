...
**Breaking Changes**
  ...
  - Class DataBoxEdgeManagementClient has a new required parameter deviceCapacityCheck
  - Class DataBoxEdgeManagementClient has a new required parameter deviceCapacityInfoOperations
