## API Report File for "@azure-rest/DocumentDB.MongoCluster.Management-rest"
...
// @public
function createClient(credentials: TokenCredential, { apiVersion, ...options }?: DocumentDBClientOptions): DocumentDBClient;
...
// @public (undocumented)
export type DocumentDBClient = Client & {
    path: Routes;
};
