...
export interface MongoClusters {
    ...
    beginUpdate(resourceGroupName: string, mongoClusterName: string, properties: MongoCluster, options?: MongoClustersUpdateOptionalParams): Promise<SimplePollerLike<OperationState<MongoClustersUpdateResponse>, MongoClustersUpdateResponse>>;
    beginUpdateAndWait(resourceGroupName: string, mongoClusterName: string, properties: MongoCluster, options?: MongoClustersUpdateOptionalParams): Promise<MongoClustersUpdateResponse>;
