...
export interface HighAvailabilityProperties {
    readonly mode?: HighAvailabilityMode;
...
export interface Replicas {
    listByMongoCluster(resourceGroupName: string, mongoClusterName: string, options?: ReplicasListByMongoClusterOptionalParams): PagedAsyncIterableIterator<Replica>;
}

// @public
export interface ReplicasListByMongoClusterNextOptionalParams extends coreClient.OperationOptions {
}

// @public
export type ReplicasListByMongoClusterNextResponse = ReplicaListResult;

// @public
export interface ReplicasListByMongoClusterOptionalParams extends coreClient.OperationOptions {
}

// @public
export type ReplicasListByMongoClusterResponse = ReplicaListResult;
