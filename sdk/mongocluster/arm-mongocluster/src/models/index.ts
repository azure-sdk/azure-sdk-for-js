...
/** Defines headers for MongoClusters_promote operation. */
...
export enum KnownHighAvailabilityMode {
  ...
  SameZone = "SameZone",
  /** High availability mode is enabled, where each server in a shard is distributed across availability zones. */
 ...
 * **ZoneRedundant**: High availability mode is enabled, where each server in a shard is distributed across availability zones. \
...
/**
 * Defines values for PreviewFeature. \
...
/**
 * Defines values for PromoteOption. \
...
/**
 * Defines values for PromoteMode. \
...
/** Optional parameters. */
export interface MongoClustersPromoteOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Optional parameters. */
export interface ReplicasListByMongoClusterOptionalParams
  extends coreClient.OperationOptions {}
...
/** Optional parameters. */
export interface ReplicasListByMongoClusterNextOptionalParams
  extends coreClient.OperationOptions {}
