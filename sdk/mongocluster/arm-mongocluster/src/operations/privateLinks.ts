...
import { MongoClusterManagementClientForTesting } from "../mongoClusterManagementClientForTesting";
import {
  PrivateLinkResource,
...
export class PrivateLinksImpl implements PrivateLinks {
  private readonly client: MongoClusterManagementClientForTesting;

  /**
   * Initialize a new instance of the class PrivateLinks class.
   * @param client Reference to the service client
   */
  constructor(client: MongoClusterManagementClientForTesting) {
    this.client = client;
  }
