...
### Create and authenticate a `MongoClusterManagementClientForTesting`
...
```javascript
const { MongoClusterManagementClientForTesting } = require("@azure/arm-mongocluster");
const { DefaultAzureCredential } = require("@azure/identity");
// For client-side applications running in the browser, use InteractiveBrowserCredential instead of DefaultAzureCredential. See https://aka.ms/azsdk/js/identity/examples for more details.

const subscriptionId = "00000000-0000-0000-0000-000000000000";
const client = new MongoClusterManagementClientForTesting(new DefaultAzureCredential(), subscriptionId);
...
// });
// const client = new MongoClusterManagementClientForTesting(credential, subscriptionId);
```
...
### MongoClusterManagementClientForTesting

`MongoClusterManagementClientForTesting` is the primary interface for developers using the Azure MongoClusterManagement client library. Explore the methods on this client object to understand the different features of the Azure MongoClusterManagement service that you can access.
