...
[Source code](https://github.com/Azure/azure-sdk-for-js/tree/main/sdk/mongocluster/arm-mongoclustertest) |
[Package (NPM)](https://www.npmjs.com/package/@azure/arm-mongoclustertest) |
[API reference documentation](https://docs.microsoft.com/javascript/api/@azure/arm-mongoclustertest?view=azure-node-preview) |
[Samples](https://github.com/Azure/azure-sdk-for-js/tree/main/sdk/mongocluster/arm-mongoclustertest/samples)
...
### Install the `@azure/arm-mongoclustertest` package

Install the Azure MongoClusterManagement client library for JavaScript with `npm`:

```bash
npm install @azure/arm-mongoclustertest
```
...
```javascript
const { DocumentDBClient } = require("@azure/arm-mongoclustertest");
...
Please take a look at the [samples](https://github.com/Azure/azure-sdk-for-js/tree/main/sdk/mongocluster/arm-mongoclustertest/samples) directory for detailed examples on how to use this library.
