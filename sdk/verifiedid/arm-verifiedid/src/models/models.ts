...
export function authoritySerializer(item: Authority): Record<string, unknown> {
  return {
    tags: !item.tags ? item.tags : (serializeRecord(item.tags as any) as any),
    location: item["location"],
...
export function authorityPropertiesSerializer(item: AuthorityProperties) {
  return item as any;
}
...
export function authorityUpdateSerializer(
  item: AuthorityUpdate,
): Record<string, unknown> {
  return {
    tags: !item.tags ? item.tags : (serializeRecord(item.tags as any) as any),
  };
