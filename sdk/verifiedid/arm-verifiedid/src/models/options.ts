...
/** Optional parameters. */
export interface AuthoritiesCreateOrUpdateOptionalParams
...
/** Optional parameters. */
export interface AuthoritiesListByResourceGroupOptionalParams
  extends OperationOptions {}

/** Optional parameters. */
export interface AuthoritiesListBySubscriptionOptionalParams
  extends OperationOptions {}
