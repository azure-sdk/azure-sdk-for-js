...
export const SAPDiscoverySite: coreClient.CompositeMapper = {
  type: {
    ...
    modelProperties: {
      ...
      migrateProjectId: {
        serializedName: "properties.migrateProjectId",
        type: {
          name: "String",
        },
      },
...
export const SAPInstance: coreClient.CompositeMapper = {
  type: {
    ...
    modelProperties: {
      ...TrackedResource.type.modelProperties,
      systemSid: {
        serializedName: "properties.systemSid",
        readOnly: true,
        type: {
          name: "String",
        },
      ...
      landscapeSid: {
        serializedName: "properties.landscapeSid",
        readOnly: true,
        type: {
          name: "String",
        },
      ...
      application: {
        serializedName: "properties.application",
        readOnly: true,
        type: {
          name: "String",
        },
...
export const ServerInstance: coreClient.CompositeMapper = {
  type: {
    ...
    modelProperties: {
      ...
      sapInstanceType: {
        serializedName: "properties.sapInstanceType",
        readOnly: true,
        type: {
          name: "String",
        },
      ...
      instanceSid: {
        serializedName: "properties.instanceSid",
        readOnly: true,
        type: {
          name: "String",
        },
      ...
      sapProductVersion: {
        serializedName: "properties.sapProductVersion",
        readOnly: true,
        type: {
          name: "String",
        },
      ...
      configurationData: {
        serializedName: "properties.configurationData",
        type: {
          name: "Composite",
          className: "ConfigurationData",
        },
      ...
      performanceData: {
        serializedName: "properties.performanceData",
        type: {
          name: "Composite",
          className: "PerformanceData",
        },
