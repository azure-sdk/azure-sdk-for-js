...
export class WorkloadsClientTest extends coreClient.ServiceClient {
  ...
  constructor(
    ...
    this.sapDiscoverySites = new SapDiscoverySitesImpl(this);
    this.sapInstances = new SapInstancesImpl(this);
    this.serverInstances = new ServerInstancesImpl(this);
