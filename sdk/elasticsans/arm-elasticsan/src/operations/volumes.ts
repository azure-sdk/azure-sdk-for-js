...
export class VolumesImpl implements Volumes {
  ...
  ): Promise<SimplePollerLike<OperationState<VolumesPreBackupResponse>, VolumesPreBackupResponse>> {
  ...
  async beginPreRestore(
    ...
    SimplePollerLike<OperationState<VolumesPreRestoreResponse>, VolumesPreRestoreResponse>
  > {
    const directSendOperation = async (
      args: coreClient.OperationArguments,
      spec: coreClient.OperationSpec,
  ...
  ): Promise<SimplePollerLike<OperationState<VolumesCreateResponse>, VolumesCreateResponse>> {
    const directSendOperation = async (
      args: coreClient.OperationArguments,
      spec: coreClient.OperationSpec,
...
const listByVolumeGroupOperationSpec: coreClient.OperationSpec = {
  ...
  headerParameters: [Parameters.accept, Parameters.xMsAccessSoftDeletedResources],
  serializer,
};
...
const deleteOperationSpec: coreClient.OperationSpec = {
  ...
  headerParameters: [Parameters.accept, Parameters.xMsDeleteSnapshots, Parameters.xMsForceDelete],
  serializer,
};
