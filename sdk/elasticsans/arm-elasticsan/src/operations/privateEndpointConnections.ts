...
export class PrivateEndpointConnectionsImpl implements PrivateEndpointConnections {
  ...
  private async *listPagingPage(
    ...
    while (continuationToken) {
      result = await this._listNext(resourceGroupName, elasticSanName, continuationToken, options);
      continuationToken = result.nextLink;
      let page = result.value || [];
      setContinuationToken(page, continuationToken);
      yield page;
  ...
  private async *listPagingAll(
    ...
    for await (const page of this.listPagingPage(resourceGroupName, elasticSanName, options)) {
      yield* page;
    }
  }
