...
export const SanTierInfo: coreClient.CompositeMapper = {
  type: {
    ...
    modelProperties: {
      ...
      minIncrementSizeTiB: {
        serializedName: "minIncrementSizeTiB",
        readOnly: true,
        type: {
          name: "Number"
        }
...
export const VolumeTierInfo: coreClient.CompositeMapper = {
  type: {
    ...
    modelProperties: {
      ...
      minIncrementSizeGiB: {
        serializedName: "minIncrementSizeGiB",
        readOnly: true,
        type: {
          name: "Number"
        }
  ...
  type: {
    ...
    modelProperties: {
      createSource: {
        ...
        type: {
          name: "Enum",
          allowedValues: ["None", "FromVolume", "FromDiskSnapshot", "Export"]
        }
      },
      sourceUri: {
