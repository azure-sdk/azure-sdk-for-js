      ...
      additionalInfo: {
        ...
        type: {
          ...
          element: {
            type: {
              name: "Composite",
              className: "ErrorAdditionalInfoAutoGenerated"
            }
          }
        }
      }
...
export const ErrorAdditionalInfoAutoGenerated: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ErrorAdditionalInfoAutoGenerated",
    modelProperties: {
...
export const ElasticSanCreateParameter: coreClient.CompositeMapper = {
  type: {
    ...
    modelProperties: {
      ...ElasticSan.type.modelProperties
    }
  }
};
