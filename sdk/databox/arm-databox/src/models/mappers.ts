...
export const CustomerInterventionStageProgress: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "CustomerInterventionStageProgress",
    modelProperties: {
      error: {
        serializedName: "error",
        type: {
...
export const CopyProgress: coreClient.CompositeMapper = {
  type: {
    ...
    className: "CopyProgress",
    modelProperties: {
      ...CustomerInterventionStageProgress.type.modelProperties,
      storageAccountName: {
