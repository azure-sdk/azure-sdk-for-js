...
**Breaking Changes**
  ...
  - Class EventHubManagementClient has a new required parameter applicationGroupOperations
  - Class EventHubManagementClient has a new required parameter networkSecurityPerimeterConfigurationOperations
  - Class EventHubManagementClient has a new required parameter networkSecurityPerimeterConfigurations
