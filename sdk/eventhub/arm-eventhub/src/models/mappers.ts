...
export const ClusterUpgradeWindow: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ClusterUpgradeWindow",
    modelProperties: {
      clusterupgradewindowproperties: {
        serializedName: "clusterupgradewindowproperties",
        type: {
          name: "Composite",
          className: "ClusterUpgradeWindowClusterupgradewindowproperties"
        }
      }
    }
  }
...
export const ClusterUpgradeWindowClusterupgradewindowproperties: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ClusterUpgradeWindowClusterupgradewindowproperties",
    modelProperties: {
      preferredstartdayofweek: {
        serializedName: "preferredstartdayofweek",
        type: {
          name: "String"
        }
      },
      preferredstarthourofday: {
        ...
        serializedName: "preferredstarthourofday",
        type: {
          name: "Number"
        }
      },
      preferredring: {
        serializedName: "preferredring",
        type: {
          name: "String"
        }
      }
...
export const ClusterUpgradeHistoryList: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ClusterUpgradeHistoryList",
    modelProperties: {
      value: {
        serializedName: "value",
        type: {
...
export const Cluster: coreClient.CompositeMapper = {
  type: {
    ...
    modelProperties: {
      ...
      clusterUpgradeList: {
        serializedName: "properties.clusterUpgradeList",
        readOnly: true,
        type: {
          name: "Sequence",
          element: {
