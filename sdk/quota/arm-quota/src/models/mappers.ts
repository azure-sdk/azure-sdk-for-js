...
export const GroupQuotaEnforcementCreateOrUpdateHeaders: coreClient.CompositeMapper =
  {
    type: {
      name: "Composite",
      className: "GroupQuotaEnforcementCreateOrUpdateHeaders",
      modelProperties: {
        retryAfter: {
          serializedName: "retry-after",
          type: {
...
export const GroupQuotaEnforcementUpdateHeaders: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "GroupQuotaEnforcementUpdateHeaders",
    modelProperties: {
      retryAfter: {
        serializedName: "retry-after",
        type: {
