...
export class GroupQuotaLimitsImpl implements GroupQuotaLimits {
  ...
  > {
    ...
    const lro = createLroSpec({
      sendOperationFn,
      args: { managementGroupId, groupQuotaName, resourceName, options },
...
const createOrUpdateOperationSpec: coreClient.OperationSpec = {
  path: "/providers/Microsoft.Management/managementGroups/{managementGroupId}/providers/Microsoft.Quota/groupQuotas/{groupQuotaName}/groupQuotaLimits/{resourceName}",
  httpMethod: "PUT",
  responses: {
    200: {
...
const listOperationSpec: coreClient.OperationSpec = {
  path: "/providers/Microsoft.Management/managementGroups/{managementGroupId}/providers/Microsoft.Quota/groupQuotas/{groupQuotaName}/groupQuotaLimits",
  httpMethod: "GET",
  responses: {
    200: {
