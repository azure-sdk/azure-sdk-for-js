...
export interface AzureBackupJob {
   ...
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly sourceDataStoreType?: string;
...
export interface AzureBackupJobProgressUrl {
...
/** Optional parameters. */
export interface JobsGenerateProgressUrlOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the generateProgressUrl operation. */
export type JobsGenerateProgressUrlResponse = AzureBackupJobProgressUrl;
