...
export interface KubernetesClusterRestoreCriteria
  ...
  /** Gets or sets the resource modifier template. This property sets the template for resource modifier during restore. */
  resourceModifierTemplate?: NamespacedNameResource;
}
