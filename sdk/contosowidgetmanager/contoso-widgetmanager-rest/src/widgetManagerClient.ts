...
export default function createClient(
  ...
  const userAgentInfo = `azsdk-js-@azure-rest/contoso-widgetmanager/1.0.0`;
  ...
  options = {
    ...
    credentials: {
      scopes: options.credentials?.scopes ?? ["https://contoso.azure.com/.default"],
    },
  };
  const client = getClient(endpointUrl, credentials, options) as WidgetManagerClient;
