...
export interface GetWidgetSecure {
    ...
    get(options?: GetWidgetSecureParameters): StreamableMethod<GetWidgetSecure200Response | GetWidgetSecureDefaultResponse>;
...
// @public
export interface GetWidgetSecure200Response extends HttpResponse {
    // (undocumented)
    body: WidgetSuiteOutput;
    // (undocumented)
    status: "200";
...
// @public (undocumented)
export interface GetWidgetSecureDefaultHeaders {
    "x-ms-error-code"?: string;
}

// @public (undocumented)
export interface GetWidgetSecureDefaultResponse extends HttpResponse {
    // (undocumented)
    body: ErrorResponse;
    // (undocumented)
    headers: RawHttpHeaders & GetWidgetSecureDefaultHeaders;
    // (undocumented)
    status: string;
}
...
// @public (undocumented)
export function isUnexpected(response: GetWidgetSecure200Response | GetWidgetSecureDefaultResponse): response is GetWidgetSecureDefaultResponse;
