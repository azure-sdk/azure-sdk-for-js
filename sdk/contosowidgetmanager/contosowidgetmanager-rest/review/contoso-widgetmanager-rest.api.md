...
export interface GetWidget2 {
    ...
    get(options?: GetWidget2Parameters): StreamableMethod<GetWidget2200Response | GetWidget2DefaultResponse>;
...
// @public
export interface GetWidget2200Response extends HttpResponse {
    // (undocumented)
    body: WidgetOutput;
    // (undocumented)
    status: "200";
...
// @public (undocumented)
export interface GetWidget2DefaultHeaders {
    "x-ms-error-code"?: string;
}

// @public (undocumented)
export interface GetWidget2DefaultResponse extends HttpResponse {
    // (undocumented)
    body: ErrorResponse;
    // (undocumented)
    headers: RawHttpHeaders & GetWidget2DefaultHeaders;
    // (undocumented)
    status: string;
}
...
// @public (undocumented)
export function isUnexpected(response: GetWidget2200Response | GetWidget2DefaultResponse): response is GetWidget2DefaultResponse;
