...
import {
  ...
  DeleteWidget2202Response,
  DeleteWidget2DefaultResponse,
...
export interface GetWidget {
  ...
  delete(
    options?: DeleteWidget2Parameters
  ): StreamableMethod<DeleteWidget2202Response | DeleteWidget2DefaultResponse>;
}
