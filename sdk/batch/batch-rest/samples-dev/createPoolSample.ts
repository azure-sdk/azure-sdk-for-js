...
/**
 * This sample demonstrates how to call operation CreatePool
 *
 * @summary call operation CreatePool
 */
async function createPoolSample() {
  ...
  const result = await client
    ...
    .post({
      body: {
          ...
          extensions: [
            {
              ...
              provisionAfterExtensions: ["{Your provisionAfterExtensions}"],
            },
          ],
          osDisk: {
        ...
        resourceTags: { key: "{Your resourceTags}" },
