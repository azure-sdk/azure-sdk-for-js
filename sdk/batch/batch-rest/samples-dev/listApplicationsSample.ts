...
/**
 * This sample demonstrates how to call operation ListApplications
 *
 * @summary call operation ListApplications
 */
async function listApplicationsSample() {
  ...
  const initialResponse = await client
    .path("/applications")
    .get({
      queryParameters: { timeOut: 123, maxresults: 123 },
      headers: {
