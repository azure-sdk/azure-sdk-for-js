...
/**
 * This sample demonstrates how to call operation GetNodeRemoteLoginSettings
 *
 * @summary call operation GetNodeRemoteLoginSettings
 */
async function getNodeRemoteLoginSettingsSample() {
...
async function main() {
  getNodeRemoteLoginSettingsSample();
}
