...
export interface JobManagerTask {
  ...
  /** The default is 1. A Task can only be scheduled to run on a compute node if the node has enough free scheduling slots available. For multi-instance Tasks, this property is not supported and must not be specified. */
...
export interface PoolSpecification {
  ...
  /** If false, at least one of targetDedicatedNodes and targetLowPriorityNodes must be specified. If true, the autoScaleFormula element is required. The Pool automatically resizes according to the formula. The default value is false. */
...
/** Defines headers for ComputeNodeExtension_get operation. */
...
/** Defines headers for ComputeNodeExtension_list operation. */
...
/** Defines headers for ComputeNodeExtension_listNext operation. */
...
/** Optional parameters. */
export interface PoolListNextOptionalParams
  extends coreClient.OperationOptions {
  /** Parameter group */
  poolListOptions?: PoolListOptions;
}
...
/** Optional parameters. */
export interface TaskListNextOptionalParams
  extends coreClient.OperationOptions {
  /** Parameter group */
  taskListOptions?: TaskListOptions;
}
...
/** Optional parameters. */
export interface ComputeNodeExtensionGetOptionalParams
  extends coreClient.OperationOptions {
  /** Parameter group */
...
/** Contains response data for the get operation. */
export type ComputeNodeExtensionGetResponse = ComputeNodeExtensionGetHeaders &
  NodeVMExtension;

/** Optional parameters. */
export interface ComputeNodeExtensionListOptionalParams
  extends coreClient.OperationOptions {
  /** Parameter group */
...
/** Contains response data for the list operation. */
export type ComputeNodeExtensionListResponse = ComputeNodeExtensionListHeaders &
  NodeVMExtensionList;

/** Optional parameters. */
export interface ComputeNodeExtensionListNextOptionalParams
  extends coreClient.OperationOptions {
  /** Parameter group */
  computeNodeExtensionListOptions?: ComputeNodeExtensionListOptions;
}
...
/** Contains response data for the listNext operation. */
export type ComputeNodeExtensionListNextResponse = ComputeNodeExtensionListNextHeaders &
  NodeVMExtensionList;
