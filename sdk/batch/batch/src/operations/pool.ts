...
export class PoolImpl implements Pool {
  ...
  updateProperties(
    ...
    return this.client.sendOperationRequest(
      { poolId, poolUpdatePropertiesParameter, options },
...
const listUsageMetricsOperationSpec: coreClient.OperationSpec = {
...
const getAllLifetimeStatisticsOperationSpec: coreClient.OperationSpec = {
...
const enableAutoScaleOperationSpec: coreClient.OperationSpec = {
...
const evaluateAutoScaleOperationSpec: coreClient.OperationSpec = {
...
const removeNodesOperationSpec: coreClient.OperationSpec = {
...
const listUsageMetricsNextOperationSpec: coreClient.OperationSpec = {
  path: "{nextLink}",
  httpMethod: "GET",
  responses: {
    200: {
