...
### Features Added
  ...
  - Added operation group NamespaceResourcesOperations
  - Added operation group NamespacesOperationGroupOperations
  - Added operation group NotificationHubResourcesOperations
  - Added operation group PrivateEndpointConnectionResourcesOperations
  - Added operation group PrivateLinkResourcesOperations
  - Added operation group SharedAccessAuthorizationRuleResourcesOperations
  ...
  - Added Interface NamespaceResourcesCheckNotificationHubAvailabilityOptionalParams
  - Added Interface NamespaceResourcesCreateOrUpdateOptionalParams
  - Added Interface NamespaceResourcesDeleteOptionalParams
  - Added Interface NamespaceResourcesGetOptionalParams
  - Added Interface NamespaceResourcesGetPnsCredentialsOptionalParams
  - Added Interface NamespaceResourcesListAllOptionalParams
  - Added Interface NamespaceResourcesListOptionalParams
  - Added Interface NamespaceResourcesUpdateOptionalParams
  - Added Interface NamespacesOperationGroupCheckAvailabilityOptionalParams
  - Added Interface NetworkAcls
  - Added Interface NotificationHubProperties
  - Added Interface NotificationHubResourcesCreateOrUpdateOptionalParams
  - Added Interface NotificationHubResourcesDebugSendOptionalParams
  - Added Interface NotificationHubResourcesDeleteOptionalParams
  - Added Interface NotificationHubResourcesGetOptionalParams
  - Added Interface NotificationHubResourcesGetPnsCredentialsOptionalParams
  - Added Interface NotificationHubResourcesListOptionalParams
  - Added Interface NotificationHubResourcesUpdateOptionalParams
  ...
  - Added Interface PrivateEndpointConnectionResourcesDeleteOptionalParams
  - Added Interface PrivateEndpointConnectionResourcesGetOptionalParams
  - Added Interface PrivateEndpointConnectionResourcesListOptionalParams
  - Added Interface PrivateEndpointConnectionResourcesUpdateOptionalParams
  - Added Interface PrivateLinkResource
  - Added Interface PrivateLinkResourceProperties
  - Added Interface PrivateLinkResourcesGetGroupIdOptionalParams
  - Added Interface PrivateLinkResourcesListGroupIdsOptionalParams
  ...
  - Added Interface SharedAccessAuthorizationRuleResourcesCreateOrUpdateAuthorizationRuleOptionalParams
  - Added Interface SharedAccessAuthorizationRuleResourcesDeleteAuthorizationRuleOptionalParams
  - Added Interface SharedAccessAuthorizationRuleResourcesGetAuthorizationRuleOptionalParams
  - Added Interface SharedAccessAuthorizationRuleResourcesListAuthorizationRulesOptionalParams
  - Added Interface SharedAccessAuthorizationRuleResourcesListKeysOptionalParams
  - Added Interface SharedAccessAuthorizationRuleResourcesRegenerateKeysOptionalParams
...
### Breaking Changes
  ...
  - Removed operation group NotificationHubs
  - Removed operation Namespaces.beginDelete
  - Removed operation Namespaces.beginDeleteAndWait
  - Removed operation Namespaces.checkAvailability
  - Removed operation Namespaces.createOrUpdate
  - Removed operation Namespaces.get
  - Removed operation Namespaces.list
  - Removed operation Namespaces.listAll
