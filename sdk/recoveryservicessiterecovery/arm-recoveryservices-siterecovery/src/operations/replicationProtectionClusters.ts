  ...
  implements ReplicationProtectionClusters
{
  ...
  > {
    ...
    const lro = createLroSpec({
      sendOperationFn,
      args: { resourceGroupName, applyClusterRecoveryPointInput, options },
  ...
  async beginFailoverCommitAndWait(
    ...
    const poller = await this.beginFailoverCommit(resourceGroupName, options);
    return poller.pollUntilDone();
  }
  ...
  getOperationResults(
    ...
    return this.client.sendOperationRequest(
      { resourceGroupName, jobId, options },
  ...
  > {
    ...
    const lro = createLroSpec({
      sendOperationFn,
      args: { resourceGroupName, failoverInput, options },
  ...
  > {
    ...
    const lro = createLroSpec({
      sendOperationFn,
      args: { resourceGroupName, cleanupInput, options },
...
const repairReplicationOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      headersMapper:
        Mappers.ReplicationProtectionClustersRepairReplicationHeaders,
    },
    201: {
      headersMapper:
        Mappers.ReplicationProtectionClustersRepairReplicationHeaders,
