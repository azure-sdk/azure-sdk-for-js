...
export interface AccessConnector extends TrackedResource {
    identity?: SystemAssignedOrUserAssignedServiceIdentity;
...
// @public
export enum KnownSystemAssignedOrUserAssignedServiceIdentityType {
    None = "None",
    SystemAssigned = "SystemAssigned",
    UserAssigned = "UserAssigned"
}
...
// @public
export interface SystemAssignedOrUserAssignedServiceIdentity {
    readonly principalId?: string;
    readonly tenantId?: string;
    type: SystemAssignedOrUserAssignedServiceIdentityType;
    userAssignedIdentities?: {
        [propertyName: string]: UserAssignedIdentity;
    };
}
...
// @public
export type SystemAssignedOrUserAssignedServiceIdentityType = string;
