...
export interface DefaultCatalogDefinition {
  /** Name of the initial default catalog of the workspace */
  initialName?: string;
...
/** Known values of {@link AutomaticClusterUpdate} that the service accepts. */
...
/**
 * Defines values for AutomaticClusterUpdate. \
 * {@link KnownAutomaticClusterUpdate} can be used interchangeably with AutomaticClusterUpdate,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Enabled** \
 * **Disabled**
...
/** Known values of {@link ComplianceSecurityProfile} that the service accepts. */
...
/**
 * Defines values for ComplianceSecurityProfile. \
 * {@link KnownComplianceSecurityProfile} can be used interchangeably with ComplianceSecurityProfile,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Enabled** \
 * **Disabled**
...
/** Known values of {@link EnhancedSecurityMonitoring} that the service accepts. */
...
/**
 * Defines values for EnhancedSecurityMonitoring. \
 * {@link KnownEnhancedSecurityMonitoring} can be used interchangeably with EnhancedSecurityMonitoring,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Enabled** \
 * **Disabled**
