...
/** Known values of {@link PrivateDbfsAccess} that the service accepts. */
...
/**
 * Defines values for PrivateDbfsAccess. \
 * {@link KnownPrivateDbfsAccess} can be used interchangeably with PrivateDbfsAccess,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Disabled** \
 * **Enabled**
