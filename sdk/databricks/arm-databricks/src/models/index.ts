...
/** Type of managed service identity (system assigned or user assigned identities - but not system assigned and user assigned identities) */
...
/** Known values of {@link SystemAssignedOrUserAssignedServiceIdentityType} that the service accepts. */
...
/**
 * Defines values for SystemAssignedOrUserAssignedServiceIdentityType. \
 * {@link KnownSystemAssignedOrUserAssignedServiceIdentityType} can be used interchangeably with SystemAssignedOrUserAssignedServiceIdentityType,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **None** \
 * **SystemAssigned** \
