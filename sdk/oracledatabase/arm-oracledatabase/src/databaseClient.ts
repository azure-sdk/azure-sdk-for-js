...
export class DatabaseClient {
  ...
  constructor(
    ...
    const userAgentPrefix = prefixFromOptions
      ...
      : `azsdk-js-client`;
    this._client = createDatabase(credential, {
      ...options,
    ...
    this.dbServers = getDbServersOperations(this._client, subscriptionId);
    this.cloudVmClusters = getCloudVmClustersOperations(
      this._client,
      subscriptionId,
    );
    ...
    this.systemVersions = getSystemVersionsOperations(
      this._client,
      subscriptionId,
    );
    this.oracleSubscriptions = getOracleSubscriptionsOperations(
      this._client,
      subscriptionId,
    );
    this.dbNodes = getDbNodesOperations(this._client, subscriptionId);
    this.giVersions = getGiVersionsOperations(this._client, subscriptionId);
    this.dbSystemShapes = getDbSystemShapesOperations(
      this._client,
      subscriptionId,
    );
    this.dnsPrivateViews = getDnsPrivateViewsOperations(
      this._client,
      subscriptionId,
    );
    this.dnsPrivateZones = getDnsPrivateZonesOperations(
      this._client,
      subscriptionId,
    );
    this.autonomousDatabases = getAutonomousDatabasesOperations(
      this._client,
      subscriptionId,
    );
