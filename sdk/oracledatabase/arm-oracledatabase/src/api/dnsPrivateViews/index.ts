      ...
      : {
          ...
          timeCreated:
            result.body.properties?.["timeCreated"] !== undefined
              ...
              : undefined,
          timeUpdated:
            result.body.properties?.["timeUpdated"] !== undefined
              ? new Date(result.body.properties?.["timeUpdated"])
              : undefined,
          ...
          : {
              ...
              timeCreated:
                p.properties?.["timeCreated"] !== undefined
                  ...
                  : undefined,
              timeUpdated:
                p.properties?.["timeUpdated"] !== undefined
                  ? new Date(p.properties?.["timeUpdated"])
                  : undefined,
