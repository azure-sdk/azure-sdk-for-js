...
export class OracleDatabaseManagementClient extends coreClient.ServiceClient {
  ...
  /**
   * Initializes a new instance of the OracleDatabaseManagementClient class.
  ...
  constructor(
    ...
    const defaults: OracleDatabaseManagementClientOptionalParams = {
      requestContentType: "application/json; charset=utf-8",
      credential: credentials,
    };

    const packageDetails = `azsdk-js-arm-oracledatabase/2.0.0-beta.1`;
    ...
    this.autonomousDatabaseNationalCharacterSets =
      new AutonomousDatabaseNationalCharacterSetsImpl(this);
    this.autonomousDatabaseVersions = new AutonomousDatabaseVersionsImpl(this);
