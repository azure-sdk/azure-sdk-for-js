...
export interface AutonomousDatabaseBackupsOperations {
    ...
    update: (resourceGroupName: string, autonomousdatabasename: string, adbbackupid: string, properties: AutonomousDatabaseBackup, options?: AutonomousDatabaseBackupsUpdateOptionalParams) => PollerLike<OperationState<AutonomousDatabaseBackup>, AutonomousDatabaseBackup>;
}
