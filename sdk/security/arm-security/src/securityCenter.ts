...
import { SecurityCenterOptionalParams, ViewOptionalParams, ViewResponse } from "./models/index.js";
...
export class SecurityCenter extends coreClient.ServiceClient {
  ...
  view(options?: ViewOptionalParams): Promise<ViewResponse> {
    return this.sendOperationRequest({ options }, viewOperationSpec);
  }
...
const viewOperationSpec: coreClient.OperationSpec = {
  path: "/providers/Microsoft.Security/view",
  httpMethod: "POST",
  responses: {
    200: {
      bodyMapper: Mappers.ScenarioResponse,
    },
    default: {
