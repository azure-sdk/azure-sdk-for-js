...
export class SecurityCenter extends coreClient.ServiceClient {
  ...
  /**
   * Run pre-defined aggregation query against Microsoft.Security data types for scopes specified in the
   * request.
  ...
  aggregations(
    ...
    options?: AggregationsOptionalParams
...
const aggregationsOperationSpec: coreClient.OperationSpec = {
  path: "/providers/Microsoft.Security/aggregations",
  httpMethod: "POST",
  responses: {
    200: {
      bodyMapper: Mappers.AggregationResponse
    },
    default: {
      bodyMapper: Mappers.ErrorResponse
    }
  },
  requestBody: Parameters.aggregations,
