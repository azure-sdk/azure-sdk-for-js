...
export interface SecurityContactPropertiesAlertNotifications {
  ...
  state?: StateForAlertNotifications;
...
export interface SecurityContactPropertiesNotificationsByRole {
  ...
  state?: StateForNotificationsByRole;
...
/** Known values of {@link StateForAlertNotifications} that the service accepts. */
export enum KnownStateForAlertNotifications {
...
/**
 * Defines values for StateForAlertNotifications. \
 * {@link KnownStateForAlertNotifications} can be used interchangeably with StateForAlertNotifications,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **On**: Get notifications on new alerts \
 * **Off**: Don't get notifications on new alerts
 */
export type StateForAlertNotifications = string;
...
/** Known values of {@link StateForNotificationsByRole} that the service accepts. */
export enum KnownStateForNotificationsByRole {
...
/**
 * Defines values for StateForNotificationsByRole. \
 * {@link KnownStateForNotificationsByRole} can be used interchangeably with StateForNotificationsByRole,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 ...
 */
export type StateForNotificationsByRole = string;
 ...
 * **Equals**: Checks that the string value of the data defined in Property equals any of the given values (exact fit)
 */
