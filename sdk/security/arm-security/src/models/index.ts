...
export interface DefenderForStorageSetting extends Resource {
  ...
  /** Indicates whether the settings defined for this resource should override the settings defined on the subscription. */
  overrideSubscriptionLevelSettings?: boolean;
  /** Indicates whether Sensitive Data Discovery should be enabled. */
  isEnabledPropertiesSensitiveDataDiscoveryIsEnabled?: boolean;
  /**
   * Optional. A status describing the success/failure of Sensitive Data Discovery's enablement/disablement operation.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly operationStatusPropertiesSensitiveDataDiscoveryOperationStatus?: OperationStatusAutoGenerated;
  /**
   * Optional. A status describing the success/failure of Malware Scanning enablement/disablement operation.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
