...
export interface TrustedIpsList {
  /**
   * Collection of trusted IPs in this page
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly value?: TrustedIps[];
  /**
   * The URI to fetch the next page
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
...
export interface TrustedIpsMetadata {
  /**
...
export interface TrustedIps extends Resource {
  /**
   * The tenantId (GUID)
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
...
/** Optional parameters. */
export interface TrustedIpsListOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the list operation. */
export type TrustedIpsListResponse = TrustedIpsList;

/** Optional parameters. */
export interface TrustedIpsGetOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the get operation. */
export type TrustedIpsGetResponse = TrustedIps;

/** Optional parameters. */
export interface TrustedIpsCreateOrUpdateOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the createOrUpdate operation. */
export type TrustedIpsCreateOrUpdateResponse = TrustedIps;

/** Optional parameters. */
export interface TrustedIpsDeleteOptionalParams
  extends coreClient.OperationOptions {}

/** Optional parameters. */
export interface TrustedIpsListNextOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the listNext operation. */
export type TrustedIpsListNextResponse = TrustedIpsList;
