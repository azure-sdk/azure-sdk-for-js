...
/** Optional parameters. */
export interface SensitivitySettingsUpdateSensitivitySettingsOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the updateSensitivitySettings operation. */
export type SensitivitySettingsUpdateSensitivitySettingsResponse = GetSensitivitySettingsResponse;

/** Optional parameters. */
export interface SensitivitySettingsGetSensitivitySettingsOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the getSensitivitySettings operation. */
export type SensitivitySettingsGetSensitivitySettingsResponse = GetSensitivitySettingsResponse;

/** Optional parameters. */
export interface SensitivitySettingsListSensitivitySettingsOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the listSensitivitySettings operation. */
export type SensitivitySettingsListSensitivitySettingsResponse = GetSensitivitySettingsListResponse;
