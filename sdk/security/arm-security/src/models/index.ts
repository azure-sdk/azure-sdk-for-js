...
/** Defines headers for ManagementGroupGovernanceRulesDeleteStatus_get operation. */
export interface ManagementGroupGovernanceRulesDeleteStatusGetHeaders {
  /** Location URL for the deletion status */
  location?: string;
}
...
/** Optional parameters. */
export interface ManagementGroupGovernanceRulesDeleteStatusGetOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the get operation. */
export type ManagementGroupGovernanceRulesDeleteStatusGetResponse = ManagementGroupGovernanceRulesDeleteStatusGetHeaders;
