...
/** Defines headers for SubscriptionGovernanceRulesOperationResult_get operation. */
export interface SubscriptionGovernanceRulesOperationResultGetHeaders {
  /** Location URL for the execution status */
  location?: string;
}

/** Defines headers for SecurityConnectorGovernanceRulesOperationResult_get operation. */
export interface SecurityConnectorGovernanceRulesOperationResultGetHeaders {
  /** Location URL for the execution status */
  location?: string;
}

/** Defines headers for ManagementGroupGovernanceRulesOperationResult_get operation. */
export interface ManagementGroupGovernanceRulesOperationResultGetHeaders {
  /** Location URL for the execution status */
  location?: string;
}
...
/** Optional parameters. */
export interface SubscriptionGovernanceRulesOperationResultGetOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the get operation. */
export type SubscriptionGovernanceRulesOperationResultGetResponse = OperationResultAutoGenerated;

/** Optional parameters. */
export interface SecurityConnectorGovernanceRulesOperationResultGetOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the get operation. */
export type SecurityConnectorGovernanceRulesOperationResultGetResponse = OperationResultAutoGenerated;

/** Optional parameters. */
export interface ManagementGroupGovernanceRulesOperationResultGetOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the get operation. */
export type ManagementGroupGovernanceRulesOperationResultGetResponse = OperationResultAutoGenerated;
