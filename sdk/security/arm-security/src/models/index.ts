...
export interface Extension {
   ...
   * Available for CloudPosture and Containers plans. <br><br>**MdeDesignatedSubscription** - VirtualMachines_P1;VirtualMachines_P2 <br><br>**AgentlessVmScanning** - CloudPosture_Default;VirtualMachines_P2;Containers_Default_Preview <br><br>**EntraPermissionsManagement** - CloudPosture_Default <br><br>**FileIntegrityMonitoring** - VirtualMachines_P2 <br><br>**ContainerSensor** - Containers_Default <br><br>**ContainerIntegrityContribution** - Containers_Default_Preview;CloudPosture_Default_Preview <br><br>**AIPromptEvidence** - AI_Default <br><br>**ApiPosture** - CloudPosture_Default_Preview <br><br>
   */
  name: string;
