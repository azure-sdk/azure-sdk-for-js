...
/** Known values of {@link AgentlessScanning} that the service accepts. */
export enum KnownAgentlessScanning {
  /** Disabled */
  Disabled = "Disabled",
  /** Enabled */
  Enabled = "Enabled",
...
/**
 * Defines values for AgentlessScanning. \
 * {@link KnownAgentlessScanning} can be used interchangeably with AgentlessScanning,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Disabled** \
 * **Enabled** \
 * **NotApplicable**
 */
export type AgentlessScanning = string;
