...
export const BenchmarkReferenceAutoGenerated: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "BenchmarkReferenceAutoGenerated",
    modelProperties: {
      benchmark: {
        serializedName: "benchmark",
        readOnly: true,
  ...
  type: {
    ...
    modelProperties: {
      ...
      lastReportedScanTime: {
        serializedName: "lastReportedScanTime",
        readOnly: true,
        type: {
          name: "DateTime",
        },
...
export const ServerVulnerabilityProperties: coreClient.CompositeMapper = {
  serializedName: "ServerVulnerability",
  type: {
    name: "Composite",
...
export let discriminators = {
  ...
  "AdditionalData.ServerVulnerability": ServerVulnerabilityProperties,
