...
export const TrustedIpsList: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "TrustedIpsList",
    modelProperties: {
      value: {
        serializedName: "value",
        readOnly: true,
...
export const TrustedIpsMetadata: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "TrustedIpsMetadata",
    modelProperties: {
      createdBy: {
        serializedName: "createdBy",
        readOnly: true,
...
export const TrustedIps: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "TrustedIps",
    modelProperties: {
