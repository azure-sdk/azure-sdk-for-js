...
export class SecurityStandardsImpl implements SecurityStandards {
  ...
  get(
    ...
    return this.client.sendOperationRequest({ scope, standardId, options }, getOperationSpec);
  }
  ...
  delete(
    ...
    return this.client.sendOperationRequest({ scope, standardId, options }, deleteOperationSpec);
  }
