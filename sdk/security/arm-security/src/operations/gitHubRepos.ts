...
export class GitHubReposImpl implements GitHubRepos {
  ...
  public list(
    ...
    const iter = this.listPagingAll(resourceGroupName, securityConnectorName, ownerName, options);
    return {
      next() {
        return iter.next();
      },
  ...
  private async *listPagingPage(
    ...
    if (!continuationToken) {
      result = await this._list(resourceGroupName, securityConnectorName, ownerName, options);
