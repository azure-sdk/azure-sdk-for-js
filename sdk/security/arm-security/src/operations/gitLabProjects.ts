...
export class GitLabProjectsImpl implements GitLabProjects {
  ...
  public list(
    ...
    const iter = this.listPagingAll(resourceGroupName, securityConnectorName, groupFQName, options);
    return {
      next() {
        return iter.next();
      },
  ...
  private async *listPagingPage(
    ...
    if (!continuationToken) {
      result = await this._list(resourceGroupName, securityConnectorName, groupFQName, options);
