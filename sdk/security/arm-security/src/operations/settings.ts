...
export class SettingsImpl implements Settings {
   ...
   */
  public list(options?: SettingsListOptionalParams): PagedAsyncIterableIterator<SettingUnion> {
   ...
   * @param options The options parameters.
   */
  private _list(options?: SettingsListOptionalParams): Promise<SettingsListResponse> {
  ...
  update(
    ...
    return this.client.sendOperationRequest({ settingName, setting, options }, updateOperationSpec);
  }
...
const getOperationSpec: coreClient.OperationSpec = {
  ...
  queryParameters: [Parameters.apiVersion23],
  urlParameters: [Parameters.$host, Parameters.subscriptionId, Parameters.settingName3],
  headerParameters: [Parameters.accept],
  serializer,
};
