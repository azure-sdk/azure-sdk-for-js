...
**Features**
  ...
  - Added Type Alias StateForAlertNotifications
  - Added Type Alias StateForNotificationsByRole
  ...
  - Added Enum KnownStateForAlertNotifications
  - Added Enum KnownStateForNotificationsByRole
