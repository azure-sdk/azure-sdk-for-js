...
## 6.0.0-beta.3 (2023-03-18)
    
**Features**

  - Added operation group Assignments
  - Added operation group Standards
  - Added Interface AssignedComponentItem
  - Added Interface AssignedStandardItem
  - Added Interface Assignment
  - Added Interface AssignmentList
  ...
  - Added Interface AssignmentsListBySubscriptionNextOptionalParams
  - Added Interface AssignmentsListBySubscriptionOptionalParams
  - Added Interface AssignmentsListNextOptionalParams
  ...
  - Added Interface StandardsListBySubscriptionNextOptionalParams
  - Added Interface StandardsListBySubscriptionOptionalParams
  - Added Interface StandardsListNextOptionalParams
  - Added Interface StandardsListOptionalParams
  - Added Interface TrackedResource
  - Added Type Alias AssignmentsCreateOrUpdateResponse
  - Added Type Alias AssignmentsGetResponse
  - Added Type Alias AssignmentsListBySubscriptionNextResponse
  - Added Type Alias AssignmentsListBySubscriptionResponse
  - Added Type Alias AssignmentsListNextResponse
  - Added Type Alias AssignmentsListResponse
  - Added Type Alias StandardsCreateOrUpdateResponse
  - Added Type Alias StandardsGetResponse
  - Added Type Alias StandardsListBySubscriptionNextResponse
  - Added Type Alias StandardsListBySubscriptionResponse
  - Added Type Alias StandardsListNextResponse
  - Added Type Alias StandardsListResponse
