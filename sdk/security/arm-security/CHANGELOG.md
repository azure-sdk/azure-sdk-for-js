...
**Features**
  ...
  - Added Interface APICollectionsCreateOptionalParams
  - Added Interface APICollectionsDeleteOptionalParams
  - Added Interface APICollectionsGetOptionalParams
  - Added Interface APICollectionsListNextOptionalParams
  - Added Interface APICollectionsListOptionalParams
  ...
  - Added Type Alias APICollectionsCreateResponse
  - Added Type Alias APICollectionsGetResponse
  - Added Type Alias APICollectionsListNextResponse
  - Added Type Alias APICollectionsListResponse
...
**Breaking Changes**
  ...
  - Interface SecurityContactList no longer has parameter nextLink
  ...
  - Type of parameter assessedResourceType of interface AdditionalData is changed from "SqlServerVulnerability" | "ContainerRegistryVulnerability" | "ServerVulnerabilityAssessment" to "SqlServerVulnerability" | "ContainerRegistryVulnerability" | "ServerVulnerability"
