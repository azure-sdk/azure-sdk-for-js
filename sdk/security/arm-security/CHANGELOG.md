...
## 6.0.0-beta.5 (2023-06-29)
    
**Features**

  - Added operation group ApplicationMappingRules
  - Added operation group ApplicationOperations
  - Added Interface Application
  - Added Interface ApplicationGetOptionalParams
  - Added Interface ApplicationList
  - Added Interface ApplicationListByRuleIdNextOptionalParams
  - Added Interface ApplicationListByRuleIdOptionalParams
  - Added Interface ApplicationListNextOptionalParams
  - Added Interface ApplicationListOptionalParams
  - Added Interface ApplicationMappingRule
  - Added Interface ApplicationMappingRuleList
  - Added Interface ApplicationMappingRuleMetaData
  - Added Interface ApplicationMappingRulesCreateOrUpdateOptionalParams
  - Added Interface ApplicationMappingRulesDeleteOptionalParams
  - Added Interface ApplicationMappingRulesGetOptionalParams
  - Added Interface ApplicationMappingRulesListNextOptionalParams
  - Added Interface ApplicationMappingRulesListOptionalParams
  - Added Interface ApplicationUpdateOptionalParams
  - Added Interface ErrorDetail
  - Added Interface ErrorResponse
  - Added Type Alias ApplicationGetResponse
  - Added Type Alias ApplicationListByRuleIdNextResponse
  - Added Type Alias ApplicationListByRuleIdResponse
  - Added Type Alias ApplicationListNextResponse
  - Added Type Alias ApplicationListResponse
  - Added Type Alias ApplicationMappingRulesCreateOrUpdateResponse
  - Added Type Alias ApplicationMappingRulesGetResponse
  - Added Type Alias ApplicationMappingRulesListNextResponse
  - Added Type Alias ApplicationMappingRulesListResponse
  - Added Type Alias ApplicationUpdateResponse
  - Added Type Alias BusinessCriticality
  - Interface SecurityCenterOptionalParams has a new optional parameter apiVersion
  - Added Enum KnownBusinessCriticality
