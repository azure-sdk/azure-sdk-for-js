...
**Features**
  ...
  - Interface ResourceDetails has a new optional parameter connectorId
  - Interface ResourceDetails has a new optional parameter id
...
**Breaking Changes**
  ...
  - Enum KnownSource no longer has value OnPremise
  - Enum KnownSource no longer has value OnPremiseSql
