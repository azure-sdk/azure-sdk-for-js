...
function _getEndpoints(context: HybridConnectivityManagementAPIContext) {
  return {
    ...
    listIngressGatewayCredentials: (
      ...
      options?: EndpointsListIngressGatewayCredentialsOptionalParams,
    ) => endpointsListIngressGatewayCredentials(context, resourceUri, endpointName, body, options),
    listCredentials: (
      resourceUri: string,
      endpointName: string,
      listCredentialsRequest: {
      ...
      endpointsListCredentials(context, resourceUri, endpointName, listCredentialsRequest, options),
