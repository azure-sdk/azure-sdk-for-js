...
import { Insights } from "../operationsInterfaces/index.js";
...
export class InsightsImpl implements Insights {
  ...
  public listBySubscription(
    ...
    return {
      ...
      byPage: (settings?: PageSettings) => {
        ...
        return this.listBySubscriptionPagingPage(workloadImpactName, options, settings);
      },
    };
  }
  ...
  private async *listBySubscriptionPagingPage(
    ...
    while (continuationToken) {
      result = await this._listBySubscriptionNext(workloadImpactName, continuationToken, options);
      continuationToken = result.nextLink;
      let page = result.value || [];
      setContinuationToken(page, continuationToken);
      yield page;
  ...
  private async *listBySubscriptionPagingAll(
    ...
    for await (const page of this.listBySubscriptionPagingPage(workloadImpactName, options)) {
      yield* page;
    }
  }
...
const listBySubscriptionOperationSpec: coreClient.OperationSpec = {
  ...
  urlParameters: [Parameters.$host, Parameters.subscriptionId, Parameters.workloadImpactName],
