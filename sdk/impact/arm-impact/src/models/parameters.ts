...
import {
  ...
  TopologyImpact as TopologyImpactMapper,
...
export const topologyImpactName: OperationURLParameter = {
  parameterPath: "topologyImpactName",
  mapper: {
    constraints: {
      Pattern: new RegExp("^[a-zA-Z0-9][a-zA-Z0-9-:]*[a-zA-Z0-9]{3,120}$"),
    },
    serializedName: "topologyImpactName",
    required: true,
    type: {
      name: "String",
    },
