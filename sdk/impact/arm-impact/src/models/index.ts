...
/** Defines headers for TopologyImpacts_create operation. */
...
export enum KnownVersions {
  /** Dec 01, 2023 Preview API Version */
 ...
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **2023-12-01-preview**: Dec 01, 2023 Preview API Version
 */
...
/** Optional parameters. */
export interface TopologyImpactsListBySubscriptionOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the listBySubscription operation. */
export type TopologyImpactsListBySubscriptionResponse =
  TopologyImpactListResult;

/** Optional parameters. */
export interface TopologyImpactsGetOptionalParams
  extends coreClient.OperationOptions {}
...
/** Optional parameters. */
export interface TopologyImpactsCreateOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Optional parameters. */
export interface TopologyImpactsDeleteOptionalParams
  extends coreClient.OperationOptions {}

/** Optional parameters. */
export interface TopologyImpactsListBySubscriptionNextOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the listBySubscriptionNext operation. */
export type TopologyImpactsListBySubscriptionNextResponse =
  TopologyImpactListResult;
