...
export interface OperationResults {
    beginGet(operationId: string, options?: OperationResultsGetOptionalParams): Promise<PollerLike<PollOperationState<void>, void>>;
    beginGetAndWait(operationId: string, options?: OperationResultsGetOptionalParams): Promise<void>;
}
...
export interface Snapshot {
    beginDownload(reportName: string, snapshotName: string, downloadType: DownloadType, options?: SnapshotDownloadOptionalParams): Promise<PollerLike<PollOperationState<SnapshotDownloadResponse>, SnapshotDownloadResponse>>;
    beginDownloadAndWait(reportName: string, snapshotName: string, downloadType: DownloadType, options?: SnapshotDownloadOptionalParams): Promise<SnapshotDownloadResponse>;
