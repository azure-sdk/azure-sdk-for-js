...
export interface AppComplianceAutomationContextOptions extends ClientOptions {
...
export default function createClient(
  credentials: TokenCredential,
  {
    ...
    ...options
  }: AppComplianceAutomationContextOptions = {},
): AppComplianceAutomationContext {
  const endpointUrl =
    options.endpoint ?? options.baseUrl ?? `https://management.azure.com`;
  const userAgentInfo = `azsdk-js-arm-appcomplianceautomation-rest/1.0.0-beta.1`;
