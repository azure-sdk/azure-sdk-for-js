...
export function isUnexpected(
  response: ReportList200Response | ReportListDefaultResponse,
): response is ReportListDefaultResponse;
export function isUnexpected(
  response:
    | ReportSyncCertRecord200Response
    | ReportSyncCertRecord202Response
...
export function isUnexpected(
  response: WebhookList200Response | WebhookListDefaultResponse,
): response is WebhookListDefaultResponse;
export function isUnexpected(
  response: SnapshotGet200Response | SnapshotGetDefaultResponse,
): response is SnapshotGetDefaultResponse;
export function isUnexpected(
  response: SnapshotList200Response | SnapshotListDefaultResponse,
): response is SnapshotListDefaultResponse;
export function isUnexpected(
  response:
    | SnapshotDownload200Response
    | SnapshotDownload202Response
...
export function isUnexpected(
  response:
    | ScopingConfigurationList200Response
    | ScopingConfigurationListDefaultResponse,
): response is ScopingConfigurationListDefaultResponse;
export function isUnexpected(
...
export function isUnexpected(
  response:
    | EvidenceListByReport200Response
    | EvidenceListByReportDefaultResponse,
): response is EvidenceListByReportDefaultResponse;
export function isUnexpected(
