...
export async function _snapshotListDeserialize(
  result: SnapshotList200Response | SnapshotListDefaultResponse,
...
export async function _snapshotDownloadDeserialize(
  ...
  const res = result as unknown as SnapshotDownloadLogicalResponse;
  return {
    resourceList:
      res.body["resourceList"] === undefined
        ? res.body["resourceList"]
        : res.body["resourceList"].map((p) => {
            return {
    ...
    complianceReport:
      res.body["complianceReport"] === undefined
        ? res.body["complianceReport"]
        : res.body["complianceReport"].map((p) => {
            return {
              categoryName: p["categoryName"],
    ...
    compliancePdfReport: !res.body.compliancePdfReport
      ? undefined
      : { sasUri: res.body.compliancePdfReport?.["sasUri"] },
    complianceDetailedPdfReport: !res.body.complianceDetailedPdfReport
      ? undefined
      : { sasUri: res.body.complianceDetailedPdfReport?.["sasUri"] },
  };
}
