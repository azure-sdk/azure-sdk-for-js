...
export function _downloadSend(
  ...
  const path = expandUrlTemplate(
    "/providers/Microsoft.AppComplianceAutomation/reports/{reportName}/evidences/{evidenceName}/download{?api%2Dversion}",
    {
...
export function _listByReportSend(
  ...
  const path = expandUrlTemplate(
    "/providers/Microsoft.AppComplianceAutomation/reports/{reportName}/evidences{?api%2Dversion,%24skipToken,%24top,%24select,%24filter,%24orderby,offerGuid,reportCreatorTenantId}",
    {
      reportName: reportName,
      "api%2Dversion": context.apiVersion,
...
export function _$deleteSend(
  ...
  const path = expandUrlTemplate(
    "/providers/Microsoft.AppComplianceAutomation/reports/{reportName}/evidences/{evidenceName}{?api%2Dversion}",
    {
      reportName: reportName,
      evidenceName: evidenceName,
      "api%2Dversion": context.apiVersion,
...
export function _createOrUpdateSend(
  ...
  const path = expandUrlTemplate(
    "/providers/Microsoft.AppComplianceAutomation/reports/{reportName}/evidences/{evidenceName}{?api%2Dversion,offerGuid,reportCreatorTenantId}",
    {
      reportName: reportName,
      evidenceName: evidenceName,
      "api%2Dversion": context.apiVersion,
