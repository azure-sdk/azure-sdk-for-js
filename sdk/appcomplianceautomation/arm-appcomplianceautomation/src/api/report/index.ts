...
export function _reportVerifySend(
  ...
  return context
    .path("/providers/Microsoft.AppComplianceAutomation/reports/{reportName}/verify", reportName)
    .post({
...
export function _reportFixSend(
  ...
  return context
    .path("/providers/Microsoft.AppComplianceAutomation/reports/{reportName}/fix", reportName)
    .post({
      ...operationOptionsToRequestParameters(options),
      headers: {
        accept: "application/json",
...
export function _reportListSend(
  ...
  return context.path("/providers/Microsoft.AppComplianceAutomation/reports").get({
    ...operationOptionsToRequestParameters(options),
    headers: {
      accept: "application/json",
      ...options.requestOptions?.headers,
...
export function _reportDeleteSend(
  ...
  return context
    .path("/providers/Microsoft.AppComplianceAutomation/reports/{reportName}", reportName)
    .delete({
      ...operationOptionsToRequestParameters(options),
      headers: {
        accept: "application/json",
