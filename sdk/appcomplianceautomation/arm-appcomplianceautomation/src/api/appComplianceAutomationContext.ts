...
export function createAppComplianceAutomation(
  ...
  const userAgentInfo = `azsdk-js-arm-appcomplianceautomation/1.0.0-beta.1`;
  ...
  const apiVersion = options.apiVersion ?? "2024-06-27";
  ...
  return { ...clientContext, apiVersion } as AppComplianceAutomationContext;
}
