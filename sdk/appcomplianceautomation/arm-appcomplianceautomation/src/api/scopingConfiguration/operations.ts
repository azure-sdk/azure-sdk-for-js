...
export function _listSend(
  ...
  const path = expandUrlTemplate(
    "/providers/Microsoft.AppComplianceAutomation/reports/{reportName}/scopingConfigurations{?api%2Dversion}",
    {
...
export function _$deleteSend(
  ...
  const path = expandUrlTemplate(
    "/providers/Microsoft.AppComplianceAutomation/reports/{reportName}/scopingConfigurations/{scopingConfigurationName}{?api%2Dversion}",
    {
      reportName: reportName,
