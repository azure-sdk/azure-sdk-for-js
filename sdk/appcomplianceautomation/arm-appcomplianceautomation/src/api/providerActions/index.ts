...
export function _providerActionsTriggerEvaluationSend(
  ...
  return context.path("/providers/Microsoft.AppComplianceAutomation/triggerEvaluation").post({
    ...operationOptionsToRequestParameters(options),
    contentType: "application/json",
    headers: {
      accept: "application/json",
...
export function _providerActionsOnboardSend(
  ...
  return context.path("/providers/Microsoft.AppComplianceAutomation/onboard").post({
    ...operationOptionsToRequestParameters(options),
    contentType: "application/json",
    headers: {
      accept: "application/json",
...
export function _providerActionsGetOverviewStatusSend(
  ...
  return context.path("/providers/Microsoft.AppComplianceAutomation/getOverviewStatus").post({
    ...operationOptionsToRequestParameters(options),
    contentType: "application/json",
    headers: {
      accept: "application/json",
...
export function _providerActionsGetCollectionCountSend(
  ...
  return context.path("/providers/Microsoft.AppComplianceAutomation/getCollectionCount").post({
    ...operationOptionsToRequestParameters(options),
    contentType: "application/json",
    headers: {
      accept: "application/json",
...
export function _providerActionsCheckNameAvailabilitySend(
  ...
  return context.path("/providers/Microsoft.AppComplianceAutomation/checkNameAvailability").post({
    ...operationOptionsToRequestParameters(options),
    contentType: "application/json",
    headers: {
      accept: "application/json",
