...
export const ReportBaseProperties: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ReportBaseProperties",
    modelProperties: {
      status: {
        serializedName: "status",
        readOnly: true,
...
export const ReportResource: coreClient.CompositeMapper = {
  type: {
    ...
    modelProperties: {
      ...
      triggerTime: {
        serializedName: "properties.triggerTime",
        required: true,
        type: {
          name: "DateTime",
        },
      ...
      offerGuid: {
        serializedName: "properties.offerGuid",
        type: {
          name: "String",
        },
      },
      nextTriggerTime: {
        serializedName: "properties.nextTriggerTime",
        readOnly: true,
        type: {
          name: "DateTime",
        },
      ...
      lastTriggerTime: {
        serializedName: "properties.lastTriggerTime",
        readOnly: true,
        type: {
          name: "DateTime",
        },
      ...
      storageInfo: {
        serializedName: "properties.storageInfo",
        type: {
          name: "Composite",
          className: "StorageInfo",
        },
      ...
      certRecords: {
        serializedName: "properties.certRecords",
        readOnly: true,
        type: {
          name: "Sequence",
          element: {
...
export const EvidenceResource: coreClient.CompositeMapper = {
  type: {
    ...
    modelProperties: {
      ...ProxyResource.type.modelProperties,
      evidenceType: {
        serializedName: "properties.evidenceType",
        type: {
          name: "String",
        },
      },
      ...
      extraData: {
        serializedName: "properties.extraData",
        type: {
          name: "String",
        },
      },
      controlId: {
        serializedName: "properties.controlId",
        type: {
          name: "String",
        },
      },
      responsibilityId: {
        serializedName: "properties.responsibilityId",
        type: {
          name: "String",
        },
      },
...
export const ScopingConfigurationResource: coreClient.CompositeMapper = {
  type: {
    ...
    modelProperties: {
      ...ProxyResource.type.modelProperties,
      answers: {
        serializedName: "properties.answers",
        type: {
          name: "Sequence",
          element: {
            type: {
...
export const SnapshotResource: coreClient.CompositeMapper = {
  type: {
    ...
    modelProperties: {
      ...ProxyResource.type.modelProperties,
      snapshotName: {
        serializedName: "properties.snapshotName",
        readOnly: true,
        type: {
          name: "String",
        },
      ...
      reportProperties: {
        serializedName: "properties.reportProperties",
        type: {
          name: "Composite",
          className: "ReportProperties",
        },
      ...
      reportSystemData: {
        serializedName: "properties.reportSystemData",
        type: {
          name: "Composite",
          className: "SystemData",
        },
      ...
      complianceResults: {
        serializedName: "properties.complianceResults",
        readOnly: true,
        type: {
          name: "Sequence",
          element: {
...
export const WebhookResource: coreClient.CompositeMapper = {
  type: {
    ...
    modelProperties: {
      ...ProxyResource.type.modelProperties,
      webhookId: {
        serializedName: "properties.webhookId",
        readOnly: true,
        type: {
          name: "String",
        },
      ...
      sendAllEvents: {
        serializedName: "properties.sendAllEvents",
        type: {
          name: "String",
        },
      },
      ...
      payloadUrl: {
        ...
        serializedName: "properties.payloadUrl",
        type: {
          name: "String",
        },
      },
      ...
      webhookKey: {
        ...
        serializedName: "properties.webhookKey",
        type: {
          name: "String",
        },
      },
      updateWebhookKey: {
        serializedName: "properties.updateWebhookKey",
        type: {
          name: "String",
        },
      },
      webhookKeyEnabled: {
        serializedName: "properties.webhookKeyEnabled",
        readOnly: true,
        type: {
          name: "String",
        },
      ...
      enableSslVerification: {
        serializedName: "properties.enableSslVerification",
        type: {
          name: "String",
        },
      },
      deliveryStatus: {
        serializedName: "properties.deliveryStatus",
        readOnly: true,
        type: {
          name: "String",
        },
...
export const ReportsCreateOrUpdateHeaders: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ReportsCreateOrUpdateHeaders",
    modelProperties: {
      retryAfter: {
        serializedName: "retry-after",
        type: {
...
export const ReportsUpdateHeaders: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ReportsUpdateHeaders",
    modelProperties: {
      location: {
        serializedName: "location",
        type: {
...
export const ReportsDeleteHeaders: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ReportsDeleteHeaders",
    modelProperties: {
      location: {
        serializedName: "location",
        type: {
...
export const ReportsFixHeaders: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ReportsFixHeaders",
    modelProperties: {
      location: {
        serializedName: "location",
        type: {
...
export const ReportsSyncCertRecordHeaders: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ReportsSyncCertRecordHeaders",
    modelProperties: {
      location: {
        serializedName: "location",
        type: {
...
export const SnapshotsDownloadHeaders: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "SnapshotsDownloadHeaders",
    modelProperties: {
      location: {
        serializedName: "location",
        type: {
