...
/** Defines headers for Reports_createOrUpdate operation. */
export interface ReportsCreateOrUpdateHeaders {
  /** The Retry-After header can indicate how long the client should wait before polling the operation status. */
  retryAfter?: number;
}

/** Defines headers for Reports_update operation. */
...
/** Defines headers for Reports_delete operation. */
...
/** Defines headers for Reports_fix operation. */
...
/** Defines headers for Reports_syncCertRecord operation. */
...
/** Defines headers for Snapshots_download operation. */
...
/** Optional parameters. */
export interface ReportsCreateOrUpdateOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Optional parameters. */
export interface ReportsUpdateOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Optional parameters. */
export interface ReportsDeleteOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Optional parameters. */
export interface ReportsNestedResourceCheckNameAvailabilityOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the nestedResourceCheckNameAvailability operation. */
export type ReportsNestedResourceCheckNameAvailabilityResponse =
  CheckNameAvailabilityResponse;
...
/** Optional parameters. */
export interface ReportsSyncCertRecordOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Optional parameters. */
export interface EvidencesListByReportOptionalParams
  extends coreClient.OperationOptions {
  /** Skip over when retrieving results. */
  skipToken?: string;
  /** Number of elements to return when retrieving results. */
...
/** Optional parameters. */
export interface EvidencesGetOptionalParams
  extends coreClient.OperationOptions {}
...
/** Optional parameters. */
export interface EvidencesCreateOrUpdateOptionalParams
  extends coreClient.OperationOptions {
  /** The offerGuid which mapping to the reports. */
  offerGuid?: string;
  /** The tenant id of the report creator. */
...
/** Optional parameters. */
export interface EvidencesDeleteOptionalParams
  extends coreClient.OperationOptions {}

/** Optional parameters. */
export interface EvidencesDownloadOptionalParams
  extends coreClient.OperationOptions {}
...
/** Optional parameters. */
export interface EvidencesListByReportNextOptionalParams
  extends coreClient.OperationOptions {}
...
/** Optional parameters. */
export interface GetScopingQuestionsOptionalParams
  extends coreClient.OperationOptions {}
...
/** Optional parameters. */
export interface ScopingConfigurationsListOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the list operation. */
export type ScopingConfigurationsListResponse =
  ScopingConfigurationResourceListResult;

/** Optional parameters. */
export interface ScopingConfigurationsListNextOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the listNext operation. */
export type ScopingConfigurationsListNextResponse =
  ScopingConfigurationResourceListResult;
...
/** Optional parameters. */
export interface SnapshotsDownloadOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Optional parameters. */
export interface WebhooksCreateOrUpdateOptionalParams
  extends coreClient.OperationOptions {}
