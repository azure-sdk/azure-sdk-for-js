...
export function getCollectionCountResponseDeserializer(
  item: any,
...
export function getOverviewStatusResponseDeserializer(
  item: any,
...
export function onboardResponseDeserializer(item: any): OnboardResponse {
  return {
...
export function triggerEvaluationResponseDeserializer(
  item: any,
): TriggerEvaluationResponse {
  return {
    properties: !item["properties"]
      ? item["properties"]
      : triggerEvaluationPropertyDeserializer(item["properties"]),
  };
}
...
export function triggerEvaluationPropertyDeserializer(
  item: any,
  ...
  return {
    ...
    evaluationEndTime: !item["evaluationEndTime"]
      ? item["evaluationEndTime"]
      : new Date(item["evaluationEndTime"]),
    resourceIds: !item["resourceIds"]
      ? item["resourceIds"]
      : item["resourceIds"].map((p: any) => {
          return p;
        }),
    quickAssessments: !item["quickAssessments"]
      ? item["quickAssessments"]
      : quickAssessmentArrayDeserializer(item["quickAssessments"]),
  };
}

export function quickAssessmentArrayDeserializer(
  result: Array<QuickAssessment>,
): any[] {
  return result.map((item) => {
    return quickAssessmentDeserializer(item);
  });
}
...
export function quickAssessmentDeserializer(item: any): QuickAssessment {
  return {
    ...
    remediationLink: item["remediationLink"],
  };
}
...
export function storageInfoArrayDeserializer(
  result: Array<StorageInfo>,
): any[] {
  return result.map((item) => {
...
export function _evidenceResourceListResultDeserializer(
  item: any,
...
export function evidenceResourceArraySerializer(
  result: Array<EvidenceResource>,
): any[] {
  return result.map((item) => {
...
export function evidenceResourceArrayDeserializer(
  result: Array<EvidenceResource>,
): any[] {
  return result.map((item) => {
...
export function evidenceFileDownloadResponseDeserializer(
  item: any,
): EvidenceFileDownloadResponse {
  return {
    evidenceFile: !item["evidenceFile"]
      ? item["evidenceFile"]
      : evidenceFileDownloadResponseEvidenceFileDeserializer(
          item["evidenceFile"],
        ),
  };
}
...
export function scopingConfigurationResourceDeserializer(
  item: any,
...
export function scopingConfigurationPropertiesSerializer(
  ...
  return {
    answers: !item["answers"]
      ? item["answers"]
      : scopingAnswerArraySerializer(item["answers"]),
  };
}
...
export function scopingConfigurationPropertiesDeserializer(
  ...
  return {
    answers: !item["answers"]
      ? item["answers"]
      : scopingAnswerArrayDeserializer(item["answers"]),
    provisioningState: item["provisioningState"],
  };
}

export function scopingAnswerArraySerializer(
  result: Array<ScopingAnswer>,
): any[] {
  return result.map((item) => {
...
export function scopingAnswerArrayDeserializer(
  result: Array<ScopingAnswer>,
): any[] {
  return result.map((item) => {
...
export function resourceMetadataArraySerializer(
  result: Array<ResourceMetadata>,
): any[] {
  return result.map((item) => {
...
export function resourceMetadataArrayDeserializer(
  result: Array<ResourceMetadata>,
): any[] {
  return result.map((item) => {
...
export function reportComplianceStatusDeserializer(
  item: any,
): ReportComplianceStatus {
  return {
    m365: !item["m365"]
      ? item["m365"]
      : overviewStatusDeserializer(item["m365"]),
  };
}
...
export function certSyncRecordArraySerializer(
  result: Array<CertSyncRecord>,
): any[] {
  return result.map((item) => {
...
export function certSyncRecordArrayDeserializer(
  result: Array<CertSyncRecord>,
): any[] {
  return result.map((item) => {
...
export function controlSyncRecordArraySerializer(
  result: Array<ControlSyncRecord>,
): any[] {
  return result.map((item) => {
...
export function controlSyncRecordArrayDeserializer(
  result: Array<ControlSyncRecord>,
): any[] {
  return result.map((item) => {
...
export function complianceResultArrayDeserializer(
  result: Array<ComplianceResult>,
): any[] {
  return result.map((item) => {
...
export function controlFamilyArrayDeserializer(
  result: Array<ControlFamily>,
): any[] {
  return result.map((item) => {
...
export function controlFamilyDeserializer(item: any): ControlFamily {
  return {
    ...
    controls: !item["controls"]
      ? item["controls"]
      : controlArrayDeserializer(item["controls"]),
  };
}
...
export function responsibilityArrayDeserializer(
  result: Array<Responsibility>,
): any[] {
  return result.map((item) => {
...
export function responsibilityResourceDeserializer(
  item: any,
...
export function recommendationArrayDeserializer(
...
export function recommendationDeserializer(item: any): Recommendation {
  return {
    ...
    recommendationSolutions: !item["recommendationSolutions"]
      ...
      : recommendationSolutionArrayDeserializer(
          item["recommendationSolutions"],
        ),
  };
}
...
export function recommendationSolutionDeserializer(
  item: any,
...
export function _snapshotResourceListResultDeserializer(
  item: any,
...
export function snapshotResourceArrayDeserializer(
  result: Array<SnapshotResource>,
): any[] {
  return result.map((item) => {
...
export function downloadResponseDeserializer(item: any): DownloadResponse {
  return {
    ...
    compliancePdfReport: !item["compliancePdfReport"]
      ...
      : downloadResponseCompliancePdfReportDeserializer(
          item["compliancePdfReport"],
        ),
...
export function resourceItemArrayDeserializer(
  result: Array<ResourceItem>,
): any[] {
  return result.map((item) => {
...
export function complianceReportItemArrayDeserializer(
  result: Array<ComplianceReportItem>,
): any[] {
  return result.map((item) => {
...
export function complianceReportItemDeserializer(
  item: any,
...
export function _webhookResourceListResultDeserializer(
  item: any,
...
export function webhookResourceArraySerializer(
  result: Array<WebhookResource>,
): any[] {
  return result.map((item) => {
...
export function webhookResourceArrayDeserializer(
  result: Array<WebhookResource>,
): any[] {
  return result.map((item) => {
...
export function _reportResourceListResultDeserializer(
  item: any,
...
export function reportResourceArraySerializer(
  result: Array<ReportResource>,
): any[] {
  return result.map((item) => {
...
export function reportResourceArrayDeserializer(
  result: Array<ReportResource>,
): any[] {
  return result.map((item) => {
...
export function syncCertRecordResponseDeserializer(
  item: any,
...
export function scopingQuestionArrayDeserializer(
  result: Array<ScopingQuestion>,
): any[] {
  return result.map((item) => {
...
export function reportVerificationResultDeserializer(
  item: any,
