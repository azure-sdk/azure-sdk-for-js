...
/** model interface _CreateOrUpdateParameterBody */
export interface _CreateOrUpdateParameterBody {
  /** Elastic External User Creation Parameters */
  body?: ExternalUserInfo;
}

export function _createOrUpdateParameterBodySerializer(item: _CreateOrUpdateParameterBody): any {
  return {
    body: !item["body"] ? item["body"] : externalUserInfoSerializer(item["body"]),
  };
}
...
/** model interface _VMCollectionUpdateParameterBody */
export interface _VMCollectionUpdateParameterBody {
  /** VM resource Id */
  body?: VMCollectionUpdate;
}

export function _vmCollectionUpdateParameterBodySerializer(
  item: _VMCollectionUpdateParameterBody,
): any {
  return {
    body: !item["body"] ? item["body"] : vmCollectionUpdateSerializer(item["body"]),
  };
}
...
/** model interface _UpgradeParameterBody */
export interface _UpgradeParameterBody {
  /** Elastic Monitor Upgrade Parameters */
  body?: ElasticMonitorUpgrade;
}

export function _upgradeParameterBodySerializer(item: _UpgradeParameterBody): any {
  return {
    body: !item["body"] ? item["body"] : elasticMonitorUpgradeSerializer(item["body"]),
  };
}
...
/** model interface _ResubscribeParameterBody */
export interface _ResubscribeParameterBody {
  /** Resubscribe Properties */
  body?: ResubscribeProperties;
}

export function _resubscribeParameterBodySerializer(item: _ResubscribeParameterBody): any {
  return {
    body: !item["body"] ? item["body"] : resubscribePropertiesSerializer(item["body"]),
  };
}
...
export interface ArmResponseElasticMonitorResource {
  /** The body type of the operation request or response. */
  body: ElasticMonitorResource;
}

export function armResponseElasticMonitorResourceDeserializer(
  item: any,
): ArmResponseElasticMonitorResource {
  return {
    body: elasticMonitorResourceDeserializer(item["body"]),
  };
}
