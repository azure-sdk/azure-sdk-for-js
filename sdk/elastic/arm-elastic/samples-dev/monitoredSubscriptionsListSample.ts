...
/**
 * This sample demonstrates how to list all the subscriptions currently being monitored by the Elastic monitor resource.
 *
 * @summary list all the subscriptions currently being monitored by the Elastic monitor resource.
 * x-ms-original-file: 2025-01-15-preview/MonitoredSubscriptions_List.json
 */
