...
export class MicrosoftStandbyPool extends coreClient.ServiceClient {
    // (undocumented)
    $host: string;
    constructor(credentials: coreAuth.TokenCredential, subscriptionId: string, options?: MicrosoftStandbyPoolOptionalParams);
    // (undocumented)
    apiVersion: string;
    // (undocumented)
...
// @public
export interface MicrosoftStandbyPoolOptionalParams extends coreClient.ServiceClientOptions {
    $host?: string;
    apiVersion?: string;
    endpoint?: string;
}
