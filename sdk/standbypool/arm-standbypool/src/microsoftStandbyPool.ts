...
import {
  OperationsImpl,
  StandbyContainerGroupPoolsImpl,
  StandbyVirtualMachinePoolsImpl,
  StandbyVirtualMachinesImpl,
} from "./operations";
import {
  Operations,
...
import { MicrosoftStandbyPoolOptionalParams } from "./models";

export class MicrosoftStandbyPool extends coreClient.ServiceClient {
  $host: string;
  apiVersion: string;
  subscriptionId: string;

  /**
   * Initializes a new instance of the MicrosoftStandbyPool class.
  ...
  constructor(
    ...
    subscriptionId: string,
    options?: MicrosoftStandbyPoolOptionalParams,
  ) {
    ...
    const defaults: MicrosoftStandbyPoolOptionalParams = {
