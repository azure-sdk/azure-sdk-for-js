...
- [API reference documentation](https://docs.microsoft.com/javascript/api/@azure/keyvault-certificates?view=azure-node-preview)
...
```javascript
const { KeyVaultClient } = require("@azure/keyvault-certificates");
