...
export function _getSettingsSend(
  ...
  return context.path("/settings").get({
...
export function _getSettingSend(
  ...
  return context.path("/settings/{setting-name}", settingName).get({
    ...operationOptionsToRequestParameters(options),
    headers: {
      accept: "application/json",
      ...options.requestOptions?.headers,
...
export function _updateSettingSend(
  ...
  return context.path("/settings/{setting-name}", settingName).patch({
    ...operationOptionsToRequestParameters(options),
...
export function _selectiveKeyRestoreOperationSend(
  ...
  return context.path("/keys/{keyName}/restore", keyName).put({
    ...operationOptionsToRequestParameters(options),
    contentType: "application/json",
    headers: {
      accept: "application/json",
...
export function _selectiveKeyRestoreStatusSend(
  ...
  return context.path("/restore/{jobId}/pending", jobId).get({
    ...operationOptionsToRequestParameters(options),
    headers: {
      accept: "application/json",
      ...options.requestOptions?.headers,
...
export function _fullRestoreOperationSend(
  ...
  return context.path("/restore").put({
    ...operationOptionsToRequestParameters(options),
    contentType: "application/json",
    headers: {
      accept: "application/json",
...
export function _preFullRestoreOperationSend(
  ...
  return context.path("/prerestore").put({
    ...operationOptionsToRequestParameters(options),
    contentType: "application/json",
    headers: {
      accept: "application/json",
...
export function _preFullBackupSend(
  ...
  return context.path("/prebackup").post({
    ...operationOptionsToRequestParameters(options),
    contentType: "application/json",
    headers: {
      accept: "application/json",
...
export function _fullBackupSend(
  ...
  return context.path("/backup").post({
    ...operationOptionsToRequestParameters(options),
    contentType: "application/json",
    headers: {
      accept: "application/json",
...
export function _fullBackupStatusSend(
  ...
  return context.path("/backup/{jobId}/pending", jobId).get({
    ...operationOptionsToRequestParameters(options),
    headers: {
      accept: "application/json",
      ...options.requestOptions?.headers,
