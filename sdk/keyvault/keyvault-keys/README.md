...
- [Source code](https://github.com/Azure/azure-sdk-for-js/tree/main/sdk/keyvault/keyvault-keys)
- [Package (NPM)](https://www.npmjs.com/package/@azure/keyvault-keys)
- [API reference documentation](https://learn.microsoft.com/javascript/api/@azure/keyvault-keys?view=azure-node-preview)
...
### Install the `@azure/keyvault-keys` package
