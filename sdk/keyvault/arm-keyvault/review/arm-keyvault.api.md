...
// @public (undocumented)
export interface ActionAutoGenerated {
    type?: KeyRotationPolicyActionType;
}
...
// @public
export interface KeyAttributesAutoGenerated {
    readonly created?: number;
    enabled?: boolean;
    expires?: number;
    exportable?: boolean;
...
// @public
export interface KeyAutoGenerated extends ResourceAutoGenerated2 {
    attributes?: KeyAttributesAutoGenerated;
    curveName?: JsonWebKeyCurveName;
    // (undocumented)
    keyOps?: JsonWebKeyOperation[];
    keySize?: number;
    ...
    readonly keyUriWithVersion?: string;
    kty?: JsonWebKeyType;
    releasePolicy?: KeyReleasePolicyAutoGenerated;
    rotationPolicy?: RotationPolicyAutoGenerated;
}
...
// @public (undocumented)
export interface KeyReleasePolicyAutoGenerated {
    contentType?: string;
    data?: Uint8Array;
}
...
// @public (undocumented)
export interface LifetimeActionAutoGenerated {
    action?: ActionAutoGenerated;
    trigger?: Trigger;
}
...
export interface ManagedHsms {
    ...
    checkMhsmNameAvailability(mhsName: CheckMhsmNameAvailabilityParameters, options?: ManagedHsmsCheckMhsmNameAvailabilityOptionalParams): Promise<ManagedHsmsCheckMhsmNameAvailabilityResponse>;
...
// @public (undocumented)
export interface RotationPolicyAutoGenerated {
    attributes?: KeyRotationPolicyAttributes;
    lifetimeActions?: LifetimeActionAutoGenerated[];
}
...
export interface Secrets {
    createOrUpdate(resourceGroupName: string, vaultName: string, secretName: string, parameters: Secret, options?: SecretsCreateOrUpdateOptionalParams): Promise<SecretsCreateOrUpdateResponse>;
...
export interface Vaults {
    beginCreateOrUpdate(resourceGroupName: string, vaultName: string, parameters: Vault, options?: VaultsCreateOrUpdateOptionalParams): Promise<SimplePollerLike<OperationState<VaultsCreateOrUpdateResponse>, VaultsCreateOrUpdateResponse>>;
    beginCreateOrUpdateAndWait(resourceGroupName: string, vaultName: string, parameters: Vault, options?: VaultsCreateOrUpdateOptionalParams): Promise<VaultsCreateOrUpdateResponse>;
    ...
    list(options?: VaultsListOptionalParams): PagedAsyncIterableIterator<ResourceAutoGenerated>;
