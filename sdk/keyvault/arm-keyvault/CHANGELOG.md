...
### Features Added
  ...
  - Added Interface NetworkSecurityPerimeterListConfigurationOptionalParams
  ...
  - Added Type Alias NetworkSecurityPerimeterListConfigurationResponse
