...
/** Known values of {@link ReasonForManagedHsm} that the service accepts. */
...
/**
 * Defines values for ReasonForManagedHsm. \
 * {@link KnownReasonForManagedHsm} can be used interchangeably with ReasonForManagedHsm,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **AccountNameInvalid** \
 * **AlreadyExists**
...
/** Defines values for ReasonForKeyVault. */
