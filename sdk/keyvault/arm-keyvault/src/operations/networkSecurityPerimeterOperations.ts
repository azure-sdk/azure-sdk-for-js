...
export class NetworkSecurityPerimeterOperationsImpl implements NetworkSecurityPerimeterOperations {
  ...
  public listConfiguration(
    ...
    const iter = this.listConfigurationPagingAll(resourceGroupName, vaultName, options);
    return {
      next() {
        return iter.next();
      },
      ...
      byPage: (settings?: PageSettings) => {
        ...
        return this.listConfigurationPagingPage(resourceGroupName, vaultName, options, settings);
      },
    };
  }
  ...
  private async *listConfigurationPagingPage(
    ...
    result = await this._listConfiguration(resourceGroupName, vaultName, options);
    yield result.value || [];
  }
