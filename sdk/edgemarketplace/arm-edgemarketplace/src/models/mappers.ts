...
export const OfferSearchRequest: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "OfferSearchRequest",
    modelProperties: {
      publisherName: {
...
export const Offer: coreClient.CompositeMapper = {
  type: {
    ...
    modelProperties: {
      ...
      contentUrl: {
        serializedName: "properties.contentUrl",
        type: {
          name: "String"
        }
      },
      offerContent: {
        serializedName: "properties.offerContent",
        type: {
          name: "Composite",
          className: "OfferContent"
        }
      ...
      marketplaceSkus: {
        serializedName: "properties.marketplaceSkus",
        type: {
          name: "Sequence",
          element: {
            type: {
...
export const OffersGetAccessTokenHeaders: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "OffersGetAccessTokenHeaders",
    modelProperties: {
      retryAfter: {
