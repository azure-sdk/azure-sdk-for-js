...
export function _listBySubscriptionSend(
  context: Client,
  options: AddressResourcesListBySubscriptionOptionalParams = {
    requestOptions: {},
  },
): StreamableMethod {
...
export function _listByResourceGroupSend(
  ...
  options: AddressResourcesListByResourceGroupOptionalParams = {
    requestOptions: {},
  },
): StreamableMethod {
  const path = expandUrlTemplate(
...
export function _$deleteSend(
  ...
  resourceGroupName: string,
  addressName: string,
  options: AddressResourcesDeleteOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
...
export function _updateSend(
  ...
  options: AddressResourcesUpdateOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EdgeOrder/addresses/{addressName}{?api%2Dversion}",
    {
...
export function _createSend(
  ...
  options: AddressResourcesCreateOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EdgeOrder/addresses/{addressName}{?api%2Dversion}",
    {
...
export function _getSend(
  ...
  resourceGroupName: string,
  addressName: string,
  options: AddressResourcesGetOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EdgeOrder/addresses/{addressName}{?api%2Dversion}",
    {
