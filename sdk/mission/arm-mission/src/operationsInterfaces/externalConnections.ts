...
export interface ExternalConnections {
  ...
  beginUpdate(
    resourceGroupName: string,
    externalConnectionName: string,
    properties: ExternalConnectionPatchResource,
  ...
  beginDelete(
    ...
    SimplePollerLike<
      OperationState<ExternalConnectionsDeleteResponse>,
      ExternalConnectionsDeleteResponse
    >
  >;
  /**
  ...
  beginDeleteAndWait(
    ...
    externalConnectionName: string,
    options?: ExternalConnectionsDeleteOptionalParams,
  ): Promise<ExternalConnectionsDeleteResponse>;
}
