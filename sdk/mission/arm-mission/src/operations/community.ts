...
import { Community } from "../operationsInterfaces/index.js";
...
import {
  CommunityResource,
  CommunityListBySubscriptionNextOptionalParams,
  CommunityListBySubscriptionOptionalParams,
  CommunityListBySubscriptionResponse,
  CommunityListByResourceGroupNextOptionalParams,
  CommunityListByResourceGroupOptionalParams,
  CommunityListByResourceGroupResponse,
  ...
  CommunityListBySubscriptionNextResponse,
  CommunityListByResourceGroupNextResponse,
} from "../models/index.js";

/// <reference lib="esnext.asynciterable" />
/** Class containing Community operations. */
export class CommunityImpl implements Community {
  private readonly client: MissionClient;

  /**
   * Initialize a new instance of the class Community class.
  ...
  ): AsyncIterableIterator<CommunityResource[]> {
    let result: CommunityListBySubscriptionResponse;
  ...
  private async *listByResourceGroupPagingPage(
    ...
    let result: CommunityListByResourceGroupResponse;
    let continuationToken = settings?.continuationToken;
    if (!continuationToken) {
  ...
  private _listBySubscription(
    options?: CommunityListBySubscriptionOptionalParams,
  ): Promise<CommunityListBySubscriptionResponse> {
  ...
  private _listByResourceGroup(
    resourceGroupName: string,
    options?: CommunityListByResourceGroupOptionalParams,
  ): Promise<CommunityListByResourceGroupResponse> {
    return this.client.sendOperationRequest(
  ...
  > {
    ...
    const lro = createLroSpec({
      sendOperationFn,
      args: { resourceGroupName, communityName, resource, options },
  ...
  async beginUpdate(
    resourceGroupName: string,
    communityName: string,
    properties: CommunityResourceUpdate,
  ...
  > {
    ...
    const lro = createLroSpec({
      sendOperationFn,
      args: { resourceGroupName, communityName, properties, options },
  ...
  > {
    ...
    const lro = createLroSpec({
      sendOperationFn,
      args: { resourceGroupName, communityName, options },
  ...
  checkAddressSpaceAvailability(
    ...
    return this.client.sendOperationRequest(
      ...
      checkAddressSpaceAvailabilityOperationSpec,
    );
  }
  ...
  private _listBySubscriptionNext(
    nextLink: string,
    options?: CommunityListBySubscriptionNextOptionalParams,
  ): Promise<CommunityListBySubscriptionNextResponse> {
    return this.client.sendOperationRequest(
      { nextLink, options },
  ...
  private _listByResourceGroupNext(
    resourceGroupName: string,
    nextLink: string,
    options?: CommunityListByResourceGroupNextOptionalParams,
  ): Promise<CommunityListByResourceGroupNextResponse> {
    return this.client.sendOperationRequest(
...
const listBySubscriptionOperationSpec: coreClient.OperationSpec = {
  path: "/subscriptions/{subscriptionId}/providers/Microsoft.Mission/communities",
  httpMethod: "GET",
  responses: {
    200: {
      bodyMapper: Mappers.CommunityResourceListResult,
    },
    default: {
...
const listByResourceGroupOperationSpec: coreClient.OperationSpec = {
  path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Mission/communities",
  httpMethod: "GET",
  responses: {
    200: {
      bodyMapper: Mappers.CommunityResourceListResult,
...
const getOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.CommunityResource,
    },
    default: {
      bodyMapper: Mappers.ErrorResponse,
    },
...
const deleteOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      headersMapper: Mappers.CommunityDeleteHeaders,
    },
    201: {
      headersMapper: Mappers.CommunityDeleteHeaders,
    },
...
const checkAddressSpaceAvailabilityOperationSpec: coreClient.OperationSpec = {
  path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Mission/communities/{communityName}/checkAddressSpaceAvailability",
  httpMethod: "POST",
  responses: {
    200: {
      bodyMapper: Mappers.CheckAddressSpaceAvailabilityResponse,
    },
    default: {
      bodyMapper: Mappers.ErrorResponse,
    },
  },
  requestBody: Parameters.checkAddressSpaceAvailabilityRequest,
  queryParameters: [Parameters.apiVersion],
  urlParameters: [
    Parameters.$host,
    Parameters.subscriptionId,
