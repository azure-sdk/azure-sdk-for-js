...
/** Community Model Resource */
export interface CommunityResourceUpdate
...
/** CommunityEndpoint Model Resource */
export interface CommunityEndpointResourceUpdate
  extends AzureResourceManagerCommonTypesTrackedResourceUpdate {
  /** Community Endpoint Rule Collection. */
  ruleCollection?: CommunityEndpointDestinationRule[];
  /** List of resource ids created by community endpoint. */
...
/** TransitHub Model Resource */
export interface TransitHubResourceUpdate
  extends AzureResourceManagerCommonTypesTrackedResourceUpdate {
  /**
   * The status of the last operation.
   * NOTE: This property will not be serialized. It can only be populated by the server.
...
/** EnclaveConnection Model Resource */
export interface EnclaveConnectionResourceUpdate
  extends AzureResourceManagerCommonTypesTrackedResourceUpdate {
  /** The state of the enclaveConnection. */
  state?: EnclaveConnectionState;
  /** Community Resource Id. */
...
/** Describes an External Connection. */
export interface ExternalConnectionUpdate
  extends AzureResourceManagerCommonTypesTrackedResourceUpdate {
  /** The state of the externalConnection. */
  state?: ExternalConnectionState;
  /** Community Resource Id. */
...
/** Describes an Internal Connection. */
export interface InternalConnectionUpdate
  extends AzureResourceManagerCommonTypesTrackedResourceUpdate {
  /**
   * Specifies the type of internal connection.
   *  Possible values are:
...
/** Virtual Enclave Model Resource */
export interface EnclaveResourceUpdate
  extends AzureResourceManagerCommonTypesTrackedResourceUpdate {
  /** The managed service identities assigned to this resource. */
  identity?: AzureResourceManagerCommonTypesManagedServiceIdentityUpdate;
  /** Virtual Network. */
...
/** EnclaveEndpoint Model Resource */
export interface EnclaveEndpointResourceUpdate
  extends AzureResourceManagerCommonTypesTrackedResourceUpdate {
  /** Enclave Endpoint Rule Collection. */
  ruleCollection?: EnclaveEndpointDestinationRule[];
  /** List of resource ids created by community endpoint. */
...
/** Endpoint Model Resource */
export interface EndpointResourceUpdate
  extends AzureResourceManagerCommonTypesTrackedResourceUpdate {
  /** Endpoint Rule Collection. */
  endpointRuleCollection?: EndpointRule[];
  /**
...
/** Workload Model Resource */
export interface WorkloadResourceUpdate
  extends AzureResourceManagerCommonTypesTrackedResourceUpdate {
  /**
   * Provisioning State.
   * NOTE: This property will not be serialized. It can only be populated by the server.
...
/** Defines headers for ExternalConnections_createOrUpdate operation. */
...
/** Defines headers for ExternalConnections_update operation. */
...
/** Defines headers for ExternalConnections_delete operation. */
...
/** Defines headers for InternalConnections_createOrUpdate operation. */
...
/** Defines headers for InternalConnections_update operation. */
...
/** Defines headers for InternalConnections_delete operation. */
...
/** Defines headers for Endpoint_update operation. */
...
/** Defines headers for Endpoint_delete operation. */
...
/** Known values of {@link ExternalConnectionState} that the service accepts. */
export enum KnownExternalConnectionState {
  /** ExternalConnectionState Type Pending */
  Pending = "Pending",
  /** ExternalConnectionState Type Approved */
  Approved = "Approved",
  /** ExternalConnectionState Type Active */
  Active = "Active",
}

/**
 * Defines values for ExternalConnectionState. \
 * {@link KnownExternalConnectionState} can be used interchangeably with ExternalConnectionState,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Pending**: ExternalConnectionState Type Pending \
 * **Approved**: ExternalConnectionState Type Approved \
 * **Active**: ExternalConnectionState Type Active
 */
export type ExternalConnectionState = string;

/** Known values of {@link InternalConnectionType} that the service accepts. */
export enum KnownInternalConnectionType {
  /** InternalConnectionType Type PrivateLink */
  PrivateLink = "PrivateLink",
  /** InternalConnectionType Type NetworkSecurityGroup. */
  NetworkSecurityGroup = "NetworkSecurityGroup",
}

/**
 * Defines values for InternalConnectionType. \
 * {@link KnownInternalConnectionType} can be used interchangeably with InternalConnectionType,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **PrivateLink**: InternalConnectionType Type PrivateLink \
 * **NetworkSecurityGroup**: InternalConnectionType Type NetworkSecurityGroup.
 */
export type InternalConnectionType = string;

/** Known values of {@link InternalConnectionState} that the service accepts. */
export enum KnownInternalConnectionState {
  /** InternalConnectionState Type Pending Approval */
  PendingApproval = "PendingApproval",
  /** InternalConnectionState Type Pending Update */
  PendingUpdate = "PendingUpdate",
  /** InternalConnectionState Type Approved */
  Approved = "Approved",
  /** InternalConnectionState Type Active */
  Active = "Active",
  /** InternalConnectionState Type Failed */
  Failed = "Failed",
}

/**
 * Defines values for InternalConnectionState. \
 * {@link KnownInternalConnectionState} can be used interchangeably with InternalConnectionState,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **PendingApproval**: InternalConnectionState Type Pending Approval \
 * **PendingUpdate**: InternalConnectionState Type Pending Update \
 * **Approved**: InternalConnectionState Type Approved \
 * **Active**: InternalConnectionState Type Active \
 * **Failed**: InternalConnectionState Type Failed
 */
...
/** Known values of {@link EndpointProtocol} that the service accepts. */
...
/** Optional parameters. */
export interface ExternalConnectionsListBySubscriptionOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the listBySubscription operation. */
export type ExternalConnectionsListBySubscriptionResponse =
  ExternalConnectionListResult;

/** Optional parameters. */
export interface ExternalConnectionsListByResourceGroupOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the listByResourceGroup operation. */
export type ExternalConnectionsListByResourceGroupResponse =
  ExternalConnectionListResult;

/** Optional parameters. */
export interface ExternalConnectionsGetOptionalParams
  extends coreClient.OperationOptions {}
...
/** Optional parameters. */
export interface ExternalConnectionsCreateOrUpdateOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Optional parameters. */
export interface ExternalConnectionsUpdateOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Optional parameters. */
export interface ExternalConnectionsDeleteOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Contains response data for the delete operation. */
export type ExternalConnectionsDeleteResponse =
  ExternalConnectionsDeleteHeaders;

/** Optional parameters. */
export interface ExternalConnectionsListBySubscriptionNextOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the listBySubscriptionNext operation. */
export type ExternalConnectionsListBySubscriptionNextResponse =
  ExternalConnectionListResult;

/** Optional parameters. */
export interface ExternalConnectionsListByResourceGroupNextOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the listByResourceGroupNext operation. */
export type ExternalConnectionsListByResourceGroupNextResponse =
  ExternalConnectionListResult;

/** Optional parameters. */
export interface InternalConnectionsListBySubscriptionOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the listBySubscription operation. */
export type InternalConnectionsListBySubscriptionResponse =
  InternalConnectionListResult;

/** Optional parameters. */
export interface InternalConnectionsListByResourceGroupOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the listByResourceGroup operation. */
export type InternalConnectionsListByResourceGroupResponse =
  InternalConnectionListResult;

/** Optional parameters. */
export interface InternalConnectionsGetOptionalParams
  extends coreClient.OperationOptions {}
...
/** Optional parameters. */
export interface InternalConnectionsCreateOrUpdateOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Optional parameters. */
export interface InternalConnectionsUpdateOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Optional parameters. */
export interface InternalConnectionsDeleteOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Contains response data for the delete operation. */
export type InternalConnectionsDeleteResponse =
  InternalConnectionsDeleteHeaders;

/** Optional parameters. */
export interface InternalConnectionsListBySubscriptionNextOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the listBySubscriptionNext operation. */
export type InternalConnectionsListBySubscriptionNextResponse =
  InternalConnectionListResult;

/** Optional parameters. */
export interface InternalConnectionsListByResourceGroupNextOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the listByResourceGroupNext operation. */
export type InternalConnectionsListByResourceGroupNextResponse =
  InternalConnectionListResult;
...
/** Optional parameters. */
export interface EndpointListBySubscriptionOptionalParams
  extends coreClient.OperationOptions {}
...
/** Optional parameters. */
export interface EndpointListByEnclaveResourceOptionalParams
  extends coreClient.OperationOptions {}
...
/** Optional parameters. */
export interface EndpointUpdateOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Optional parameters. */
export interface EndpointDeleteOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Optional parameters. */
export interface EndpointListBySubscriptionNextOptionalParams
  extends coreClient.OperationOptions {}
...
/** Optional parameters. */
export interface EndpointListByEnclaveResourceNextOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the listByEnclaveResourceNext operation. */
export type EndpointListByEnclaveResourceNextResponse =
