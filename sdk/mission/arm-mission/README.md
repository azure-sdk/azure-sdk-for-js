...
[API reference documentation](https://docs.microsoft.com/javascript/api/@azure/arm-mission?view=azure-node-preview) |
...
```javascript
const { MissionClient } = require("@azure/arm-mission");
