...
import {
  ...
  armResourceUpdatedResponseSiteDeserializer,
...
export async function _createOrUpdateDeserialize(
...
): Promise<ArmResourceUpdatedResponseSite> {
  ...
  return armResourceUpdatedResponseSiteDeserializer(result.body);
}
...
export function createOrUpdate(
  ...
  }) as PollerLike<OperationState<ArmResourceUpdatedResponseSite>, ArmResourceUpdatedResponseSite>;
}
