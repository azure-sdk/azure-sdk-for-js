...
import { Site, SiteUpdate, ArmResourceUpdatedResponseSite } from "../../models/models.js";
import {
...
export interface SitesByServiceGroupOperations {
  ...
  ) => PollerLike<OperationState<ArmResourceUpdatedResponseSite>, ArmResourceUpdatedResponseSite>;
