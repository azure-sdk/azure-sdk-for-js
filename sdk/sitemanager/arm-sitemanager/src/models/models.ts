...
/** Resource 'Site' update operation succeeded */
export interface ArmResourceUpdatedResponseSite {
  /** The body type of the operation request or response. */
  body: Site;
}

export function armResourceUpdatedResponseSiteDeserializer(
  item: any,
): ArmResourceUpdatedResponseSite {
  return {
    body: siteDeserializer(item["body"]),
  };
}
