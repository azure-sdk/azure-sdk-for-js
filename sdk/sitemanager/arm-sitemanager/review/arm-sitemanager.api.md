...
export interface SitesByServiceGroupOperations {
    createOrUpdate: (servicegroupName: string, siteName: string, resource: Site, options?: SitesByServiceGroupCreateOrUpdateOptionalParams) => PollerLike<OperationState<ArmResourceUpdatedResponseSite>, ArmResourceUpdatedResponseSite>;
