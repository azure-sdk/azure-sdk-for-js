 ...
 * **user**: If a message was generated by a human, the role should be assigned user \
 * **assistant**: If a message was generated by ARG Query Generation service, then the role should be assistant \
 * **system**: If a message provides high level instructions for the query generation, then the role should be system
 */
 ...
 * {@link KnownStatusCategory} can be used interchangeably with StatusCategory,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Succeeded**: Succeeded when query was generated successfully \
 * **Failed**: Failed when query was not generated
 */
...
/** Optional parameters. */
export interface QueryGenerateQueryOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the generateQuery operation. */
...
export type ResourcesHistoryResponse = { [propertyName: string]: any };
