...
export const VirtualDiskInventory: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "VirtualDiskInventory",
    modelProperties: {
      diskName: {
...
export const NetworkProfileInventory: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "NetworkProfileInventory",
    modelProperties: {
      networkInterfaces: {
        serializedName: "networkInterfaces",
        type: {
          ...
          element: {
            type: {
              name: "Composite",
              className: "NetworkInterfaceInventory",
            },
          },
        },
      },
...
export const NetworkInterfaceInventory: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "NetworkInterfaceInventory",
    modelProperties: {
...
export const StorageProfileInventory: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "StorageProfileInventory",
    modelProperties: {
      disks: {
        serializedName: "disks",
        type: {
