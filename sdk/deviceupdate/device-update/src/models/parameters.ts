...
import {
  ...
  LogCollection as LogCollectionMapper
} from "../models/mappers";
...
export const logCollection: OperationParameter = {
  parameterPath: "logCollection",
  mapper: LogCollectionMapper
};

export const logCollectionId: OperationURLParameter = {
  parameterPath: "logCollectionId",
  mapper: {
    constraints: {
      MaxLength: 256,
      MinLength: 1
