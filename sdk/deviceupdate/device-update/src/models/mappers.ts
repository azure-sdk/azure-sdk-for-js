...
export const LogCollection: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "LogCollection",
    modelProperties: {
      logCollectionId: {
        serializedName: "operationId",
        type: {
...
export const LogCollectionList: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "LogCollectionList",
    modelProperties: {
      value: {
        serializedName: "value",
        required: true,
...
export const DeviceClassSubgroupFilter: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "DeviceClassSubgroupFilter",
    modelProperties: {
      compatPropertyName: {
        serializedName: "compatPropertyName",
        type: {
          name: "String"
        }
      },
      compatPropertyValue: {
        serializedName: "compatPropertyValue",
        type: {
          name: "String"
        }
      }
...
export const LogCollectionDetailedStatusList: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "LogCollectionDetailedStatusList",
    modelProperties: {
      value: {
        serializedName: "value",
        required: true,
