...
export interface SqlVulnerabilityAssessmentRuleBaseline {
    ...
    delete(resourceGroupName: string, serverName: string, vulnerabilityAssessmentName: VulnerabilityAssessmentName, baselineName: BaselineName, ruleId: string, options?: SqlVulnerabilityAssessmentRuleBaselineDeleteOptionalParams): Promise<void>;
...
// @public
export interface SqlVulnerabilityAssessmentRuleBaselineDeleteOptionalParams extends coreClient.OperationOptions {
}
