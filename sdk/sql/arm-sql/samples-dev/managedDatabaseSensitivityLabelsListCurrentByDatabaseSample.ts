 ...
 */
async function getsTheCurrentSensitivityLabelsOfAGivenDatabaseInAManagedDatabase(): Promise<void> {
...
async function main(): Promise<void> {
  await getsTheCurrentSensitivityLabelsOfAGivenDatabaseInAManagedDatabase();
}
