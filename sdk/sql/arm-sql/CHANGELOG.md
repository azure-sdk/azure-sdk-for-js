...
## 11.0.0-beta.1 (2023-09-13)
    
**Features**

  - Added operation group JobPrivateEndpoints
  - Added operation group NetworkSecurityPerimeterConfigurations
  - Added operation DeletedServers.listByResourceGroup
  ...
  - Added Interface DeletedServersListByResourceGroupNextOptionalParams
  - Added Interface DeletedServersListByResourceGroupOptionalParams
  ...
  - Added Type Alias DeletedServersListByResourceGroupNextResponse
  - Added Type Alias DeletedServersListByResourceGroupResponse
  ...
  - Interface DeletedServer has a new optional parameter scheduledPurgeDate
...
**Breaking Changes**
  ...
  - Removed operation DeletedServers.beginRecover
  - Removed operation DeletedServers.beginRecoverAndWait
  - Removed operation DeletedServers.listByLocation
