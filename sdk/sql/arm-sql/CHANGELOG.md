...
**Features**
  ...
  - Enum KnownProvisioningState has a new value Registering
  - Enum KnownProvisioningState has a new value Running
  - Enum KnownProvisioningState has a new value TimedOut
  - Enum KnownProvisioningState has a new value Unknown
  - Enum KnownProvisioningState has a new value Unrecognized
