...
**Breaking Changes**
  ...
  - Class SqlManagementClient has a new required parameter databaseAdvancedThreatProtectionSettings
  - Class SqlManagementClient has a new required parameter databaseSqlVulnerabilityAssessmentBaselines
  - Class SqlManagementClient has a new required parameter databaseSqlVulnerabilityAssessmentExecuteScan
  - Class SqlManagementClient has a new required parameter databaseSqlVulnerabilityAssessmentRuleBaselines
  - Class SqlManagementClient has a new required parameter databaseSqlVulnerabilityAssessmentScanResult
  - Class SqlManagementClient has a new required parameter databaseSqlVulnerabilityAssessmentScans
  - Class SqlManagementClient has a new required parameter databaseSqlVulnerabilityAssessmentsSettings
  - Class SqlManagementClient has a new required parameter distributedAvailabilityGroups
  - Class SqlManagementClient has a new required parameter endpointCertificates
  - Class SqlManagementClient has a new required parameter iPv6FirewallRules
  - Class SqlManagementClient has a new required parameter managedDatabaseAdvancedThreatProtectionSettings
  - Class SqlManagementClient has a new required parameter managedDatabaseMoveOperations
  - Class SqlManagementClient has a new required parameter managedInstanceAdvancedThreatProtectionSettings
  - Class SqlManagementClient has a new required parameter managedInstanceDtcs
  - Class SqlManagementClient has a new required parameter managedServerDnsAliases
  - Class SqlManagementClient has a new required parameter serverAdvancedThreatProtectionSettings
  - Class SqlManagementClient has a new required parameter serverConfigurationOptions
  - Class SqlManagementClient has a new required parameter serverTrustCertificates
  - Class SqlManagementClient has a new required parameter sqlVulnerabilityAssessmentBaseline
  - Class SqlManagementClient has a new required parameter sqlVulnerabilityAssessmentBaselines
  - Class SqlManagementClient has a new required parameter sqlVulnerabilityAssessmentExecuteScan
  - Class SqlManagementClient has a new required parameter sqlVulnerabilityAssessmentRuleBaseline
  - Class SqlManagementClient has a new required parameter sqlVulnerabilityAssessmentRuleBaselines
  - Class SqlManagementClient has a new required parameter sqlVulnerabilityAssessments
  - Class SqlManagementClient has a new required parameter sqlVulnerabilityAssessmentScanResult
  - Class SqlManagementClient has a new required parameter sqlVulnerabilityAssessmentScans
  - Class SqlManagementClient has a new required parameter sqlVulnerabilityAssessmentsSettings
  - Class SqlManagementClient has a new required parameter synapseLinkWorkspaces
