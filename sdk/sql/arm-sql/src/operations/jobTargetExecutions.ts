...
export class JobTargetExecutionsImpl implements JobTargetExecutions {
  ...
  ): PagedAsyncIterableIterator<JobExecutionAutoGenerated2> {
  ...
  ): AsyncIterableIterator<JobExecutionAutoGenerated2[]> {
...
const listByStepOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.JobExecutionListResultAutoGenerated2
    },
    default: {}
  },
  queryParameters: [
...
const getOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.JobExecutionAutoGenerated2
    },
    default: {}
  },
