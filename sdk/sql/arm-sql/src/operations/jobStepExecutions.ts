...
export class JobStepExecutionsImpl implements JobStepExecutions {
  ...
  ): PagedAsyncIterableIterator<JobExecutionAutoGenerated> {
  ...
  ): AsyncIterableIterator<JobExecutionAutoGenerated[]> {
...
const listByJobExecutionOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.JobExecutionListResultAutoGenerated
    },
    default: {}
  },
  queryParameters: [
...
const getOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.JobExecutionAutoGenerated
    },
    default: {}
  },
