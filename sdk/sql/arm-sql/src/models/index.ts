...
/** Defines headers for ManagedInstances_createOrUpdate operation. */
export interface ManagedInstancesCreateOrUpdateHeaders {
  location?: string;
}

/** Defines headers for ManagedInstances_delete operation. */
export interface ManagedInstancesDeleteHeaders {
  location?: string;
}

/** Defines headers for ManagedInstances_update operation. */
export interface ManagedInstancesUpdateHeaders {
  location?: string;
}

/** Defines headers for ManagedInstances_failover operation. */
export interface ManagedInstancesFailoverHeaders {
  location?: string;
}
...
/** Defines headers for ManagedInstances_start operation. */
export interface ManagedInstancesStartHeaders {
  location?: string;
}

/** Defines headers for ManagedInstances_stop operation. */
export interface ManagedInstancesStopHeaders {
  location?: string;
}
...
/** Known values of {@link PricingModel} that the service accepts. */
