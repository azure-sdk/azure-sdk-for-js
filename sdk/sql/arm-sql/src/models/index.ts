...
export interface DeletedServer extends ProxyResource {
  ...
  readonly fullyQualifiedDomainName?: string;
  /**
   * Time at which the server data will be purged, after which server restore will no longer be possible. If this is `null`, then default behavior will be used.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
...
/** Defines headers for ManagedInstances_refreshStatus operation. */
 ...
 * {@link KnownClientClassificationSource} can be used interchangeably with ClientClassificationSource,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **None** \
 * **Native** \
...
/** Optional parameters. */
export interface DeletedServersListByResourceGroupOptionalParams
  extends coreClient.OperationOptions {}
...
/** Optional parameters. */
export interface DeletedServersListByResourceGroupNextOptionalParams
  extends coreClient.OperationOptions {}
