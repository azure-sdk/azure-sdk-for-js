...
export interface ServerUpdate {
  ...
  /** A CMK URI of the key to use for encryption. */
  keyId?: string;
  /** Whether or not IPv6 firewall rule is enabled for this server. Value is optional but if passed in, must be 'Enabled' or 'Disabled' */
...
/** Known values of {@link ServerIPv6EnabledFlag} that the service accepts. */
...
/**
 * Defines values for ServerIPv6EnabledFlag. \
 * {@link KnownServerIPv6EnabledFlag} can be used interchangeably with ServerIPv6EnabledFlag,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Enabled** \
 * **Disabled**
