...
import {
  ...
  DatabaseVulnerabilityAssessmentRuleBaselineAutoGenerated as DatabaseVulnerabilityAssessmentRuleBaselineAutoGeneratedMapper,
...
export const parameters54: OperationParameter = {
  parameterPath: "parameters",
  mapper: DatabaseVulnerabilityAssessmentRuleBaselineAutoGeneratedMapper
};
...
export const sensitivityLabelSource3: OperationURLParameter = {
  parameterPath: "sensitivityLabelSource",
  mapper: {
    defaultValue: "current",
    isConstant: true,
