...
export class RoleAssignmentScheduleRequestsImpl implements RoleAssignmentScheduleRequests {
...
const createOperationSpec: coreClient.OperationSpec = {
  ...
  urlParameters: [Parameters.$host, Parameters.scope, Parameters.roleAssignmentScheduleRequestName],
