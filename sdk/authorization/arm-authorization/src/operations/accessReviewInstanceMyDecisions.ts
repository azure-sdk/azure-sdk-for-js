...
export class AccessReviewInstanceMyDecisionsImpl
  ...
  public list(
    ...
    const iter = this.listPagingAll(scheduleDefinitionId, acid, options);
    return {
      next() {
        return iter.next();
      },
      ...
      byPage: () => {
        return this.listPagingPage(scheduleDefinitionId, acid, options);
      }
    };
  }
  ...
  private async *listPagingPage(
    ...
    let result = await this._list(scheduleDefinitionId, acid, options);
    yield result.value || [];
  ...
  private _list(
    ...
    return this.client.sendOperationRequest(
      { scheduleDefinitionId, acid, options },
      listOperationSpec
    );
  }
  ...
  private _listNext(
    ...
    return this.client.sendOperationRequest(
      { scheduleDefinitionId, acid, nextLink, options },
...
const listOperationSpec: coreClient.OperationSpec = {
  path:
    "/providers/Microsoft.Authorization/accessReviewScheduleDefinitions/{scheduleDefinitionId}/instances/{acid}/decisions",
  httpMethod: "GET",
  responses: {
    200: {
