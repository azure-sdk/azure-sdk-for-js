...
import {
  ...
  AlertOperationListForScopeOptionalParams,
  AlertOperationListForScopeResponse
} from "../models";
...
export class AlertOperationImpl implements AlertOperation {
  ...
  listForScope(
    scope: string,
    options?: AlertOperationListForScopeOptionalParams
  ): Promise<AlertOperationListForScopeResponse> {
    return this.client.sendOperationRequest(
      { scope, options },
...
const listForScopeOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.AlertOperationListResult
    },
    default: {
      bodyMapper: Mappers.CloudError
    }
