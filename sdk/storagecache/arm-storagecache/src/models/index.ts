...
export interface AutoImportJob extends TrackedResource {
   ...
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly totalBlobsImportedPropertiesStatusTotalBlobsImported?: number;
  /**
   * Rate of blob import during full scan.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly rateOfBlobImportPropertiesStatusRateOfBlobImport?: number;
  /**
   * Number of files imported during full scan.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly importedFilesPropertiesStatusImportedFiles?: number;
  /**
   * Number of directories imported during full scan.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly importedDirectoriesPropertiesStatusImportedDirectories?: number;
  /**
   * Number of symlinks imported during full scan.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly importedSymlinksPropertiesStatusImportedSymlinks?: number;
  /**
   * Number of preexisting files during full scan.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly preexistingFilesPropertiesStatusPreexistingFiles?: number;
  /**
   * Number of preexisting directories during full scan.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly preexistingDirectoriesPropertiesStatusPreexistingDirectories?: number;
  /**
   * Number of preexisting symlinks during full scan.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly preexistingSymlinksPropertiesStatusPreexistingSymlinks?: number;
  /**
   * Total errors encountered during full scan.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly totalErrorsPropertiesStatusTotalErrors?: number;
  /**
   * Total conflicts encountered during full scan.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly totalConflictsPropertiesStatusTotalConflicts?: number;
  /**
   * Number of files imported during auto import.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly importedFilesPropertiesStatusBlobSyncEventsImportedFiles?: number;
  /**
   * Number of directories imported during auto import.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly importedDirectoriesPropertiesStatusBlobSyncEventsImportedDirectories?: number;
  /**
   * Number of symlinks imported during auto import.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly importedSymlinksPropertiesStatusBlobSyncEventsImportedSymlinks?: number;
  /**
   * Number of preexisting files during auto import.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly preexistingFilesPropertiesStatusBlobSyncEventsPreexistingFiles?: number;
  /**
   * Number of preexisting directories during auto import.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly preexistingDirectoriesPropertiesStatusBlobSyncEventsPreexistingDirectories?: number;
  /**
   * Number of preexisting symlinks during auto import.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly preexistingSymlinksPropertiesStatusBlobSyncEventsPreexistingSymlinks?: number;
  /**
   * Total number of blobs imported during auto import.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly totalBlobsImportedPropertiesStatusBlobSyncEventsTotalBlobsImported?: number;
  /**
   * Rate of blob import during auto import.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly rateOfBlobImportPropertiesStatusBlobSyncEventsRateOfBlobImport?: number;
  /**
   * Total errors encountered during auto import.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly totalErrorsPropertiesStatusBlobSyncEventsTotalErrors?: number;
  /**
   * Total conflicts encountered during auto import.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly totalConflictsPropertiesStatusBlobSyncEventsTotalConflicts?: number;
  /**
...
/** Optional parameters. */
export interface AutoImportJobsDeleteOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Optional parameters. */
export interface AutoImportJobsGetOptionalParams
  extends coreClient.OperationOptions {}
...
/** Optional parameters. */
export interface AutoImportJobsCreateOrUpdateOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Optional parameters. */
export interface AutoImportJobsUpdateOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Contains response data for the listByAmlFilesystem operation. */
export type AutoImportJobsListByAmlFilesystemResponse =
...
/** Contains response data for the listByAmlFilesystemNext operation. */
export type AutoImportJobsListByAmlFilesystemNextResponse =
  AutoImportJobsListResult;
