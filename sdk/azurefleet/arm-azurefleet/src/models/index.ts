...
export interface ManagedServiceIdentityUpdate {
  ...
  userAssignedIdentities?: {
    [propertyName: string]: AzureResourceManagerFoundationsUserAssignedIdentity;
  };
}

/** A managed identity assigned by the user. */
export interface AzureResourceManagerFoundationsUserAssignedIdentity {
...
/** Optional parameters. */
export interface VirtualMachineScaleSetsListByFleetOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the listByFleet operation. */
export type VirtualMachineScaleSetsListByFleetResponse =
  VirtualMachineScaleSetListResult;

/** Optional parameters. */
export interface VirtualMachineScaleSetsListByFleetNextOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the listByFleetNext operation. */
export type VirtualMachineScaleSetsListByFleetNextResponse =
  VirtualMachineScaleSetListResult;
