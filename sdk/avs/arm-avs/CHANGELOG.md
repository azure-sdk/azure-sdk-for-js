...
**Features**
  ...
  - Added Interface ProvisionedNetworksListByPrivateCloudNextOptionalParams
  - Added Interface ProvisionedNetworksListByPrivateCloudOptionalParams
  ...
  - Added Type Alias ProvisionedNetworksListByPrivateCloudNextResponse
  - Added Type Alias ProvisionedNetworksListByPrivateCloudResponse
  ...
  - Interface Cluster has a new optional parameter displayName
  - Interface Cluster has a new optional parameter vsanDatastoreName
  - Interface ClusterUpdate has a new optional parameter displayName
  - Interface ClusterUpdate has a new optional parameter sku
  - Interface ClusterUpdate has a new optional parameter vsanDatastoreName
  ...
  - Interface ManagementCluster has a new optional parameter displayName
  ...
  - Interface PrivateCloud has a new optional parameter displayName
  - Interface PrivateCloud has a new optional parameter dnsZoneType
  - Interface PrivateCloud has a new optional parameter tags
  ...
  - Interface PrivateCloudUpdate has a new optional parameter displayName
