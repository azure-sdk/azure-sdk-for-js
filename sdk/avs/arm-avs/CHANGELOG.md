...
### Features Added
  ...
  - Added operation WorkloadNetworksOperations.createSegment
  ...
  - Added operation WorkloadNetworksOperations.listDnsService
  ...
  - Added operation WorkloadNetworksOperations.updateSegment
  ...
  - Added Interface WorkloadNetworksCreateSegmentOptionalParams
  - Added Interface WorkloadNetworkSegmentProperties
  - Added Interface WorkloadNetworksListDnsServiceOptionalParams
  - Added Interface WorkloadNetworksUpdateSegmentOptionalParams
...
### Breaking Changes
  ...
  - Type of parameter type of interface PrivateCloudIdentity is changed from ResourceIdentityType to SystemAssignedServiceIdentityType
