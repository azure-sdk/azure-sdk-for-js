...
export class AzureVMwareSolutionAPIClient {
  ...
  constructor(
    ...
    this.workloadNetworkVmGroups = _getWorkloadNetworkVmGroupsOperations(this._client);
    this.workloadNetworkVirtualMachines = _getWorkloadNetworkVirtualMachinesOperations(
      this._client,
    );
    this.workloadNetworkSegments = _getWorkloadNetworkSegmentsOperations(this._client);
    this.workloadNetworkPublicIps = _getWorkloadNetworkPublicIpsOperations(this._client);
    this.workloadNetworkPortMirroringProfiles = _getWorkloadNetworkPortMirroringProfilesOperations(
      this._client,
    );
    this.workloadNetworkGateways = _getWorkloadNetworkGatewaysOperations(this._client);
    this.workloadNetworkDnsZones = _getWorkloadNetworkDnsZonesOperations(this._client);
    this.workloadNetworkDnsServices = _getWorkloadNetworkDnsServicesOperations(this._client);
    this.workloadNetworkDhcpConfigurations = _getWorkloadNetworkDhcpConfigurationsOperations(
      this._client,
    );
