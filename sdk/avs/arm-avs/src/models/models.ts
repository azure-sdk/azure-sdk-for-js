...
export interface ArmResponseCluster {
  /** The body type of the operation request or response. */
  body: Cluster;
}

export function armResponseClusterDeserializer(item: any): ArmResponseCluster {
  return {
    body: clusterDeserializer(item["body"]),
  };
}
...
export function placementPolicyPropertiesUnionSerializer(
  ...
  switch (item.type) {
    case "VmVm":
      return vmVmPlacementPolicyPropertiesSerializer(item as VmVmPlacementPolicyProperties);
...
export function placementPolicyPropertiesUnionDeserializer(
  ...
  switch (item.type) {
    case "VmVm":
      return vmVmPlacementPolicyPropertiesDeserializer(item as VmVmPlacementPolicyProperties);
...
export function vmVmPlacementPolicyPropertiesSerializer(item: VmVmPlacementPolicyProperties): any {
  return {
    type: item["type"],
    state: item["state"],
    displayName: item["displayName"],
...
/** Azure operation completed successfully. */
export interface ArmResponsePrivateCloud {
  /** The body type of the operation request or response. */
  body: PrivateCloud;
}

export function armResponsePrivateCloudDeserializer(item: any): ArmResponsePrivateCloud {
  return {
    body: privateCloudDeserializer(item["body"]),
  };
}
