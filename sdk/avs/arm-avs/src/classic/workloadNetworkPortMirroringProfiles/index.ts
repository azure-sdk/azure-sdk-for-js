...
function _getWorkloadNetworkPortMirroringProfiles(context: AzureVMwareSolutionAPIContext) {
  return {
    delete: (
      resourceGroupName: string,
      portMirroringId: string,
      privateCloudName: string,
      options?: WorkloadNetworkPortMirroringProfilesDeleteOptionalParams,
    ) => $delete(context, resourceGroupName, portMirroringId, privateCloudName, options),
    update: (
      resourceGroupName: string,
      privateCloudName: string,
      portMirroringId: string,
    ...
    get: (
      ...
      portMirroringId: string,
      options?: WorkloadNetworkPortMirroringProfilesGetOptionalParams,
    ) => get(context, resourceGroupName, privateCloudName, portMirroringId, options),
    list: (
      resourceGroupName: string,
      privateCloudName: string,
      options?: WorkloadNetworkPortMirroringProfilesListOptionalParams,
