...
function _getWorkloadNetworkDhcpConfigurations(context: AzureVMwareSolutionAPIContext) {
  return {
    delete: (
      resourceGroupName: string,
      privateCloudName: string,
    ...
    update: (
      ...
      workloadNetworkDhcp: WorkloadNetworkDhcp,
      options?: WorkloadNetworkDhcpConfigurationsUpdateOptionalParams,
    ) => update(context, resourceGroupName, privateCloudName, dhcpId, workloadNetworkDhcp, options),
    create: (
      resourceGroupName: string,
      privateCloudName: string,
      dhcpId: string,
      workloadNetworkDhcp: WorkloadNetworkDhcp,
      options?: WorkloadNetworkDhcpConfigurationsCreateOptionalParams,
    ) => create(context, resourceGroupName, privateCloudName, dhcpId, workloadNetworkDhcp, options),
    get: (
      resourceGroupName: string,
      dhcpId: string,
      privateCloudName: string,
