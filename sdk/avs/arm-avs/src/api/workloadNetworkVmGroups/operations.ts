...
export function $delete(
  ...
  return getLongRunningPoller(context, _$deleteDeserialize, ["200", "202", "204"], {
    ...
    getInitialResponse: () =>
      _$deleteSend(context, resourceGroupName, vmGroupId, privateCloudName, options),
...
export async function get(
  ...
  const result = await _getSend(context, resourceGroupName, privateCloudName, vmGroupId, options);
