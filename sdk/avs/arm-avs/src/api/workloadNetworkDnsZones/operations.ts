...
export function $delete(
  ...
  return getLongRunningPoller(context, _$deleteDeserialize, ["200", "202", "204"], {
    ...
    getInitialResponse: () =>
      _$deleteSend(context, resourceGroupName, dnsZoneId, privateCloudName, options),
...
export async function get(
  ...
  const result = await _getSend(context, resourceGroupName, privateCloudName, dnsZoneId, options);
