...
export function _deleteVMGroupSend(
  ...
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}/workloadNetworks/default/vmGroups/{vmGroupId}/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/{vmGroupId}/{privateCloudName}{?api%2Dversion}",
    {
...
export function listVMGroups(
  ...
  return buildPagedAsyncIterator(
    context,
    () =>
      _listVMGroupsSend(context, resourceGroupName, privateCloudName, workloadNetworkName, options),
...
export function _deletePublicIPSend(
  ...
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}/workloadNetworks/default/publicIPs/{publicIPId}/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/{publicIPId}/{privateCloudName}{?api%2Dversion}",
    {
      subscriptionId: context.subscriptionId,
      resourceGroupName: resourceGroupName,
...
export function _deletePortMirroringSend(
  ...
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}/workloadNetworks/default/portMirroringProfiles/{portMirroringId}/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/{portMirroringId}/{privateCloudName}{?api%2Dversion}",
    {
      subscriptionId: context.subscriptionId,
      resourceGroupName: resourceGroupName,
...
export function _deleteDnsZoneSend(
  ...
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}/workloadNetworks/default/dnsZones/{dnsZoneId}/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/{dnsZoneId}/{privateCloudName}{?api%2Dversion}",
    {
      subscriptionId: context.subscriptionId,
      resourceGroupName: resourceGroupName,
      dnsZoneId: dnsZoneId,
...
export function _deleteDnsServiceSend(
  ...
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}/workloadNetworks/default/dnsServices/{dnsServiceId}/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/{dnsServiceId}/{privateCloudName}{?api%2Dversion}",
    {
      subscriptionId: context.subscriptionId,
      resourceGroupName: resourceGroupName,
...
export function _getDhcpSend(
  ...
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}/workloadNetworks/default/dhcpConfigurations/{dhcpId}/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/{dhcpId}/{privateCloudName}{?api%2Dversion}",
    {
      subscriptionId: context.subscriptionId,
      resourceGroupName: resourceGroupName,
      dhcpId: dhcpId,
