...
import {
  ...
  ArmResponseCluster,
  armResponseClusterDeserializer,
  ClusterZoneList,
...
export async function _updateDeserialize(result: PathUncheckedResponse): Promise<Cluster> {
  ...
  return armResponseClusterDeserializer(result.body);
}
...
export function update(
  ...
  clusterUpdate: ClusterUpdate,
  options: ClustersUpdateOptionalParams = { requestOptions: {} },
): PollerLike<OperationState<ArmResponseCluster>, ArmResponseCluster> {
  return getLongRunningPoller(context, _updateDeserialize, ["200", "201"], {
    ...
    resourceLocationConfig: "location",
  }) as PollerLike<OperationState<ArmResponseCluster>, ArmResponseCluster>;
}
