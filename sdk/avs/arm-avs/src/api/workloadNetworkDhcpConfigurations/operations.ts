...
export function $delete(
  ...
  return getLongRunningPoller(context, _$deleteDeserialize, ["200", "202", "204"], {
    ...
    getInitialResponse: () =>
      _$deleteSend(context, resourceGroupName, privateCloudName, dhcpId, options),
...
export async function _getDeserialize(result: PathUncheckedResponse): Promise<WorkloadNetworkDhcp> {
...
export async function get(
  ...
  const result = await _getSend(context, resourceGroupName, dhcpId, privateCloudName, options);
