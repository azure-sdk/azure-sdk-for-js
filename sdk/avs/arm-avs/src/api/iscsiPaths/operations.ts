...
export function _$deleteSend(
  ...
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}/iscsiPaths/{iscsiPathName}{?api%2Dversion}",
    {
      subscriptionId: context.subscriptionId,
      resourceGroupName: resourceGroupName,
      privateCloudName: privateCloudName,
      iscsiPathName: iscsiPathName,
...
export function $delete(
  ...
  return getLongRunningPoller(context, _$deleteDeserialize, ["200", "202", "204"], {
    ...
    getInitialResponse: () =>
      _$deleteSend(context, resourceGroupName, privateCloudName, iscsiPathName, options),
