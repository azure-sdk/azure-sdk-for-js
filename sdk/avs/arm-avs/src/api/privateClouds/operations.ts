...
import {
  ...
  armResponsePrivateCloudDeserializer,
  AdminCredentials,
...
export async function _updateDeserialize(result: PathUncheckedResponse): Promise<PrivateCloud> {
  ...
  return armResponsePrivateCloudDeserializer(result.body);
}
...
export function update(
  ...
  privateCloudUpdate: PrivateCloudUpdate,
  options: PrivateCloudsUpdateOptionalParams = { requestOptions: {} },
): PollerLike<OperationState<ArmResponsePrivateCloud>, ArmResponsePrivateCloud> {
  return getLongRunningPoller(context, _updateDeserialize, ["200", "201"], {
    ...
    resourceLocationConfig: "location",
  }) as PollerLike<OperationState<ArmResponsePrivateCloud>, ArmResponsePrivateCloud>;
}
