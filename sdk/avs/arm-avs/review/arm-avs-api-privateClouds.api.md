...
// @public
export function update(context: AzureVMwareSolutionAPIContext, resourceGroupName: string, privateCloudName: string, privateCloudUpdate: PrivateCloudUpdate, options?: PrivateCloudsUpdateOptionalParams): Promise<PrivateCloud>;
