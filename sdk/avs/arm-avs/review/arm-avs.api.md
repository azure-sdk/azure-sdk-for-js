...
export class AzureVMwareSolutionAPIForTesting extends coreClient.ServiceClient {
    // (undocumented)
    $host: string;
    constructor(credentials: coreAuth.TokenCredential, subscriptionId: string, options?: AzureVMwareSolutionAPIForTestingOptionalParams);
    // (undocumented)
    addons: Addons;
    // (undocumented)
    apiVersion: string;
...
// @public
export interface AzureVMwareSolutionAPIForTestingOptionalParams extends coreClient.ServiceClientOptions {
    $host?: string;
    apiVersion?: string;
    endpoint?: string;
}
