...
export interface WorkloadNetworksOperations {
    ...
    listDnsService: (resourceGroupName: string, privateCloudName: string, workloadNetworkName: string, options?: WorkloadNetworksListDnsServiceOptionalParams) => PagedAsyncIterableIterator<WorkloadNetworkDnsService>;
