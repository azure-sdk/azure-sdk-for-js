...
export class AzureVMwareSolutionAPITest extends coreClient.ServiceClient {
    // (undocumented)
    $host: string;
    constructor(credentials: coreAuth.TokenCredential, subscriptionId: string, options?: AzureVMwareSolutionAPITestOptionalParams);
    // (undocumented)
    addons: Addons;
    // (undocumented)
    apiVersion: string;
...
// @public
export interface AzureVMwareSolutionAPITestOptionalParams extends coreClient.ServiceClientOptions {
    $host?: string;
    apiVersion?: string;
    endpoint?: string;
}
