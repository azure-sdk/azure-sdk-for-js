...
import {
  ...
  ImageBatchOperationsBatchAnalyzeImageParameters,
  ImageBatchOperationsGetBatchTaskStatusParameters,
  ImageBatchOperationsListBatchTasksParameters,
...
import {
  ...
  ImageBatchOperationsBatchAnalyzeImageDefaultResponse,
  ImageBatchOperationsGetBatchTaskStatus200Response,
  ImageBatchOperationsGetBatchTaskStatusDefaultResponse,
  ImageBatchOperationsListBatchTasks200Response,
...
export interface ImageBatchOperationsBatchAnalyzeImage {
  /** An asynchronous API for the batch analysis of potentially harmful image content. Currently, it supports four categories: Hate, SelfHarm, Sexual, and Violence. */
  put(
    options: ImageBatchOperationsBatchAnalyzeImageParameters,
  ): StreamableMethod<
    | ImageBatchOperationsBatchAnalyzeImage200Response
    | ImageBatchOperationsBatchAnalyzeImageDefaultResponse
  >;
  /** Check the status of a batch image analysis task. */
  get(
    options?: ImageBatchOperationsGetBatchTaskStatusParameters,
  ): StreamableMethod<
    | ImageBatchOperationsGetBatchTaskStatus200Response
    | ImageBatchOperationsGetBatchTaskStatusDefaultResponse
  >;
...
export interface ImageBatchOperationsListBatchTasks {
  /** List all batch image analysis tasks. */
  get(
    options?: ImageBatchOperationsListBatchTasksParameters,
  ): StreamableMethod<
    | ImageBatchOperationsListBatchTasks200Response
    | ImageBatchOperationsListBatchTasksDefaultResponse
  >;
...
export interface Routes {
  ...
  /** Resource for '/image/batchAnalyses/\{operationId\}' has methods for the following verbs: put, get */
  (
    path: "/image/batchAnalyses/{operationId}",
    operationId: string,
  ): ImageBatchOperationsBatchAnalyzeImage;
  /** Resource for '/image/batchAnalyses' has methods for the following verbs: get */
