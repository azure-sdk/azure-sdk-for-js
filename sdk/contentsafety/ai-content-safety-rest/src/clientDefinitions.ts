...
import {
  ...
  ImageOperationsDetectWatermarkParameters,
  ...
  AutoReviewerOperationsGetLongRunningOperationParameters,
...
import {
  ...
  ImageOperationsDetectWatermark200Response,
  ImageOperationsDetectWatermarkDefaultResponse,
  ...
  AutoReviewerOperationsGetLongRunningOperation200Response,
  AutoReviewerOperationsGetLongRunningOperationDefaultResponse,
...
export interface ImageOperationsDetectWatermark {
  /** A synchronous API for decoding the content credentials from assets. */
  post(
    options: ImageOperationsDetectWatermarkParameters,
  ): StreamableMethod<
    | ImageOperationsDetectWatermark200Response
    | ImageOperationsDetectWatermarkDefaultResponse
  >;
...
export interface AutoReviewerOperationsGetLongRunningOperation {
  /** Get details of an Auto Reviewer operation. */
  get(
    options?: AutoReviewerOperationsGetLongRunningOperationParameters,
  ): StreamableMethod<
    | AutoReviewerOperationsGetLongRunningOperation200Response
    | AutoReviewerOperationsGetLongRunningOperationDefaultResponse
  >;
...
export interface Routes {
  ...
  /** Resource for '/image:detectWatermark' has methods for the following verbs: post */
  (path: "/image:detectWatermark"): ImageOperationsDetectWatermark;
  ...
  (
    ...
    operationId: string,
  ): AutoReviewerOperationsGetLongRunningOperation;
