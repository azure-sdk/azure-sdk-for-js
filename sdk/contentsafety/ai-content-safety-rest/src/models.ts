...
/** The request of detecting content credential in the given image. */
export interface DetectImageContentCredentialOptions {
  /** The image to be analyzed. */
  image: ContentCredentialImageData;
}

/** The image to be analyzed. */
export interface ContentCredentialImageData {
  /** The Base64 encoding of the image. */
  content: string;
}
