...
const responseMap: Record<string, string[]> = {
  ...
  "PUT /image/batchAnalyses/{operationId}": ["200"],
  "GET /image/batchAnalyses/{operationId}": ["200"],
  "GET /image/batchAnalyses": ["200"],
...
export function isUnexpected(
  response:
    | ImageBatchOperationsBatchAnalyzeImage200Response
    | ImageBatchOperationsBatchAnalyzeImageDefaultResponse,
): response is ImageBatchOperationsBatchAnalyzeImageDefaultResponse;
export function isUnexpected(
  response:
    | ImageBatchOperationsGetBatchTaskStatus200Response
    | ImageBatchOperationsGetBatchTaskStatusDefaultResponse,
): response is ImageBatchOperationsGetBatchTaskStatusDefaultResponse;
export function isUnexpected(
  response:
    | ImageBatchOperationsListBatchTasks200Response
    | ImageBatchOperationsListBatchTasksDefaultResponse,
): response is ImageBatchOperationsListBatchTasksDefaultResponse;
export function isUnexpected(
  response:
    | TextIncidentsGetIncidents200Response
    | TextIncidentsGetIncidentsDefaultResponse,
