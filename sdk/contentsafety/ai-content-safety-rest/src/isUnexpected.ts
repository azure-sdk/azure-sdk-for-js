...
const responseMap: Record<string, string[]> = {
  ...
  "POST /image:detectWatermark": ["200"],
...
export function isUnexpected(
  response:
    | ImageOperationsDetectWatermark200Response
    | ImageOperationsDetectWatermarkDefaultResponse,
): response is ImageOperationsDetectWatermarkDefaultResponse;
export function isUnexpected(
  response:
    | TextOperationsAnalyzeText200Response
    | TextOperationsAnalyzeTextDefaultResponse,
...
export function isUnexpected(
  response:
    | AutoReviewerOperationsGetLongRunningOperation200Response
    | AutoReviewerOperationsGetLongRunningOperationDefaultResponse,
): response is AutoReviewerOperationsGetLongRunningOperationDefaultResponse;
export function isUnexpected(
  response:
    | AutoReviewerOperationsListAutoReviewers200Response
    | AutoReviewerOperationsListAutoReviewersDefaultResponse,
