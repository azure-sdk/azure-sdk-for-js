...
export interface ImageOperationsDetectWatermarkBodyParam {
  /** The image to be decoded, which is in base64 string format. */
  body: DecodeImageCredentialOptions;
}

export type ImageOperationsDetectWatermarkParameters =
  ImageOperationsDetectWatermarkBodyParam & RequestParameters;
...
export type AutoReviewerOperationsCreateOrReplaceAutoReviewerParameters =
  AutoReviewerOperationsCreateOrReplaceAutoReviewerHeaderParam &
    ...
    RequestParameters;
export type AutoReviewerOperationsGetLongRunningOperationParameters =
  RequestParameters;
