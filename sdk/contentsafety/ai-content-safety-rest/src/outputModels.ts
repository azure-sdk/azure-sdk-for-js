...
/** Image batch analyze task. */
export interface ImageBatchTaskDetailOutput {
  /** The id of image batch analysis task. */
  id: string;
  /** The kind of operation. */
  kind: string;
  /**
   * The status of the batch image analysis task.
   *
  ...
  /** Return error detail when the task failed. */
  error?: ErrorModel;
}

/** Image batch task result. */
export interface ImageBatchTaskResultOutput {
  /** The timestamp of when batch image analysis task was created. */
  createdTime: string;
  /** The progress of the batch image analysis task, represented as a percentage (0-100). */
...
/** The response of ungroundedness detection. */
export interface DetectUngroundednessResultOutput {
  /** Detection result for ungrounded text. */
  ungrounded: boolean;
  /** Confidence score of the model in the analysis results. */
  confidenceScore: number;
  /** Percentage of ungrounded Text. */
  ungroundedPercentage: number;
  /** The detailed information about a text identified as ungrounded. */
...
/** Paged collection of ImageBatchTaskDetail items */
