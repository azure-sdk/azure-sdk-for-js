...
/** The detection results of content credential. */
export interface DetectImageContentCredentialResultOutput {
  /** Analysis result for the given image. */
  contentCredentialAnalysis: ImageContentCredentialAnalysisResultOutput;
}

/** The detection result of content credential. */
export interface ImageContentCredentialAnalysisResultOutput {
