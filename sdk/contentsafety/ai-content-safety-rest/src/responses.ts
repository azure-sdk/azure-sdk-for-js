...
import {
  ...
  DecodeImageCredentialResultOutput,
...
/** The request has succeeded. */
export interface ImageOperationsDetectWatermark200Response
  extends HttpResponse {
  status: "200";
  body: DecodeImageCredentialResultOutput;
}

export interface ImageOperationsDetectWatermarkDefaultHeaders {
  /** String error code indicating what went wrong. */
  "x-ms-error-code"?: string;
}

export interface ImageOperationsDetectWatermarkDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponse;
  headers: RawHttpHeaders & ImageOperationsDetectWatermarkDefaultHeaders;
}
...
/** The request has succeeded. */
export interface AutoReviewerOperationsGetLongRunningOperation200Response
  extends HttpResponse {
  status: "200";
  body: AutoReviewerOperationDetailOutput;
}

export interface AutoReviewerOperationsGetLongRunningOperationDefaultHeaders {
  /** String error code indicating what went wrong. */
  "x-ms-error-code"?: string;
}

export interface AutoReviewerOperationsGetLongRunningOperationDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponse;
  headers: RawHttpHeaders &
    AutoReviewerOperationsGetLongRunningOperationDefaultHeaders;
}
