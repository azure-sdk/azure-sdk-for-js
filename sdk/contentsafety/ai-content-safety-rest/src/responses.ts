...
/** The request has succeeded. */
export interface ImageBatchOperationsBatchAnalyzeImage200Response
  extends HttpResponse {
  status: "200";
...
export interface ImageBatchOperationsBatchAnalyzeImageDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponse;
...
/** The request has succeeded. */
export interface ImageBatchOperationsGetBatchTaskStatus200Response
  extends HttpResponse {
  status: "200";
  body: ImageBatchTaskDetailOutput;
}
...
export interface ImageBatchOperationsGetBatchTaskStatusDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponse;
  headers: RawHttpHeaders &
    ImageBatchOperationsGetBatchTaskStatusDefaultHeaders;
}

/** The request has succeeded. */
export interface ImageBatchOperationsListBatchTasks200Response
  extends HttpResponse {
  status: "200";
...
export interface ImageBatchOperationsListBatchTasksDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponse;
