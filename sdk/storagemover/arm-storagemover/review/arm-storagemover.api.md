...
// @public
export interface AzureStorageFileShareEndpointBaseProperties {
    fileShareName: string;
    storageAccountResourceId: string;
}

// @public
export interface AzureStorageSmbFileShareEndpointProperties extends EndpointBaseProperties, AzureStorageFileShareEndpointBaseProperties {
