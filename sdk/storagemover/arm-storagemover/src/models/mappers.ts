...
export const AzureStorageFileShareEndpointBaseProperties: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "AzureStorageFileShareEndpointBaseProperties",
    modelProperties: {
...
export const AzureStorageSmbFileShareEndpointProperties: coreClient.CompositeMapper = {
  ...
  type: {
    ...
    modelProperties: {
      ...EndpointBaseProperties.type.modelProperties,
      ...AzureStorageFileShareEndpointBaseProperties.type.modelProperties
    }
  }
};
