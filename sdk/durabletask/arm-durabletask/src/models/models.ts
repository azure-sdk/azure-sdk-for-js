...
export function taskHubSerializer(item: TaskHub): Record<string, unknown> {
  return {
...
export function taskHubPropertiesSerializer(item: TaskHubProperties) {
  return item as any;
}
...
export function schedulerSerializer(item: Scheduler): Record<string, unknown> {
  return {
    tags: !item.tags ? item.tags : (serializeRecord(item.tags as any) as any),
    location: item["location"],
    properties: !item.properties
...
export function schedulerPropertiesSerializer(
  item: SchedulerProperties,
): Record<string, unknown> {
  return {
...
export function schedulerSkuSerializer(
  item: SchedulerSku,
): Record<string, unknown> {
  return {
    name: item["name"],
...
/** API Versions */
export type Versions = "2024-10-01-preview";
