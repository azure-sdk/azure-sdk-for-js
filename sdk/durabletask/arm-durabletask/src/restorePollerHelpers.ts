...
import { _$deleteDeserialize, _createOrUpdateDeserialize } from "./api/taskHubs/index.js";
import {
  _$deleteDeserialize as _deleteDeserializeSchedulers,
  _updateDeserialize,
...
const deserializeMap: Record<string, DeserializationHelper> = {
  ...
  "DELETE /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DurableTask/schedulers/{schedulerName}":
    {
      deserializer: _deleteDeserializeSchedulers,
      expectedStatuses: ["202", "204", "200"],
    },
