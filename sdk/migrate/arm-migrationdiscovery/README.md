...
[API reference documentation](https://docs.microsoft.com/javascript/api/@azure/arm-migrationdiscovery?view=azure-node-preview) |
...
```javascript
const { AzureMigrateDiscoveryService } = require("@azure/arm-migrationdiscovery");
...
![Impressions](https://azure-sdk-impressions.azurewebsites.net/api/impressions/azure-sdk-for-js%2Fsdk%2Fmigrate%2Farm-migrationdiscovery%2FREADME.png)
