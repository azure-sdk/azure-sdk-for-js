...
[Source code](https://github.com/Azure/azure-sdk-for-js/tree/main/sdk/migrate/arm-migrationhub) |
[Package (NPM)](https://www.npmjs.com/package/@azure/arm-migrationhub) |
[API reference documentation](https://learn.microsoft.com/javascript/api/@azure/arm-migrationhub?view=azure-node-preview) |
...
### Install the `@azure/arm-migrationhub` package

Install the AzureMigrateV2 client library for JavaScript with `npm`:

```bash
npm install @azure/arm-migrationhub
```
...
```javascript
const { AzureMigrateV2 } = require("@azure/arm-migrationhub");
...
![Impressions](https://azure-sdk-impressions.azurewebsites.net/api/impressions/azure-sdk-for-js%2Fsdk%2Fmigrate%2Farm-migrationhub%2FREADME.png)
