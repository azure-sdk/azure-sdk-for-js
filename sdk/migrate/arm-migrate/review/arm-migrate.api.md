...
export interface SqlSitesController {
    ...
    triggerImportInventory(resourceGroupName: string, siteName: string, sqlSiteName: string, body: SQLInventoryImportBody, options?: SqlSitesControllerTriggerImportInventoryOptionalParams): Promise<SqlSitesControllerTriggerImportInventoryResponse>;
...
// @public
export type SqlSitesControllerTriggerImportInventoryResponse = SQLInventoryImportBody;
