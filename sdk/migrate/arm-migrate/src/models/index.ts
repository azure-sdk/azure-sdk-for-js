...
/** Defines headers for SqlSitesController_importInventory operation. */
export interface SqlSitesControllerImportInventoryHeaders {
...
/** Optional parameters. */
export interface SqlSitesControllerImportInventoryOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Contains response data for the importInventory operation. */
export type SqlSitesControllerImportInventoryResponse =
  SqlSitesControllerImportInventoryHeaders;
