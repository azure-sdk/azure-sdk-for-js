...
/** Known values of {@link LinuxAzureHybridUseBenefit} that the service accepts. */
export enum KnownLinuxAzureHybridUseBenefit {
  /** Unknown */
  Unknown = "Unknown",
  /** Yes */
  Yes = "Yes",
...
/**
 * Defines values for LinuxAzureHybridUseBenefit. \
 * {@link KnownLinuxAzureHybridUseBenefit} can be used interchangeably with LinuxAzureHybridUseBenefit,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Unknown** \
 * **Yes** \
 * **No**
 */
export type LinuxAzureHybridUseBenefit = string;
