...
export interface ImportSqlInventoryJobProperties {
  /** Gets or sets the Blob name for the blob to fetch Import file from. */
  blobName?: string;
  /** Gets or sets the blob SAS Uri of the input import file. */
  blobSasUri?: string;
  /** Gets or sets the Job Result status. */
  jobResult?: ImportSqlInventoryJobResult;
  /** Gets or sets the Number of servers imported. */
  numberOfServersImported?: number;
  /** Gets or sets the Number of databases imported. */
  numberOfDatabasesImported?: number;
  /** Gets or sets the Number of availability groups imported. */
  numberOfAvailabilityGroupsImported?: number;
  /** Gets or sets the Blob creation time stamp. */
  blobCreationTimeStamp?: Date;
  /** Gets or sets the Job Error Summary. */
  errorSummary?: SqlImportJobErrorSummary;
}

/** Job Error Summary */
export interface SqlImportJobErrorSummary {
  /** Gets or sets the Job level errors. */
  errors?: string[];
  /** Gets or sets the Number of errors while trying to import SQL Inventory from CSV. */
  errorCount?: number;
  /** Gets or sets the Number of warnings while trying to import SQL Inventory from CSV. */
  warningCount?: number;
}
...
export interface Server extends ProxyResource {
  ...
  readonly arcDiscovery?: ArcDiscovery;
  /**
   * Gets or sets the discovery source of the server.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
...
/** Known values of {@link ArcScopeType} that the service accepts. */
...
/**
 * Defines values for ArcScopeType. \
 * {@link KnownArcScopeType} can be used interchangeably with ArcScopeType,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 ...
 * **2024-12-01-preview**: Api version 2024-12-01-preview.
 */
...
/** Optional parameters. */
export interface SqlSitesControllerExportImportedSqlInventoryAsyncOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the exportImportedSqlInventoryAsync operation. */
export type SqlSitesControllerExportImportedSqlInventoryAsyncResponse =
...
/** Optional parameters. */
export interface SqlSitesControllerTriggerImportInventoryOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the triggerImportInventory operation. */
export type SqlSitesControllerTriggerImportInventoryResponse =
  SQLInventoryImportBody;

/** Optional parameters. */
export interface SqlSitesControllerValidateAndImportInventoryOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the validateAndImportInventory operation. */
export type SqlSitesControllerValidateAndImportInventoryResponse =
  SQLInventoryImportBody;
