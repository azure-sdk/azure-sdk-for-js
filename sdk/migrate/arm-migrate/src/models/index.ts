...
/** Defines headers for SqlSitesController_triggerImportInventory operation. */
export interface SqlSitesControllerTriggerImportInventoryHeaders {
  /** URL to monitor operation status */
...
export type SqlSitesControllerTriggerImportInventoryResponse =
  SqlSitesControllerTriggerImportInventoryHeaders;
