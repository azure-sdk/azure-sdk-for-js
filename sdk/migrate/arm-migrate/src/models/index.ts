...
export interface SqlSiteErrorDetails {
  /** Appliance Name. */
  applianceName: string;
  /** Gets the error detailed summary. */
...
export interface ErrorDetailedSummary {
  /** Count of servers affected by the error. */
  countOfServersAffected: number;
  /**
   * Gets the error message.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
...
export interface ExportImportedMachinesJobCollection {
  /** Gets the list of jobs. */
...
export interface ImportMachinesJobImportMachinesJobCollection {
  /** Gets the list of jobs. */
...
/** Import URI response class. */
export interface V20190501PreviewSasUriResponse {
  /** Gets or sets the job ARM ID. */
  jobArmId?: string;
  /** Gets or sets the SAS URI. */
  uri?: string;
...
/** Defines headers for PrivateEndpointConnectionController_delete operation. */
export interface PrivateEndpointConnectionControllerDeleteHeaders {
  /** The Retry-After header can indicate how long the client should wait before polling the operation status. */
  retryAfter?: number;
  /** The Location header contains the URL where the status of the long running operation can be checked. */
  location?: string;
...
/** Defines headers for SqlDiscoverySiteDataSourceController_delete operation. */
export interface SqlDiscoverySiteDataSourceControllerDeleteHeaders {
  /** The Retry-After header can indicate how long the client should wait before polling the operation status. */
  retryAfter?: number;
  /** The Location header contains the URL where the status of the long running operation can be checked. */
  location?: string;
...
/** Defines headers for VcenterController_delete operation. */
export interface VcenterControllerDeleteHeaders {
  /** The Retry-After header can indicate how long the client should wait before polling the operation status. */
  retryAfter?: number;
  /** The Location header contains the URL where the status of the long running operation can be checked. */
  location?: string;
...
/** Known values of {@link CosmosDBImportMachinesJobEntityImportMachinesJobPropertiesJobResultValues} that the service accepts. */
export enum KnownCosmosDBImportMachinesJobEntityImportMachinesJobPropertiesJobResultValues {
  /** Unknown value. */
  Unknown = "Unknown",
  /** Completed value. */
  Completed = "Completed",
...
/**
 * Defines values for CosmosDBImportMachinesJobEntityImportMachinesJobPropertiesJobResultValues. \
 * {@link KnownCosmosDBImportMachinesJobEntityImportMachinesJobPropertiesJobResultValues} can be used interchangeably with CosmosDBImportMachinesJobEntityImportMachinesJobPropertiesJobResultValues,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Unknown**: Unknown value. \
 * **Completed**: Completed value. \
 ...
 * **InProgress**: InProgress value.
 */
export type CosmosDBImportMachinesJobEntityImportMachinesJobPropertiesJobResultValues =
  string;
...
export type PrivateEndpointConnectionControllerDeleteResponse =
  PrivateEndpointConnectionControllerDeleteHeaders;
...
/** Optional parameters. */
export interface SqlSitesControllerErrorDetailedSummaryOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the errorDetailedSummary operation. */
export type SqlSitesControllerErrorDetailedSummaryResponse =
  SqlSiteErrorDetails;
...
/** Contains response data for the delete operation. */
export type SqlDiscoverySiteDataSourceControllerDeleteResponse =
  SqlDiscoverySiteDataSourceControllerDeleteHeaders;
...
/** Contains response data for the delete operation. */
export type WebAppDiscoverySiteDataSourcesControllerDeleteResponse =
  WebAppDiscoverySiteDataSourcesControllerDeleteHeaders;
...
/** Contains response data for the delete operation. */
export type VcenterControllerDeleteResponse = VcenterControllerDeleteHeaders;
