...
import {
  ...
  SqlSitesControllerImportInventoryOptionalParams,
  SqlSitesControllerImportInventoryResponse,
...
export class SqlSitesControllerImpl implements SqlSitesController {
   ...
   * @param options The options parameters.
   */
  async beginImportInventory(
    resourceGroupName: string,
    siteName: string,
    sqlSiteName: string,
    body: SQLInventoryImportBody,
    options?: SqlSitesControllerImportInventoryOptionalParams,
  ): Promise<
    SimplePollerLike<
      OperationState<SqlSitesControllerImportInventoryResponse>,
      SqlSitesControllerImportInventoryResponse
    >
  > {
    const directSendOperation = async (
      args: coreClient.OperationArguments,
      spec: coreClient.OperationSpec,
    ): Promise<SqlSitesControllerImportInventoryResponse> => {
      return this.client.sendOperationRequest(args, spec);
    };
    const sendOperationFn = async (
      args: coreClient.OperationArguments,
    ...
    const lro = createLroSpec({
      sendOperationFn,
      args: { resourceGroupName, siteName, sqlSiteName, body, options },
      spec: importInventoryOperationSpec,
    });
    const poller = await createHttpPoller<
      SqlSitesControllerImportInventoryResponse,
      OperationState<SqlSitesControllerImportInventoryResponse>
   ...
   * @param options The options parameters.
   */
  async beginImportInventoryAndWait(
    resourceGroupName: string,
    siteName: string,
    sqlSiteName: string,
    body: SQLInventoryImportBody,
    ...
    const poller = await this.beginImportInventory(
      resourceGroupName,
      siteName,
      sqlSiteName,
      body,
...
const exportImportedSqlInventoryAsyncOperationSpec: coreClient.OperationSpec = {
  path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OffAzure/masterSites/{siteName}/sqlSites/{sqlSiteName}/exportImportedSqlInventory",
  httpMethod: "POST",
  responses: {
    200: {
...
const importInventoryOperationSpec: coreClient.OperationSpec = {
  path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OffAzure/masterSites/{siteName}/sqlSites/{sqlSiteName}/importInventory",
  httpMethod: "POST",
  responses: {
    200: {
      headersMapper: Mappers.SqlSitesControllerImportInventoryHeaders,
    },
    201: {
      headersMapper: Mappers.SqlSitesControllerImportInventoryHeaders,
    },
