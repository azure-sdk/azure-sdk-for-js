...
export class SqlSitesControllerImpl implements SqlSitesController {
  ...
  /**
   * Method to trigger the import SQL inventory.
   * @param resourceGroupName The name of the resource group. The name is case insensitive.
   * @param siteName Site name
   * @param sqlSiteName SQL site name.
   * @param body The content of the action request
  ...
  triggerImportInventory(
    ...
    return this.client.sendOperationRequest(
      { resourceGroupName, siteName, sqlSiteName, body, options },
      triggerImportInventoryOperationSpec,
    );
  }

  /**
   * Method to validate the SQL inventory before triggering the import process.
   * @param resourceGroupName The name of the resource group. The name is case insensitive.
   * @param siteName Site name
   * @param sqlSiteName SQL site name.
   * @param body The content of the action request
