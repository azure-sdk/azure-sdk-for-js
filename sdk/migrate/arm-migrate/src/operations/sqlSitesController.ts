...
import {
  ...
  ErrorSummaryRequest,
  SqlSitesControllerErrorDetailedSummaryOptionalParams,
  SqlSitesControllerErrorDetailedSummaryResponse,
...
export class SqlSitesControllerImpl implements SqlSitesController {
  ...
  /**
   * Method to get error detailed summary from SQL site.
   * @param resourceGroupName The name of the resource group. The name is case insensitive.
   * @param siteName Site name
   * @param sqlSiteName SQL site name.
   ...
   * @param options The options parameters.
   */
  errorDetailedSummary(
    resourceGroupName: string,
    siteName: string,
    sqlSiteName: string,
    body: ErrorSummaryRequest,
    options?: SqlSitesControllerErrorDetailedSummaryOptionalParams,
  ): Promise<SqlSitesControllerErrorDetailedSummaryResponse> {
    return this.client.sendOperationRequest(
      { resourceGroupName, siteName, sqlSiteName, body, options },
      errorDetailedSummaryOperationSpec,
    );
  }
...
const errorDetailedSummaryOperationSpec: coreClient.OperationSpec = {
  path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OffAzure/masterSites/{siteName}/sqlSites/{sqlSiteName}/errorDetailedSummary",
  httpMethod: "POST",
  responses: {
    200: {
      bodyMapper: Mappers.SqlSiteErrorDetails,
    },
    default: {
      bodyMapper: Mappers.ErrorResponse,
    },
