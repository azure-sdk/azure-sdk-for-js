...
import {
  ...
  SqlSitesControllerExportImportedSqlInventoryAsyncOptionalParams,
  SqlSitesControllerExportImportedSqlInventoryAsyncResponse,
  ...
  SqlSitesControllerTriggerImportInventoryOptionalParams,
  SqlSitesControllerTriggerImportInventoryResponse,
  SqlSitesControllerValidateAndImportInventoryOptionalParams,
  SqlSitesControllerValidateAndImportInventoryResponse,
...
export class SqlSitesControllerImpl implements SqlSitesController {
   ...
   * @param options The options parameters.
   */
  exportImportedSqlInventoryAsync(
    resourceGroupName: string,
    siteName: string,
    sqlSiteName: string,
    body: SQLInventoryImportBody,
    options?: SqlSitesControllerExportImportedSqlInventoryAsyncOptionalParams,
  ): Promise<SqlSitesControllerExportImportedSqlInventoryAsyncResponse> {
    return this.client.sendOperationRequest(
      { resourceGroupName, siteName, sqlSiteName, body, options },
      exportImportedSqlInventoryAsyncOperationSpec,
    );
  }
   ...
   * @param options The options parameters.
   */
  async beginTriggerImportInventory(
    resourceGroupName: string,
    siteName: string,
    sqlSiteName: string,
    body: SQLInventoryImportBody,
    options?: SqlSitesControllerTriggerImportInventoryOptionalParams,
  ): Promise<
    SimplePollerLike<
      OperationState<SqlSitesControllerTriggerImportInventoryResponse>,
      SqlSitesControllerTriggerImportInventoryResponse
    >
  > {
    const directSendOperation = async (
      args: coreClient.OperationArguments,
      spec: coreClient.OperationSpec,
    ): Promise<SqlSitesControllerTriggerImportInventoryResponse> => {
      return this.client.sendOperationRequest(args, spec);
    };
    const sendOperationFn = async (
      args: coreClient.OperationArguments,
    ...
    const lro = createLroSpec({
      sendOperationFn,
      args: { resourceGroupName, siteName, sqlSiteName, body, options },
      spec: triggerImportInventoryOperationSpec,
    });
    const poller = await createHttpPoller<
      SqlSitesControllerTriggerImportInventoryResponse,
      OperationState<SqlSitesControllerTriggerImportInventoryResponse>
   ...
   * @param options The options parameters.
   */
  async beginTriggerImportInventoryAndWait(
    resourceGroupName: string,
    siteName: string,
    sqlSiteName: string,
    body: SQLInventoryImportBody,
    ...
    const poller = await this.beginTriggerImportInventory(
      resourceGroupName,
      siteName,
      sqlSiteName,
      body,
   ...
   * @param options The options parameters.
   */
  validateAndImportInventory(
    resourceGroupName: string,
    siteName: string,
    sqlSiteName: string,
    body: SQLInventoryImportBody,
    options?: SqlSitesControllerValidateAndImportInventoryOptionalParams,
  ): Promise<SqlSitesControllerValidateAndImportInventoryResponse> {
    return this.client.sendOperationRequest(
      { resourceGroupName, siteName, sqlSiteName, body, options },
      validateAndImportInventoryOperationSpec,
    );
  }
...
const exportImportedSqlInventoryAsyncOperationSpec: coreClient.OperationSpec = {
  path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OffAzure/masterSites/{siteName}/sqlSites/{sqlSiteName}/exportImportedSqlInventoryAsync",
  httpMethod: "POST",
  responses: {
    200: {
...
const triggerImportInventoryOperationSpec: coreClient.OperationSpec = {
  path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OffAzure/masterSites/{siteName}/sqlSites/{sqlSiteName}/triggerImportInventory",
  httpMethod: "POST",
  responses: {
    200: {
      headersMapper: Mappers.SqlSitesControllerTriggerImportInventoryHeaders,
    },
    201: {
      headersMapper: Mappers.SqlSitesControllerTriggerImportInventoryHeaders,
    },
...
const validateAndImportInventoryOperationSpec: coreClient.OperationSpec = {
  path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OffAzure/masterSites/{siteName}/sqlSites/{sqlSiteName}/validateAndImportInventory",
  httpMethod: "POST",
  responses: {
    200: {
      bodyMapper: Mappers.SQLInventoryImportBody,
