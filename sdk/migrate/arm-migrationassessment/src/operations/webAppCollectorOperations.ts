...
import { WebAppCollectorOperations } from "../operationsInterfaces/index.js";
...
import {
  WebAppCollector,
  WebAppCollectorOperationsListByAssessmentProjectNextOptionalParams,
  WebAppCollectorOperationsListByAssessmentProjectOptionalParams,
  WebAppCollectorOperationsListByAssessmentProjectResponse,
  ...
  WebAppCollectorOperationsListByAssessmentProjectNextResponse,
} from "../models/index.js";

/// <reference lib="esnext.asynciterable" />
/** Class containing WebAppCollectorOperations operations. */
export class WebAppCollectorOperationsImpl
  implements WebAppCollectorOperations
{
  private readonly client: AzureMigrateAssessmentService;

  /**
   * Initialize a new instance of the class WebAppCollectorOperations class.
  ...
  ): AsyncIterableIterator<WebAppCollector[]> {
    let result: WebAppCollectorOperationsListByAssessmentProjectResponse;
  ...
  private _listByAssessmentProject(
    ...
    projectName: string,
    options?: WebAppCollectorOperationsListByAssessmentProjectOptionalParams,
  ): Promise<WebAppCollectorOperationsListByAssessmentProjectResponse> {
  ...
  private _listByAssessmentProjectNext(
    ...
    projectName: string,
    nextLink: string,
    options?: WebAppCollectorOperationsListByAssessmentProjectNextOptionalParams,
  ): Promise<WebAppCollectorOperationsListByAssessmentProjectNextResponse> {
    return this.client.sendOperationRequest(
...
const listByAssessmentProjectOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.WebAppCollectorListResult,
    },
    default: {
...
const getOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.WebAppCollector,
    },
    default: {
      bodyMapper: Mappers.ErrorResponse,
    },
