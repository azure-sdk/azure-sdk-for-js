...
import { AksClusterOperations } from "../operationsInterfaces/index.js";
...
import {
  AKSCluster,
  AksClusterOperationsListByAksAssessmentNextOptionalParams,
  AksClusterOperationsListByAksAssessmentOptionalParams,
  AksClusterOperationsListByAksAssessmentResponse,
  AksClusterOperationsGetOptionalParams,
  AksClusterOperationsGetResponse,
  AksClusterOperationsListByAksAssessmentNextResponse,
} from "../models/index.js";

/// <reference lib="esnext.asynciterable" />
/** Class containing AksClusterOperations operations. */
export class AksClusterOperationsImpl implements AksClusterOperations {
  private readonly client: AzureMigrateAssessmentService;

  /**
   * Initialize a new instance of the class AksClusterOperations class.
  ...
  ): AsyncIterableIterator<AKSCluster[]> {
    let result: AksClusterOperationsListByAksAssessmentResponse;
  ...
  private _listByAksAssessment(
    ...
    assessmentName: string,
    options?: AksClusterOperationsListByAksAssessmentOptionalParams,
  ): Promise<AksClusterOperationsListByAksAssessmentResponse> {
  ...
  get(
    ...
    return this.client.sendOperationRequest(
      { resourceGroupName, projectName, assessmentName, clusterName, options },
      getOperationSpec,
    );
  }
  ...
  private _listByAksAssessmentNext(
    ...
    assessmentName: string,
    nextLink: string,
    options?: AksClusterOperationsListByAksAssessmentNextOptionalParams,
  ): Promise<AksClusterOperationsListByAksAssessmentNextResponse> {
    return this.client.sendOperationRequest(
...
const listByAksAssessmentOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.AKSClusterListResult,
    },
    default: {
