...
export interface ChoiceDeltaOutput {
  ...
  finishReason?: FinishReasonOutput;
}
...
export interface TextChatMessageDeltaOutput
  extends ChatMessageDeltaOutputParent {
  /** The type of the message. */
  kind: "text";
...
/** A single, role-attributed message within a chat completion interaction. */
export type ChatMessageOutput = ChatMessageOutputParent | TextChatMessageOutput;
/** The representation of a delta message received in a streaming completion. */
export type ChatMessageDeltaOutput =
  | ChatMessageDeltaOutputParent
  | TextChatMessageDeltaOutput;
/** Alias for MessageKindOutput */
export type MessageKindOutput = string | "text";
/** Alias for ChatRoleOutput */
export type ChatRoleOutput = string | "user" | "system" | "assistant";
/** Alias for FinishReasonOutput */
export type FinishReasonOutput = string | "stop" | "length";
