...
/** A single, role-attributed message within a chat completion interaction. */
export type ChatMessage = ChatMessageParent | TextChatMessage;
/** Alias for MessageKind */
export type MessageKind = string | "text";
/** Alias for ChatRole */
export type ChatRole = string | "user" | "system" | "assistant";
