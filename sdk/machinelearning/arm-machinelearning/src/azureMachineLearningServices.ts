...
import {
  AzureMachineLearningServicesOptionalParams,
  OutboundNetworkDependenciesEndpointsOptionalParams,
  OutboundNetworkDependenciesEndpointsResponse
} from "./models";
...
export class AzureMachineLearningServices extends coreClient.ServiceClient {
  ...
  ): Promise<OutboundNetworkDependenciesEndpointsResponse> {
    return this.sendOperationRequest(
      { resourceGroupName, workspaceName, options },
      outboundNetworkDependenciesEndpointsOperationSpec
    );
  }
...
const outboundNetworkDependenciesEndpointsOperationSpec: coreClient.OperationSpec = {
  path:
