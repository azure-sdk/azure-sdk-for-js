...
import {
  ...
  StandbyPoolProperties as StandbyPoolPropertiesMapper
} from "../models/mappers";
...
export const body49: OperationParameter = {
  parameterPath: "body",
  mapper: StandbyPoolPropertiesMapper
};

export const standbyPoolName: OperationURLParameter = {
  parameterPath: "standbyPoolName",
  mapper: {
    constraints: {
      Pattern: new RegExp("^[a-zA-Z0-9][a-zA-Z0-9_-]{2,64}$")
    },
    serializedName: "standbyPoolName",
    required: true,
    type: {
      name: "String"
    }
