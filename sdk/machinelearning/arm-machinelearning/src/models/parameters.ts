...
import {
  ...
  IndexVersion as IndexVersionMapper
} from "../models/mappers";
...
export const listViewType2: OperationQueryParameter = {
  parameterPath: ["options", "listViewType"],
  mapper: {
...
export const versionName1: OperationURLParameter = {
