...
import {
  ...
  InferenceGroupMinimalTrackedResourceWithSku as InferenceGroupMinimalTrackedResourceWithSkuMapper,
  InferenceEndpointMinimalTrackedResource as InferenceEndpointMinimalTrackedResourceMapper,
...
export const body25: OperationParameter = {
  parameterPath: "body",
  mapper: InferenceGroupMinimalTrackedResourceWithSkuMapper
};
...
export const body27: OperationParameter = {
  parameterPath: "body",
  mapper: InferenceEndpointMinimalTrackedResourceMapper
};
