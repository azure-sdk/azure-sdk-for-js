...
export const includeAllVersions: OperationQueryParameter = {
  parameterPath: ["options", "includeAllVersions"],
  mapper: {
    defaultValue: false,
    serializedName: "includeAllVersions",
    type: {
      name: "Boolean"
    }
  }
