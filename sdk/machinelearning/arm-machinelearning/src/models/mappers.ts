...
export const StandbyPoolProperties: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "StandbyPoolProperties",
    modelProperties: {
      name: {
        serializedName: "name",
        type: {
      ...
      standbyAvailableInstances: {
        serializedName: "standbyAvailableInstances",
        type: {
          name: "Sequence",
          element: {
            type: {
              name: "Composite",
              className: "StandbyPoolResourceStatus"
            }
          }
        }
      }
...
export const StandbyPoolResourceStatus: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "StandbyPoolResourceStatus",
    modelProperties: {
...
export const StandbyPool: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "StandbyPool",
    modelProperties: {
      ...
      standbyAvailableInstances: {
        serializedName: "properties.standbyAvailableInstances",
        type: {
          name: "Sequence",
          element: {
            type: {
