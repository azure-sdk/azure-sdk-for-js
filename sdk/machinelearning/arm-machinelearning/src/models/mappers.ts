...
export const SkuResourceAutoGenerated: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "SkuResourceAutoGenerated",
    modelProperties: {
      capacity: {
        serializedName: "capacity",
        type: {
      ...
      sku: {
        ...
        type: {
          name: "Composite",
          className: "SkuSettingAutoGenerated"
        }
      }
    }
  }
...
export const SkuSettingAutoGenerated: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "SkuSettingAutoGenerated",
    modelProperties: {
...
export const SkuResourceArmPaginatedResultAutoGenerated: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "SkuResourceArmPaginatedResultAutoGenerated",
    modelProperties: {
      nextLink: {
        serializedName: "nextLink",
        type: {
  ...
  type: {
    ...
    modelProperties: {
      ...
      managedResourceGroupTags: {
        serializedName: "managedResourceGroupTags",
        type: {
          name: "Dictionary",
          value: { type: { name: "String" } }
        }
