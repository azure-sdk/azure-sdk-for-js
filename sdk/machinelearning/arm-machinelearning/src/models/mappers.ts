...
export const GetFeatureRequest: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "GetFeatureRequest",
    modelProperties: {
      featureName: {
...
export const FeatureArmPaginatedResult: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "FeatureArmPaginatedResult",
    modelProperties: {
      nextLink: {
        serializedName: "nextLink",
        type: {
  ...
  type: {
    ...
    modelProperties: {
      partialNotificationSetting: {
        serializedName: "partialNotificationSetting",
        type: {
          name: "Composite",
