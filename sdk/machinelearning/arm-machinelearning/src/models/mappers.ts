...
export const IndexesResourceArmPaginatedResult: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "IndexesResourceArmPaginatedResult",
    modelProperties: {
      nextLink: {
        serializedName: "nextLink",
        type: {
...
export const IndexesProperties: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "IndexesProperties",
    modelProperties: {
      ...ResourceBase.type.modelProperties,
      indexConfigurations: {
      ...
      previousVersionIndexId: {
        serializedName: "previousVersionIndexId",
        nullable: true,
        type: {
          name: "String"
        }
