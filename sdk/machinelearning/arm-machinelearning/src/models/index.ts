...
export interface IndexVersion extends ProxyResource {
  ...
  storageUri?: string;
  /** Placeholder for extras. */
  indexConfigurations?: { [propertyName: string]: string };
}
...
export enum KnownVersions {
  /** Azure Machine Learning Services api version 2024-01-01-preview. */
 ...
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **2024-01-01-preview**: Azure Machine Learning Services api version 2024-01-01-preview.
 */
...
/** Optional parameters. */
export interface IndexesListByWorkspaceOptionalParams
  extends coreClient.OperationOptions {}
...
/** Optional parameters. */
export interface IndexesListByWorkspaceNextOptionalParams
  extends coreClient.OperationOptions {}
...
/** Optional parameters. */
export interface IndexesVersionsListByIndexOptionalParams
  extends coreClient.OperationOptions {
  /** If set to true, $latest provides the latest of each index. */
  label?: string;
  /** Defines what set of entities to return in list, default active only. */
  listViewType?: string;
...
/** Contains response data for the listByIndex operation. */
export type IndexesVersionsListByIndexResponse = IndexVersionListResult;

/** Optional parameters. */
export interface IndexesVersionsGetOptionalParams
  extends coreClient.OperationOptions {}
...
/** Optional parameters. */
export interface IndexesVersionsCreateOrUpdateOptionalParams
  extends coreClient.OperationOptions {}
...
/** Optional parameters. */
export interface IndexesVersionsListByIndexNextOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the listByIndexNext operation. */
