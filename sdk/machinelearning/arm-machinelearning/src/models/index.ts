...
export interface RegistryProperties extends ResourceBase {
  ...
  managedResourceGroupTags?: { [propertyName: string]: string | null };
}
...
export interface CustomMonitoringSignal extends MonitoringSignalBase {
  ...
  inputAssets?: { [propertyName: string]: MonitoringInputData | null };
...
/** Known values of {@link FeaturestoreJobType} that the service accepts. */
 ...
 * {@link KnownFeaturestoreJobType} can be used interchangeably with FeaturestoreJobType,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **RecurrentMaterialization** \
 * **BackfillMaterialization**
...
export enum KnownClassificationModels {
   ...
   * The "forest" it builds, is an ensemble of decision trees, usually trained with the â€œbaggingâ€ method.
 ...
 * **F1Score**: Calculates the F1 score of the model predictions.
 */
...
/** Known values of {@link MonitoringNotificationMode} that the service accepts. */
 ...
 * {@link KnownMonitoringNotificationMode} can be used interchangeably with MonitoringNotificationMode,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Disabled**: Disabled notifications will not produce emails\/metrics leveraged for alerting. \
 * **Enabled**: Enabled notification will produce emails\/metrics leveraged for alerting.
 */
 ...
 * **ModelPerformance**: Tracks model perforance based on ground truth data.
 */
export type MonitoringSignalType = string;

/** Known values of {@link MonitoringInputDataContext} that the service accepts. */
 ...
 * {@link KnownMonitoringInputDataContext} can be used interchangeably with MonitoringInputDataContext,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **ModelInputs**: A dataset containing the feature input to the model. \
 * **ModelOutputs**: A dataset containing the infered results of the model. \
 * **Training**: A dataset containing the data used for training the model. \
 * **Test**: A dataset leveraged to test the model. \
 * **Validation**: A dataset leveraged for model validation. \
 * **GroundTruth**: A dataset containing the ground truth data.
 */
...
/** Optional parameters. */
export interface RegistryCodeVersionsCreateOrGetPendingUploadOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the createOrGetPendingUpload operation. */
...
/** Optional parameters. */
export interface RegistryModelVersionsCreateOrGetPendingUploadOptionalParams
  extends coreClient.OperationOptions {}
...
/** Optional parameters. */
export interface CodeVersionsCreateOrGetPendingUploadOptionalParams
  extends coreClient.OperationOptions {}
...
/** Optional parameters. */
export interface FeaturesetVersionsGetFeatureOptionalParams
  extends coreClient.OperationOptions {}
...
/** Optional parameters. */
export interface FeaturesetVersionsListFeaturesOptionalParams
  extends coreClient.OperationOptions {
  /** Continuation token for pagination. */
  skip?: string;
  /** description. */
...
/** Optional parameters. */
export interface FeaturesetVersionsListMaterializationJobsOptionalParams
  extends coreClient.OperationOptions {
  /** Continuation token for pagination. */
  skip?: string;
  /** Comma-separated list of tag names (and optionally values). Example: tag1,tag2=value2 */
...
/** Contains response data for the listMaterializationJobs operation. */
...
/** Optional parameters. */
export interface FeaturesetVersionsListFeaturesNextOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the listFeaturesNext operation. */
export type FeaturesetVersionsListFeaturesNextResponse = FeatureArmPaginatedResult;

/** Optional parameters. */
export interface FeaturesetVersionsListMaterializationJobsNextOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the listMaterializationJobsNext operation. */
