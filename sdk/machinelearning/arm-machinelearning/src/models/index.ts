...
export interface IndexesProperties extends ResourceBase {
   ...
   */
  indexConfigurations?: { [propertyName: string]: string | null };
  /**
   ...
   * Uri azureml://subscriptions/{{sub}}/resourcegroups/{{rg}}/workspaces/{{workspace}}/datastores/workspaceblobstore/paths/azureml
   */
  storageUri?: string;
  /**
...
/** Optional parameters. */
export interface IndexesListNextOptionalParams
  extends coreClient.OperationOptions {}
