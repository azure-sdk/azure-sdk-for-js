...
/** Known values of {@link OsPatchingStatus} that the service accepts. */
...
/**
 * Defines values for OsPatchingStatus. \
 * {@link KnownOsPatchingStatus} can be used interchangeably with OsPatchingStatus,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **CompletedWithWarnings** \
 * **Failed** \
