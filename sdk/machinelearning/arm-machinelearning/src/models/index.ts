...
/** The properties of a standby pool. */
export interface StandbyPoolProperties {
  /** Name of the standby pool. */
  name?: string;
  /** Number of virtual machines (VMs) in the standby pool. */
  count?: number;
  /** The virtual machine (VM) size of the VMs in the standby pool. */
  vmSize?: string;
  /** The current status of all virtual machine (VM) instances in the standby pool. */
  standbyAvailableInstances?: StandbyPoolResourceStatus[];
}

/** The status of a resource within a standby pool. */
export interface StandbyPoolResourceStatus {
  /** Human-readable status of the resource. */
  status?: string;
  /** An error object containing additional error information. */
  error?: CloudError;
}
...
export interface AdditionalErrorInfo {
  /** JSON-serialized string containing additional information of the type of error that occured. */
  info?: string;
  /** Type of error that occured (e.g., PolicyViolation, SecurityViolation). */
  type?: string;
}
...
/** The resource model definition for a Standby Pool resource */
...
/** Optional parameters. */
export interface StandbyPoolCreateOptionalParams
  extends coreClient.OperationOptions {}

/** Optional parameters. */
export interface StandbyPoolCreateOrUpdateOptionalParams
  extends coreClient.OperationOptions {
  /** Force the PATCH request to be treated as create */
  ifMatch?: string;
  /** If value is '*', then PATCH will NOT be treated as an update. */
  ifNoneMatch?: string;
}

/** Optional parameters. */
export interface StandbyPoolDeleteOptionalParams
  extends coreClient.OperationOptions {}
...
/** Optional parameters. */
export interface StandbyPoolGetOptionalParams
  extends coreClient.OperationOptions {}
...
/** Optional parameters. */
export interface StandbyPoolListOptionalParams
  extends coreClient.OperationOptions {}
