...
export interface EndpointPropertiesBase {
  /** [Required] The authentication method for invoking the endpoint (data plane operation). Use 'key' for key-based authentication. Use 'aml_token' for Azure Machine Learning token-based authentication. Use 'aad_token' for Microsoft Entra token-based authentication. */
