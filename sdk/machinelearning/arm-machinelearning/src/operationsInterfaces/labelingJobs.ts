...
import {
  ...
  LabelingJobsPauseResponse,
  LabelingJobsResumeOptionalParams,
  LabelingJobsResumeResponse
} from "../models";
...
export interface LabelingJobs {
  ...
  beginCreateOrUpdate(
    ...
    SimplePollerLike<
      OperationState<LabelingJobsCreateOrUpdateResponse>,
      LabelingJobsCreateOrUpdateResponse
    >
  >;
  /**
  ...
  beginExportLabels(
    ...
    SimplePollerLike<
      OperationState<LabelingJobsExportLabelsResponse>,
      LabelingJobsExportLabelsResponse
    >
  >;
  /**
  ...
  ): Promise<LabelingJobsPauseResponse>;
  /**
  ...
  beginResume(
    ...
    SimplePollerLike<
      OperationState<LabelingJobsResumeResponse>,
      LabelingJobsResumeResponse
    >
  >;
  /**
  ...
  beginResumeAndWait(
    ...
    id: string,
    options?: LabelingJobsResumeOptionalParams
  ): Promise<LabelingJobsResumeResponse>;
}
