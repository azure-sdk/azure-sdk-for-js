...
import {
  ...
  InferenceGroupsGetDeltaModelsStatusAsyncResponse,
...
export interface InferenceGroups {
  ...
  beginUpdate(
    ...
    SimplePollerLike<OperationState<InferenceGroupsUpdateResponse>, InferenceGroupsUpdateResponse>
  >;
  /**
   * Update InferenceGroup (asynchronous).
   * @param resourceGroupName The name of the resource group. The name is case insensitive.
  ...
  ): Promise<InferenceGroupsGetDeltaModelsStatusAsyncResponse>;
  /**
  ...
  beginModifyDeltaModelsAsync(
    ...
    SimplePollerLike<
      OperationState<InferenceGroupsModifyDeltaModelsAsyncResponse>,
      InferenceGroupsModifyDeltaModelsAsyncResponse
    >
  >;
  /**
  ...
  beginModifyDeltaModelsAsyncAndWait(
    ...
    body: DeltaModelModifyRequest,
    options?: InferenceGroupsModifyDeltaModelsAsyncOptionalParams,
  ): Promise<InferenceGroupsModifyDeltaModelsAsyncResponse>;
  /**
