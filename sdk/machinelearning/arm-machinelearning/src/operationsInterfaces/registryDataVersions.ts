...
import {
  ...
  RegistryDataVersionsGetBlobReferenceSASOptionalParams,
  RegistryDataVersionsGetBlobReferenceSASResponse,
...
export interface RegistryDataVersions {
  ...
  getBlobReferenceSAS(
    ...
    options?: RegistryDataVersionsGetBlobReferenceSASOptionalParams
  ): Promise<RegistryDataVersionsGetBlobReferenceSASResponse>;
  /**
