...
export class OutboundRuleOperationsImpl implements OutboundRuleOperations {
  ...
  public list(
    ...
    const iter = this.listPagingAll(resourceGroupName, workspaceName, managedNetworkName, options);
    return {
      next() {
        return iter.next();
      },
  ...
  private async *listPagingPage(
    ...
    if (!continuationToken) {
      result = await this._list(resourceGroupName, workspaceName, managedNetworkName, options);
