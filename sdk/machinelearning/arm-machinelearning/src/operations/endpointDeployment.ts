...
import { EndpointDeployment } from "../operationsInterfaces/index.js";
...
export class EndpointDeploymentImpl implements EndpointDeployment {
  ...
  public listInWorkspace(
    ...
    const iter = this.getInWorkspacePagingAll(resourceGroupName, workspaceName, options);
    return {
      next() {
        return iter.next();
      },
      ...
      byPage: (settings?: PageSettings) => {
        ...
        return this.getInWorkspacePagingPage(resourceGroupName, workspaceName, options, settings);
      },
    };
  }
  ...
  private async *getInWorkspacePagingPage(
    ...
    if (!continuationToken) {
      result = await this._getInWorkspace(resourceGroupName, workspaceName, options);
...
const getInWorkspaceOperationSpec: coreClient.OperationSpec = {
  ...
  queryParameters: [Parameters.apiVersion, Parameters.skip, Parameters.endpointType],
  urlParameters: [
    Parameters.$host,
