...
import { EndpointOperations } from "../operationsInterfaces/index.js";
...
export class EndpointOperationsImpl implements EndpointOperations {
  ...
  public listModels(
    ...
    const iter = this.getModelsPagingAll(resourceGroupName, workspaceName, endpointName, options);
    return {
      next() {
        return iter.next();
      },
  ...
  private async *getModelsPagingPage(
    ...
    let continuationToken = settings?.continuationToken;
    if (!continuationToken) {
      result = await this._getModels(resourceGroupName, workspaceName, endpointName, options);
      let page = result.value || [];
      continuationToken = result.nextLink;
      setContinuationToken(page, continuationToken);
      yield page;
  ...
  async beginCreateOrUpdate(
    ...
    SimplePollerLike<OperationState<EndpointCreateOrUpdateResponse>, EndpointCreateOrUpdateResponse>
  > {
...
const listOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.EndpointResourcePropertiesBasicResourceArmPaginatedResult,
    },
    default: {
  ...
  queryParameters: [
    ...
    Parameters.includeOnlineEndpoints,
    Parameters.includeServerlessEndpoints,
    Parameters.includeConnections,
    Parameters.expand,
  ],
  urlParameters: [
    Parameters.$host,
