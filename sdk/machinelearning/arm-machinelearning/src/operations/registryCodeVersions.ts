...
import { RegistryCodeVersions } from "../operationsInterfaces/index.js";
...
export class RegistryCodeVersionsImpl implements RegistryCodeVersions {
  ...
  public list(
    ...
    const iter = this.listPagingAll(resourceGroupName, registryName, codeName, options);
    return {
      next() {
        return iter.next();
      },
  ...
  private async *listPagingPage(
    ...
    if (!continuationToken) {
      result = await this._list(resourceGroupName, registryName, codeName, options);
