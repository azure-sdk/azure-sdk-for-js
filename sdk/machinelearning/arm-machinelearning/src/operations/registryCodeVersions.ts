...
import {
  ...
  RegistryCodeVersionsGetBlobReferenceSASOptionalParams,
  RegistryCodeVersionsGetBlobReferenceSASResponse,
...
export class RegistryCodeVersionsImpl implements RegistryCodeVersions {
  ...
  getBlobReferenceSAS(
    ...
    options?: RegistryCodeVersionsGetBlobReferenceSASOptionalParams
  ): Promise<RegistryCodeVersionsGetBlobReferenceSASResponse> {
    return this.client.sendOperationRequest(
...
const getBlobReferenceSASOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.BlobReferenceSASResponseDto
    },
    default: {
      bodyMapper: Mappers.ErrorResponse
    }
