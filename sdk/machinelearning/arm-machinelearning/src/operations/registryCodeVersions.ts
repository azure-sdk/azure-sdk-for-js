...
import {
  ...
  RegistryCodeVersionsCreateOrGetPendingUploadOptionalParams,
  RegistryCodeVersionsCreateOrGetPendingUploadResponse,
...
export class RegistryCodeVersionsImpl implements RegistryCodeVersions {
  ...
  createOrGetPendingUpload(
    ...
    options?: RegistryCodeVersionsCreateOrGetPendingUploadOptionalParams
  ): Promise<RegistryCodeVersionsCreateOrGetPendingUploadResponse> {
    return this.client.sendOperationRequest(
      { resourceGroupName, registryName, codeName, version, body, options },
      createOrGetPendingUploadOperationSpec
    );
  }
...
const createOrGetPendingUploadOperationSpec: coreClient.OperationSpec = {
  path:
