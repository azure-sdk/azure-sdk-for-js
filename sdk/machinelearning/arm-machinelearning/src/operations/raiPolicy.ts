...
import { RaiPolicy } from "../operationsInterfaces/index.js";
...
export class RaiPolicyImpl implements RaiPolicy {
  ...
  ): Promise<SimplePollerLike<OperationState<RaiPolicyDeleteResponse>, RaiPolicyDeleteResponse>> {
  ...
  ): Promise<SimplePollerLike<OperationState<RaiPolicyCreateResponse>, RaiPolicyCreateResponse>> {
    const directSendOperation = async (
      args: coreClient.OperationArguments,
      spec: coreClient.OperationSpec,
