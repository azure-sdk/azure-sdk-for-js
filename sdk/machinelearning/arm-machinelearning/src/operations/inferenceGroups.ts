...
import { InferenceGroups } from "../operationsInterfaces/index.js";
...
import {
  ...
  InferenceGroupsListDeltaModelsAsyncNextOptionalParams,
  ...
  InferenceGroupsListDeltaModelsAsyncNextResponse,
...
export class InferenceGroupsImpl implements InferenceGroups {
  ...
  public listDeltaModelsAsync(
    ...
    const iter = this.listDeltaModelsAsyncPagingAll(
      resourceGroupName,
      workspaceName,
      poolName,
      groupName,
    ...
    return {
      ...
      byPage: (settings?: PageSettings) => {
        ...
        return this.listDeltaModelsAsyncPagingPage(
          resourceGroupName,
          workspaceName,
          poolName,
          groupName,
  ...
  private async *listDeltaModelsAsyncPagingPage(
    resourceGroupName: string,
    workspaceName: string,
    poolName: string,
    groupName: string,
    ...
    let result: InferenceGroupsListDeltaModelsAsyncResponse;
    let continuationToken = settings?.continuationToken;
    if (!continuationToken) {
      result = await this._listDeltaModelsAsync(
        resourceGroupName,
        workspaceName,
        poolName,
        groupName,
    ...
    while (continuationToken) {
      result = await this._listDeltaModelsAsyncNext(
        resourceGroupName,
        workspaceName,
        poolName,
        groupName,
  ...
  private async *listDeltaModelsAsyncPagingAll(
    resourceGroupName: string,
    workspaceName: string,
    poolName: string,
    groupName: string,
    ...
    for await (const page of this.listDeltaModelsAsyncPagingPage(
      resourceGroupName,
      workspaceName,
      poolName,
      groupName,
  ...
  private async *listSkusPagingPage(
    ...
    let continuationToken = settings?.continuationToken;
    if (!continuationToken) {
      result = await this._listSkus(resourceGroupName, workspaceName, poolName, groupName, options);
      let page = result.value || [];
      continuationToken = result.nextLink;
      setContinuationToken(page, continuationToken);
      yield page;
  ...
  getDeltaModelsStatusAsync(
    ...
    return this.client.sendOperationRequest(
      { resourceGroupName, workspaceName, poolName, groupName, body, options },
      getDeltaModelsStatusAsyncOperationSpec,
    );
  }
  ...
  private _listDeltaModelsAsync(
    ...
    body: DeltaModelListRequest,
    options?: InferenceGroupsListDeltaModelsAsyncOptionalParams,
  ): Promise<InferenceGroupsListDeltaModelsAsyncResponse> {
    return this.client.sendOperationRequest(
      { resourceGroupName, workspaceName, poolName, groupName, body, options },
      listDeltaModelsAsyncOperationSpec,
    );
  }
   ...
   * @param options The options parameters.
   */
  async beginModifyDeltaModelsAsync(
    resourceGroupName: string,
    workspaceName: string,
    poolName: string,
    groupName: string,
  ...
  > {
    ...
    const lro = createLroSpec({
      ...
      spec: modifyDeltaModelsAsyncOperationSpec,
    });
    const poller = await createHttpPoller<
      InferenceGroupsModifyDeltaModelsAsyncResponse,
      OperationState<InferenceGroupsModifyDeltaModelsAsyncResponse>
   ...
   * @param options The options parameters.
   */
  async beginModifyDeltaModelsAsyncAndWait(
    resourceGroupName: string,
    workspaceName: string,
    poolName: string,
    groupName: string,
    ...
    const poller = await this.beginModifyDeltaModelsAsync(
      resourceGroupName,
      workspaceName,
      poolName,
      groupName,
  ...
  /**
   * ListDeltaModelsAsyncNext
   * @param resourceGroupName The name of the resource group. The name is case insensitive.
   * @param workspaceName Name of Azure Machine Learning workspace.
   * @param poolName InferencePool name.
   * @param groupName InferenceGroup name.
   * @param body DeltaModelBaseRequest.
   * @param nextLink The nextLink from the previous successful call to the ListDeltaModelsAsync method.
   * @param options The options parameters.
   */
  private _listDeltaModelsAsyncNext(
    resourceGroupName: string,
    workspaceName: string,
    poolName: string,
    groupName: string,
    body: DeltaModelListRequest,
    nextLink: string,
    options?: InferenceGroupsListDeltaModelsAsyncNextOptionalParams,
  ): Promise<InferenceGroupsListDeltaModelsAsyncNextResponse> {
    return this.client.sendOperationRequest(
      {
        resourceGroupName,
        workspaceName,
      ...
      listDeltaModelsAsyncNextOperationSpec,
    );
  }
...
const getDeltaModelsStatusAsyncOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.DeltaModelStatusResponse,
    },
    default: {
      bodyMapper: Mappers.ErrorResponse,
    },
...
const listDeltaModelsAsyncOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.StringArmPaginatedResult,
    },
    default: {
      bodyMapper: Mappers.ErrorResponse,
    },
...
const modifyDeltaModelsAsyncOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      headersMapper: Mappers.InferenceGroupsModifyDeltaModelsAsyncHeaders,
    },
    201: {
      headersMapper: Mappers.InferenceGroupsModifyDeltaModelsAsyncHeaders,
    },
...
const listDeltaModelsAsyncNextOperationSpec: coreClient.OperationSpec = {
  path: "{nextLink}",
  httpMethod: "GET",
  responses: {
    200: {
