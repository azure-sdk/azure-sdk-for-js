...
import { RegistryDataContainers } from "../operationsInterfaces/index.js";
...
export class RegistryDataContainersImpl implements RegistryDataContainers {
  ...
  async beginDeleteAndWait(
    ...
    const poller = await this.beginDelete(resourceGroupName, registryName, name, options);
...
const listOperationSpec: coreClient.OperationSpec = {
  ...
  queryParameters: [Parameters.apiVersion, Parameters.skip, Parameters.listViewType],
  urlParameters: [
    Parameters.$host,
