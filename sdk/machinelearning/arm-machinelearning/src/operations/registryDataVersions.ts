...
import {
  ...
  RegistryDataVersionsCreateOrGetPendingUploadOptionalParams,
  RegistryDataVersionsCreateOrGetPendingUploadResponse,
...
export class RegistryDataVersionsImpl implements RegistryDataVersions {
  ...
  createOrGetPendingUpload(
    ...
    options?: RegistryDataVersionsCreateOrGetPendingUploadOptionalParams
  ): Promise<RegistryDataVersionsCreateOrGetPendingUploadResponse> {
    return this.client.sendOperationRequest(
