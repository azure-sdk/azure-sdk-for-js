...
export class RegistryComponentContainersImpl implements RegistryComponentContainers {
  ...
  async beginDeleteAndWait(
    ...
    const poller = await this.beginDelete(resourceGroupName, registryName, componentName, options);
