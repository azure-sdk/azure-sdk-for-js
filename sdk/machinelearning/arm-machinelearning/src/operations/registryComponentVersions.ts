...
import {
  ...
  RegistryComponentVersionsGetBlobReferenceSASOptionalParams,
  RegistryComponentVersionsGetBlobReferenceSASResponse,
...
export class RegistryComponentVersionsImpl
  ...
  getBlobReferenceSAS(
    ...
    options?: RegistryComponentVersionsGetBlobReferenceSASOptionalParams
  ): Promise<RegistryComponentVersionsGetBlobReferenceSASResponse> {
    return this.client.sendOperationRequest(
      {
        resourceGroupName,
        registryName,
