...
import {
  InferenceEndpointMinimalTrackedResource,
...
export class InferenceEndpointsImpl implements InferenceEndpoints {
  ...
  ): PagedAsyncIterableIterator<InferenceEndpointMinimalTrackedResource> {
  ...
  ): AsyncIterableIterator<InferenceEndpointMinimalTrackedResource[]> {
  ...
  get(
    ...
    return this.client.sendOperationRequest(
      { resourceGroupName, workspaceName, poolName, groupName, name, options },
      getOperationSpec
    );
  }
  ...
  async beginCreateOrUpdate(
    ...
    groupName: string,
    name: string,
    body: InferenceEndpointMinimalTrackedResource,
...
const listOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper:
        Mappers.InferenceEndpointMinimalTrackedResourceArmPaginatedResult
    },
    default: {
...
const getOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.InferenceEndpointMinimalTrackedResource
    },
    default: {
      bodyMapper: Mappers.ErrorResponse
    }
