...
import { InferenceEndpoints } from "../operationsInterfaces/index.js";
...
export class InferenceEndpointsImpl implements InferenceEndpoints {
  ...
  public list(
    ...
    const iter = this.listPagingAll(resourceGroupName, workspaceName, poolName, options);
    return {
      next() {
        return iter.next();
      },
      ...
      byPage: (settings?: PageSettings) => {
        ...
        return this.listPagingPage(resourceGroupName, workspaceName, poolName, options, settings);
      },
    };
  }
  ...
  private async *listPagingPage(
    ...
    if (!continuationToken) {
      result = await this._list(resourceGroupName, workspaceName, poolName, options);
