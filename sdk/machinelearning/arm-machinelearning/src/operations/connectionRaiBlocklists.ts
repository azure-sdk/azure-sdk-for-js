...
import { ConnectionRaiBlocklists } from "../operationsInterfaces/index.js";
...
export class ConnectionRaiBlocklistsImpl implements ConnectionRaiBlocklists {
  ...
  public list(
    ...
    const iter = this.listPagingAll(resourceGroupName, workspaceName, connectionName, options);
    return {
      next() {
        return iter.next();
      },
  ...
  private async *listPagingPage(
    ...
    if (!continuationToken) {
      result = await this._list(resourceGroupName, workspaceName, connectionName, options);
