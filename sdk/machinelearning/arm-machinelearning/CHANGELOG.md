...
**Features**
  ...
  - Added Interface ManagedNetworkProvisionsPostHeaders
  - Added Interface ManagedNetworkProvisionsPostOptionalParams
  ...
  - Added Type Alias ManagedNetworkProvisionsPostResponse
  ...
  - Added Type Alias OutboundNetworkDependenciesEndpointsResponse
  ...
  - Interface AmlOperation has a new optional parameter origin
  ...
  - Interface WorkspacesUpdateOptionalParams has a new optional parameter body
...
**Breaking Changes**
  ...
  - Removed operation Workspaces.listOutboundNetworkDependenciesEndpoints
  ...
  - Interface WorkspacesListByResourceGroupOptionalParams no longer has parameter skip
  - Interface WorkspacesListBySubscriptionNextOptionalParams no longer has parameter skip
  - Interface WorkspacesListBySubscriptionOptionalParams no longer has parameter skip
  ...
  - Type of parameter provisioningState of interface PrivateEndpointConnection is changed from PrivateEndpointConnectionProvisioningState to EndpointServiceConnectionStatus
