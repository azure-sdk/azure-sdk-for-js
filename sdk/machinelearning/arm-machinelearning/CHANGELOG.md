...
**Features**
  ...
  - Added operation group Indexes
  - Added operation group IndexesVersions
  ...
  - Added Interface Index
  - Added Interface IndexColumn
  - Added Interface IndexContainerProperties
  - Added Interface IndexesListByWorkspaceNextOptionalParams
  - Added Interface IndexesListByWorkspaceOptionalParams
  - Added Interface IndexesVersionsCreateOrUpdateOptionalParams
  - Added Interface IndexesVersionsGetOptionalParams
  - Added Interface IndexesVersionsListByIndexNextOptionalParams
  - Added Interface IndexesVersionsListByIndexOptionalParams
  - Added Interface IndexListResult
  - Added Interface IndexVersion
  - Added Interface IndexVersionListResult
  - Added Interface IndexVersionProperties
  ...
  - Added Interface ResourceBaseAutoGenerated
  ...
  - Added Type Alias IndexesListByWorkspaceNextResponse
  - Added Type Alias IndexesListByWorkspaceResponse
  - Added Type Alias IndexesVersionsCreateOrUpdateResponse
  - Added Type Alias IndexesVersionsGetResponse
  - Added Type Alias IndexesVersionsListByIndexNextResponse
  - Added Type Alias IndexesVersionsListByIndexResponse
