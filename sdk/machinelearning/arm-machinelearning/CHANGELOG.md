...
**Features**
  ...
  - Added Interface AnonymousAccessCredentialDto
  ...
  - Added Interface BlobReferenceSASRequestDto
  - Added Interface BlobReferenceSASResponseDto
  - Added Interface CodeVersionsCreateOrGetStartPendingUploadOptionalParams
  - Added Interface Cron
  - Added Interface CustomService
  - Added Interface DataReferenceCredentialDto
  - Added Interface Docker
  - Added Interface DockerCredentialDto
  ...
  - Added Interface ManagedIdentityCredentialDto
  - Added Interface Nodes
  - Added Interface PartialRegistryPartialTrackedResource
  - Added Interface PendingUploadBlobReferenceForConsumptionDto
  ...
  - Added Interface PendingUploadSASCredentialDto
  ...
  - Added Interface RegistryCodeVersionsGetBlobReferenceSASOptionalParams
  ...
  - Added Interface RegistryComponentVersionsGetBlobReferenceSASOptionalParams
  ...
  - Added Interface RegistryDataVersionsGetBlobReferenceSASOptionalParams
  ...
  - Added Interface RegistryEnvironmentVersionsGetBlobReferenceSASOptionalParams
  ...
  - Added Interface RegistryModelVersionsGetBlobReferenceSASOptionalParams
  ...
  - Added Type Alias DataReferenceCredentialDtoUnion
  ...
  - Added Type Alias RegistryCodeVersionsGetBlobReferenceSASResponse
  ...
  - Added Type Alias RegistryComponentVersionsGetBlobReferenceSASResponse
  ...
  - Added Type Alias RegistryDataVersionsGetBlobReferenceSASResponse
  ...
  - Added Type Alias RegistryEnvironmentVersionsGetBlobReferenceSASResponse
  ...
  - Added Type Alias RegistryModelVersionsGetBlobReferenceSASResponse
