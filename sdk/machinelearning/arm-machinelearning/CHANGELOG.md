...
**Features**
  ...
  - Added Interface Trial
  - Added Interface TrialPipelineComponent
  ...
  - Added Type Alias TrialType
  - Added Type Alias TrialUnion
...
**Breaking Changes**
  ...
  - Interface TrialComponent has a new required parameter trialType
  ...
  - Type of parameter trial of interface SweepJob is changed from TrialComponent to TrialUnion
