...
**Breaking Changes**
  ...
  - Type of parameter provisioningState of interface Compute is changed from ProvisioningState to ComputeProvisioningState
  ...
  - Type of parameter provisioningState of interface Workspace is changed from ProvisioningState to WorkspaceProvisioningState
  ...
  - Type of parameter category of interface WorkspaceConnectionPropertiesV2 is changed from ConnectionCategory to string
