...
**Features**
  ...
  - Added operation CodeVersions.createOrGetPendingUpload
  ...
  - Added Interface CodeVersionsCreateOrGetPendingUploadOptionalParams
  ...
  - Added Interface FeatureArmPaginatedResult
  ...
  - Added Interface FeaturesetVersionsGetFeatureOptionalParams
  - Added Interface FeaturesetVersionsGetOptionalParams
  - Added Interface FeaturesetVersionsListFeaturesNextOptionalParams
  ...
  - Added Interface GetFeatureRequest
  ...
  - Added Interface ModelPerformanceSignalBase
  ...
  - Added Interface MonitoringInputData
  ...
  - Added Interface RegistryCodeVersionsCreateOrGetPendingUploadOptionalParams
  ...
  - Added Interface RegistryModelVersionsCreateOrGetPendingUploadOptionalParams
  ...
  - Added Interface SkuResourceArmPaginatedResultAutoGenerated
  - Added Interface SkuResourceAutoGenerated
  - Added Interface SkuSettingAutoGenerated
  ...
  - Added Type Alias CodeVersionsCreateOrGetPendingUploadResponse
  ...
  - Added Type Alias FeaturesetVersionsGetFeatureResponse
  - Added Type Alias FeaturesetVersionsGetResponse
  - Added Type Alias FeaturesetVersionsListFeaturesNextResponse
  ...
  - Added Type Alias MonitoringInputDataContext
  ...
  - Added Type Alias RegistryCodeVersionsCreateOrGetPendingUploadResponse
  ...
  - Added Type Alias RegistryModelVersionsCreateOrGetPendingUploadResponse
  ...
  - Added Enum KnownMonitoringInputDataContext
