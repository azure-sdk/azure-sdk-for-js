...
export class AzureMachineLearningServices extends coreClient.ServiceClient {
    ...
    // (undocumented)
    standbyPoolOperations: StandbyPoolOperations;
    // (undocumented)
    subscriptionId: string;
    // (undocumented)
    usages: Usages;
...
// @public
export interface StandbyPool extends TrackedResourceAutoGenerated {
    count?: number;
    namePropertiesName?: string;
    standbyAvailableInstances?: StandbyPoolResourceStatus[];
    vmSize?: string;
}

// @public
export interface StandbyPoolCreateOptionalParams extends coreClient.OperationOptions {
}

// @public
export interface StandbyPoolCreateOrUpdateOptionalParams extends coreClient.OperationOptions {
    ifMatch?: string;
    ifNoneMatch?: string;
}

// @public
export interface StandbyPoolDeleteOptionalParams extends coreClient.OperationOptions {
}

// @public
export type StandbyPoolDeleteResponse = StandbyPool;

// @public
export interface StandbyPoolGetOptionalParams extends coreClient.OperationOptions {
}

// @public
export type StandbyPoolGetResponse = StandbyPool;

// @public
export interface StandbyPoolListOptionalParams extends coreClient.OperationOptions {
}

// @public
export interface StandbyPoolOperations {
    create(resourceGroupName: string, workspaceName: string, standbyPoolName: string, body: StandbyPoolProperties, options?: StandbyPoolCreateOptionalParams): Promise<void>;
    createOrUpdate(resourceGroupName: string, workspaceName: string, standbyPoolName: string, body: StandbyPoolProperties, options?: StandbyPoolCreateOrUpdateOptionalParams): Promise<void>;
    delete(resourceGroupName: string, workspaceName: string, standbyPoolName: string, options?: StandbyPoolDeleteOptionalParams): Promise<StandbyPoolDeleteResponse>;
    get(resourceGroupName: string, workspaceName: string, standbyPoolName: string, options?: StandbyPoolGetOptionalParams): Promise<StandbyPoolGetResponse>;
    list(resourceGroupName: string, workspaceName: string, options?: StandbyPoolListOptionalParams): Promise<void>;
}

// @public
export interface StandbyPoolProperties {
    count?: number;
    name?: string;
    standbyAvailableInstances?: StandbyPoolResourceStatus[];
    vmSize?: string;
...
// @public
export interface StandbyPoolResourceStatus {
    error?: CloudError;
    status?: string;
}
