...
export interface RegistryDataVersions {
    ...
    createOrGetPendingUpload(resourceGroupName: string, registryName: string, name: string, version: string, body: PendingUploadRequestDto, options?: RegistryDataVersionsCreateOrGetPendingUploadOptionalParams): Promise<RegistryDataVersionsCreateOrGetPendingUploadResponse>;
...
// @public
export interface RegistryDataVersionsCreateOrGetPendingUploadOptionalParams extends coreClient.OperationOptions {
}

// @public
export type RegistryDataVersionsCreateOrGetPendingUploadResponse = PendingUploadResponseDto;
