...
export interface Trial {
    trialType: "CommandComponent" | "PipelineComponent";
}

// @public
export interface TrialComponent extends Trial {
    codeId?: string;
    command: string;
    distribution?: DistributionConfigurationUnion;
    environmentId: string;
    ...
    resources?: JobResourceConfiguration;
    trialType: "CommandComponent";
}

// @public (undocumented)
export interface TrialPipelineComponent extends Trial {
    componentId?: string;
    trialType: "PipelineComponent";
}

// @public
export type TrialType = string;

// @public (undocumented)
export type TrialUnion = Trial | TrialComponent | TrialPipelineComponent;
