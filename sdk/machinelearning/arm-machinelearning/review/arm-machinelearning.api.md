...
export interface EndpointDeploymentResourceProperties {
    ...
    type: "managedOnlineEndpoint" | "Azure.OpenAI" | "Azure.Speech" | "Azure.ContentSafety";
}
...
// @public (undocumented)
export type EndpointDeploymentResourcePropertiesUnion = EndpointDeploymentResourceProperties | ManagedOnlineEndpointDeploymentResourceProperties | OpenAIEndpointDeploymentResourceProperties | SpeechEndpointDeploymentResourceProperties | ContentSafetyEndpointDeploymentResourceProperties;
