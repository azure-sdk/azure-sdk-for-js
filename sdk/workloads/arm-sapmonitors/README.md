...
- [Source code](https://github.com/Azure/azure-sdk-for-js/tree/main/sdk/workloads/arm-sapmonitors)
- [Package (NPM)](https://www.npmjs.com/package/@azure/arm-sapmonitors)
- [API reference documentation](https://learn.microsoft.com/javascript/api/@azure/arm-sapmonitors?view=azure-node-preview)
- [Samples](https://github.com/Azure/azure-sdk-for-js/tree/main/sdk/workloads/arm-sapmonitors/samples)
...
### Install the `@azure/arm-sapmonitors` package

Install the Azure Workloads client library for JavaScript with `npm`:

```bash
npm install @azure/arm-sapmonitors
```
...
Please take a look at the [samples](https://github.com/Azure/azure-sdk-for-js/tree/main/sdk/workloads/arm-sapmonitors/samples) directory for detailed examples on how to use this library.
