...
import { _$deleteDeserialize, _createDeserialize } from "./api/alerts/operations.js";
import {
  _$deleteDeserialize as _$deleteDeserializeProviderInstances,
  _createDeserialize as _createDeserializeProviderInstances,
} from "./api/providerInstances/operations.js";
import {
  _$deleteDeserialize as _$deleteDeserializeMonitors,
  _updateDeserialize,
...
const deserializeMap: Record<string, DeserializationHelper> = {
  ...
  "DELETE /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Workloads/monitors/{monitorName}/providerInstances/{providerInstanceName}":
    {
      deserializer: _$deleteDeserializeProviderInstances,
      expectedStatuses: ["202", "204", "200"],
    },
  "PUT /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Workloads/monitors/{monitorName}/providerInstances/{providerInstanceName}":
    {
      deserializer: _createDeserializeProviderInstances,
  ...
  "DELETE /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Workloads/monitors/{monitorName}":
    {
      deserializer: _$deleteDeserializeMonitors,
      expectedStatuses: ["202", "204", "200"],
    },
