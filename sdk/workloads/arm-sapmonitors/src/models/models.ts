...
export function alertTemplatePropertiesDeserializer(item: any): AlertTemplateProperties {
  return {
    errors: !item["errors"] ? item["errors"] : errorDetailDeserializer(item["errors"]),
    ...
    queryInputParameters: !item["queryInputParameters"]
      ...
      : alertTemplateQueryInputParameterArrayDeserializer(item["queryInputParameters"]),
  };
}
...
export function _alertTemplateListResultDeserializer(item: any): _AlertTemplateListResult {
  return {
...
export function alertTemplateArrayDeserializer(result: Array<AlertTemplate>): any[] {
  return result.map((item) => {
...
export function alertQueryParameterArraySerializer(result: Array<AlertQueryParameter>): any[] {
  return result.map((item) => {
    return alertQueryParameterSerializer(item);
  });
}

export function alertQueryParameterArrayDeserializer(result: Array<AlertQueryParameter>): any[] {
  return result.map((item) => {
...
export function alertQueryParameterDeserializer(item: any): AlertQueryParameter {
  return {
    name: item["name"],
    value: item["value"],
  };
...
export function sapLandscapeMonitorResourceSerializer(item: SapLandscapeMonitorResource): any {
  return {
    properties: !item["properties"]
      ? item["properties"]
...
export function sapLandscapeMonitorResourceDeserializer(item: any): SapLandscapeMonitorResource {
  return {
    id: item["id"],
    name: item["name"],
    type: item["type"],
...
export function sapLandscapeMonitorPropertiesSerializer(item: SapLandscapeMonitorProperties): any {
  return {
    ...
    topMetricsThresholds: !item["topMetricsThresholds"]
      ...
      : sapLandscapeMonitorMetricThresholdsArraySerializer(item["topMetricsThresholds"]),
  };
}
...
export function sapLandscapeMonitorPropertiesDeserializer(
  ...
  return {
    ...
    topMetricsThresholds: !item["topMetricsThresholds"]
      ? item["topMetricsThresholds"]
      : sapLandscapeMonitorMetricThresholdsArrayDeserializer(item["topMetricsThresholds"]),
  };
}
...
export function sapLandscapeMonitorSidMappingSerializer(item: SapLandscapeMonitorSidMapping): any {
  return {
    name: item["name"],
    topSid: !item["topSid"]
      ? item["topSid"]
...
export function providerInstancePropertiesDeserializer(item: any): ProviderInstanceProperties {
  return {
    provisioningState: item["provisioningState"],
    health: !item["health"] ? item["health"] : healthDeserializer(item["health"]),
    errors: !item["errors"] ? item["errors"] : errorDetailDeserializer(item["errors"]),
    providerSettings: !item["providerSettings"]
      ? item["providerSettings"]
...
export function providerSpecificPropertiesSerializer(item: ProviderSpecificProperties): any {
  return { providerType: item["providerType"] };
}

export function providerSpecificPropertiesDeserializer(item: any): ProviderSpecificProperties {
  return {
    providerType: item["providerType"],
  };
}
...
export function providerSpecificPropertiesUnionSerializer(
  ...
  switch (item.providerType) {
    case "SapHana":
      return hanaDbProviderInstancePropertiesSerializer(item as HanaDbProviderInstanceProperties);
    ...
    case "Db2":
      return db2ProviderInstancePropertiesSerializer(item as Db2ProviderInstanceProperties);
    ...
    case "Oracle":
      return oracleProviderInstancePropertiesSerializer(item as OracleProviderInstanceProperties);
...
export function providerSpecificPropertiesUnionDeserializer(
  ...
  switch (item.providerType) {
    case "SapHana":
      return hanaDbProviderInstancePropertiesDeserializer(item as HanaDbProviderInstanceProperties);
    ...
    case "Db2":
      return db2ProviderInstancePropertiesDeserializer(item as Db2ProviderInstanceProperties);
    ...
    case "Oracle":
      return oracleProviderInstancePropertiesDeserializer(item as OracleProviderInstanceProperties);
...
export function db2ProviderInstancePropertiesSerializer(item: Db2ProviderInstanceProperties): any {
  return {
    providerType: item["providerType"],
    hostname: item["hostname"],
    dbName: item["dbName"],
...
export function monitorPropertiesDeserializer(item: any): MonitorProperties {
  return {
    ...
    appServicePlanConfiguration: !item["appServicePlanConfiguration"]
      ? item["appServicePlanConfiguration"]
      : appServicePlanConfigurationDeserializer(item["appServicePlanConfiguration"]),
...
export function appServicePlanConfigurationSerializer(item: AppServicePlanConfiguration): any {
  return { tier: item["tier"], capacity: item["capacity"] };
}

export function appServicePlanConfigurationDeserializer(item: any): AppServicePlanConfiguration {
  return {
    tier: item["tier"],
...
export function updateMonitorRequestSerializer(item: UpdateMonitorRequest): any {
  return {
    tags: item["tags"],
    identity: !item["identity"]
      ? item["identity"]
