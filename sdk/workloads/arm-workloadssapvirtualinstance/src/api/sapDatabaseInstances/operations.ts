...
export function sapDatabaseInstancesStop(
  ...
  return getLongRunningPoller(context, _sapDatabaseInstancesStopDeserialize, ["202", "200"], {
...
export function sapDatabaseInstancesStart(
  ...
  return getLongRunningPoller(context, _sapDatabaseInstancesStartDeserialize, ["202", "200"], {
    updateIntervalInMs: options?.updateIntervalInMs,
    abortSignal: options?.abortSignal,
    getInitialResponse: () =>
...
export function sapDatabaseInstancesList(
  ...
  return buildPagedAsyncIterator(
    context,
    () =>
      _sapDatabaseInstancesListSend(context, resourceGroupName, sapVirtualInstanceName, options),
