...
export function sAPCentralServerInstancesStop(
  ...
  return getLongRunningPoller(context, _sAPCentralServerInstancesStopDeserialize, ["202", "200"], {
...
export function sAPCentralServerInstancesStart(
  ...
  return getLongRunningPoller(context, _sAPCentralServerInstancesStartDeserialize, ["202", "200"], {
    updateIntervalInMs: options?.updateIntervalInMs,
    abortSignal: options?.abortSignal,
    getInitialResponse: () =>
