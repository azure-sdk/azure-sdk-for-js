...
export async function sAPVirtualInstancesGetSapSupportedSku(
  ...
  const result = await _sAPVirtualInstancesGetSapSupportedSkuSend(context, location, body, options);
...
export function sAPVirtualInstancesStop(
  ...
  return getLongRunningPoller(context, _sAPVirtualInstancesStopDeserialize, ["202", "200"], {
    updateIntervalInMs: options?.updateIntervalInMs,
    abortSignal: options?.abortSignal,
    getInitialResponse: () =>
      _sAPVirtualInstancesStopSend(context, resourceGroupName, sapVirtualInstanceName, options),
...
export function sAPVirtualInstancesStart(
  ...
  return getLongRunningPoller(context, _sAPVirtualInstancesStartDeserialize, ["202", "200"], {
    updateIntervalInMs: options?.updateIntervalInMs,
    abortSignal: options?.abortSignal,
    getInitialResponse: () =>
      _sAPVirtualInstancesStartSend(context, resourceGroupName, sapVirtualInstanceName, options),
    resourceLocationConfig: "location",
  }) as PollerLike<OperationState<OperationStatusResult>, OperationStatusResult>;
}
...
export function sAPVirtualInstancesListByResourceGroup(
  ...
  return buildPagedAsyncIterator(
    context,
    () => _sAPVirtualInstancesListByResourceGroupSend(context, resourceGroupName, options),
...
export function sAPVirtualInstancesDelete(
  ...
  return getLongRunningPoller(
    ...
    ["202", "204", "200"],
    {
      ...
      abortSignal: options?.abortSignal,
      getInitialResponse: () =>
        _sAPVirtualInstancesDeleteSend(context, resourceGroupName, sapVirtualInstanceName, options),
      resourceLocationConfig: "location",
    },
