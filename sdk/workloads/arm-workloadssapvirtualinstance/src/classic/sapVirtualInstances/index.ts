...
function _getSAPVirtualInstances(context: WorkloadsContext) {
  return {
    ...
    stop: (
      ...
      sapVirtualInstanceName: string,
      options?: SAPVirtualInstancesStopOptionalParams,
    ) => sAPVirtualInstancesStop(context, resourceGroupName, sapVirtualInstanceName, options),
    start: (
      resourceGroupName: string,
      sapVirtualInstanceName: string,
      options?: SAPVirtualInstancesStartOptionalParams,
    ) => sAPVirtualInstancesStart(context, resourceGroupName, sapVirtualInstanceName, options),
