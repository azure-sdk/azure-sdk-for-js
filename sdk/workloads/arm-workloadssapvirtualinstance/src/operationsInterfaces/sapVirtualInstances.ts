...
export interface SapVirtualInstances {
  ...
  ): Promise<SapVirtualInstancesGetAvailabilityZoneDetailsResponse>;
  /**
  ...
  ): Promise<SapVirtualInstancesGetDiskConfigurationsResponse>;
  /**
  ...
  ): Promise<SapVirtualInstancesGetSapSupportedSkuResponse>;
  /**
  ...
  ): Promise<SapVirtualInstancesGetSizingRecommendationsResponse>;
  /**
