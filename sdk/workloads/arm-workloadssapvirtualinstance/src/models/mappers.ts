...
export const SAPVirtualInstanceIdentity: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "SAPVirtualInstanceIdentity",
    modelProperties: {
      type: {
        serializedName: "type",
        required: true,
...
export const Components1IrwhnvSchemasSapvirtualinstanceidentityPropertiesUserassignedidentitiesAdditionalproperties: coreClient.CompositeMapper =
  {
    type: {
      name: "Composite",
      className:
