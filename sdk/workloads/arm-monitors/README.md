...
[Source code](https://github.com/Azure/azure-sdk-for-js/tree/main/sdk/workloads/arm-monitors) |
[Package (NPM)](https://www.npmjs.com/package/@azure/arm-workloads-monitors) |
[API reference documentation](https://docs.microsoft.com/javascript/api/@azure/arm-workloads-monitors?view=azure-node-preview) |
...
### Install the `@azure/arm-workloads-monitors` package

Install the Azure Workloads client library for JavaScript with `npm`:

```bash
npm install @azure/arm-workloads-monitors
```
...
```javascript
const { WorkloadsClient } = require("@azure/arm-workloads-monitors");
...
![Impressions](https://azure-sdk-impressions.azurewebsites.net/api/impressions/azure-sdk-for-js%2Fsdk%2Fworkloads%2Farm-monitors%2FREADME.png)
