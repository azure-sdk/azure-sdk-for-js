...
export const MonitorManagedResourceGroupConfiguration: coreClient.CompositeMapper =
  {
    type: {
      name: "Composite",
      className: "MonitorManagedResourceGroupConfiguration",
      modelProperties: {
        name: {
          serializedName: "name",
          type: {
...
export const MonitorAppServicePlanConfiguration: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "MonitorAppServicePlanConfiguration",
    modelProperties: {
      tier: {
        serializedName: "tier",
        type: {
...
export const MonitorUpdateMonitorRequest: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "MonitorUpdateMonitorRequest",
    modelProperties: {
      tags: {
        serializedName: "tags",
        type: {
...
export const ProviderHealth: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ProviderHealth",
    modelProperties: {
      healthState: {
        ...
        value: {
          ...
          type: {
            ...
            element: {
              type: {
                name: "Composite",
                className: "SapLandscapeMonitorSapLandscapeMonitorResource",
              },
            },
          },
        },
...
export const SapLandscapeMonitorPropertyGrouping: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "SapLandscapeMonitorPropertyGrouping",
    modelProperties: {
      landscape: {
        constraints: {
          MaxItems: 50,
...
export const ProviderProvidersDb2Properties: coreClient.CompositeMapper = {
  serializedName: "Db2",
  type: {
    name: "Composite",
    className: "ProviderProvidersDb2Properties",
    uberParent: "ProviderSpecificProperties",
    polymorphicDiscriminator:
...
export const ProviderProvidersHanaDbProperties: coreClient.CompositeMapper = {
  serializedName: "SapHana",
  type: {
    name: "Composite",
    className: "ProviderProvidersHanaDbProperties",
    uberParent: "ProviderSpecificProperties",
    polymorphicDiscriminator:
      ProviderSpecificProperties.type.polymorphicDiscriminator,
    modelProperties: {
...
export const ProviderProvidersMsSqlServerProperties: coreClient.CompositeMapper =
  {
    serializedName: "MsSqlServer",
    type: {
      name: "Composite",
      className: "ProviderProvidersMsSqlServerProperties",
      uberParent: "ProviderSpecificProperties",
      polymorphicDiscriminator:
        ProviderSpecificProperties.type.polymorphicDiscriminator,
      modelProperties: {
...
export const ProviderProvidersPrometheusHaClusterProperties: coreClient.CompositeMapper =
  {
    serializedName: "PrometheusHaCluster",
    type: {
      name: "Composite",
      className: "ProviderProvidersPrometheusHaClusterProperties",
      uberParent: "ProviderSpecificProperties",
      polymorphicDiscriminator:
        ProviderSpecificProperties.type.polymorphicDiscriminator,
      modelProperties: {
...
export const ProviderProvidersPrometheusOsProperties: coreClient.CompositeMapper =
  {
    serializedName: "PrometheusOS",
    type: {
      name: "Composite",
      className: "ProviderProvidersPrometheusOsProperties",
      uberParent: "ProviderSpecificProperties",
      polymorphicDiscriminator:
        ProviderSpecificProperties.type.polymorphicDiscriminator,
      modelProperties: {
...
export const ProviderProvidersSapNetWeaverProperties: coreClient.CompositeMapper =
  {
    serializedName: "SapNetWeaver",
    type: {
      name: "Composite",
      className: "ProviderProvidersSapNetWeaverProperties",
      uberParent: "ProviderSpecificProperties",
      polymorphicDiscriminator:
        ProviderSpecificProperties.type.polymorphicDiscriminator,
      modelProperties: {
...
export const SapLandscapeMonitorSapLandscapeMonitorResource: coreClient.CompositeMapper =
  {
    type: {
      name: "Composite",
      className: "SapLandscapeMonitorSapLandscapeMonitorResource",
...
export let discriminators = {
  ...
  "ProviderSpecificProperties.Db2": ProviderProvidersDb2Properties,
  "ProviderSpecificProperties.SapHana": ProviderProvidersHanaDbProperties,
