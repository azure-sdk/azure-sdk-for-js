...
export interface ProviderProvidersDb2Properties
...
export interface ProviderProvidersHanaDbProperties
  extends ProviderSpecificProperties {
  /** Polymorphic discriminator, which specifies the different types this object can be */
...
export interface ProviderProvidersMsSqlServerProperties
  extends ProviderSpecificProperties {
  /** Polymorphic discriminator, which specifies the different types this object can be */
...
export interface ProviderProvidersPrometheusHaClusterProperties
  extends ProviderSpecificProperties {
  /** Polymorphic discriminator, which specifies the different types this object can be */
...
export interface ProviderProvidersPrometheusOsProperties
  extends ProviderSpecificProperties {
  /** Polymorphic discriminator, which specifies the different types this object can be */
...
export interface ProviderProvidersSapNetWeaverProperties
  extends ProviderSpecificProperties {
  /** Polymorphic discriminator, which specifies the different types this object can be */
...
export interface SapLandscapeMonitorSapLandscapeMonitorResource
 ...
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **SapHana**: SapHana Provider. \
 * **SapNetWeaver**: SapNetWeaver Provider. \
 * **PrometheusOS**: PrometheusOS Provider. \
 * **MsSqlServer**: MsSqlServer Provider. \
 * **PrometheusHaCluster**: PrometheusHaCluster Provider. \
 * **Db2**: Db2 Provider.
 */
...
/** Contains response data for the get operation. */
export type SapLandscapeMonitorGetResponse =
...
/** Contains response data for the create operation. */
export type SapLandscapeMonitorCreateResponse =
  SapLandscapeMonitorSapLandscapeMonitorResource;
...
/** Contains response data for the update operation. */
export type SapLandscapeMonitorUpdateResponse =
  SapLandscapeMonitorSapLandscapeMonitorResource;
