...
import {
  ...
  Db2JobConfiguration as Db2JobConfigurationMapper,
...
export const alertParameter: OperationParameter = {
  parameterPath: "alertParameter",
  mapper: AlertMapper,
};

export const jobConfigurationName: OperationURLParameter = {
  parameterPath: "jobConfigurationName",
  mapper: {
    constraints: {
      Pattern: new RegExp("^[a-zA-Z0-9-_]+$"),
    },
...
export const db2JobConfigurationsParameter: OperationParameter = {
  parameterPath: "db2JobConfigurationsParameter",
  mapper: Db2JobConfigurationMapper,
};
