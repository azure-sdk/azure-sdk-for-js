...
export class SapLandscapeMonitorImpl implements SapLandscapeMonitor {
  ...
  ): PagedAsyncIterableIterator<SapLandscapeMonitorSapLandscapeMonitorResource> {
  ...
  ): AsyncIterableIterator<SapLandscapeMonitorSapLandscapeMonitorResource[]> {
  ...
  create(
    resourceGroupName: string,
    monitorName: string,
    resource: SapLandscapeMonitorSapLandscapeMonitorResource,
  ...
  update(
    resourceGroupName: string,
    monitorName: string,
    properties: SapLandscapeMonitorSapLandscapeMonitorResource,
...
const getOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.SapLandscapeMonitorSapLandscapeMonitorResource,
    },
    default: {
      bodyMapper: Mappers.ErrorResponse,
    },
