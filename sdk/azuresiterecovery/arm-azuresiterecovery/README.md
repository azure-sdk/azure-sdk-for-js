...
[Source code](https://github.com/Azure/azure-sdk-for-js/tree/main/sdk/azuresiterecovery/arm-azuresiterecovery) |
[Package (NPM)](https://www.npmjs.com/package/@azure/arm-azuresiterecovery) |
[API reference documentation](https://docs.microsoft.com/javascript/api/@azure/arm-azuresiterecovery?view=azure-node-preview) |
...
### Install the `@azure/arm-azuresiterecovery` package

Install the Azure Site Recovery Management client library for JavaScript with `npm`:

```bash
npm install @azure/arm-azuresiterecovery
```
...
```javascript
const { AzureSiteRecoveryManagementServiceAPI } = require("@azure/arm-azuresiterecovery");
...
![Impressions](https://azure-sdk-impressions.azurewebsites.net/api/impressions/azure-sdk-for-js%2Fsdk%2Fazuresiterecovery%2Farm-azuresiterecovery%2FREADME.png)
