...
export interface Gates {
    beginUpdate(resourceGroupName: string, fleetName: string, gateName: string, properties: GateUpdate, options?: GatesUpdateOptionalParams): Promise<SimplePollerLike<OperationState<GatesUpdateResponse>, GatesUpdateResponse>>;
    beginUpdateAndWait(resourceGroupName: string, fleetName: string, gateName: string, properties: GateUpdate, options?: GatesUpdateOptionalParams): Promise<GatesUpdateResponse>;
