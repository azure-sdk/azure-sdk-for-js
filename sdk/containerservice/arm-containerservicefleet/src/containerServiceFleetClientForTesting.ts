...
import { ContainerServiceFleetClientForTestingOptionalParams } from "./models";

export class ContainerServiceFleetClientForTesting extends coreClient.ServiceClient {
  $host: string;
  apiVersion: string;
  subscriptionId: string;

  /**
   * Initializes a new instance of the ContainerServiceFleetClientForTesting class.
  ...
  constructor(
    ...
    subscriptionId: string,
    options?: ContainerServiceFleetClientForTestingOptionalParams,
  ) {
    ...
    const defaults: ContainerServiceFleetClientForTestingOptionalParams = {
