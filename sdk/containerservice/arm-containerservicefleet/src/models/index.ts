...
export enum KnownManagedClusterUpgradeType {
  ...
  /** ControlPlaneOnly upgrades only the control plane of the target ManagedClusters. */
 ...
 * **ControlPlaneOnly**: ControlPlaneOnly upgrades only the control plane of the target ManagedClusters.
 */
