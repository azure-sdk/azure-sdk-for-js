...
## 17.2.0-beta.1 (2022-08-31)
    
**Features**

  - Added operation group GuardrailsVersions
  ...
  - Added Interface ListGuardrailsVersionsResponse
  ...
  - Added Type Alias GuardrailsVersionsListResponse
  ...
  - Class ContainerServiceClient has a new parameter guardrailsVersions
