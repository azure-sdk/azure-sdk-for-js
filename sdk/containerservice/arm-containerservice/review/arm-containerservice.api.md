...
export interface ContainerServices {
    listOrchestrators(location: string, options?: ContainerServicesListOrchestratorsOptionalParams): Promise<ContainerServicesListOrchestratorsResponse>;
}

// @public
export interface ContainerServicesListOrchestratorsOptionalParams extends coreClient.OperationOptions {
    resourceType?: string;
}
