...
export interface ContainerServiceNetworkProfile {
  ...
  ipFamilies?: IpFamily[];
  /** Defines access to special link local addresses (IMDS and wire server) for pods with hostNetwork=false. if not specified, the default is 'IMDS'. */
...
/** components of given Kubernetes version. */
export interface ComponentsByReleases {
 ...
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **IMDS**: Pods with hostNetwork=false can access IMDS without restriction. \
 * **None**: Pods with hostNetwork=false cannot access IMDS and wire server.
 */
