...
export interface IstioEgressGateway {
  ...
  namespace?: string;
  /** Name of the gateway configuration custom resource to configure the Istio egress routing. Must be specified when enabling the Istio egress gateway. Must be deployed in the same namespace that the Istio egress gateway will be deployed in. */
