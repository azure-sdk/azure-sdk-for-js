...
export interface ManagedClusterAutoReconcileProfile {
  /** Whether a client wants to disable the auto managed cluster reconciliation. The default value is false. */
  disable?: boolean;
  /** The maximum count for reconciliation. The default value is 3. */
  maxRetryCount?: number;
  /** The maximum duration in minutes for reconciliation. The default value is 200. */
