...
export interface AdvancedNetworkingSecurity {
  /** Configure Advanced Networking Security features on Cilium clusters. When the flag is set to true, FQDN policies will be enabled by default unless advancedNetworkPolicies is explicitly set to a different value. If not specified, the default is false. */
  enabled?: boolean;
