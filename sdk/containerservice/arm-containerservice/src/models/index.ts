...
/** Scheduled event. */
export interface ScheduledEvent extends ProxyResource {
  /** Properties for the event. */
  properties?: ScheduledEventProperties;
}
...
export enum KnownOutboundType {
  ...
  /** The egress network is not configured. */
  None = "none",
}
 ...
 * **none**: The egress network is not configured.
 */
