...
export const ScheduledEventProperties: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ScheduledEventProperties",
    modelProperties: {
      description: {
        serializedName: "description",
        type: {
...
export const ScheduledEvent: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
