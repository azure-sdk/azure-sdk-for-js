...
export default function createClient(
  ...
  const endpointUrl =
    options.endpoint ?? options.baseUrl ?? `${endpointParam}/anomalydetector/${apiVersion}`;
  ...
  const client = getClient(endpointUrl, credentials, options) as AnomalyDetectorClient;
