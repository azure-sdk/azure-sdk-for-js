...
export class HybridComputeManagementClient extends coreClient.ServiceClient {
    ...
    // (undocumented)
    apiVersion: string;
    beginSetupExtensions(resourceGroupName: string, machineName: string, extensionSetupBody: MachineExtensionSetup, options?: SetupExtensionsOptionalParams): Promise<SimplePollerLike<OperationState<SetupExtensionsResponse>, SetupExtensionsResponse>>;
    beginSetupExtensionsAndWait(resourceGroupName: string, machineName: string, extensionSetupBody: MachineExtensionSetup, options?: SetupExtensionsOptionalParams): Promise<SetupExtensionsResponse>;
