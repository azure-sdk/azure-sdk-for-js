...
export interface Machine extends TrackedResource {
  ...
  /** Specifies if machine is enabled to use TPM */
  tpmEnabled?: boolean;
  /** Endorsement Key Certificate of the TPM that the client provides to be used during initial resource onboarding */
