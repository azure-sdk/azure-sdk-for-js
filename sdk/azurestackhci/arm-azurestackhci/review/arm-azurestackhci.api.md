...
export interface Create {
    nodeConfiguration(resourceUri: string, nodeConfigurationName: string, nodeConfiguration: NodeConfiguration, options?: CreateNodeConfigurationOptionalParams): Promise<CreateNodeConfigurationResponse>;
}
...
// @public
export interface CreateNodeConfigurationOptionalParams extends coreClient.OperationOptions {
}

// @public
export type CreateNodeConfigurationResponse = NodeConfiguration;
...
export interface Extensions {
    ...
    beginUpdate(resourceGroupName: string, clusterName: string, arcSettingName: string, extensionName: string, extension: Extension, options?: ExtensionsUpdateOptionalParams): Promise<SimplePollerLike<OperationState<ExtensionsUpdateResponse>, ExtensionsUpdateResponse>>;
...
export interface Get {
    nodeConfiguration(resourceUri: string, nodeConfigurationName: string, options?: GetNodeConfigurationOptionalParams): Promise<GetNodeConfigurationResponse>;
}
...
// @public
export interface GetNodeConfigurationOptionalParams extends coreClient.OperationOptions {
}

// @public
export type GetNodeConfigurationResponse = NodeConfiguration;
...
// @public
export interface NodeConfiguration extends ProxyResourceAutoGenerated {
    nodeConfiguration?: string;
    readonly provisioningState?: ProvisioningState;
}

// @public
export interface NodeConfigurationResources {
    value?: NodeConfiguration[];
}

// @public
export interface NodeConfigurations {
    validate(resourceUri: string, nodeConfigurationName: string, nodeConfigurationResources: NodeConfigurationResources, options?: NodeConfigurationsValidateOptionalParams): Promise<void>;
}

// @public
export interface NodeConfigurationsValidateOptionalParams extends coreClient.OperationOptions {
}
...
// @public
export interface UpdateNodeConfigurationOptionalParams extends coreClient.OperationOptions {
}

// @public
export type UpdateNodeConfigurationResponse = NodeConfiguration;

// @public
export interface UpdateOperations {
    nodeConfiguration(resourceUri: string, nodeConfigurationName: string, nodeConfiguration: NodeConfiguration, options?: UpdateNodeConfigurationOptionalParams): Promise<UpdateNodeConfigurationResponse>;
}
