...
export interface ClusterIdentityResponse {
    readonly properties?: ClusterIdentityResponseProperties;
}
...
export interface ExtensionParameters {
    ...
    protectedSettings?: ExtensionParametersProtectedSettings;
    publisher?: string;
    settings?: ExtensionParametersSettings;
    type?: string;
    typeHandlerVersion?: string;
}

// @public
export interface ExtensionParametersProtectedSettings {
    workspaceKey?: string;
}

// @public
export interface ExtensionParametersSettings {
    workspaceId?: string;
}
