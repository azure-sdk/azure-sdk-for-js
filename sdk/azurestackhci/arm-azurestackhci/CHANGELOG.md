...
## 4.0.0-beta.1 (2023-06-19)
    
**Features**

  - Added operation group Create
  - Added operation group Get
  - Added operation group NodeConfigurations
  ...
  - Added Interface CreateNodeConfigurationOptionalParams
  ...
  - Added Interface GetNodeConfigurationOptionalParams
  - Added Interface NodeConfiguration
  - Added Interface NodeConfigurationResources
  - Added Interface NodeConfigurationsValidateOptionalParams
  ...
  - Added Interface UpdateNodeConfigurationOptionalParams
  ...
  - Added Type Alias CreateNodeConfigurationResponse
  - Added Type Alias ExtensionManagedBy
  - Added Type Alias GetNodeConfigurationResponse
  ...
  - Added Type Alias UpdateNodeConfigurationResponse
