...
**Features**
  ...
  - Added Interface ExtensionParametersProtectedSettings
  - Added Interface ExtensionParametersSettings
  ...
  - Interface ClusterIdentityResponse has a new optional parameter properties
  ...
  - Interface ClusterPatch has a new optional parameter identity
...
**Breaking Changes**
  ...
  - Interface ClusterIdentityResponse no longer has parameter aadApplicationObjectId
  - Interface ClusterIdentityResponse no longer has parameter aadClientId
  - Interface ClusterIdentityResponse no longer has parameter aadServicePrincipalObjectId
  - Interface ClusterIdentityResponse no longer has parameter aadTenantId
