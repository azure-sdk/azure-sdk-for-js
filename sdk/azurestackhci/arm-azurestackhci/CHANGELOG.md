...
### Features Added
  ...
  - Added operation group ValidatedSolutionRecipes
  ...
  - Added operation Clusters.beginUpdateSecretsLocations
  - Added operation Clusters.beginUpdateSecretsLocationsAndWait
  ...
  - Added Interface ClustersUpdateSecretsLocationsHeaders
  - Added Interface ClustersUpdateSecretsLocationsOptionalParams
  - Added Interface CollectLogJobProperties
  ...
  - Added Interface EdgeDeviceJobListResult
  - Added Interface EdgeDeviceJobProperties
  - Added Interface EdgeDeviceJobsCreateOrUpdateHeaders
  - Added Interface EdgeDeviceJobsCreateOrUpdateOptionalParams
  - Added Interface EdgeDeviceJobsDeleteHeaders
  - Added Interface EdgeDeviceJobsDeleteOptionalParams
  - Added Interface EdgeDeviceJobsGetOptionalParams
  - Added Interface EdgeDeviceJobsListByEdgeDeviceNextOptionalParams
  ...
  - Added Interface RemoteSupportJobProperties
  ...
  - Added Interface ValidatedSolutionRecipeListResult
  - Added Interface ValidatedSolutionRecipeProperties
  - Added Interface ValidatedSolutionRecipesGetOptionalParams
  - Added Interface ValidatedSolutionRecipesListBySubscriptionLocationResourceNextOptionalParams
  ...
  - Added Type Alias ClustersUpdateSecretsLocationsResponse
  ...
  - Added Type Alias EdgeDeviceJobsCreateOrUpdateResponse
  - Added Type Alias EdgeDeviceJobsDeleteResponse
  - Added Type Alias EdgeDeviceJobsGetResponse
  - Added Type Alias EdgeDeviceJobsListByEdgeDeviceNextResponse
  - Added Type Alias EdgeDeviceJobsListByEdgeDeviceResponse
  - Added Type Alias EdgeDeviceJobType
  ...
  - Added Type Alias EdgeSolutionType
  ...
  - Added Type Alias ValidatedSolutionRecipesGetResponse
  - Added Type Alias ValidatedSolutionRecipesListBySubscriptionLocationResourceNextResponse
  - Added Type Alias ValidatedSolutionRecipesListBySubscriptionLocationResourceResponse
  ...
  - Added Enum KnownEdgeDeviceJobType
  - Added Enum KnownEdgeDeviceKind
  - Added Enum KnownEdgeSolutionType
