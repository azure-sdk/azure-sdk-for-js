...
import { VirtualMachineInstances } from "../operationsInterfaces/index.js";
...
export class VirtualMachineInstancesImpl implements VirtualMachineInstances {
  ...
  async beginCreateOrUpdateAndWait(
    ...
    const poller = await this.beginCreateOrUpdate(resourceUri, virtualMachineInstance, options);
  ...
  async beginUpdateAndWait(
    ...
    const poller = await this.beginUpdate(resourceUri, virtualMachineInstance, options);
    return poller.pollUntilDone();
  }
