...
import { VirtualHardDisksOperations } from "../operationsInterfaces/index.js";
...
export class VirtualHardDisksOperationsImpl implements VirtualHardDisksOperations {
  ...
  async beginDeleteAndWait(
    ...
    const poller = await this.beginDelete(resourceGroupName, virtualHardDiskName, options);
    return poller.pollUntilDone();
  }
