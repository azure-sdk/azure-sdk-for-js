...
import { LogicalNetworksOperations } from "../operationsInterfaces/index.js";
...
export class LogicalNetworksOperationsImpl implements LogicalNetworksOperations {
  ...
  async beginDelete(
    ...
    SimplePollerLike<OperationState<LogicalNetworksDeleteResponse>, LogicalNetworksDeleteResponse>
  > {
    const directSendOperation = async (
      args: coreClient.OperationArguments,
      spec: coreClient.OperationSpec,
  ...
  async beginDeleteAndWait(
    ...
    const poller = await this.beginDelete(resourceGroupName, logicalNetworkName, options);
    return poller.pollUntilDone();
  }
  ...
  async beginUpdate(
    ...
    SimplePollerLike<OperationState<LogicalNetworksUpdateResponse>, LogicalNetworksUpdateResponse>
  > {
    const directSendOperation = async (
      args: coreClient.OperationArguments,
      spec: coreClient.OperationSpec,
