...
import { MarketplaceGalleryImagesOperations } from "../operationsInterfaces/index.js";
...
export class MarketplaceGalleryImagesOperationsImpl implements MarketplaceGalleryImagesOperations {
  ...
  async beginDeleteAndWait(
    ...
    const poller = await this.beginDelete(resourceGroupName, marketplaceGalleryImageName, options);
    return poller.pollUntilDone();
  }
