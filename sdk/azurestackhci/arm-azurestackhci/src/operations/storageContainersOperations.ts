...
import { StorageContainersOperations } from "../operationsInterfaces/index.js";
...
export class StorageContainersOperationsImpl implements StorageContainersOperations {
  ...
  async beginDeleteAndWait(
    ...
    const poller = await this.beginDelete(resourceGroupName, storageContainerName, options);
    return poller.pollUntilDone();
  }
