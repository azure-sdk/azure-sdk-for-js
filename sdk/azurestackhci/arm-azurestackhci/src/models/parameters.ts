...
export const galleryImageName: OperationURLParameter = {
  ...
  mapper: {
    constraints: {
      Pattern: new RegExp("^[a-zA-Z0-9]$|^[a-zA-Z0-9][-._a-zA-Z0-9]{0,78}[a-zA-Z0-9]$"),
      MaxLength: 80,
      MinLength: 1,
    },
...
export const logicalNetworkName: OperationURLParameter = {
  ...
  mapper: {
    constraints: {
      Pattern: new RegExp("^[a-zA-Z0-9]$|^[a-zA-Z0-9][-._a-zA-Z0-9]{0,62}[_a-zA-Z0-9]$"),
      MaxLength: 64,
      MinLength: 2,
    },
...
export const networkInterfaceName: OperationURLParameter = {
  ...
  mapper: {
    constraints: {
      Pattern: new RegExp("^[a-zA-Z0-9]$|^[a-zA-Z0-9][-._a-zA-Z0-9]{0,78}[_a-zA-Z0-9]$"),
      MaxLength: 80,
      MinLength: 1,
    },
...
export const virtualHardDiskName: OperationURLParameter = {
  ...
  mapper: {
    constraints: {
      Pattern: new RegExp("^[a-zA-Z0-9]$|^[a-zA-Z0-9][-._a-zA-Z0-9]{0,62}[a-zA-Z0-9]$"),
      MaxLength: 80,
      MinLength: 1,
    },
