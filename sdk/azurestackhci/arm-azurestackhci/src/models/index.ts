...
/** Known values of {@link NetworkTypeEnum} that the service accepts. */
...
/**
 * Defines values for NetworkTypeEnum. \
 * {@link KnownNetworkTypeEnum} can be used interchangeably with NetworkTypeEnum,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **NAT** \
 * **Transparent** \
