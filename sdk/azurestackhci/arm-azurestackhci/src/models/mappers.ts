  ...
  type: {
    ...
    modelProperties: {
      vmAgent: {
        ...
        type: {
          name: "Composite",
          className: "VirtualMachineVMConfigAgentInstanceView"
        }
      }
    }
  }
...
export const VirtualMachineVMConfigAgentInstanceView: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "VirtualMachineVMConfigAgentInstanceView",
    modelProperties: {
      vmConfigAgentVersion: {
        serializedName: "vmVMConfigAgentVersion",
        type: {
          name: "String"
        }
      },
...
export const VirtualNetworkPropertiesDhcpOptions: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "VirtualNetworkPropertiesDhcpOptions",
    modelProperties: {
      dnsServers: {
        serializedName: "dnsServers",
        type: {
...
export const VirtualNetworkPropertiesSubnetsItem: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "VirtualNetworkPropertiesSubnetsItem",
    modelProperties: {
      name: {
        constraints: {
          Pattern: new RegExp(
...
export const ComponentsCr63WSchemasVirtualnetworkpropertiesPropertiesSubnetsItemsPropertiesIpconfigurationreferencesItems: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className:
      "ComponentsCr63WSchemasVirtualnetworkpropertiesPropertiesSubnetsItemsPropertiesIpconfigurationreferencesItems",
...
export const ComponentsI4F0MhSchemasVirtualnetworkpropertiesPropertiesSubnetsItemsPropertiesRoutetable: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className:
      "ComponentsI4F0MhSchemasVirtualnetworkpropertiesPropertiesSubnetsItemsPropertiesRoutetable",
      ...
      routes: {
        ...
        type: {
          ...
          element: {
            type: {
              name: "Composite",
              className: "VirtualNetworkPropertiesSubnetsPropertiesItemsItem"
            }
          }
        }
      }
...
export const VirtualNetworkPropertiesSubnetsPropertiesItemsItem: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "VirtualNetworkPropertiesSubnetsPropertiesItemsItem",
    modelProperties: {
...
export const VirtualNetworkStatus: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "VirtualNetworkStatus",
    modelProperties: {
      errorCode: {
        serializedName: "errorCode",
        type: {
      ...
      provisioningStatus: {
        ...
        type: {
          name: "Composite",
          className: "VirtualNetworkStatusProvisioningStatus"
        }
      }
    }
  }
...
export const VirtualNetworkStatusProvisioningStatus: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "VirtualNetworkStatusProvisioningStatus",
    modelProperties: {
...
export const VirtualNetworksUpdateRequest: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "VirtualNetworksUpdateRequest",
    modelProperties: {
      tags: {
        serializedName: "tags",
        type: {
