...
export interface GuestAgentOperations {
  ...
  ): Promise<SimplePollerLike<OperationState<GuestAgentCreateResponse>, GuestAgentCreateResponse>>;
  /**
   * Create Or Update GuestAgent.
   * @param resourceUri The fully qualified Azure Resource manager identifier of the Hybrid Compute
   *                    machine resource to be extended.
  ...
  ): Promise<SimplePollerLike<OperationState<GuestAgentDeleteResponse>, GuestAgentDeleteResponse>>;
  /**
   * Implements GuestAgent DELETE method.
   * @param resourceUri The fully qualified Azure Resource manager identifier of the Hybrid Compute
   *                    machine resource to be extended.
