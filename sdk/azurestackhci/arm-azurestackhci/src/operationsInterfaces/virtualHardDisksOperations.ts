...
export interface VirtualHardDisksOperations {
  ...
  beginDelete(
    ...
    SimplePollerLike<OperationState<VirtualHardDisksDeleteResponse>, VirtualHardDisksDeleteResponse>
  >;
  /**
   * The operation to delete a virtual hard disk.
   * @param resourceGroupName The name of the resource group. The name is case insensitive.
  ...
  beginUpdate(
    ...
    SimplePollerLike<OperationState<VirtualHardDisksUpdateResponse>, VirtualHardDisksUpdateResponse>
  >;
  /**
   * The operation to update a virtual hard disk.
   * @param resourceGroupName The name of the resource group. The name is case insensitive.
