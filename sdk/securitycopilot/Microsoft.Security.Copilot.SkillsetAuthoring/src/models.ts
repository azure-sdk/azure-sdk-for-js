...
export interface EcsConfigurationRequest {
  /** ECSFlightIdentity object containing properties for ECSFlight. */
...
/** ECSFlightIdentity object containing properties for ECSFlight. */
export interface ECSFlightIdentity {
  /** workspace of the ecs flight */
  workspace?: string;
  /** Geography of the ECSFlight. */
  geo?: string;
  /** GPU geograpthy of the ECSFlight */
  gpuGeo?: string;
  /** Region of the ECSFlight. */
  region?: string;
  /** Ring of the ECSFlight. */
  ring?: string;
  /** Name of the skillset */
  skillsetName?: string;
  /** Name of the skill */
  skillName?: string;
  /** Source of the skillset */
  source?: string;
}

export interface FlightEnabledRequest {
  /** ECSFlightIdentity object containing properties for ECSFlight. */
  ecsFlightIdentity?: ECSFlightIdentity;
  /** Configuration root */
  configurationRoot?: string;
...
export interface DynamicPromptsSearchRequest {
  /** The scenario name for the search. */
  ScenarioName: string;
  /** The index name for the search. */
  IndexName: string;
  ...
  TopK: number;
  /** The score threshold for the search. */
  ScoreThreshold: number;
  /** The number of nearest neighbors to consider. */
  KNearestNeighborsCount: number;
}

export interface DynamicPromptsFilterRequest {
  /** The selected columns for filtering. */
  selectedColumns?: string[];
  /** The filter string. */
  filter?: string;
}

export interface DynamicPromptsBaseRequest {
  /** The scenario name for the request. */
  scenarioName: string;
  /** The index name for the request. */
  indexName: string;
  /** The version of the index. */
  version: string;
}

export interface DynamicPromptsIndexFilterRequest {
  /** The scenario name for the index filter request. */
  scenarioName: string;
  /** The index name for the index filter request. */
  indexName: string;
  /** The version of the index. */
  version: string;
  /** The selected columns for filtering. */
...
export interface DynamicPromptsSuggestedPromptsRequest {
  /** The skillset name for the suggested prompts request. */
  skillsetName: string;
  /** The skill name for the suggested prompts request. */
  skillName: string;
  /** The prompt string. */
  prompt: string;
  /** The response string. */
