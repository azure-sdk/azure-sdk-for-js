...
import {
  ...
  GetEcsConfigurationParameters,
  IsEcsFlightEnabledParameters,
  SearchAsyncParameters,
  HybridSearchAsyncParameters,
  FilterAsyncParameters,
  GetDocumentCountAsyncParameters,
  IndexFilterAsyncParameters,
  PhysicalIndexExistsAsyncParameters,
  GetSuggestedPromptsAsyncParameters,
  RenderParameters,
} from "./parameters";
import {
  ...
  GetEcsConfiguration200Response,
  IsEcsFlightEnabled200Response,
  SearchAsync200Response,
  HybridSearchAsync200Response,
  FilterAsync200Response,
  GetDocumentCountAsync200Response,
  IndexFilterAsync200Response,
  PhysicalIndexExistsAsync200Response,
  GetSuggestedPromptsAsync200Response,
  Render200Response,
} from "./responses";
...
export interface GetEcsConfiguration {
  /** Gets the ECS configuration */
  get(
    options: GetEcsConfigurationParameters
  ): StreamableMethod<GetEcsConfiguration200Response>;
}

export interface IsEcsFlightEnabled {
  /** returns if the flight is enabled */
  get(
    options: IsEcsFlightEnabledParameters
  ): StreamableMethod<IsEcsFlightEnabled200Response>;
}

export interface SearchAsync {
  /** Performs a search operation using the provided search request. */
  post(
    options: SearchAsyncParameters
  ): StreamableMethod<SearchAsync200Response>;
}

export interface HybridSearchAsync {
  /** Performs a hybrid search operation using the provided search request. */
  post(
    options: HybridSearchAsyncParameters
  ): StreamableMethod<HybridSearchAsync200Response>;
}

export interface FilterAsync {
  /** Filters the dynamic prompts based on the provided filter request. */
  post(
    options: FilterAsyncParameters
  ): StreamableMethod<FilterAsync200Response>;
}

export interface GetDocumentCountAsync {
  /** Gets the document count based on the provided base request. */
  post(
    options: GetDocumentCountAsyncParameters
  ): StreamableMethod<GetDocumentCountAsync200Response>;
}

export interface IndexFilterAsync {
  /** Filters the dynamic prompts by index based on the provided index filter request. */
  post(
    options: IndexFilterAsyncParameters
  ): StreamableMethod<IndexFilterAsync200Response>;
}

export interface PhysicalIndexExistsAsync {
  /** Checks if the physical index exists. */
  get(
    options: PhysicalIndexExistsAsyncParameters
  ): StreamableMethod<PhysicalIndexExistsAsync200Response>;
}

export interface GetSuggestedPromptsAsync {
  /** Gets the suggested prompts based on the provided suggested prompts request. */
  post(
    options: GetSuggestedPromptsAsyncParameters
  ): StreamableMethod<GetSuggestedPromptsAsync200Response>;
}

export interface Render {
  /** Renders the prompt part */
  get(options?: RenderParameters): StreamableMethod<Render200Response>;
}
...
export interface Routes {
  ...
  /** Resource for '/ecsFlight/getEcsConfiguration' has methods for the following verbs: get */
  (path: "/ecsFlight/getEcsConfiguration"): GetEcsConfiguration;
  /** Resource for '/ecsFlight/isEcsFlightEnabled' has methods for the following verbs: get */
  (path: "/ecsFlight/isEcsFlightEnabled"): IsEcsFlightEnabled;
  /** Resource for '/dynamicPrompts/search' has methods for the following verbs: post */
  (path: "/dynamicPrompts/search"): SearchAsync;
  /** Resource for '/dynamicPrompts/hybridsearch' has methods for the following verbs: post */
  (path: "/dynamicPrompts/hybridsearch"): HybridSearchAsync;
  /** Resource for '/dynamicPrompts/filter' has methods for the following verbs: post */
  (path: "/dynamicPrompts/filter"): FilterAsync;
  /** Resource for '/dynamicPrompts/count' has methods for the following verbs: post */
  (path: "/dynamicPrompts/count"): GetDocumentCountAsync;
  /** Resource for '/dynamicPrompts/indexfilter' has methods for the following verbs: post */
  (path: "/dynamicPrompts/indexfilter"): IndexFilterAsync;
  /** Resource for '/dynamicPrompts/exists' has methods for the following verbs: get */
  (path: "/dynamicPrompts/exists"): PhysicalIndexExistsAsync;
  /** Resource for '/dynamicPrompts/suggestedprompts' has methods for the following verbs: post */
  (path: "/dynamicPrompts/suggestedprompts"): GetSuggestedPromptsAsync;
