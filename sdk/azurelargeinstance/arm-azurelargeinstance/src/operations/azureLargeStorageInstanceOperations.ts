...
import {
  ...
  AzureLargeStorageInstanceCreateOptionalParams,
  AzureLargeStorageInstanceCreateResponse,
  Tags,
  AzureLargeStorageInstanceUpdateOptionalParams,
  AzureLargeStorageInstanceUpdateResponse,
  AzureLargeStorageInstanceDeleteOptionalParams,
...
export class AzureLargeStorageInstanceOperationsImpl
  ...
  /**
   * Gets an Azure LargeStorage Storage instance for the specified subscription, resource group, and
   * instance name.
   * @param resourceGroupName The name of the resource group. The name is case insensitive.
  ...
  create(
    resourceGroupName: string,
    azureLargeStorageInstanceName: string,
    requestBodyParameters: AzureLargeStorageInstance,
    options?: AzureLargeStorageInstanceCreateOptionalParams
  ): Promise<AzureLargeStorageInstanceCreateResponse> {
    return this.client.sendOperationRequest(
      {
        resourceGroupName,
  ...
  delete(
    resourceGroupName: string,
    azureLargeStorageInstanceName: string,
    options?: AzureLargeStorageInstanceDeleteOptionalParams
  ): Promise<void> {
    return this.client.sendOperationRequest(
      { resourceGroupName, azureLargeStorageInstanceName, options },
      deleteOperationSpec
