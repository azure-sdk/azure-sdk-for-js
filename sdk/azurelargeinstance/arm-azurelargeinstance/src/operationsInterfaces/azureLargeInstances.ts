...
import {
  ...
  AzureLargeInstancesCreateOptionalParams,
  AzureLargeInstancesCreateResponse,
  Tags,
  AzureLargeInstancesUpdateOptionalParams,
  AzureLargeInstancesUpdateResponse,
  AzureLargeInstancesDeleteOptionalParams
} from "../models";
...
export interface AzureLargeInstances {
  ...
  create(
    resourceGroupName: string,
    azureLargeInstanceName: string,
    azureLargeInstanceProperties: AzureLargeInstance,
    options?: AzureLargeInstancesCreateOptionalParams
  ): Promise<AzureLargeInstancesCreateResponse>;
  /**
  ...
  delete(
    resourceGroupName: string,
    azureLargeInstanceName: string,
    options?: AzureLargeInstancesDeleteOptionalParams
  ): Promise<void>;
}
