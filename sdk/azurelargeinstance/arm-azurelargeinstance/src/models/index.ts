...
/** Optional parameters. */
export interface AzureLargeStorageInstancesCreateOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the create operation. */
export type AzureLargeStorageInstancesCreateResponse = AzureLargeStorageInstance;

/** Optional parameters. */
export interface AzureLargeStorageInstancesDeleteOptionalParams
  extends coreClient.OperationOptions {}
