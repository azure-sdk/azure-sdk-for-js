...
export const AzureResourceManagerArmResponseAvailableContactsListResult: coreClient.CompositeMapper =
  {
    type: {
      name: "Composite",
      className: "AzureResourceManagerArmResponseAvailableContactsListResult",
      modelProperties: {
        body: {
          serializedName: "body",
          type: {
