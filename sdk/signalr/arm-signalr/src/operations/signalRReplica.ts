...
import { SignalRReplica } from "../operationsInterfaces";
...
/** Class containing SignalRReplica operations. */
export class SignalRReplicaImpl implements SignalRReplica {
  private readonly client: SignalRManagementClient;

  /**
   * Initialize a new instance of the class SignalRReplica class.
   ...
   */
  public listSharedPrivateLinkResourcesList(
    ...
    const iter = this.sharedPrivateLinkResourcesListPagingAll(
      resourceGroupName,
      resourceName,
      replicaName,
      options,
    ...
    return {
      ...
      byPage: (settings?: PageSettings) => {
        ...
        return this.sharedPrivateLinkResourcesListPagingPage(
          resourceGroupName,
          resourceName,
          replicaName,
          options,
  ...
  private async *sharedPrivateLinkResourcesListPagingPage(
    resourceGroupName: string,
    resourceName: string,
    replicaName: string,
    options?: SignalRReplicaSharedPrivateLinkResourcesListOptionalParams,
    ...
    if (!continuationToken) {
      result = await this._sharedPrivateLinkResourcesList(
        resourceGroupName,
        resourceName,
        replicaName,
        options,
    ...
    while (continuationToken) {
      result = await this._sharedPrivateLinkResourcesListNext(
        resourceGroupName,
        resourceName,
        replicaName,
        continuationToken,
  ...
  private async *sharedPrivateLinkResourcesListPagingAll(
    resourceGroupName: string,
    resourceName: string,
    replicaName: string,
    options?: SignalRReplicaSharedPrivateLinkResourcesListOptionalParams,
  ): AsyncIterableIterator<SharedPrivateLinkResource> {
    for await (const page of this.sharedPrivateLinkResourcesListPagingPage(
      resourceGroupName,
      resourceName,
      replicaName,
      options,
   ...
   * @param options The options parameters.
   */
  private _sharedPrivateLinkResourcesList(
    resourceGroupName: string,
    resourceName: string,
    replicaName: string,
    options?: SignalRReplicaSharedPrivateLinkResourcesListOptionalParams,
    ...
    return this.client.sendOperationRequest(
      ...
      sharedPrivateLinkResourcesListOperationSpec,
    );
  }
  ...
  sharedPrivateLinkResourcesGet(
    ...
    return this.client.sendOperationRequest(
      ...
      sharedPrivateLinkResourcesGetOperationSpec,
    );
  }
   ...
   * @param options The options parameters.
   */
  async beginSharedPrivateLinkResourcesCreateOrUpdate(
    resourceGroupName: string,
    resourceName: string,
    replicaName: string,
    sharedPrivateLinkResourceName: string,
  ...
  > {
    ...
    const lro = createLroSpec({
      ...
      spec: sharedPrivateLinkResourcesCreateOrUpdateOperationSpec,
    });
   ...
   * @param options The options parameters.
   */
  async beginSharedPrivateLinkResourcesCreateOrUpdateAndWait(
    resourceGroupName: string,
    resourceName: string,
    replicaName: string,
    sharedPrivateLinkResourceName: string,
    ...
    const poller = await this.beginSharedPrivateLinkResourcesCreateOrUpdate(
      resourceGroupName,
      resourceName,
      replicaName,
      sharedPrivateLinkResourceName,
  ...
  /**
   * SharedPrivateLinkResourcesListNext
   * @param resourceGroupName The name of the resource group. The name is case insensitive.
   * @param resourceName The name of the resource.
   * @param replicaName The name of the replica.
   * @param nextLink The nextLink from the previous successful call to the SharedPrivateLinkResourcesList
   *                 method.
   * @param options The options parameters.
   */
  private _sharedPrivateLinkResourcesListNext(
    resourceGroupName: string,
    resourceName: string,
    replicaName: string,
    nextLink: string,
    ...
    return this.client.sendOperationRequest(
      ...
      sharedPrivateLinkResourcesListNextOperationSpec,
    );
  }
}
...
const sharedPrivateLinkResourcesListOperationSpec: coreClient.OperationSpec = {
...
const sharedPrivateLinkResourcesGetOperationSpec: coreClient.OperationSpec = {
...
const sharedPrivateLinkResourcesCreateOrUpdateOperationSpec: coreClient.OperationSpec =
  {
    path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SignalRService/signalR/{resourceName}/replicas/{replicaName}/sharedPrivateLinkResources/{sharedPrivateLinkResourceName}",
    httpMethod: "PUT",
    responses: {
...
const sharedPrivateLinkResourcesListNextOperationSpec: coreClient.OperationSpec =
  {
    path: "{nextLink}",
    httpMethod: "GET",
    responses: {
