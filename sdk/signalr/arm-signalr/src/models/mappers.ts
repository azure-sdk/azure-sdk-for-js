  ...
  type: {
    ...
    modelProperties: {
      ...
      keepAliveIntervalInSeconds: {
        ...
        serializedName: "keepAliveIntervalInSeconds",
        type: {
          name: "Number",
        },
      },
...
export const RouteSettings: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "RouteSettings",
    modelProperties: {
      serverBalanceWeight: {
        constraints: {
        ...
        serializedName: "serverBalanceWeight",
        type: {
          name: "Number",
        },
      },
      connectionBalanceWeight: {
        ...
        serializedName: "connectionBalanceWeight",
        type: {
          name: "Number",
        },
      },
...
export const SignalRResource: coreClient.CompositeMapper = {
  type: {
    ...
    modelProperties: {
      ...
      routeSettings: {
        serializedName: "properties.routeSettings",
        type: {
          name: "Composite",
          className: "RouteSettings",
        },
