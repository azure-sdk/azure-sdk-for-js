...
export class SavingsPlanImpl implements SavingsPlan {
  ...
  private async *listPagingPage(
    ...
    while (continuationToken) {
      result = await this._listNext(savingsPlanOrderId, continuationToken, options);
      continuationToken = result.nextLink;
      let page = result.value || [];
      setContinuationToken(page, continuationToken);
      yield page;
  ...
  async beginUpdate(
    ...
    SimplePollerLike<OperationState<SavingsPlanUpdateResponse>, SavingsPlanUpdateResponse>
  > {
    ...
    const lro = createLroSpec({
      sendOperationFn,
      args: { savingsPlanOrderId, savingsPlanId, body, options },
  ...
  async beginUpdateAndWait(
    ...
    const poller = await this.beginUpdate(savingsPlanOrderId, savingsPlanId, body, options);
...
const getOperationSpec: coreClient.OperationSpec = {
  ...
  urlParameters: [Parameters.$host, Parameters.savingsPlanOrderId, Parameters.savingsPlanId],
  headerParameters: [Parameters.accept],
  serializer,
};
...
const listNextOperationSpec: coreClient.OperationSpec = {
  ...
  urlParameters: [Parameters.$host, Parameters.nextLink, Parameters.savingsPlanOrderId],
  headerParameters: [Parameters.accept],
  serializer,
};
