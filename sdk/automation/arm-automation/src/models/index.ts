...
/** Known values of {@link ThrottlingState} that the service accepts. */
export enum KnownThrottlingState {
  /** NotThrottled */
  NotThrottled = "NotThrottled",
  /** ThrottledAtSubscriptionLevel */
  ThrottledAtSubscriptionLevel = "ThrottledAtSubscriptionLevel",
}

/**
 * Defines values for ThrottlingState. \
 * {@link KnownThrottlingState} can be used interchangeably with ThrottlingState,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **NotThrottled** \
 * **ThrottledAtSubscriptionLevel**
