...
export const UsageListResultAutoGenerated: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "UsageListResultAutoGenerated",
    modelProperties: {
      value: {
        serializedName: "value",
        required: true,
...
export const UsageAutoGenerated: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "UsageAutoGenerated",
    modelProperties: {
