...
import type { TokenCredential, KeyCredential, isKeyCredential } from "@azure/core-auth";
import type { EventGridClient } from "./clientDefinitions.js";
...
/**
 * Initialize a new instance of `EventGridClient`
...
export default function createClient(
  ...
  { apiVersion = "2024-06-01", ...options }: EventGridClientOptions = {},
): EventGridClient {
  ...
  const client = getClient(endpointUrl, credentials, options) as EventGridClient;
