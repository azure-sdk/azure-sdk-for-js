...
export function acsCallingEventPropertiesDeserializer(item: any): AcsCallingEventProperties {
  return {
    startedBy: acsCallParticipantPropertiesDeserializer(item["startedBy"]),
    serverCallId: item["serverCallId"],
    group: !item["group"] ? item["group"] : acsCallGroupPropertiesDeserializer(item["group"]),
    room: !item["room"] ? item["room"] : acsCallRoomPropertiesDeserializer(item["room"]),
...
export function acsCallParticipantPropertiesDeserializer(item: any): AcsCallParticipantProperties {
  return {
...
export function acsCallGroupPropertiesDeserializer(item: any): AcsCallGroupProperties {
  return {
    id: item["id"],
  };
}
...
export function acsCallRoomPropertiesDeserializer(item: any): AcsCallRoomProperties {
  return {
    id: item["id"],
  };
}
...
export function acsCallEndedEventDataDeserializer(item: any): AcsCallEndedEventData {
  return {
    ...
    endedBy: !item["endedBy"]
      ? item["endedBy"]
      : acsCallEndedByPropertiesDeserializer(item["endedBy"]),
    reason: !item["reason"]
      ? item["reason"]
      : acsCallEndReasonPropertiesDeserializer(item["reason"]),
...
export function acsCallEndedByPropertiesDeserializer(item: any): AcsCallEndedByProperties {
  return {
...
export function acsCallEndReasonPropertiesDeserializer(item: any): AcsCallEndReasonProperties {
  return {
    code: item["code"],
...
export function acsCallParticipantEventPropertiesDeserializer(
  item: any,
  ...
  return {
    ...
    correlationId: item["correlationId"],
    isRoomsCall: item["isRoomsCall"],
    user: !item["user"] ? item["user"] : acsCallParticipantPropertiesDeserializer(item["user"]),
