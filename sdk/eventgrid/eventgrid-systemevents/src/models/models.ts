...
export function acsMessageEventDataDeserializer(item: any): AcsMessageEventData {
  return {
    ...
    to: item["to"],
    receivedTimeStamp: new Date(item["receivedTimeStamp"]),
    error: acsMessageChannelEventErrorDeserializer(item["error"]),
  };
}
...
export function acsMessageReceivedEventDataDeserializer(item: any): AcsMessageReceivedEventData {
  return {
    ...
    channelKind: item["channelType"],
    mediaContent: acsMessageMediaContentDeserializer(item["media"]),
    context: acsMessageContextDeserializer(item["context"]),
    button: acsMessageButtonContentDeserializer(item["button"]),
    interactiveContent: acsMessageInteractiveContentDeserializer(item["interactive"]),
  };
}
...
export function acsMessageInteractiveContentDeserializer(item: any): AcsMessageInteractiveContent {
  return {
    replyKind: item["type"],
    buttonReply: acsMessageInteractiveButtonReplyContentDeserializer(item["buttonReply"]),
    listReply: acsMessageInteractiveListReplyContentDeserializer(item["listReply"]),
  };
}
