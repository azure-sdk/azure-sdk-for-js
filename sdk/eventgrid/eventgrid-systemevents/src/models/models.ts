...
export function apiManagementCircuitBreakerOpenedEventDataDeserializer(
  ...
  return {
    ...
    circuitBreaker: apiManagementCircuitBreakerPropertiesDeserializer(item["circuitBreaker"]),
  };
}
...
export function apiManagementCircuitBreakerPropertiesDeserializer(
  ...
  return {
    rules: _apiManagementCircuitBreakerPropertiesRuleRecordDeserializer(item["rules"]),
  };
}
...
export function apiManagementGatewayTokenNearExpiryEventDataDeserializer(
  ...
  return {
    gatewayInfo: apiManagementGatewayPropertiesDeserializer(item["gatewayInfo"]),
    tokenInfo: apiManagementNearExpiryGatewayTokenPropertiesDeserializer(item["tokenInfo"]),
  };
}
...
export function apiManagementGatewayTokenExpiredEventDataDeserializer(
  ...
  return {
    gatewayInfo: apiManagementGatewayPropertiesDeserializer(item["gatewayInfo"]),
    tokenInfo: apiManagementExpiredGatewayTokenPropertiesDeserializer(item["tokenInfo"]),
  };
}
...
export function acsChatThreadCreatedWithUserEventDataDeserializer(
  ...
  return {
    ...
    properties: _acsChatThreadCreatedWithUserEventDataPropertyRecordDeserializer(
      item["properties"],
    ),
    metadata: item["metadata"],
...
export function _acsChatThreadCreatedWithUserEventDataPropertyRecordDeserializer(
  item: Record<string, any>,
): Record<string, _AcsChatThreadCreatedWithUserEventDataProperty> {
  const result: Record<string, any> = {};
  Object.keys(item).map((key) => {
    result[key] = !item[key]
      ? item[key]
      : _acsChatThreadCreatedWithUserEventDataPropertyDeserializer(item[key]);
  });
  return result;
}

/** model interface _AcsChatThreadCreatedWithUserEventDataProperty */
export interface _AcsChatThreadCreatedWithUserEventDataProperty {}

export function _acsChatThreadCreatedWithUserEventDataPropertyDeserializer(
  item: any,
): _AcsChatThreadCreatedWithUserEventDataProperty {
  return item;
}
...
export function acsChatThreadPropertiesUpdatedPerUserEventDataDeserializer(
  ...
  return {
    ...
    editTime: new Date(item["editTime"]),
    metadata: item["metadata"],
    properties: _acsChatThreadPropertiesUpdatedPerUserEventDataPropertyRecordDeserializer(
      item["properties"],
    ),
  };
}

export function _acsChatThreadPropertiesUpdatedPerUserEventDataPropertyRecordDeserializer(
  item: Record<string, any>,
): Record<string, _AcsChatThreadPropertiesUpdatedPerUserEventDataProperty> {
  const result: Record<string, any> = {};
  Object.keys(item).map((key) => {
    result[key] = !item[key]
      ? item[key]
      : _acsChatThreadPropertiesUpdatedPerUserEventDataPropertyDeserializer(item[key]);
  });
  return result;
}

/** model interface _AcsChatThreadPropertiesUpdatedPerUserEventDataProperty */
export interface _AcsChatThreadPropertiesUpdatedPerUserEventDataProperty {}

export function _acsChatThreadPropertiesUpdatedPerUserEventDataPropertyDeserializer(
  item: any,
): _AcsChatThreadPropertiesUpdatedPerUserEventDataProperty {
  return item;
}
...
export function acsChatThreadPropertiesUpdatedEventDataDeserializer(
  ...
  return {
    ...
    editTime: new Date(item["editTime"]),
    properties: _acsChatThreadPropertiesUpdatedEventDataPropertyRecordDeserializer(
      item["properties"],
    ),
    metadata: item["metadata"],
  };
...
export function _acsChatThreadPropertiesUpdatedEventDataPropertyRecordDeserializer(
  item: Record<string, any>,
): Record<string, _AcsChatThreadPropertiesUpdatedEventDataProperty> {
  const result: Record<string, any> = {};
  Object.keys(item).map((key) => {
    result[key] = !item[key]
      ? item[key]
      : _acsChatThreadPropertiesUpdatedEventDataPropertyDeserializer(item[key]);
  });
  return result;
}

/** model interface _AcsChatThreadPropertiesUpdatedEventDataProperty */
export interface _AcsChatThreadPropertiesUpdatedEventDataProperty {}

export function _acsChatThreadPropertiesUpdatedEventDataPropertyDeserializer(
  item: any,
): _AcsChatThreadPropertiesUpdatedEventDataProperty {
  return item;
}
...
export function resourceNotificationsResourceUpdatedDetailsDeserializer(
  ...
  return {
    ...
    properties: !item["properties"]
      ? item["properties"]
      : _resourceNotificationsResourceUpdatedDetailsPropertyRecordDeserializer(item["properties"]),
  };
}

export function _resourceNotificationsResourceUpdatedDetailsPropertyRecordDeserializer(
  item: Record<string, any>,
): Record<string, _ResourceNotificationsResourceUpdatedDetailsProperty> {
  const result: Record<string, any> = {};
  Object.keys(item).map((key) => {
    result[key] = !item[key]
      ? item[key]
      : _resourceNotificationsResourceUpdatedDetailsPropertyDeserializer(item[key]);
  });
  return result;
}

/** model interface _ResourceNotificationsResourceUpdatedDetailsProperty */
export interface _ResourceNotificationsResourceUpdatedDetailsProperty {}

export function _resourceNotificationsResourceUpdatedDetailsPropertyDeserializer(
  item: any,
): _ResourceNotificationsResourceUpdatedDetailsProperty {
  return item;
}
