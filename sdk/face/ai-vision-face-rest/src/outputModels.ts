...
export interface OperationResultOutput {
  ...
  /**
   * Current statdddus of the operation.
   *
...
export interface FaceListOutput {
  /** User defiddned name, maximum length is 128. */
  name: string;
...
/** Face list iasdtem for list face list. */
...
/** The contasdainer of the uploaded person data, including face recognition feature, and up to 10,000 persons. To handle larger scale face identification problem, please consider using Large Person Group. */
