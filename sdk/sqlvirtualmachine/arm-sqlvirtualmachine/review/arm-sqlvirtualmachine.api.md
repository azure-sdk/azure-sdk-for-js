...
export interface SqlVirtualMachineGroupsOperations {
    ...
    listBySqlVmGroup: (resourceGroupName: string, sqlVirtualMachineGroupName: string, options?: SqlVirtualMachineGroupsListBySqlVmGroupOptionalParams) => PagedAsyncIterableIterator<SqlVirtualMachine>;
...
export interface SqlVirtualMachinesOperations {
    ...
    troubleshoot: (resourceGroupName: string, sqlVirtualMachineName: string, parameters: SqlVmTroubleshooting, options?: SqlVirtualMachinesTroubleshootOptionalParams) => PollerLike<OperationState<SqlVmTroubleshooting>, SqlVmTroubleshooting>;
