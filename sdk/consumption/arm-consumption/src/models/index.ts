...
/** Known values of {@link OrgType} that the service accepts. */
export enum KnownOrgType {
  /** Primary organization type for MACC */
  PrimaryOrgType = "Primary",
  /** Contributor organization type for MACC */
  ContributorOrgType = "Contributor"
}

/**
 * Defines values for OrgType. \
 * {@link KnownOrgType} can be used interchangeably with OrgType,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Primary**: Primary organization type for MACC \
 * **Contributor**: Contributor organization type for MACC
 */
