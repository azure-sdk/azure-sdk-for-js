...
export class UsageDetailsImpl implements UsageDetails {
   ...
   * !Note :
   *
   * Microsoft will be retiring the Consumption Usage Details API at some point in the future. We do not
   * recommend that you take a new dependency on this API. Please use the Cost Details API instead. We
   * will notify customers once a date for retirement has been determined.For Cost Details API see,
