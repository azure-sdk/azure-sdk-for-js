...
export interface GetKeyValues {
  ...
  ): StreamableMethod<CheckKeyValues200Response | CheckKeyValuesDefaultResponse>;
}
...
export interface GetKeyValue {
  ...
  delete(
    ...
    DeleteKeyValue200Response | DeleteKeyValue204Response | DeleteKeyValueDefaultResponse
  >;
  /** Requests the headers and status of the given resource. */
  head(
...
export interface GetSnapshots {
  ...
  ): StreamableMethod<CheckSnapshots200Response | CheckSnapshotsDefaultResponse>;
}
...
export interface GetSnapshot {
  ...
  ): StreamableMethod<CreateSnapshot201Response | CreateSnapshotDefaultResponse>;
  /** Updates the state of a key-value snapshot. */
  patch(
    options: UpdateSnapshotParameters,
  ): StreamableMethod<UpdateSnapshot200Response | UpdateSnapshotDefaultResponse>;
  /** Requests the headers and status of the given resource. */
  head(
...
export interface GetOperationDetails {
  ...
  ): StreamableMethod<GetOperationDetails200Response | GetOperationDetailsDefaultResponse>;
}
...
export interface GetRevisions {
  ...
  ): StreamableMethod<CheckRevisions200Response | CheckRevisionsDefaultResponse>;
}
