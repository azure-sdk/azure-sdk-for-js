...
export interface GetKeyValues200Headers {
  ...
  etag?: string;
  /** This optional response header may contain max-age directive to specify the maximum time (in seconds) that a response is considered fresh after the response is generated. */
