...
### Features Added
  ...
  - Added operation ConfigurationStores.resetSasTokens
  - Added Interface ConfigurationStoresGenerateSasTokenOptionalParams
  - Added Interface ConfigurationStoresResetSasTokensOptionalParams
  ...
  - Added Interface KvResourceParameters
  - Added Interface ResetSasTokensParameters
  - Added Interface ResourceParameters
  - Added Interface SasTokenGenerationParameters
  - Added Interface SasTokenGenerationResult
  - Added Interface Snapshot
  - Added Interface SnapshotResourceParameters
  ...
  - Added Type Alias ResourceParametersUnion
  - Added Type Alias ResourceType
  - Added Type Alias SasAuth
  - Added Type Alias SasTokenKind
  ...
  - Interface ConfigurationStore has a new optional parameter sasAuth
  ...
  - Interface ConfigurationStoreUpdateParameters has a new optional parameter sasAuth
  ...
  - Added Enum KnownSasAuth
  - Added Enum KnownSasTokenKind
