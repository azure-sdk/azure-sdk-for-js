...
export class ExperimentationOperationsImpl
  implements ExperimentationOperations
{
  ...
  /**
   * Lists the experimentations for a given configuration store.
...
const listOperationSpec: coreClient.OperationSpec = {
  path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppConfiguration/configurationStores/{configStoreName}/experimentations",
  httpMethod: "GET",
  responses: {
    200: {
...
const getOperationSpec: coreClient.OperationSpec = {
  path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppConfiguration/configurationStores/{configStoreName}/experimentations/{experimentationName}",
  httpMethod: "GET",
  responses: {
    200: {
