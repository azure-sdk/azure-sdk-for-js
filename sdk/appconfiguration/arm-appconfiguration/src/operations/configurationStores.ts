...
export class ConfigurationStoresImpl implements ConfigurationStores {
  ...
  resetSasTokens(
    ...
    return this.client.sendOperationRequest(
      { resourceGroupName, configStoreName, resetSasTokensParameters, options },
      resetSasTokensOperationSpec,
    );
  }
...
const resetSasTokensOperationSpec: coreClient.OperationSpec = {
  path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppConfiguration/configurationStores/{configStoreName}/resetSasTokens",
  httpMethod: "POST",
  responses: {
    200: {},
    default: {
  ...
  requestBody: Parameters.resetSasTokensParameters,
  queryParameters: [Parameters.apiVersion],
  urlParameters: [
    Parameters.$host,
    Parameters.subscriptionId,
