...
export type ResourceParametersUnion =
  | ResourceParameters
...
export interface SasTokenGenerationParameters {
  ...
  resourceParameters?: ResourceParametersUnion;
...
export interface SasTokenGenerationResult {
   ...
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly resourceParameters?: ResourceParametersUnion;
  /**
   * The time that the SAS token expires in the Universal ISO 8601 DateTime format. Max allowed expiration is 1 year from the time of token creation.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
...
export interface KvResourceParameters extends ResourceParameters {
  /** Polymorphic discriminator, which specifies the different types this object can be */
  resourceType: "Kv";
  /**
...
export interface SnapshotResourceParameters extends ResourceParameters {
  /** Polymorphic discriminator, which specifies the different types this object can be */
...
/** Known values of {@link SasAuth} that the service accepts. */
export enum KnownSasAuth {
...
/**
 * Defines values for SasAuth. \
 * {@link KnownSasAuth} can be used interchangeably with SasAuth,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Enabled**: SAS token authentication is enabled. \
 * **Disabled**: SAS token authentication is disabled.
 */
export type SasAuth = string;
...
/** Known values of {@link SasTokenKind} that the service accepts. */
export enum KnownSasTokenKind {
  /** Primary */
  Primary = "Primary",
  /** Secondary */
  Secondary = "Secondary",
...
/**
 * Defines values for SasTokenKind. \
 * {@link KnownSasTokenKind} can be used interchangeably with SasTokenKind,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Primary** \
 * **Secondary**
 */
export type SasTokenKind = string;
...
/** Optional parameters. */
export interface ConfigurationStoresResetSasTokensOptionalParams
  extends coreClient.OperationOptions {}
