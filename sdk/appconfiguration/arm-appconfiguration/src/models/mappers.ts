...
export const ConfigurationStoreUpdateParameters: coreClient.CompositeMapper = {
  type: {
    ...
    modelProperties: {
      ...
      sasAuth: {
        serializedName: "properties.sasAuth",
        type: {
          name: "String",
        },
      },
...
export const SasTokenGenerationParameters: coreClient.CompositeMapper = {
  type: {
    ...
    modelProperties: {
      resourceParameters: {
        serializedName: "resourceParameters",
        type: {
          name: "Composite",
          className: "ResourceParameters",
        },
      },
      expires: {
...
export const ResourceParameters: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ResourceParameters",
    uberParent: "ResourceParameters",
...
export const ResetSasTokensParameters: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ResetSasTokensParameters",
    modelProperties: {
      kind: {
        serializedName: "kind",
        required: true,
...
export const KvResourceParameters: coreClient.CompositeMapper = {
  serializedName: "Kv",
  type: {
    name: "Composite",
    className: "KvResourceParameters",
    uberParent: "ResourceParameters",
    polymorphicDiscriminator: ResourceParameters.type.polymorphicDiscriminator,
    modelProperties: {
      ...ResourceParameters.type.modelProperties,
      key: {
        serializedName: "key",
        type: {
          name: "String",
...
export const SnapshotResourceParameters: coreClient.CompositeMapper = {
  serializedName: "Snapshot",
  type: {
    name: "Composite",
    className: "SnapshotResourceParameters",
    uberParent: "ResourceParameters",
    polymorphicDiscriminator: ResourceParameters.type.polymorphicDiscriminator,
    modelProperties: {
      ...ResourceParameters.type.modelProperties,
...
export let discriminators = {
  ...
  "ResourceParameters.Kv": KvResourceParameters,
  "ResourceParameters.Snapshot": SnapshotResourceParameters,
};
