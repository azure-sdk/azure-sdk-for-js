# Azuredatatransferrp client library for JavaScript
...
[API reference documentation](https://docs.microsoft.com/javascript/api/@azure/arm-azuredatatransfer?view=azure-node-preview) |
...
```javascript
const { Azuredatatransferrp } = require("@azure/arm-azuredatatransfer");
