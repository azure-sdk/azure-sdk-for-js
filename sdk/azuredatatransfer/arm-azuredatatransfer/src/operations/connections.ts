...
export class ConnectionsImpl implements Connections {
  ...
  async beginUpdateAndWait(
    ...
    const poller = await this.beginUpdate(resourceGroupName, connectionName, connection, options);
    return poller.pollUntilDone();
  }
  ...
  async beginLinkAndWait(
    ...
    const poller = await this.beginLink(resourceGroupName, connectionName, connection, options);
    return poller.pollUntilDone();
  }
