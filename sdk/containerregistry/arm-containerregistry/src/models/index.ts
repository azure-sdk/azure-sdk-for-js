...
/** Known values of {@link PipelineTargetType} that the service accepts. */
...
/**
 * Defines values for PipelineTargetType. \
 * {@link KnownPipelineTargetType} can be used interchangeably with PipelineTargetType,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **AzureStorageBlobContainer**
 */
...
/** Known values of {@link StorageAccessMode} that the service accepts. */
...
/**
 * Defines values for StorageAccessMode. \
