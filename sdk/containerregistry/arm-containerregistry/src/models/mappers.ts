...
export const ConnectedRegistryPropertiesAutoGenerated: coreClient.CompositeMapper =
  {
    type: {
      name: "Composite",
      className: "ConnectedRegistryPropertiesAutoGenerated",
      modelProperties: {
        provisioningState: {
        ...
        activation: {
          ...
          type: {
            name: "Composite",
            className: "ConnectedRegistryPropertiesActivation",
          },
        },
        parent: {
  ...
  type: {
    ...
    modelProperties: {
      ...
      tls: {
        ...
        type: {
          name: "Composite",
          className: "LoginServerPropertiesTls",
        },
      },
    },
  },
  ...
  type: {
    ...
    modelProperties: {
      ...
      certificate: {
        ...
        type: {
          name: "Composite",
          className: "TlsPropertiesCertificate",
        },
      },
    },
  },
...
export const ConnectedRegistryUpdateProperties: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ConnectedRegistryUpdateProperties",
    modelProperties: {
      syncProperties: {
        serializedName: "syncProperties",
        type: {
...
export const ConnectedRegistryProperties: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ConnectedRegistryProperties",
    modelProperties: {
      ...ConnectedRegistryPropertiesAutoGenerated.type.modelProperties,
    },
  },
};

export const ConnectedRegistryPropertiesActivation: coreClient.CompositeMapper =
  {
    type: {
      name: "Composite",
      className: "ConnectedRegistryPropertiesActivation",
      modelProperties: {
        ...ActivationProperties.type.modelProperties,
      },
    },
  };

export const LoginServerPropertiesTls: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "LoginServerPropertiesTls",
    modelProperties: {
      ...TlsProperties.type.modelProperties,
    },
  },
};

export const TlsPropertiesCertificate: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "TlsPropertiesCertificate",
    modelProperties: {
      ...TlsCertificateProperties.type.modelProperties,
    },
  },
};

export const ConnectedRegistryUpdateParametersProperties: coreClient.CompositeMapper =
  {
    type: {
      name: "Composite",
      className: "ConnectedRegistryUpdateParametersProperties",
      modelProperties: {
        ...ConnectedRegistryUpdateProperties.type.modelProperties,
      },
    },
  };
