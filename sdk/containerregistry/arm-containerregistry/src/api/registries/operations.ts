...
export function _checkNameAvailabilitySend(
  ...
  options: RegistriesCheckNameAvailabilityOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
...
export function generateCredentials(
  ...
  return getLongRunningPoller(context, _generateCredentialsDeserialize, ["202", "200", "201"], {
...
export function _regenerateCredentialSend(
  ...
  options: RegistriesRegenerateCredentialOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
...
export function importImage(
  ...
  return getLongRunningPoller(context, _importImageDeserialize, ["202", "200", "201"], {
    updateIntervalInMs: options?.updateIntervalInMs,
    abortSignal: options?.abortSignal,
    getInitialResponse: () =>
