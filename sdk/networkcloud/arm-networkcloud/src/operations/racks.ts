...
export class RacksImpl implements Racks {
  ...
  async beginCreateOrUpdate(
    ...
    PollerLike<
      PollOperationState<RacksCreateOrUpdateResponse>,
      RacksCreateOrUpdateResponse
    >
  > {
    ...
    const lro = new LroImpl(
      sendOperation,
      { resourceGroupName, rackName, rackParameters, options },
  ...
  async beginUpdate(
    ...
    PollerLike<PollOperationState<RacksUpdateResponse>, RacksUpdateResponse>
  > {
    const directSendOperation = async (
      args: coreClient.OperationArguments,
      spec: coreClient.OperationSpec
