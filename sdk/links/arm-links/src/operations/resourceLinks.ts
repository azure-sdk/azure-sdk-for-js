...
import { ResourceLinks } from "../operationsInterfaces/index.js";
import * as coreClient from "@azure/core-client";
import * as Mappers from "../models/mappers.js";
import * as Parameters from "../models/parameters.js";
import { ManagementLinkClient } from "../managementLinkClient.js";
import {
  ResourceLink,
...
export class ResourceLinksImpl implements ResourceLinks {
  ...
  private async *listAtSourceScopePagingPage(
    ...
    while (continuationToken) {
      result = await this._listAtSourceScopeNext(scope, continuationToken, options);
      continuationToken = result.nextLink;
      let page = result.value || [];
      setContinuationToken(page, continuationToken);
      yield page;
