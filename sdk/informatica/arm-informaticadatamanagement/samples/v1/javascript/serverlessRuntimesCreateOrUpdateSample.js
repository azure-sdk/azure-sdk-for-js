...
async function serverlessRuntimesCreateOrUpdate() {
  ...
  const result = await client.serverlessRuntimes.createOrUpdate("rgopenapi", "__C", "0j-__", {
    properties: {
...
async function serverlessRuntimesCreateOrUpdateMin() {
  ...
  const subscriptionId = "3599DA28-E346-4D9F-811E-189C0445F0FE";
  const client = new DataManagementClient(credential, subscriptionId);
  const result = await client.serverlessRuntimes.createOrUpdate("rgopenapi", "-4Z__7", "J", {});
  console.log(result);
}
