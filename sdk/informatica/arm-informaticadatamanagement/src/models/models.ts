...
export function informaticaServerlessRuntimePropertiesSerializer(
  ...
  return {
    ...
    advancedCustomProperties:
      item["advancedCustomProperties"] === undefined
        ? item["advancedCustomProperties"]
        : item["advancedCustomProperties"].map(
            advancedCustomPropertiesSerializer,
          ),
    ...
    serverlessRuntimeTags:
      item["serverlessRuntimeTags"] === undefined
        ? item["serverlessRuntimeTags"]
        : item["serverlessRuntimeTags"].map(serverlessRuntimeTagSerializer),
...
export function serverlessRuntimeConfigPropertiesSerializer(
  ...
  return {
    cdiConfigProps:
      item["cdiConfigProps"] === undefined
        ? item["cdiConfigProps"]
        : item["cdiConfigProps"].map(cdiConfigPropsSerializer),
    cdieConfigProps:
      item["cdieConfigProps"] === undefined
        ? item["cdieConfigProps"]
        : item["cdieConfigProps"].map(cdiConfigPropsSerializer),
  };
}
...
export function cdiConfigPropsSerializer(
  item: CdiConfigProps,
): Record<string, unknown> {
  return {
    engineName: item["engineName"],
    engineVersion: item["engineVersion"],
    applicationConfigs: item["applicationConfigs"].map(
      applicationConfigsSerializer,
    ),
  };
}
...
export function applicationConfigsSerializer(
...
export function companyDetailsSerializer(
  item: CompanyDetails,
): Record<string, unknown> {
  return {
...
export function linkOrganizationSerializer(
  item: LinkOrganization,
): Record<string, unknown> {
  return {
    token: item["token"],
...
export function offerDetailsUpdateSerializer(
  item: OfferDetailsUpdate,
): Record<string, unknown> {
  return {
    publisherId: item["publisherId"],
    offerId: item["offerId"],
...
export function userDetailsUpdateSerializer(
  item: UserDetailsUpdate,
): Record<string, unknown> {
  return {
    firstName: item["firstName"],
    lastName: item["lastName"],
...
export type Versions = "2024-05-08";
