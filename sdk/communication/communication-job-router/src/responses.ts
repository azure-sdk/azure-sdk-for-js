...
/** OK Response payload from cancelling a job */
...
/** OK Response payload from completing a job */
...
/** Response payload from closing a job synchronously. */
export interface CloseJobAction200Response extends HttpResponse {
  status: "200";
  body: CloseJobResultOutput;
}

/** Response payload from closing a job at a future time. */
...
/** OK Response payload from declining a job. */
