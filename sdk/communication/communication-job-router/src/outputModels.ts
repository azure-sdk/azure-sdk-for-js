...
export interface ReclassifyJobResultOutput extends Record<string, any> {}

/** Response payload from cancelling a job */
export interface CancelJobResultOutput extends Record<string, any> {}

/** Response payload from completing a job */
export interface CompleteJobResultOutput extends Record<string, any> {}

/** Response payload from closing a job */
export interface CloseJobResultOutput extends Record<string, any> {}
...
export interface DeclineJobOfferResultOutput extends Record<string, any> {}
