...
export interface QueueSelectorAttachmentOutputParent {
   ...
   *
   * Possible values: "conditional", "passThrough", "ruleEngine", "static", "weightedAllocation"
   */
...
export interface RouterRuleOutputParent {
   ...
   *
   * Possible values: "directMap", "expression", "function", "static", "webhook"
   */
...
export interface DirectMapRouterRuleOutput extends RouterRuleOutputParent {
  ...
  /** The type discriminator describing a kind of Rule. */
  kind: "directMap";
}
...
export interface DistributionModeOutputParent {
   ...
   *
   * Possible values: "bestWorker", "longestIdle", "roundRobin"
   */
...
export interface BestWorkerModeOutput extends DistributionModeOutputParent {
  ...
  /** The type discriminator describing a kind of Mode */
  kind: "bestWorker";
}
...
export interface ExceptionTriggerOutputParent {
   ...
   *
   * Possible values: "queueLength", "waitTime"
   */
...
export interface ExceptionActionOutputParent {
   ...
   *
   * Possible values: "cancel", "manualReclassify", "reclassify"
   */
...
export interface JobMatchingModeOutputParent {
   ...
   *
   * Possible values: "queueAndMatch", "scheduleAndSuspend", "suspend"
   */
...
export interface ScheduleAndSuspendModeOutput
  ...
  /** The type discriminator describing ScheduleAndSuspendMode kind */
