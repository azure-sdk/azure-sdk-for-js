...
export interface AddParticipants {
  ...
  ): StreamableMethod<AddParticipants207Response | AddParticipantsDefaultResponse>;
}
...
export interface RemoveParticipants {
  ...
  ): StreamableMethod<RemoveParticipants207Response | RemoveParticipantsDefaultResponse>;
}
...
export interface ListConversations {
  ...
  ): StreamableMethod<ListConversations200Response | ListConversationsDefaultResponse>;
  /** Creates a new conversation. This is only for create operation. */
  post(
    options: CreateConversationParameters,
  ): StreamableMethod<CreateConversation201Response | CreateConversationDefaultResponse>;
}
...
export interface AnalyzeConversation {
  ...
  ): StreamableMethod<AnalyzeConversation200Response | AnalyzeConversationDefaultResponse>;
}
...
export interface GetConversation {
  ...
  ): StreamableMethod<GetConversation200Response | GetConversationDefaultResponse>;
  /** Deletes a specific conversation. */
  delete(
    options?: DeleteConversationParameters,
  ): StreamableMethod<DeleteConversation204Response | DeleteConversationDefaultResponse>;
}
...
export interface TerminateConversation {
  ...
  ): StreamableMethod<TerminateConversation200Response | TerminateConversationDefaultResponse>;
}
