...
const responseMap: Record<string, string[]> = {
  ...
  "POST /messages/notifications:sendMessage": ["202"],
  "GET /messages/channels/{channelId}/templates": ["200"],
};

export function isUnexpected(
  response: GetStream200Response | GetStreamDefaultResponse
): response is GetStreamDefaultResponse;
export function isUnexpected(
  response: SendMessage202Response | SendMessageDefaultResponse
