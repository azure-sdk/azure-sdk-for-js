...
export function isUnexpected(
  response: DeviceLocationVerify200Response | DeviceLocationVerifyDefaultResponse,
): response is DeviceLocationVerifyDefaultResponse;
export function isUnexpected(
  response: DeviceNetworkRetrieve200Response | DeviceNetworkRetrieveDefaultResponse,
