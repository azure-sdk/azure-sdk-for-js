## API Report File for "@azure-rest/analytics-onlineexperimentation"
...
export interface Routes {
    ...
    (path: "/experiment-metrics/{experimentMetricId}:validate", experimentMetricId: string): ValidateMetric;
