...
export interface _RpUsageAndQuotaEnumerationForExistingResourceResult {
...
export function _rpUsageAndQuotaEnumerationForExistingResourceResultDeserializer(
  item: any,
): _RpUsageAndQuotaEnumerationForExistingResourceResult {
  return {
    value: rpUsageAndQuotaDetailsForExistingResourceArrayDeserializer(
      item["value"],
    ),
    nextLink: item["nextLink"],
  };
...
export function rpUsageAndQuotaDetailsForExistingResourceArrayDeserializer(
  result: Array<RpUsageAndQuotaDetailsForExistingResource>,
): any[] {
  return result.map((item) => {
    return rpUsageAndQuotaDetailsForExistingResourceDeserializer(item);
  });
}
...
export function rpUsageAndQuotaDetailsForExistingResourceDeserializer(
  item: any,
