...
export class FabricCapacitiesImpl implements FabricCapacities {
  ...
  update(
    ...
    return this.client.sendOperationRequest(
      { resourceGroupName, capacityName, properties, options },
      updateOperationSpec,
    );
  }
...
const resumeOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      headersMapper: Mappers.FabricCapacitiesResumeHeaders,
    },
    201: {
      headersMapper: Mappers.FabricCapacitiesResumeHeaders,
    },
...
const suspendOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      headersMapper: Mappers.FabricCapacitiesSuspendHeaders,
    },
    201: {
      headersMapper: Mappers.FabricCapacitiesSuspendHeaders,
    },
