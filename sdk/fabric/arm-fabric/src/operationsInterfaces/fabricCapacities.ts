...
export interface FabricCapacities {
  ...
  beginResume(
    ...
    SimplePollerLike<
      OperationState<FabricCapacitiesResumeResponse>,
      FabricCapacitiesResumeResponse
    >
  >;
  /**
  ...
  beginResumeAndWait(
    ...
    capacityName: string,
    options?: FabricCapacitiesResumeOptionalParams,
  ): Promise<FabricCapacitiesResumeResponse>;
  /**
  ...
  beginSuspend(
    ...
    SimplePollerLike<
      OperationState<FabricCapacitiesSuspendResponse>,
      FabricCapacitiesSuspendResponse
    >
  >;
  /**
  ...
  beginSuspendAndWait(
    ...
    capacityName: string,
    options?: FabricCapacitiesSuspendOptionalParams,
  ): Promise<FabricCapacitiesSuspendResponse>;
}
