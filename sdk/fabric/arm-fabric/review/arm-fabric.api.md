...
export class MicrosoftFabricManagementServiceForTesting extends coreClient.ServiceClient {
    // (undocumented)
    $host: string;
    constructor(credentials: coreAuth.TokenCredential, subscriptionId: string, options?: MicrosoftFabricManagementServiceForTestingOptionalParams);
    // (undocumented)
    apiVersion: string;
    // (undocumented)
...
// @public
export interface MicrosoftFabricManagementServiceForTestingOptionalParams extends coreClient.ServiceClientOptions {
    $host?: string;
    apiVersion?: string;
    endpoint?: string;
}
