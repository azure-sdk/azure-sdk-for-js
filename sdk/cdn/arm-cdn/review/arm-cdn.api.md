...
export interface Profiles {
    ...
    beginMigrationCommit(resourceGroupName: string, profileName: string, options?: ProfilesMigrationCommitOptionalParams): Promise<PollerLike<PollOperationState<ProfilesMigrationCommitResponse>, ProfilesMigrationCommitResponse>>;
    beginMigrationCommitAndWait(resourceGroupName: string, profileName: string, options?: ProfilesMigrationCommitOptionalParams): Promise<ProfilesMigrationCommitResponse>;
