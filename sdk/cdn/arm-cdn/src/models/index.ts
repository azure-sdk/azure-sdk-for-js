...
export interface RemoteAddressMatchConditionParameters
  extends DeliveryRuleConditionParameters {
  /** Polymorphic discriminator, which specifies the different types this object can be */
...
export interface UrlRedirectActionParameters
  extends DeliveryRuleActionParameters {
  /** Polymorphic discriminator, which specifies the different types this object can be */
...
export interface CdnCertificateSourceParameters
  extends CertificateSourceParameters {
  /** Polymorphic discriminator, which specifies the different types this object can be */
...
/** Defines headers for Profiles_cdnCanMigrateToAfd operation. */
export interface ProfilesCdnCanMigrateToAfdHeaders {
  location?: string;
}

/** Defines headers for Profiles_cdnMigrateToAfd operation. */
export interface ProfilesCdnMigrateToAfdHeaders {
  location?: string;
}

/** Defines headers for Profiles_migrationAbort operation. */
...
/** Known values of {@link AfdCipherSuiteSetType} that the service accepts. */
...
/**
 * Defines values for AfdCipherSuiteSetType. \
 ...
 * {@link KnownAfdCustomizedCipherSuiteForTls12} can be used interchangeably with AfdCustomizedCipherSuiteForTls12,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 ...
 * {@link KnownAfdCustomizedCipherSuiteForTls13} can be used interchangeably with AfdCustomizedCipherSuiteForTls13,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 ...
 * {@link KnownDeliveryRuleConditionParametersType} can be used interchangeably with DeliveryRuleConditionParametersType,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **DeliveryRuleRemoteAddressConditionParameters** \
 * **DeliveryRuleRequestMethodConditionParameters** \
 ...
 * {@link KnownDeliveryRuleActionParametersType} can be used interchangeably with DeliveryRuleActionParametersType,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **DeliveryRuleUrlRedirectActionParameters** \
 * **DeliveryRuleUrlSigningActionParameters** \
 ...
 * {@link KnownCertificateSourceParametersType} can be used interchangeably with CertificateSourceParametersType,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **CdnCertificateSourceParameters** \
 * **KeyVaultCertificateSourceParameters**
...
/** Optional parameters. */
export interface ProfilesCdnCanMigrateToAfdOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Contains response data for the cdnCanMigrateToAfd operation. */
export type ProfilesCdnCanMigrateToAfdResponse = CanMigrateResult;

/** Optional parameters. */
export interface ProfilesCdnMigrateToAfdOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Contains response data for the cdnMigrateToAfd operation. */
export type ProfilesCdnMigrateToAfdResponse = MigrateResult;

/** Optional parameters. */
export interface ProfilesMigrationAbortOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Contains response data for the migrationAbort operation. */
