...
export interface SecurityPolicyWebApplicationFirewallAssociation {
  ...
  isProfileLevel?: SecurityPolicyWebApplicationFirewallAssociationIsProfileLevel;
  /** List of domains. */
...
/** Known values of {@link SecurityPolicyWebApplicationFirewallAssociationIsProfileLevel} that the service accepts. */
export enum KnownSecurityPolicyWebApplicationFirewallAssociationIsProfileLevel {
  /** True */
  True = "True",
  /** False */
  False = "False"
...
/**
 * Defines values for SecurityPolicyWebApplicationFirewallAssociationIsProfileLevel. \
 * {@link KnownSecurityPolicyWebApplicationFirewallAssociationIsProfileLevel} can be used interchangeably with SecurityPolicyWebApplicationFirewallAssociationIsProfileLevel,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **True** \
 * **False**
 */
export type SecurityPolicyWebApplicationFirewallAssociationIsProfileLevel = string;
