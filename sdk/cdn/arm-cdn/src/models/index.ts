...
export interface CanMigrateResult {
   ...
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly errors?: MigrationErrorsListResponse;
}
...
export interface MigrationErrorsListResponse {
...
/** Contains response data for the migrationCommit operation. */
export type ProfilesMigrationCommitResponse = ProfilesMigrationCommitHeaders;
