...
export class JobExecutionsImpl implements JobExecutions {
  ...
  public list(
    ...
    const iter = this.listPagingAll(resourceGroupName, serviceName, jobName, options);
    return {
      next() {
        return iter.next();
      },
      ...
      byPage: (settings?: PageSettings) => {
        ...
        return this.listPagingPage(resourceGroupName, serviceName, jobName, options, settings);
      },
    };
  }
  ...
  private async *listPagingPage(
    ...
    if (!continuationToken) {
      result = await this._list(resourceGroupName, serviceName, jobName, options);
