...
export class JobImpl implements Job {
  ...
  async beginCreateOrUpdate(
    ...
    SimplePollerLike<OperationState<JobCreateOrUpdateResponse>, JobCreateOrUpdateResponse>
  > {
  ...
  async beginDelete(
  ...
  ): Promise<SimplePollerLike<OperationState<JobDeleteResponse>, JobDeleteResponse>> {
    const directSendOperation = async (
      args: coreClient.OperationArguments,
      spec: coreClient.OperationSpec,
    ...
    const poller = await createHttpPoller<JobDeleteResponse, OperationState<JobDeleteResponse>>(
      lro,
      {
        restoreFrom: options?.resumeFrom,
        intervalInMs: options?.updateIntervalInMs,
  ...
  async beginDeleteAndWait(
    ...
    const poller = await this.beginDelete(resourceGroupName, serviceName, jobName, options);
    return poller.pollUntilDone();
  }
  ...
  async beginStart(
  ...
  ): Promise<SimplePollerLike<OperationState<JobStartResponse>, JobStartResponse>> {
    const directSendOperation = async (
      args: coreClient.OperationArguments,
      spec: coreClient.OperationSpec,
    ...
    const poller = await createHttpPoller<JobStartResponse, OperationState<JobStartResponse>>(lro, {
      restoreFrom: options?.resumeFrom,
      intervalInMs: options?.updateIntervalInMs,
  ...
  async beginStartAndWait(
    ...
    const poller = await this.beginStart(resourceGroupName, serviceName, jobName, options);
    return poller.pollUntilDone();
  }
