...
import {
  ...
  BuildSettingResource as BuildSettingResourceMapper,
...
export const buildSettingName: OperationURLParameter = {
  parameterPath: "buildSettingName",
  mapper: {
    constraints: {
      Pattern: new RegExp("^[a-z][a-z0-9-]*[a-z0-9]$"),
    },
...
export const buildSettingResource: OperationParameter = {
  parameterPath: "buildSettingResource",
  mapper: BuildSettingResourceMapper,
};
