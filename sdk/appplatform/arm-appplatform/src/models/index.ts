...
export interface BuildServiceProperties {
  ...
  defaultBuilderConfiguration?: DefaultBuilderConfigurationState;
  /**
...
/** Known values of {@link DefaultBuilderConfigurationState} that the service accepts. */
export enum KnownDefaultBuilderConfigurationState {
  /** Enable default builder configuration. */
  Enabled = "Enabled",
  /** Disable default builder configuration. */
  Disabled = "Disabled",
}

/**
 * Defines values for DefaultBuilderConfigurationState. \
 * {@link KnownDefaultBuilderConfigurationState} can be used interchangeably with DefaultBuilderConfigurationState,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Enabled**: Enable default builder configuration. \
 * **Disabled**: Disable default builder configuration.
 */
export type DefaultBuilderConfigurationState = string;
