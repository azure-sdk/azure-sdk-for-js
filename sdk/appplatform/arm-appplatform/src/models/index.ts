...
/** Known values of {@link AppResourceType} that the service accepts. */
export enum KnownAppResourceType {
  /** Application */
  Application = "Application",
  /** Task */
  Task = "Task"
...
/**
 * Defines values for AppResourceType. \
 * {@link KnownAppResourceType} can be used interchangeably with AppResourceType,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Application** \
 * **Task**
 */
export type AppResourceType = string;
