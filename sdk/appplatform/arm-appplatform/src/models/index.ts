...
export type ProbeActionUnion =
  ...
  | ExecAction
  | TCPSocketAction;
export type GatewayResponseCachePropertiesUnion =
...
export interface ConfigServerProperties {
   ...
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly resourceRequests?: ConfigServerResourceRequests;
  /**
   * Collection of instances belong to Config Server, only available in Enterprise Plan.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly instances?: ConfigServerInstance[];
...
export interface ConfigServerResourceRequests {
  /**
...
export interface ConfigServerInstance {
  /**
...
export interface BuildSettingResourceCollection {
  /** Collection of build setting resources */
  value?: BuildSettingResource[];
  /**
   * URL client should use to fetch the next page (per server side paging).
   * It's null for now, added for future use.
   */
...
export interface BuildSettingProperties {
  /** build setting type */
  type: string;
  /**
   ...
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly provisioningState?: BuildSettingProvisioningState;
  /** Sensitive properties for the APM */
  secrets?: BuildSettingPropertiesSecrets;
}

/** Sensitive properties for the APM */
export interface BuildSettingPropertiesSecrets {
  /** the context of settings.xml encoded by base64 */
  settingsXml?: string;
  /** the context of settings-security.xml encoded by base64 */
  settingsSecurityXml?: string;
  /** the context of gradle.properties encoded by base64 */
  gradleProperties?: string;
}

/** Supported build setting types payload */
export interface SupportedBuildSettingTypes {
  /** Collection of the supported build setting type */
  value?: SupportedBuildSettingType[];
  /**
   * URL client should use to fetch the next page (per server side paging).
   * It's null for now, added for future use.
   */
...
export interface SupportedBuildSettingType {
...
export interface BuildProperties {
  ...
  buildSettings?: BuildSettingReference[];
  /**
...
export interface BuildSettingReference {
...
export interface JobResourceRequests {
...
export interface ManagedComponentReference {
...
export interface EnvSecretsCollection {
...
export interface GatewayLocalResponseCachePerRouteProperties
...
export interface GatewayLocalResponseCachePerInstanceProperties
  extends GatewayResponseCacheProperties {
  /** Polymorphic discriminator, which specifies the different types this object can be */
...
export interface BuildSettingResource extends ProxyResource {
  /** Properties of a build setting */
  properties?: BuildSettingProperties;
}
...
/** Defines headers for ConfigServers_delete operation. */
export interface ConfigServersDeleteHeaders {
  location?: string;
}
...
/** Defines headers for BuildSettings_delete operation. */
export interface BuildSettingsDeleteHeaders {
  location?: string;
}
...
/** Defines headers for Job_start operation. */
export interface JobStartHeaders {
  location?: string;
}

/** Defines headers for JobExecution_cancel operation. */
...
/** Known values of {@link PrivateStorageAccess} that the service accepts. */
export enum KnownPrivateStorageAccess {
  /** Enabled */
  Enabled = "Enabled",
  /** Disabled */
  Disabled = "Disabled",
...
/**
 * Defines values for PrivateStorageAccess. \
 * {@link KnownPrivateStorageAccess} can be used interchangeably with PrivateStorageAccess,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Enabled** \
 * **Disabled**
 */
export type PrivateStorageAccess = string;
...
/** Known values of {@link BuildSettingProvisioningState} that the service accepts. */
export enum KnownBuildSettingProvisioningState {
  /** Creating */
  Creating = "Creating",
  /** Updating */
  Updating = "Updating",
...
/**
 * Defines values for BuildSettingProvisioningState. \
 * {@link KnownBuildSettingProvisioningState} can be used interchangeably with BuildSettingProvisioningState,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Creating** \
 * **Updating** \
 ...
 * **Canceled**
 */
export type BuildSettingProvisioningState = string;
...
/** Known values of {@link TestEndpointAuthState} that the service accepts. */
...
/**
 * Defines values for TestEndpointAuthState. \
 * {@link KnownTestEndpointAuthState} can be used interchangeably with TestEndpointAuthState,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Enabled**: Enable test endpoint auth. \
 * **Disabled**: Disable test endpoint auth
 */
...
/** Known values of {@link JobResourceProvisioningState} that the service accepts. */
...
/**
 * Defines values for JobResourceProvisioningState. \
 * {@link KnownJobResourceProvisioningState} can be used interchangeably with JobResourceProvisioningState,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Succeeded** \
 * **Failed** \
...
/** Optional parameters. */
export interface ConfigServersDeleteOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Contains response data for the delete operation. */
export type ConfigServersDeleteResponse = ConfigServersDeleteHeaders;

/** Optional parameters. */
export interface ConfigServersListOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the list operation. */
export type ConfigServersListResponse = ConfigServerResourceCollection;
...
/** Optional parameters. */
export interface ConfigServersListNextOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the listNext operation. */
export type ConfigServersListNextResponse = ConfigServerResourceCollection;
...
/** Optional parameters. */
export interface BuildSettingsListOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the list operation. */
export type BuildSettingsListResponse = BuildSettingResourceCollection;

/** Optional parameters. */
export interface BuildSettingsGetOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the get operation. */
export type BuildSettingsGetResponse = BuildSettingResource;

/** Optional parameters. */
export interface BuildSettingsDeleteOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Contains response data for the delete operation. */
export type BuildSettingsDeleteResponse = BuildSettingsDeleteHeaders;

/** Optional parameters. */
export interface BuildSettingsListSupportedTypesOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the listSupportedTypes operation. */
export type BuildSettingsListSupportedTypesResponse =
  SupportedBuildSettingTypes;

/** Optional parameters. */
export interface BuildSettingsListNextOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the listNext operation. */
export type BuildSettingsListNextResponse = BuildSettingResourceCollection;

/** Optional parameters. */
export interface BuildSettingsListSupportedTypesNextOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the listSupportedTypesNext operation. */
export type BuildSettingsListSupportedTypesNextResponse =
  SupportedBuildSettingTypes;

/** Optional parameters. */
export interface BuildSettingCreateOrUpdateOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Contains response data for the createOrUpdate operation. */
export type BuildSettingCreateOrUpdateResponse = BuildSettingResource;
...
/** Optional parameters. */
export interface JobListEnvSecretsOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the listEnvSecrets operation. */
export type JobListEnvSecretsResponse = EnvSecretsCollection;

/** Optional parameters. */
export interface JobExecutionCancelOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
export type JobExecutionCancelResponse = JobExecutionCancelHeaders;

/** Optional parameters. */
export interface JobExecutionGetOptionalParams
  extends coreClient.OperationOptions {}
...
/** Optional parameters. */
export interface JobExecutionListEnvSecretsOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the listEnvSecrets operation. */
export type JobExecutionListEnvSecretsResponse = EnvSecretsCollection;

/** Optional parameters. */
export interface JobExecutionsListOptionalParams
  extends coreClient.OperationOptions {}
...
/** Optional parameters. */
export interface JobExecutionsListNextOptionalParams
  extends coreClient.OperationOptions {}
