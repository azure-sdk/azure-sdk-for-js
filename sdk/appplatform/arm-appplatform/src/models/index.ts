...
/** Known values of {@link AutoSyncCertificate} that the service accepts. */
export enum KnownAutoSyncCertificate {
  /** Disabled */
  Disabled = "Disabled",
  /** Enabled */
  Enabled = "Enabled"
...
/**
 * Defines values for AutoSyncCertificate. \
 * {@link KnownAutoSyncCertificate} can be used interchangeably with AutoSyncCertificate,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Disabled** \
 * **Enabled**
 */
export type AutoSyncCertificate = string;
