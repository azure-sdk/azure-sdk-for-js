...
/**
 * This sample demonstrates how to Disable an APM globally.
 *
 ...
 */
async function servicesDisableApmGlobally(): Promise<void> {
  ...
  const result = await client.services.beginDisableApmGloballyAndWait(
    resourceGroupName,
    serviceName,
    apm
  );
