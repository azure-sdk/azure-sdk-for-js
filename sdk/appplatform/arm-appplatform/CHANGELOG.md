...
## 3.1.0-beta.1 (2024-03-19)
    
**Features**

  - Added operation group BuildSetting
  - Added operation group BuildSettings
  ...
  - Added Interface BuildSettingCreateOrUpdateOptionalParams
  - Added Interface BuildSettingProperties
  - Added Interface BuildSettingPropertiesSecrets
  - Added Interface BuildSettingReference
  - Added Interface BuildSettingResource
  - Added Interface BuildSettingResourceCollection
  - Added Interface BuildSettingsDeleteHeaders
  - Added Interface BuildSettingsDeleteOptionalParams
  - Added Interface BuildSettingsGetOptionalParams
  - Added Interface BuildSettingsListNextOptionalParams
  - Added Interface BuildSettingsListOptionalParams
  - Added Interface BuildSettingsListSupportedTypesNextOptionalParams
  - Added Interface BuildSettingsListSupportedTypesOptionalParams
  ...
  - Added Interface SupportedBuildSettingType
  - Added Interface SupportedBuildSettingTypes
  ...
  - Added Type Alias BuildSettingCreateOrUpdateResponse
  - Added Type Alias BuildSettingProvisioningState
  - Added Type Alias BuildSettingsDeleteResponse
  - Added Type Alias BuildSettingsGetResponse
  - Added Type Alias BuildSettingsListNextResponse
  - Added Type Alias BuildSettingsListResponse
  - Added Type Alias BuildSettingsListSupportedTypesNextResponse
  - Added Type Alias BuildSettingsListSupportedTypesResponse
  ...
  - Interface BuildProperties has a new optional parameter buildSettings
  ...
  - Added Enum KnownBuildSettingProvisioningState
