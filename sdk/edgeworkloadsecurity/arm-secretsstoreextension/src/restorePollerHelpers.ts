...
import { SecretsStoreExtensionManagementClient } from "./secretsStoreExtensionManagementClient.js";
import {
  _$deleteDeserialize,
  _updateDeserialize,
...
import {
  _$deleteDeserialize as _$deleteDeserializeAzureKeyVaultSecretProviderClasses,
  _updateDeserialize as _updateDeserializeAzureKeyVaultSecretProviderClasses,
  _createOrUpdateDeserialize as _createOrUpdateDeserializeAzureKeyVaultSecretProviderClasses,
...
export function restorePoller<TResponse extends PathUncheckedResponse, TResult>(
  client: SecretsStoreExtensionManagementClient,
...
const deserializeMap: Record<string, DeserializationHelper> = {
  ...
  "DELETE /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SecretSyncController/azureKeyVaultSecretProviderClasses/{azureKeyVaultSecretProviderClassName}":
    {
      deserializer: _$deleteDeserializeAzureKeyVaultSecretProviderClasses,
      expectedStatuses: ["202", "204", "200"],
    },
  "PATCH /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SecretSyncController/azureKeyVaultSecretProviderClasses/{azureKeyVaultSecretProviderClassName}":
    {
      deserializer: _updateDeserializeAzureKeyVaultSecretProviderClasses,
  ...
  "PUT /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SecretSyncController/azureKeyVaultSecretProviderClasses/{azureKeyVaultSecretProviderClassName}":
    {
      deserializer: _createOrUpdateDeserializeAzureKeyVaultSecretProviderClasses,
      expectedStatuses: ["200", "201"],
    },
};
