...
export interface HealthBotContext extends Client {
...
export function createHealthBot(
  ...
  const userAgentInfo = `azsdk-js-arm-healthbot/3.0.0`;
  ...
  return { ...clientContext, apiVersion, subscriptionId } as HealthBotContext;
}
