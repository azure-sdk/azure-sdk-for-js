...
export class BillingProfilesImpl implements BillingProfiles {
  ...
  ): PagedAsyncIterableIterator<BillingProfileAutoGenerated> {
  ...
  ): AsyncIterableIterator<BillingProfileAutoGenerated[]> {
  ...
  async beginCreateOrUpdate(
    billingAccountName: string,
    billingProfileName: string,
    parameters: BillingProfileAutoGenerated,
...
const getOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.BillingProfileAutoGenerated
    },
    default: {
      bodyMapper: Mappers.ArmError
    }
