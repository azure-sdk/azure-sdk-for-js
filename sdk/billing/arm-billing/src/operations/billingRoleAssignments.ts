...
export class BillingRoleAssignmentsImpl implements BillingRoleAssignments {
  ...
  createOrUpdateByBillingAccount(
    ...
    return this.client.sendOperationRequest(
      { billingAccountName, billingRoleAssignmentName, options },
      createOrUpdateByBillingAccountOperationSpec
    );
  }
   ...
   * @param options The options parameters.
   */
  async beginAddByBillingAccount(
    billingAccountName: string,
  ...
  > {
    ...
    const lro = createLroSpec({
      ...
      spec: addByBillingAccountOperationSpec
    });
    const poller = await createHttpPoller<
      BillingRoleAssignmentsAddByBillingAccountResponse,
      OperationState<BillingRoleAssignmentsAddByBillingAccountResponse>
   ...
   * @param options The options parameters.
   */
  async beginAddByBillingAccountAndWait(
    billingAccountName: string,
    options?: BillingRoleAssignmentsAddByBillingAccountOptionalParams
  ): Promise<BillingRoleAssignmentsAddByBillingAccountResponse> {
    const poller = await this.beginAddByBillingAccount(
      billingAccountName,
      options
    );
    return poller.pollUntilDone();
  ...
  createOrUpdateByDepartment(
    ...
    return this.client.sendOperationRequest(
      ...
      createOrUpdateByDepartmentOperationSpec
    );
  }
  ...
  createOrUpdateByEnrollmentAccount(
    ...
    return this.client.sendOperationRequest(
      ...
      createOrUpdateByEnrollmentAccountOperationSpec
    );
  }
...
const addByBillingAccountOperationSpec: coreClient.OperationSpec = {
  path:
