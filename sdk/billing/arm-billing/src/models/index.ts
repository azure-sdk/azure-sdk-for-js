...
export interface IndirectRelationshipInfoAutoGenerated {
  /** The billing account name of the partner or the customer for an indirect motion. */
  billingAccountName?: string;
  /** The billing profile name of the partner or the customer for an indirect motion. This field is not populated for Enterprise Agreement billing accounts. */
  billingProfileName?: string;
  /** The display name of the partner or customer for an indirect motion. */
  displayName?: string;
}
...
export interface AvailableBalanceProperties
  extends AvailableBalancePropertiesAutoGenerated {}

/** Credit amount for immediate payment. */
export interface AvailableBalancePropertiesCreditAmountForImmediatePayment
  extends Amount {}
...
/** Known values of {@link AgreementAcceptanceMode} that the service accepts. */
...
/**
 * Defines values for AgreementAcceptanceMode. \
 * {@link KnownAgreementAcceptanceMode} can be used interchangeably with AgreementAcceptanceMode,
...
/** Known values of {@link AcceptanceStatus} that the service accepts. */
 ...
 * {@link KnownAcceptanceStatus} can be used interchangeably with AcceptanceStatus,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Other** \
 * **Accepted** \
...
/** Known values of {@link AgreementStatus} that the service accepts. */
...
/**
 * Defines values for AgreementStatus. \
 * {@link KnownAgreementStatus} can be used interchangeably with AgreementStatus,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Other** \
 * **Draft** \
...
/** Known values of {@link InvoiceSectionLabelManagement} that the service accepts. */
...
/**
 * Defines values for InvoiceSectionLabelManagement. \
 * {@link KnownInvoiceSectionLabelManagement} can be used interchangeably with InvoiceSectionLabelManagement,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Other** \
 * **Allowed** \
...
/** Optional parameters. */
export interface AvailableBalanceGetByBillingAccountOptionalParams
  extends coreClient.OperationOptions {}
...
/** Optional parameters. */
export interface AvailableBalanceGetByBillingProfileOptionalParams
  extends coreClient.OperationOptions {}
