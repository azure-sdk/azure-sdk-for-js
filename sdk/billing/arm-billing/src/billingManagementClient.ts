...
import {
  ...
  ProductsImpl,
  ReservationsImpl,
  ReservationOperationsImpl,
  ReservationOrderOperationsImpl,
...
export class BillingManagementClient extends coreClient.ServiceClient {
  ...
  constructor(
    ...
    this.reservationOperations = new ReservationOperationsImpl(this);
    this.reservationOrderOperations = new ReservationOrderOperationsImpl(this);
