...
export interface AssociatedTenants {
  /**
   * Lists the tenants that can collaborate with the billing account on commerce activities like viewing
   * and downloading invoices, managing payments, making purchases, and managing licenses.
