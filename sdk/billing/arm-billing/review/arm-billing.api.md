...
export interface BillingAccounts {
    beginUpdate(billingAccountName: string, parameters: BillingAccountUpdateRequest, options?: BillingAccountsUpdateOptionalParams): Promise<SimplePollerLike<OperationState<BillingAccountsUpdateResponse>, BillingAccountsUpdateResponse>>;
...
export interface BillingProfiles {
    beginCreateOrUpdate(billingAccountName: string, billingProfileName: string, parameters: BillingProfileAutoGenerated, options?: BillingProfilesCreateOrUpdateOptionalParams): Promise<SimplePollerLike<OperationState<BillingProfilesCreateOrUpdateResponse>, BillingProfilesCreateOrUpdateResponse>>;
    beginCreateOrUpdateAndWait(billingAccountName: string, billingProfileName: string, parameters: BillingProfileAutoGenerated, options?: BillingProfilesCreateOrUpdateOptionalParams): Promise<BillingProfilesCreateOrUpdateResponse>;
    ...
    listByBillingAccount(billingAccountName: string, options?: BillingProfilesListByBillingAccountOptionalParams): PagedAsyncIterableIterator<BillingProfileAutoGenerated>;
}
...
export interface BillingPropertyOperations {
    get(subscriptionId: string, options?: BillingPropertyGetOptionalParams): Promise<BillingPropertyGetResponse>;
    update(subscriptionId: string, parameters: BillingProperty, options?: BillingPropertyUpdateOptionalParams): Promise<BillingPropertyUpdateResponse>;
}
...
// @public
export interface BillingRoleAssignmentProperties extends BillingRoleAssignmentPropertiesAutoGenerated {
}

// @public
export interface BillingRoleAssignmentPropertiesAutoGenerated {
    readonly billingAccountDisplayName?: string;
    readonly billingAccountId?: string;
    readonly billingProfileDisplayName?: string;
    readonly billingProfileId?: string;
...
export interface BillingRoleAssignments {
    beginAddByBillingAccount(billingAccountName: string, options?: BillingRoleAssignmentsAddByBillingAccountOptionalParams): Promise<SimplePollerLike<OperationState<BillingRoleAssignmentsAddByBillingAccountResponse>, BillingRoleAssignmentsAddByBillingAccountResponse>>;
    beginAddByBillingAccountAndWait(billingAccountName: string, options?: BillingRoleAssignmentsAddByBillingAccountOptionalParams): Promise<BillingRoleAssignmentsAddByBillingAccountResponse>;
    beginCreateByBillingProfile(billingAccountName: string, billingProfileName: string, options?: BillingRoleAssignmentsCreateByBillingProfileOptionalParams): Promise<SimplePollerLike<OperationState<BillingRoleAssignmentsCreateByBillingProfileResponse>, BillingRoleAssignmentsCreateByBillingProfileResponse>>;
    beginCreateByBillingProfileAndWait(billingAccountName: string, billingProfileName: string, options?: BillingRoleAssignmentsCreateByBillingProfileOptionalParams): Promise<BillingRoleAssignmentsCreateByBillingProfileResponse>;
    beginCreateByCustomer(billingAccountName: string, billingProfileName: string, customerName: string, options?: BillingRoleAssignmentsCreateByCustomerOptionalParams): Promise<SimplePollerLike<OperationState<BillingRoleAssignmentsCreateByCustomerResponse>, BillingRoleAssignmentsCreateByCustomerResponse>>;
    beginCreateByCustomerAndWait(billingAccountName: string, billingProfileName: string, customerName: string, options?: BillingRoleAssignmentsCreateByCustomerOptionalParams): Promise<BillingRoleAssignmentsCreateByCustomerResponse>;
    beginCreateByInvoiceSection(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, options?: BillingRoleAssignmentsCreateByInvoiceSectionOptionalParams): Promise<SimplePollerLike<OperationState<BillingRoleAssignmentsCreateByInvoiceSectionResponse>, BillingRoleAssignmentsCreateByInvoiceSectionResponse>>;
    beginCreateByInvoiceSectionAndWait(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, options?: BillingRoleAssignmentsCreateByInvoiceSectionOptionalParams): Promise<BillingRoleAssignmentsCreateByInvoiceSectionResponse>;
    ...
    createOrUpdateByBillingAccount(billingAccountName: string, billingRoleAssignmentName: string, options?: BillingRoleAssignmentsCreateOrUpdateByBillingAccountOptionalParams): Promise<BillingRoleAssignmentsCreateOrUpdateByBillingAccountResponse>;
    createOrUpdateByDepartment(billingAccountName: string, departmentName: string, billingRoleAssignmentName: string, options?: BillingRoleAssignmentsCreateOrUpdateByDepartmentOptionalParams): Promise<BillingRoleAssignmentsCreateOrUpdateByDepartmentResponse>;
    createOrUpdateByEnrollmentAccount(billingAccountName: string, enrollmentAccountName: string, billingRoleAssignmentName: string, options?: BillingRoleAssignmentsCreateOrUpdateByEnrollmentAccountOptionalParams): Promise<BillingRoleAssignmentsCreateOrUpdateByEnrollmentAccountResponse>;
    ...
    deleteByCustomer(billingAccountName: string, billingProfileName: string, customerName: string, billingRoleAssignmentName: string, options?: BillingRoleAssignmentsDeleteByCustomerOptionalParams): Promise<BillingRoleAssignmentsDeleteByCustomerResponse>;
    deleteByDepartment(billingAccountName: string, departmentName: string, billingRoleAssignmentName: string, options?: BillingRoleAssignmentsDeleteByDepartmentOptionalParams): Promise<BillingRoleAssignmentsDeleteByDepartmentResponse>;
    deleteByEnrollmentAccount(billingAccountName: string, enrollmentAccountName: string, billingRoleAssignmentName: string, options?: BillingRoleAssignmentsDeleteByEnrollmentAccountOptionalParams): Promise<BillingRoleAssignmentsDeleteByEnrollmentAccountResponse>;
...
// @public
export interface BillingRoleAssignmentsAddByBillingAccountHeaders {
    // (undocumented)
    location?: string;
}

// @public
export interface BillingRoleAssignmentsAddByBillingAccountOptionalParams extends coreClient.OperationOptions {
    body?: BillingRoleAssignmentPropertiesAutoGenerated;
    resumeFrom?: string;
    updateIntervalInMs?: number;
}
...
// @public
export type BillingRoleAssignmentsDeleteByCustomerResponse = BillingRoleAssignment;
...
// @public
export type BillingRoleAssignmentsDeleteByDepartmentResponse = BillingRoleAssignment;
...
// @public
export type BillingRoleAssignmentsDeleteByEnrollmentAccountResponse = BillingRoleAssignment;
...
// @public
export interface BillingRoleDefinitionProperties extends BillingRoleDefinitionPropertiesAutoGenerated {
}

// @public
export interface BillingRoleDefinitionPropertiesAutoGenerated {
    readonly description?: string;
    readonly permissions?: BillingPermission[];
    roleName: string;
}
...
export interface BillingSubscriptions {
    beginMove(billingAccountName: string, subscriptionId: string, parameters: TransferBillingSubscriptionRequestProperties, options?: BillingSubscriptionsMoveOptionalParams): Promise<SimplePollerLike<OperationState<BillingSubscriptionsMoveResponse>, BillingSubscriptionsMoveResponse>>;
    beginMoveAndWait(billingAccountName: string, subscriptionId: string, parameters: TransferBillingSubscriptionRequestProperties, options?: BillingSubscriptionsMoveOptionalParams): Promise<BillingSubscriptionsMoveResponse>;
    get(billingAccountName: string, subscriptionId: string, options?: BillingSubscriptionsGetOptionalParams): Promise<BillingSubscriptionsGetResponse>;
    ...
    update(billingAccountName: string, subscriptionId: string, parameters: BillingSubscription, options?: BillingSubscriptionsUpdateOptionalParams): Promise<BillingSubscriptionsUpdateResponse>;
    validateMove(billingAccountName: string, subscriptionId: string, parameters: TransferBillingSubscriptionRequestProperties, options?: BillingSubscriptionsValidateMoveOptionalParams): Promise<BillingSubscriptionsValidateMoveResponse>;
}
...
export interface CheckAccess {
    getByBillingAccount(billingAccountName: string, options?: CheckAccessGetByBillingAccountOptionalParams): Promise<CheckAccessGetByBillingAccountResponse>;
    getByBillingProfile(billingAccountName: string, billingProfileName: string, options?: CheckAccessGetByBillingProfileOptionalParams): Promise<CheckAccessGetByBillingProfileResponse>;
    getByCustomer(billingAccountName: string, billingProfileName: string, customerName: string, options?: CheckAccessGetByCustomerOptionalParams): Promise<CheckAccessGetByCustomerResponse>;
    getByDepartment(billingAccountName: string, departmentName: string, options?: CheckAccessGetByDepartmentOptionalParams): Promise<CheckAccessGetByDepartmentResponse>;
    getByEnrollmentAccount(billingAccountName: string, enrollmentAccountName: string, options?: CheckAccessGetByEnrollmentAccountOptionalParams): Promise<CheckAccessGetByEnrollmentAccountResponse>;
    getByInvoiceSection(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, options?: CheckAccessGetByInvoiceSectionOptionalParams): Promise<CheckAccessGetByInvoiceSectionResponse>;
}

// @public
export interface CheckAccessGetByBillingAccountOptionalParams extends coreClient.OperationOptions {
    body?: CheckAccessRequest;
}

// @public
export type CheckAccessGetByBillingAccountResponse = CheckAccessResponse[];

// @public
export interface CheckAccessGetByBillingProfileOptionalParams extends coreClient.OperationOptions {
    body?: CheckAccessRequest;
}

// @public
export type CheckAccessGetByBillingProfileResponse = CheckAccessResponse[];

// @public
export interface CheckAccessGetByCustomerOptionalParams extends coreClient.OperationOptions {
    body?: CheckAccessRequest;
}

// @public
export type CheckAccessGetByCustomerResponse = CheckAccessResponse[];

// @public
export interface CheckAccessGetByDepartmentOptionalParams extends coreClient.OperationOptions {
    body?: CheckAccessRequest;
}

// @public
export type CheckAccessGetByDepartmentResponse = CheckAccessResponse[];

// @public
export interface CheckAccessGetByEnrollmentAccountOptionalParams extends coreClient.OperationOptions {
    body?: CheckAccessRequest;
}

// @public
export type CheckAccessGetByEnrollmentAccountResponse = CheckAccessResponse[];

// @public
export interface CheckAccessGetByInvoiceSectionOptionalParams extends coreClient.OperationOptions {
    body?: CheckAccessRequest;
}

// @public
export type CheckAccessGetByInvoiceSectionResponse = CheckAccessResponse[];
...
// @public
export interface DepartmentProperties extends DepartmentPropertiesAutoGenerated {
}
...
export interface Departments {
    ...
    listByBillingAccount(billingAccountName: string, options?: DepartmentsListByBillingAccountOptionalParams): PagedAsyncIterableIterator<DepartmentAutoGenerated>;
}
...
// @public
export interface EnrollmentAccountProperties extends EnrollmentAccountPropertiesAutoGenerated {
}
...
export interface EnrollmentAccounts {
    ...
    getByAccountIdByDepartmentId(billingAccountName: string, departmentName: string, enrollmentAccountName: string, options?: EnrollmentAccountsGetByAccountIdByDepartmentIdOptionalParams): Promise<EnrollmentAccountsGetByAccountIdByDepartmentIdResponse>;
    listByBillingAccount(billingAccountName: string, options?: EnrollmentAccountsListByBillingAccountOptionalParams): PagedAsyncIterableIterator<EnrollmentAccountAutoGenerated>;
    listByDepartmentName(billingAccountName: string, departmentName: string, options?: EnrollmentAccountsListByDepartmentNameOptionalParams): PagedAsyncIterableIterator<EnrollmentAccountAutoGenerated>;
}

// @public
export interface EnrollmentAccountsGetByAccountIdByDepartmentIdOptionalParams extends coreClient.OperationOptions {
}
...
// @public
export interface EnrollmentAccountsListByDepartmentNameNextOptionalParams extends coreClient.OperationOptions {
}
...
// @public
export interface EnrollmentAccountsListByDepartmentNameOptionalParams extends coreClient.OperationOptions {
    count?: boolean;
    filter?: string;
    orderBy?: string;
    search?: string;
...
// @public
export interface IndirectRelationshipInfoAutoGenerated {
    billingAccountName?: string;
    billingProfileName?: string;
    displayName?: string;
}
...
export interface Invoices {
    beginDownloadBillingSubscriptionInvoice(subscriptionId: string, invoiceName: string, downloadToken: string, options?: InvoicesDownloadBillingSubscriptionInvoiceOptionalParams): Promise<SimplePollerLike<OperationState<InvoicesDownloadBillingSubscriptionInvoiceResponse>, InvoicesDownloadBillingSubscriptionInvoiceResponse>>;
    beginDownloadBillingSubscriptionInvoiceAndWait(subscriptionId: string, invoiceName: string, downloadToken: string, options?: InvoicesDownloadBillingSubscriptionInvoiceOptionalParams): Promise<InvoicesDownloadBillingSubscriptionInvoiceResponse>;
    beginDownloadInvoice(billingAccountName: string, invoiceName: string, downloadToken: string, options?: InvoicesDownloadInvoiceOptionalParams): Promise<SimplePollerLike<OperationState<InvoicesDownloadInvoiceResponse>, InvoicesDownloadInvoiceResponse>>;
    ...
    beginDownloadMultipleBillingSubscriptionInvoices(subscriptionId: string, downloadUrls: string[], options?: InvoicesDownloadMultipleBillingSubscriptionInvoicesOptionalParams): Promise<SimplePollerLike<OperationState<InvoicesDownloadMultipleBillingSubscriptionInvoicesResponse>, InvoicesDownloadMultipleBillingSubscriptionInvoicesResponse>>;
    beginDownloadMultipleBillingSubscriptionInvoicesAndWait(subscriptionId: string, downloadUrls: string[], options?: InvoicesDownloadMultipleBillingSubscriptionInvoicesOptionalParams): Promise<InvoicesDownloadMultipleBillingSubscriptionInvoicesResponse>;
    ...
    getBySubscriptionAndInvoiceId(subscriptionId: string, invoiceName: string, options?: InvoicesGetBySubscriptionAndInvoiceIdOptionalParams): Promise<InvoicesGetBySubscriptionAndInvoiceIdResponse>;
    ...
    listByBillingSubscription(subscriptionId: string, periodStartDate: string, periodEndDate: string, options?: InvoicesListByBillingSubscriptionOptionalParams): PagedAsyncIterableIterator<Invoice>;
}
...
// @public
export enum KnownNotificationFrequency {
    Daily = "Daily",
    Monthly = "Monthly",
    None = "None",
    Weekly = "Weekly"
...
// @public
export type NotificationFrequency = string;
