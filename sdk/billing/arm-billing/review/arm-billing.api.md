...
// @public
export interface AssociatedTenant extends ArmResource {
    billingManagementState?: BillingManagementTenantState;
    displayName?: string;
    provisioningAccessState?: ProvisioningTenantState;
...
// @public
export interface AssociatedTenantProperties extends AssociatedTenantPropertiesAutoGenerated {
}

// @public
export interface AssociatedTenantPropertiesAutoGenerated {
    billingManagementState?: BillingManagementTenantState;
    displayName?: string;
    provisioningAccessState?: ProvisioningTenantState;
    readonly provisioningBillingRequestId?: string;
...
export interface AssociatedTenants {
    beginCreateOrUpdate(billingAccountName: string, associatedTenantName: string, options?: AssociatedTenantsCreateOrUpdateOptionalParams): Promise<SimplePollerLike<OperationState<AssociatedTenantsCreateOrUpdateResponse>, AssociatedTenantsCreateOrUpdateResponse>>;
    beginCreateOrUpdateAndWait(billingAccountName: string, associatedTenantName: string, options?: AssociatedTenantsCreateOrUpdateOptionalParams): Promise<AssociatedTenantsCreateOrUpdateResponse>;
...
// @public
export interface BillingRequest extends ArmResource {
...
// @public
export interface BillingRequestProperties extends BillingRequestPropertiesAutoGenerated {
}

// @public
export interface BillingRequestPropertiesAutoGenerated {
    additionalInformation?: {
        [propertyName: string]: string;
    };
    readonly billingAccountDisplayName?: string;
...
export interface BillingRequests {
    beginCreateOrUpdate(billingRequestName: string, options?: BillingRequestsCreateOrUpdateOptionalParams): Promise<SimplePollerLike<OperationState<BillingRequestsCreateOrUpdateResponse>, BillingRequestsCreateOrUpdateResponse>>;
    beginCreateOrUpdateAndWait(billingRequestName: string, options?: BillingRequestsCreateOrUpdateOptionalParams): Promise<BillingRequestsCreateOrUpdateResponse>;
