...
export interface CalculateRefund {
    post(body: CalculateRefundRequest, options?: CalculateRefundPostOptionalParams): Promise<CalculateRefundPostResponse>;
}
...
export interface Return {
    post(body: RefundRequest, options?: ReturnPostOptionalParams): Promise<ReturnPostResponse>;
}
