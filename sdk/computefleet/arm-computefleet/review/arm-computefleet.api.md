...
export class MicrosoftAzureFleetTesting extends coreClient.ServiceClient {
    // (undocumented)
    $host: string;
    constructor(credentials: coreAuth.TokenCredential, subscriptionId: string, options?: MicrosoftAzureFleetTestingOptionalParams);
    // (undocumented)
    apiVersion: string;
    // (undocumented)
    fleets: Fleets;
...
// @public
export interface MicrosoftAzureFleetTestingOptionalParams extends coreClient.ServiceClientOptions {
    $host?: string;
    apiVersion?: string;
    endpoint?: string;
}
