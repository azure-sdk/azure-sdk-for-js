...
// @public (undocumented)
export class MicrosoftAzureFleetTest extends coreClient.ServiceClient {
    // (undocumented)
    $host: string;
    constructor(credentials: coreAuth.TokenCredential, subscriptionId: string, options?: MicrosoftAzureFleetTestOptionalParams);
    // (undocumented)
    apiVersion: string;
    // (undocumented)
    fleets: Fleets;
...
// @public
export interface MicrosoftAzureFleetTestOptionalParams extends coreClient.ServiceClientOptions {
    $host?: string;
    apiVersion?: string;
    endpoint?: string;
}
