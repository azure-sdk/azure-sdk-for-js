...
export class MicrosoftAzureFleetForTesting extends coreClient.ServiceClient {
    // (undocumented)
    $host: string;
    constructor(credentials: coreAuth.TokenCredential, subscriptionId: string, options?: MicrosoftAzureFleetForTestingOptionalParams);
    // (undocumented)
    apiVersion: string;
    // (undocumented)
    fleets: Fleets;
...
// @public
export interface MicrosoftAzureFleetForTestingOptionalParams extends coreClient.ServiceClientOptions {
    $host?: string;
    apiVersion?: string;
    endpoint?: string;
}
