...
export interface Workspaces {
    ...
    updateTags(resourceGroupName: string, workspaceName: string, properties: QuantumWorkspaceTagsUpdate, options?: WorkspacesUpdateTagsOptionalParams): Promise<WorkspacesUpdateTagsResponse>;
}
