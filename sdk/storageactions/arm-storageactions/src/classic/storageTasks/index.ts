...
export interface StorageTasksOperations {
  ...
  list: (
    resourceGroupName: string,
    storageTaskName: string,
    options?: StorageTasksListOptionalParams,
...
function _getStorageTasks(context: StorageActionsContext) {
  return {
    storageTaskAssignmentList: (
      resourceGroupName: string,
      storageTaskName: string,
...
export function _getStorageTasksOperations(context: StorageActionsContext): StorageTasksOperations {
  return {
