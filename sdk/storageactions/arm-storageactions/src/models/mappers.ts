...
export const StorageTaskListResult: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "StorageTaskListResult",
    modelProperties: {
      value: {
        serializedName: "value",
        required: true,
...
export const StorageTaskReportInstanceListResult: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "StorageTaskReportInstanceListResult",
    modelProperties: {
      value: {
        serializedName: "value",
        required: true,
...
export const PagedStorageTaskAssignment: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "PagedStorageTaskAssignment",
    modelProperties: {
      value: {
        serializedName: "value",
        required: true,
