...
export interface AutomaticZoneRebalancingPolicy {
  ...
  /** Optional property used for performing automatic expansion. If defined, the scale set will grow to minTargetZonalInstanceCount. Until then, automatic rebalancing will not take effect. */
  automaticExpansionPolicy?: AutomaticExpansionPolicy;
}

/** The configuration parameters used by Automatic AZ Balancing for expanding the scale set to a target zonal instance count. */
export interface AutomaticExpansionPolicy {
  /** Specifies the minimum number of zonal VMs that will be gradually provisioned to the scale set. */
  minTargetZonalInstanceCount?: number;
}
