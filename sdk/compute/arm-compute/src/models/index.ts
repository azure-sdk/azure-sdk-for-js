...
export interface ProxyAgentSettingsImds {
  ...
  /** Specifies the resource id on the form of /subscriptions/{SubscriptionId}/resourceGroups/{ResourceGroupName}/providers/Microsoft.Compute/galleries/{galleryName}/InVMAccessSettings/{settings}/versions/{version} */
  accessControlProfileReferenceId?: string;
}

/** Specify access control profile for IMDS endpoint */
export interface ProxyAgentSettingsImdsAccessControlProfile {
  /** Specifies the mode that ProxyAgent will execute on. ProxyAgent will start to simulate and log access control over requests to IMDS endpoints in Audit mode, while in Enforce mode it will enforce access control. The default value is Disabled mode. */
  mode?: Mode;
  /** Specify a dictionary of rules, key is URL path, value is an array of allowed list */
  rules?: { [propertyName: string]: RuleDefinition[] };
}
...
export interface ProxyAgentSettingsWireserverAccessControlProfile {
  /** Specifies the mode that ProxyAgent will execute on. ProxyAgent will start to simulate and log access control over requests to wireserver endpoints in Audit mode, while in Enforce mode it will enforce access control. Default is Audit mode. */
  mode?: Mode;
