...
export interface Placement {
  /** Specifies the policy for resource's placement in availability zone. <br>Supported policies: {'Any'}<br><br>Policy wise behavior:<br>'Any' - An availability zone will be automatically picked by system as part of resource creation. */
...
export interface VirtualMachine extends Resource {
  ...
  /** The virtual machine zones. */
  zones?: string[];
  /** Placement section specifies the user-defined constraints for virtual machine hardware placement.<br> Minimum api-version: 2024-03-01. */
  placement?: Placement;
  /** The extended location of the Virtual Machine. */
  extendedLocation?: ExtendedLocation;
  /**
