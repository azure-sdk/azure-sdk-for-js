...
export interface Placement {
  /** Specifies the policy for resource's placement in availability zone. <br>Possible values are:<br>**Any** - An availability zone will be automatically picked by system as part of resource creation. */
