...
export interface VirtualMachine extends Resource {
  ...
  /** Specifies Scheduled Event related configurations. */
  scheduledEventsProfile?: ScheduledEventsProfile;
  /** UserData for the VM, which must be base-64 encoded. Customer should not pass any secrets in here. Maximum size limit of 256KB before base-64 encoding. Minimum api-version: 2021-03-01. */
  userData?: string;
