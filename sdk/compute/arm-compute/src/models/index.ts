...
export interface VirtualMachineScaleSetHardwareProfile {
  /** Specifies the properties for customizing the size of the virtual machine. Minimum api-version: 2022-08-01. <br><br> Please follow the instructions in [VM Customization](https://aka.ms/vmcustomization) for more details. */
...
/** Specifies the desired targets for mixing Spot and Regular priority VMs in the same VMSS Flex instance. This feature is only supported for Scale Sets with Flexible orchestration mode. <br><br>Minimum api-version: 2022-08-01 */
...
export interface DedicatedHostGroupPropertiesAdditionalCapabilities {
  /** The flag that enables or disables a capability to have UltraSSD Enabled Virtual Machines on Dedicated Hosts of the Dedicated Host Group. For the Virtual Machines to be UltraSSD Enabled, UltraSSDEnabled flag for the resource needs to be set true as well. The value is defaulted to 'false' when not provided. Please refer to https://docs.microsoft.com/en-us/azure/virtual-machines/disks-enable-ultra-ssd for more details on Ultra SSD feature. <br><br>NOTE: The ultraSSDEnabled setting can only be enabled for Host Groups that are created as zonal. <br><br>Minimum api-version: 2022-08-01. */
  ultraSSDEnabled?: boolean;
}
...
export interface VirtualMachineScaleSet extends Resource {
  ...
  /** Specify the target splits for Spot and Regular priority VM's within a VMSS Flex instance. This feature is only supported for Scale Sets with Flexible orchestration mode. <br><br>Minimum api-version: 2022-08-01 */
  priorityMixPolicy?: PriorityMixPolicy;
  /**
   * Specifies the time at which the Virtual Machine Scale Set resource was created.<br><br>Minimum api-version: 2022-08-01.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
...
export interface CapacityReservation extends Resource {
  ...
  /**
   * Specifies the time at which the Capacity Reservation resource was created.<br><br>Minimum api-version: 2022-08-01.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly timeCreated?: Date;
}
