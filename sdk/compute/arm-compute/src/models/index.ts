...
/** Describes the script sources for run command. Use only one these script sources: script, scriptUri, commandId, galleryScriptReferenceId. */
export interface VirtualMachineRunCommandScriptSource {
  /** Specifies the script content to be executed on the VM. */
  script?: string;
  /** Specifies the script download location. It can be either SAS URI of an Azure storage blob with read access or public URI. */
  scriptUri?: string;
  /** Specifies a commandId of predefined built-in script. commandIds available for Linux listed at https://aka.ms/RunCommandManagedLinux#available-commands, Windows at https://aka.ms/RunCommandManagedWindows#available-commands */
  commandId?: string;
...
/** Known values of {@link VirtualMachineRunCommandScriptSourceScriptShell} that the service accepts. */
...
/**
 * Defines values for VirtualMachineRunCommandScriptSourceScriptShell. \
 * {@link KnownVirtualMachineRunCommandScriptSourceScriptShell} can be used interchangeably with VirtualMachineRunCommandScriptSourceScriptShell,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Default** \
 * **Powershell7**
