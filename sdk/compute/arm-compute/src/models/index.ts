...
export interface CapacityReservation extends Resource {
  ...
  /**
   * This is the readonly property that is populated and set in the response to specify the Maximum Fault Domain Count that capacity reservation support using the VM Size.<br><br>Minimum api-version: 2022-08-01.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
