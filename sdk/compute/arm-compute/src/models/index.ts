...
/** Optional parameters. */
export interface SoftDeleteListSoftDeletedResourcesByArtifactNameOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the listSoftDeletedResourcesByArtifactName operation. */
export type SoftDeleteListSoftDeletedResourcesByArtifactNameResponse =
  GallerySoftDeletedResourceList;

/** Optional parameters. */
export interface SoftDeleteListSoftDeletedResourcesByArtifactNameNextOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the listSoftDeletedResourcesByArtifactNameNext operation. */
export type SoftDeleteListSoftDeletedResourcesByArtifactNameNextResponse =
  GallerySoftDeletedResourceList;
