...
export interface Placement {
  /** Specifies the policy for virtual machine's placement in availability zone. <br>Possible values are:<br><br>**Any** - An availability zone will be automatically picked by system as part of virtual machine creation. */
...
export interface VirtualMachine extends Resource {
  ...
  /** The virtual machine zones. */
  zones?: string[];
  /** Placement section specifies the user-defined constraints for virtual machine hardware placement. This property cannot be changed once VM is provisioned.<br> Minimum api-version: 2024-03-01. */
  placement?: Placement;
  /** The extended location of the Virtual Machine. */
  extendedLocation?: ExtendedLocation;
  /**
