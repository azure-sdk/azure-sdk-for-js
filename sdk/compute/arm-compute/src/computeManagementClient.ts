...
import { ContainerServicesImpl } from "./operations";
...
export class ComputeManagementClient extends coreClient.ServiceClient {
  ...
  constructor(
    ...
    const packageDetails = `azsdk-js-arm-compute/20.0.0-beta.1`;
    ...
    this.apiVersion = options.apiVersion || "2022-09-07-preview";
