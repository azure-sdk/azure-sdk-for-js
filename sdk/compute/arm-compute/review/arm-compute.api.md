...
export interface VirtualMachineApplications {
    ...
    beginPut(resourceGroupName: string, vmName: string, applicationName: string, application: VMApplicationProxyResource, options?: VirtualMachineApplicationsPutOptionalParams): Promise<SimplePollerLike<OperationState<VirtualMachineApplicationsPutResponse>, VirtualMachineApplicationsPutResponse>>;
    beginPutAndWait(resourceGroupName: string, vmName: string, applicationName: string, application: VMApplicationProxyResource, options?: VirtualMachineApplicationsPutOptionalParams): Promise<VirtualMachineApplicationsPutResponse>;
...
// @public
export type VirtualMachineApplicationsPutResponse = VMApplicationProxyResource;
