...
export interface CloudServiceNetworkProfile {
    ...
    swappableCloudService?: SubResourceAutoGenerated;
}
...
export interface CloudServiceVaultAndSecretReference {
    secretUrl?: string;
    sourceVault?: SubResourceAutoGenerated;
}
...
export interface LoadBalancerFrontendIPConfigurationProperties {
    ...
    publicIPAddress?: SubResourceAutoGenerated;
    subnet?: SubResourceAutoGenerated;
}
...
export interface RoleInstanceNetworkProfile {
    readonly networkInterfaces?: SubResourceAutoGenerated[];
}
...
// @public (undocumented)
export interface SubResourceAutoGenerated {
    id?: string;
}
