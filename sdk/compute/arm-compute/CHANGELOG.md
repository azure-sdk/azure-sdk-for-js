...
### Features Added
  ...
  - Added Interface PagedVirtualMachineImageResource
  ...
  - Added Interface VirtualMachineImagesEdgeZoneListNextOptionalParams
  - Added Interface VirtualMachineImagesEdgeZoneListOffersNextOptionalParams
  - Added Interface VirtualMachineImagesEdgeZoneListPublishersNextOptionalParams
  - Added Interface VirtualMachineImagesEdgeZoneListSkusNextOptionalParams
  - Added Interface VirtualMachineImagesListNextOptionalParams
  - Added Interface VirtualMachineImagesListOffersNextOptionalParams
  - Added Interface VirtualMachineImagesListPublishersNextOptionalParams
  - Added Interface VirtualMachineImagesListSkusNextOptionalParams
  ...
  - Added Type Alias VirtualMachineImagesEdgeZoneListNextResponse
  - Added Type Alias VirtualMachineImagesEdgeZoneListOffersNextResponse
  - Added Type Alias VirtualMachineImagesEdgeZoneListPublishersNextResponse
  - Added Type Alias VirtualMachineImagesEdgeZoneListSkusNextResponse
  - Added Type Alias VirtualMachineImagesListNextResponse
  - Added Type Alias VirtualMachineImagesListOffersNextResponse
  - Added Type Alias VirtualMachineImagesListPublishersNextResponse
  - Added Type Alias VirtualMachineImagesListSkusNextResponse
  ...
  - Interface DiskRestorePoint has a new optional parameter resourceId
  - Interface DiskRestorePoint has a new optional parameter resourceName
  - Interface DiskRestorePoint has a new optional parameter resourceType
  ...
  - Interface PrivateEndpointConnection has a new optional parameter connectionId
  - Interface PrivateEndpointConnection has a new optional parameter connectionName
  - Interface PrivateEndpointConnection has a new optional parameter connectionType
  ...
  - Interface VirtualMachineExtensionUpdate has a new optional parameter provisionAfterExtensions
  - Interface VirtualMachineExtensionUpdate has a new optional parameter provisioningState
  - Interface VirtualMachinesAttachDetachDataDisksHeaders has a new optional parameter retryAfter
  - Interface VirtualMachineScaleSetExtension has a new optional parameter extensionName
  - Interface VirtualMachineScaleSetExtension has a new optional parameter extensionType
  ...
  - Interface VirtualMachineScaleSetVMExtension has a new optional parameter extensionName
  - Interface VirtualMachineScaleSetVMExtension has a new optional parameter extensionType
  - Interface VirtualMachineScaleSetVMExtensionUpdate has a new optional parameter provisionAfterExtensions
  - Interface VirtualMachineScaleSetVMExtensionUpdate has a new optional parameter provisioningState
