...
**Features**
  ...
  - Added operation group CommunityGallerySecurityPostures
  - Added operation group CommunityGallerySecurityPostureVersions
  - Added operation group GallerySecurityPostures
  - Added operation group GallerySecurityPostureVersions
  - Added Interface CommunityGallerySecurityPosturesGetOptionalParams
  - Added Interface CommunityGallerySecurityPostureVersionsGetOptionalParams
  - Added Interface CommunitySecurityPosture
  - Added Interface CommunitySecurityPostureVersion
  - Added Interface GallerySecurityPosture
  - Added Interface GallerySecurityPosturesCreateOrUpdateOptionalParams
  - Added Interface GallerySecurityPosturesDeleteOptionalParams
  - Added Interface GallerySecurityPosturesGetOptionalParams
  - Added Interface GallerySecurityPosturesUpdateOptionalParams
  - Added Interface GallerySecurityPostureUpdate
  - Added Interface GallerySecurityPostureVersion
  - Added Interface GallerySecurityPostureVersionsCreateOrUpdateOptionalParams
  - Added Interface GallerySecurityPostureVersionsDeleteOptionalParams
  - Added Interface GallerySecurityPostureVersionsGetOptionalParams
  - Added Interface GallerySecurityPostureVersionsUpdateOptionalParams
  - Added Interface GallerySecurityPostureVersionUpdate
  - Added Interface PostureSetting
  - Added Interface VirtualMachineExtensionAutoGenerated
  - Added Interface VirtualMachineExtensionAutoGenerated2
  - Added Interface VirtualMachineExtensionProperties
  - Added Interface VirtualMachineExtensionPropertiesAutoGenerated
  - Added Type Alias CommunityGallerySecurityPosturesGetResponse
  - Added Type Alias CommunityGallerySecurityPostureVersionsGetResponse
  - Added Type Alias GallerySecurityPosturesCreateOrUpdateResponse
  - Added Type Alias GallerySecurityPosturesGetResponse
  - Added Type Alias GallerySecurityPosturesUpdateResponse
  - Added Type Alias GallerySecurityPostureVersionsCreateOrUpdateResponse
  - Added Type Alias GallerySecurityPostureVersionsGetResponse
  - Added Type Alias GallerySecurityPostureVersionsUpdateResponse

**Breaking Changes**

  - Interface CapacityReservationGroupsListBySubscriptionOptionalParams no longer has parameter resourceIdsOnly
  - Interface DataDisk no longer has parameter sourceResource
  - Interface DataDisksToAttach no longer has parameter caching
  - Interface DataDisksToAttach no longer has parameter deleteOption
  - Interface DataDisksToAttach no longer has parameter diskEncryptionSet
  - Interface DataDisksToAttach no longer has parameter writeAcceleratorEnabled
  - Interface PirCommunityGalleryResource no longer has parameter location
  ...
  - Interface VirtualMachineScaleSetUpdateOSDisk no longer has parameter diffDiskSettings
  - Interface VirtualMachineScaleSetVMReimageParameters no longer has parameter forceUpdateOSDiskForEphemeral
  - Interface VirtualMachineUpdate no longer has parameter scheduledEventsPolicy
  - Removed Enum KnownResourceIdOptionsForGetCapacityReservationGroups
  - Enum KnownDiffDiskPlacement no longer has value NvmeDisk
  - Enum KnownDiskCreateOptionTypes no longer has value Copy
  - Enum KnownDiskCreateOptionTypes no longer has value Restore
