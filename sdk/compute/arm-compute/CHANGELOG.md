...
**Features**
  ...
  - Added operation GalleryImages.getLatestVersionName
  ...
  - Added Interface GalleryImagesGetLatestVersionNameOptionalParams
  ...
  - Added Type Alias GalleryApplicationVersionSafetyProfile
  - Added Type Alias GalleryApplicationVersionUpdate
  - Added Type Alias GalleryArtifactVersionFullSource
  - Added Type Alias GalleryDataDiskImage
  - Added Type Alias GalleryDiskImageSource
  - Added Type Alias GalleryImage
  - Added Type Alias GalleryImagesGetLatestVersionNameResponse
  ...
  - Added Type Alias GalleryImageVersionSafetyProfile
