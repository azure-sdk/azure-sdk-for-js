...
export interface AppResiliencyOperations {
    ...
    patch(resourceGroupName: string, appName: string, name: string, resiliencyEnvelope: AppResiliency, options?: AppResiliencyPatchOptionalParams): Promise<AppResiliencyPatchResponse>;
}

// @public
export interface AppResiliencyPatchOptionalParams extends coreClient.OperationOptions {
}
...
export interface Jobs {
    ...
    proxyList(resourceGroupName: string, jobName: string, options?: JobsProxyListOptionalParams): Promise<JobsProxyListResponse>;
}
...
// @public
export interface JobsProxyListOptionalParams extends coreClient.OperationOptions {
}
