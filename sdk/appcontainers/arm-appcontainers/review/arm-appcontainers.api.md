...
export interface HttpRouteConfigOperations {
    ...
    update(resourceGroupName: string, environmentName: string, httpRouteName: string, managedHttpRouteEnvelope: ManagedHttpRoutePatch, options?: HttpRouteConfigUpdateOptionalParams): Promise<HttpRouteConfigUpdateResponse>;
}
