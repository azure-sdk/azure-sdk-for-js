...
import {
  ...
  DaprResiliencyCircuitBreakerPolicy as DaprResiliencyCircuitBreakerPolicyMapper,
  DaprResiliencyTimeoutPolicy as DaprResiliencyTimeoutPolicyMapper,
  DaprResiliencyRetryPolicy as DaprResiliencyRetryPolicyMapper,
...
export const connectedEnvironmentName1: OperationURLParameter = {
  parameterPath: "connectedEnvironmentName",
  mapper: {
    constraints: {
      Pattern: new RegExp("^.*")
...
export const daprResiliencyCircuitBreakerPoliciesEnvelope: OperationParameter = {
  parameterPath: "daprResiliencyCircuitBreakerPoliciesEnvelope",
  mapper: DaprResiliencyCircuitBreakerPolicyMapper
};

export const daprResiliencyTimeoutPoliciesEnvelope: OperationParameter = {
  parameterPath: "daprResiliencyTimeoutPoliciesEnvelope",
  mapper: DaprResiliencyTimeoutPolicyMapper
};

export const daprResiliencyRetryPoliciesEnvelope: OperationParameter = {
  parameterPath: "daprResiliencyRetryPoliciesEnvelope",
  mapper: DaprResiliencyRetryPolicyMapper
};
