...
import {
  ...
  ManagedEnvironmentSecret as ManagedEnvironmentSecretMapper,
...
export const secretEnvelope: OperationParameter = {
  parameterPath: "secretEnvelope",
  mapper: ManagedEnvironmentSecretMapper
};
