...
import {
  ...
  ManagedHttpRoutePatch as ManagedHttpRoutePatchMapper,
...
export const managedHttpRouteEnvelope: OperationParameter = {
  parameterPath: ["options", "managedHttpRouteEnvelope"],
...
export const managedHttpRouteEnvelope1: OperationParameter = {
  parameterPath: "managedHttpRouteEnvelope",
  mapper: ManagedHttpRoutePatchMapper,
};
...
export const environmentName3: OperationURLParameter = {
  parameterPath: "environmentName",
  mapper: {
    constraints: {
      Pattern: new RegExp("^[-\\w\\._]+$"),
