...
/** Managed service identity (system assigned and/or user assigned identities) */
export interface ManagedServiceIdentityAutoGenerated {
  /**
   * The service principal ID of the system assigned identity. This property will only be provided for a system assigned identity.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
...
export interface TrackedResourceAutoGenerated extends Resource {
  /** Resource tags. */
  tags?: { [propertyName: string]: string };
...
export interface ConnectedEnvironment extends TrackedResourceAutoGenerated {
  /** The complex type of the extended location. */
...
export interface Certificate extends TrackedResourceAutoGenerated {
  /** Certificate resource specific properties */
...
export interface ContainerAppAuthToken extends TrackedResourceAutoGenerated {
  /**
   * Auth token value.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
...
export interface ManagedEnvironment extends TrackedResourceAutoGenerated {
...
/** Container App Job */
export interface Job extends TrackedResourceAutoGenerated {
  /** Managed identities needed by a container app job to interact with other Azure services to not maintain any secrets or credentials in code. */
  identity?: ManagedServiceIdentityAutoGenerated;
  /**
...
export interface ManagedCertificate extends TrackedResourceAutoGenerated {
  /** Certificate resource specific properties */
  properties?: ManagedCertificateProperties;
}

/** Environment Auth Token. */
export interface EnvironmentAuthToken extends TrackedResourceAutoGenerated {
  /**
   * Auth token value.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
...
export interface BuilderResource extends TrackedResource {
   ...
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly buildComputeId?: string;
  /**
   * Resource ID of the compute that the patching will be performed on.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly patchComputeId?: string;
  /** List of mappings of container registries and the managed identity used to connect to it. */
  containerRegistries?: ContainerRegistries[];
}

/** Information pertaining to an individual build. */
export interface BuildResource extends ProxyResourceAutoGenerated {
  /**
