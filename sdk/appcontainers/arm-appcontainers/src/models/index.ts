...
export interface ContainerAppsSourceControlsDeleteOptionalParams
  extends coreClient.OperationOptions {
  /** If set to true, GitHub Workflow deletion failure will be ignored. Default is set to false. */
  ignoreWorkflowDeletionFailure?: boolean;
  /** If set to true, the GitHub Workflow created by this SourceControl will be deleted while deleting SourceControl. Default is set to true. */
