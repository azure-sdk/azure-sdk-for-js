...
export interface ManagedEnvironmentStorageProperties {
  /**
   * Provisioning state of storage.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly provisioningState?: StorageProvisioningState;
  /** Azure file properties */
  azureFile?: AzureFileProperties;
}
...
export interface DaprComponent extends ProxyResource {
  /**
   * Provisioning state of dapr component.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
...
/** Known values of {@link StorageProvisioningState} that the service accepts. */
export enum KnownStorageProvisioningState {
  /** Succeeded */
  Succeeded = "Succeeded",
  /** Failed */
  Failed = "Failed",
...
/**
 * Defines values for StorageProvisioningState. \
 * {@link KnownStorageProvisioningState} can be used interchangeably with StorageProvisioningState,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Succeeded** \
 * **Failed** \
 ...
 * **InProgress**
 */
export type StorageProvisioningState = string;
