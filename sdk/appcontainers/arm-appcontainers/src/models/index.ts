...
/** Container registry that the final image will be uploaded to. */
export interface ContainerRegistryWithCustomImageAutoGenerated {
  /**
...
export interface ContainerAppsBuildConfiguration {
   ...
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly preBuildSteps?: PreBuildStepAutoGenerated[];
}

/** Model representing a pre-build step. */
export interface PreBuildStepAutoGenerated {
  /**
   * Description of the pre-build step.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  ...
  /** Http get request to send before the build. */
  httpGet?: HttpGetAutoGenerated;
}

/** Model representing a http get request. */
export interface HttpGetAutoGenerated {
  /**
   * URL to make HTTP GET request against.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
...
/** Information pertaining to an individual build. */
export interface ContainerAppsBuildResource extends ProxyResourceAutoGenerated {
  /**
   * Build provisioning state.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
   ...
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly destinationContainerRegistry?: ContainerRegistryWithCustomImageAutoGenerated;
  /**
   * Configuration of the build.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
