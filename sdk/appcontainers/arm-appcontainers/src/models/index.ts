...
export interface Ingress {
  ...
  targetPortScheme?: IngressTargetPortScheme;
}
...
/** Known values of {@link IngressTargetPortScheme} that the service accepts. */
export enum KnownIngressTargetPortScheme {
  /** Http */
  Http = "http",
  /** Https */
  Https = "https"
...
/**
 * Defines values for IngressTargetPortScheme. \
 * {@link KnownIngressTargetPortScheme} can be used interchangeably with IngressTargetPortScheme,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **http** \
 * **https**
 */
export type IngressTargetPortScheme = string;
