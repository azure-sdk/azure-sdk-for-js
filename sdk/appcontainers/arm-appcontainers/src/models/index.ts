...
export interface LabelHistoryRecordItem {
   ...
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly status?: LabelHistoryRecordItemStatus;
}
...
export interface ConnectedEnvironmentDaprComponentProperties
...
/** Known values of {@link LabelHistoryRecordItemStatus} that the service accepts. */
export enum KnownLabelHistoryRecordItemStatus {
  /** Starting */
  Starting = "Starting",
  /** Succeeded */
  Succeeded = "Succeeded",
...
/**
 * Defines values for LabelHistoryRecordItemStatus. \
 * {@link KnownLabelHistoryRecordItemStatus} can be used interchangeably with LabelHistoryRecordItemStatus,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Starting** \
 * **Succeeded** \
 * **Failed**
 */
export type LabelHistoryRecordItemStatus = string;
...
export type ContainerAppsLabelHistoryListLabelHistoryResponse =
...
export type ContainerAppsLabelHistoryListLabelHistoryNextResponse =
  LabelHistoryCollection;
