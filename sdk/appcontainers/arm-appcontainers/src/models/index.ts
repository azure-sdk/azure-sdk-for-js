...
export interface HttpRouteConfigPatch {
  /** Resource tags. */
  tags?: { [propertyName: string]: string };
  /** Http Route Config properties */
  properties?: HttpRouteConfigPatchProperties;
}

/** Http Route Config properties */
export interface HttpRouteConfigPatchProperties {
  /**
   * The provisioning state of the Http Route Config in cluster
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
...
export interface ManagedHttpRouteConfigCollection {
  /** Collection of resources. */
...
export interface ManagedHttpRoutePatch {
  /** Application-specific metadata in the form of key-value pairs. */
  tags?: { [propertyName: string]: string };
}
...
/** Advanced Ingress routing for path/header based routing for a Container App Environment */
export interface HttpRouteConfig extends TrackedResource {
  /** Http Route Config properties */
...
/** Contains response data for the list operation. */
export type HttpRouteConfigListResponse = ManagedHttpRouteConfigCollection;
...
/** Contains response data for the listNext operation. */
export type HttpRouteConfigListNextResponse = ManagedHttpRouteConfigCollection;
