...
/** Defines headers for Job_executions operation. */
export interface JobExecutionsHeaders {
  location?: string;
}

/** Defines headers for Job_executionsNext operation. */
export interface JobExecutionsNextHeaders {
  location?: string;
}
...
export type JobRunResponse = JobExecutionBase;

/** Optional parameters. */
export interface JobExecutionsOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Contains response data for the executions operation. */
export type JobExecutionsResponse = ContainerAppJobExecutions;

/** Optional parameters. */
export interface JobExecutionsNextOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the executionsNext operation. */
export type JobExecutionsNextResponse = ContainerAppJobExecutions;
