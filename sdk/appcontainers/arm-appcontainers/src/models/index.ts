...
export interface VnetConfiguration {
  ...
  internal?: boolean;
  /** Resource ID of a subnet for control plane components. This subnet must be in the same VNET as the subnet defined in infrastructureSubnetId. Must not overlap with any other provided IP ranges. */
  controlPlaneSubnetId?: string;
  /** Resource ID of a subnet for infrastructure components. This subnet must be in the same VNET as the subnet defined in controlPlaneSubnetId if provided. Must not overlap with any other provided IP ranges. */
