...
export interface DynamicPoolConfiguration {
  ...
  coolDownPeriodInSecond?: number;
}

/** Custom container configuration. */
export interface CustomContainerConfiguration {
...
export interface SessionPoolPatchProperties {
...
export enum KnownContainerType {
  /** JupyterPython */
  JupyterPython = "JupyterPython",
  /** FunctionsPython */
  FunctionsPython = "FunctionsPython",
  /** CustomContainer */
