...
export interface Labels extends ProxyResourceAutoGenerated {
  /**
   * Current provisioning State of the operation
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly provisioningState?: LabelsProvisioningState;
  /** Labels for the Container App. */
  labels?: { [propertyName: string]: Label };
}
...
/** Defines headers for ContainerAppsLabels_delete operation. */
export interface ContainerAppsLabelsDeleteHeaders {
  location?: string;
}
...
/** Known values of {@link LabelsProvisioningState} that the service accepts. */
export enum KnownLabelsProvisioningState {
  /** InProgress */
  InProgress = "InProgress",
  /** Succeeded */
  Succeeded = "Succeeded",
...
/**
 * Defines values for LabelsProvisioningState. \
 * {@link KnownLabelsProvisioningState} can be used interchangeably with LabelsProvisioningState,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **InProgress** \
 * **Succeeded** \
 ...
 * **Canceled**
 */
export type LabelsProvisioningState = string;
...
/** Optional parameters. */
export interface ContainerAppsLabelsListOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the list operation. */
export type ContainerAppsLabelsListResponse = LabelsCollection;

/** Optional parameters. */
export interface ContainerAppsLabelsGetOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the get operation. */
export type ContainerAppsLabelsGetResponse = Labels;

/** Optional parameters. */
export interface ContainerAppsLabelsCreateOrUpdateOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Contains response data for the createOrUpdate operation. */
export type ContainerAppsLabelsCreateOrUpdateResponse = Labels;

/** Optional parameters. */
export interface ContainerAppsLabelsDeleteOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Contains response data for the delete operation. */
export type ContainerAppsLabelsDeleteResponse =
  ContainerAppsLabelsDeleteHeaders;

/** Optional parameters. */
export interface ContainerAppsLabelsListNextOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the listNext operation. */
export type ContainerAppsLabelsListNextResponse = LabelsCollection;
