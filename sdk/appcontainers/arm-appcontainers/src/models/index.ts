...
export interface ManagedEnvironmentSecretsCollection {
  /** Collection of secret resources. */
  value: ManagedEnvironmentSecret[];
  /**
   * Link to next page of resources.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
...
/** Secret properties */
export interface ManagedEnvironmentSecretProperties extends Secret {}
...
export interface ManagedEnvironmentSecret extends ProxyResource {
  /** Secret properties */
  properties?: ManagedEnvironmentSecretProperties;
}
...
/** Optional parameters. */
export interface ManagedEnvironmentSecretsListOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the list operation. */
export type ManagedEnvironmentSecretsListResponse = ManagedEnvironmentSecretsCollection;

/** Optional parameters. */
export interface ManagedEnvironmentSecretsGetOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the get operation. */
export type ManagedEnvironmentSecretsGetResponse = ManagedEnvironmentSecret;

/** Optional parameters. */
export interface ManagedEnvironmentSecretsCreateOrUpdateOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the createOrUpdate operation. */
export type ManagedEnvironmentSecretsCreateOrUpdateResponse = ManagedEnvironmentSecret;

/** Optional parameters. */
export interface ManagedEnvironmentSecretsDeleteOptionalParams
  extends coreClient.OperationOptions {}

/** Optional parameters. */
export interface ManagedEnvironmentSecretsGetValueOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the getValue operation. */
export type ManagedEnvironmentSecretsGetValueResponse = ManagedEnvironmentSecret;

/** Optional parameters. */
export interface ManagedEnvironmentSecretsListNextOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the listNext operation. */
export type ManagedEnvironmentSecretsListNextResponse = ManagedEnvironmentSecretsCollection;
