...
export const ContainerRegistries: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ContainerRegistries",
    modelProperties: {
...
export const ManagedServiceIdentityAutoGenerated: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ManagedServiceIdentityAutoGenerated",
    modelProperties: {
      principalId: {
        serializedName: "principalId",
        readOnly: true,
