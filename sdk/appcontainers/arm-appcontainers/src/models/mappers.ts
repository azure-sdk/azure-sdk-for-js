...
export const ManagedEnvironmentQuota: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ManagedEnvironmentQuota",
    modelProperties: {
      cores: {
        serializedName: "cores",
        type: {
          name: "Composite",
          className: "QuotaStatus"
        }
      }
    }
  }
...
export const QuotaStatus: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "QuotaStatus",
    modelProperties: {
