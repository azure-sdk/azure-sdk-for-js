...
export const RegistryCredentials: coreClient.CompositeMapper = {
  type: {
    ...
    modelProperties: {
      ...
      passwordSecretId: {
        serializedName: "passwordSecretId",
        type: {
          name: "String"
        }
      },
  ...
  type: {
    ...
    modelProperties: {
      includeSystemTelemetry: {
        serializedName: "includeSystemTelemetry",
        type: {
          name: "Boolean"
        }
      },
...
export const ManagedEnvironmentSecretsCollection: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ManagedEnvironmentSecretsCollection",
    modelProperties: {
      value: {
        serializedName: "value",
        required: true,
        type: {
          ...
          element: {
            type: {
              name: "Composite",
              className: "ManagedEnvironmentSecret"
            }
          }
        }
      },
...
export const ManagedEnvironmentSecretProperties: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ManagedEnvironmentSecretProperties",
    modelProperties: {
      ...Secret.type.modelProperties
    }
  }
};
...
export const ManagedEnvironmentSecret: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ManagedEnvironmentSecret",
    modelProperties: {
