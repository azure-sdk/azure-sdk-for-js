...
export const LabelsCollection: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "LabelsCollection",
    modelProperties: {
      value: {
        serializedName: "value",
        required: true,
...
export const Labels: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "Labels",
    modelProperties: {
      ...
      labels: {
        ...
        type: {
          name: "Dictionary",
          value: { type: { name: "Composite", className: "Label" } },
        },
      },
    },
  },
...
export const ContainerAppsLabelsDeleteHeaders: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ContainerAppsLabelsDeleteHeaders",
    modelProperties: {
      location: {
        serializedName: "location",
        type: {
