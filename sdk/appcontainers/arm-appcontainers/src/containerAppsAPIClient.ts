...
import {
  ...
  ConnectedEnvironmentsDaprResiliencyCircuitBreakerPoliciesImpl,
  ConnectedEnvironmentsDaprResiliencyTimeoutPoliciesImpl,
  ConnectedEnvironmentsDaprResiliencyRetryPoliciesImpl,
  ...
  NamespacesImpl,
  DaprResiliencyCircuitBreakerPoliciesImpl,
  DaprResiliencyTimeoutPoliciesImpl,
  DaprResiliencyRetryPoliciesImpl,
  DaprComponentsImpl,
...
export class ContainerAppsAPIClient extends coreClient.ServiceClient {
  ...
  constructor(
    ...
    this.connectedEnvironmentsDaprResiliencyCircuitBreakerPolicies = new ConnectedEnvironmentsDaprResiliencyCircuitBreakerPoliciesImpl(
      this
    );
    this.connectedEnvironmentsDaprResiliencyTimeoutPolicies = new ConnectedEnvironmentsDaprResiliencyTimeoutPoliciesImpl(
      this
    );
    this.connectedEnvironmentsDaprResiliencyRetryPolicies = new ConnectedEnvironmentsDaprResiliencyRetryPoliciesImpl(
      this
    );
    ...
    this.daprResiliencyCircuitBreakerPolicies = new DaprResiliencyCircuitBreakerPoliciesImpl(
      this
    );
    this.daprResiliencyTimeoutPolicies = new DaprResiliencyTimeoutPoliciesImpl(
      this
    );
    this.daprResiliencyRetryPolicies = new DaprResiliencyRetryPoliciesImpl(
      this
    );
  ...
  connectedEnvironmentsDaprResiliencyCircuitBreakerPolicies: ConnectedEnvironmentsDaprResiliencyCircuitBreakerPolicies;
  connectedEnvironmentsDaprResiliencyTimeoutPolicies: ConnectedEnvironmentsDaprResiliencyTimeoutPolicies;
  connectedEnvironmentsDaprResiliencyRetryPolicies: ConnectedEnvironmentsDaprResiliencyRetryPolicies;
  ...
  daprResiliencyCircuitBreakerPolicies: DaprResiliencyCircuitBreakerPolicies;
  daprResiliencyTimeoutPolicies: DaprResiliencyTimeoutPolicies;
  daprResiliencyRetryPolicies: DaprResiliencyRetryPolicies;
