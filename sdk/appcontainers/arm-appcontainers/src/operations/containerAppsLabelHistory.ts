...
import { ContainerAppsLabelHistory } from "../operationsInterfaces";
...
export class ContainerAppsLabelHistoryImpl
  implements ContainerAppsLabelHistory
{
  ...
  public listLabelHistory(
    ...
    const iter = this.listLabelHistoryPagingAll(
      resourceGroupName,
      containerAppName,
      options,
    );
  ...
  private async *listLabelHistoryPagingPage(
    ...
    if (!continuationToken) {
      result = await this._listLabelHistory(
        resourceGroupName,
        containerAppName,
        options,
      );
