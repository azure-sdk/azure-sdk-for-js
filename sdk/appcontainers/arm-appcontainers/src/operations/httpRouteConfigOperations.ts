  ...
  implements HttpRouteConfigOperations
{
  ...
  update(
    ...
    environmentName: string,
    httpRouteName: string,
    managedHttpRouteEnvelope: ManagedHttpRoutePatch,
...
const getOperationSpec: coreClient.OperationSpec = {
  path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/managedEnvironments/{environmentName}/httpRoutes/{httpRouteName}",
  httpMethod: "GET",
  responses: {
    200: {
...
const createOrUpdateOperationSpec: coreClient.OperationSpec = {
  ...
  requestBody: Parameters.managedHttpRouteEnvelope,
  queryParameters: [Parameters.apiVersion],
  urlParameters: [
    Parameters.$host,
    Parameters.subscriptionId,
...
const updateOperationSpec: coreClient.OperationSpec = {
  ...
  requestBody: Parameters.managedHttpRouteEnvelope1,
  queryParameters: [Parameters.apiVersion],
  urlParameters: [
    Parameters.$host,
    Parameters.subscriptionId,
...
const listOperationSpec: coreClient.OperationSpec = {
  path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/managedEnvironments/{environmentName}/httpRoutes",
  httpMethod: "GET",
  responses: {
    200: {
      bodyMapper: Mappers.ManagedHttpRouteConfigCollection,
    },
    default: {
      bodyMapper: Mappers.DefaultErrorResponse,
    },
