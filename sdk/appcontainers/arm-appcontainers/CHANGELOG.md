...
**Features**
  ...
  - Added operation group ContainerAppsLabels
  ...
  - Added Interface ContainerAppsLabelsCreateOrUpdateOptionalParams
  - Added Interface ContainerAppsLabelsDeleteHeaders
  - Added Interface ContainerAppsLabelsDeleteOptionalParams
  - Added Interface ContainerAppsLabelsGetOptionalParams
  - Added Interface ContainerAppsLabelsListNextOptionalParams
  - Added Interface ContainerAppsLabelsListOptionalParams
  ...
  - Added Interface Labels
  - Added Interface LabelsCollection
  ...
  - Added Type Alias ContainerAppsLabelsCreateOrUpdateResponse
  - Added Type Alias ContainerAppsLabelsDeleteResponse
  - Added Type Alias ContainerAppsLabelsGetResponse
  - Added Type Alias ContainerAppsLabelsListNextResponse
  - Added Type Alias ContainerAppsLabelsListResponse
  ...
  - Added Type Alias LabelsProvisioningState
  ...
  - Added Enum KnownLabelsProvisioningState
  - Enum KnownActiveRevisionsMode has a new value Labeled
