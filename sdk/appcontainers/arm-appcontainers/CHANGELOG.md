...
**Features**
  ...
  - Added operation group ManagedEnvironmentSecrets
  ...
  - Added Interface ManagedEnvironmentSecret
  - Added Interface ManagedEnvironmentSecretProperties
  - Added Interface ManagedEnvironmentSecretsCollection
  - Added Interface ManagedEnvironmentSecretsCreateOrUpdateOptionalParams
  - Added Interface ManagedEnvironmentSecretsDeleteOptionalParams
  - Added Interface ManagedEnvironmentSecretsGetOptionalParams
  - Added Interface ManagedEnvironmentSecretsGetValueOptionalParams
  - Added Interface ManagedEnvironmentSecretsListNextOptionalParams
  - Added Interface ManagedEnvironmentSecretsListOptionalParams
  ...
  - Added Type Alias ManagedEnvironmentSecretsCreateOrUpdateResponse
  - Added Type Alias ManagedEnvironmentSecretsGetResponse
  - Added Type Alias ManagedEnvironmentSecretsGetValueResponse
  - Added Type Alias ManagedEnvironmentSecretsListNextResponse
  - Added Type Alias ManagedEnvironmentSecretsListResponse
  ...
  - Interface DaprMetadata has a new optional parameter secretId
  - Interface EnvironmentVar has a new optional parameter secretId
  ...
  - Interface RegistryCredentials has a new optional parameter passwordSecretId
  - Interface ScaleRuleAuth has a new optional parameter secretId
  - Interface SecretVolumeItem has a new optional parameter secretId
