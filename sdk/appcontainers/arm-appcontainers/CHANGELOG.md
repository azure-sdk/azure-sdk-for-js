...
### Features Added
  ...
  - Added Interface ContainerAppsLabelHistoryListLabelHistoryNextOptionalParams
  ...
  - Added Interface HttpRouteConfigListNextOptionalParams
  ...
  - Added Interface MaintenanceConfigurationsListNextOptionalParams
  ...
  - Interface DaprComponent has a new optional parameter properties
...
### Breaking Changes
  ...
  - Interface DaprComponent no longer has parameter componentType
  - Interface DaprComponent no longer has parameter ignoreErrors
  - Interface DaprComponent no longer has parameter initTimeout
  - Interface DaprComponent no longer has parameter metadata
  - Interface DaprComponent no longer has parameter scopes
  - Interface DaprComponent no longer has parameter secrets
  - Interface DaprComponent no longer has parameter secretStoreComponent
  - Interface DaprComponent no longer has parameter version
