...
**Breaking Changes**
  ...
  - Class ContainerAppsAPIClient has a new required parameter availableWorkloadProfiles
  - Class ContainerAppsAPIClient has a new required parameter billingMeters
  - Class ContainerAppsAPIClient has a new required parameter connectedEnvironments
  - Class ContainerAppsAPIClient has a new required parameter connectedEnvironmentsCertificates
  - Class ContainerAppsAPIClient has a new required parameter connectedEnvironmentsDaprComponents
  - Class ContainerAppsAPIClient has a new required parameter connectedEnvironmentsStorages
  - Class ContainerAppsAPIClient has a new required parameter containerAppsDiagnostics
  - Class ContainerAppsAPIClient has a new required parameter managedCertificates
  - Class ContainerAppsAPIClient has a new required parameter managedEnvironmentDiagnostics
  - Class ContainerAppsAPIClient has a new required parameter managedEnvironmentsDiagnostics
