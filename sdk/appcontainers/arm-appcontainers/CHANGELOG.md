...
**Features**
  ...
  - Added Interface ContainerRegistries
...
**Breaking Changes**
  ...
  - Type of parameter identity of interface ContainerApp is changed from ManagedServiceIdentity to ManagedServiceIdentityAutoGenerated
