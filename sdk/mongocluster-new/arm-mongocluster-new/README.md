# Azure MongoClusterManagement client library for JavaScript
...
[Source code](https://github.com/Azure/azure-sdk-for-js/tree/main/sdk/mongocluster-new/arm-mongocluster-new) |
[Package (NPM)](https://www.npmjs.com/package/@azure/arm-mongocluster-new) |
[API reference documentation](https://docs.microsoft.com/javascript/api/@azure/arm-mongocluster-new?view=azure-node-preview) |
[Samples](https://github.com/Azure/azure-sdk-for-js/tree/main/sdk/mongocluster-new/arm-mongocluster-new/samples)
...
### Install the `@azure/arm-mongocluster-new` package

Install the Azure MongoClusterManagement client library for JavaScript with `npm`:

```bash
npm install @azure/arm-mongocluster-new
```
...
```javascript
const { DocumentDBClient } = require("@azure/arm-mongocluster-new");
...
Please take a look at the [samples](https://github.com/Azure/azure-sdk-for-js/tree/main/sdk/mongocluster-new/arm-mongocluster-new/samples) directory for detailed examples on how to use this library.
