...
/** The curation profile properties for partial update. Properties not provided in the update request will not be changed. */
...
export interface CurationProfileProperties
  extends CurationProfileUpdateProperties {
  /**
   * The provisioning state of the resource.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
...
/** Defines headers for CurationProfiles_update operation. */
export interface CurationProfilesUpdateHeaders {
  location?: string;
}

/** Defines headers for CurationProfiles_delete operation. */
...
/** Known values of {@link PlanMemberSyncState} that the service accepts. */
...
/**
 * Defines values for PlanMemberSyncState. \
 * {@link KnownPlanMemberSyncState} can be used interchangeably with PlanMemberSyncState,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Succeeded** \
 * **InProgress** \
...
/** Optional parameters. */
export interface CurationProfilesListByDevCenterOptionalParams
  extends coreClient.OperationOptions {
  /** The maximum number of resources to return from the operation. Example: '$top=10'. */
  top?: number;
}
...
/** Optional parameters. */
export interface CurationProfilesGetOptionalParams
  extends coreClient.OperationOptions {}
...
/** Optional parameters. */
export interface CurationProfilesCreateOrUpdateOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Optional parameters. */
export interface CurationProfilesUpdateOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Optional parameters. */
export interface CurationProfilesDeleteOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Optional parameters. */
export interface CurationProfilesListByDevCenterNextOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the listByDevCenterNext operation. */
export type CurationProfilesListByDevCenterNextResponse =
