...
export type ProjectAbilityAsAdminOutput =
  | "DeleteDevBoxes"
  | "DeleteEnvironments"
...
export type ProjectAbilityAsDeveloperOutput =
  | "CustomizeDevBoxes"
  | "DeleteDevBoxes"
  | "DeleteEnvironments"
  | "ManageDevBoxActions"
...
export type CustomizationTaskExecutionAccountOutput =
  | "System"
  | "User"
  | string;
/** Alias for CustomizationTaskStatusOutput */
export type CustomizationTaskStatusOutput =
  | "NotStarted"
  | "Running"
  | "Succeeded"
  | "FailedValidation"
...
export type CustomizationGroupStatusOutput =
  | "NotStarted"
  | "Running"
  | "Succeeded"
  | "Failed"
...
export type CustomizationTaskDefinitionParameterTypeOutput =
  | "string"
  | "number"
  | "boolean"
  | string;
/** Alias for CustomizationTaskListValidationStatusOutput */
export type CustomizationTaskListValidationStatusOutput =
  | "Succeeded"
  | "Failed"
  | string;
...
export type EnvironmentTypeAbilityAsAdminOutput =
  | "DeleteEnvironments"
  | "ManageEnvironmentActions"
  | "ReadEnvironmentActions"
  | "ReadEnvironmentOutputs"
...
export type EnvironmentTypeAbilityAsDeveloperOutput =
  | "DeleteEnvironments"
  | "ManageEnvironmentActions"
  | "ReadEnvironmentActions"
  | "ReadEnvironmentOutputs"
