# Azure DevCenterForTesting REST client library for JavaScript
...
Install the Azure DevCenterForTesting REST client REST client library for JavaScript with `npm`:
