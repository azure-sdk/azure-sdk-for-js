...
// @public
export interface CustomerInitiatedFailoverInput {
...
export interface IotDpsPropertiesDescription {
    ...
    enableCustomerInitiatedFailover?: boolean;
...
// @public
export interface IotDpsPropertiesDescriptionDpsFailoverDescription {
    failoverRegion: string;
}
...
export interface IotDpsResource {
    ...
    failover(resourceGroupName: string, provisioningServiceName: string, dpsFailoverDescription: CustomerInitiatedFailoverInput, options?: IotDpsResourceFailoverOptionalParams): Promise<void>;
...
// @public
export interface IotDpsResourceFailoverOptionalParams extends coreClient.OperationOptions {
}
