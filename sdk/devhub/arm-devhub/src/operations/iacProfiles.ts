...
import { IacProfiles } from "../operationsInterfaces";
...
import {
  ...
  IacProfilesQuickTemplateOptionalParams,
  IacProfilesQuickTemplateResponse,
...
export class IacProfilesImpl implements IacProfiles {
  ...
  quickTemplate(
    resourceGroupName: string,
    iacProfileName: string,
    parameters: QuickTemplateRequest,
    options?: IacProfilesQuickTemplateOptionalParams,
  ): Promise<IacProfilesQuickTemplateResponse> {
    return this.client.sendOperationRequest(
      { resourceGroupName, iacProfileName, parameters, options },
      quickTemplateOperationSpec,
    );
  }
...
const quickTemplateOperationSpec: coreClient.OperationSpec = {
  path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevHub/iacProfiles/{iacProfileName}/quickTemplate",
  httpMethod: "POST",
  responses: {
    200: {
      bodyMapper: Mappers.PrLinkResponse,
