...
/** Optional parameters. */
export interface SharedKeysListOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the list operation. */
export type SharedKeysListResponse = SharedKeys;

/** Optional parameters. */
export interface SharedKeysGetOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the get operation. */
export type SharedKeysGetResponse = SharedKeys;
