...
export interface Table extends ProxyResource {
   ...
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly retentionInDaysAsDefault?: RetentionInDaysAsDefault;
  /**
   * True - Value originates from retention in days, False - Customer specific.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly totalRetentionInDaysAsDefault?: TotalRetentionInDaysAsDefault;
}
...
/** Known values of {@link RetentionInDaysAsDefault} that the service accepts. */
export enum KnownRetentionInDaysAsDefault {
...
/**
 * Defines values for RetentionInDaysAsDefault. \
 * {@link KnownRetentionInDaysAsDefault} can be used interchangeably with RetentionInDaysAsDefault,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **True**: Value originates from workspace retention in days. \
 * **False**: Value is customer specific.
 */
export type RetentionInDaysAsDefault = string;

/** Known values of {@link TotalRetentionInDaysAsDefault} that the service accepts. */
export enum KnownTotalRetentionInDaysAsDefault {
...
/**
 * Defines values for TotalRetentionInDaysAsDefault. \
 * {@link KnownTotalRetentionInDaysAsDefault} can be used interchangeably with TotalRetentionInDaysAsDefault,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **True**: Value originates from retention in days. \
 * **False**: Value is customer specific.
 */
export type TotalRetentionInDaysAsDefault = string;
...
export type DataExportsDeleteResponse = ErrorResponse;
