...
export interface AzureEntityResource extends ResourceAutoGenerated {
  /**
   * Resource Etag.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
...
/** The top level Log Analytics cluster resource container. */
export interface Cluster extends TrackedResourceAutoGenerated {
  /** Resource's identity. */
  identity?: ManagedServiceIdentity;
  /** The sku properties. */
  sku?: ClusterSku;
...
export interface Workspace extends TrackedResourceAutoGenerated {
...
export interface DataExport extends ProxyResourceAutoGenerated {
...
export interface DataSource extends ProxyResourceAutoGenerated {
...
export interface LinkedService extends ProxyResourceAutoGenerated {
  /** Resource tags. */
  tags?: { [propertyName: string]: string };
...
export interface SavedSearch extends ProxyResourceAutoGenerated {
...
export interface StorageInsight extends ProxyResourceAutoGenerated {
...
export interface Table extends ProxyResourceAutoGenerated {
  /**
   * Metadata pertaining to creation and last modification of the resource.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
