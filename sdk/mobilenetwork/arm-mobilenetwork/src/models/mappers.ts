...
export const UeInfo5G: coreClient.CompositeMapper = {
  ...
  type: {
    ...
    modelProperties: {
      ...
      plmnInfoConnectionInfoLocationInfoPlmn: {
        serializedName: "info.connectionInfo.locationInfo.plmn",
        type: {
          name: "Composite",
          className: "PlmnId",
        },
      },
      plmnInfoFivegGutiPlmn: {
        serializedName: "info.fivegGuti.plmn",
        type: {
          name: "Composite",
          className: "PlmnId",
        },
