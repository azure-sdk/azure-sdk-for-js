 ...
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **G0**: 100 Mbps, 20 active SIMs plan, 1 RAN \
 * **G1**: 1 Gbps, 100 active SIMs plan, 5 RANs \
 * **G2**: 2 Gbps, 200 active SIMs plan, 10 RANs \
 * **G3**: 3 Gbps, 300 active SIMs plan, 15 RANs \
 * **G4**: 4 Gbps, 400 active SIMs plan, 20 RANs \
 * **G5**: 5 Gbps, 500 active SIMs plan, 25 RANs \
 * **G10**: 10 Gbps, 1000 active SIMs plan, 50 RANs
 */
