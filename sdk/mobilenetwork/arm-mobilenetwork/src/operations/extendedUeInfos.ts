...
import { ExtendedUeInfos } from "../operationsInterfaces";
...
/** Class containing ExtendedUeInfos operations. */
export class ExtendedUeInfosImpl implements ExtendedUeInfos {
  private readonly client: MobileNetworkManagementClient;

  /**
   * Initialize a new instance of the class ExtendedUeInfos class.
