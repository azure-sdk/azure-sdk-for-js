...
export interface SpringbootsitesModelListResult {
...
export interface SpringbootappsModelListResult {
...
export interface SpringbootserversModelListResult {
...
export interface ErrorSummaryListResult {
 ...
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **2023-01-01-preview**: The 2023-01-01-preview API version.
 */
...
/** Contains response data for the listBySubscription operation. */
export type SpringbootappsListBySubscriptionResponse =
...
export type ErrorSummariesListBySiteResponse = ErrorSummaryListResult;
...
export type ErrorSummariesListBySiteNextResponse = ErrorSummaryListResult;
...
/** Contains response data for the listBySite operation. */
export type SummariesListBySiteResponse = SummaryListResult;
...
/** Contains response data for the listBySiteNext operation. */
export type SummariesListBySiteNextResponse = SummaryListResult;
