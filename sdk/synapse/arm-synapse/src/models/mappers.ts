...
export const SkuGet: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "SkuGet",
    modelProperties: {
...
export const ManagedIntegrationRuntime: coreClient.CompositeMapper = {
  ...
  type: {
    ...
    modelProperties: {
      ...
      provisioningState: {
        serializedName: "typeProperties.provisioningState",
        type: {
          name: "String"
        }
      }
...
export const SqlPoolGet: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "SqlPoolGet",
    modelProperties: {
      ...TrackedResource.type.modelProperties,
      kind: {
        serializedName: "kind",
