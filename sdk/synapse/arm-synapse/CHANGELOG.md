...
**Features**
  ...
  - Interface SqlPoolPatchInfo has a new optional parameter catalogCollation
  - Interface SqlPoolPatchInfo has a new optional parameter currentServiceObjectiveName
  - Interface SqlPoolPatchInfo has a new optional parameter defaultSecondaryLocation
...
**Breaking Changes**
  ...
  - Interface ManagedVirtualNetworkSettings no longer has parameter linkedAccessCheckOnTargetResource
