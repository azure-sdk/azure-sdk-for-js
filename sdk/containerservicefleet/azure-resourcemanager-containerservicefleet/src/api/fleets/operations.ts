...
export function $delete(
  ...
  return getLongRunningPoller(
    ...
    ["200", "202", "204"],
    {
      ...
      getInitialResponse: () =>
        _$deleteSend(context, resourceGroupName, fleetName, options),
...
export function updateAsync(
  ...
  ) as __PLACEHOLDER_o122__<__PLACEHOLDER_o123__<Fleet>, Fleet>;
}
...
export function create(
  ...
  return getLongRunningPoller(context, _createDeserialize, ["200", "201"], {
    ...
    abortSignal: options?.abortSignal,
    getInitialResponse: () =>
      _createSend(context, resourceGroupName, fleetName, resource, options),
