...
export interface DeviceLocationVerify {
  ...
  post(
    ...
    DeviceLocationVerify200Response | DeviceLocationVerifyDefaultResponse
  >;
}
...
export interface DeviceNetworkRetrieve {
  ...
  post(
    ...
    DeviceNetworkRetrieve200Response | DeviceNetworkRetrieveDefaultResponse
  >;
}
...
export interface SimSwapRetrieve {
  ...
  post(
    ...
    SimSwapRetrieve200Response | SimSwapRetrieveDefaultResponse
  >;
}
...
export interface Routes {
  ...
  ): NumberVerificationVerifyWithoutCode;
