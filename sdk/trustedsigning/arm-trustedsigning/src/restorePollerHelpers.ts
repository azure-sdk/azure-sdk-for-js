...
import { _$deleteDeserialize, _createDeserialize } from "./api/certificateProfiles/index.js";
import {
  _$deleteDeserialize as _deleteDeserializeCodeSigningAccounts,
  _updateDeserialize,
...
const deserializeMap: Record<string, DeserializationHelper> = {
  ...
  "DELETE /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.CodeSigning/codeSigningAccounts/{accountName}":
    {
      deserializer: _deleteDeserializeCodeSigningAccounts,
      expectedStatuses: ["202", "204", "200"],
    },
