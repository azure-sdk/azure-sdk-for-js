...
export enum KnownProfileType {
  /** Used for signing code files which are distributed publicly. */
  PublicTrust = "PublicTrust",
  /** Used for signing code files which are distributed internally within organization or group boundary. */
  PrivateTrust = "PrivateTrust",
  /** Used for signing CI policy files. */
  PrivateTrustCIPolicy = "PrivateTrustCIPolicy",
  /** Used for signing code files which are run in secure vbs enclave. */
  VBSEnclave = "VBSEnclave",
  /** Used for signing code files for testing purpose. */
  PublicTrustTest = "PublicTrustTest",
  /** Used for signing content files. */
  C2PAContentCredentials = "C2PAContentCredentials",
}
 ...
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **PublicTrust**: Used for signing code files which are distributed publicly. \
 * **PrivateTrust**: Used for signing code files which are distributed internally within organization or group boundary. \
 * **PrivateTrustCIPolicy**: Used for signing CI policy files. \
 * **VBSEnclave**: Used for signing code files which are run in secure vbs enclave. \
 * **PublicTrustTest**: Used for signing code files for testing purpose. \
 * **C2PAContentCredentials**: Used for signing content files.
 */
