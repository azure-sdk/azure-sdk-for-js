...
export function certificateProfilePropertiesDeserializer(
  item: any,
...
export function certificateProfileArraySerializer(
  result: Array<CertificateProfile>,
): any[] {
  return result.map((item) => {
...
export function certificateProfileArrayDeserializer(
  result: Array<CertificateProfile>,
): any[] {
  return result.map((item) => {
...
export function codeSigningAccountPropertiesDeserializer(
  item: any,
...
export function codeSigningAccountArraySerializer(
  result: Array<CodeSigningAccount>,
): any[] {
  return result.map((item) => {
...
export function codeSigningAccountArrayDeserializer(
  result: Array<CodeSigningAccount>,
): any[] {
  return result.map((item) => {
