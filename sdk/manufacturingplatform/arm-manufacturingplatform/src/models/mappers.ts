...
export const MdsResourceProperties: coreClient.CompositeMapper = {
  type: {
    ...
    modelProperties: {
      ...
      amlProfile: {
        serializedName: "amlProfile",
        type: {
          name: "Composite",
          className: "AmlProfile",
        },
      },
      userManagedDatabaseProfile: {
        serializedName: "userManagedDatabaseProfile",
        type: {
          name: "Composite",
          className: "UserManagedDatabaseProfile",
        },
      },
      userManagedAdxProfile: {
        serializedName: "userManagedAdxProfile",
        type: {
          name: "Composite",
          className: "UserManagedAdxProfile",
        },
      },
      cmkProfile: {
...
export const AmlProfile: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "AmlProfile",
    modelProperties: {
...
export const UserManagedDatabaseProfile: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "UserManagedDatabaseProfile",
    modelProperties: {
...
export const UserManagedAdxProfile: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "UserManagedAdxProfile",
    modelProperties: {
...
export const AmlProfileUpdate: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "AmlProfileUpdate",
    modelProperties: {
