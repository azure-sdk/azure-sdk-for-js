...
import { BestPractices } from "../operationsInterfaces/index.js";
...
export class BestPracticesImpl implements BestPractices {
  ...
  get(
    ...
    return this.client.sendOperationRequest({ bestPracticeName, options }, getOperationSpec);
  }
  ...
  private _listByTenant(
    ...
    return this.client.sendOperationRequest({ options }, listByTenantOperationSpec);
  }
}
