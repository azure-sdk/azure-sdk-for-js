...
export class BestPracticesVersionsImpl implements BestPracticesVersions {
  ...
  private async *listByTenantPagingAll(
    ...
    for await (const page of this.listByTenantPagingPage(bestPracticeName, options)) {
      yield* page;
    }
  }
...
const getOperationSpec: coreClient.OperationSpec = {
  ...
  urlParameters: [Parameters.$host, Parameters.bestPracticeName, Parameters.versionName],
