...
import { DatabaseFleetManagerClient } from "./databaseFleetManagerClient.js";
import {
  _$deleteDeserialize,
  _updateDeserialize,
...
import {
  _$deleteDeserialize as _deleteDeserializeFleets,
  _updateDeserialize as _updateDeserializeFleets,
  _createOrUpdateDeserialize as _createOrUpdateDeserializeFleets,
} from "./api/fleets/index.js";
import {
  _unregisterDeserialize,
  _registerServerDeserialize,
  _$deleteDeserialize as _deleteDeserializeFleetspaces,
  _updateDeserialize as _updateDeserializeFleetspaces,
  _createOrUpdateDeserialize as _createOrUpdateDeserializeFleetspaces,
} from "./api/fleetspaces/index.js";
import {
  _revertDeserialize,
  _renameDeserialize,
  _changeTierDeserialize,
  _$deleteDeserialize as _deleteDeserializeFleetDatabases,
  _updateDeserialize as _updateDeserializeFleetDatabases,
  _createOrUpdateDeserialize as _createOrUpdateDeserializeFleetDatabases,
...
const deserializeMap: Record<string, DeserializationHelper> = {
  ...
  "DELETE /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DatabaseFleetManager/fleets/{fleetName}":
    {
      deserializer: _deleteDeserializeFleets,
      expectedStatuses: ["202", "204", "200"],
    },
  "PATCH /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DatabaseFleetManager/fleets/{fleetName}":
    {
      deserializer: _updateDeserializeFleets,
  ...
  "PUT /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DatabaseFleetManager/fleets/{fleetName}":
    {
      deserializer: _createOrUpdateDeserializeFleets,
      expectedStatuses: ["200", "201"],
    },
  "POST /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DatabaseFleetManager/fleets/{fleetName}/fleetspaces/{fleetspaceName}/unregister":
    { deserializer: _unregisterDeserialize, expectedStatuses: ["202", "200"] },
  "POST /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DatabaseFleetManager/fleets/{fleetName}/fleetspaces/{fleetspaceName}/registerServer":
    {
      deserializer: _registerServerDeserialize,
  ...
  "DELETE /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DatabaseFleetManager/fleets/{fleetName}/fleetspaces/{fleetspaceName}":
    {
      deserializer: _deleteDeserializeFleetspaces,
      expectedStatuses: ["202", "204", "200"],
    },
  "PATCH /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DatabaseFleetManager/fleets/{fleetName}/fleetspaces/{fleetspaceName}":
    {
      deserializer: _updateDeserializeFleetspaces,
      expectedStatuses: ["200", "202"],
    },
  "PUT /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DatabaseFleetManager/fleets/{fleetName}/fleetspaces/{fleetspaceName}":
    {
      deserializer: _createOrUpdateDeserializeFleetspaces,
      expectedStatuses: ["200", "201"],
    },
  ...
  "POST /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DatabaseFleetManager/fleets/{fleetName}/fleetspaces/{fleetspaceName}/databases/{databaseName}/rename":
    { deserializer: _renameDeserialize, expectedStatuses: ["202", "200"] },
  "POST /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DatabaseFleetManager/fleets/{fleetName}/fleetspaces/{fleetspaceName}/databases/{databaseName}/changeTier":
    { deserializer: _changeTierDeserialize, expectedStatuses: ["202", "200"] },
  "DELETE /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DatabaseFleetManager/fleets/{fleetName}/fleetspaces/{fleetspaceName}/databases/{databaseName}":
    {
      deserializer: _deleteDeserializeFleetDatabases,
      expectedStatuses: ["202", "204", "200"],
    },
  "PATCH /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DatabaseFleetManager/fleets/{fleetName}/fleetspaces/{fleetspaceName}/databases/{databaseName}":
    {
      deserializer: _updateDeserializeFleetDatabases,
      expectedStatuses: ["200", "202"],
    },
  "PUT /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DatabaseFleetManager/fleets/{fleetName}/fleetspaces/{fleetspaceName}/databases/{databaseName}":
    {
      deserializer: _createOrUpdateDeserializeFleetDatabases,
      expectedStatuses: ["200", "201"],
    },
};
