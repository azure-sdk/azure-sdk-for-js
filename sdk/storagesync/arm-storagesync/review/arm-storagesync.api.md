...
export interface RegisteredServer extends ProxyResource {
    ...
    readonly identityType?: ManagedServiceIdentityType;
...
export interface RegisteredServers {
    ...
    beginUpdate(resourceGroupName: string, storageSyncServiceName: string, serverId: string, parameters: RegisteredServerUpdateParameters, options?: RegisteredServersUpdateOptionalParams): Promise<PollerLike<PollOperationState<RegisteredServersUpdateResponse>, RegisteredServersUpdateResponse>>;
