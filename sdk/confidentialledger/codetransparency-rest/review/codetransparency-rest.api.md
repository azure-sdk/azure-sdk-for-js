...
// @public
function createClient(endpointParam: string, credentials: KeyCredential, options?: ClientOptions): CodeTransparencyClient;
...
// @public
export interface EmbedReceiptParameter {
}

// @public
export interface EntryIdParameter {
}
...
export interface GetEntry {
    post(options: GetEntryParameters): StreamableMethod<GetEntry200Response | GetEntryDefaultResponse>;
}
...
// @public (undocumented)
export type GetEntryParameters = GetEntryQueryParam & GetEntryBodyParam & RequestParameters;
...
export interface GetEntryReceipt {
    post(options: GetEntryReceiptParameters): StreamableMethod<GetEntryReceipt200Response | GetEntryReceiptDefaultResponse>;
}
...
// @public (undocumented)
export type GetEntryReceiptParameters = GetEntryReceiptBodyParam & RequestParameters;

// @public (undocumented)
export interface GetEntryStatus {
    post(options: GetEntryStatusParameters): StreamableMethod<GetEntryStatus200Response | GetEntryStatusDefaultResponse>;
}
...
// @public (undocumented)
export type GetEntryStatusParameters = GetEntryStatusBodyParam & RequestParameters;
...
export interface ListEntryIds {
    post(options: ListEntryIdsParameters): StreamableMethod<ListEntryIds200Response | ListEntryIds503Response | ListEntryIdsDefaultResponse>;
}
...
// @public (undocumented)
export type ListEntryIdsParameters = ListEntryIdsQueryParam & ListEntryIdsBodyParam & RequestParameters;
...
// @public
export interface OperationIdParameter {
}
