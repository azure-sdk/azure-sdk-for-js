...
export interface CodeTransparencyConfigurationOutput {
  ...
  /** Issuer used in receipts */
  serviceIssuer?: string;
  /** Feed name used in receipts */
  serviceFeed?: string;
}

/** Policy configuration listing accepted algorithms and the the policy script */
export interface CodeTransparencyConfigurationPolicyOutput {
  /** Accepted COSE signature algorithms when verifying signed statements */
  acceptedAlgorithms?: string[];
  /** COSE signature verification script in Javascript */
  policyScript: string;
}

/** Configuration of CCF authentication. */
export interface CodeTransparencyConfigurationAuthenticationOutput {
  /** Disable API authentication and rely on signed statement verification only */
  allowUnauthenticated: boolean;
  /** JWT requirements if authentication is enabled */
