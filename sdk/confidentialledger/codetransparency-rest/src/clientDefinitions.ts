...
export interface Routes {
  ...
  /** Resource for '/operations/\{operationId\}' has methods for the following verbs: post */
  ...
  /** Resource for '/entries/\{entryId\}' has methods for the following verbs: post */
  (path: "/entries/{entryId}", entryId: string): GetEntry;
  /** Resource for '/entries/\{entryId\}/receipt' has methods for the following verbs: post */
  (path: "/entries/{entryId}/receipt", entryId: string): GetEntryReceipt;
  /** Resource for '/entries/txIds' has methods for the following verbs: post */
