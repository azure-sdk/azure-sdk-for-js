...
import type { _OperationListResult, OperationResult } from "../../models/models.js";
import {
...
import type { OrganizationOperationsListOptionalParams } from "./options.js";
...
export function list(
  ...
  return buildPagedAsyncIterator(
    ...
    _listDeserialize,
    ["200"],
    { itemName: "value", nextLinkName: "nextLink", apiVersion: context.apiVersion ?? "2024-07-01" },
  );
}
