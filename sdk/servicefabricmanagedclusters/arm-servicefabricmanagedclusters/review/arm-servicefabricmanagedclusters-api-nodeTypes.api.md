...
// @public
export function startFaultSimulation(context: ServiceFabricContext, resourceGroupName: string, clusterName: string, nodeTypeName: string, parameters: FaultSimulationContentUnion, options?: NodeTypesStartFaultSimulationOptionalParams): PollerLike<OperationState<FaultSimulation>, FaultSimulation>;
