...
// @public
export function startFaultSimulation(context: ServiceFabricContext, resourceGroupName: string, clusterName: string, parameters: FaultSimulationContentUnion, options?: ManagedClustersStartFaultSimulationOptionalParams): PollerLike<OperationState<FaultSimulation>, FaultSimulation>;
