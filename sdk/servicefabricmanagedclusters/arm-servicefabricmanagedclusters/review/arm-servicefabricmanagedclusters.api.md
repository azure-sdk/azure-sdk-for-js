...
export interface ManagedClustersOperations {
    ...
    startFaultSimulation: (resourceGroupName: string, clusterName: string, parameters: FaultSimulationContentUnion, options?: ManagedClustersStartFaultSimulationOptionalParams) => PollerLike<OperationState<FaultSimulation>, FaultSimulation>;
...
export interface NodeTypesOperations {
    ...
    startFaultSimulation: (resourceGroupName: string, clusterName: string, nodeTypeName: string, parameters: FaultSimulationContentUnion, options?: NodeTypesStartFaultSimulationOptionalParams) => PollerLike<OperationState<FaultSimulation>, FaultSimulation>;
