...
import { managedApplyMaintenanceWindowPost } from "../../api/managedApplyMaintenanceWindow/index.js";
import { ManagedApplyMaintenanceWindowPostOptionalParams } from "../../api/options.js";
...
function _getManagedApplyMaintenanceWindow(context: ServiceFabricContext) {
  return {
    post: (
      ...
      clusterName: string,
      options?: ManagedApplyMaintenanceWindowPostOptionalParams,
    ) => managedApplyMaintenanceWindowPost(context, resourceGroupName, clusterName, options),
  };
}
