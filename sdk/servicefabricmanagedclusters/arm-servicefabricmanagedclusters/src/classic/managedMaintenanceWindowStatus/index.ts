...
import { managedMaintenanceWindowStatusGet } from "../../api/managedMaintenanceWindowStatus/index.js";
import { ManagedMaintenanceWindowStatus } from "../../models/models.js";
import { ManagedMaintenanceWindowStatusGetOptionalParams } from "../../api/options.js";
...
function _getManagedMaintenanceWindowStatus(context: ServiceFabricContext) {
  return {
    get: (
      ...
      clusterName: string,
      options?: ManagedMaintenanceWindowStatusGetOptionalParams,
    ) => managedMaintenanceWindowStatusGet(context, resourceGroupName, clusterName, options),
  };
}
