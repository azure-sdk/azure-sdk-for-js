...
**Breaking Changes**
  ...
  - Type of parameter identity of interface ServiceUpdate is changed from ManagedServiceIdentity to AzureResourceManagerCommonTypesManagedServiceIdentityUpdate
