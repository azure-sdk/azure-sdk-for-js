...
**Features**
  ...
  - Interface ApiDefinitionsCreateOrUpdateOptionalParams has a new optional parameter ifMatch
  - Interface ApisCreateOrUpdateOptionalParams has a new optional parameter ifMatch
  - Interface ApiVersion has a new optional parameter lifecycleStage
  - Interface ApiVersion has a new optional parameter title
  - Interface ApiVersionsCreateOrUpdateOptionalParams has a new optional parameter ifMatch
  ...
  - Interface DeploymentsCreateOrUpdateOptionalParams has a new optional parameter ifMatch
  ...
  - Interface EnvironmentsCreateOrUpdateOptionalParams has a new optional parameter ifMatch
  ...
  - Interface MetadataSchemasCreateOrUpdateOptionalParams has a new optional parameter ifMatch
  ...
  - Interface WorkspacesCreateOrUpdateOptionalParams has a new optional parameter ifMatch
