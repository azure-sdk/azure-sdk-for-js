...
export class AzureAPICenterTest extends coreClient.ServiceClient {
    // (undocumented)
    $host: string;
    constructor(credentials: coreAuth.TokenCredential, subscriptionId: string, options?: AzureAPICenterTestOptionalParams);
    // (undocumented)
...
// @public
export interface AzureAPICenterTestOptionalParams extends coreClient.ServiceClientOptions {
    $host?: string;
    apiVersion?: string;
    endpoint?: string;
}
