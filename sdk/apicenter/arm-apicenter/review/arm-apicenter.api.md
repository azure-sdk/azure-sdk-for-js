...
// @public (undocumented)
export class AzureAPICenterForTesting extends coreClient.ServiceClient {
    // (undocumented)
    $host: string;
    constructor(credentials: coreAuth.TokenCredential, subscriptionId: string, options?: AzureAPICenterForTestingOptionalParams);
    // (undocumented)
...
// @public
export interface AzureAPICenterForTestingOptionalParams extends coreClient.ServiceClientOptions {
    $host?: string;
    apiVersion?: string;
    endpoint?: string;
}
