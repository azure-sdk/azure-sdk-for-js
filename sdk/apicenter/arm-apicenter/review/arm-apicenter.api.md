...
export class AzureAPICenterTesttest extends coreClient.ServiceClient {
    // (undocumented)
    $host: string;
    constructor(credentials: coreAuth.TokenCredential, subscriptionId: string, options?: AzureAPICenterTesttestOptionalParams);
    // (undocumented)
...
// @public
export interface AzureAPICenterTesttestOptionalParams extends coreClient.ServiceClientOptions {
    $host?: string;
    apiVersion?: string;
    endpoint?: string;
}
