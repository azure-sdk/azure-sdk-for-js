...
export interface ApiDefinitions {
    ...
    importSpecification(resourceGroupName: string, serviceName: string, payload: ApiSpecImportSource, options?: ApiDefinitionsImportSpecificationOptionalParams): Promise<void>;
...
export interface Services {
    ...
    exportMetadataSchema(resourceGroupName: string, serviceName: string, assignedTo: MetadataAssignmentEntity, options?: ServicesExportMetadataSchemaOptionalParams): Promise<ServicesExportMetadataSchemaResponse>;
