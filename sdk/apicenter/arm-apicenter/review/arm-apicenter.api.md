...
export interface ApiDefinitions {
    ...
    beginImportSpecification(resourceGroupName: string, serviceName: string, workspaceName: string, apiName: string, versionName: string, definitionName: string, payload: ApiSpecImportRequest, options?: ApiDefinitionsImportSpecificationOptionalParams): Promise<SimplePollerLike<OperationState<ApiDefinitionsImportSpecificationResponse>, ApiDefinitionsImportSpecificationResponse>>;
    beginImportSpecificationAndWait(resourceGroupName: string, serviceName: string, workspaceName: string, apiName: string, versionName: string, definitionName: string, payload: ApiSpecImportRequest, options?: ApiDefinitionsImportSpecificationOptionalParams): Promise<ApiDefinitionsImportSpecificationResponse>;
...
// @public
export type ApiDefinitionsImportSpecificationResponse = ApiDefinitionsImportSpecificationHeaders;
...
export interface Services {
    ...
    createOrUpdate(resourceGroupName: string, serviceName: string, payload: Service, options?: ServicesCreateOrUpdateOptionalParams): Promise<ServicesCreateOrUpdateResponse>;
