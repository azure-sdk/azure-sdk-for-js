...
import { AzureAPICenterForTestingOptionalParams } from "./models";
...
export class AzureAPICenterForTesting extends coreClient.ServiceClient {
  ...
  /**
   * Initializes a new instance of the AzureAPICenterForTesting class.
  ...
  constructor(
    ...
    subscriptionId: string,
    options?: AzureAPICenterForTestingOptionalParams,
  ) {
    ...
    const defaults: AzureAPICenterForTestingOptionalParams = {
