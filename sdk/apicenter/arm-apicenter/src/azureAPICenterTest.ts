...
import { AzureAPICenterTestOptionalParams } from "./models";

export class AzureAPICenterTest extends coreClient.ServiceClient {
  $host: string;
  apiVersion: string;
  subscriptionId: string;

  /**
   * Initializes a new instance of the AzureAPICenterTest class.
  ...
  constructor(
    ...
    subscriptionId: string,
    options?: AzureAPICenterTestOptionalParams,
  ) {
    ...
    const defaults: AzureAPICenterTestOptionalParams = {
