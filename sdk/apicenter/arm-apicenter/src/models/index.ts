...
/** The API analyzer filter, used to select API definitions for static analysis. All the conditions get applied with the logical AND operator. */
export interface AnalyzerFilter {
  /** API filter conditions. */
  apis: AnalyzerFilterCondition[];
  /** APi version filter conditions. */
  apiVersions: AnalyzerFilterCondition[];
  /** Api definition filter conditions. */
  apiDefinitions: AnalyzerFilterCondition[];
}

/** Analyzer filter condition. */
export interface AnalyzerFilterCondition {
  /** The property to filter on, e.g. "lifecycleStage". */
  property: string;
  /** The operator to use for the filter, e.g. "equals". */
  operator: AnalyzerFilterOperator;
...
/** Defines headers for AnalyzerConfigs_get operation. */
export interface AnalyzerConfigsGetHeaders {
  /** The entity tag for the response. */
  eTag?: string;
}

/** Defines headers for AnalyzerConfigs_createOrUpdate operation. */
export interface AnalyzerConfigsCreateOrUpdateHeaders {
  /** The entity tag for the response. */
  eTag?: string;
}

/** Defines headers for AnalyzerConfigs_exportRuleset operation. */
...
/** Defines headers for AnalyzerConfigs_importRuleset operation. */
...
/** Known values of {@link AnalyzerType} that the service accepts. */
...
/**
 * Defines values for AnalyzerType. \
 * {@link KnownAnalyzerType} can be used interchangeably with AnalyzerType,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **spectral**: The Spectral analyzer.
 */
export type AnalyzerType = string;

/** Known values of {@link AnalyzerRulesetState} that the service accepts. */
export enum KnownAnalyzerRulesetState {
  ...
  Inactive = "inactive",
  /** The ruleset is suspended until the next analysis period because the number of analysis runs in the current period has exceeded the limit. */
  Suspended = "suspended",
}

/**
 * Defines values for AnalyzerRulesetState. \
 * {@link KnownAnalyzerRulesetState} can be used interchangeably with AnalyzerRulesetState,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **active**: The ruleset is active and analysis is running. \
 * **inactive**: The ruleset is inactive because ruleset wasn't uploaded. \
 * **suspended**: The ruleset is suspended until the next analysis period because the number of analysis runs in the current period has exceeded the limit.
 */
export type AnalyzerRulesetState = string;

/** Known values of {@link AnalyzerFilterOperator} that the service accepts. */
export enum KnownAnalyzerFilterOperator {
  /** In operator. */
  Equals = "equals",
  /** Contains operator. */
  Contains = "contains",
...
/**
 * Defines values for AnalyzerFilterOperator. \
 * {@link KnownAnalyzerFilterOperator} can be used interchangeably with AnalyzerFilterOperator,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **equals**: In operator. \
 * **contains**: Contains operator.
 */
export type AnalyzerFilterOperator = string;

/** Known values of {@link RulesetExportResultFormat} that the service accepts. */
...
/**
 * Defines values for RulesetExportResultFormat. \
 * {@link KnownRulesetExportResultFormat} can be used interchangeably with RulesetExportResultFormat,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **inline-zip**: The inlined ruleset package. \
 * **link-zip**: The link to the ruleset package. The URL is valid for 5 minutes. \
 * **inline-json**: The inlined ruleset JSON document. \
 * **inline-yaml**: The inlined ruleset YAML document.
 */
export type RulesetExportResultFormat = string;

/** Known values of {@link RulesetImportSourceFormat} that the service accepts. */
...
/**
 * Defines values for RulesetImportSourceFormat. \
 * {@link KnownRulesetImportSourceFormat} can be used interchangeably with RulesetImportSourceFormat,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **inline-zip**: The inlined ruleset package. \
 * **link-zip**: The link to a ruleset package hosted on a publicly accessible internet address. \
 * **inline-json**: The inlined ruleset JSON document. \
 * **inline-yaml**: The inlined ruleset YAML document.
 */
...
/** Optional parameters. */
export interface AnalyzerConfigsListOptionalParams
  extends coreClient.OperationOptions {
  /** OData filter parameter. */
  filter?: string;
}
...
/** Optional parameters. */
export interface AnalyzerConfigsGetOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the get operation. */
export type AnalyzerConfigsGetResponse = AnalyzerConfigsGetHeaders &
  AnalyzerConfig;

/** Optional parameters. */
export interface AnalyzerConfigsCreateOrUpdateOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the createOrUpdate operation. */
export type AnalyzerConfigsCreateOrUpdateResponse =
  AnalyzerConfigsCreateOrUpdateHeaders & AnalyzerConfig;

/** Optional parameters. */
export interface AnalyzerConfigsDeleteOptionalParams
  extends coreClient.OperationOptions {}

/** Optional parameters. */
export interface AnalyzerConfigsExportRulesetOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Contains response data for the exportRuleset operation. */
export type AnalyzerConfigsExportRulesetResponse = RulesetExportResult;

/** Optional parameters. */
export interface AnalyzerConfigsImportRulesetOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Contains response data for the importRuleset operation. */
export type AnalyzerConfigsImportRulesetResponse = OperationStatusResult;

/** Optional parameters. */
export interface AnalyzerConfigsListNextOptionalParams
  extends coreClient.OperationOptions {}
