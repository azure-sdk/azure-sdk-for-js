...
/** Defines headers for Services_importFromApim operation. */
...
/** Known values of {@link ShouldImportSpec} that the service accepts. */
...
/**
 * Defines values for ShouldImportSpec. \
 * {@link KnownShouldImportSpec} can be used interchangeably with ShouldImportSpec,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
...
/** Optional parameters. */
export interface ServicesImportFromApimOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Contains response data for the importFromApim operation. */
