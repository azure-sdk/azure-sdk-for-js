...
import {
  ...
  AnalyzerConfig as AnalyzerConfigMapper,
  RulesetImportRequest as RulesetImportRequestMapper,
...
export const analyzerConfigName: OperationURLParameter = {
  parameterPath: "analyzerConfigName",
  mapper: {
    constraints: {
      Pattern: new RegExp("^[a-zA-Z0-9-]{3,90}$"),
      MaxLength: 90,
...
export const resource3: OperationParameter = {
  parameterPath: "resource",
  mapper: AnalyzerConfigMapper,
};

export const body1: OperationParameter = {
  parameterPath: "body",
  mapper: RulesetImportRequestMapper,
};
