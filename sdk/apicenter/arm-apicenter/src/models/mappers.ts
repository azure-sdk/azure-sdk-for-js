...
export const ImportFromApimSuccessResult: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ImportFromApimSuccessResult",
    modelProperties: {
      status: {
...
export const ApimSource: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ApimSource",
    modelProperties: {
      resourceId: {
...
export const ApiSource: coreClient.CompositeMapper = {
  type: {
    ...
    modelProperties: {
      ...ProxyResource.type.modelProperties,
      shouldImportSpec: {
        serializedName: "properties.shouldImportSpec",
        type: {
          name: "String",
        },
      },
      apimSource: {
        serializedName: "properties.apimSource",
        type: {
          name: "Composite",
          className: "ApimSource",
        },
...
export const ServicesImportFromApimHeaders: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ServicesImportFromApimHeaders",
    modelProperties: {
      location: {
        serializedName: "location",
        type: {
