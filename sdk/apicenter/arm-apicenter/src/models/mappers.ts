...
export const AmazonApiGatewaySource: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "AmazonApiGatewaySource",
    modelProperties: {
      accessKey: {
...
export const ImportApiSourceRequest: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ImportApiSourceRequest",
    modelProperties: {
      importSpecification: {
      ...
      azureApiManagementSource: {
        serializedName: "azureApiManagementSource",
        type: {
          name: "Composite",
          className: "AzureApiManagementSourceImportApis",
        },
      },
      amazonApiGatewaySource: {
        serializedName: "amazonApiGatewaySource",
        type: {
          name: "Composite",
          className: "AmazonApiGatewaySource",
        },
...
export const AzureApiManagementSourceImportApis: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "AzureApiManagementSourceImportApis",
    modelProperties: {
...
export const ApiSource: coreClient.CompositeMapper = {
  type: {
    ...
    modelProperties: {
      ...
      apiSourceType: {
        serializedName: "properties.apiSourceType",
        type: {
          name: "String",
        },
      },
      ...
      amazonApiGatewaySource: {
        serializedName: "properties.amazonApiGatewaySource",
        type: {
          name: "Composite",
          className: "AmazonApiGatewaySource",
        },
...
export const WorkspacesImportApiSourceHeaders: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "WorkspacesImportApiSourceHeaders",
    modelProperties: {
      location: {
        serializedName: "location",
        type: {
