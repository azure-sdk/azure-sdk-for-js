...
export const ApiSpecImportSource: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ApiSpecImportSource",
    modelProperties: {
      value: {
        serializedName: "value",
        type: {
      ...
      specification: {
        ...
        type: {
          name: "Composite",
          className: "ApiSpecImportSourceSpecification"
        }
      }
    }
  }
...
export const ApiSpecImportSourceSpecification: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ApiSpecImportSourceSpecification",
    modelProperties: {
