...
export interface ApiDefinitionsListDefinitionsDefaultResponse
...
export interface ApiDefinitionsGetDefinitionDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponse;
...
export interface ApiDefinitionsGetExportSpecificationOperationStatusDefaultResponse
  ...
  headers: RawHttpHeaders &
    ApiDefinitionsGetExportSpecificationOperationStatusDefaultHeaders;
}
...
export interface ApiDefinitionsExportSpecification202Response
  extends HttpResponse {
  status: "202";
  body: ResourceOperationStatusOutput;
...
export interface ApiDefinitionsExportSpecificationDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponse;
...
export interface ApiDefinitionsExportSpecificationLogicalResponse
  extends HttpResponse {
  status: "200";
  body: ResourceOperationStatusOutput;
}
...
export interface ApiDeploymentsListDeploymentsDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponse;
...
export interface ApiDeploymentsGetDeploymentDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponse;
...
export interface ApiVersionsGetVersion200Response extends HttpResponse {
  status: "200";
  body: { title: string; lifecycleStage: LifecycleStageOutput };
}
