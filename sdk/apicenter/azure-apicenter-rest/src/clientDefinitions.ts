...
export interface ApisGet {
  /** Get an API. */
  get(
    options?: ApisGetParameters,
  ): StreamableMethod<ApisGet200Response | ApisGetDefaultResponse>;
}
...
export interface EnvironmentsListAll {
  ...
  get(
    ...
    EnvironmentsListAll200Response | EnvironmentsListAllDefaultResponse
  >;
}
...
export interface EnvironmentsGet {
  ...
  get(
    ...
    EnvironmentsGet200Response | EnvironmentsGetDefaultResponse
  >;
}
...
export interface ApiVersionsGetVersion {
  ...
  get(
    ...
    ApiVersionsGetVersion200Response | ApiVersionsGetVersionDefaultResponse
  >;
}
