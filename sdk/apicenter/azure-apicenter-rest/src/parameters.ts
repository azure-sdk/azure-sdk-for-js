...
export type ApiDefinitionsListDefinitionsParameters =
  ApiDefinitionsListDefinitionsQueryParam & RequestParameters;
export type ApiDefinitionsGetDefinitionParameters = RequestParameters;
export type ApiDefinitionsGetExportSpecificationOperationStatusParameters =
  RequestParameters;
...
export type ApiDeploymentsListDeploymentsParameters =
  ApiDeploymentsListDeploymentsQueryParam & RequestParameters;
...
export type EnvironmentsListParameters = EnvironmentsListQueryParam &
  RequestParameters;
...
export type EnvironmentsListAllParameters = EnvironmentsListAllQueryParam &
  RequestParameters;
...
export type ApiVersionsListVersionsParameters =
  ApiVersionsListVersionsQueryParam & RequestParameters;
