...
const responseMap: Record<string, string[]> = {
  ...
  "GET /workspaces/{workspaceName}/apis/{apiName}/versions/{versionName}/definitions": ["200"],
  ...
  "GET /workspaces/{workspaceName}/apis/{apiName}/deployments/{deploymentName}": ["200"],
  ...
  "GET /workspaces/{workspaceName}/apis/{apiName}/versions/{versionName}": ["200"],
};
...
export function isUnexpected(
  response: ApiDefinitionsListDefinitions200Response | ApiDefinitionsListDefinitionsDefaultResponse,
): response is ApiDefinitionsListDefinitionsDefaultResponse;
export function isUnexpected(
  response: ApiDefinitionsGetDefinition200Response | ApiDefinitionsGetDefinitionDefaultResponse,
...
export function isUnexpected(
  response: ApiDeploymentsListDeployments200Response | ApiDeploymentsListDeploymentsDefaultResponse,
): response is ApiDeploymentsListDeploymentsDefaultResponse;
export function isUnexpected(
  response: ApiDeploymentsGetDeployment200Response | ApiDeploymentsGetDeploymentDefaultResponse,
...
export function isUnexpected(
  response: ApiVersionsListVersions200Response | ApiVersionsListVersionsDefaultResponse,
): response is ApiVersionsListVersionsDefaultResponse;
export function isUnexpected(
  response: ApiVersionsGetVersion200Response | ApiVersionsGetVersionDefaultResponse,
