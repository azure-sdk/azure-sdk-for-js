...
/** Defines headers for HealthValidations_startValidation operation. */
...
/** Known values of {@link AlertRuleCreationProperties} that the service accepts. */
...
/**
 * Defines values for AlertRuleCreationProperties. \
...
export type AlertRuleResourcesListByParentResponse =
  AlertRuleResourceListResult;

/** Optional parameters. */
export interface AlertRuleResourcesGetOptionalParams
  extends coreClient.OperationOptions {}
...
/** Optional parameters. */
export interface AlertRuleResourcesListByParentNextOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the listByParentNext operation. */
export type AlertRuleResourcesListByParentNextResponse =
  AlertRuleResourceListResult;
...
/** Optional parameters. */
export interface HealthValidationsGetOptionalParams
  extends coreClient.OperationOptions {}
...
/** Contains response data for the startValidation operation. */
export type HealthValidationsStartValidationResponse = HealthValidation;

/** Optional parameters. */
export interface HealthValidationsListByParentNextOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the listByParentNext operation. */
export type HealthValidationsListByParentNextResponse =
