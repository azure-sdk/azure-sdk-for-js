...
/** Known values of {@link String} that the service accepts. */
 ...
 * {@link KnownString} can be used interchangeably with String,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Enabled**: Denotes a target that is enabled. \
 * **Disabled**: Denotes a target that is disabled.
 */
export type String = string;

/** Known values of {@link TargetCollectionStatus} that the service accepts. */
...
/**
 * Defines values for TargetCollectionStatus. \
 * {@link KnownTargetCollectionStatus} can be used interchangeably with TargetCollectionStatus,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Enabled**: Denotes a target that is enabled. \
 * **Disabled**: Denotes a target that is disabled.
