...
import { MicrosoftDatabaseWatcherTest } from "../microsoftDatabaseWatcherTest";
import {
  Target,
...
export class TargetsImpl implements Targets {
  private readonly client: MicrosoftDatabaseWatcherTest;

  /**
   * Initialize a new instance of the class Targets class.
   * @param client Reference to the service client
   */
  constructor(client: MicrosoftDatabaseWatcherTest) {
    this.client = client;
  }
