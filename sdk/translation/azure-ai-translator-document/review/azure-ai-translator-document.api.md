## API Report File for "@azure-rest/azure-ai-translator-document"
...
// @public
function createClient(endpoint: string, credentials: TokenCredential | KeyCredential, options?: ClientOptions): DocumentTranslationClient;
