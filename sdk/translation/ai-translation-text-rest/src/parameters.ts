...
import type { TranslateBodyDetails, InputTextItem } from "./models.js";
...
export interface Translate2Headers {
  /** A client-generated GUID to uniquely identify the request. */
  "X-ClientTraceId"?: string;
}

export interface Translate2BodyParam {
  /** Defines the content of the request */
  body: Array<TranslateBodyDetails>;
}

export interface Translate2HeaderParam {
  headers?: RawHttpHeadersInput & Translate2Headers;
}

export type Translate2Parameters = Translate2HeaderParam &
  Translate2BodyParam &
  RequestParameters;
