...
export interface Translate2200Headers {
  /** Value generated by the service to identify the request. It is used for troubleshooting purposes. */
  "x-requestid": string;
  /**
...
export interface Translate2200Response extends HttpResponse {
  status: "200";
  body: Array<TranslatedTextItemOutput>;
  headers: RawHttpHeaders & Translate2200Headers;
}

export interface Translate2DefaultHeaders {
  /** Value generated by the service to identify the request. It is used for troubleshooting purposes. */
  "x-requestid": string;
}

export interface Translate2DefaultResponse extends HttpResponse {
  status: string;
  body: ErrorResponseOutput;
  headers: RawHttpHeaders & Translate2DefaultHeaders;
}
