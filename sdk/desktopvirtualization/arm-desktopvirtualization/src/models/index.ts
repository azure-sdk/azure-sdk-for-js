...
/** Defines headers for ControlSessionHostProvisioning_post operation. */
...
/** Known values of {@link ScalingMethod} that the service accepts. */
...
/**
 * Defines values for ScalingMethod. \
 * {@link KnownScalingMethod} can be used interchangeably with ScalingMethod,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 ...
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **None**: This value is read only, it is not accepted on input. \
 * **Desktop**: Users access the full Windows desktop from a session host. Available with pooled or personal host pools. \
 * **RailApplications**: Users access individual applications you select and publish to the application group. Available with pooled host pools only.
 */
...
/** Known values of {@link CanaryPolicy} that the service accepts. */
...
/**
 * Defines values for CanaryPolicy. \
 * {@link KnownCanaryPolicy} can be used interchangeably with CanaryPolicy,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Auto** \
 * **Never** \
...
/** Known values of {@link FailedSessionHostCleanupPolicySHC} that the service accepts. */
...
/**
 * Defines values for FailedSessionHostCleanupPolicySHC. \
 * {@link KnownFailedSessionHostCleanupPolicySHC} can be used interchangeably with FailedSessionHostCleanupPolicySHC,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **KeepAll** \
 * **KeepOne** \
...
/** Known values of {@link HostPoolProvisioningAction} that the service accepts. */
...
/**
 * Defines values for HostPoolProvisioningAction. \
 * {@link KnownHostPoolProvisioningAction} can be used interchangeably with HostPoolProvisioningAction,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Cancel**: Cancel the hostpool provisioning.
 */
...
/** Known values of {@link DiffDiskOption} that the service accepts. */
...
/**
 * Defines values for DiffDiskOption. \
 * {@link KnownDiffDiskOption} can be used interchangeably with DiffDiskOption,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Local**: Operating system disk local setting
 */
 ...
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **CacheDisk**: Cache disk placement \
 * **ResourceDisk**: Resource disk placement
 */
...
/** Optional parameters. */
export interface ControlSessionHostProvisioningPostOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Contains response data for the post operation. */
export type ControlSessionHostProvisioningPostResponse =
  ControlSessionHostProvisioningPostHeaders;
...
/** Optional parameters. */
export interface SessionHostProvisioningStatusesGetOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the get operation. */
export type SessionHostProvisioningStatusesGetResponse =
