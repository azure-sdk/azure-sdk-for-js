...
import { PrivateEndpointConnectionsOperations } from "../operationsInterfaces/index.js";
...
/** Class containing PrivateEndpointConnectionsOperations operations. */
export class PrivateEndpointConnectionsOperationsImpl
  implements PrivateEndpointConnectionsOperations
{
  private readonly client: DesktopVirtualizationAPIClient;

  /**
   * Initialize a new instance of the class PrivateEndpointConnectionsOperations class.
  ...
  ): AsyncIterableIterator<PrivateEndpointConnections[]> {
  ...
  updateByHostPool(
    ...
    hostPoolName: string,
    privateEndpointConnectionName: string,
    connection: PrivateEndpointConnections,
...
const listByHostPoolOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.PrivateEndpointConnectionsListResult,
    },
    default: {
...
const getByHostPoolOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.PrivateEndpointConnections,
    },
    default: {
      bodyMapper: Mappers.ErrorResponse,
    },
