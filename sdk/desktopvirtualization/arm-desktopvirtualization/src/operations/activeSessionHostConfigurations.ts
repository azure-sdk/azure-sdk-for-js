...
import { ActiveSessionHostConfigurations } from "../operationsInterfaces/index.js";
  ...
  implements ActiveSessionHostConfigurations
{
   ...
   * @param resourceGroupName The name of the resource group. The name is case insensitive.
   * @param hostPoolName The name of the host pool within the specified resource group
   * @param activeSessionHostConfigurationName The name of the ActiveSessionHostConfiguration within the
   *                                           specified ActiveSessionHostConfiguration group
   * @param options The options parameters.
   */
  get(
    resourceGroupName: string,
    hostPoolName: string,
    activeSessionHostConfigurationName: string,
    ...
    return this.client.sendOperationRequest(
      {
        resourceGroupName,
        hostPoolName,
        activeSessionHostConfigurationName,
        options,
      },
      getOperationSpec,
    );
...
const getOperationSpec: coreClient.OperationSpec = {
  path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DesktopVirtualization/hostPools/{hostPoolName}/activeSessionHostConfigurations/{activeSessionHostConfigurationName}/default",
  httpMethod: "GET",
  responses: {
    200: {
  ...
  urlParameters: [
    ...
    Parameters.resourceGroupName,
    Parameters.hostPoolName,
    Parameters.activeSessionHostConfigurationName,
  ],
  headerParameters: [Parameters.accept],
  serializer,
};
