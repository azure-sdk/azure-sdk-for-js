...
### Breaking Changes
  ...
  - Type of parameter daysOfWeek of interface ScalingPlanPersonalSchedule is changed from DayOfWeek[] to DaysOfWeek[]
  - Type of parameter daysOfWeek of interface ScalingPlanPooledSchedule is changed from DayOfWeek[] to DaysOfWeek[]
  - Type of parameter daysOfWeek of interface ScalingSchedule is changed from ScalingScheduleDaysOfWeekItem[] to DaysOfWeek[]
