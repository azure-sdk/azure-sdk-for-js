...
### Features Added
  ...
  - Added Interface ScalingPlanPooledSchedulePut
...
### Breaking Changes
  ...
  - Operation ScalingPlanPooledSchedules.create has a new signature
  ...
  - Type of parameter schedules of interface ScalingPlan is changed from ScalingSchedule[] to ScalingPlanPooledScheduleProperties[]
  - Type of parameter schedules of interface ScalingPlanPatch is changed from ScalingSchedule[] to ScalingPlanPooledScheduleProperties[]
  - Type of parameter value of interface ScalingPlanPooledScheduleList is changed from ScalingPlanPooledSchedule[] to ScalingPlanPooledSchedulePut[]
