...
export interface SessionHostConfigurations {
    ...
    createOrUpdate(resourceGroupName: string, hostPoolName: string, sessionHostConfiguration: SessionHostConfiguration, options?: SessionHostConfigurationsCreateOrUpdateOptionalParams): Promise<SessionHostConfigurationsCreateOrUpdateResponse>;
