...
export const OverviewSection: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "OverviewSection",
    modelProperties: {
      sectionKind: {
        serializedName: "sectionKind",
        type: {
          name: "String"
        }
      },
...
export const AnalyticsSectionData: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "AnalyticsSectionData",
    modelProperties: {
      alertRulesByStatus: {
        serializedName: "alertRulesByStatus",
        type: {
          name: "Dictionary",
          value: { type: { name: "String" } }
        }
...
export const AutomationSectionData: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "AutomationSectionData",
    modelProperties: {
      actionsPerformedByAutomation: {
        serializedName: "actionsPerformedByAutomation",
        type: {
          name: "Dictionary",
          value: { type: { name: "String" } }
        }
      ...
      activeAutomationRules: {
        serializedName: "activeAutomationRules",
        type: {
          name: "String"
        }
      },
      timeSavedByAutomation: {
        serializedName: "timeSavedByAutomation",
        type: {
          name: "Dictionary",
          value: { type: { name: "String" } }
        }
      },
      closedIncidentsByAutomation: {
        serializedName: "closedIncidentsByAutomation",
        type: {
          name: "String"
        }
      }
...
export const MeanTimeToAction: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "MeanTimeToAction",
    modelProperties: {
      value: {
        serializedName: "value",
        type: {
...
export const IncidentsSectionData: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "IncidentsSectionData",
    modelProperties: {
      incidentsByStatus: {
        serializedName: "incidentsByStatus",
        type: {
          name: "Dictionary",
          value: { type: { name: "String" } }
        }
      ...
      incidentsBySeverity: {
        serializedName: "incidentsBySeverity",
        type: {
          name: "Dictionary",
          value: { type: { name: "String" } }
        }
      ...
      closedIncidentsClassification: {
        serializedName: "closedIncidentsClassification",
        type: {
          name: "Dictionary",
          value: { type: { name: "String" } }
        }
      ...
      incidentsStatusByCreationTime: {
        serializedName: "incidentsStatusByCreationTime",
        type: {
          name: "Sequence",
          element: {
            type: {
      ...
      meanTimeToClose: {
        serializedName: "meanTimeToClose",
        type: {
          name: "Composite",
          className: "MeanTimeToAction"
        }
...
export const DataConnectorsSectionData: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "DataConnectorsSectionData",
    modelProperties: {
      activeConnectors: {
        serializedName: "activeConnectors",
        type: {
          name: "Dictionary",
          value: { type: { name: "String" } }
        }
      ...
      anomaliesVolume: {
        serializedName: "anomaliesVolume",
        type: {
          name: "Sequence",
          element: {
            type: {
      ...
      unhealthyConnectors: {
        serializedName: "unhealthyConnectors",
        type: {
          name: "Dictionary",
          value: { type: { name: "String" } }
        }
...
export const AnalyticsSection: coreClient.CompositeMapper = {
  serializedName: "Analytics",
  type: {
    name: "Composite",
    className: "AnalyticsSection",
    modelProperties: {
      ...OverviewSection.type.modelProperties,
      data: {
        serializedName: "data",
        type: {
          name: "Composite",
...
export const AutomationSection: coreClient.CompositeMapper = {
  serializedName: "Automation",
  type: {
    name: "Composite",
    className: "AutomationSection",
    modelProperties: {
      ...OverviewSection.type.modelProperties,
      data: {
        serializedName: "data",
...
export const IncidentsSection: coreClient.CompositeMapper = {
  serializedName: "Incidents",
  type: {
    name: "Composite",
    className: "IncidentsSection",
    modelProperties: {
      ...OverviewSection.type.modelProperties,
      data: {
        serializedName: "data",
...
export const DataConnectorsSection: coreClient.CompositeMapper = {
  serializedName: "DataConnectors",
  type: {
    name: "Composite",
    className: "DataConnectorsSection",
    modelProperties: {
      ...OverviewSection.type.modelProperties,
      data: {
        serializedName: "data",
