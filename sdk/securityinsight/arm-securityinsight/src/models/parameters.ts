...
import {
  ...
  EnrichmentIpAddressBody as EnrichmentIpAddressBodyMapper,
  EnrichmentDomainBody as EnrichmentDomainBodyMapper,
  ...
  QueryAutoGenerated as QueryAutoGeneratedMapper,
...
export const ipAddressBody: OperationParameter = {
  parameterPath: "ipAddressBody",
  mapper: EnrichmentIpAddressBodyMapper,
};

export const enrichmentType: OperationURLParameter = {
  parameterPath: "enrichmentType",
  mapper: {
    serializedName: "enrichmentType",
    required: true,
    type: {
      name: "String",
    },
...
export const domainBody: OperationParameter = {
  parameterPath: "domainBody",
...
export const query1: OperationParameter = {
  parameterPath: ["options", "query"],
  mapper: QueryAutoGeneratedMapper,
};
