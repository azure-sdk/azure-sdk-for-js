...
import {
  ...
  IncidentCreationRule as IncidentCreationRuleMapper,
...
export const incidentCreationRuleId: OperationURLParameter = {
  parameterPath: "incidentCreationRuleId",
  mapper: {
    serializedName: "incidentCreationRuleId",
    required: true,
    type: {
      name: "String"
    }
...
export const incidentCreationRuleToUpsert: OperationParameter = {
  parameterPath: ["options", "incidentCreationRuleToUpsert"],
  mapper: IncidentCreationRuleMapper
};
