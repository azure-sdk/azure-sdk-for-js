...
export interface AutomationSectionData {
  ...
  timeSavedByAutomation?: { [propertyName: string]: string };
...
export interface IncidentsSectionData {
  ...
  incidentsByStatus?: { [propertyName: string]: string };
  /** Aggregation of all incidents by severity: 'High', 'Medium', 'Low', 'Informational', ... */
  incidentsBySeverity?: { [propertyName: string]: string };
  /** Aggregation of all closed incidents by closed classification reason: 'TruePositive', 'FalsePositive', 'BenignPositive', 'Undetermined', ... */
  closedIncidentsClassification?: { [propertyName: string]: string };
  /** A series of incidents by status */
  incidentsStatusByCreationTime?: { [propertyName: string]: string }[];
...
export interface DataConnectorsSectionData {
  ...
  activeConnectors?: { [propertyName: string]: string };
  ...
  tiByType?: { [propertyName: string]: string };
  /** A series of all ingested events */
  totalVolume?: string[];
  /** A dictionary of all unhealthy connectors */
  unhealthyConnectors?: { [propertyName: string]: string };
}
...
/** Known values of {@link OverviewSectionKind} that the service accepts. */
 ...
 * {@link KnownOverviewSectionKind} can be used interchangeably with OverviewSectionKind,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Analytics** \
 * **Incidents** \
...
/** Optional parameters. */
export interface OverviewListOptionalParams
  extends coreClient.OperationOptions {
...
/** Contains response data for the list operation. */
export type OverviewListResponse = { [propertyName: string]: OverviewSection };
