...
/** Known values of {@link Op} that the service accepts. */
export enum KnownOp {
 ...
 * {@link KnownOp} can be used interchangeably with Op,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **replace**: Replace action of patch.
 */
...
/** Optional parameters. */
export interface GetRecommendationsOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the recommendations operation. */
