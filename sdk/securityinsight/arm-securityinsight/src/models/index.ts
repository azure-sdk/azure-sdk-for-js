...
export interface Summary extends ResourceWithEtag {
  ...
  /** A flag that indicates if the summary is deleted or not */
  isDeleted?: boolean;
  /** The tenantId where the summary belongs to */
  tenantId?: string;
  /** The status of the Summary : Active, Deleted */
  summaryStatus?: string;
  /** The status of the Summary upload : New, InProgress or Complete. Pls note : When a Summary upload status is equal to InProgress, the Summary cannot be deleted */
  uploadStatus?: string;
}
