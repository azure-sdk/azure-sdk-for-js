...
/** Count of all the threat intelligence objects. */
...
/** List all the threat intelligence objects. */
export interface ThreatIntelligenceList {
   ...
   */
  readonly nextLink?: string;
  /** Array of threat intelligence objects. */
  value: TIObjectUnion[];
}
...
export interface TIObjectCommonProperties {
   ...
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly data?: { [propertyName: string]: any };
  /**
...
export interface ThreatActor extends TIObject {
   ...
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly dataPropertiesData?: { [propertyName: string]: any };
  /**
   * The UserInfo of the user/entity which originally created this TI object.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
 ...
 * {@link KnownEnrichmentType} can be used interchangeably with EnrichmentType,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **main**
 */
...
/** Known values of {@link SortingDirection} that the service accepts. */
...
/** Known values of {@link LastUpdateMethod} that the service accepts. */
...
/**
 * Defines values for LastUpdateMethod. \
 * {@link KnownLastUpdateMethod} can be used interchangeably with LastUpdateMethod,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **TAXII Connector** \
 * **ISG Connector** \
 * **Sentinel REST API** \
 * **TI Matching Connector** \
 * **Microsoft TI Connector** \
 * **File Import** \
 * **Indicator Refresher** \
 * **TI Manager** \
 * **Threat Intelligence Upload Indicators API** \
 * **UploadStixObjectsAPI** \
 * **Threat Intelligence Bulk Actions**
 */
export type LastUpdateMethod = string;

/** Known values of {@link TIObjectKind} that the service accepts. */
...
/**
 * Defines values for TIObjectKind. \
...
/** Optional parameters. */
export interface ListGeodataByIpOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the listGeodataByIp operation. */
export type ListGeodataByIpResponse = EnrichmentIpGeodataAutoGenerated;

/** Optional parameters. */
export interface ListWhoisByDomainOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the listWhoisByDomain operation. */
...
/** Optional parameters. */
export interface ThreatIntelligenceCountOptionalParams
  extends coreClient.OperationOptions {
...
/** Optional parameters. */
export interface ThreatIntelligenceQueryOptionalParams
  extends coreClient.OperationOptions {
  /** The query to run on the TI objects in the workspace. */
...
/** Optional parameters. */
export interface ThreatIntelligenceQueryNextOptionalParams
  extends coreClient.OperationOptions {
  /** The query to run on the TI objects in the workspace. */
  query?: QueryAutoGenerated;
}

/** Contains response data for the queryNext operation. */
