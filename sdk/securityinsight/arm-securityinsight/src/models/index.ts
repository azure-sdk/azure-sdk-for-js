...
export type IncidentCreationRuleConditionUnion =
  | IncidentCreationRuleCondition
  | IncidentCreationPropertyConditionProperties;
export type IncidentCreationRuleGroupingConfigurationUnion =
...
export interface IncidentCreationPropertyConditionProperties
  extends IncidentCreationRuleCondition {
  /** Polymorphic discriminator, which specifies the different types this object can be */
  conditionType: "Property";
...
export interface PropertyBasedGroupingProperties
  extends IncidentCreationRuleGroupingConfiguration {
  /** Polymorphic discriminator, which specifies the different types this object can be */
  groupingKind: "PropertyBased";
...
/** Known values of {@link IncidentCreationRuleConditionType} that the service accepts. */
 ...
 * {@link KnownIncidentCreationRuleConditionType} can be used interchangeably with IncidentCreationRuleConditionType,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Property**: Evaluate an object property value.
 */
...
/** Known values of {@link GroupingKind} that the service accepts. */
 ...
 * {@link KnownGroupingKind} can be used interchangeably with GroupingKind,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **PropertyBased**
 */
...
/** Known values of {@link IncidentCreationRulePropertyGroupingSupportedProperty} that the service accepts. */
...
/**
 * Defines values for IncidentCreationRulePropertyGroupingSupportedProperty. \
 * {@link KnownIncidentCreationRulePropertyGroupingSupportedProperty} can be used interchangeably with IncidentCreationRulePropertyGroupingSupportedProperty,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Entities**: Group alerts by identical entities. \
 * **CustomDetails**: Group alerts by custom details. \
 * **AlertProperties**: Group alerts by alert properties.
 */
export type IncidentCreationRulePropertyGroupingSupportedProperty = string;

/** Known values of {@link IncidentCreationRulePropertyConditionSupportedProperty} that the service accepts. */
...
/**
 * Defines values for IncidentCreationRulePropertyConditionSupportedProperty. \
 * {@link KnownIncidentCreationRulePropertyConditionSupportedProperty} can be used interchangeably with IncidentCreationRulePropertyConditionSupportedProperty,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **AlertDisplayName**: The name of the alert. \
 * **AlertAnalyticRuleId**: The analytic rule id of the alert. \
 * **AlertProductName**: The name of the product of the alert. \
...
/** Known values of {@link IncidentCreationRulePropertyConditionSupportedOperator} that the service accepts. */
 ...
 * {@link KnownIncidentCreationRulePropertyConditionSupportedOperator} can be used interchangeably with IncidentCreationRulePropertyConditionSupportedOperator,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Equals**: Evaluates if the property equals at least one of the condition values. \
 * **NotEquals**: Evaluates if the property does not equal any of the condition values. \
...
/** Optional parameters. */
export interface IncidentCreationRulesListOptionalParams
  extends coreClient.OperationOptions {
  /** Returns only the first n results. Optional. */
  top?: number;
  /** Skiptoken is only used if a previous operation returned a partial result. If a previous response contains a nextLink element, the value of the nextLink element will include a skiptoken parameter that specifies a starting point to use for subsequent calls. Optional. */
...
/** Optional parameters. */
export interface IncidentCreationRulesGetOptionalParams
  extends coreClient.OperationOptions {}
...
/** Optional parameters. */
export interface IncidentCreationRulesCreateOrUpdateOptionalParams
  extends coreClient.OperationOptions {
...
/** Optional parameters. */
export interface IncidentCreationRulesDeleteOptionalParams
  extends coreClient.OperationOptions {}

/** Optional parameters. */
export interface IncidentCreationRulesListNextOptionalParams
  extends coreClient.OperationOptions {}
