...
export interface PackageBaseProperties {
  /** Static ID for the content.  Used to identify dependencies and content from solutions or community.  Hard-coded/static for out of the box content and solutions. Can be optionally set for user created content to define dependencies.  If an active content item is made from a metadata, both will have the same contentId. */
  contentId?: string;
...
export interface Recommendation {
  ...
  additionalProperties?: { [propertyName: string]: Record<string, unknown> };
...
/** Known values of {@link ActionState} that the service accepts. */
export enum KnownActionState {
  /** Default state of actions. */
  Active = "Active",
  /** State for when actions have been clicked on. */
  InProgress = "InProgress",
  /** State of completed actions. */
  Done = "Done"
}

/**
 * Defines values for ActionState. \
 * {@link KnownActionState} can be used interchangeably with ActionState,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Active**: Default state of actions. \
 * **InProgress**: State for when actions have been clicked on. \
 * **Done**: State of completed actions.
 */
...
/** Known values of {@link PullRequestState} that the service accepts. */
...
/** Known values of {@link ItemStatus} that the service accepts. */
 ...
 * {@link KnownItemStatus} can be used interchangeably with ItemStatus,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
