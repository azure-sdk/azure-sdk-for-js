 ...
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **StixIndicator**: This bulk action is targeting stix indicators.
 */
export type TargetType = string;

/** Known values of {@link BulkActionState} that the service accepts. */
...
/**
 * Defines values for BulkActionState. \
 * {@link KnownBulkActionState} can be used interchangeably with BulkActionState,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Unknown**: This bulk action's state is not known. \
 * **Queued**: This bulk action is waiting to be processed. \
 * **WaitingForInitialization**: This bulk action is waiting to be initialized. \
 * **Initializing**: This bulk action is currently being initialized. \
 * **WaitingForExecution**: This bulk action is waiting to be executed. \
 * **Executing**: This bulk action is currently executing. \
 * **Finalizing**: This bulk action is being finalized. \
 * **Done**: This bulk action has successfully completed. \
 * **Error**: An error occured during the execution of this bulk action. \
 * **OnHold**: This bulk action is currently on hold. \
 * **CancellationRequested**: Cancellation was requested for this bulk action. \
 * **Cancelled**: This bulk action has been cancelled.
 */
export type BulkActionState = string;

/** Known values of {@link Connective} that the service accepts. */
...
/**
 * Defines values for Connective. \
 * {@link KnownConnective} can be used interchangeably with Connective,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **And**: Conditions\/clauses should be joined together using logical AND operator. \
 * **Or**: Conditions\/clauses should be joined together using logical OR operator.
 */
 ...
 * **StringContains**: The 'contains' operator for strings. \
 * **StringNotContains**: The 'not contains' operator for strings. \
 * **IsNull**: The 'is_null' operator. \
 * **IsNotNull**: The 'not is_null' operator.
 */
 ...
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Delete**: This item will be deleted. \
 * **Edit**: This item will be edited.
 */
export type OperationType = string;

/** Known values of {@link OperationMutator} that the service accepts. */
export enum KnownOperationMutator {
  ...
  /** Use this operator to remove the specified element from a set (i.e. an unordered multivalue variable). */
  RemoveFromSet = "RemoveFromSet"
}

/**
 * Defines values for OperationMutator. \
 * {@link KnownOperationMutator} can be used interchangeably with OperationMutator,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **SetValue**: Use this operator when a scalar value should be replaced\/overwritten. \
 * **SetNull**: Use this operator when a scalar or array value should be set explicitly to NULL. \
 * **SetEmpty**: Use this operator when an array value should be set to the empty set\/list. \
 * **AddToSet**: Use this operator to add an element to a set (i.e. an unordered multivalue variable). \
 * **AppendToList**: Use this operator to add an element to the end of a list (i.e. an ordered multivalue variable). \
 * **RemoveFromSet**: Use this operator to remove the specified element from a set (i.e. an unordered multivalue variable).
 */
...
/** Optional parameters. */
export interface BulkActionsListOptionalParams
  extends coreClient.OperationOptions {
  /** Filters the results, based on a Boolean condition. Optional. */
  filter?: string;
  /** Sorts the results. Optional. */
...
/** Optional parameters. */
export interface BulkActionsGetOptionalParams
  extends coreClient.OperationOptions {}
...
/** Optional parameters. */
export interface BulkActionsCreateOrUpdateOptionalParams
  extends coreClient.OperationOptions {}
...
/** Optional parameters. */
export interface BulkActionsDeleteOptionalParams
  extends coreClient.OperationOptions {
...
/** Optional parameters. */
export interface BulkActionsListNextOptionalParams
  extends coreClient.OperationOptions {
  /** Filters the results, based on a Boolean condition. Optional. */
  filter?: string;
  /** Sorts the results. Optional. */
