...
/** Known values of {@link RelatedResourceKind} that the service accepts. */
...
/**
 * Defines values for RelatedResourceKind. \
 * {@link KnownRelatedResourceKind} can be used interchangeably with RelatedResourceKind,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Hunt** \
 * **Incident** \
