...
export class DataConnectorDefinitionsImpl implements DataConnectorDefinitions {
  ...
  createOrUpdate(
    ...
    workspaceName: string,
    dataConnectorDefinitionName: string,
    connectorDefinitionInput: ConnectorDefinitionBaseArmObjectWrapperWithConverter,
...
const listOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.ConnectorDefinitionBaseArmCollectionWrapper
    },
    default: {
...
const getOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.ConnectorDefinitionBaseArmObjectWrapper
    },
    default: {
      bodyMapper: Mappers.CloudError
    }
