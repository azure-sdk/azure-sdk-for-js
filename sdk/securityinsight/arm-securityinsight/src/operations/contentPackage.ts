...
import {
  ContentPackageGetOptionalParams,
  ContentPackageGetResponse,
...
export class ContentPackageImpl implements ContentPackage {
  ...
  get(
    ...
    packageId: string,
    options?: ContentPackageGetOptionalParams
  ): Promise<ContentPackageGetResponse> {
...
const installOperationSpec: coreClient.OperationSpec = {
  path:
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/contentPackages/{packageId}/install",
  httpMethod: "POST",
  responses: {
    200: {
      bodyMapper: Mappers.PackageModel
...
const uninstallOperationSpec: coreClient.OperationSpec = {
  path:
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/contentPackages/{packageId}/uninstall",
  httpMethod: "POST",
  responses: {
    200: {},
    default: {
