...
export class ProductPackagesImpl implements ProductPackages {
  ...
  ): PagedAsyncIterableIterator<PackageModelAutoGenerated> {
  ...
  ): AsyncIterableIterator<PackageModelAutoGenerated[]> {
...
const listOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.PackageListAutoGenerated
    },
    default: {
