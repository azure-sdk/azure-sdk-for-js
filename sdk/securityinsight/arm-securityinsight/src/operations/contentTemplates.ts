...
export class ContentTemplatesImpl implements ContentTemplates {
  ...
  ): PagedAsyncIterableIterator<TemplateModelAutoGenerated> {
  ...
  ): AsyncIterableIterator<TemplateModelAutoGenerated[]> {
...
const listOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.TemplateListAutoGenerated
    },
    default: {
