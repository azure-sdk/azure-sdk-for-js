...
**Breaking Changes**
  ...
  - Class SecurityInsights has a new required parameter get
  - Class SecurityInsights has a new required parameter getRecommendations
  - Class SecurityInsights has a new required parameter incidentTasks
  - Class SecurityInsights has a new required parameter update
