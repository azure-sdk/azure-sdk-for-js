...
**Features**
  ...
  - Added operation group IncidentCreationRules
  ...
  - Added Interface IncidentCreationPropertyConditionProperties
  - Added Interface IncidentCreationRule
  - Added Interface IncidentCreationRuleCondition
  - Added Interface IncidentCreationRuleGroupingAttribute
  - Added Interface IncidentCreationRuleGroupingConfiguration
  - Added Interface IncidentCreationRulePropertyBasedGroupingProperties
  - Added Interface IncidentCreationRulePropertyConditionProperties
  - Added Interface IncidentCreationRulesCreateOrUpdateOptionalParams
  - Added Interface IncidentCreationRulesDeleteOptionalParams
  - Added Interface IncidentCreationRulesGetOptionalParams
  - Added Interface IncidentCreationRulesList
  - Added Interface IncidentCreationRulesListNextOptionalParams
  - Added Interface IncidentCreationRulesListOptionalParams
  ...
  - Added Interface PropertyBasedGroupingProperties
  ...
  - Added Type Alias GroupingKind
  - Added Type Alias IncidentCreationRuleConditionType
  - Added Type Alias IncidentCreationRuleConditionUnion
  - Added Type Alias IncidentCreationRuleGroupingConfigurationUnion
  - Added Type Alias IncidentCreationRulePropertyConditionSupportedOperator
  - Added Type Alias IncidentCreationRulePropertyConditionSupportedProperty
  - Added Type Alias IncidentCreationRulePropertyGroupingSupportedProperty
  - Added Type Alias IncidentCreationRulesCreateOrUpdateResponse
  - Added Type Alias IncidentCreationRulesGetResponse
  - Added Type Alias IncidentCreationRulesListNextResponse
  - Added Type Alias IncidentCreationRulesListResponse
  ...
  - Added Enum KnownGroupingKind
  - Added Enum KnownIncidentCreationRuleConditionType
  - Added Enum KnownIncidentCreationRulePropertyConditionSupportedOperator
  - Added Enum KnownIncidentCreationRulePropertyConditionSupportedProperty
  - Added Enum KnownIncidentCreationRulePropertyGroupingSupportedProperty
