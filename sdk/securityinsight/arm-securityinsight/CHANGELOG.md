...
**Features**
  ...
  - Added Interface AttackPatternProperties
  ...
  - Added Interface EnrichmentIpGeodataAutoGenerated
  ...
  - Added Interface IndicatorProperties
  - Added Interface IndicatorPropertiesObservablesItem
  ...
  - Added Interface QueryAutoGenerated
  ...
  - Added Interface RelationshipProperties
  ...
  - Added Interface ThreatActorProperties
  - Added Interface ThreatIntelligenceCount
  - Added Interface ThreatIntelligenceCountOptionalParams
  - Added Interface ThreatIntelligenceList
  - Added Interface ThreatIntelligenceQueryNextOptionalParams
  ...
  - Added Interface UserInfoAutoGenerated
  ...
  - Added Type Alias LastUpdateMethod
  - Added Type Alias ListGeodataByIpResponse
  - Added Type Alias ListWhoisByDomainResponse
  ...
  - Added Type Alias ThreatIntelligenceCountResponse
  - Added Type Alias ThreatIntelligenceQueryNextResponse
  - Added Type Alias ThreatIntelligenceQueryResponse
  ...
  - Added Enum KnownLastUpdateMethod
...
**Breaking Changes**
  ...
  - Type of parameter kind of interface EntityQueriesListOptionalParams is changed from Enum13 to Enum21
