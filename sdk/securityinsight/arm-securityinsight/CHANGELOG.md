...
**Features**
  ...
  - Added operation group BulkActions
  ...
  - Added Interface BulkAction
  - Added Interface BulkActionList
  ...
  - Added Interface BulkActionsListNextOptionalParams
  - Added Interface BulkActionsListOptionalParams
  - Added Interface Clause
  ...
  - Added Type Alias BulkActionsCreateOrUpdateResponse
  - Added Type Alias BulkActionsDeleteResponse
  - Added Type Alias BulkActionsGetResponse
  - Added Type Alias BulkActionsListNextResponse
  - Added Type Alias BulkActionsListResponse
  - Added Type Alias BulkActionState
  - Added Type Alias ConditionOperator
  ...
  - Added Type Alias OperationMutator
  ...
  - Interface Operation has a new optional parameter steps
  - Interface Operation has a new optional parameter type
  ...
  - Class SecurityInsights has a new parameter bulkActions
  ...
  - Added Enum KnownBulkActionState
  ...
  - Added Enum KnownOperationMutator
...
**Breaking Changes**
  ...
  - Interface Operation no longer has parameter display
  - Interface Operation no longer has parameter isDataAction
  - Interface Operation no longer has parameter name
