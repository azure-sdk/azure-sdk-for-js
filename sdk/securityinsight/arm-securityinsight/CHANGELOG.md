...
## 1.0.0-beta.6 (2023-01-04)
    
**Features**

  - Added operation group ExportConnections
  - Added operation group ExportJobs
  ...
  - Added Interface ExportConnection
  - Added Interface ExportConnectionList
  - Added Interface ExportConnectionsCreateOptionalParams
  - Added Interface ExportConnectionsDeleteOptionalParams
  - Added Interface ExportConnectionsGetOptionalParams
  - Added Interface ExportConnectionsListNextOptionalParams
  - Added Interface ExportConnectionsListOptionalParams
  - Added Interface ExportJob
  - Added Interface ExportJobContentInfo
  - Added Interface ExportJobList
  - Added Interface ExportJobResultInfo
  - Added Interface ExportJobsCreateOptionalParams
  - Added Interface ExportJobsGetOptionalParams
  - Added Interface ExportJobsListNextOptionalParams
  - Added Interface ExportJobsListOptionalParams
  ...
  - Added Interface RepositoryAutoGenerated
  ...
  - Added Type Alias ExportConnectionsCreateResponse
  - Added Type Alias ExportConnectionsGetResponse
  - Added Type Alias ExportConnectionsListNextResponse
  - Added Type Alias ExportConnectionsListResponse
  - Added Type Alias ExportJobOutcome
  - Added Type Alias ExportJobsCreateResponse
  - Added Type Alias ExportJobsGetResponse
  - Added Type Alias ExportJobsListNextResponse
  - Added Type Alias ExportJobsListResponse
  - Added Type Alias ExportJobStatus
  - Added Type Alias ExportType
  ...
  - Added Enum KnownExportJobOutcome
  - Added Enum KnownExportJobStatus
  - Added Enum KnownExportType
...
**Breaking Changes**
  ...
  - Interface Repository no longer has parameter deploymentLogsUrl
  - Interface Repository no longer has parameter displayUrl
  ...
  - Type of parameter repository of interface SourceControl is changed from Repository to RepositoryAutoGenerated
  ...
  - Enum KnownContentType no longer has value Workbook
  - Enum KnownVersion no longer has value V2
