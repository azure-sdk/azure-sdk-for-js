...
**Features**
  ...
  - Added operation group Overview
  - Added Interface AnalyticsSectionData
  - Added Interface AutomationSectionData
  - Added Interface DataConnectorsSectionData
  - Added Interface GetInsightsError
  - Added Interface IncidentsSectionData
  - Added Interface MeanTimeToAction
  - Added Interface OverviewListOptionalParams
  - Added Interface OverviewSection
  ...
  - Added Type Alias AnalyticsSection
  ...
  - Added Type Alias AutomationSection
  ...
  - Added Type Alias DataConnectorsSection
  ...
  - Added Type Alias IncidentsSection
  ...
  - Added Type Alias OverviewListResponse
  - Added Type Alias OverviewSectionKind
  ...
  - Class SecurityInsights has a new parameter overview
  - Added Enum KnownEnum12
  - Added Enum KnownOverviewSectionKind

**Breaking Changes**

  - Removed operation group SecurityMLAnalyticsSettings
  - Interface DataConnectorConnectBody no longer has parameter dataCollectionEndpoint
  - Interface DataConnectorConnectBody no longer has parameter dataCollectionRuleImmutableId
  - Interface DataConnectorConnectBody no longer has parameter outputStream
  ...
  - Enum KnownAutomationRulePropertyConditionSupportedProperty no longer has value AlertAnalyticRuleIds
  - Enum KnownConditionType no longer has value PropertyArrayChanged
  - Enum KnownConditionType no longer has value PropertyChanged
  - Enum KnownEntityKind no longer has value Nic
  - Enum KnownEntityTimelineKind no longer has value Anomaly
  - Enum KnownEntityType no longer has value Nic
  - Enum KnownTriggersOn no longer has value Alerts
  - Enum KnownTriggersWhen no longer has value Updated
