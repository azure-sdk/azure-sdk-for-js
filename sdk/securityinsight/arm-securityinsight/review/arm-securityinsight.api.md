...
// @public
export type AnalyticsSection = OverviewSection & {
...
// @public
export type AutomationSection = OverviewSection & {
    data?: AutomationSectionData;
};

// @public (undocumented)
export interface AutomationSectionData {
    actionsPerformedByAutomation?: {
        [propertyName: string]: string;
    };
    activeAutomationRules?: string;
    closedIncidentsByAutomation?: string;
...
// @public
export type DataConnectorsSection = OverviewSection & {
    data?: DataConnectorsSectionData;
};

// @public (undocumented)
export interface DataConnectorsSectionData {
    activeConnectors?: {
        [propertyName: string]: string;
    };
    anomaliesVolume?: string[];
    tiByType?: {
        [propertyName: string]: string;
    };
    totalVolume?: string[];
...
// @public
export type IncidentsSection = OverviewSection & {
    data?: IncidentsSectionData;
};

// @public (undocumented)
export interface IncidentsSectionData {
    closedIncidentsClassification?: {
        [propertyName: string]: string;
    };
    incidentsBySeverity?: {
        [propertyName: string]: string;
    ...
    incidentsStatusByCreationTime?: {
        [propertyName: string]: string;
    }[];
    meanTimeToAck?: MeanTimeToAction;
    meanTimeToClose?: MeanTimeToAction;
}
...
// @public
export enum KnownOverviewSectionKind {
    // (undocumented)
    Analytics = "Analytics",
    // (undocumented)
...
// @public (undocumented)
export interface MeanTimeToAction {
    trend?: string;
    value?: string;
}
...
export interface Overview {
    list(resourceGroupName: string, workspaceName: string, options?: OverviewListOptionalParams): Promise<OverviewListResponse>;
}

// @public
export interface OverviewListOptionalParams extends coreClient.OperationOptions {
    sections?: string;
}

// @public
export type OverviewListResponse = {
    [propertyName: string]: OverviewSection;
};

// @public
export interface OverviewSection {
    readonly dataQueryTime?: string;
    readonly isFromCache?: boolean;
    sectionKind?: OverviewSectionKind;
}

// @public
export type OverviewSectionKind = string;
