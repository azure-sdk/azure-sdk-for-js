...
// @public
export interface ActionResponse extends ResourceAutoGenerated {
    etag?: string;
    logicAppResourceId?: string;
    workflowId?: string;
}
...
// @public
export interface AlertRuleTemplate extends ResourceAutoGenerated {
    kind: AlertRuleKind;
}
...
// @public
export interface Entity extends ResourceAutoGenerated {
    kind: EntityKindEnum;
}
