...
// @public
export enum KnownRelatedResourceKind {
    AmlWorkspace = "AmlWorkspace",
    Bookmark = "Bookmark",
    Entities = "Entities",
    Hunt = "Hunt",
    Incident = "Incident",
    LogAnalyticsSavedSearchQueries = "LogAnalyticsSavedSearchQueries"
}
...
// @public
export type RelatedResourceKind = string;
