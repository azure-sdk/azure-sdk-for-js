...
export interface AttackPattern extends TIObject {
    readonly createdByPropertiesCreatedBy?: UserInfoAutoGenerated;
    readonly dataPropertiesData?: {
        [propertyName: string]: any;
    };
    readonly firstIngestedTimeUtcPropertiesFirstIngestedTimeUtc?: Date;
    readonly ingestionRulesVersionPropertiesIngestionRulesVersion?: string;
    kind: "AttackPattern";
    readonly lastIngestedTimeUtcPropertiesLastIngestedTimeUtc?: Date;
    readonly lastModifiedByPropertiesLastModifiedBy?: UserInfoAutoGenerated;
    readonly lastUpdatedDateTimeUtcPropertiesLastUpdatedDateTimeUtc?: Date;
    readonly lastUpdateMethodPropertiesLastUpdateMethod?: LastUpdateMethod;
    readonly relationshipHintsPropertiesRelationshipHints?: RelationshipHint[];
    readonly sourcePropertiesSource?: string;
}

// @public
export interface AttackPatternProperties extends TIObjectCommonProperties {
}
...
// @public
export interface EnrichmentIpGeodataAutoGenerated {
    asn?: string;
    carrier?: string;
    city?: string;
...
// @public
export interface IdentityProperties extends TIObjectCommonProperties {
}
...
export interface Indicator extends TIObject {
    ...
    readonly lastUpdatedDateTimeUtcPropertiesLastUpdatedDateTimeUtc?: Date;
    readonly lastUpdateMethodPropertiesLastUpdateMethod?: LastUpdateMethod;
    observables?: IndicatorPropertiesObservablesItem[];
    readonly relationshipHintsPropertiesRelationshipHints?: RelationshipHint[];
    readonly sourcePropertiesSource?: string;
}

// @public
export interface IndicatorProperties extends TIObjectCommonProperties {
    observables?: IndicatorPropertiesObservablesItem[];
}

// @public
export interface IndicatorPropertiesObservablesItem {
    type?: string;
    value?: string;
}
...
// @public
export enum KnownLastUpdateMethod {
    FileImport = "File Import",
    IndicatorRefresher = "Indicator Refresher",
    ISGConnector = "ISG Connector",
    MicrosoftTIConnector = "Microsoft TI Connector",
    SentinelRestAPI = "Sentinel REST API",
    TaxiiConnector = "TAXII Connector",
    ThreatIntelligenceBulkActions = "Threat Intelligence Bulk Actions",
    ThreatIntelligenceUploadIndicatorsAPI = "Threat Intelligence Upload Indicators API",
    TIManager = "TI Manager",
    TIMatchingConnector = "TI Matching Connector",
    UploadStixObjectsAPI = "UploadStixObjectsAPI"
}
...
// @public
export type LastUpdateMethod = string;

// @public
export interface ListGeodataByIpOptionalParams extends coreClient.OperationOptions {
}

// @public
export type ListGeodataByIpResponse = EnrichmentIpGeodataAutoGenerated;

// @public
export interface ListWhoisByDomainOptionalParams extends coreClient.OperationOptions {
}

// @public
export type ListWhoisByDomainResponse = EnrichmentDomainWhois;
...
// @public
export interface QueryAutoGenerated {
...
// @public
export interface RelationshipProperties extends TIObjectCommonProperties {
}
...
export class SecurityInsights extends coreClient.ServiceClient {
    ...
    // (undocumented)
    iPGeodata: IPGeodata;
    listGeodataByIp(resourceGroupName: string, workspaceName: string, enrichmentType: EnrichmentType, ipAddressBody: EnrichmentIpAddressBody, options?: ListGeodataByIpOptionalParams): Promise<ListGeodataByIpResponse>;
    listWhoisByDomain(resourceGroupName: string, workspaceName: string, enrichmentType: EnrichmentType, domainBody: EnrichmentDomainBody, options?: ListWhoisByDomainOptionalParams): Promise<ListWhoisByDomainResponse>;
    // (undocumented)
    metadata: Metadata;
    // (undocumented)
    ...
    // (undocumented)
    threatIntelligenceOperations: ThreatIntelligenceOperations;
    // (undocumented)
...
// @public
export interface ThreatActorProperties extends TIObjectCommonProperties {
}
...
// @public
export interface ThreatIntelligenceCountOptionalParams extends coreClient.OperationOptions {
    query?: Query;
}

// @public
export type ThreatIntelligenceCountResponse = ThreatIntelligenceCount;
...
// @public
export interface ThreatIntelligenceList {
    readonly nextLink?: string;
    value: TIObjectUnion[];
}
...
export interface ThreatIntelligenceOperations {
    count(resourceGroupName: string, workspaceName: string, options?: ThreatIntelligenceCountOptionalParams): Promise<ThreatIntelligenceCountResponse>;
    listQuery(resourceGroupName: string, workspaceName: string, options?: ThreatIntelligenceQueryOptionalParams): PagedAsyncIterableIterator<TIObjectUnion>;
}
...
// @public
export interface ThreatIntelligenceQueryNextOptionalParams extends coreClient.OperationOptions {
    query?: QueryAutoGenerated;
}

// @public
export type ThreatIntelligenceQueryNextResponse = ThreatIntelligenceList;

// @public
export interface ThreatIntelligenceQueryOptionalParams extends coreClient.OperationOptions {
    query?: QueryAutoGenerated;
}

// @public
export type ThreatIntelligenceQueryResponse = ThreatIntelligenceList;
...
export interface TIObject extends Resource {
    readonly createdBy?: UserInfoAutoGenerated;
    readonly data?: {
        [propertyName: string]: any;
    };
    ...
    readonly lastModifiedBy?: UserInfoAutoGenerated;
    readonly lastUpdatedDateTimeUtc?: Date;
    readonly lastUpdateMethod?: LastUpdateMethod;
...
// @public (undocumented)
export type TIObjectUnion = TIObject | ThreatActor | AttackPattern | Identity | Relationship | Indicator;
...
// @public
export interface UserInfoAutoGenerated {
    email?: string;
    name?: string;
