...
export interface Get {
    recommendations(resourceGroupName: string, workspaceName: string, options?: GetRecommendationsOptionalParams): Promise<GetRecommendationsResponse>;
...
// @public
export interface GetRecommendationsOptionalParams extends coreClient.OperationOptions {
}

// @public
export type GetRecommendationsResponse = Recommendation[];
...
export interface Update {
    recommendation(resourceGroupName: string, workspaceName: string, recommendationId: string, recommendationPatch: RecommendationPatch[], options?: UpdateRecommendationOptionalParams): Promise<UpdateRecommendationResponse>;
}
