...
// @public
export type GroupingKind = string;
...
// @public
export interface IncidentCreationPropertyConditionProperties extends IncidentCreationRuleCondition {
    // (undocumented)
    conditionProperties?: IncidentCreationRulePropertyConditionProperties;
    conditionType: "Property";
}

// @public (undocumented)
export interface IncidentCreationRule extends ResourceWithEtag {
    conditions?: IncidentCreationRuleConditionUnion[];
    ...
    displayName: string;
    enabled: boolean;
    groupingConfiguration?: IncidentCreationRuleGroupingConfigurationUnion;
...
// @public
export interface IncidentCreationRuleCondition {
    conditionType: "Property";
}

// @public
export type IncidentCreationRuleConditionType = string;

// @public (undocumented)
export type IncidentCreationRuleConditionUnion = IncidentCreationRuleCondition | IncidentCreationPropertyConditionProperties;

// @public (undocumented)
export interface IncidentCreationRuleGroupingAttribute {
    propertyName?: IncidentCreationRulePropertyGroupingSupportedProperty;
    // (undocumented)
    propertyValue?: string;
}

// @public
export interface IncidentCreationRuleGroupingConfiguration {
    enabled?: boolean;
    groupingKind: "PropertyBased";
    lookbackDuration?: string;
    reopenClosedIncident?: boolean;
}

// @public (undocumented)
export type IncidentCreationRuleGroupingConfigurationUnion = IncidentCreationRuleGroupingConfiguration | PropertyBasedGroupingProperties;

// @public (undocumented)
export interface IncidentCreationRulePropertyBasedGroupingProperties {
    groupingAttributes?: IncidentCreationRuleGroupingAttribute[];
}

// @public (undocumented)
export interface IncidentCreationRulePropertyConditionProperties {
    // (undocumented)
    operator?: IncidentCreationRulePropertyConditionSupportedOperator;
    propertyName?: IncidentCreationRulePropertyConditionSupportedProperty;
    // (undocumented)
    propertyValues?: string[];
}

// @public
export type IncidentCreationRulePropertyConditionSupportedOperator = string;

// @public
export type IncidentCreationRulePropertyConditionSupportedProperty = string;

// @public
export type IncidentCreationRulePropertyGroupingSupportedProperty = string;

// @public
export interface IncidentCreationRules {
    createOrUpdate(resourceGroupName: string, workspaceName: string, incidentCreationRuleId: string, options?: IncidentCreationRulesCreateOrUpdateOptionalParams): Promise<IncidentCreationRulesCreateOrUpdateResponse>;
    delete(resourceGroupName: string, workspaceName: string, incidentCreationRuleId: string, options?: IncidentCreationRulesDeleteOptionalParams): Promise<void>;
    get(resourceGroupName: string, workspaceName: string, incidentCreationRuleId: string, options?: IncidentCreationRulesGetOptionalParams): Promise<IncidentCreationRulesGetResponse>;
    list(resourceGroupName: string, workspaceName: string, options?: IncidentCreationRulesListOptionalParams): PagedAsyncIterableIterator<IncidentCreationRule>;
}

// @public
export interface IncidentCreationRulesCreateOrUpdateOptionalParams extends coreClient.OperationOptions {
    // (undocumented)
    incidentCreationRuleToUpsert?: IncidentCreationRule;
}

// @public
export type IncidentCreationRulesCreateOrUpdateResponse = IncidentCreationRule;

// @public
export interface IncidentCreationRulesDeleteOptionalParams extends coreClient.OperationOptions {
}

// @public
export interface IncidentCreationRulesGetOptionalParams extends coreClient.OperationOptions {
}

// @public
export type IncidentCreationRulesGetResponse = IncidentCreationRule;

// @public (undocumented)
export interface IncidentCreationRulesList {
    // (undocumented)
    nextLink?: string;
    // (undocumented)
    value?: IncidentCreationRule[];
}

// @public
export interface IncidentCreationRulesListNextOptionalParams extends coreClient.OperationOptions {
}

// @public
export type IncidentCreationRulesListNextResponse = IncidentCreationRulesList;

// @public
export interface IncidentCreationRulesListOptionalParams extends coreClient.OperationOptions {
    skipToken?: string;
    top?: number;
}

// @public
export type IncidentCreationRulesListResponse = IncidentCreationRulesList;
...
// @public
export enum KnownIncidentCreationRuleConditionType {
    Property = "Property"
}

// @public
export enum KnownIncidentCreationRulePropertyConditionSupportedOperator {
    Contains = "Contains",
    EndsWith = "EndsWith",
    Equals = "Equals",
    NotContains = "NotContains",
...
// @public
export enum KnownIncidentCreationRulePropertyConditionSupportedProperty {
    AlertAnalyticRuleId = "AlertAnalyticRuleId",
...
// @public
export enum KnownIncidentCreationRulePropertyGroupingSupportedProperty {
...
// @public
export interface PropertyBasedGroupingProperties extends IncidentCreationRuleGroupingConfiguration {
    groupingKind: "PropertyBased";
    // (undocumented)
    groupingProperties?: IncidentCreationRulePropertyBasedGroupingProperties;
}
