...
/** model interface _ValidateBackupPropertiesParameterBody */
export interface _ValidateBackupPropertiesParameterBody {
  /** Backup Operation Required properties */
  backupRequestProperties?: BackupRequestProperties;
}

export function _validateBackupPropertiesParameterBodySerializer(
  item: _ValidateBackupPropertiesParameterBody,
): any {
  return {
    backupRequestProperties: !item["backupRequestProperties"]
      ? item["backupRequestProperties"]
      : backupRequestPropertiesSerializer(item["backupRequestProperties"]),
  };
}
...
/** model interface _BackupParameterBody */
export interface _BackupParameterBody {
  /** Azure storage Resource Uri */
  backupRequestProperties?: BackupRequestProperties;
}

export function _backupParameterBodySerializer(item: _BackupParameterBody): any {
  return {
    backupRequestProperties: !item["backupRequestProperties"]
      ? item["backupRequestProperties"]
      : backupRequestPropertiesSerializer(item["backupRequestProperties"]),
...
/** model interface _ValidateRestorePropertiesParameterBody */
export interface _ValidateRestorePropertiesParameterBody {
  /** Optional Parameters to validate prior performing a restore operation. */
  restoreRequestProperties?: RestoreRequestProperties;
}

export function _validateRestorePropertiesParameterBodySerializer(
  item: _ValidateRestorePropertiesParameterBody,
): any {
  return {
    restoreRequestProperties: !item["restoreRequestProperties"]
      ? item["restoreRequestProperties"]
      : restoreRequestPropertiesSerializer(item["restoreRequestProperties"]),
  };
}
...
export enum KnownVersions {
  ...
  V20240630Preview = "2024-06-30-preview",
}
