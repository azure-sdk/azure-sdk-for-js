...
export function _$deleteSend(
  ...
  resourceGroupName: string,
  name: string,
  options: DedicatedHsmsDeleteOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
...
export function _updateSend(
  ...
  options: DedicatedHsmsUpdateOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HardwareSecurityModules/dedicatedHSMs/{name}{?api%2Dversion}",
    {
...
export function _createOrUpdateSend(
  ...
  options: DedicatedHsmsCreateOrUpdateOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HardwareSecurityModules/dedicatedHSMs/{name}{?api%2Dversion}",
    {
...
export function _getSend(
  ...
  resourceGroupName: string,
  name: string,
  options: DedicatedHsmsGetOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HardwareSecurityModules/dedicatedHSMs/{name}{?api%2Dversion}",
    {
