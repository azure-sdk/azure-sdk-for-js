...
export function _cloudHsmClusterRestoreStatusGetSend(
  context: Client,
...
export async function _cloudHsmClusterRestoreStatusGetDeserialize(
...
export async function cloudHsmClusterRestoreStatusGet(
  context: Client,
  resourceGroupName: string,
  cloudHsmClusterName: string,
  jobId: string,
  ...
  const result = await _cloudHsmClusterRestoreStatusGetSend(
    context,
    resourceGroupName,
    cloudHsmClusterName,
    jobId,
  ...
  return _cloudHsmClusterRestoreStatusGetDeserialize(result);
}

export function _cloudHsmClusterBackupStatusGetSend(
  context: Client,
  resourceGroupName: string,
  cloudHsmClusterName: string,
  jobId: string,
...
export async function _cloudHsmClusterBackupStatusGetDeserialize(
  result: PathUncheckedResponse,
...
export async function cloudHsmClusterBackupStatusGet(
  context: Client,
  resourceGroupName: string,
  cloudHsmClusterName: string,
  jobId: string,
  ...
  const result = await _cloudHsmClusterBackupStatusGetSend(
    context,
    resourceGroupName,
    cloudHsmClusterName,
    jobId,
  ...
  return _cloudHsmClusterBackupStatusGetDeserialize(result);
}
...
export async function _backupDeserialize(result: PathUncheckedResponse): Promise<void> {
  const expectedStatuses = ["202", "200"];
  if (!expectedStatuses.includes(result.status)) {
    const error = createRestError(result);
    error.details = errorResponseDeserializer(result.body);
...
export function backup(
  ...
  return getLongRunningPoller(context, _backupDeserialize, ["202", "200"], {
    ...
    abortSignal: options?.abortSignal,
    getInitialResponse: () =>
      _backupSend(context, resourceGroupName, cloudHsmClusterName, body, options),
    resourceLocationConfig: "azure-async-operation",
  }) as PollerLike<OperationState<void>, void>;
}
...
export function validateBackupProperties(
  ...
  return getLongRunningPoller(context, _validateBackupPropertiesDeserialize, ["202", "200"], {
    ...
    abortSignal: options?.abortSignal,
    getInitialResponse: () =>
      _validateBackupPropertiesSend(context, resourceGroupName, cloudHsmClusterName, body, options),
    resourceLocationConfig: "azure-async-operation",
  }) as PollerLike<OperationState<void>, void>;
}
