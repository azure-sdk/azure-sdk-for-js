# Azure SchemaRegistry REST client library for JavaScript
...
- [API reference documentation](https://learn.microsoft.com/javascript/api/@azure/schema-registry?view=azure-node-preview)
...
Install the Azure SchemaRegistry REST client REST client library for JavaScript with `npm`:
