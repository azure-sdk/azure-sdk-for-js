...
import {
  ...
  _getConnectedClustersOperations,
} from "./classic/connectedClusters/index.js";
...
export class KubernetesClient {
  ...
  constructor(
    ...
    this.connectedClusters = _getConnectedClustersOperations(this._client);
    this.operations = _getOperationsOperations(this._client);
  }

  /** The operation groups for connectedClusters */
  public readonly connectedClusters: ConnectedClustersOperations;
