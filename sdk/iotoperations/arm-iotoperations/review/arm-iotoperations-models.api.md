...
// @public
export type DiagnosticsRemoteSupportAccessLevels = string;

// @public
export type DiagnosticsRemoteSupportActivationState = string;

// @public
export interface DiagnosticsRemoteSupportProperties {
...
// @public
export enum KnownDiagnosticsRemoteSupportAccessLevels {
    Diagnose = "Diagnose",
    DiagnoseAndRepair = "DiagnoseAndRepair"
}

// @public
export enum KnownDiagnosticsRemoteSupportActivationState {
    Disabled = "Disabled",
    Enabled = "Enabled"
}
