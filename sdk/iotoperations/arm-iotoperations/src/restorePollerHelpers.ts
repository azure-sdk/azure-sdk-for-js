...
import {
  _$deleteDeserialize as _$deleteDeserializeDiagnostic,
  _createOrUpdateDeserialize as _createOrUpdateDeserializeDiagnostic,
...
const deserializeMap: Record<string, DeserializationHelper> = {
  ...
  "DELETE /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.IoTOperations/instances/{instanceName}/diagnostics/{diagnosticName}":
    {
      deserializer: _$deleteDeserializeDiagnostic,
      expectedStatuses: ["202", "204", "200"],
    },
  "PUT /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.IoTOperations/instances/{instanceName}/diagnostics/{diagnosticName}":
    {
      deserializer: _createOrUpdateDeserializeDiagnostic,
      expectedStatuses: ["200", "201"],
    },
