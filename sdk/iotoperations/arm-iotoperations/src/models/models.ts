...
export function brokerPersistenceSerializer(item: BrokerPersistence): any {
  return {
    dynamicSettings: !item["dynamicSettings"]
      ? item["dynamicSettings"]
      : brokerPersistenceDynamicSettingsSerializer(item["dynamicSettings"]),
    maxSize: item["maxSize"],
    persistentVolumeClaimSpec: !item["persistentVolumeClaimSpec"]
      ? item["persistentVolumeClaimSpec"]
      : volumeClaimSpecSerializer(item["persistentVolumeClaimSpec"]),
...
export function brokerPersistenceDeserializer(item: any): BrokerPersistence {
  return {
    dynamicSettings: !item["dynamicSettings"]
      ? item["dynamicSettings"]
      : brokerPersistenceDynamicSettingsDeserializer(item["dynamicSettings"]),
    maxSize: item["maxSize"],
    persistentVolumeClaimSpec: !item["persistentVolumeClaimSpec"]
      ? item["persistentVolumeClaimSpec"]
      : volumeClaimSpecDeserializer(item["persistentVolumeClaimSpec"]),
...
export function brokerPersistenceDynamicSettingsSerializer(
  item: BrokerPersistenceDynamicSettings,
): any {
  return {
    userPropertyKey: item["userPropertyKey"],
    userPropertyValue: item["userPropertyValue"],
  };
}

export function brokerPersistenceDynamicSettingsDeserializer(
  item: any,
...
/**
 * DataflowEndpoint Host Type properties \
 * {@link KnownDataflowEnpointHostType} can be used interchangeably with DataflowEnpointHostType,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **FabricRT**: Fabric Real-Time Type \
 * **EventGrid**: EventGrid Type \
 * **LocalMq**: Local MQTT Type \
 * **Eventhub**: EventHub Type \
 * **CustomMq**: Custom MQTT Type \
...
export function dataflowEndpointOpenTelemetrySerializer(item: DataflowEndpointOpenTelemetry): any {
  return {
    metricIntervalSec: item["metricIntervalSec"],
    host: item["host"],
    batching: !item["batching"]
      ? item["batching"]
      : batchingConfigurationSerializer(item["batching"]),
...
export function dataflowGraphNodeUnionSerializer(item: DataflowGraphNodeUnion): any {
  switch (item.type) {
    ...
    case "Destination":
      return datafloGraphDestinationNodeSerializer(item as DatafloGraphDestinationNode);
...
export function dataflowGraphNodeUnionDeserializer(item: any): DataflowGraphNodeUnion {
  switch (item.type) {
    ...
    case "Destination":
      return datafloGraphDestinationNodeDeserializer(item as DatafloGraphDestinationNode);
...
export function datafloGraphDestinationNodeSerializer(item: DatafloGraphDestinationNode): any {
  return {
    name: item["name"],
    type: item["type"],
...
export function datafloGraphDestinationNodeDeserializer(item: any): DatafloGraphDestinationNode {
  return {
    name: item["name"],
    type: item["type"],
...
export function dataflowGraphDestinationNodeSettingsSerializer(
  ...
  return {
    ...
    outputSchemaSettings: !item["outputSchemaSettings"]
      ...
      : dataflowGraphSchemaSettingsSerializer(item["outputSchemaSettings"]),
  };
}
...
export function dataflowGraphDestinationNodeSettingsDeserializer(
  ...
  return {
    ...
    outputSchemaSettings: !item["outputSchemaSettings"]
      ? item["outputSchemaSettings"]
      : dataflowGraphSchemaSettingsDeserializer(item["outputSchemaSettings"]),
  };
}
...
export function dataflowGraphSchemaSettingsSerializer(item: DataflowGraphSchemaSettings): any {
  return {
    serializationFormat: item["serializationFormat"],
    schemaRef: item["schemaRef"],
  };
...
export function dataflowGraphSchemaSettingsDeserializer(item: any): DataflowGraphSchemaSettings {
  return {
    serializationFormat: item["serializationFormat"],
    schemaRef: item["schemaRef"],
  };
...
/**
 * Serialization format for dataflow graph. \
 * {@link KnownDataflowGraphSerializationFormat} can be used interchangeably with DataflowGraphSerializationFormat,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Delta**: Delta Format \
 * **Json**: JSON Format \
...
export function dataflowGraphConnectionInputSerializer(item: DataflowGraphConnectionInput): any {
  return {
    ...
    schema: !item["schema"]
      ? item["schema"]
      : dataflowGraphSchemaSettingsSerializer(item["schema"]),
  };
}
...
export function dataflowGraphConnectionInputDeserializer(item: any): DataflowGraphConnectionInput {
  return {
    ...
    schema: !item["schema"]
      ? item["schema"]
      : dataflowGraphSchemaSettingsDeserializer(item["schema"]),
  };
}
...
export function diagnosticPropertiesSerializer(item: DiagnosticProperties): any {
  return {
    remoteSupport: !item["remoteSupport"]
      ? item["remoteSupport"]
      : diagnosticsRemoteSupportPropertiesSerializer(item["remoteSupport"]),
  };
}
...
export function diagnosticPropertiesDeserializer(item: any): DiagnosticProperties {
  return {
    remoteSupport: !item["remoteSupport"]
      ? item["remoteSupport"]
      : diagnosticsRemoteSupportPropertiesDeserializer(item["remoteSupport"]),
    provisioningState: item["provisioningState"],
  };
}
...
export function diagnosticsRemoteSupportPropertiesSerializer(
  item: DiagnosticsRemoteSupportProperties,
): any {
  return {
    state: item["state"],
...
export function diagnosticsRemoteSupportPropertiesDeserializer(
  item: any,
...
/**
 * Represents the activation state of Diagnostic. \
 * {@link KnownDiagnosticsRemoteSupportActivationState} can be used interchangeably with DiagnosticsRemoteSupportActivationState,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Enabled**: Enabled is equivalent to True \
 * **Disabled**: Disabled is equivalent to False.
...
/**
 * DiagnosticAccessLevels allowed \
 * {@link KnownDiagnosticsRemoteSupportAccessLevels} can be used interchangeably with DiagnosticsRemoteSupportAccessLevels,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
...
export interface _DiagnosticResourceListResult {
...
export function _diagnosticResourceListResultDeserializer(
  item: any,
): _DiagnosticResourceListResult {
  return {
    value: diagnosticResourceArrayDeserializer(item["value"]),
    nextLink: item["nextLink"],
  };
}
...
export interface AkriConnectorTemplateRuntimeConfiguration {
  ...
  /** The discriminator possible values: HelmConfiguration, ManagedConfiguration */
...
export function akriConnectorTemplateRuntimeConfigurationUnionSerializer(
  ...
  switch (item.runtimeConfigurationType) {
    case "HelmConfiguration":
      return akriConnectorTemplateHelmConfigurationSerializer(
        item as AkriConnectorTemplateHelmConfiguration,
      );
...
export function akriConnectorTemplateRuntimeConfigurationUnionDeserializer(
  ...
  switch (item.runtimeConfigurationType) {
    case "HelmConfiguration":
      return akriConnectorTemplateHelmConfigurationDeserializer(
        item as AkriConnectorTemplateHelmConfiguration,
      );
 ...
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **HelmConfiguration**: Helm Configuration Type. \
...
export interface AkriConnectorTemplateHelmConfiguration
...
export function akriConnectorTemplateHelmConfigurationSerializer(
  item: AkriConnectorTemplateHelmConfiguration,
): any {
  return {
    runtimeConfigurationType: item["runtimeConfigurationType"],
    helmConfigurationSettings: akriConnectorTemplateHelmConfigurationSettingsSerializer(
      item["helmConfigurationSettings"],
    ),
  };
}

export function akriConnectorTemplateHelmConfigurationDeserializer(
  item: any,
): AkriConnectorTemplateHelmConfiguration {
  return {
    runtimeConfigurationType: item["runtimeConfigurationType"],
    helmConfigurationSettings: akriConnectorTemplateHelmConfigurationSettingsDeserializer(
      item["helmConfigurationSettings"],
    ),
  };
}
...
export function akriConnectorTemplateHelmConfigurationSettingsSerializer(
  item: AkriConnectorTemplateHelmConfigurationSettings,
): any {
  return {
    registrySettings: !item["registrySettings"]
      ? item["registrySettings"]
      : akriConnectorTemplateHelmRegistrySettingsUnionSerializer(item["registrySettings"]),
    releaseName: item["releaseName"],
    version: item["version"],
    advancedConfiguration: !item["advancedConfiguration"]
      ? item["advancedConfiguration"]
      : akriConnectorTemplateHelmAdvancedConfigurationSerializer(item["advancedConfiguration"]),
    values: item["values"],
  };
}

export function akriConnectorTemplateHelmConfigurationSettingsDeserializer(
  item: any,
): AkriConnectorTemplateHelmConfigurationSettings {
  return {
    registrySettings: !item["registrySettings"]
      ? item["registrySettings"]
      : akriConnectorTemplateHelmRegistrySettingsUnionDeserializer(item["registrySettings"]),
    releaseName: item["releaseName"],
    version: item["version"],
    advancedConfiguration: !item["advancedConfiguration"]
      ? item["advancedConfiguration"]
      : akriConnectorTemplateHelmAdvancedConfigurationDeserializer(item["advancedConfiguration"]),
    values: item["values"],
  };
}
...
export function akriConnectorTemplateHelmRegistrySettingsSerializer(
  item: AkriConnectorTemplateHelmRegistrySettings,
): any {
  return { registrySettingsType: item["registrySettingsType"] };
}

export function akriConnectorTemplateHelmRegistrySettingsDeserializer(
  item: any,
...
/** Alias for AkriConnectorTemplateHelmRegistrySettingsUnion */
export type AkriConnectorTemplateHelmRegistrySettingsUnion =
  | AkriConnectorTemplateHelmRegistryEndpointRef
  | AkriConnectorTemplateHelmContainerRegistry
  | AkriConnectorTemplateHelmRegistrySettings;

export function akriConnectorTemplateHelmRegistrySettingsUnionSerializer(
  item: AkriConnectorTemplateHelmRegistrySettingsUnion,
): any {
  switch (item.registrySettingsType) {
    case "RegistryEndpointRef":
      return akriConnectorTemplateHelmRegistryEndpointRefSerializer(
        item as AkriConnectorTemplateHelmRegistryEndpointRef,
      );

    case "ContainerRegistry":
      return akriConnectorTemplateHelmContainerRegistrySerializer(
        item as AkriConnectorTemplateHelmContainerRegistry,
      );

    default:
      return akriConnectorTemplateHelmRegistrySettingsSerializer(item);
  }
}

export function akriConnectorTemplateHelmRegistrySettingsUnionDeserializer(
  item: any,
): AkriConnectorTemplateHelmRegistrySettingsUnion {
  switch (item.registrySettingsType) {
    case "RegistryEndpointRef":
      return akriConnectorTemplateHelmRegistryEndpointRefDeserializer(
        item as AkriConnectorTemplateHelmRegistryEndpointRef,
      );

    case "ContainerRegistry":
      return akriConnectorTemplateHelmContainerRegistryDeserializer(
        item as AkriConnectorTemplateHelmContainerRegistry,
      );

    default:
      return akriConnectorTemplateHelmRegistrySettingsDeserializer(item);
  }
}
...
/**
 * AkriConnectorTemplateHelmRegistrySettingsType values. \
 * {@link KnownAkriConnectorTemplateHelmRegistrySettingsType} can be used interchangeably with AkriConnectorTemplateHelmRegistrySettingsType,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
...
export interface AkriConnectorTemplateHelmRegistryEndpointRef
...
export function akriConnectorTemplateHelmRegistryEndpointRefSerializer(
  item: AkriConnectorTemplateHelmRegistryEndpointRef,
): any {
  return {
    registrySettingsType: item["registrySettingsType"],
    registryEndpointRef: item["registryEndpointRef"],
...
export function akriConnectorTemplateHelmRegistryEndpointRefDeserializer(
  item: any,
): AkriConnectorTemplateHelmRegistryEndpointRef {
  return {
    registrySettingsType: item["registrySettingsType"],
...
export interface AkriConnectorTemplateHelmContainerRegistry
  extends AkriConnectorTemplateHelmRegistrySettings {
...
export function akriConnectorTemplateHelmContainerRegistrySerializer(
  item: AkriConnectorTemplateHelmContainerRegistry,
): any {
  return {
    registrySettingsType: item["registrySettingsType"],
    containerRegistrySettings: akriConnectorTemplateHelmContainerRegistrySettingsSerializer(
      item["containerRegistrySettings"],
    ),
  };
}

export function akriConnectorTemplateHelmContainerRegistryDeserializer(
  item: any,
): AkriConnectorTemplateHelmContainerRegistry {
  return {
    registrySettingsType: item["registrySettingsType"],
    containerRegistrySettings: akriConnectorTemplateHelmContainerRegistrySettingsDeserializer(
      item["containerRegistrySettings"],
    ),
  };
}
...
export interface AkriConnectorTemplateHelmContainerRegistrySettings {
  ...
  registry: string;
  /** The repository to use for the Helm chart. */
  repository: string;
...
export function akriConnectorTemplateHelmContainerRegistrySettingsSerializer(
  item: AkriConnectorTemplateHelmContainerRegistrySettings,
): any {
  return {
    registry: item["registry"],
    repository: item["repository"],
    authSecretRef: !item["authSecretRef"]
      ? item["authSecretRef"]
      : akriConnectorTemplateHelmAuthSecretRefSerializer(item["authSecretRef"]),
  };
}

export function akriConnectorTemplateHelmContainerRegistrySettingsDeserializer(
  item: any,
  ...
  return {
    ...
    authSecretRef: !item["authSecretRef"]
      ? item["authSecretRef"]
      : akriConnectorTemplateHelmAuthSecretRefDeserializer(item["authSecretRef"]),
  };
}
...
export function akriConnectorTemplateHelmAuthSecretRefSerializer(
  item: AkriConnectorTemplateHelmAuthSecretRef,
): any {
  return {
    secretRef: item["secretRef"],
...
export function akriConnectorTemplateHelmAuthSecretRefDeserializer(
  item: any,
...
export function akriConnectorTemplateHelmAdvancedConfigurationSerializer(
  item: AkriConnectorTemplateHelmAdvancedConfiguration,
): any {
  return {
    delete: !item["delete"]
      ? item["delete"]
      : akriConnectorTemplateHelmDeleteConfigurationSerializer(item["delete"]),
    install: !item["install"]
      ? item["install"]
      : akriConnectorTemplateHelmInstallConfigurationSerializer(item["install"]),
    upgrade: !item["upgrade"]
      ? item["upgrade"]
      : akriConnectorTemplateHelmUpgradeConfigurationSerializer(item["upgrade"]),
  };
}

export function akriConnectorTemplateHelmAdvancedConfigurationDeserializer(
  item: any,
): AkriConnectorTemplateHelmAdvancedConfiguration {
  return {
    delete: !item["delete"]
      ? item["delete"]
      : akriConnectorTemplateHelmDeleteConfigurationDeserializer(item["delete"]),
    install: !item["install"]
      ? item["install"]
      : akriConnectorTemplateHelmInstallConfigurationDeserializer(item["install"]),
    upgrade: !item["upgrade"]
      ? item["upgrade"]
      : akriConnectorTemplateHelmUpgradeConfigurationDeserializer(item["upgrade"]),
  };
}
...
export function akriConnectorTemplateHelmDeleteConfigurationSerializer(
  item: AkriConnectorTemplateHelmDeleteConfiguration,
): any {
  return {
    timeout: item["timeout"],
    waitForJobs: item["waitForJobs"],
    atomic: item["atomic"],
    disableHooks: item["disableHooks"],
    wait: item["wait"],
  };
}

export function akriConnectorTemplateHelmDeleteConfigurationDeserializer(
  item: any,
...
export function akriConnectorTemplateHelmInstallConfigurationSerializer(
  item: AkriConnectorTemplateHelmInstallConfiguration,
): any {
  return {
    timeout: item["timeout"],
    waitForJobs: item["waitForJobs"],
...
export function akriConnectorTemplateHelmInstallConfigurationDeserializer(
  item: any,
...
export function akriConnectorTemplateHelmUpgradeConfigurationSerializer(
  item: AkriConnectorTemplateHelmUpgradeConfiguration,
): any {
  return {
    timeout: item["timeout"],
    waitForJobs: item["waitForJobs"],
...
export function akriConnectorTemplateHelmUpgradeConfigurationDeserializer(
  item: any,
...
export function akriConnectorTemplateDeviceInboundEndpointTypeSerializer(
  ...
  return {
    endpointType: item["endpointType"],
    version: item["version"],
    configurationSchemaRefs: !item["configurationSchemaRefs"]
      ? item["configurationSchemaRefs"]
      : akriConnectorTemplateDeviceInboundEndpointConfigurationSchemaRefsSerializer(
          item["configurationSchemaRefs"],
        ),
  };
}
...
export function akriConnectorTemplateDeviceInboundEndpointTypeDeserializer(
  ...
  return {
    ...
    configurationSchemaRefs: !item["configurationSchemaRefs"]
      ? item["configurationSchemaRefs"]
      : akriConnectorTemplateDeviceInboundEndpointConfigurationSchemaRefsDeserializer(
          item["configurationSchemaRefs"],
        ),
  };
}
...
export function akriConnectorTemplateDeviceInboundEndpointConfigurationSchemaRefsSerializer(
  item: AkriConnectorTemplateDeviceInboundEndpointConfigurationSchemaRefs,
): any {
  return {
    defaultDatasetConfigSchemaRef: item["defaultDatasetConfigSchemaRef"],
    defaultEventsConfigSchemaRef: item["defaultEventsConfigSchemaRef"],
    defaultProcessControlConfigSchemaRef: item["defaultProcessControlConfigSchemaRef"],
    defaultStreamsConfigSchemaRef: item["defaultStreamsConfigSchemaRef"],
    additionalConfigSchemaRef: item["additionalConfigSchemaRef"],
  };
}

export function akriConnectorTemplateDeviceInboundEndpointConfigurationSchemaRefsDeserializer(
  item: any,
...
export function akriDiscoveryHandlerResourceSerializer(item: AkriDiscoveryHandlerResource): any {
  return {
    properties: !item["properties"]
      ? item["properties"]
      : akriDiscoveryHandlerPropertiesSerializer(item["properties"]),
    extendedLocation: extendedLocationSerializer(item["extendedLocation"]),
  };
}

export function akriDiscoveryHandlerResourceDeserializer(item: any): AkriDiscoveryHandlerResource {
  return {
    id: item["id"],
    name: item["name"],
    type: item["type"],
    ...
    properties: !item["properties"]
      ? item["properties"]
      : akriDiscoveryHandlerPropertiesDeserializer(item["properties"]),
    extendedLocation: extendedLocationDeserializer(item["extendedLocation"]),
  };
}
...
export function akriDiscoveryHandlerPropertiesSerializer(
  item: AkriDiscoveryHandlerProperties,
): any {
  return {
    aioMetadata: !item["aioMetadata"]
      ? item["aioMetadata"]
      : akriDiscoveryHandlerAioMetadataSerializer(item["aioMetadata"]),
    additionalConfiguration: item["additionalConfiguration"],
    diagnostics: !item["diagnostics"]
      ? item["diagnostics"]
      : akriDiscoveryHandlerDiagnosticsSerializer(item["diagnostics"]),
    mode: item["mode"],
    discoverableDeviceEndpointTypes:
      akriDiscoveryHandlerDiscoverableDeviceEndpointTypeArraySerializer(
        item["discoverableDeviceEndpointTypes"],
      ),
    mqttConnectionConfiguration: !item["mqttConnectionConfiguration"]
      ? item["mqttConnectionConfiguration"]
      : akriConnectorsMqttConnectionConfigurationSerializer(item["mqttConnectionConfiguration"]),
    imageConfiguration: akriDiscoveryHandlerImageConfigurationSerializer(
      item["imageConfiguration"],
    ),
    schedule: akriDiscoveryHandlerScheduleUnionSerializer(item["schedule"]),
    secrets: !item["secrets"]
      ? item["secrets"]
      : akriConnectorsSecretArraySerializer(item["secrets"]),
  };
...
export function akriDiscoveryHandlerPropertiesDeserializer(
  item: any,
  ...
  return {
    ...
    aioMetadata: !item["aioMetadata"]
      ? item["aioMetadata"]
      : akriDiscoveryHandlerAioMetadataDeserializer(item["aioMetadata"]),
    additionalConfiguration: item["additionalConfiguration"],
    diagnostics: !item["diagnostics"]
      ? item["diagnostics"]
      : akriDiscoveryHandlerDiagnosticsDeserializer(item["diagnostics"]),
    mode: item["mode"],
    discoverableDeviceEndpointTypes:
      akriDiscoveryHandlerDiscoverableDeviceEndpointTypeArrayDeserializer(
        item["discoverableDeviceEndpointTypes"],
      ),
    mqttConnectionConfiguration: !item["mqttConnectionConfiguration"]
      ? item["mqttConnectionConfiguration"]
      : akriConnectorsMqttConnectionConfigurationDeserializer(item["mqttConnectionConfiguration"]),
    imageConfiguration: akriDiscoveryHandlerImageConfigurationDeserializer(
      item["imageConfiguration"],
    ),
    schedule: akriDiscoveryHandlerScheduleUnionDeserializer(item["schedule"]),
    secrets: !item["secrets"]
      ? item["secrets"]
      : akriConnectorsSecretArrayDeserializer(item["secrets"]),
  };
...
export function akriDiscoveryHandlerAioMetadataSerializer(
  item: AkriDiscoveryHandlerAioMetadata,
): any {
  return {
    aioMinVersion: item["aioMinVersion"],
    aioMaxVersion: item["aioMaxVersion"],
...
export function akriDiscoveryHandlerAioMetadataDeserializer(
  item: any,
...
export function akriDiscoveryHandlerDiagnosticsSerializer(
  item: AkriDiscoveryHandlerDiagnostics,
): any {
  return { logs: akriConnectorsDiagnosticsLogsSerializer(item["logs"]) };
}

export function akriDiscoveryHandlerDiagnosticsDeserializer(
  item: any,
...
export function akriDiscoveryHandlerDiscoverableDeviceEndpointTypeArraySerializer(
  result: Array<AkriDiscoveryHandlerDiscoverableDeviceEndpointType>,
): any[] {
  return result.map((item) => {
    return akriDiscoveryHandlerDiscoverableDeviceEndpointTypeSerializer(item);
  });
}

export function akriDiscoveryHandlerDiscoverableDeviceEndpointTypeArrayDeserializer(
  result: Array<AkriDiscoveryHandlerDiscoverableDeviceEndpointType>,
): any[] {
  return result.map((item) => {
    return akriDiscoveryHandlerDiscoverableDeviceEndpointTypeDeserializer(item);
  });
}
...
export function akriDiscoveryHandlerDiscoverableDeviceEndpointTypeSerializer(
  item: AkriDiscoveryHandlerDiscoverableDeviceEndpointType,
): any {
  return { endpointType: item["endpointType"], version: item["version"] };
}

export function akriDiscoveryHandlerDiscoverableDeviceEndpointTypeDeserializer(
  item: any,
...
export function akriDiscoveryHandlerImageConfigurationSerializer(
  item: AkriDiscoveryHandlerImageConfiguration,
): any {
  return {
    imageName: item["imageName"],
    imagePullPolicy: item["imagePullPolicy"],
...
export function akriDiscoveryHandlerImageConfigurationDeserializer(
  item: any,
...
export interface AkriDiscoveryHandlerSchedule {
  /** Schedule type. */
  /** The discriminator possible values: Cron, RunOnce, Continuous */
  scheduleType: AkriDiscoveryHandlerScheduleType;
}

export function akriDiscoveryHandlerScheduleSerializer(item: AkriDiscoveryHandlerSchedule): any {
  return { scheduleType: item["scheduleType"] };
}

export function akriDiscoveryHandlerScheduleDeserializer(item: any): AkriDiscoveryHandlerSchedule {
  return {
    scheduleType: item["scheduleType"],
  };
}

/** Alias for AkriDiscoveryHandlerScheduleUnion */
export type AkriDiscoveryHandlerScheduleUnion =
...
export function akriDiscoveryHandlerScheduleUnionSerializer(
  item: AkriDiscoveryHandlerScheduleUnion,
): any {
  switch (item.scheduleType) {
    case "Cron":
      return akriDiscoveryHandlerScheduleCronSerializer(item as AkriDiscoveryHandlerScheduleCron);

    case "RunOnce":
      return akriDiscoveryHandlerScheduleRunOnceSerializer(
        item as AkriDiscoveryHandlerScheduleRunOnce,
      );

    case "Continuous":
      return akriDiscoveryHandlerScheduleContinuousSerializer(
        item as AkriDiscoveryHandlerScheduleContinuous,
      );

    default:
      return akriDiscoveryHandlerScheduleSerializer(item);
  }
}

export function akriDiscoveryHandlerScheduleUnionDeserializer(
  item: any,
): AkriDiscoveryHandlerScheduleUnion {
  switch (item.scheduleType) {
    case "Cron":
      return akriDiscoveryHandlerScheduleCronDeserializer(item as AkriDiscoveryHandlerScheduleCron);

    case "RunOnce":
      return akriDiscoveryHandlerScheduleRunOnceDeserializer(
        item as AkriDiscoveryHandlerScheduleRunOnce,
      );

    case "Continuous":
      return akriDiscoveryHandlerScheduleContinuousDeserializer(
        item as AkriDiscoveryHandlerScheduleContinuous,
      );

    default:
      return akriDiscoveryHandlerScheduleDeserializer(item);
  }
}
...
/**
 * AkriDiscoveryHandlerScheduleType properties. \
 * {@link KnownAkriDiscoveryHandlerScheduleType} can be used interchangeably with AkriDiscoveryHandlerScheduleType,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Cron**: The schedule is a cron expression. \
 * **RunOnce**: The discovery handler should run once. \
 * **Continuous**: The discovery handler should run continuously.
 */
...
export function akriDiscoveryHandlerScheduleCronSerializer(
  item: AkriDiscoveryHandlerScheduleCron,
): any {
  return { scheduleType: item["scheduleType"], cron: item["cron"] };
}

export function akriDiscoveryHandlerScheduleCronDeserializer(
  item: any,
): AkriDiscoveryHandlerScheduleCron {
  return {
    scheduleType: item["scheduleType"],
...
export function akriDiscoveryHandlerScheduleRunOnceSerializer(
  item: AkriDiscoveryHandlerScheduleRunOnce,
): any {
  return { scheduleType: item["scheduleType"], runOnce: item["runOnce"] };
}

export function akriDiscoveryHandlerScheduleRunOnceDeserializer(
  item: any,
): AkriDiscoveryHandlerScheduleRunOnce {
  return {
    scheduleType: item["scheduleType"],
    runOnce: item["runOnce"],
  };
}
...
export function akriDiscoveryHandlerScheduleContinuousSerializer(
  item: AkriDiscoveryHandlerScheduleContinuous,
): any {
  return { scheduleType: item["scheduleType"], continuous: item["continuous"] };
}

export function akriDiscoveryHandlerScheduleContinuousDeserializer(
  item: any,
): AkriDiscoveryHandlerScheduleContinuous {
  return {
    scheduleType: item["scheduleType"],
...
export interface _AkriDiscoveryHandlerResourceListResult {
...
export function _akriDiscoveryHandlerResourceListResultDeserializer(
  item: any,
): _AkriDiscoveryHandlerResourceListResult {
  return {
    value: akriDiscoveryHandlerResourceArrayDeserializer(item["value"]),
    nextLink: item["nextLink"],
  };
}

export function akriDiscoveryHandlerResourceArraySerializer(
  result: Array<AkriDiscoveryHandlerResource>,
): any[] {
  return result.map((item) => {
    return akriDiscoveryHandlerResourceSerializer(item);
  });
}

export function akriDiscoveryHandlerResourceArrayDeserializer(
  result: Array<AkriDiscoveryHandlerResource>,
): any[] {
  return result.map((item) => {
    return akriDiscoveryHandlerResourceDeserializer(item);
  });
}
