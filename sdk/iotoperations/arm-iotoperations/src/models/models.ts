...
export function instancePropertiesSerializer(item: InstanceProperties): any {
  return {
    ...
    features: !item["features"]
      ? item["features"]
      : instanceFeatureArraySerializer(item["features"]),
  };
}
...
export function instancePropertiesDeserializer(item: any): InstanceProperties {
  return {
    ...
    features: !item["features"]
      ? item["features"]
      : instanceFeatureArrayDeserializer(item["features"]),
  };
}
...
export function instanceFeatureArraySerializer(result: Array<InstanceFeature>): any[] {
  return result.map((item) => {
    return instanceFeatureSerializer(item);
  });
}

export function instanceFeatureArrayDeserializer(result: Array<InstanceFeature>): any[] {
  return result.map((item) => {
    return instanceFeatureDeserializer(item);
  });
}
