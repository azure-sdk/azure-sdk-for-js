...
export function dataflowEndpointResourceSerializer(
  ...
  return {
    properties: !item["properties"]
      ? item["properties"]
      : dataflowEndpointPropertiesUnionSerializer(item["properties"]),
...
export function dataflowEndpointResourceDeserializer(
  ...
  return {
    ...
    properties: !item["properties"]
      ? item["properties"]
      : dataflowEndpointPropertiesUnionDeserializer(item["properties"]),
...
export interface DataflowEndpointProperties {
  /** Endpoint Type. */
  /** The discriminator possible values: DataExplorer, DataLakeStorage, FabricOneLake, Kafka, LocalStorage, Mqtt */
...
/** Alias for DataflowEndpointPropertiesUnion */
export type DataflowEndpointPropertiesUnion =
...
export function dataflowEndpointPropertiesUnionSerializer(
  item: DataflowEndpointPropertiesUnion,
): any {
  switch (item.endpointType) {
    case "DataExplorer":
      return dataExplorerEndpointSerializer(item as DataExplorerEndpoint);

    case "DataLakeStorage":
      return dataLakeStorageEndpointSerializer(item as DataLakeStorageEndpoint);

    case "FabricOneLake":
      return fabricOneLakeEndpointSerializer(item as FabricOneLakeEndpoint);

    case "Kafka":
      return kafkaEndpointSerializer(item as KafkaEndpoint);

    case "LocalStorage":
      return localStorageEndpointSerializer(item as LocalStorageEndpoint);

    case "Mqtt":
      return mqttEndpointSerializer(item as MqttEndpoint);

    default:
      return dataflowEndpointPropertiesSerializer(item);
  }
}

export function dataflowEndpointPropertiesUnionDeserializer(
  item: any,
): DataflowEndpointPropertiesUnion {
  switch (item.endpointType) {
    case "DataExplorer":
      return dataExplorerEndpointDeserializer(item as DataExplorerEndpoint);

    case "DataLakeStorage":
      return dataLakeStorageEndpointDeserializer(
        item as DataLakeStorageEndpoint,
      );

    case "FabricOneLake":
      return fabricOneLakeEndpointDeserializer(item as FabricOneLakeEndpoint);

    case "Kafka":
      return kafkaEndpointDeserializer(item as KafkaEndpoint);

    case "LocalStorage":
      return localStorageEndpointDeserializer(item as LocalStorageEndpoint);

    case "Mqtt":
      return mqttEndpointDeserializer(item as MqttEndpoint);

    default:
      return dataflowEndpointPropertiesDeserializer(item);
  }
}
...
export function dataExplorerEndpointSerializer(
  item: DataExplorerEndpoint,
): any {
  return {
    endpointType: item["endpointType"],
    dataExplorerSettings: dataExplorerSettingsSerializer(
      item["dataExplorerSettings"],
    ),
  };
}

export function dataExplorerEndpointDeserializer(
  item: any,
): DataExplorerEndpoint {
  return {
    endpointType: item["endpointType"],
    provisioningState: item["provisioningState"],
    dataExplorerSettings: dataExplorerSettingsDeserializer(
      item["dataExplorerSettings"],
    ),
  };
}
...
export function dataExplorerSettingsSerializer(
  item: DataExplorerSettings,
): any {
  return {
...
export function dataExplorerSettingsDeserializer(
  item: any,
...
export function dataLakeStorageEndpointSerializer(
  item: DataLakeStorageEndpoint,
): any {
  return {
    endpointType: item["endpointType"],
    dataLakeStorageSettings: dataLakeStorageSettingsSerializer(
      item["dataLakeStorageSettings"],
    ),
  };
}

export function dataLakeStorageEndpointDeserializer(
  item: any,
): DataLakeStorageEndpoint {
  return {
    endpointType: item["endpointType"],
    provisioningState: item["provisioningState"],
    dataLakeStorageSettings: dataLakeStorageSettingsDeserializer(
      item["dataLakeStorageSettings"],
    ),
  };
}
...
export function dataLakeStorageSettingsSerializer(
  item: DataLakeStorageSettings,
): any {
  return {
...
export function dataLakeStorageSettingsDeserializer(
  item: any,
...
export function fabricOneLakeEndpointSerializer(
  item: FabricOneLakeEndpoint,
): any {
  return {
    endpointType: item["endpointType"],
    fabricOneLakeSettings: fabricOneLakeSettingsSerializer(
      item["fabricOneLakeSettings"],
    ),
  };
}

export function fabricOneLakeEndpointDeserializer(
  item: any,
): FabricOneLakeEndpoint {
  return {
    endpointType: item["endpointType"],
    provisioningState: item["provisioningState"],
    fabricOneLakeSettings: fabricOneLakeSettingsDeserializer(
      item["fabricOneLakeSettings"],
    ),
  };
}
...
export function fabricOneLakeSettingsSerializer(
  item: FabricOneLakeSettings,
): any {
  return {
...
export function fabricOneLakeSettingsDeserializer(
  item: any,
...
export function kafkaEndpointSerializer(item: KafkaEndpoint): any {
  return {
    endpointType: item["endpointType"],
    kafkaSettings: kafkaSettingsSerializer(item["kafkaSettings"]),
  };
}

export function kafkaEndpointDeserializer(item: any): KafkaEndpoint {
  return {
    endpointType: item["endpointType"],
    provisioningState: item["provisioningState"],
    kafkaSettings: kafkaSettingsDeserializer(item["kafkaSettings"]),
  };
}
...
export function kafkaSettingsSerializer(item: KafkaSettings): any {
  return {
...
export function kafkaSettingsDeserializer(item: any): KafkaSettings {
  return {
...
export function localStorageEndpointSerializer(
  item: LocalStorageEndpoint,
): any {
  return {
    endpointType: item["endpointType"],
    localStorageSettings: localStorageSettingsSerializer(
      item["localStorageSettings"],
    ),
  };
}

export function localStorageEndpointDeserializer(
  item: any,
): LocalStorageEndpoint {
  return {
    endpointType: item["endpointType"],
    provisioningState: item["provisioningState"],
    localStorageSettings: localStorageSettingsDeserializer(
      item["localStorageSettings"],
    ),
  };
}
...
export function localStorageSettingsSerializer(
  item: LocalStorageSettings,
): any {
  return { persistentVolumeClaimRef: item["persistentVolumeClaimRef"] };
}

export function localStorageSettingsDeserializer(
  item: any,
...
export function mqttEndpointSerializer(item: MqttEndpoint): any {
  return {
    endpointType: item["endpointType"],
    mqttSettings: mqttSettingsSerializer(item["mqttSettings"]),
  };
}

export function mqttEndpointDeserializer(item: any): MqttEndpoint {
  return {
    endpointType: item["endpointType"],
    provisioningState: item["provisioningState"],
    mqttSettings: mqttSettingsDeserializer(item["mqttSettings"]),
  };
}
...
export function mqttSettingsSerializer(item: MqttSettings): any {
  return {
...
export function mqttSettingsDeserializer(item: any): MqttSettings {
  return {
...
export function authorizationResourceSerializer(
  item: AuthorizationResource,
): any {
  return {
    properties: !item["properties"]
      ? item["properties"]
      : authorizationPropertiesSerializer(item["properties"]),
    extendedLocation: extendedLocationSerializer(item["extendedLocation"]),
  };
}

export function authorizationResourceDeserializer(
  item: any,
  ...
  return {
    ...
    properties: !item["properties"]
      ? item["properties"]
      : authorizationPropertiesDeserializer(item["properties"]),
    extendedLocation: extendedLocationDeserializer(item["extendedLocation"]),
  };
}
...
export function authorizationPropertiesSerializer(
  item: AuthorizationProperties,
): any {
  return {
...
export function authorizationPropertiesDeserializer(
  item: any,
...
export interface _AuthorizationResourceListResult {
...
export function _authorizationResourceListResultDeserializer(
  item: any,
): _AuthorizationResourceListResult {
  return {
    value: authorizationResourceArrayDeserializer(item["value"]),
    nextLink: item["nextLink"],
  };
}

export function authorizationResourceArraySerializer(
  result: Array<AuthorizationResource>,
): any[] {
  return result.map((item) => {
    return authorizationResourceSerializer(item);
  });
}

export function authorizationResourceArrayDeserializer(
  result: Array<AuthorizationResource>,
): any[] {
  return result.map((item) => {
    return authorizationResourceDeserializer(item);
  });
}
...
export function authenticationResourceSerializer(
  item: AuthenticationResource,
): any {
  return {
    properties: !item["properties"]
      ? item["properties"]
      : authenticationPropertiesSerializer(item["properties"]),
    extendedLocation: extendedLocationSerializer(item["extendedLocation"]),
  };
}

export function authenticationResourceDeserializer(
  item: any,
  ...
  return {
    ...
    properties: !item["properties"]
      ? item["properties"]
      : authenticationPropertiesDeserializer(item["properties"]),
    extendedLocation: extendedLocationDeserializer(item["extendedLocation"]),
  };
}
...
export function authenticationPropertiesSerializer(
  item: AuthenticationProperties,
): any {
  return {
    authenticationMethods: authenticatorMethodsArraySerializer(
      item["authenticationMethods"],
    ),
  };
}

export function authenticationPropertiesDeserializer(
  item: any,
): AuthenticationProperties {
  return {
    authenticationMethods: authenticatorMethodsArrayDeserializer(
      item["authenticationMethods"],
    ),
    provisioningState: item["provisioningState"],
  };
...
export function authenticatorMethodsArraySerializer(
  result: Array<AuthenticatorMethods>,
): any[] {
  return result.map((item) => {
    return authenticatorMethodsSerializer(item);
  });
}

export function authenticatorMethodsArrayDeserializer(
  result: Array<AuthenticatorMethods>,
): any[] {
  return result.map((item) => {
    return authenticatorMethodsDeserializer(item);
  });
}
...
export function authenticatorMethodsSerializer(
  item: AuthenticatorMethods,
): any {
  return {
    method: item["method"],
    customSettings: !item["customSettings"]
      ? item["customSettings"]
      : authenticatorMethodCustomSerializer(item["customSettings"]),
    serviceAccountTokenSettings: !item["serviceAccountTokenSettings"]
      ? item["serviceAccountTokenSettings"]
      : authenticatorMethodSatSerializer(item["serviceAccountTokenSettings"]),
    x509Settings: !item["x509Settings"]
      ? item["x509Settings"]
      : authenticatorMethodX509Serializer(item["x509Settings"]),
  };
}

export function authenticatorMethodsDeserializer(
  item: any,
  ...
  return {
    ...
    customSettings: !item["customSettings"]
      ? item["customSettings"]
      : authenticatorMethodCustomDeserializer(item["customSettings"]),
    serviceAccountTokenSettings: !item["serviceAccountTokenSettings"]
      ? item["serviceAccountTokenSettings"]
      : authenticatorMethodSatDeserializer(item["serviceAccountTokenSettings"]),
    x509Settings: !item["x509Settings"]
      ? item["x509Settings"]
      : authenticatorMethodX509Deserializer(item["x509Settings"]),
  };
}
...
export function authenticatorMethodCustomSerializer(
  item: AuthenticatorMethodCustom,
): any {
  return {
    auth: !item["auth"]
      ? item["auth"]
...
export function authenticatorMethodCustomDeserializer(
  item: any,
...
export function authenticatorMethodSatSerializer(
  item: AuthenticatorMethodSat,
): any {
  return {
...
export function authenticatorMethodSatDeserializer(
  item: any,
...
export function authenticatorMethodX509Serializer(
  item: AuthenticatorMethodX509,
): any {
  return {
...
export function authenticatorMethodX509Deserializer(
  item: any,
...
export interface _AuthenticationResourceListResult {
...
export function _authenticationResourceListResultDeserializer(
  item: any,
): _AuthenticationResourceListResult {
  return {
    value: authenticationResourceArrayDeserializer(item["value"]),
    nextLink: item["nextLink"],
  };
}

export function authenticationResourceArraySerializer(
  result: Array<AuthenticationResource>,
): any[] {
  return result.map((item) => {
    return authenticationResourceSerializer(item);
  });
}

export function authenticationResourceArrayDeserializer(
  result: Array<AuthenticationResource>,
): any[] {
  return result.map((item) => {
    return authenticationResourceDeserializer(item);
  });
}
...
export function listenerResourceSerializer(item: ListenerResource): any {
  return {
    properties: !item["properties"]
      ? item["properties"]
      : listenerPropertiesSerializer(item["properties"]),
    extendedLocation: extendedLocationSerializer(item["extendedLocation"]),
  };
}

export function listenerResourceDeserializer(item: any): ListenerResource {
  return {
    id: item["id"],
    name: item["name"],
    type: item["type"],
    ...
    properties: !item["properties"]
      ? item["properties"]
      : listenerPropertiesDeserializer(item["properties"]),
    extendedLocation: extendedLocationDeserializer(item["extendedLocation"]),
  };
}
...
export function listenerPropertiesSerializer(item: ListenerProperties): any {
  return {
...
export function listenerPropertiesDeserializer(item: any): ListenerProperties {
  return {
    serviceName: item["serviceName"],
...
export interface _ListenerResourceListResult {
...
export function _listenerResourceListResultDeserializer(
  item: any,
): _ListenerResourceListResult {
  return {
    value: listenerResourceArrayDeserializer(item["value"]),
    nextLink: item["nextLink"],
  };
}

export function listenerResourceArraySerializer(
  result: Array<ListenerResource>,
): any[] {
  return result.map((item) => {
    return listenerResourceSerializer(item);
  });
}

export function listenerResourceArrayDeserializer(
  result: Array<ListenerResource>,
): any[] {
  return result.map((item) => {
    return listenerResourceDeserializer(item);
  });
}
