...
export function registryEndpointPropertiesSerializer(item: RegistryEndpointProperties): any {
  return {
    ...
    trustSettings: !item["trustSettings"]
      ? item["trustSettings"]
      : registryEndpointTrustedSettingsSerializer(item["trustSettings"]),
  };
}
...
export function registryEndpointPropertiesDeserializer(item: any): RegistryEndpointProperties {
  return {
    ...
    trustSettings: !item["trustSettings"]
      ? item["trustSettings"]
      : registryEndpointTrustedSettingsDeserializer(item["trustSettings"]),
  };
}
...
export function registryEndpointTrustedSettingsSerializer(
  item: RegistryEndpointTrustedSettings,
): any {
  return {
    trustedSigningKeys: registryEndpointTrustedSigningKeyUnionSerializer(
      item["trustedSigningKeys"],
    ),
  };
}

export function registryEndpointTrustedSettingsDeserializer(
  item: any,
): RegistryEndpointTrustedSettings {
  return {
    trustedSigningKeys: registryEndpointTrustedSigningKeyUnionDeserializer(
      item["trustedSigningKeys"],
    ),
  };
}
