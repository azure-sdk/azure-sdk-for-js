...
import { DiagnosticResource, diagnosticResourceArrayDeserializer } from "./diagnostics/models.js";
...
export function instancePropertiesSerializer(item: InstanceProperties): any {
  return {
    ...
    adrNamespace: item["adrNamespace"],
  };
}
...
export function instancePropertiesDeserializer(item: any): InstanceProperties {
  return {
    ...
    secretProviderClassRef: item["secretProviderClassRef"],
    features: !item["features"]
      ? item["features"]
...
export function persistenceSerializer(item: Persistence): any {
  return {
    dynamicSettings: !item["dynamicSettings"]
      ...
      : dynamicPersistenceSettingsSerializer(item["dynamicSettings"]),
    maxSize: item["maxSize"],
    persistentVolumeClaimSpec: !item["persistentVolumeClaimSpec"]
      ? item["persistentVolumeClaimSpec"]
      : volumeClaimSpecSerializer(item["persistentVolumeClaimSpec"]),
    retain: !item["retain"] ? item["retain"] : topicRetainmentPolicyUnionSerializer(item["retain"]),
    stateStore: !item["stateStore"]
      ? item["stateStore"]
      : stateStoreRetainmentPolicyUnionSerializer(item["stateStore"]),
    subscriberQueue: !item["subscriberQueue"]
      ? item["subscriberQueue"]
      : subscriberQueueRetainmentPolicyUnionSerializer(item["subscriberQueue"]),
  };
}
...
export function persistenceDeserializer(item: any): Persistence {
  return {
    dynamicSettings: !item["dynamicSettings"]
      ? item["dynamicSettings"]
      : dynamicPersistenceSettingsDeserializer(item["dynamicSettings"]),
    maxSize: item["maxSize"],
    persistentVolumeClaimSpec: !item["persistentVolumeClaimSpec"]
      ? item["persistentVolumeClaimSpec"]
      : volumeClaimSpecDeserializer(item["persistentVolumeClaimSpec"]),
    retain: !item["retain"]
      ? item["retain"]
      : topicRetainmentPolicyUnionDeserializer(item["retain"]),
    stateStore: !item["stateStore"]
      ? item["stateStore"]
      : stateStoreRetainmentPolicyUnionDeserializer(item["stateStore"]),
    subscriberQueue: !item["subscriberQueue"]
      ? item["subscriberQueue"]
      : subscriberQueueRetainmentPolicyUnionDeserializer(item["subscriberQueue"]),
  };
}
...
export function dynamicPersistenceSettingsSerializer(item: DynamicPersistenceSettings): any {
  return {
...
export function dynamicPersistenceSettingsDeserializer(item: any): DynamicPersistenceSettings {
  return {
    userPropertyKey: item["userPropertyKey"],
    userPropertyValue: item["userPropertyValue"],
  };
...
export function topicRetainmentPolicySerializer(item: TopicRetainmentPolicy): any {
  return { mode: item["mode"] };
}

export function topicRetainmentPolicyDeserializer(item: any): TopicRetainmentPolicy {
  return {
    mode: item["mode"],
  };
}

/** Alias for TopicRetainmentPolicyUnion */
export type TopicRetainmentPolicyUnion = CustomTopicRetainmentPolicy | TopicRetainmentPolicy;

export function topicRetainmentPolicyUnionSerializer(item: TopicRetainmentPolicyUnion): any {
  switch (item.mode) {
    case "Custom":
      return customTopicRetainmentPolicySerializer(item as CustomTopicRetainmentPolicy);

    default:
      return topicRetainmentPolicySerializer(item);
  }
}

export function topicRetainmentPolicyUnionDeserializer(item: any): TopicRetainmentPolicyUnion {
  switch (item.mode) {
    case "Custom":
      return customTopicRetainmentPolicyDeserializer(item as CustomTopicRetainmentPolicy);

    default:
      return topicRetainmentPolicyDeserializer(item);
  }
}

/** Known values of {@link RetainmentPolicyMode} that the service accepts. */
...
export function customTopicRetainmentPolicySerializer(item: CustomTopicRetainmentPolicy): any {
  return {
    mode: item["mode"],
    retainSettings: !item["retainSettings"]
      ? item["retainSettings"]
      : topicRetainmentSettingsSerializer(item["retainSettings"]),
  };
}

export function customTopicRetainmentPolicyDeserializer(item: any): CustomTopicRetainmentPolicy {
  return {
    mode: item["mode"],
    retainSettings: !item["retainSettings"]
      ? item["retainSettings"]
      : topicRetainmentSettingsDeserializer(item["retainSettings"]),
  };
}
...
export function topicRetainmentSettingsSerializer(item: TopicRetainmentSettings): any {
  return {
    topics: !item["topics"]
      ? item["topics"]
    ...
    dynamic: !item["dynamic"]
      ? item["dynamic"]
      : dynamicRetainmentSettingsSerializer(item["dynamic"]),
  };
}

export function topicRetainmentSettingsDeserializer(item: any): TopicRetainmentSettings {
  return {
    topics: !item["topics"]
      ? item["topics"]
      : item["topics"].map((p: any) => {
    ...
    dynamic: !item["dynamic"]
      ? item["dynamic"]
      : dynamicRetainmentSettingsDeserializer(item["dynamic"]),
  };
}
...
export function dynamicRetainmentSettingsSerializer(item: DynamicRetainmentSettings): any {
  return { mode: item["mode"] };
}

export function dynamicRetainmentSettingsDeserializer(item: any): DynamicRetainmentSettings {
  return {
    mode: item["mode"],
  };
}
...
export function stateStoreRetainmentPolicySerializer(item: StateStoreRetainmentPolicy): any {
  return {
    mode: item["mode"],
    stateStoreSettings: !item["stateStoreSettings"]
      ? item["stateStoreSettings"]
      : stateStoreRetainmentSettingsSerializer(item["stateStoreSettings"]),
  };
}

export function stateStoreRetainmentPolicyDeserializer(item: any): StateStoreRetainmentPolicy {
  return {
    mode: item["mode"],
    stateStoreSettings: !item["stateStoreSettings"]
      ? item["stateStoreSettings"]
      : stateStoreRetainmentSettingsDeserializer(item["stateStoreSettings"]),
  };
}

/** Alias for StateStoreRetainmentPolicyUnion */
export type StateStoreRetainmentPolicyUnion =
  | CustomStateStoreRetainmentPolicy
  | StateStoreRetainmentPolicy;

export function stateStoreRetainmentPolicyUnionSerializer(
  item: StateStoreRetainmentPolicyUnion,
): any {
  switch (item.mode) {
    case "Custom":
      return customStateStoreRetainmentPolicySerializer(item as CustomStateStoreRetainmentPolicy);

    default:
      return stateStoreRetainmentPolicySerializer(item);
  }
}

export function stateStoreRetainmentPolicyUnionDeserializer(
  item: any,
): StateStoreRetainmentPolicyUnion {
  switch (item.mode) {
    case "Custom":
      return customStateStoreRetainmentPolicyDeserializer(item as CustomStateStoreRetainmentPolicy);

    default:
      return stateStoreRetainmentPolicyDeserializer(item);
  }
}
...
export function stateStoreRetainmentSettingsSerializer(item: StateStoreRetainmentSettings): any {
  return {
    stateStoreResources: !item["stateStoreResources"]
      ? item["stateStoreResources"]
      : stateStoreRetainmentResourcesArraySerializer(item["stateStoreResources"]),
    dynamic: !item["dynamic"]
      ? item["dynamic"]
      : dynamicRetainmentSettingsSerializer(item["dynamic"]),
  };
...
export function stateStoreRetainmentSettingsDeserializer(item: any): StateStoreRetainmentSettings {
  return {
    stateStoreResources: !item["stateStoreResources"]
      ? item["stateStoreResources"]
      : stateStoreRetainmentResourcesArrayDeserializer(item["stateStoreResources"]),
    dynamic: !item["dynamic"]
      ? item["dynamic"]
      : dynamicRetainmentSettingsDeserializer(item["dynamic"]),
  };
...
export function stateStoreRetainmentResourcesArraySerializer(
  result: Array<StateStoreRetainmentResources>,
): any[] {
  return result.map((item) => {
    return stateStoreRetainmentResourcesSerializer(item);
  });
}

export function stateStoreRetainmentResourcesArrayDeserializer(
  result: Array<StateStoreRetainmentResources>,
): any[] {
  return result.map((item) => {
    return stateStoreRetainmentResourcesDeserializer(item);
  });
}
...
export function stateStoreRetainmentResourcesSerializer(item: StateStoreRetainmentResources): any {
  return {
...
export function stateStoreRetainmentResourcesDeserializer(
  item: any,
...
export function customStateStoreRetainmentPolicySerializer(
  item: CustomStateStoreRetainmentPolicy,
): any {
  return {
    mode: item["mode"],
    stateStoreSettings: !item["stateStoreSettings"]
...
export function customStateStoreRetainmentPolicyDeserializer(
  item: any,
): CustomStateStoreRetainmentPolicy {
  return {
    mode: item["mode"],
...
export function subscriberQueueRetainmentPolicySerializer(
  item: SubscriberQueueRetainmentPolicy,
): any {
  return {
    mode: item["mode"],
    subscriberQueueSettings: !item["subscriberQueueSettings"]
      ? item["subscriberQueueSettings"]
      : subscriberQueueRetainmentSettingsSerializer(item["subscriberQueueSettings"]),
  };
}

export function subscriberQueueRetainmentPolicyDeserializer(
  item: any,
  ...
  return {
    ...
    subscriberQueueSettings: !item["subscriberQueueSettings"]
      ? item["subscriberQueueSettings"]
      : subscriberQueueRetainmentSettingsDeserializer(item["subscriberQueueSettings"]),
  };
}

/** Alias for SubscriberQueueRetainmentPolicyUnion */
export type SubscriberQueueRetainmentPolicyUnion =
  | CustomSubscriberQueueRetainmentPolicy
  | SubscriberQueueRetainmentPolicy;

export function subscriberQueueRetainmentPolicyUnionSerializer(
  item: SubscriberQueueRetainmentPolicyUnion,
): any {
  switch (item.mode) {
    case "Custom":
      return customSubscriberQueueRetainmentPolicySerializer(
        item as CustomSubscriberQueueRetainmentPolicy,
      );

    default:
      return subscriberQueueRetainmentPolicySerializer(item);
  }
}

export function subscriberQueueRetainmentPolicyUnionDeserializer(
  item: any,
): SubscriberQueueRetainmentPolicyUnion {
  switch (item.mode) {
    case "Custom":
      return customSubscriberQueueRetainmentPolicyDeserializer(
        item as CustomSubscriberQueueRetainmentPolicy,
      );

    default:
      return subscriberQueueRetainmentPolicyDeserializer(item);
  }
}
...
export function subscriberQueueRetainmentSettingsSerializer(
  item: SubscriberQueueRetainmentSettings,
): any {
  return {
...
export function subscriberQueueRetainmentSettingsDeserializer(
  item: any,
...
export function customSubscriberQueueRetainmentPolicySerializer(
  item: CustomSubscriberQueueRetainmentPolicy,
): any {
  return {
    mode: item["mode"],
    subscriberQueueSettings: !item["subscriberQueueSettings"]
...
export function customSubscriberQueueRetainmentPolicyDeserializer(
  item: any,
): CustomSubscriberQueueRetainmentPolicy {
  return {
    mode: item["mode"],
...
export function dataflowEndpointPropertiesSerializer(item: DataflowEndpointProperties): any {
  return {
    ...
    otelSettings: !item["otelSettings"]
      ? item["otelSettings"]
      : dataflowEndpointOtelSerializer(item["otelSettings"]),
  };
}
...
export function dataflowEndpointPropertiesDeserializer(item: any): DataflowEndpointProperties {
  return {
    ...
    otelSettings: !item["otelSettings"]
      ? item["otelSettings"]
      : dataflowEndpointOtelDeserializer(item["otelSettings"]),
    provisioningState: item["provisioningState"],
  };
}
 ...
 * **LocalMq**: LocalMq Type \
 * **FabricRT**: FabricRT Type \
 * **Otel**: OpenTelemetry Type
 */
...
export function dataflowEndpointOtelSerializer(item: DataflowEndpointOtel): any {
  return {
...
export function dataflowEndpointOtelDeserializer(item: any): DataflowEndpointOtel {
  return {
    metricIntervalSec: item["metricIntervalSec"],
    host: item["host"],
    batching: !item["batching"]
