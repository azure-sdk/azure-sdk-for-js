...
export class SubnetServiceAssociationLinkImpl
  ...
  async beginDelete(
    ...
    const lro = new LroImpl(
      sendOperation,
      { resourceGroup, virtualNetworkName, subnetName, options },
      deleteOperationSpec
    );
...
const deleteOperationSpec: coreClient.OperationSpec = {
  path:
    "/subscriptions/{subscriptionId}/resourcegroups/{resourceGroup}/providers/Microsoft.Network/virtualNetworks/{virtualNetworkName}/subnets/{subnetName}/providers/Microsoft.ContainerInstance/serviceAssociationLinks/default",
  httpMethod: "DELETE",
  responses: {
    200: {},
    201: {},
