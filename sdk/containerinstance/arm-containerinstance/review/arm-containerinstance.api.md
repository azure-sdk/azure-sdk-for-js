...
// @public
export type ContainerGroupProvisioningState = string;
...
export interface ContainerGroups {
    ...
    list(options?: ContainerGroupsListOptionalParams): PagedAsyncIterableIterator<ListResultContainerGroup>;
    listByResourceGroup(resourceGroupName: string, options?: ContainerGroupsListByResourceGroupOptionalParams): PagedAsyncIterableIterator<ListResultContainerGroup>;
...
// @public
export enum KnownContainerGroupProvisioningState {
    Accepted = "Accepted",
    Canceled = "Canceled",
    Creating = "Creating",
    Deleting = "Deleting",
...
// @public
export interface ListResultContainerGroup extends Resource, ListResultContainerGroupProperties {
}

// @public
export interface ListResultContainerGroupProperties {
    confidentialComputeProperties?: ConfidentialComputeProperties;
    containers: Container[];
    diagnostics?: ContainerGroupDiagnostics;
    dnsConfig?: DnsConfiguration;
    ...
    osType: OperatingSystemTypes;
    priority?: ContainerGroupPriority;
    readonly provisioningState?: ContainerGroupProvisioningState;
    restartPolicy?: ContainerGroupRestartPolicy;
    secretReferences?: SecretReference[];
    sku?: ContainerGroupSku;
    subnetIds?: ContainerGroupSubnetId[];
