...
export interface OncoPhenotypeResultOutput {
  ...
  result?: OncoPhenotypeInferenceResultOutput;
}

/** The inference results for the Onco Phenotype request. */
export interface OncoPhenotypeInferenceResultOutput {
  /** Results for the patients given in the request. */
  patientResults: Array<OncoPhenotypePatientResultOutput>;
...
export interface OncoPhenotypeInferenceOutput {
   ...
   *
   * Possible values: "tumorSite", "histology", "clinicalStageT", "clinicalStageN", "clinicalStageM", "pathologicStageT", "pathologicStageN", "pathologicStageM", "diagnosisDate"
   */
  type: string;
...
export interface OncoPhenotypeDataOutput {
  ...
  configuration?: OncoPhenotypeModelConfigurationOutput;
}
...
/** Configuration affecting the Onco Phenotype model's inference. */
export interface OncoPhenotypeModelConfigurationOutput {
