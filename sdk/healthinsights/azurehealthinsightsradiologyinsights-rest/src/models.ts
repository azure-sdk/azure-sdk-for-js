...
export interface PresentGuidanceInformation {
  ...
  sizes?: Array<ObservationComponent>[];
...
export type QualityMeasureType =
  | string
  | "mips76"
  | "mips147"
  | "mips195"
...
export type ScoringAndAssessmentCategoryType =
  | string
  | "BIRADS"
...
export type GuidanceRankingType = string | "high" | "low";
/** Alias for QualityMeasureComplianceType */
export type QualityMeasureComplianceType =
  | string
  | "notEligible"
  | "performanceNotMet"
  | "performanceMet"
