...
export interface PresentGuidanceInformationOutput {
  ...
  sizes?: Array<ObservationComponentOutput>[];
...
export type QualityMeasureTypeOutput =
  | string
  | "mips76"
  | "mips147"
  | "mips195"
...
export type ScoringAndAssessmentCategoryTypeOutput =
  | string
  | "BIRADS"
...
export type GuidanceRankingTypeOutput = string | "high" | "low";
/** Alias for QualityMeasureComplianceTypeOutput */
export type QualityMeasureComplianceTypeOutput =
  | string
  | "notEligible"
  | "performanceNotMet"
  | "performanceMet"
