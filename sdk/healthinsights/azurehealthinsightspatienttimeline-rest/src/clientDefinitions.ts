...
export interface Routes {
  /** Resource for '/patient-timeline/jobs/\{id\}' has methods for the following verbs: get */
  (path: "/patient-timeline/jobs/{id}", id: string): GetJob;
  /** Resource for '/patient-timeline/jobs' has methods for the following verbs: post */
