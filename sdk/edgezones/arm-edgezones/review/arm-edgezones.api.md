...
export class MicrosoftEdgeZonesForTesting extends coreClient.ServiceClient {
    // (undocumented)
    $host: string;
    constructor(credentials: coreAuth.TokenCredential, subscriptionId: string, options?: MicrosoftEdgeZonesForTestingOptionalParams);
    // (undocumented)
    apiVersion: string;
    // (undocumented)
...
// @public
export interface MicrosoftEdgeZonesForTestingOptionalParams extends coreClient.ServiceClientOptions {
    $host?: string;
    apiVersion?: string;
    endpoint?: string;
}
