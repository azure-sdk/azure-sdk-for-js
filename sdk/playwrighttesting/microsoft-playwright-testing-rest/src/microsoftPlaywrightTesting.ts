...
import type { MicrosoftPlaywrightTestingClient } from "./clientDefinitions.js";
...
export default function createClient(
  ...
  { apiVersion = "2024-12-01", ...options }: MicrosoftPlaywrightTestingClientOptions = {},
  ...
  const client = getClient(endpointUrl, credentials, options) as MicrosoftPlaywrightTestingClient;
