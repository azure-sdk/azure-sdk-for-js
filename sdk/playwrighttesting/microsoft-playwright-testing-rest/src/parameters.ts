...
export interface TestRunsComputeMetadataQueryParamProperties {
  /** The number of result items to return. */
  top?: number;
  /** The number of result items to skip. */
  skip?: number;
...
export interface TestRunsComputeMetadataQueryParam {
  queryParameters?: TestRunsComputeMetadataQueryParamProperties;
}
...
export type TestRunsComputeMetadataParameters = TestRunsComputeMetadataQueryParam &
  TestRunsComputeMetadataHeaderParam &
  RequestParameters;
...
export type TestResultsUploadBatchParameters = TestResultsUploadBatchHeaderParam &
