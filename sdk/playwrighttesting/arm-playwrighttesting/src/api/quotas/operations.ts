...
export function _listBySubscriptionSend(
  ...
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/providers/Microsoft.AzurePlaywrightService/locations/{location}/quotas{?api%2Dversion}",
    {
...
export function _getSend(
  ...
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/providers/Microsoft.AzurePlaywrightService/locations/{location}/quotas/{quotaName}{?api%2Dversion}",
    {
      subscriptionId: context.subscriptionId,
      location: location,
      quotaName: quotaName,
