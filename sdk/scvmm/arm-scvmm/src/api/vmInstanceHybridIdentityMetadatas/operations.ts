...
export function _listByVirtualMachineInstanceSend(
  ...
  const path = expandUrlTemplate(
    "/{+resourceUri}/providers/Microsoft.ScVmm/virtualMachineInstances/default/hybridIdentityMetadata{?api%2Dversion}",
    {
...
export function _getSend(
  ...
  const path = expandUrlTemplate(
    "/{+resourceUri}/providers/Microsoft.ScVmm/virtualMachineInstances/default/hybridIdentityMetadata/default{?api%2Dversion}",
    {
      resourceUri: resourceUri,
      "api%2Dversion": context.apiVersion,
    },
