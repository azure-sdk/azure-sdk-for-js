...
export async function _vmmServersCreateOrUpdateDeserialize(
  ...
  const res = result as unknown as VmmServersCreateOrUpdateLogicalResponse;
  return {
    tags: res.body["tags"],
    ...
    properties: !res.body.properties
      ...
      : {
          ...
          fqdn: res.body.properties?.["fqdn"],
          port: res.body.properties?.["port"],
          connectionStatus: res.body.properties?.["connectionStatus"],
          errorMessage: res.body.properties?.["errorMessage"],
...
export function vmmServersCreateOrUpdate(
  ...
  return getLongRunningPoller(context, _vmmServersCreateOrUpdateDeserialize, {
...
export async function _vmmServersUpdateDeserialize(
  ...
  const res = result as unknown as VmmServersUpdateLogicalResponse;
  return {
    tags: res.body["tags"],
    location: res.body["location"],
    id: res.body["id"],
...
export function vmmServersUpdate(
  ...
  return getLongRunningPoller(context, _vmmServersUpdateDeserialize, {
    updateIntervalInMs: options?.updateIntervalInMs,
    abortSignal: options?.abortSignal,
    getInitialResponse: () =>
...
export function vmmServersDelete(
  ...
  return getLongRunningPoller(context, _vmmServersDeleteDeserialize, {
    updateIntervalInMs: options?.updateIntervalInMs,
    abortSignal: options?.abortSignal,
    getInitialResponse: () =>
