...
export function availabilitySetsListByResourceGroup(
  ...
  return buildPagedAsyncIterator(
    context,
    () => _availabilitySetsListByResourceGroupSend(context, resourceGroupName, options),
...
export function availabilitySetsDelete(
  ...
  return getLongRunningPoller(context, _availabilitySetsDeleteDeserialize, ["202", "204", "200"], {
    updateIntervalInMs: options?.updateIntervalInMs,
    abortSignal: options?.abortSignal,
    getInitialResponse: () =>
      _availabilitySetsDeleteSend(context, resourceGroupName, availabilitySetResourceName, options),
...
export function availabilitySetsUpdate(
  ...
  return getLongRunningPoller(context, _availabilitySetsUpdateDeserialize, ["200", "202"], {
    updateIntervalInMs: options?.updateIntervalInMs,
    abortSignal: options?.abortSignal,
    getInitialResponse: () =>
...
export function availabilitySetsCreateOrUpdate(
  ...
  return getLongRunningPoller(context, _availabilitySetsCreateOrUpdateDeserialize, ["200", "201"], {
    updateIntervalInMs: options?.updateIntervalInMs,
    abortSignal: options?.abortSignal,
    getInitialResponse: () =>
