...
export function virtualMachineTemplatesListByResourceGroup(
  ...
  return buildPagedAsyncIterator(
    context,
    () => _virtualMachineTemplatesListByResourceGroupSend(context, resourceGroupName, options),
...
export function virtualMachineTemplatesUpdate(
  ...
  return getLongRunningPoller(context, _virtualMachineTemplatesUpdateDeserialize, ["200", "202"], {
    updateIntervalInMs: options?.updateIntervalInMs,
    abortSignal: options?.abortSignal,
    getInitialResponse: () =>
