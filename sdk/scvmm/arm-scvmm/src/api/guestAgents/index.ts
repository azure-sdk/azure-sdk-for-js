...
export function guestAgentsListByVirtualMachineInstance(
  ...
  return buildPagedAsyncIterator(
    context,
    () => _guestAgentsListByVirtualMachineInstanceSend(context, resourceUri, options),
...
export async function _guestAgentsDeleteDeserialize(result: PathUncheckedResponse): Promise<void> {
...
export function guestAgentsCreate(
  ...
  return getLongRunningPoller(context, _guestAgentsCreateDeserialize, ["200", "201"], {
    updateIntervalInMs: options?.updateIntervalInMs,
    abortSignal: options?.abortSignal,
    getInitialResponse: () => _guestAgentsCreateSend(context, resourceUri, resource, options),
