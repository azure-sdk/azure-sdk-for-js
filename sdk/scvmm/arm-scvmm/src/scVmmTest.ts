...
import { ScVmmTestOptionalParams } from "./models";
...
export class ScVmmTest extends coreClient.ServiceClient {
  ...
  /**
   * Initializes a new instance of the ScVmmTest class.
  ...
  constructor(
    ...
    subscriptionId: string,
    options?: ScVmmTestOptionalParams,
  );
  constructor(
    credentials: coreAuth.TokenCredential,
    options?: ScVmmTestOptionalParams,
  ...
  constructor(
    credentials: coreAuth.TokenCredential,
    subscriptionIdOrOptions?: ScVmmTestOptionalParams | string,
    options?: ScVmmTestOptionalParams,
  ) {
    ...
    const defaults: ScVmmTestOptionalParams = {
