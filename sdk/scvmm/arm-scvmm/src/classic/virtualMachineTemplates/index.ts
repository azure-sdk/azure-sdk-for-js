...
function _getVirtualMachineTemplates(context: ScVmmContext) {
  return {
    ...
    listByResourceGroup: (
      resourceGroupName: string,
      options?: VirtualMachineTemplatesListByResourceGroupOptionalParams,
    ) => virtualMachineTemplatesListByResourceGroup(context, resourceGroupName, options),
    delete: (
      resourceGroupName: string,
      virtualMachineTemplateName: string,
      options?: VirtualMachineTemplatesDeleteOptionalParams,
    ...
    get: (
      ...
      virtualMachineTemplatesGet(context, resourceGroupName, virtualMachineTemplateName, options),
  };
}
