...
function _getVmInstanceHybridIdentityMetadatas(context: ScVmmContext) {
  return {
    listByVirtualMachineInstance: (
      ...
      vmInstanceHybridIdentityMetadatasListByVirtualMachineInstance(context, resourceUri, options),
    get: (resourceUri: string, options?: VmInstanceHybridIdentityMetadatasGetOptionalParams) =>
