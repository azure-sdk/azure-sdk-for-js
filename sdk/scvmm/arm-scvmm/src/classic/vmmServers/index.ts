...
function _getVmmServers(context: ScVmmContext) {
  return {
    ...
    update: (
      ...
      properties: VmmServerTagsUpdate,
      options?: VmmServersUpdateOptionalParams,
    ) => vmmServersUpdate(context, resourceGroupName, vmmServerName, properties, options),
    createOrUpdate: (
      resourceGroupName: string,
      vmmServerName: string,
      resource: VmmServer,
      options?: VmmServersCreateOrUpdateOptionalParams,
    ) => vmmServersCreateOrUpdate(context, resourceGroupName, vmmServerName, resource, options),
    get: (
      resourceGroupName: string,
      vmmServerName: string,
      options?: VmmServersGetOptionalParams,
