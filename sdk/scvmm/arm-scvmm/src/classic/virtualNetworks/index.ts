...
import { VirtualNetwork, VirtualNetworkTagsUpdate } from "../../models/models.js";
...
function _getVirtualNetworks(context: ScVmmContext) {
  return {
    listBySubscription: (options?: VirtualNetworksListBySubscriptionOptionalParams) =>
    ...
    delete: (
      ...
      virtualNetworkName: string,
      options?: VirtualNetworksDeleteOptionalParams,
    ) => virtualNetworksDelete(context, resourceGroupName, virtualNetworkName, options),
    update: (
      resourceGroupName: string,
      virtualNetworkName: string,
      properties: VirtualNetworkTagsUpdate,
      options?: VirtualNetworksUpdateOptionalParams,
    ) => virtualNetworksUpdate(context, resourceGroupName, virtualNetworkName, properties, options),
    createOrUpdate: (
      resourceGroupName: string,
      virtualNetworkName: string,
      resource: VirtualNetwork,
    ...
    get: (
      ...
      virtualNetworkName: string,
      options?: VirtualNetworksGetOptionalParams,
    ) => virtualNetworksGet(context, resourceGroupName, virtualNetworkName, options),
  };
}

export function _getVirtualNetworksOperations(context: ScVmmContext): VirtualNetworksOperations {
  return {
