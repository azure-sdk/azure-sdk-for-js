...
function _getClouds(context: ScVmmContext) {
  return {
    ...
    update: (
      ...
      properties: CloudTagsUpdate,
      options?: CloudsUpdateOptionalParams,
    ) => cloudsUpdate(context, resourceGroupName, cloudResourceName, properties, options),
    createOrUpdate: (
      resourceGroupName: string,
      cloudResourceName: string,
      resource: Cloud,
      options?: CloudsCreateOrUpdateOptionalParams,
    ) => cloudsCreateOrUpdate(context, resourceGroupName, cloudResourceName, resource, options),
    get: (
      resourceGroupName: string,
      cloudResourceName: string,
      options?: CloudsGetOptionalParams,
