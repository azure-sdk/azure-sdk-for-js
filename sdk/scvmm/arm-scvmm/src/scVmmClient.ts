...
import { _getGuestAgentsOperations, GuestAgentsOperations } from "./classic/guestAgents/index.js";
import {
...
import { _getCloudsOperations, CloudsOperations } from "./classic/clouds/index.js";
import { _getVmmServersOperations, VmmServersOperations } from "./classic/vmmServers/index.js";
import { _getOperationsOperations, OperationsOperations } from "./classic/operations/index.js";
import { createScVmm, ScVmmContext, ScVmmClientOptionalParams } from "./api/index.js";
...
export class ScVmmClient {
  ...
  constructor(
    ...
    this.vmInstanceHybridIdentityMetadatas = _getVmInstanceHybridIdentityMetadatasOperations(
      this._client,
    );
    ...
    this.virtualMachineTemplates = _getVirtualMachineTemplatesOperations(this._client);
