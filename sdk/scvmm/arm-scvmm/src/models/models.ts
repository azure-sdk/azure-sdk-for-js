...
export function vmmServerPropertiesDeserializer(item: any): VmmServerProperties {
  return {
    credentials: !item["credentials"]
      ? item["credentials"]
...
export function _vmmServerListResultDeserializer(item: any): _VmmServerListResult {
  return {
...
export function storageQosPolicyArrayDeserializer(result: Array<StorageQosPolicy>): any[] {
  return result.map((item) => {
...
export function virtualMachineTemplateSerializer(item: VirtualMachineTemplate): any {
  return {
    tags: item["tags"],
    location: item["location"],
    properties: !item["properties"]
...
export function virtualMachineTemplateDeserializer(item: any): VirtualMachineTemplate {
  return {
    tags: item["tags"],
    location: item["location"],
    id: item["id"],
...
export function virtualMachineTemplatePropertiesDeserializer(
  ...
  return {
    ...
    disks: !item["disks"] ? item["disks"] : virtualDiskArrayDeserializer(item["disks"]),
    provisioningState: item["provisioningState"],
  };
}
...
export function virtualDiskArrayDeserializer(result: Array<VirtualDisk>): any[] {
  return result.map((item) => {
...
export function storageQosPolicyDetailsSerializer(item: StorageQosPolicyDetails): any {
  return { name: item["name"], id: item["id"] };
}

export function storageQosPolicyDetailsDeserializer(item: any): StorageQosPolicyDetails {
  return {
    name: item["name"],
    id: item["id"],
  };
...
export function availabilitySetTagsUpdateSerializer(item: AvailabilitySetTagsUpdate): any {
  return { tags: item["tags"] };
}
...
export function inventoryItemPropertiesSerializer(item: InventoryItemProperties): any {
  return { inventoryType: item["inventoryType"] };
}

export function inventoryItemPropertiesDeserializer(item: any): InventoryItemProperties {
  return {
...
export function inventoryItemPropertiesUnionSerializer(item: InventoryItemPropertiesUnion): any {
  switch (item.inventoryType) {
    ...
    case "VirtualNetwork":
      return virtualNetworkInventoryItemSerializer(item as VirtualNetworkInventoryItem);
    ...
    case "VirtualMachine":
      return virtualMachineInventoryItemSerializer(item as VirtualMachineInventoryItem);
...
export function inventoryItemPropertiesUnionDeserializer(item: any): InventoryItemPropertiesUnion {
  switch (item.inventoryType) {
    case "Cloud":
      return cloudInventoryItemDeserializer(item as CloudInventoryItem);

    case "VirtualNetwork":
      return virtualNetworkInventoryItemDeserializer(item as VirtualNetworkInventoryItem);
    ...
    case "VirtualMachine":
      return virtualMachineInventoryItemDeserializer(item as VirtualMachineInventoryItem);
...
export function virtualNetworkInventoryItemSerializer(item: VirtualNetworkInventoryItem): any {
  return { inventoryType: item["inventoryType"] };
}

export function virtualNetworkInventoryItemDeserializer(item: any): VirtualNetworkInventoryItem {
  return {
    inventoryType: item["inventoryType"],
    managedResourceId: item["managedResourceId"],
    uuid: item["uuid"],
...
export function virtualMachineInventoryItemSerializer(item: VirtualMachineInventoryItem): any {
  return {
    inventoryType: item["inventoryType"],
    ...
    cloud: !item["cloud"] ? item["cloud"] : inventoryItemDetailsSerializer(item["cloud"]),
  };
}

export function virtualMachineInventoryItemDeserializer(item: any): VirtualMachineInventoryItem {
  return {
    inventoryType: item["inventoryType"],
    managedResourceId: item["managedResourceId"],
    uuid: item["uuid"],
    ...
    cloud: !item["cloud"] ? item["cloud"] : inventoryItemDetailsDeserializer(item["cloud"]),
...
export function inventoryItemDetailsSerializer(item: InventoryItemDetails): any {
  return {
    inventoryItemId: item["inventoryItemId"],
    inventoryItemName: item["inventoryItemName"],
  };
...
export function inventoryItemDetailsDeserializer(item: any): InventoryItemDetails {
  return {
    inventoryItemId: item["inventoryItemId"],
    inventoryItemName: item["inventoryItemName"],
  };
...
export function inventoryItemArraySerializer(result: Array<InventoryItem>): any[] {
  return result.map((item) => {
    return inventoryItemSerializer(item);
  });
}

export function inventoryItemArrayDeserializer(result: Array<InventoryItem>): any[] {
  return result.map((item) => {
...
export function availabilitySetListItemSerializer(item: AvailabilitySetListItem): any {
  return { id: item["id"], name: item["name"] };
}

export function availabilitySetListItemDeserializer(item: any): AvailabilitySetListItem {
  return {
    id: item["id"],
    name: item["name"],
  };
...
export function osProfileForVmInstanceSerializer(item: OsProfileForVmInstance): any {
  return {
...
export function osProfileForVmInstanceDeserializer(item: any): OsProfileForVmInstance {
  return {
    adminUsername: item["adminUsername"],
    adminPassword: item["adminPassword"],
    computerName: item["computerName"],
...
export function storageProfileSerializer(item: StorageProfile): any {
  return {
    disks: !item["disks"] ? item["disks"] : virtualDiskArraySerializer(item["disks"]),
  };
}
...
export function infrastructureProfileSerializer(item: InfrastructureProfile): any {
  return {
    inventoryItemId: item["inventoryItemId"],
    vmmServerId: item["vmmServerId"],
...
export function infrastructureProfileDeserializer(item: any): InfrastructureProfile {
  return {
    inventoryItemId: item["inventoryItemId"],
    vmmServerId: item["vmmServerId"],
    cloudId: item["cloudId"],
...
export function virtualMachineInstanceUpdateSerializer(item: VirtualMachineInstanceUpdate): any {
  return {
    properties: !item["properties"]
      ? item["properties"]
...
export function networkInterfaceUpdateSerializer(item: NetworkInterfaceUpdate): any {
  return {
    name: item["name"],
    macAddress: item["macAddress"],
    virtualNetworkId: item["virtualNetworkId"],
...
export function storageProfileUpdateSerializer(item: StorageProfileUpdate): any {
  return {
    disks: !item["disks"] ? item["disks"] : virtualDiskUpdateArraySerializer(item["disks"]),
  };
}

export function virtualDiskUpdateArraySerializer(result: Array<VirtualDiskUpdate>): any[] {
  return result.map((item) => {
...
export function infrastructureProfileUpdateSerializer(item: InfrastructureProfileUpdate): any {
...
/** model interface _StopParameterBody */
export interface _StopParameterBody {
  /** The content of the action request */
  body?: StopVirtualMachineOptions;
}

export function _stopParameterBodySerializer(item: _StopParameterBody): any {
  return item;
}
...
export function stopVirtualMachineOptionsSerializer(item: StopVirtualMachineOptions): any {
...
export function vmInstanceHybridIdentityMetadataDeserializer(
  ...
  return {
    ...
    properties: !item["properties"]
      ? item["properties"]
      : vmInstanceHybridIdentityMetadataPropertiesDeserializer(item["properties"]),
  };
}
