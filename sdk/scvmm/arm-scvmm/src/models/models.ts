...
import {
  GuestAgent as GuestAgentRest,
  GuestAgentProperties as GuestAgentPropertiesRest,
  GuestCredential as GuestCredentialRest,
  HttpProxyConfiguration as HttpProxyConfigurationRest,
  VirtualMachineInstance as VirtualMachineInstanceRest,
  VirtualMachineInstanceProperties as VirtualMachineInstancePropertiesRest,
  AvailabilitySetListItem as AvailabilitySetListItemRest,
  OsProfileForVmInstance as OsProfileForVmInstanceRest,
  HardwareProfile as HardwareProfileRest,
  NetworkProfile as NetworkProfileRest,
  NetworkInterface as NetworkInterfaceRest,
  StorageProfile as StorageProfileRest,
  VirtualDisk as VirtualDiskRest,
  StorageQosPolicyDetails as StorageQosPolicyDetailsRest,
  InfrastructureProfile as InfrastructureProfileRest,
  ExtendedLocation as ExtendedLocationRest,
  VirtualMachineInstanceUpdate as VirtualMachineInstanceUpdateRest,
  VirtualMachineInstanceUpdateProperties as VirtualMachineInstanceUpdatePropertiesRest,
  HardwareProfileUpdate as HardwareProfileUpdateRest,
  NetworkProfileUpdate as NetworkProfileUpdateRest,
  NetworkInterfaceUpdate as NetworkInterfaceUpdateRest,
  StorageProfileUpdate as StorageProfileUpdateRest,
  VirtualDiskUpdate as VirtualDiskUpdateRest,
  InfrastructureProfileUpdate as InfrastructureProfileUpdateRest,
  StopVirtualMachineOptions as StopVirtualMachineOptionsRest,
  VirtualMachineCreateCheckpoint as VirtualMachineCreateCheckpointRest,
  VirtualMachineDeleteCheckpoint as VirtualMachineDeleteCheckpointRest,
  VirtualMachineRestoreCheckpoint as VirtualMachineRestoreCheckpointRest,
  InventoryItem as InventoryItemRest,
  InventoryItemProperties as InventoryItemPropertiesRest,
  CloudInventoryItem as CloudInventoryItemRest,
  VirtualNetworkInventoryItem as VirtualNetworkInventoryItemRest,
  VirtualMachineTemplateInventoryItem as VirtualMachineTemplateInventoryItemRest,
  VirtualMachineInventoryItem as VirtualMachineInventoryItemRest,
  InventoryItemDetails as InventoryItemDetailsRest,
  TrackedResource as TrackedResourceRest,
  AvailabilitySet as AvailabilitySetRest,
  AvailabilitySetProperties as AvailabilitySetPropertiesRest,
  AvailabilitySetTagsUpdate as AvailabilitySetTagsUpdateRest,
  VirtualMachineTemplate as VirtualMachineTemplateRest,
  VirtualMachineTemplateProperties as VirtualMachineTemplatePropertiesRest,
  VirtualMachineTemplateTagsUpdate as VirtualMachineTemplateTagsUpdateRest,
  VirtualNetwork as VirtualNetworkRest,
  VirtualNetworkProperties as VirtualNetworkPropertiesRest,
  VirtualNetworkTagsUpdate as VirtualNetworkTagsUpdateRest,
  Cloud as CloudRest,
  CloudProperties as CloudPropertiesRest,
  CloudTagsUpdate as CloudTagsUpdateRest,
  VmmServer as VmmServerRest,
  VmmServerProperties as VmmServerPropertiesRest,
  VmmCredential as VmmCredentialRest,
  VmmServerTagsUpdate as VmmServerTagsUpdateRest,
} from "../rest/index.js";
...
export function guestAgentSerializer(item: GuestAgent): GuestAgentRest {
  return {
...
): VirtualMachineInstancePropertiesRest {
  return {
    availabilitySets:
...
export function virtualDiskSerializer(item: VirtualDisk): VirtualDiskRest {
  return {
    name: item["name"],
    diskId: item["diskId"],
...
): VirtualMachineInstanceUpdateRest {
  return {
    properties: !item.properties
      ? item.properties
...
): VirtualMachineInstanceUpdatePropertiesRest {
  return {
    availabilitySets:
      item["availabilitySets"] === undefined
        ? item["availabilitySets"]
...
): InfrastructureProfileUpdateRest {
  return {
    checkpointType: item["checkpointType"],
  };
}
...
): VirtualMachineCreateCheckpointRest {
  return {
    name: item["name"],
...
): VirtualMachineDeleteCheckpointRest {
  return {
    id: item["id"],
  };
}
...
): VirtualMachineRestoreCheckpointRest {
  return {
    id: item["id"],
  };
}
...
): VirtualNetworkInventoryItemRest {
  return {
    inventoryType: item["inventoryType"],
  };
}
...
): VirtualMachineTemplateInventoryItemRest {
  return {
    inventoryType: item["inventoryType"],
  };
}
...
): VirtualMachineInventoryItemRest {
  return {
    inventoryType: item["inventoryType"],
...
): VirtualMachineTemplatePropertiesRest {
  return {
    inventoryItemId: item["inventoryItemId"],
    uuid: item["uuid"],
    vmmServerId: item["vmmServerId"],
...
): VirtualMachineTemplateTagsUpdateRest {
  return {
    tags: !item.tags ? item.tags : (serializeRecord(item.tags as any) as any),
  };
}
...
export function cloudSerializer(item: Cloud): CloudRest {
  return {
    tags: !item.tags ? item.tags : (serializeRecord(item.tags as any) as any),
    location: item["location"],
    properties: !item.properties
...
export function vmmServerSerializer(item: VmmServer): VmmServerRest {
  return {
    tags: !item.tags ? item.tags : (serializeRecord(item.tags as any) as any),
    location: item["location"],
    properties: !item.properties
