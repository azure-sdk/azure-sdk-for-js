 ...
 * x-ms-original-file: 2025-03-13/GuestAgents_ListByVirtualMachineInstance_MaximumSet_Gen.json
 */
 ...
 *
 * @summary returns the list of GuestAgent of the given vm.
 * x-ms-original-file: 2025-03-13/GuestAgents_ListByVirtualMachineInstance_MinimumSet_Gen.json
 */
