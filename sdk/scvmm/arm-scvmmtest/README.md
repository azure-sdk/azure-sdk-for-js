...
[Source code](https://github.com/Azure/azure-sdk-for-js/tree/main/sdk/scvmm/arm-scvmmtest) |
[Package (NPM)](https://www.npmjs.com/package/@azure/arm-scvmmtest) |
[API reference documentation](https://docs.microsoft.com/javascript/api/@azure/arm-scvmmtest) |
...
### Install the `@azure/arm-scvmmtest` package

Install the Azure ScVmm client library for JavaScript with `npm`:

```bash
npm install @azure/arm-scvmmtest
```
...
```javascript
const { ScVmm } = require("@azure/arm-scvmmtest");
...
![Impressions](https://azure-sdk-impressions.azurewebsites.net/api/impressions/azure-sdk-for-js%2Fsdk%2Fscvmm%2Farm-scvmmtest%2FREADME.png)
