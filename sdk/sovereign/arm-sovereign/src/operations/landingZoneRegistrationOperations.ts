...
export class LandingZoneRegistrationOperationsImpl implements LandingZoneRegistrationOperations {
  ...
  public list(
    ...
    const iter = this.listPagingAll(resourceGroupName, landingZoneAccountName, options);
    return {
      next() {
        return iter.next();
      },
      ...
      byPage: (settings?: PageSettings) => {
        ...
        return this.listPagingPage(resourceGroupName, landingZoneAccountName, options, settings);
      },
    };
  }
  ...
  private async *listPagingPage(
    ...
    if (!continuationToken) {
      result = await this._list(resourceGroupName, landingZoneAccountName, options);
