...
export function _preRestoreSend(
  ...
  options: VolumeGroupsPreRestoreOptionalParams = { requestOptions: {} },
): StreamableMethod {
...
export function preRestore(
  ...
  return getLongRunningPoller(context, _preRestoreDeserialize, ["202", "200"], {
    ...
    OperationState<PreValidationResponse>,
    PreValidationResponse
  >;
}
...
export function _preBackupSend(
  ...
  options: VolumeGroupsPreBackupOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
