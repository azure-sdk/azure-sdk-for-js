...
/** deserialize function for InternalConnectionPropertiesSASAuth */
function deserializeInternalConnectionPropertiesSASAuth(
  obj: InternalConnectionPropertiesSASAuthOutput,
): InternalConnectionPropertiesSASAuth {
  return {
...
/** deserialize function for InternalConnectionPropertiesOutput */
export function deserializeInternalConnectionPropertiesUnion(
  obj: InternalConnectionPropertiesOutput,
): InternalConnectionPropertiesUnion {
  switch (obj.authType) {
    case "SAS":
      return deserializeInternalConnectionPropertiesSASAuth(
        obj as InternalConnectionPropertiesSASAuth,
      );
    default:
      return obj;
  }
...
/** deserialize function for BingGroundingToolDefinition */
function deserializeBingGroundingToolDefinition(
  obj: BingGroundingToolDefinitionOutput,
): BingGroundingToolDefinition {
  return {
    type: obj["type"],
    bingGrounding: {
      connectionList:
        obj.bing_grounding["connections"] === undefined
          ? obj.bing_grounding["connections"]
          : obj.bing_grounding["connections"].map((p: any) => {
...
/** deserialize function for MicrosoftFabricToolDefinition */
function deserializeMicrosoftFabricToolDefinition(
  obj: MicrosoftFabricToolDefinitionOutput,
): MicrosoftFabricToolDefinition {
  return {
    type: obj["type"],
    microsoftFabric: {
      connectionList:
        obj.microsoft_fabric["connections"] === undefined
          ? obj.microsoft_fabric["connections"]
          : obj.microsoft_fabric["connections"].map((p: any) => {
              return { connectionId: p["connection_id"] };
            }),
    },
  };
...
/** deserialize function for SharepointToolDefinition */
function deserializeSharepointToolDefinition(
  obj: SharepointToolDefinitionOutput,
): SharepointToolDefinition {
  return {
    type: obj["type"],
    sharepointGrounding: {
      connectionList:
        obj.sharepoint_grounding["connections"] === undefined
          ? obj.sharepoint_grounding["connections"]
          : obj.sharepoint_grounding["connections"].map((p: any) => {
              return { connectionId: p["connection_id"] };
            }),
    },
  };
...
export function deserializeToolDefinitionUnion(
  ...
  switch (obj.type) {
    ...
    case "bing_grounding":
      return deserializeBingGroundingToolDefinition(
        obj as BingGroundingToolDefinition,
      );
    case "microsoft_fabric":
      return deserializeMicrosoftFabricToolDefinition(
        obj as MicrosoftFabricToolDefinition,
      );
    case "sharepoint_grounding":
      return deserializeSharepointToolDefinition(
        obj as SharepointToolDefinition,
      );
    default:
      return obj;
  }
...
/** deserialize function for RunStepBingGroundingToolCall */
function deserializeRunStepBingGroundingToolCall(
  obj: RunStepBingGroundingToolCallOutput,
): RunStepBingGroundingToolCall {
  return {
    type: obj["type"],
    id: obj["id"],
    bingGrounding: obj["bing_grounding"],
  };
}
...
function deserializeRunStepSharepointToolCall(
  ...
  return {
    type: obj["type"],
    id: obj["id"],
    sharePoint: obj["sharepoint_grounding"],
  };
}
...
export function deserializeRunStepToolCallUnion(
  ...
  switch (obj.type) {
    ...
    case "bing_grounding":
      return deserializeRunStepBingGroundingToolCall(
        obj as RunStepBingGroundingToolCall,
      );
