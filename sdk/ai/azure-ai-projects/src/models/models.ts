...
export interface ToolDefinition {
  /** the discriminator possible values: code_interpreter, file_search, function, bing_grounding, microsoft_fabric, sharepoint_grounding, azure_ai_search */
  type: string;
}
...
export function toolConnectionListSerializer(
  item: ToolConnectionList,
): Record<string, unknown> {
  return {
    connections:
      item["connectionList"] === undefined
        ? item["connectionList"]
        : item["connectionList"].map(toolConnectionSerializer),
  };
}
...
export function toolConnectionSerializer(
  item: ToolConnection,
): Record<string, unknown> {
  return {
...
export function microsoftFabricToolDefinitionSerializer(
  ...
  return {
    type: item["type"],
    microsoft_fabric: toolConnectionListSerializer(item.microsoftFabric),
  };
}
...
export interface RunStepToolCall {
  /** the discriminator possible values: code_interpreter, file_search, bing_grounding, azure_ai_search, sharepoint_grounding, microsoft_fabric, function */
  type: string;
