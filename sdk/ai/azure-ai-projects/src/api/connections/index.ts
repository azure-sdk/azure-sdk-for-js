...
import { deserializeInternalConnectionPropertiesUnion } from "../../utils/deserializeUtil.js";
  ...
  return {
    value: result.body["value"].map((p: any) => {
      return {
        id: p["id"],
        name: p["name"],
        properties: deserializeInternalConnectionPropertiesUnion(p.properties),
      };
    }),
  };
}
...
export async function _getConnectionDeserialize(
  ...
  return {
    id: result.body["id"],
    name: result.body["name"],
    properties: deserializeInternalConnectionPropertiesUnion(
