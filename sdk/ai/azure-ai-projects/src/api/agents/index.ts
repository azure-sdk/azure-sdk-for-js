...
import {
  ...
  vectorStorageDataSourceSerializer,
                  ...
                  dataSources:
                    result.body.tool_resources.code_interpreter?.[
                      ...
                      : result.body.tool_resources.code_interpreter?.[
                          ...
                          return { storageUri: p["uri"], assetType: p["type"] };
                        }),
                },
                    ...
                    result.body.tool_resources.file_search?.[
                      ...
                      : result.body.tool_resources.file_search?.[
                          ...
                          return {
                            storeName: p["name"],
                            storeConfiguration: {
                              dataSources: p.configuration["data_sources"].map(
                                (p: any) => {
                                  return {
                                    storageUri: p["uri"],
                                    assetType: p["type"],
            ...
            : {
                codeInterpreter: !p.tool_resources.code_interpreter
                  ...
                  : {
                      ...
                      dataSources:
                        p.tool_resources.code_interpreter?.["data_sources"] ===
                        undefined
                          ? p.tool_resources.code_interpreter?.["data_sources"]
                          : p.tool_resources.code_interpreter?.[
                              "data_sources"
                            ].map((p: any) => {
                              return {
                                storageUri: p["uri"],
                ...
                fileSearch: !p.tool_resources.file_search
                  ...
                  : {
                      ...
                      vectorStores:
                        p.tool_resources.file_search?.["vector_stores"] ===
                        undefined
                          ? p.tool_resources.file_search?.["vector_stores"]
                          : p.tool_resources.file_search?.["vector_stores"].map(
                              (p: any) => {
                                return {
                                  storeName: p["name"],
                                  storeConfiguration: {
                                    dataSources: p.configuration[
                                      "data_sources"
                                    ].map((p: any) => {
                                      return {
                                        storageUri: p["uri"],
      ...
      result.body["attachments"] === null
        ...
        : result.body["attachments"].map((p: any) => {
            return {
              fileId: p["file_id"],
              dataSources:
                p["data_sources"] === undefined
                  ? p["data_sources"]
                  : p["data_sources"].map((p: any) => {
                      return { storageUri: p["uri"], assetType: p["type"] };
                    }),
              tools: p["tools"],
            };
  ...
  return {
    ...
    data: result.body["data"].map((p: any) => {
      return {
        ...
        storeConfiguration: !p.configuration
          ? undefined
          : {
              dataSources: p.configuration?.["data_sources"].map((p: any) => {
                return { storageUri: p["uri"], assetType: p["type"] };
              }),
            },
        metadata: p["metadata"],
  ...
  return context
    ...
    .post({
      ...
      body: {
        ...
        name: options?.name,
        configuration: {
          data_sources: options?.storeConfiguration?.["dataSources"].map(
            vectorStorageDataSourceSerializer,
          ),
        },
        expires_after: {
...
export async function _createVectorStoreDeserialize(
  ...
  return {
    ...
    storeConfiguration: !result.body.configuration
      ? undefined
      : {
          dataSources: result.body.configuration?.["data_sources"].map(
            (p: any) => {
              return { storageUri: p["uri"], assetType: p["type"] };
            },
          ),
      ...
      body: {
        ...
        data_sources:
          options?.dataSources === undefined
            ? options?.dataSources
            : options?.dataSources.map(vectorStorageDataSourceSerializer),
        chunking_strategy: vectorStoreChunkingStrategyRequestUnionSerializer(
          options?.chunkingStrategy,
        ),
      },
