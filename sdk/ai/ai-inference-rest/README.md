# Azure Model REST client library for JavaScript
...
- [API reference documentation](https://learn.microsoft.com/javascript/api/@azure-rest/ai-inference?view=azure-node-preview)
...
Install the Azure Model REST client REST client library for JavaScript with `npm`:
