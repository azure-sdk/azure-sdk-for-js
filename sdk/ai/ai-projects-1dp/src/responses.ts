...
export interface RunsCreateRun201Headers {
  location: string;
  /** An opaque, globally-unique, client-generated string identifier for the request. */
  "x-ms-client-request-id"?: string;
}
...
/** The request has succeeded and a new resource has been created as a result. */
export interface RunsCreateRun201Response extends HttpResponse {
  status: "201";
  headers: RawHttpHeaders & RunsCreateRun201Headers;
}
...
export interface RunsListRunInputs200Headers {
  /** An opaque, globally-unique, client-generated string identifier for the request. */
  "x-ms-client-request-id"?: string;
}
...
export interface RunsListRunInputs200Response extends HttpResponse {
  status: "200";
  body: PagedRunInputsOutput;
  headers: RawHttpHeaders & RunsListRunInputs200Headers;
}
