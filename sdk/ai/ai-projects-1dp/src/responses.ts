...
/** The request has succeeded. */
export interface RunsListRunInputs200Response extends HttpResponse {
  status: "200";
  body: RunInputsOutput;
}

export interface RunsListRunInputsDefaultHeaders {
  /** String error code indicating what went wrong. */
  "x-ms-error-code"?: string;
}

export interface RunsListRunInputsDefaultResponse extends HttpResponse {
  status: string;
  body: ErrorResponse;
  headers: RawHttpHeaders & RunsListRunInputsDefaultHeaders;
}
