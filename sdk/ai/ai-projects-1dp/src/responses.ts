...
/** The request has succeeded. */
export interface EvaluationsGetAgentEvaluationResults200Response
  extends HttpResponse {
  status: "200";
  body: AgentEvaluationOutput;
}

export interface EvaluationsGetAgentEvaluationResultsDefaultHeaders {
  /** String error code indicating what went wrong. */
  "x-ms-error-code"?: string;
}

export interface EvaluationsGetAgentEvaluationResultsDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponse;
  headers: RawHttpHeaders & EvaluationsGetAgentEvaluationResultsDefaultHeaders;
}
