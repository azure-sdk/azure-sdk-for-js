...
/** The request has succeeded. */
export interface RedTeamsJailbreak200Response extends HttpResponse {
  status: "200";
  body: string;
}

/** The request has succeeded. */
export interface RedTeamsTemplateParameters200Response extends HttpResponse {
  status: "200";
  body: string;
}

/** The request has succeeded. */
export interface RedTeamsTemplateParametersImage200Response
  extends HttpResponse {
  status: "200";
  body: string;
}
...
/** The request has been accepted for processing, but processing has not yet completed. */
export interface RedTeamsChatCompletionsSubmit202Response extends HttpResponse {
  status: "202";
  body: string;
}
