...
import type {
  ...
  AgentLongRunningOperationResponseOutput,
...
/** The request has succeeded. */
export interface EvaluationsCreateAgentRunAsync200Response
  extends HttpResponse {
  status: "200";
  body: AgentLongRunningOperationResponseOutput;
}

export interface EvaluationsCreateAgentRunAsyncDefaultHeaders {
  /** String error code indicating what went wrong. */
  "x-ms-error-code"?: string;
}

export interface EvaluationsCreateAgentRunAsyncDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponse;
  headers: RawHttpHeaders & EvaluationsCreateAgentRunAsyncDefaultHeaders;
}
...
/** The request has been accepted for processing, but processing has not yet completed. */
export interface EvaluationsOperationResults202Response extends HttpResponse {
  status: "202";
