...
export interface EvaluationsCreateDefaultHeaders {
  /** String error code indicating what went wrong. */
  "x-ms-error-code"?: string;
}
...
export interface EvaluationsCreateDefaultResponse extends HttpResponse {
  status: string;
  body: ErrorResponse;
  headers: RawHttpHeaders & EvaluationsCreateDefaultHeaders;
}
...
/** The request has succeeded. */
export interface ModelsGetChatCompletions200Response extends HttpResponse {
  status: "200";
  body: ChatCompletionsOutput;
}

export interface ModelsGetChatCompletionsDefaultHeaders {
  /** String error code indicating what went wrong. */
  "x-ms-error-code"?: string;
}

export interface ModelsGetChatCompletionsDefaultResponse extends HttpResponse {
  status: string;
  body: ErrorResponse;
  headers: RawHttpHeaders & ModelsGetChatCompletionsDefaultHeaders;
}

/** The request has succeeded. */
export interface ModelsGetEmbeddings200Response extends HttpResponse {
  status: "200";
  body: EmbeddingsResultOutput;
}

export interface ModelsGetEmbeddingsDefaultHeaders {
  /** String error code indicating what went wrong. */
  "x-ms-error-code"?: string;
}

export interface ModelsGetEmbeddingsDefaultResponse extends HttpResponse {
  status: string;
  body: ErrorResponse;
  headers: RawHttpHeaders & ModelsGetEmbeddingsDefaultHeaders;
}

/** The request has succeeded. */
export interface ModelsGetImageEmbeddings200Response extends HttpResponse {
  status: "200";
  body: EmbeddingsResultOutput;
}

export interface ModelsGetImageEmbeddingsDefaultHeaders {
  /** String error code indicating what went wrong. */
  "x-ms-error-code"?: string;
}

export interface ModelsGetImageEmbeddingsDefaultResponse extends HttpResponse {
  status: string;
  body: ErrorResponse;
  headers: RawHttpHeaders & ModelsGetImageEmbeddingsDefaultHeaders;
}
