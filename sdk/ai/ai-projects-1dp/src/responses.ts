...
export interface MessagesSendMessage200Response extends HttpResponse {
  status: "200";
...
/** The request has succeeded. */
export interface ConversationsUpdateConversation200Response
  extends HttpResponse {
  status: "200";
  body: ConversationOutput;
}

export interface ConversationsUpdateConversationDefaultHeaders {
  /** String error code indicating what went wrong. */
  "x-ms-error-code"?: string;
}

export interface ConversationsUpdateConversationDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponse;
  headers: RawHttpHeaders & ConversationsUpdateConversationDefaultHeaders;
}

/** There is no content to send for this request, but the headers may be useful. */
export interface ConversationsDeleteConversation204Response
  extends HttpResponse {
  status: "204";
}

export interface ConversationsDeleteConversationDefaultHeaders {
  /** String error code indicating what went wrong. */
  "x-ms-error-code"?: string;
}

export interface ConversationsDeleteConversationDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponse;
  headers: RawHttpHeaders & ConversationsDeleteConversationDefaultHeaders;
}
...
/** The request has succeeded. */
export interface AgentsRun200Response extends HttpResponse {
  status: "200";
  body: RunOutput;
}

export interface AgentsRunDefaultHeaders {
  /** String error code indicating what went wrong. */
  "x-ms-error-code"?: string;
}

export interface AgentsRunDefaultResponse extends HttpResponse {
  status: string;
  body: ErrorResponse;
  headers: RawHttpHeaders & AgentsRunDefaultHeaders;
}

/** The request has succeeded. */
export interface AgentsStream200Response extends HttpResponse {
  status: "200";
}

export interface AgentsStreamDefaultHeaders {
  /** String error code indicating what went wrong. */
  "x-ms-error-code"?: string;
}

export interface AgentsStreamDefaultResponse extends HttpResponse {
  status: string;
  body: ErrorResponse;
  headers: RawHttpHeaders & AgentsStreamDefaultHeaders;
}

export interface AgentsGetRun200Headers {
  /** An opaque, globally-unique, client-generated string identifier for the request. */
  "x-ms-client-request-id"?: string;
}
...
export interface AgentsGetRun200Response extends HttpResponse {
  status: "200";
  body: RunOutput;
  headers: RawHttpHeaders & AgentsGetRun200Headers;
}
...
export interface AgentsListRuns200Headers {
  /** An opaque, globally-unique, client-generated string identifier for the request. */
  "x-ms-client-request-id"?: string;
}
...
export interface AgentsListRuns200Response extends HttpResponse {
  status: "200";
  body: PagedRunOutput;
  headers: RawHttpHeaders & AgentsListRuns200Headers;
}
...
/** The request has succeeded. */
export interface AgentsListRunInputs200Response extends HttpResponse {
  status: "200";
  body: RunInputsOutput;
}

export interface AgentsListRunInputsDefaultHeaders {
  /** String error code indicating what went wrong. */
  "x-ms-error-code"?: string;
}

export interface AgentsListRunInputsDefaultResponse extends HttpResponse {
  status: string;
  body: ErrorResponse;
  headers: RawHttpHeaders & AgentsListRunInputsDefaultHeaders;
}
