...
import type {
  ...
  EvaluationsGetAgentEvaluationResultsParameters,
...
import type {
  ...
  EvaluationsGetAgentEvaluationResults201Response,
...
export interface EvaluationsGetAgentEvaluationResults {
  /** Get agent evaluation results. */
  get(
    options?: EvaluationsGetAgentEvaluationResultsParameters,
  ): StreamableMethod<
    | EvaluationsGetAgentEvaluationResults201Response
    | EvaluationsGetAgentEvaluationResultsDefaultResponse
  >;
...
export interface Routes {
  ...
  /** Resource for '/evaluations/runs/agents/\{runId\}' has methods for the following verbs: get */
  (
    path: "/evaluations/runs/agents/{runId}",
    runId: string,
  ): EvaluationsGetAgentEvaluationResults;
