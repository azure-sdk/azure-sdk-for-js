...
import type {
  ConnectionsConnectionsGetParameters,
  ConnectionsConnectionsListParameters,
...
import type {
  ConnectionsConnectionsGet200Response,
  ConnectionsConnectionsGetDefaultResponse,
  ConnectionsConnectionsList200Response,
  ConnectionsConnectionsListDefaultResponse,
...
export interface ConnectionsConnectionsGet {
  /** Get a connection by name. */
  get(
    options?: ConnectionsConnectionsGetParameters,
  ): StreamableMethod<
    | ConnectionsConnectionsGet200Response
    | ConnectionsConnectionsGetDefaultResponse
  >;
...
export interface ConnectionsConnectionsList {
  /** List all connections in the project */
  get(
    options?: ConnectionsConnectionsListParameters,
  ): StreamableMethod<
    | ConnectionsConnectionsList200Response
    | ConnectionsConnectionsListDefaultResponse
  >;
...
export interface Routes {
  ...
  (path: "/connections/{name}", name: string): ConnectionsConnectionsGet;
  /** Resource for '/connections' has methods for the following verbs: get */
  (path: "/connections"): ConnectionsConnectionsList;
