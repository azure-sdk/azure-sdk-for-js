...
import type {
  ...
  RedTeamsJailbreakParameters,
  RedTeamsTemplateParametersParameters,
  RedTeamsTemplateParametersImageParameters,
  RedTeamsChatCompletionsSubmitParameters,
} from "./parameters.js";
import type {
  ...
  RedTeamsJailbreak200Response,
  RedTeamsTemplateParameters200Response,
  RedTeamsTemplateParametersImage200Response,
  RedTeamsChatCompletionsSubmit202Response,
} from "./responses.js";
...
export interface RedTeamsJailbreak {
  /** Simulation jailbreak. */
  get(
    options?: RedTeamsJailbreakParameters,
  ): StreamableMethod<RedTeamsJailbreak200Response>;
}

export interface RedTeamsTemplateParameters {
  /** Simulation template parameters. */
  get(
    options?: RedTeamsTemplateParametersParameters,
  ): StreamableMethod<RedTeamsTemplateParameters200Response>;
}

export interface RedTeamsTemplateParametersImage {
  /** Simulation template parameters for image. */
  get(
    options: RedTeamsTemplateParametersImageParameters,
  ): StreamableMethod<RedTeamsTemplateParametersImage200Response>;
}

export interface RedTeamsChatCompletionsSubmit {
  /** Simulation chat completion. */
  post(
    options: RedTeamsChatCompletionsSubmitParameters,
  ): StreamableMethod<RedTeamsChatCompletionsSubmit202Response>;
}
...
export interface Routes {
  ...
  (path: "/redTeams/simulation/jailbreak"): RedTeamsJailbreak;
  ...
  ): RedTeamsTemplateParametersImage;
