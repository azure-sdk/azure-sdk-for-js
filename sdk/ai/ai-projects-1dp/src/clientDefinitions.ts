...
export interface RunsCreateRun {
  ...
  ): StreamableMethod<RunsCreateRun201Response | RunsCreateRunDefaultResponse>;
  /** Lists run inputs. */
  get(
...
export interface Routes {
  ...
  /** Resource for '/runinputs' has methods for the following verbs: post, get */
  (path: "/runinputs"): RunsCreateRun;
