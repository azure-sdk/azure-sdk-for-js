...
import type {
  ...
  ModelsGetChatCompletionsParameters,
  ModelsGetEmbeddingsParameters,
  ModelsGetImageEmbeddingsParameters,
...
import type {
  ...
  ModelsGetChatCompletions200Response,
  ModelsGetChatCompletionsDefaultResponse,
  ModelsGetEmbeddings200Response,
  ModelsGetEmbeddingsDefaultResponse,
  ModelsGetImageEmbeddings200Response,
  ModelsGetImageEmbeddingsDefaultResponse,
...
export interface ConnectionsGetWithCredentials {
  /** Get connection with secrets by name. */
  post(
...
export interface EvaluationsCreate {
  ...
  post(
    ...
    EvaluationsCreate201Response | EvaluationsCreateDefaultResponse
  >;
}
...
export interface ModelsGetChatCompletions {
  /**
   ...
   */
  post(
    options: ModelsGetChatCompletionsParameters,
  ): StreamableMethod<
    | ModelsGetChatCompletions200Response
    | ModelsGetChatCompletionsDefaultResponse
  >;
...
export interface ModelsGetEmbeddings {
  /**
   * Return the embedding vectors for given text prompts.
   * The method makes a REST API call to the `/embeddings` route on the given endpoint.
   */
  post(
    options: ModelsGetEmbeddingsParameters,
  ): StreamableMethod<
    ModelsGetEmbeddings200Response | ModelsGetEmbeddingsDefaultResponse
  >;
}

export interface ModelsGetImageEmbeddings {
  /**
   * Return the embedding vectors for given images.
   * The method makes a REST API call to the `/images/embeddings` route on the given endpoint.
   */
  post(
    options: ModelsGetImageEmbeddingsParameters,
  ): StreamableMethod<
    | ModelsGetImageEmbeddings200Response
    | ModelsGetImageEmbeddingsDefaultResponse
  >;
...
export interface Routes {
  ...
  /** Resource for '/connections/\{connectionName\}:getWithCredentials' has methods for the following verbs: post */
  (
    path: "/connections/{connectionName}:getWithCredentials",
    connectionName: string,
  ...
  /** Resource for '/evaluations/\{id\}' has methods for the following verbs: get */
  (path: "/evaluations/{id}", id: string): EvaluationsGet;
  /** Resource for '/evaluations:create' has methods for the following verbs: post */
  (path: "/evaluations:create"): EvaluationsCreate;
  /** Resource for '/evaluations' has methods for the following verbs: get */
  ...
  /** Resource for '/models/chat/completions' has methods for the following verbs: post */
  (path: "/models/chat/completions"): ModelsGetChatCompletions;
  /** Resource for '/models/embeddings' has methods for the following verbs: post */
  (path: "/models/embeddings"): ModelsGetEmbeddings;
  /** Resource for '/models/images/embeddings' has methods for the following verbs: post */
  (path: "/models/images/embeddings"): ModelsGetImageEmbeddings;
  ...
  /** Resource for '/deployments/\{deploymentName\}' has methods for the following verbs: get */
  (
...
export type UnifiedClient = Client & {
  path: Routes;
};
