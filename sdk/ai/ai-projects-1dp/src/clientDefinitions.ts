...
export interface Routes {
  ...
  /** Resource for '/red-teams/runs/\{name\}' has methods for the following verbs: get */
  (path: "/red-teams/runs/{name}", name: string): RedTeamsGet;
  /** Resource for '/red-teams/runs' has methods for the following verbs: get */
  (path: "/red-teams/runs"): RedTeamsList;
  /** Resource for '/red-teams/runs:run' has methods for the following verbs: post */
  (path: "/red-teams/runs:run"): RedTeamsCreateRun;
}
