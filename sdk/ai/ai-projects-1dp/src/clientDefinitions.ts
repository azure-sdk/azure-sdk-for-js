...
import type {
  ...
  EvaluationsCreateAgentRunAsyncParameters,
...
import type {
  ...
  EvaluationsCreateAgentRunAsync200Response,
  EvaluationsCreateAgentRunAsyncDefaultResponse,
  EvaluationsCheckAnnotation200Response,
  EvaluationsSubmitAnnotation202Response,
  EvaluationsOperationResults202Response,
...
export interface EvaluationsCreateAgentRunAsync {
  /** Creates an evaluation run for agent continuous evaluation. */
  post(
    options: EvaluationsCreateAgentRunAsyncParameters,
  ): StreamableMethod<
    | EvaluationsCreateAgentRunAsync200Response
    | EvaluationsCreateAgentRunAsyncDefaultResponse
  >;
...
export interface EvaluationsOperationResults {
  ...
  ): StreamableMethod<EvaluationsOperationResults202Response>;
}
...
export interface Routes {
  ...
  /** Resource for '/evaluations/runs:agents/submit' has methods for the following verbs: post */
  (path: "/evaluations/runs:agents/submit"): EvaluationsCreateAgentRunAsync;
