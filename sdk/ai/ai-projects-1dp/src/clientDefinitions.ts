...
import type {
  ...
  RunsListRunInputs200Response,
  RunsListRunInputsDefaultResponse,
...
export interface RunsListRunInputs {
  /** Lists the inputs for a specific run by its ID. */
  get(
    options?: RunsListRunInputsParameters,
  ): StreamableMethod<
    RunsListRunInputs200Response | RunsListRunInputsDefaultResponse
  >;
}
...
export interface Routes {
  ...
  /** Resource for '/agents/runs/run' has methods for the following verbs: post */
  (path: "/agents/runs/run"): AgentsRun;
  /** Resource for '/agents/runs/stream' has methods for the following verbs: post */
  (path: "/agents/runs/stream"): AgentsStream;
  ...
  /** Resource for '/runs/\{runId\}/listInputs' has methods for the following verbs: get */
  (path: "/runs/{runId}/listInputs", runId: string): RunsListRunInputs;
