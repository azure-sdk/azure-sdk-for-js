...
import type {
  ...
  DatasetsVersions200Response,
  DatasetsVersionsDefaultResponse,
  ...
  IndexesVersions200Response,
  IndexesVersionsDefaultResponse,
...
export interface DatasetsListVersions {
  ...
  post(
    options: DatasetsVersionsParameters,
  ): StreamableMethod<
    DatasetsVersions200Response | DatasetsVersionsDefaultResponse
  >;
}
...
export interface IndexesListVersions {
  ...
  post(
    options: IndexesVersionsParameters,
  ): StreamableMethod<
    IndexesVersions200Response | IndexesVersionsDefaultResponse
  >;
}
