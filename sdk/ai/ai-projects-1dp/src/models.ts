...
export interface TargetConfigParent {
  type: string;
}

/** Azure OpenAI model configuration. The API version would be selected by the service for querying the model. */
export interface AzureOpenAIModelConfiguration extends TargetConfigParent {
...
export type Index =
  ...
  | CosmosDBIndex;
/** Abstract class for target configuration. */
export type TargetConfig = TargetConfigParent | AzureOpenAIModelConfiguration;
