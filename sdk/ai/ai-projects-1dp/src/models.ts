...
export interface AgentToolOptionsParent {
  type: string;
}

/** Options for a function-based tool behavior. */
export interface FunctionToolOptions extends AgentToolOptionsParent {
...
export interface RunInputs {
  ...
  evaluators?: Array<EvaluatorInfo>;
}
...
/** Base type for any agent tool-specific options, used in a polymorphic manner. */
export type AgentToolOptions = AgentToolOptionsParent | FunctionToolOptions;
/** The base behavior for how an agent chooses among available tools. */
...
/** Alias for RunOutputsStatus */
export type RunOutputsStatus = string;
