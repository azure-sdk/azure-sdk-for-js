...
/** Evaluation definition for agent run. */
export interface AgentEvaluation {}

/** Agent API v2, completion message for agent run. */
export interface CompletionsMessage {}

/** Text content for completion message. */
...
/** Alias for AuthorRoleEnum */
export type AuthorRoleEnum = string;
