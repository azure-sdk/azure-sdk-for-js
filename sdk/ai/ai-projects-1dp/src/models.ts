...
export interface Evaluation {
  ...
  /** EvaluationResult Uri: output asset type. Uploaded for local runs. Example: azureml://registries/azureml/evaluationresults/name/{name}/version/{version} */
  evaluationResultId: string;
  /** Outputs of the evaluation as a dictionary of IDs. Example: { 'evaluationResultId': 'azureml://project/azureml/evaluationresults/myevaluationresult1', 'logId': 'azureml://project/azureml/datasets/joblogs' } */
