...
/** Dataset as source for evaluation. */
export interface RawDataset extends InputDataParent {
  type: "raw";
  /** The collection of context messages associated with this chat completions that need to be evaluated. */
  value: Array<ChatCompletions>;
  /** Raw Data's properties. Unlike tags, properties are add-only. Once added, a property cannot be removed. */
  properties?: Record<string, string>;
}
...
/** Abstract data class. */
export type InputData = InputDataParent | InputDataset | RawDataset;
/** DatasetVersion Definition */
