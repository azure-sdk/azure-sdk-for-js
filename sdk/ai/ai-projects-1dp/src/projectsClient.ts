 ...
 * @param endpointParam - Project endpoint. In the form "https://<your-ai-services-account-name>.services.ai.azure.com/api/projects/_project"
...
export default function createClient(
  ...
  { apiVersion = "2025-05-15-preview", ...options }: ProjectsClientOptions = {},
): ProjectsClient {
