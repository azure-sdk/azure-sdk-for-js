...
export interface DatasetsVersionsHeaders {
  /** An opaque, globally-unique, client-generated string identifier for the request. */
...
export interface DatasetsVersionsBodyParam {
  /** The definition of the DatasetVersion to create */
  body: DatasetVersion;
}

export interface DatasetsVersionsHeaderParam {
  headers?: RawHttpHeadersInput & DatasetsVersionsHeaders;
}

export type DatasetsVersionsParameters = DatasetsVersionsHeaderParam &
  DatasetsVersionsBodyParam &
  RequestParameters;
...
export interface IndexesVersionsHeaders {
  /** An opaque, globally-unique, client-generated string identifier for the request. */
  "Repeatability-Request-ID"?: string;
  /** Specifies the date and time at which the request was first created. */
  "Repeatability-First-Sent"?: string;
...
export interface IndexesVersionsBodyParam {
  /** The definition of the Index to create */
  body: Index;
}

export interface IndexesVersionsHeaderParam {
  headers?: RawHttpHeadersInput & IndexesVersionsHeaders;
}

export type IndexesVersionsParameters = IndexesVersionsHeaderParam &
  IndexesVersionsBodyParam &
  RequestParameters;
