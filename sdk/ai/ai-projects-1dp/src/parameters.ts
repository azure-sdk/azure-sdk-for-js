...
export interface RedTeamsJailbreakQueryParamProperties {
  /** Type of parameter. */
  type?: string;
}

export interface RedTeamsJailbreakQueryParam {
  queryParameters?: RedTeamsJailbreakQueryParamProperties;
}

export type RedTeamsJailbreakParameters = RedTeamsJailbreakQueryParam &
  RequestParameters;

export interface RedTeamsTemplateParametersQueryParamProperties {
  /** Type of parameter. */
  type?: string;
}

export interface RedTeamsTemplateParametersQueryParam {
  queryParameters?: RedTeamsTemplateParametersQueryParamProperties;
}

export type RedTeamsTemplateParametersParameters =
  RedTeamsTemplateParametersQueryParam & RequestParameters;

export interface RedTeamsTemplateParametersImageQueryParamProperties {
  /** Path for image. */
  path: string;
}

export interface RedTeamsTemplateParametersImageQueryParam {
  queryParameters: RedTeamsTemplateParametersImageQueryParamProperties;
}

export type RedTeamsTemplateParametersImageParameters =
  RedTeamsTemplateParametersImageQueryParam & RequestParameters;

export interface RedTeamsChatCompletionsSubmitBodyParam {
  /** Simulation request. */
  body: SimulationDTO;
}

export type RedTeamsChatCompletionsSubmitParameters =
  RedTeamsChatCompletionsSubmitBodyParam & RequestParameters;
