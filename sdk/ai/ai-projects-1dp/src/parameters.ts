...
export interface EvaluationsUploadRunQueryParamProperties {
  /** The API version to use for this operation. */
  "api-version": string;
}

export interface EvaluationsUploadRunQueryParam {
  queryParameters: EvaluationsUploadRunQueryParamProperties;
}

export type EvaluationsUploadRunParameters = EvaluationsUploadRunQueryParam &
  EvaluationsUploadRunBodyParam &
  RequestParameters;
