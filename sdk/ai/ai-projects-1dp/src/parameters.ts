...
export interface EvaluationsCreateAgentRunBodyParam {
  /** Agent evaluation to be run */
  body: AgentEvaluation;
}

export type EvaluationsCreateAgentRunParameters =
  EvaluationsCreateAgentRunBodyParam & RequestParameters;
...
export interface DatasetsFetchAssetCredentialsBodyParam {
  /** Input asset to fetch credentials for */
  body: AssetCredentialRequest;
}

export type DatasetsFetchAssetCredentialsParameters =
  DatasetsFetchAssetCredentialsBodyParam & RequestParameters;
...
export interface EvaluationResultsFetchAssetCredentialsBodyParam {
  /** Input asset to fetch credentials for */
  body: AssetCredentialRequest;
}

export type EvaluationResultsFetchAssetCredentialsParameters =
  EvaluationResultsFetchAssetCredentialsBodyParam & RequestParameters;
export type EvaluationResultsGetAgentEvaluationResultsParameters =
  RequestParameters;
