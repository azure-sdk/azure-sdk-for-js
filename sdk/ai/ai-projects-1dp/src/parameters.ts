...
export type RunsCreateRunParameters = RunsCreateRunBodyParam &
  RequestParameters;
...
export interface RunsCreateAndExecuteRunBodyParam {
  body: RunInputs;
}

export type RunsCreateAndExecuteRunParameters =
  RunsCreateAndExecuteRunBodyParam & RequestParameters;
...
export interface RunsListRunsHeaders {
  /** An opaque, globally-unique, client-generated string identifier for the request. */
  "x-ms-client-request-id"?: string;
}

export interface RunsListRunsHeaderParam {
  headers?: RawHttpHeadersInput & RunsListRunsHeaders;
}

export type RunsListRunsParameters = RunsListRunsHeaderParam &
  RequestParameters;
