...
export interface EvaluationsCreateAgentRunBodyParam {
  /** Agent evaluation with synchronous run */
...
export interface EvaluationsCreateAgentRunAsyncBodyParam {
  /** Agent evaluation with asynchronous run */
  body: AgentEvaluation;
}

export type EvaluationsCreateAgentRunAsyncParameters =
  EvaluationsCreateAgentRunAsyncBodyParam & RequestParameters;
