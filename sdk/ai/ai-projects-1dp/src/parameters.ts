...
export interface ConnectionsGetWithCredentialsQueryParamProperties {
  /** The API version to use for this operation. */
  "api-version": string;
}

export interface ConnectionsGetWithCredentialsQueryParam {
  queryParameters: ConnectionsGetWithCredentialsQueryParamProperties;
}
...
export type ConnectionsGetWithCredentialsParameters =
  ConnectionsGetWithCredentialsQueryParam &
...
export interface EvaluationsCreateQueryParamProperties {
  /** The API version to use for this operation. */
  "api-version": string;
}

export interface EvaluationsCreateQueryParam {
  queryParameters: EvaluationsCreateQueryParamProperties;
}

export type EvaluationsCreateParameters = EvaluationsCreateQueryParam &
...
export interface ModelsGetChatCompletionsHeaders {
  /**
...
export interface ModelsGetChatCompletionsBodyParam {
  /** The parameters of the chat completions request. */
  body: ChatCompletionsOptions;
}

export interface ModelsGetChatCompletionsQueryParamProperties {
  /** The API version to use for this operation. */
  "api-version": string;
}

export interface ModelsGetChatCompletionsQueryParam {
  queryParameters: ModelsGetChatCompletionsQueryParamProperties;
}

export interface ModelsGetChatCompletionsHeaderParam {
  headers?: RawHttpHeadersInput & ModelsGetChatCompletionsHeaders;
}

export type ModelsGetChatCompletionsParameters =
  ModelsGetChatCompletionsQueryParam &
    ModelsGetChatCompletionsHeaderParam &
    ModelsGetChatCompletionsBodyParam &
    RequestParameters;

export interface ModelsGetEmbeddingsHeaders {
  /**
   * Controls what happens if extra parameters, undefined by the REST API,
   * are passed in the JSON request payload.
   * This sets the HTTP request header `extra-parameters`.
...
export interface ModelsGetEmbeddingsBodyParam {
  /** The parameters of the embeddings request. */
  body: EmbeddingsOptions;
}

export interface ModelsGetEmbeddingsQueryParamProperties {
  /** The API version to use for this operation. */
  "api-version": string;
}

export interface ModelsGetEmbeddingsQueryParam {
  queryParameters: ModelsGetEmbeddingsQueryParamProperties;
}

export interface ModelsGetEmbeddingsHeaderParam {
  headers?: RawHttpHeadersInput & ModelsGetEmbeddingsHeaders;
}

export type ModelsGetEmbeddingsParameters = ModelsGetEmbeddingsQueryParam &
  ModelsGetEmbeddingsHeaderParam &
  ModelsGetEmbeddingsBodyParam &
  RequestParameters;

export interface ModelsGetImageEmbeddingsHeaders {
  /**
   * Controls what happens if extra parameters, undefined by the REST API,
   * are passed in the JSON request payload.
   * This sets the HTTP request header `extra-parameters`.
...
export interface ModelsGetImageEmbeddingsBodyParam {
  /** The parameters of the image embeddings request. */
  body: ImageEmbeddingsOptions;
}

export interface ModelsGetImageEmbeddingsQueryParamProperties {
  /** The API version to use for this operation. */
  "api-version": string;
}

export interface ModelsGetImageEmbeddingsQueryParam {
  queryParameters: ModelsGetImageEmbeddingsQueryParamProperties;
}

export interface ModelsGetImageEmbeddingsHeaderParam {
  headers?: RawHttpHeadersInput & ModelsGetImageEmbeddingsHeaders;
}

export type ModelsGetImageEmbeddingsParameters =
  ModelsGetImageEmbeddingsQueryParam &
    ModelsGetImageEmbeddingsHeaderParam &
    ModelsGetImageEmbeddingsBodyParam &
    RequestParameters;
