...
/** Paged collection of Connection items */
export interface ConnectionPagedOutput {
  /** The Connection items on this page */
  value: Array<ConnectionOutput>;
  /** The link to the next page of items */
  nextLink?: string;
...
export interface AgentEvaluationOutput {
  ...
  result?: Array<AgentEvaluationResultOutput>;
}

/** Result for the agent evaluation evaluator run. */
export interface AgentEvaluationResultOutput {
...
export interface RedTeamOutput {
  ...
  attackStrategies: AttackStrategyOutput[];
  ...
  targetConfig: TargetConfigOutput;
}

/** Abstract class for target configuration. */
export interface TargetConfigOutputParent {
  type: string;
}

/** Azure OpenAI model configuration. The API version would be selected by the service for querying the model. */
export interface AzureOpenAIModelConfigurationOutput
  extends TargetConfigOutputParent {
...
export type TargetConfigOutput =
  | TargetConfigOutputParent
  | AzureOpenAIModelConfigurationOutput;
