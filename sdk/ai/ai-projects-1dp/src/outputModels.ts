...
export interface ConnectionOutput {
  ...
  /** Credential used to connect to the external resource. */
  readonly credentials: BaseCredentialOutput;
  /**
   * Category of the connection
   *
   * Possible values: "AzureOpenAI", "AzureBlob", "CognitiveSearch", "CosmosDB", "ApiKey"
   */
  readonly category: ConnectionCategoryOutput;
...
/** PagedDataVersionBase Definition */
export interface PagedDatasetVersionOutput {
  /** The list of DatasetVersions. */
...
export interface DatasetVersionOutput {
...
export interface ChatResponseMessageOutput {
  ...
  audio?: ChatCompletionsAudioOutput;
}

/** A representation of the audio generated by the model. */
export interface ChatCompletionsAudioOutput {
  /**
   ...
   */
  format?: AudioContentFormatOutput;
...
export interface DeploymentOutput {
  /** Name of the deployment for the model */
  readonly deploymentName: string;
  /** Publisher-specific name of the model */
  readonly modelName: string;
  /** Publisher-specific version of the model */
  readonly modelVersion: string;
  /** Name of the model publisher */
  readonly publisher: string;
  /** Capabilities of model */
  readonly capabilities: Record<string, string>;
  /** RAI policy enabled for model */
...
export type BaseCredentialOutput =
  ...
  | AadCredentialOutput;
/** Abstract data class. */
export type InputDataOutput = InputDataOutputParent | DatasetOutput;
/** Index resource Definition */
...
/** Alias for ConnectionCategoryOutput */
export type ConnectionCategoryOutput = string;
...
/** Alias for AudioContentFormatOutput */
export type AudioContentFormatOutput = string;
