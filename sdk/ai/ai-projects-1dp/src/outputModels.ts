...
export interface ConnectionOutput {
  ...
  /** A collection of properties of the connection */
...
/** Dataset as source for evaluation. */
export interface RawDatasetOutput extends InputDataOutputParent {
  type: "raw";
  /** The collection of context messages associated with this chat completions that need to be evaluated. */
  value: Array<ChatCompletionsOutput>;
  readonly metric: Array<MetricOutput>;
...
export interface ChatCompletionsOutput {
  /** The collection of context messages associated with this chat completions that need to be evaluated. */
  messages: Array<ChatRequestMessageOutput>;
}

/** An abstract representation of a chat message as provided in a request. */
export interface ChatRequestMessageOutput {
  /**
 ...
 * response.
 */
export interface ChatRequestSystemMessageOutput
  extends ChatRequestMessageOutput {
...
export interface ChatRequestUserMessageOutput extends ChatRequestMessageOutput {
  /** The chat role associated with this message, which is always 'user' for user messages. */
  role: "user";
  /** The contents of the user message, with available input types varying by selected model. */
  content: string | Array<ChatMessageContentItemOutput>;
}

/** An abstract representation of a structured content item within a chat message. */
export interface ChatMessageContentItemOutput {
  /** The discriminated object type. */
  type: string;
}

/** A structured chat content item containing plain text. */
export interface ChatMessageTextContentItemOutput
  extends ChatMessageContentItemOutput {
...
export interface ChatMessageImageContentItemOutput
  extends ChatMessageContentItemOutput {
  ...
  image_url: ChatMessageImageUrlOutput;
}

/** An internet location from which the model may retrieve an image. */
export interface ChatMessageImageUrlOutput {
   ...
   */
  detail?: ChatMessageImageDetailLevelOutput;
}

/** A request chat message representing response or action from the assistant. */
export interface ChatRequestAssistantMessageOutput
  extends ChatRequestMessageOutput {
...
/** Alias for ChatMessageImageDetailLevelOutput */
export type ChatMessageImageDetailLevelOutput = string;
