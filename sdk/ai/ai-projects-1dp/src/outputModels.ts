...
export interface AgentEvaluationResultOutput {
  ...
  /** Status of the evaluation result. Options: Success, Failure, NotApplicable. */
  readonly status: string;
  ...
  /** Identifies message sent to or received from Generative AI model or agent. */
...
/** Long running operation response for agent evaluation. */
export interface AgentLongRunningOperationResponseOutput {
  /** URI for the long running operation. */
  readonly location: string;
  /** Result of the long running operation. */
  readonly operationResult?: any;
}
