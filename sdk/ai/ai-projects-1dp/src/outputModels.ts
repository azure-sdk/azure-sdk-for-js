...
export interface AgentToolOptionsOutput {
...
export interface AgentOutput {
  ...
  configurationOptions: AgentConfigurationOptionsOutput;
}

/** Options used when creating and an agent or completing a run without an existing agent. */
export interface AgentConfigurationOptionsOutput {
...
export interface RunInputsOutput {
  ...
  agentConfiguration?: AgentConfigurationOptionsOutput;
}
