...
export interface AgentOutput {
  ...
  instructions?: Array<ChatMessageOutput>;
...
export interface RunOutput {
  ...
  output: Array<ChatMessageOutput>;
...
export interface AgentOptionsOutput {
  /** The name of the agent; used for display purposes and sent to the LLM to identify the agent. */
  name?: string;
  /** The model definition for this agent. */
  agentModel: AgentModelOutput;
...
/** Paged collection of RunInputs items */
export interface PagedRunInputsOutput {
  /** The RunInputs items on this page */
  value: Array<RunInputsOutput>;
  /** The link to the next page of items */
  nextLink?: string;
}
