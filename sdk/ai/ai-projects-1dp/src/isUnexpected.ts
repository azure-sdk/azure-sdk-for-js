...
const responseMap: Record<string, string[]> = {
  ...
  "POST /connections/{connectionName}:getWithCredentials": ["200"],
  "GET /connections": ["200"],
  "GET /evaluations/{id}": ["200"],
  "POST /evaluations:create": ["201"],
  "GET /evaluations": ["200"],
  "GET /datasets": ["200"],
  "GET /datasets/{name}/versions": ["200"],
  "DELETE /datasets/{name}/versions/{version}": ["204"],
  "GET /datasets/{name}/versions/{version}": ["200"],
  "PUT /datasets/{name}/versions/{version}": ["200"],
  "POST /datasets/{name}/versions/{version}/startPendingUpload": ["200"],
  "POST /models/chat/completions": ["200"],
  "POST /models/embeddings": ["200"],
  "POST /models/images/embeddings": ["200"],
  "GET /indexes": ["200"],
  "GET /indexes/{name}/versions/{version}": ["200"],
  "DELETE /indexes/{name}/versions/{version}": ["204"],
  "POST /indexes/{name}:create": ["200", "201"],
...
export function isUnexpected(
  response:
    | ModelsGetChatCompletions200Response
    | ModelsGetChatCompletionsDefaultResponse,
): response is ModelsGetChatCompletionsDefaultResponse;
export function isUnexpected(
  response: ModelsGetEmbeddings200Response | ModelsGetEmbeddingsDefaultResponse,
): response is ModelsGetEmbeddingsDefaultResponse;
export function isUnexpected(
  response:
    | ModelsGetImageEmbeddings200Response
    | ModelsGetImageEmbeddingsDefaultResponse,
): response is ModelsGetImageEmbeddingsDefaultResponse;
export function isUnexpected(
...
export function isUnexpected(
  response:
    | IndexesListIndexVersions200Response
    | IndexesListIndexVersionsDefaultResponse,
): response is IndexesListIndexVersionsDefaultResponse;
export function isUnexpected(
