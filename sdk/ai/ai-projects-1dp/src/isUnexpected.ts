...
export function isUnexpected(
  response: DatasetsVersions200Response | DatasetsVersionsDefaultResponse,
): response is DatasetsVersionsDefaultResponse;
export function isUnexpected(
...
export function isUnexpected(
  response: IndexesVersions200Response | IndexesVersionsDefaultResponse,
): response is IndexesVersionsDefaultResponse;
export function isUnexpected(
