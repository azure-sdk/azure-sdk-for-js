...
const responseMap: Record<string, string[]> = {
  ...
  "POST /evaluations/runs:agents/submit": ["200"],
  "GET /evaluations/checkannotation": ["200"],
  "POST /evaluations/submitannotation": ["202"],
  "GET /evaluations/operations/{operationId}": ["202"],
...
export function isUnexpected(
  response:
    | EvaluationsCreateAgentRunAsync200Response
    | EvaluationsCreateAgentRunAsyncDefaultResponse,
): response is EvaluationsCreateAgentRunAsyncDefaultResponse;
export function isUnexpected(
  response:
    | EvaluationsUploadRun200Response
    | EvaluationsUploadRunDefaultResponse,
