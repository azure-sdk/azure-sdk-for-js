...
const responseMap: Record<string, string[]> = {
  ...
  "POST /agents/runs/run": ["200"],
  "POST /agents/runs/stream": ["200"],
  "GET /runs/{runId}": ["200"],
  "GET /runs": ["200"],
  "GET /runs/{runId}/listInputs": ["200"],
...
export function isUnexpected(
  response: RunsListRunInputs200Response | RunsListRunInputsDefaultResponse,
): response is RunsListRunInputsDefaultResponse;
export function isUnexpected(
