...
export interface IndexesGetLatest {
  ...
  ): StreamableMethod<IndexesGetLatest200Response | IndexesGetLatestDefaultResponse>;
}
...
export interface IndexesGetNextVersion {
  ...
  ): StreamableMethod<IndexesGetNextVersion200Response | IndexesGetNextVersionDefaultResponse>;
}
...
export interface IndexesListLatest {
  ...
  ): StreamableMethod<IndexesListLatest200Response | IndexesListLatestDefaultResponse>;
}
...
export interface PromptsGetLatest {
  ...
  ): StreamableMethod<PromptsGetLatest200Response | PromptsGetLatestDefaultResponse>;
}
...
export interface PromptsGetNextVersion {
  ...
  ): StreamableMethod<PromptsGetNextVersion200Response | PromptsGetNextVersionDefaultResponse>;
}
...
export interface PromptsListLatest {
  ...
  ): StreamableMethod<PromptsListLatest200Response | PromptsListLatestDefaultResponse>;
}
