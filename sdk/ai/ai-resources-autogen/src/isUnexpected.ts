...
export function isUnexpected(
  response: IndexesGetNextVersion200Response | IndexesGetNextVersionDefaultResponse,
...
export function isUnexpected(
  response: PromptsGetNextVersion200Response | PromptsGetNextVersionDefaultResponse,
