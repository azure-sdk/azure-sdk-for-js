 ...
 * @param endpointParam - Supported Azure-AI asset endpoints.
...
export default function createClient(
  ...
  { apiVersion = "2024-05-01-preview", ...options }: MachineLearningServicesClientOptions = {},
  ...
  const userAgentInfo = `azsdk-js-@azure-rest/ai-resources-autogen/1.0.0-beta.1`;
  ...
  const client = getClient(endpointUrl, credentials, options) as MachineLearningServicesClient;
