...
export function _createOrUpdateSend(
  context: Client,
  name: string,
  pendingUploadRequest: IndexUnion,
  version: string,
  ...
  return context
    ...
    .patch({
      ...
      body: indexUnionSerializer(pendingUploadRequest),
    });
}
...
export function _listSend(
  ...
  const path = expandUrlTemplate(
    "/indexes{?api%2Dversion,continuationToken}",
    {
      "api%2Dversion": context.apiVersion,
...
export function _listVersionsSend(
  ...
  const path = expandUrlTemplate(
    "/indexes/{name}/versions{?api%2Dversion,continuationToken}",
    {
      name: name,
      "api%2Dversion": context.apiVersion,
      continuationToken: options?.continuationToken,
