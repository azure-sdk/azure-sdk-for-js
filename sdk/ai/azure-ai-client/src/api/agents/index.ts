    ...
    toolResources:
      result.body.tool_resources === null
        ...
        : {
            ...
            bingGrounding: !result.body.tool_resources.bing_grounding
              ? undefined
              : {
                  connectionList:
                    result.body.tool_resources.bing_grounding?.[
                      "connections"
                    ] === undefined
                      ? result.body.tool_resources.bing_grounding?.[
                          "connections"
        ...
        toolResources:
          p.tool_resources === null
            ...
            : {
                ...
                bingGrounding: !p.tool_resources.bing_grounding
                  ? undefined
                  : {
                      connectionList:
                        p.tool_resources.bing_grounding?.["connections"] ===
                        undefined
                          ? p.tool_resources.bing_grounding?.["connections"]
                          : p.tool_resources.bing_grounding?.[
                              "connections"
                            ].map((p: any) => {
                              return { connectionId: p["connection_id"] };
                            }),
