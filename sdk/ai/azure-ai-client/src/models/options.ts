...
/** Optional parameters. */
export interface EndpointsListSecretsOptionalParams extends OperationOptions {}
...
/** Optional parameters. */
export interface EvaluationsCreateScheduleOptionalParams
  extends OperationOptions {}

/** Optional parameters. */
export interface EvaluationsGetScheduleOptionalParams
  extends OperationOptions {}

/** Optional parameters. */
export interface EvaluationsListSchedulesOptionalParams
  extends OperationOptions {
  /** The number of result items to return. */
  top?: number;
  /** The number of result items to skip. */
...
/** Optional parameters. */
export interface EvaluationsListScheduleEvaluationsOptionalParams
  extends OperationOptions {
  /** The number of result items to return. */
  top?: number;
  /** The number of result items to skip. */
