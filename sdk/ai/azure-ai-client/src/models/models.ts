...
export function updateEvaluationRequestSerializer(
  item: UpdateEvaluationRequest,
): Record<string, unknown> {
  return {
    tags: serializeRecord(item.tags as any) as any,
    displayName: item["displayName"],
    description: item["description"],
  };
}
...
export function evaluationScheduleSerializer(
  ...
  return {
    ...
    recurrence: !item.recurrence
      ? item.recurrence
      : recurrenceSerializer(item.recurrence),
...
export function recurrenceSerializer(
  item: Recurrence,
): Record<string, unknown> {
  return {
...
/** Paged evaluation schedule items */
export interface _PagedEvaluationSchedule {
  /** The list of Evaluation Schedules. */
...
export type EndpointType = "AzureOpenAI" | "Serverless";
