...
export interface AppInsightsConfiguration extends InputData {
  ...
  /** Service name. */
  serviceName: string;
  /** Connection String to connect to AppInsights. */
...
export interface EvaluationSchedule {
  /** Unique identifier for the evaluation, which also serves as the name for the schedule. */
  readonly id: string;
  /** Data for evaluation. */
  data: AppInsightsConfiguration;
  /** Description of the evaluation. It can be used to store additional information about the evaluation and is mutable. */
  description?: string;
  /** Metadata containing createdBy and modifiedBy information. */
  readonly systemData?: SystemData;
...
export function evaluationScheduleSerializer(
  ...
  return {
    data: appInsightsConfigurationSerializer(item.data),
    description: item["description"],
    tags: !item.tags ? item.tags : (serializeRecord(item.tags as any) as any),
    properties: !item.properties
      ? item.properties
