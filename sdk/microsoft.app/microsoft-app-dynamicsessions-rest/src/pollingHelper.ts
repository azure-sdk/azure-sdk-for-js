...
export async function getLongRunningPoller<
  TResult extends CodeExecutionExecuteLogicalResponse | CodeExecutionExecuteDefaultResponse,
>(
  client: Client,
  initialResponse: CodeExecutionExecute202Response | CodeExecutionExecuteDefaultResponse,
