...
export async function getLongRunningPoller<
  TResult extends ExecuteCodeLogicalResponse | ExecuteCodeDefaultResponse,
>(
  client: Client,
  initialResponse: ExecuteCode202Response | ExecuteCodeDefaultResponse,
