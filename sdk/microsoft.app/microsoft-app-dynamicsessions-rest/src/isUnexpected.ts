...
export function isUnexpected(
  response: SessionResourceFilesList200Response | SessionResourceFilesListDefaultResponse,
): response is SessionResourceFilesListDefaultResponse;
export function isUnexpected(
  response: SessionResourceFilesUpload200Response | SessionResourceFilesUploadDefaultResponse,
): response is SessionResourceFilesUploadDefaultResponse;
export function isUnexpected(
  response: SessionResourceFilesGet200Response | SessionResourceFilesGetDefaultResponse,
): response is SessionResourceFilesGetDefaultResponse;
export function isUnexpected(
  response: SessionResourceFilesDelete204Response | SessionResourceFilesDeleteDefaultResponse,
...
export function isUnexpected(
  response: SessionManagementGet200Response | SessionManagementGetDefaultResponse,
): response is SessionManagementGetDefaultResponse;
export function isUnexpected(
  response: SessionManagementDelete204Response | SessionManagementDeleteDefaultResponse,
): response is SessionManagementDeleteDefaultResponse;
export function isUnexpected(
  response: ListSessionsGet200Response | ListSessionsGetDefaultResponse,
): response is ListSessionsGetDefaultResponse;
export function isUnexpected(
  response: SessionPoolMetadataGet200Response | SessionPoolMetadataGetDefaultResponse,
): response is SessionPoolMetadataGetDefaultResponse;
export function isUnexpected(
  response:
    | CodeExecutionExecute202Response
    | CodeExecutionExecuteLogicalResponse
