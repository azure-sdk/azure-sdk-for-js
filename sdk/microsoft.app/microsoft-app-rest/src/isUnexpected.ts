...
const responseMap: Record<string, string[]> = {
  "POST /codeExecute": ["200"],
  "GET /codeExecutionResult": ["200"],
  "GET /files": ["200"],
  "GET /files/{fileName}": ["200"],
  "DELETE /files/{fileName}": ["204"],
  "GET /files/{fileName}/download": ["200"],
  "POST /files/{fileName}:uploadFile": ["200"],
};
...
export function isUnexpected(
  response:
    | GetCodeExecutionResult200Response
    | GetCodeExecutionResultDefaultResponse,
): response is GetCodeExecutionResultDefaultResponse;
export function isUnexpected(
