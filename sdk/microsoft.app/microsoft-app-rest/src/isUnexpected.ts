...
const responseMap: Record<string, string[]> = {
  "POST /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/sessionPools/{sessionPoolName}/code/execute":
    ["200"],
  "GET /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/sessionPools/{sessionPoolName}/files":
    ["200"],
...
export function isUnexpected(
  response: ListFileMetadata200Response | ListFileMetadataDefaultResponse,
): response is ListFileMetadataDefaultResponse;
export function isUnexpected(
