...
import { MongoClustersImpl } from "./operations";
import { MongoClusters } from "./operationsInterfaces";
import * as Parameters from "./models/parameters";
import * as Mappers from "./models/mappers";
import {
  CosmosDBMongoClusterOptionalParams,
  Operation,
...
export class CosmosDBMongoCluster extends coreClient.ServiceClient {
  ...
  /**
   * Initializes a new instance of the CosmosDBMongoCluster class.
  ...
  constructor(
    ...
    subscriptionId: string,
    options?: CosmosDBMongoClusterOptionalParams
  );
  constructor(
    credentials: coreAuth.TokenCredential,
    options?: CosmosDBMongoClusterOptionalParams
  ...
  constructor(
    credentials: coreAuth.TokenCredential,
    subscriptionIdOrOptions?: CosmosDBMongoClusterOptionalParams | string,
    options?: CosmosDBMongoClusterOptionalParams
  ) {
    ...
    const defaults: CosmosDBMongoClusterOptionalParams = {
      requestContentType: "application/json; charset=utf-8",
      credential: credentials
    };

    const packageDetails = `azsdk-js-arm-cosmosdb-mongocluster/1.0.0`;
