...
export interface RecommendationsListOptionalParams
  extends coreClient.OperationOptions {
  /** The filter to apply to the recommendations.<br>Filter can be applied to properties ['ResourceId', 'ResourceGroup', 'RecommendationTypeGuid', '[Category](#category)', '[Control](#control)', 'RetirementDate'] with operators ['eq', 'and', 'or', 'lt', 'gt', 'le', 'ge'].<br>Example:<br>- $filter=Category eq 'Cost' and ResourceGroup eq 'MyResourceGroup'<br>-$filter=Control eq 'ServiceUpgradeAndRetirement' and RetirementDate ge 2024-01-01T00:00:00Z */
  filter?: string;
