...
export interface ConfigData extends Resource {
  ...
  exclude?: boolean;
  /** Minimum percentage threshold for Advisor low CPU utilization evaluation. Valid only for subscriptions. Valid values: 5, 10, 15, 20 or 100 (default). */
...
/** Known values of {@link ConfigurationNameAutoGenerated} that the service accepts. */
export enum KnownConfigurationNameAutoGenerated {
  /** Duration */
  Duration = "duration"
}
 ...
 * {@link KnownConfigurationNameAutoGenerated} can be used interchangeably with ConfigurationNameAutoGenerated,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **duration**
 */
export type ConfigurationNameAutoGenerated = string;
...
/** Optional parameters. */
export interface ConfigurationsCreateInSubscriptionDurationOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the createInSubscriptionDuration operation. */
...
/** Optional parameters. */
export interface ConfigurationsCreateInResourceGroupDurationOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the createInResourceGroupDuration operation. */
