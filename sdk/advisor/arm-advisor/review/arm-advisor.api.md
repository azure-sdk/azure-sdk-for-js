...
export interface Configurations {
    ...
    createInResourceGroupDuration(resourceGroup: string, configurationName: ConfigurationName, configurationType: ConfigurationNameAutoGenerated, configContract: ConfigData, options?: ConfigurationsCreateInResourceGroupDurationOptionalParams): Promise<ConfigurationsCreateInResourceGroupDurationResponse>;
    ...
    createInSubscriptionDuration(configurationName: ConfigurationName, configurationType: ConfigurationNameAutoGenerated, configContract: ConfigData, options?: ConfigurationsCreateInSubscriptionDurationOptionalParams): Promise<ConfigurationsCreateInSubscriptionDurationResponse>;
