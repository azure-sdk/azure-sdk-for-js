...
export async function getLongRunningPoller<
  TResult extends EvaluateModelLogicalResponse | EvaluateModelDefaultResponse,
>(
  client: Client,
  initialResponse: EvaluateModel202Response | EvaluateModelDefaultResponse,
  options?: CreateHttpPollerOptions<TResult, OperationState<TResult>>,
): Promise<SimplePollerLike<OperationState<TResult>, TResult>>;
export async function getLongRunningPoller<
  TResult extends CancelTrainingJobLogicalResponse | CancelTrainingJobDefaultResponse,
>(
  client: Client,
  initialResponse: CancelTrainingJob202Response | CancelTrainingJobDefaultResponse,
  options?: CreateHttpPollerOptions<TResult, OperationState<TResult>>,
): Promise<SimplePollerLike<OperationState<TResult>, TResult>>;
export async function getLongRunningPoller<
  TResult extends DeleteProjectLogicalResponse | DeleteProjectDefaultResponse,
>(
  client: Client,
  initialResponse: DeleteProject202Response | DeleteProjectDefaultResponse,
  options?: CreateHttpPollerOptions<TResult, OperationState<TResult>>,
): Promise<SimplePollerLike<OperationState<TResult>, TResult>>;
export async function getLongRunningPoller<
  TResult extends CopyProjectLogicalResponse | CopyProjectDefaultResponse,
>(
  client: Client,
  initialResponse: CopyProject202Response | CopyProjectDefaultResponse,
  options?: CreateHttpPollerOptions<TResult, OperationState<TResult>>,
): Promise<SimplePollerLike<OperationState<TResult>, TResult>>;
export async function getLongRunningPoller<
...
export async function getLongRunningPoller<
  TResult extends ImportLogicalResponse | ImportDefaultResponse,
>(
  client: Client,
  initialResponse: Import202Response | ImportDefaultResponse,
  options?: CreateHttpPollerOptions<TResult, OperationState<TResult>>,
): Promise<SimplePollerLike<OperationState<TResult>, TResult>>;
export async function getLongRunningPoller<
  TResult extends SwapDeploymentsLogicalResponse | SwapDeploymentsDefaultResponse,
>(
  client: Client,
...
>(
  client: Client,
  initialResponse: DeployProject202Response | DeployProjectDefaultResponse,
  options?: CreateHttpPollerOptions<TResult, OperationState<TResult>>,
): Promise<SimplePollerLike<OperationState<TResult>, TResult>>;
export async function getLongRunningPoller<
  TResult extends DeleteDeploymentLogicalResponse | DeleteDeploymentDefaultResponse,
>(
  client: Client,
  initialResponse: DeleteDeployment202Response | DeleteDeploymentDefaultResponse,
  options?: CreateHttpPollerOptions<TResult, OperationState<TResult>>,
): Promise<SimplePollerLike<OperationState<TResult>, TResult>>;
export async function getLongRunningPoller<
  TResult extends
...
export async function getLongRunningPoller<
  TResult extends LoadSnapshotLogicalResponse | LoadSnapshotDefaultResponse,
>(
  client: Client,
  initialResponse: LoadSnapshot202Response | LoadSnapshotDefaultResponse,
  options?: CreateHttpPollerOptions<TResult, OperationState<TResult>>,
): Promise<SimplePollerLike<OperationState<TResult>, TResult>>;
export async function getLongRunningPoller<
  TResult extends
...
>(
  client: Client,
  initialResponse: AssignDeploymentResources202Response | AssignDeploymentResourcesDefaultResponse,
  options?: CreateHttpPollerOptions<TResult, OperationState<TResult>>,
): Promise<SimplePollerLike<OperationState<TResult>, TResult>>;
export async function getLongRunningPoller<
  TResult extends
...
export async function getLongRunningPoller<
  TResult extends DeleteExportedModelLogicalResponse | DeleteExportedModelDefaultResponse,
>(
  client: Client,
  initialResponse: DeleteExportedModel202Response | DeleteExportedModelDefaultResponse,
  options?: CreateHttpPollerOptions<TResult, OperationState<TResult>>,
): Promise<SimplePollerLike<OperationState<TResult>, TResult>>;
export async function getLongRunningPoller<
  TResult extends
