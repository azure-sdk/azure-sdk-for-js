...
export type CopyProjectAuthorizationParameters = CopyProjectAuthorizationBodyParam &
  RequestParameters;
...
export type DeleteDeploymentFromResourcesParameters = DeleteDeploymentFromResourcesBodyParam &
  RequestParameters;
...
export type GetModelEvaluationResultsParameters = GetModelEvaluationResultsQueryParam &
  RequestParameters;
...
export type ListDeploymentResourcesParameters = ListDeploymentResourcesQueryParam &
  RequestParameters;
...
export type AssignDeploymentResourcesParameters = AssignDeploymentResourcesBodyParam &
  RequestParameters;
...
export type UnassignDeploymentResourcesParameters = UnassignDeploymentResourcesBodyParam &
  RequestParameters;
...
export type ListAssignedResourceDeploymentsParameters = ListAssignedResourceDeploymentsQueryParam &
  RequestParameters;
...
export type GetSupportedPrebuiltEntitiesParameters = GetSupportedPrebuiltEntitiesQueryParam &
  RequestParameters;
...
export type CreateOrUpdateExportedModelParameters = CreateOrUpdateExportedModelBodyParam &
  RequestParameters;
