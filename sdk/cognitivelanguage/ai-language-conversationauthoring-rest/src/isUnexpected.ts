...
const responseMap: Record<string, string[]> = {
  "GET /authoring/analyze-conversations/projects": ["200"],
  "GET /authoring/analyze-conversations/projects/{projectName}": ["200"],
  "PATCH /authoring/analyze-conversations/projects/{projectName}": ["200", "201"],
  "DELETE /authoring/analyze-conversations/projects/{projectName}": ["202"],
  "POST /authoring/analyze-conversations/projects/{projectName}/:authorize-copy": ["200"],
  "GET /authoring/analyze-conversations/projects/{projectName}/:copy": ["200", "202"],
  "POST /authoring/analyze-conversations/projects/{projectName}/:copy": ["202"],
  "GET /authoring/analyze-conversations/projects/{projectName}/:export": ["200", "202"],
  "POST /authoring/analyze-conversations/projects/{projectName}/:export": ["202"],
  "GET /authoring/analyze-conversations/projects/{projectName}/:import": ["200", "202"],
  "POST /authoring/analyze-conversations/projects/{projectName}/:import": ["202"],
  "GET /authoring/analyze-conversations/projects/{projectName}/:train": ["200", "202"],
  "POST /authoring/analyze-conversations/projects/{projectName}/:train": ["202"],
  "GET /authoring/analyze-conversations/projects/{projectName}/copy/jobs/{jobId}": ["200"],
  "GET /authoring/analyze-conversations/projects/{projectName}/deployments": ["200"],
  "GET /authoring/analyze-conversations/projects/{projectName}/deployments/:swap": ["200", "202"],
  "POST /authoring/analyze-conversations/projects/{projectName}/deployments/:swap": ["202"],
  ...
  "GET /authoring/analyze-conversations/projects/{projectName}/deployments/{deploymentName}/:delete-from-resources":
    ["200", "202"],
  ...
  "GET /authoring/analyze-conversations/projects/{projectName}/export/jobs/{jobId}": ["200"],
  "GET /authoring/analyze-conversations/projects/{projectName}/import/jobs/{jobId}": ["200"],
  "GET /authoring/analyze-conversations/projects/{projectName}/models": ["200"],
  "GET /authoring/analyze-conversations/projects/{projectName}/models/{trainedModelLabel}": ["200"],
  "DELETE /authoring/analyze-conversations/projects/{projectName}/models/{trainedModelLabel}": [
    "204",
  ],
  "GET /authoring/analyze-conversations/projects/{projectName}/models/{trainedModelLabel}/:evaluate":
    ["200", "202"],
  "POST /authoring/analyze-conversations/projects/{projectName}/models/{trainedModelLabel}/:evaluate":
    ["202"],
  "GET /authoring/analyze-conversations/projects/{projectName}/models/{trainedModelLabel}/:load-snapshot":
    ["200", "202"],
  ...
  "GET /authoring/analyze-conversations/projects/{projectName}/models/{trainedModelLabel}/load-snapshot/jobs/{jobId}":
    ["200"],
  "GET /authoring/analyze-conversations/projects/{projectName}/resources": ["200"],
  "GET /authoring/analyze-conversations/projects/{projectName}/resources/:assign": ["200", "202"],
  "POST /authoring/analyze-conversations/projects/{projectName}/resources/:assign": ["202"],
  "GET /authoring/analyze-conversations/projects/{projectName}/resources/:unassign": ["200", "202"],
  "POST /authoring/analyze-conversations/projects/{projectName}/resources/:unassign": ["202"],
  ...
  "GET /authoring/analyze-conversations/projects/{projectName}/train/jobs": ["200"],
  "GET /authoring/analyze-conversations/projects/{projectName}/train/jobs/{jobId}": ["200"],
  "GET /authoring/analyze-conversations/projects/{projectName}/train/jobs/{jobId}/:cancel": [
    "200",
    "202",
  ],
  ...
  "GET /authoring/analyze-conversations/projects/global/deletion-jobs/{jobId}": ["200"],
  "GET /authoring/analyze-conversations/projects/global/deployments/resources": ["200"],
  "GET /authoring/analyze-conversations/projects/global/languages": ["200"],
  "GET /authoring/analyze-conversations/projects/global/prebuilt-entities": ["200"],
  "GET /authoring/analyze-conversations/projects/global/training-config-versions": ["200"],
  ...
  "PUT /authoring/analyze-conversations/projects/{projectName}/exported-models/{exportedModelName}":
    ["202"],
  "GET /authoring/analyze-conversations/projects/{projectName}/exported-models": ["200"],
...
export function isUnexpected(
  response: CreateProject200Response | CreateProject201Response | CreateProjectDefaultResponse,
): response is CreateProjectDefaultResponse;
export function isUnexpected(
  response: DeleteProject202Response | DeleteProjectLogicalResponse | DeleteProjectDefaultResponse,
): response is DeleteProjectDefaultResponse;
export function isUnexpected(
  response: CopyProjectAuthorization200Response | CopyProjectAuthorizationDefaultResponse,
): response is CopyProjectAuthorizationDefaultResponse;
export function isUnexpected(
  response: CopyProject202Response | CopyProjectLogicalResponse | CopyProjectDefaultResponse,
...
export function isUnexpected(
  response: GetCopyProjectStatus200Response | GetCopyProjectStatusDefaultResponse,
...
export function isUnexpected(
  response: DeployProject202Response | DeployProjectLogicalResponse | DeployProjectDefaultResponse,
...
export function isUnexpected(
  response: EvaluateModel202Response | EvaluateModelLogicalResponse | EvaluateModelDefaultResponse,
): response is EvaluateModelDefaultResponse;
export function isUnexpected(
  response: LoadSnapshot202Response | LoadSnapshotLogicalResponse | LoadSnapshotDefaultResponse,
...
export function isUnexpected(
  response: GetModelEvaluationResults200Response | GetModelEvaluationResultsDefaultResponse,
): response is GetModelEvaluationResultsDefaultResponse;
export function isUnexpected(
  response: GetModelEvaluationSummary200Response | GetModelEvaluationSummaryDefaultResponse,
): response is GetModelEvaluationSummaryDefaultResponse;
export function isUnexpected(
  response: GetLoadSnapshotStatus200Response | GetLoadSnapshotStatusDefaultResponse,
): response is GetLoadSnapshotStatusDefaultResponse;
export function isUnexpected(
  response: ListDeploymentResources200Response | ListDeploymentResourcesDefaultResponse,
...
export function isUnexpected(
  response: GetProjectDeletionStatus200Response | GetProjectDeletionStatusDefaultResponse,
...
export function isUnexpected(
  response: GetSupportedPrebuiltEntities200Response | GetSupportedPrebuiltEntitiesDefaultResponse,
...
export function isUnexpected(
  response: GetExportedModelJobStatus200Response | GetExportedModelJobStatusDefaultResponse,
