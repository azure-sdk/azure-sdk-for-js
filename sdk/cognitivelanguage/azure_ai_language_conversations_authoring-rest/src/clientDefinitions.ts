...
export interface Routes {
  /** Resource for '/authoring/analyze-conversations/projects' has methods for the following verbs: get */
  (path: "/authoring/analyze-conversations/projects"): ListProjects;
  /** Resource for '/authoring/analyze-conversations/projects/\{projectName\}' has methods for the following verbs: get, patch, delete */
  (
    path: "/authoring/analyze-conversations/projects/{projectName}",
    projectName: string,
  ): GetProject;
  /** Resource for '/authoring/analyze-conversations/projects/\{projectName\}/:authorize-copy' has methods for the following verbs: post */
  (
    path: "/authoring/analyze-conversations/projects/{projectName}/:authorize-copy",
    projectName: string,
  ): CopyProjectAuthorization;
  /** Resource for '/authoring/analyze-conversations/projects/\{projectName\}/:copy' has methods for the following verbs: post */
  (
    path: "/authoring/analyze-conversations/projects/{projectName}/:copy",
    projectName: string,
  ): CopyProject;
  /** Resource for '/authoring/analyze-conversations/projects/\{projectName\}/:export' has methods for the following verbs: post */
  (
    path: "/authoring/analyze-conversations/projects/{projectName}/:export",
    projectName: string,
  ): Export;
  /** Resource for '/authoring/analyze-conversations/projects/\{projectName\}/:import' has methods for the following verbs: post */
  (
    path: "/authoring/analyze-conversations/projects/{projectName}/:import",
    projectName: string,
  ): Import;
  /** Resource for '/authoring/analyze-conversations/projects/\{projectName\}/:train' has methods for the following verbs: post */
  (
    path: "/authoring/analyze-conversations/projects/{projectName}/:train",
    projectName: string,
  ): Train;
  /** Resource for '/authoring/analyze-conversations/projects/\{projectName\}/copy/jobs/\{jobId\}' has methods for the following verbs: get */
  (
    path: "/authoring/analyze-conversations/projects/{projectName}/copy/jobs/{jobId}",
    projectName: string,
    jobId: string,
  ): GetCopyProjectStatus;
  /** Resource for '/authoring/analyze-conversations/projects/\{projectName\}/deployments' has methods for the following verbs: get */
  (
    path: "/authoring/analyze-conversations/projects/{projectName}/deployments",
    projectName: string,
  ): ListDeployments;
  /** Resource for '/authoring/analyze-conversations/projects/\{projectName\}/deployments/:swap' has methods for the following verbs: post */
  (
    path: "/authoring/analyze-conversations/projects/{projectName}/deployments/:swap",
    projectName: string,
  ): SwapDeployments;
  /** Resource for '/authoring/analyze-conversations/projects/\{projectName\}/deployments/\{deploymentName\}' has methods for the following verbs: get, put, delete */
  (
    path: "/authoring/analyze-conversations/projects/{projectName}/deployments/{deploymentName}",
    projectName: string,
    deploymentName: string,
  ): GetDeployment;
  /** Resource for '/authoring/analyze-conversations/projects/\{projectName\}/deployments/\{deploymentName\}/:delete-from-resources' has methods for the following verbs: post */
  (
  ...
  /** Resource for '/authoring/analyze-conversations/projects/\{projectName\}/deployments/\{deploymentName\}/delete-from-resources/jobs/\{jobId\}' has methods for the following verbs: get */
  (
  ...
  /** Resource for '/authoring/analyze-conversations/projects/\{projectName\}/deployments/\{deploymentName\}/jobs/\{jobId\}' has methods for the following verbs: get */
  (
  ...
  /** Resource for '/authoring/analyze-conversations/projects/\{projectName\}/deployments/swap/jobs/\{jobId\}' has methods for the following verbs: get */
  (
    path: "/authoring/analyze-conversations/projects/{projectName}/deployments/swap/jobs/{jobId}",
    projectName: string,
    jobId: string,
  ): GetSwapDeploymentsStatus;
  /** Resource for '/authoring/analyze-conversations/projects/\{projectName\}/export/jobs/\{jobId\}' has methods for the following verbs: get */
  (
    path: "/authoring/analyze-conversations/projects/{projectName}/export/jobs/{jobId}",
    projectName: string,
    jobId: string,
  ): GetExportStatus;
  /** Resource for '/authoring/analyze-conversations/projects/\{projectName\}/import/jobs/\{jobId\}' has methods for the following verbs: get */
  (
    path: "/authoring/analyze-conversations/projects/{projectName}/import/jobs/{jobId}",
    projectName: string,
    jobId: string,
  ): GetImportStatus;
  /** Resource for '/authoring/analyze-conversations/projects/\{projectName\}/models' has methods for the following verbs: get */
  (
    path: "/authoring/analyze-conversations/projects/{projectName}/models",
    projectName: string,
  ): ListTrainedModels;
  /** Resource for '/authoring/analyze-conversations/projects/\{projectName\}/models/\{trainedModelLabel\}' has methods for the following verbs: get, delete */
  (
    path: "/authoring/analyze-conversations/projects/{projectName}/models/{trainedModelLabel}",
    projectName: string,
    trainedModelLabel: string,
  ): GetTrainedModel;
  /** Resource for '/authoring/analyze-conversations/projects/\{projectName\}/models/\{trainedModelLabel\}/:evaluate' has methods for the following verbs: post */
  (
    path: "/authoring/analyze-conversations/projects/{projectName}/models/{trainedModelLabel}/:evaluate",
    projectName: string,
    trainedModelLabel: string,
  ): EvaluateModel;
  /** Resource for '/authoring/analyze-conversations/projects/\{projectName\}/models/\{trainedModelLabel\}/:load-snapshot' has methods for the following verbs: post */
  (
    path: "/authoring/analyze-conversations/projects/{projectName}/models/{trainedModelLabel}/:load-snapshot",
    projectName: string,
    trainedModelLabel: string,
  ): LoadSnapshot;
  /** Resource for '/authoring/analyze-conversations/projects/\{projectName\}/models/\{trainedModelLabel\}/evaluate/jobs/\{jobId\}' has methods for the following verbs: get */
  (
  ...
  /** Resource for '/authoring/analyze-conversations/projects/\{projectName\}/models/\{trainedModelLabel\}/evaluation/result' has methods for the following verbs: get */
  (
  ...
  /** Resource for '/authoring/analyze-conversations/projects/\{projectName\}/models/\{trainedModelLabel\}/evaluation/summary-result' has methods for the following verbs: get */
  (
  ...
  /** Resource for '/authoring/analyze-conversations/projects/\{projectName\}/models/\{trainedModelLabel\}/load-snapshot/jobs/\{jobId\}' has methods for the following verbs: get */
  (
  ...
  /** Resource for '/authoring/analyze-conversations/projects/\{projectName\}/resources' has methods for the following verbs: get */
  (
    path: "/authoring/analyze-conversations/projects/{projectName}/resources",
    projectName: string,
  ): ListDeploymentResources;
  /** Resource for '/authoring/analyze-conversations/projects/\{projectName\}/resources/:assign' has methods for the following verbs: post */
  (
    path: "/authoring/analyze-conversations/projects/{projectName}/resources/:assign",
    projectName: string,
  ): AssignDeploymentResources;
  /** Resource for '/authoring/analyze-conversations/projects/\{projectName\}/resources/:unassign' has methods for the following verbs: post */
  (
    path: "/authoring/analyze-conversations/projects/{projectName}/resources/:unassign",
    projectName: string,
  ): UnassignDeploymentResources;
  /** Resource for '/authoring/analyze-conversations/projects/\{projectName\}/resources/assign/jobs/\{jobId\}' has methods for the following verbs: get */
  (
    path: "/authoring/analyze-conversations/projects/{projectName}/resources/assign/jobs/{jobId}",
    projectName: string,
    jobId: string,
  ): GetAssignDeploymentResourcesStatus;
  /** Resource for '/authoring/analyze-conversations/projects/\{projectName\}/resources/unassign/jobs/\{jobId\}' has methods for the following verbs: get */
  (
  ...
  /** Resource for '/authoring/analyze-conversations/projects/\{projectName\}/train/jobs' has methods for the following verbs: get */
  (
    path: "/authoring/analyze-conversations/projects/{projectName}/train/jobs",
    projectName: string,
  ): ListTrainingJobs;
  /** Resource for '/authoring/analyze-conversations/projects/\{projectName\}/train/jobs/\{jobId\}' has methods for the following verbs: get */
  (
    path: "/authoring/analyze-conversations/projects/{projectName}/train/jobs/{jobId}",
    projectName: string,
    jobId: string,
  ): GetTrainingStatus;
  /** Resource for '/authoring/analyze-conversations/projects/\{projectName\}/train/jobs/\{jobId\}/:cancel' has methods for the following verbs: post */
  (
    path: "/authoring/analyze-conversations/projects/{projectName}/train/jobs/{jobId}/:cancel",
    projectName: string,
    jobId: string,
  ): CancelTrainingJob;
  /** Resource for '/authoring/analyze-conversations/projects/global/deletion-jobs/\{jobId\}' has methods for the following verbs: get */
  (
    path: "/authoring/analyze-conversations/projects/global/deletion-jobs/{jobId}",
    jobId: string,
  ): GetProjectDeletionStatus;
  /** Resource for '/authoring/analyze-conversations/projects/global/deployments/resources' has methods for the following verbs: get */
  (
    path: "/authoring/analyze-conversations/projects/global/deployments/resources",
  ): ListAssignedResourceDeployments;
  /** Resource for '/authoring/analyze-conversations/projects/global/languages' has methods for the following verbs: get */
  (
    path: "/authoring/analyze-conversations/projects/global/languages",
  ): GetSupportedLanguages;
  /** Resource for '/authoring/analyze-conversations/projects/global/prebuilt-entities' has methods for the following verbs: get */
  (
    path: "/authoring/analyze-conversations/projects/global/prebuilt-entities",
  ): GetSupportedPrebuiltEntities;
  /** Resource for '/authoring/analyze-conversations/projects/global/training-config-versions' has methods for the following verbs: get */
  (
    path: "/authoring/analyze-conversations/projects/global/training-config-versions",
  ): ListTrainingConfigVersions;
  /** Resource for '/authoring/analyze-conversations/projects/\{projectName\}/exported-models/\{exportedModelName\}' has methods for the following verbs: get, delete, put */
  (
    path: "/authoring/analyze-conversations/projects/{projectName}/exported-models/{exportedModelName}",
    projectName: string,
    exportedModelName: string,
  ): GetExportedModel;
  /** Resource for '/authoring/analyze-conversations/projects/\{projectName\}/exported-models' has methods for the following verbs: get */
  (
    path: "/authoring/analyze-conversations/projects/{projectName}/exported-models",
    projectName: string,
  ): ListExportedModels;
  /** Resource for '/authoring/analyze-conversations/projects/\{projectName\}/exported-models/\{exportedModelName\}/jobs/\{jobId\}' has methods for the following verbs: get */
  (
