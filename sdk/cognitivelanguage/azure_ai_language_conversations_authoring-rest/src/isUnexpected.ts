...
const responseMap: Record<string, string[]> = {
  ...
  "POST /authoring/analyze-conversations/projects/{projectName}/:authorize-copy":
    ["200"],
  "GET /authoring/analyze-conversations/projects/{projectName}/:copy": [
    "200",
    "202",
  ],
  "POST /authoring/analyze-conversations/projects/{projectName}/:copy": ["202"],
  "GET /authoring/analyze-conversations/projects/{projectName}/:export": [
    "200",
    "202",
  ],
  ...
  "GET /authoring/analyze-conversations/projects/{projectName}/:import": [
    "200",
    "202",
  ],
  ...
  "GET /authoring/analyze-conversations/projects/{projectName}/:train": [
    "200",
    "202",
  ],
  ...
  "GET /authoring/analyze-conversations/projects/{projectName}/deployments/:swap":
    ["200", "202"],
  ...
  "GET /authoring/analyze-conversations/projects/{projectName}/resources/:assign":
    ["200", "202"],
  "POST /authoring/analyze-conversations/projects/{projectName}/resources/:assign":
    ["202"],
  "GET /authoring/analyze-conversations/projects/{projectName}/resources/:unassign":
    ["200", "202"],
