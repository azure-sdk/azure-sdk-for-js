 ...
 * @param endpointParam - Supported Cognitive Services endpoint e.g., https://<resource-name>.api.cognitiveservices.azure.com.
...
export default function createClient(
  ...
  const userAgentInfo = `azsdk-js-azure-ai-language-conversations-authoring-rest/1.0.0-beta.1`;
