...
import type {
  PagedTextAnalysisAuthoringProjectMetadataOutput,
  ErrorResponseOutput,
  TextAnalysisAuthoringProjectMetadataOutput,
  TextAnalysisAuthoringCopyProjectOptionsOutput,
  TextAnalysisAuthoringCopyProjectJobStateOutput,
  PagedTextAnalysisAuthoringProjectDeploymentOutput,
  TextAnalysisAuthoringProjectDeploymentOutput,
  TextAnalysisAuthoringDeploymentDeleteFromResourcesJobStateOutput,
  TextAnalysisAuthoringDeploymentJobStateOutput,
  TextAnalysisAuthoringSwapDeploymentsJobStateOutput,
  TextAnalysisAuthoringExportProjectJobStateOutput,
  PagedTextAnalysisAuthoringExportedTrainedModelOutput,
  TextAnalysisAuthoringExportedTrainedModelOutput,
  TextAnalysisAuthoringExportedModelJobStateOutput,
  TextAnalysisAuthoringExportedModelManifestOutput,
  TextAnalysisAuthoringImportProjectJobStateOutput,
  PagedTextAnalysisAuthoringProjectTrainedModelOutput,
  TextAnalysisAuthoringProjectTrainedModelOutput,
  TextAnalysisAuthoringEvaluationJobStateOutput,
  PagedTextAnalysisAuthoringDocumentEvaluationResultOutput,
  TextAnalysisAuthoringEvaluationSummaryOutput,
  TextAnalysisAuthoringLoadSnapshotJobStateOutput,
  PagedTextAnalysisAuthoringAssignedDeploymentResourceOutput,
  TextAnalysisAuthoringAssignDeploymentResourcesJobStateOutput,
  TextAnalysisAuthoringUnassignDeploymentResourcesJobStateOutput,
  PagedTextAnalysisAuthoringTrainingJobStateOutput,
  TextAnalysisAuthoringTrainingJobStateOutput,
  TextAnalysisAuthoringProjectDeletionJobStateOutput,
  PagedTextAnalysisAuthoringAssignedProjectDeploymentsMetadataOutput,
  PagedTextAnalysisAuthoringSupportedLanguageOutput,
  PagedTextAnalysisAuthoringPrebuiltEntityOutput,
  PagedTextAnalysisAuthoringTrainingConfigVersionOutput,
