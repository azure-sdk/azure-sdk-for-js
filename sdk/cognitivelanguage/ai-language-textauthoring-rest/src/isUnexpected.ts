...
const responseMap: Record<string, string[]> = {
  ...
  "POST /authoring/analyze-text/projects/{projectName}/:authorize-copy": ["200"],
  ...
  "GET /authoring/analyze-text/projects/{projectName}/copy/jobs/{jobId}": ["200"],
  ...
  "GET /authoring/analyze-text/projects/{projectName}/exported-models/{exportedModelName}": ["200"],
  "PUT /authoring/analyze-text/projects/{projectName}/exported-models/{exportedModelName}": ["202"],
  ...
  "GET /authoring/analyze-text/projects/{projectName}/resources/:assign": ["200", "202"],
  "POST /authoring/analyze-text/projects/{projectName}/resources/:assign": ["202"],
  "GET /authoring/analyze-text/projects/{projectName}/resources/:unassign": ["200", "202"],
  ...
  "GET /authoring/analyze-text/projects/{projectName}/train/jobs/{jobId}/:cancel": ["200", "202"],
...
export function isUnexpected(
  response: GetExportedModelManifest200Response | GetExportedModelManifestDefaultResponse,
