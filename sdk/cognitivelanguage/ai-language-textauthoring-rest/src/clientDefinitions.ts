...
export interface GetProject {
  ...
  patch(
    ...
    CreateProject200Response | CreateProject201Response | CreateProjectDefaultResponse
  >;
  /** Deletes a project. */
  delete(
...
export interface CopyProjectAuthorization {
  ...
  post(
    ...
    CopyProjectAuthorization200Response | CopyProjectAuthorizationDefaultResponse
  >;
}
...
export interface GetCopyProjectStatus {
  ...
  ): StreamableMethod<GetCopyProjectStatus200Response | GetCopyProjectStatusDefaultResponse>;
}
...
export interface DeleteDeploymentFromResources {
  ...
  post(
    ...
    DeleteDeploymentFromResources202Response | DeleteDeploymentFromResourcesDefaultResponse
  >;
}
...
export interface GetExportStatus {
  ...
  ): StreamableMethod<GetExportStatus200Response | GetExportStatusDefaultResponse>;
}
...
export interface ListExportedModels {
  ...
  ): StreamableMethod<ListExportedModels200Response | ListExportedModelsDefaultResponse>;
}
...
export interface GetExportedModel {
  ...
  ): StreamableMethod<GetExportedModel200Response | GetExportedModelDefaultResponse>;
  /** Creates a new exported model or replaces an existing one. */
  put(
    options: CreateOrUpdateExportedModelParameters,
  ): StreamableMethod<
    CreateOrUpdateExportedModel202Response | CreateOrUpdateExportedModelDefaultResponse
  >;
  /** Deletes an existing exported model. */
  delete(
    options?: DeleteExportedModelParameters,
  ): StreamableMethod<DeleteExportedModel202Response | DeleteExportedModelDefaultResponse>;
}
...
export interface GetExportedModelJobStatus {
  ...
  get(
    ...
    GetExportedModelJobStatus200Response | GetExportedModelJobStatusDefaultResponse
  >;
}
...
export interface GetExportedModelManifest {
  ...
  get(
    ...
    GetExportedModelManifest200Response | GetExportedModelManifestDefaultResponse
  >;
}
...
export interface GetImportStatus {
  ...
  ): StreamableMethod<GetImportStatus200Response | GetImportStatusDefaultResponse>;
}
...
export interface ListTrainedModels {
  ...
  ): StreamableMethod<ListTrainedModels200Response | ListTrainedModelsDefaultResponse>;
}
...
export interface GetTrainedModel {
  ...
  ): StreamableMethod<GetTrainedModel200Response | GetTrainedModelDefaultResponse>;
  /** Deletes an existing trained model. */
  delete(
    options?: DeleteTrainedModelParameters,
  ): StreamableMethod<DeleteTrainedModel204Response | DeleteTrainedModelDefaultResponse>;
}
...
export interface GetEvaluationStatus {
  ...
  ): StreamableMethod<GetEvaluationStatus200Response | GetEvaluationStatusDefaultResponse>;
}
...
export interface GetModelEvaluationResults {
  ...
  get(
    ...
    GetModelEvaluationResults200Response | GetModelEvaluationResultsDefaultResponse
  >;
}
...
export interface GetModelEvaluationSummary {
  ...
  get(
    ...
    GetModelEvaluationSummary200Response | GetModelEvaluationSummaryDefaultResponse
  >;
}
...
export interface GetLoadSnapshotStatus {
  ...
  ): StreamableMethod<GetLoadSnapshotStatus200Response | GetLoadSnapshotStatusDefaultResponse>;
}
...
export interface ListDeploymentResources {
  ...
  ): StreamableMethod<ListDeploymentResources200Response | ListDeploymentResourcesDefaultResponse>;
}
...
export interface AssignDeploymentResources {
  ...
  post(
    ...
    AssignDeploymentResources202Response | AssignDeploymentResourcesDefaultResponse
  >;
}
...
export interface UnassignDeploymentResources {
  ...
  post(
    ...
    UnassignDeploymentResources202Response | UnassignDeploymentResourcesDefaultResponse
  >;
}
...
export interface ListTrainingJobs {
  ...
  ): StreamableMethod<ListTrainingJobs200Response | ListTrainingJobsDefaultResponse>;
}
...
export interface GetTrainingStatus {
  ...
  ): StreamableMethod<GetTrainingStatus200Response | GetTrainingStatusDefaultResponse>;
}
...
export interface CancelTrainingJob {
  ...
  ): StreamableMethod<CancelTrainingJob202Response | CancelTrainingJobDefaultResponse>;
}
...
export interface GetProjectDeletionStatus {
  ...
  get(
    ...
    GetProjectDeletionStatus200Response | GetProjectDeletionStatusDefaultResponse
  >;
}
...
export interface ListAssignedResourceDeployments {
  ...
  get(
    ...
    ListAssignedResourceDeployments200Response | ListAssignedResourceDeploymentsDefaultResponse
  >;
}
...
export interface GetSupportedPrebuiltEntities {
  ...
  get(
    ...
    GetSupportedPrebuiltEntities200Response | GetSupportedPrebuiltEntitiesDefaultResponse
  >;
}
