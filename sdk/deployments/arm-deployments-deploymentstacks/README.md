# Azure DeploymentStacks client library for JavaScript
...
[Source code](https://github.com/Azure/azure-sdk-for-js/tree/main/sdk/deployments/arm-deployments-deploymentstacks) |
[Package (NPM)](https://www.npmjs.com/package/@azure/arm-deployments-deploymentstacks) |
[API reference documentation](https://learn.microsoft.com/javascript/api/@azure/arm-deployments-deploymentstacks) |
...
### Install the `@azure/arm-deployments-deploymentstacks` package

Install the Azure DeploymentStacks client library for JavaScript with `npm`:

```bash
npm install @azure/arm-deployments-deploymentstacks
```
...
import { DeploymentStacksClient } from "@azure/arm-deployments-deploymentstacks";
