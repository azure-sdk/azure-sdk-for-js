...
export class DeploymentStacksImpl implements DeploymentStacks {
  ...
  async beginDeleteAtSubscriptionAndWait(
    ...
    const poller = await this.beginDeleteAtSubscription(deploymentStackName, options);
    return poller.pollUntilDone();
  }
...
const createOrUpdateAtSubscriptionOperationSpec: coreClient.OperationSpec = {
  ...
  requestBody: Parameters.deploymentStack,
  queryParameters: [Parameters.apiVersion],
  urlParameters: [Parameters.$host, Parameters.subscriptionId, Parameters.deploymentStackName],
  headerParameters: [Parameters.accept, Parameters.contentType],
  mediaType: "json",
  serializer,
};
...
const createOrUpdateAtManagementGroupOperationSpec: coreClient.OperationSpec = {
  ...
  requestBody: Parameters.deploymentStack,
  queryParameters: [Parameters.apiVersion],
  urlParameters: [Parameters.$host, Parameters.managementGroupId, Parameters.deploymentStackName],
  headerParameters: [Parameters.accept, Parameters.contentType],
  mediaType: "json",
  serializer,
};
