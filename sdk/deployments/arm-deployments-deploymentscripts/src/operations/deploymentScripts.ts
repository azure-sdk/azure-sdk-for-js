...
import { DeploymentScriptsClient } from "../deploymentScriptsClient.js";
...
export class DeploymentScriptsImpl implements DeploymentScripts {
  ...
  async beginCreateAndWait(
    ...
    const poller = await this.beginCreate(resourceGroupName, scriptName, deploymentScript, options);
