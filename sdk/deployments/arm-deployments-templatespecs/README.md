...
[Source code](https://github.com/Azure/azure-sdk-for-js/tree/main/sdk/deployments/arm-deployments-templatespecs) |
[Package (NPM)](https://www.npmjs.com/package/@azure/arm-deployments-templatespecs) |
[API reference documentation](https://learn.microsoft.com/javascript/api/@azure/arm-deployments-templatespecs) |
...
### Install the `@azure/arm-deployments-templatespecs` package

Install the Azure TemplateSpecs client library for JavaScript with `npm`:

```bash
npm install @azure/arm-deployments-templatespecs
```
...
import { TemplateSpecsClient } from "@azure/arm-deployments-templatespecs";
