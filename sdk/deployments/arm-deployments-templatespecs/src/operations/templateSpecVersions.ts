...
export class TemplateSpecVersionsImpl implements TemplateSpecVersions {
  ...
  private async *listBuiltInsPagingPage(
    ...
    while (continuationToken) {
      result = await this._listBuiltInsNext(templateSpecName, continuationToken, options);
      continuationToken = result.nextLink;
      let page = result.value || [];
      setContinuationToken(page, continuationToken);
      yield page;
  ...
  private async *listBuiltInsPagingAll(
    ...
    for await (const page of this.listBuiltInsPagingPage(templateSpecName, options)) {
      yield* page;
    }
  }
...
const getBuiltInOperationSpec: coreClient.OperationSpec = {
  ...
  queryParameters: [Parameters.apiVersion],
  urlParameters: [Parameters.$host, Parameters.templateSpecName, Parameters.templateSpecVersion],
  headerParameters: [Parameters.accept],
  serializer,
};
...
const listBuiltInsNextOperationSpec: coreClient.OperationSpec = {
  ...
  urlParameters: [Parameters.$host, Parameters.templateSpecName, Parameters.nextLink],
  headerParameters: [Parameters.accept],
  serializer,
};
