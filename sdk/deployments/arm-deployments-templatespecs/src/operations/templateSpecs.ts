...
export class TemplateSpecsImpl implements TemplateSpecs {
  ...
  getBuiltIn(
    ...
    return this.client.sendOperationRequest({ templateSpecName, options }, getBuiltInOperationSpec);
  }
  ...
  private _listBuiltIns(
    ...
    return this.client.sendOperationRequest({ options }, listBuiltInsOperationSpec);
  }
  ...
  private _listBuiltInsNext(
    ...
    return this.client.sendOperationRequest({ nextLink, options }, listBuiltInsNextOperationSpec);
  }
}
