...
export class DeploymentsImpl implements Deployments {
  ...
  async beginValidate(
    ...
    SimplePollerLike<OperationState<DeploymentsValidateResponse>, DeploymentsValidateResponse>
  > {
    const directSendOperation = async (
      args: coreClient.OperationArguments,
      spec: coreClient.OperationSpec,
  ...
  async beginWhatIf(
    ...
    SimplePollerLike<OperationState<DeploymentsWhatIfResponse>, DeploymentsWhatIfResponse>
  > {
    const directSendOperation = async (
      args: coreClient.OperationArguments,
      spec: coreClient.OperationSpec,
