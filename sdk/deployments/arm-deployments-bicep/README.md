...
[Source code](https://github.com/Azure/azure-sdk-for-js/tree/main/sdk/deployments/arm-deployments-bicep) |
[Package (NPM)](https://www.npmjs.com/package/@azure/arm-deployments-bicep) |
[API reference documentation](https://learn.microsoft.com/javascript/api/@azure/arm-deployments-bicep) |
...
### Install the `@azure/arm-deployments-bicep` package

Install the Azure Bicep client library for JavaScript with `npm`:

```bash
npm install @azure/arm-deployments-bicep
```
...
import { BicepClient } from "@azure/arm-deployments-bicep";
