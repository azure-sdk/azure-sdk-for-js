...
export function _$deleteSend(
  ...
  resourceName: string,
  connectionName: string,
  options: ConnectionSettingsDeleteOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
...
export function _updateSend(
  ...
  options: ConnectionSettingsUpdateOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BotService/botServices/{resourceName}/connections/{connectionName}{?api%2Dversion}",
    {
...
export function _createSend(
  ...
  connectionName: string,
  parameters: ConnectionSetting,
  options: ConnectionSettingsCreateOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BotService/botServices/{resourceName}/connections/{connectionName}{?api%2Dversion}",
    {
...
export function _getSend(
  ...
  resourceName: string,
  connectionName: string,
  options: ConnectionSettingsGetOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BotService/botServices/{resourceName}/connections/{connectionName}{?api%2Dversion}",
    {
