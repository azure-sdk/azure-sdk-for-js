...
## 7.0.0-beta.1 (2024-09-10)
Compared with version 6.0.0
    
### Features Added

  - Added operation group DeletedVaults
  - Added Interface DeletedVault
  - Added Interface DeletedVaultList
  ...
  - Added Interface DeletedVaultsListBySubscriptionIdNextOptionalParams
  - Added Interface DeletedVaultsListBySubscriptionIdOptionalParams
  - Added Interface DeletedVaultsUndeleteHeaders
  ...
  - Added Type Alias DeletedVaultsGetOperationStatusResponse
  - Added Type Alias DeletedVaultsGetResponse
  - Added Type Alias DeletedVaultsListBySubscriptionIdNextResponse
  - Added Type Alias DeletedVaultsListBySubscriptionIdResponse
  - Added Type Alias DeletedVaultsUndeleteResponse

### Breaking Changes

  - Class RecoveryServicesClient has a new signature
