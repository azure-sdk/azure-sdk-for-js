...
/** ARM Resource. */
export interface RecoveryServicesResource {
  /**
   * Resource Id represents the complete path to the resource.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
...
export interface RecoveryServicesTrackedResource
  extends RecoveryServicesResource {
  /** Resource location. */
  location: string;
  /** Resource tags. */
...
/** Tracked resource with location. */
export interface PatchTrackedResource extends RecoveryServicesResource {
  /** Resource location. */
  location?: string;
  /** Resource tags. */
  tags?: { [propertyName: string]: string };
...
export interface VaultExtendedInfoResource extends RecoveryServicesResource {
  /** Integrity key. */
  integrityKey?: string;
  /** Encryption key. */
...
export interface Vault extends RecoveryServicesTrackedResource {
  /** Identity for the resource. */
