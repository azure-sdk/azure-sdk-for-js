...
**Features**
  ...
  - Interface CertificateProperties has a new optional parameter domainControlValidation
  - Interface CertificateProperties has a new optional parameter error
  - Interface CertificateProperties has a new optional parameter subjectAlternativeNames
  - Interface CertificateProperties has a new optional parameter validationToken
