  ...
  type: {
    ...
    modelProperties: {
      ...
      ipSecurityRestrictionRules: {
        serializedName: "ipSecurityRestrictionRules",
        type: {
          name: "Sequence",
          element: {
            type: {
              name: "Composite",
              className: "IpSecurityRestrictionRules"
            }
          }
        }
      },
...
export const IpSecurityRestrictionRules: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "IpSecurityRestrictionRules",
    modelProperties: {
...
export const TrafficLabel: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "TrafficLabel",
    modelProperties: {
      label: {
        serializedName: "label",
        readOnly: true,
...
export const Revision: coreClient.CompositeMapper = {
  type: {
    ...
    modelProperties: {
      ...
      trafficLabels: {
        serializedName: "properties.trafficLabels",
        readOnly: true,
        type: {
          name: "Sequence",
          element: {
