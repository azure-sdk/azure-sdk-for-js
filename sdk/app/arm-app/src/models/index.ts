...
export interface EnvironmentSkuProperties {
  /** Name of the Sku. */
  name: SkuType;
  /** Capacity of the SKU (number of deployed nodes of the SKU). For Consumption SKU capacity must be specified as 0. */
  capacity: number;
}
...
export type Revision = ProxyResource & {
   ...
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly trafficLabels?: TrafficLabel[];
  /**
...
export type Diagnostics = ProxyResource & {
  /** Diagnostics resource specific properties */
...
export type ConnectedEnvironmentStorage = ProxyResource & {
  /** Storage properties */
...
export type ConnectedEnvironment = TrackedResource & {
  /** The complex type of the extended location. */
  extendedLocation?: ExtendedLocation;
  /**
...
/** Known values of {@link WorkloadProfileType} that the service accepts. */
export enum KnownWorkloadProfileType {
 ...
 * {@link KnownWorkloadProfileType} can be used interchangeably with WorkloadProfileType,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **General Purpose** \
 * **Memory Optimized** \
 * **Compute Optimized**
 */
export type WorkloadProfileType = string;
