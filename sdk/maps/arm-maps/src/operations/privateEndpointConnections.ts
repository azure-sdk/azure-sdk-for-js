...
export class PrivateEndpointConnectionsImpl
  ...
  /**
   * Gets the specified private endpoint connection associated with the Map Account.
   * @param resourceGroupName The name of the resource group. The name is case insensitive.
   * @param accountName The name of the Maps Account.
  ...
  /**
   * Create or update the state of specified private endpoint connection associated with the Map account.
   * @param resourceGroupName The name of the resource group. The name is case insensitive.
   * @param accountName The name of the Maps Account.
   * @param privateEndpointConnectionName The name of the Private Endpoint Connection.
  ...
  async beginCreate(
    ...
    accountName: string,
    privateEndpointConnectionName: string,
    properties: PrivateEndpointConnectionAutoGenerated,
  ...
  /**
   * Deletes the specified private endpoint connection associated with the Map account.
   * @param resourceGroupName The name of the resource group. The name is case insensitive.
   * @param accountName The name of the Maps Account.
   * @param privateEndpointConnectionName The name of the Private Endpoint Connection.
   * @param options The options parameters.
