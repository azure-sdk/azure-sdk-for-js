...
export interface MapsAccountProperties {
  ...
  /**
   * List of private endpoint connections associated with the Map Account.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly privateEndpointConnections?: PrivateEndpointConnection[];
  /** Property to specify whether the Map account will accept traffic from public internet. If set to 'disabled' all traffic except private endpoint traffic and that that originates from trusted services will be blocked. */
...
/** A list of private link resources for a map account resource type. */
export interface PrivateLinkResourceList {
  /** The list of the private link resources which can be used for map account. */
  value?: PrivateLinkResource[];
  /**
   * Request URL that can be used to query next page of private link resources. Returned when the total number of requested private resources exceed maximum page size.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly nextLink?: string;
}
