 ...
 * x-ms-original-file: specification/network/resource-manager/Microsoft.Network/stable/2024-05-01/examples/ReachabilityAnalysisRunPut.json
 */
async function reachabilityAnalysisRunCreate(): Promise<void> {
  ...
  const body: ReachabilityAnalysisRun = {
    properties: {
