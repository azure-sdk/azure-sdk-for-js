 ...
 * x-ms-original-file: specification/network/resource-manager/Microsoft.Network/stable/2024-05-01/examples/IpamPools_List.json
 */
async function ipamPoolsList(): Promise<void> {
  ...
  for await (let item of client.ipamPools.list(
    resourceGroupName,
    networkManagerName,
  )) {
    resArray.push(item);
