...
// @public
export interface GetSessionRecordingSasUrlOptionalParams extends coreClient.OperationOptions {
    resumeFrom?: string;
    updateIntervalInMs?: number;
}
...
export class NetworkManagementClient extends coreClient.ServiceClient {
    ...
    beginGetSessionRecordingSasUrl(resourceGroupName: string, bastionHostName: string, options?: GetSessionRecordingSasUrlOptionalParams): Promise<SimplePollerLike<OperationState<GetSessionRecordingSasUrlResponse>, GetSessionRecordingSasUrlResponse>>;
    beginGetSessionRecordingSasUrlAndWait(resourceGroupName: string, bastionHostName: string, options?: GetSessionRecordingSasUrlOptionalParams): Promise<GetSessionRecordingSasUrlResponse>;
    ...
    beginSetSessionRecordingSasUrl(resourceGroupName: string, bastionHostName: string, sasurl: string, options?: SetSessionRecordingSasUrlOptionalParams): Promise<SimplePollerLike<OperationState<SetSessionRecordingSasUrlOperationResponse>, SetSessionRecordingSasUrlOperationResponse>>;
    beginSetSessionRecordingSasUrlAndWait(resourceGroupName: string, bastionHostName: string, sasurl: string, options?: SetSessionRecordingSasUrlOptionalParams): Promise<SetSessionRecordingSasUrlOperationResponse>;
    // (undocumented)
...
// @public
export type SetSessionRecordingSasUrlOperationResponse = SetSessionRecordingSasUrlResponse;

// @public
export interface SetSessionRecordingSasUrlOptionalParams extends coreClient.OperationOptions {
    resumeFrom?: string;
    updateIntervalInMs?: number;
}
