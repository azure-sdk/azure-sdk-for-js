...
export interface NspOperationStatus {
    ...
    name?: string;
    // (undocumented)
    properties?: NspOperationStatusProperties;
    startTime?: Date;
...
// @public
export type NspOperationStatusGetResponse = NspOperationStatus;

// @public
export interface NspOperationStatusOperations {
    get(location: string, operationId: string, options?: NspOperationStatusGetOptionalParams): Promise<NspOperationStatusGetResponse>;
}

// @public (undocumented)
export interface NspOperationStatusProperties {
    resourceId?: string;
}
