...
## 33.6.0-beta.1 (2025-01-24)
Compared with version 33.5.0
    
### Features Added

  - Added operation group NetworkSecurityPerimeters
  - Added operation group NspAccessRules
  - Added operation group NspAccessRulesReconcile
  - Added operation group NspAssociationReconcile
  - Added operation group NspAssociations
  - Added operation group NspLinkReferences
  - Added operation group NspLinks
  - Added operation group NspLoggingConfigurationOperations
  - Added operation group NspLoggingConfigurations
  - Added operation group NspOperationStatus
  - Added operation group NspProfiles
  - Added operation group PerimeterAssociableResourceTypes
  - Added Interface CloudErrorAutoGenerated
  - Added Interface CloudErrorBodyAutoGenerated
  - Added Interface CommonErrorDetailAutoGenerated
  - Added Interface CommonErrorResponseAutoGenerated
  - Added Interface CommonProxyResourceAutoGenerated
  - Added Interface CommonResourceAutoGenerated
  - Added Interface CommonTrackedResourceAutoGenerated
  ...
  - Added Interface NspAccessRulesCreateOrUpdateOptionalParams
  - Added Interface NspAccessRulesDeleteOptionalParams
  - Added Interface NspAccessRulesGetOptionalParams
  - Added Interface NspAccessRulesListNextOptionalParams
  - Added Interface NspAccessRulesListOptionalParams
  - Added Interface NspAccessRulesReconcilePostOptionalParams
  - Added Interface NspAssociation
  - Added Interface NspAssociationReconcilePostOptionalParams
  - Added Interface NspAssociationsCreateOrUpdateHeaders
  - Added Interface NspAssociationsCreateOrUpdateOptionalParams
  - Added Interface NspAssociationsDeleteHeaders
  - Added Interface NspAssociationsDeleteOptionalParams
  - Added Interface NspAssociationsGetOptionalParams
  - Added Interface NspAssociationsListNextOptionalParams
  - Added Interface NspAssociationsListOptionalParams
  ...
  - Added Interface NspLinkReferencesDeleteHeaders
  - Added Interface NspLinkReferencesDeleteOptionalParams
  - Added Interface NspLinkReferencesGetOptionalParams
  - Added Interface NspLinkReferencesListNextOptionalParams
  - Added Interface NspLinkReferencesListOptionalParams
  - Added Interface NspLinksCreateOrUpdateOptionalParams
  - Added Interface NspLinksDeleteHeaders
  - Added Interface NspLinksDeleteOptionalParams
  - Added Interface NspLinksGetOptionalParams
  - Added Interface NspLinksListNextOptionalParams
  - Added Interface NspLinksListOptionalParams
  - Added Interface NspLoggingConfiguration
  - Added Interface NspLoggingConfigurationCreateOrUpdateOptionalParams
  - Added Interface NspLoggingConfigurationDeleteOptionalParams
  - Added Interface NspLoggingConfigurationGetOptionalParams
  - Added Interface NspLoggingConfigurationListResult
  - Added Interface NspLoggingConfigurationProperties
  - Added Interface NspLoggingConfigurationsListNextOptionalParams
  - Added Interface NspLoggingConfigurationsListOptionalParams
  - Added Interface NspOperationStatusGetOptionalParams
  - Added Interface NspProfile
  - Added Interface NspProfileListResult
  - Added Interface NspProfilesCreateOrUpdateOptionalParams
  - Added Interface NspProfilesDeleteOptionalParams
  - Added Interface NspProfilesGetOptionalParams
  - Added Interface NspProfilesListNextOptionalParams
  - Added Interface NspProfilesListOptionalParams
  - Added Interface OperationStatusResult
  - Added Interface PerimeterAssociableResource
  - Added Interface PerimeterAssociableResourcesListResult
  - Added Interface PerimeterAssociableResourceTypesListNextOptionalParams
  - Added Interface PerimeterAssociableResourceTypesListOptionalParams
  ...
  - Added Type Alias NspAccessRulesCreateOrUpdateResponse
  - Added Type Alias NspAccessRulesGetResponse
  - Added Type Alias NspAccessRulesListNextResponse
  - Added Type Alias NspAccessRulesListResponse
  - Added Type Alias NspAccessRulesReconcilePostResponse
  - Added Type Alias NspAssociationReconcilePostResponse
  - Added Type Alias NspAssociationsCreateOrUpdateResponse
  - Added Type Alias NspAssociationsGetResponse
  - Added Type Alias NspAssociationsListNextResponse
  - Added Type Alias NspAssociationsListResponse
  - Added Type Alias NspLinkProvisioningState
  - Added Type Alias NspLinkReferencesGetResponse
  - Added Type Alias NspLinkReferencesListNextResponse
  - Added Type Alias NspLinkReferencesListResponse
  - Added Type Alias NspLinksCreateOrUpdateResponse
  - Added Type Alias NspLinksGetResponse
  - Added Type Alias NspLinksListNextResponse
  - Added Type Alias NspLinksListResponse
  - Added Type Alias NspLinkStatus
  - Added Type Alias NspLoggingConfigurationCreateOrUpdateResponse
  - Added Type Alias NspLoggingConfigurationGetResponse
  - Added Type Alias NspLoggingConfigurationsListNextResponse
  - Added Type Alias NspLoggingConfigurationsListResponse
  - Added Type Alias NspOperationStatusGetResponse
  - Added Type Alias NspProfilesCreateOrUpdateResponse
  - Added Type Alias NspProfilesGetResponse
  - Added Type Alias NspProfilesListNextResponse
  - Added Type Alias NspProfilesListResponse
  - Added Type Alias NspProvisioningState
  - Added Type Alias PerimeterAssociableResourceTypesListNextResponse
  - Added Type Alias PerimeterAssociableResourceTypesListResponse
