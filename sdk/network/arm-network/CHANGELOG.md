...
**Features**
  ...
  - Added operation ApplicationGateways.beginCommitMigration
  - Added operation ApplicationGateways.beginCommitMigrationAndWait
  - Added operation ApplicationGateways.beginExecuteMigration
  - Added operation ApplicationGateways.beginExecuteMigrationAndWait
  - Added operation ApplicationGateways.beginPrepareMigration
  - Added operation ApplicationGateways.beginPrepareMigrationAndWait
  - Added operation NetworkVirtualAppliances.restart
  - Added Interface ApplicationGatewayMigrationRequest
  - Added Interface ApplicationGatewayPrepareMigrationRequestResponse
  - Added Interface ApplicationGatewaysCommitMigrationOptionalParams
  - Added Interface ApplicationGatewaysExecuteMigrationOptionalParams
  - Added Interface ApplicationGatewaysPrepareMigrationOptionalParams
  ...
  - Added Type Alias ApplicationGatewayMigrationType
  ...
  - Added Enum KnownApplicationGatewayMigrationType
