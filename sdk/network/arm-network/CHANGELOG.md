...
## 33.0.0-beta.1 (2023-09-14)
    
**Features**

  - Added operation group IpamPoolOperations
  - Added Interface AllocationRequest
  - Added Interface AssociationRequest
  - Added Interface BastionHostPropertiesFormatNetworkAcls
  - Added Interface CompliancyProperties
  - Added Interface ErrorAdditionalInfo
  - Added Interface ErrorDetail
  - Added Interface ErrorResponseAutoGenerated
  - Added Interface IpamPool
  - Added Interface IpamPoolAllocateAzureResourceOptionalParams
  - Added Interface IpamPoolAllocateNonAzureResourceOptionalParams
  - Added Interface IpamPoolAssociateResourcesOptionalParams
  - Added Interface IpamPoolCreateOptionalParams
  - Added Interface IpamPoolDeleteHeaders
  - Added Interface IpamPoolDeleteOptionalParams
  - Added Interface IpamPoolDisassociateResourcesOptionalParams
  - Added Interface IpamPoolGetOptionalParams
  - Added Interface IpamPoolList
  - Added Interface IpamPoolListAssociationNextOptionalParams
  - Added Interface IpamPoolListAssociationOptionalParams
  - Added Interface IpamPoolListNextOptionalParams
  - Added Interface IpamPoolListOptionalParams
  - Added Interface IpamPoolProperties
  - Added Interface IpamPoolUpdate
  - Added Interface IpamPoolUpdateOptionalParams
  - Added Interface IpamPoolUsageOptionalParams
  - Added Interface IPRule
  - Added Interface NonAzureAllocationRequest
  ...
  - Added Type Alias AssociationStatus
  - Added Type Alias CompliancyStatus
  - Added Type Alias IpamPoolAllocateAzureResourceResponse
  - Added Type Alias IpamPoolAllocateNonAzureResourceResponse
  - Added Type Alias IpamPoolAssociateResourcesResponse
  - Added Type Alias IpamPoolCreateResponse
  - Added Type Alias IpamPoolDeleteResponse
  - Added Type Alias IpamPoolGetResponse
  - Added Type Alias IpamPoolListAssociationNextResponse
  - Added Type Alias IpamPoolListAssociationResponse
  - Added Type Alias IpamPoolListNextResponse
  - Added Type Alias IpamPoolListResponse
  - Added Type Alias IpamPoolUpdateResponse
  - Added Type Alias IpamPoolUsageResponse
  ...
  - Added Enum KnownAssociationStatus
  - Added Enum KnownCompliancyStatus
...
**Breaking Changes**
  ...
  - Interface NetworkManagementClientOptionalParams no longer has parameter $host
  - Interface Resource no longer has parameter location
  - Interface Resource no longer has parameter tags
  - Type of parameter systemData of interface AdminRuleCollection is changed from SystemData to SystemDataAutoGenerated
  - Type of parameter systemData of interface BaseAdminRule is changed from SystemData to SystemDataAutoGenerated
  - Type of parameter systemData of interface ConnectivityConfiguration is changed from SystemData to SystemDataAutoGenerated
  - Type of parameter error of interface ErrorResponse is changed from ErrorDetails to ErrorDetail
  - Type of parameter systemData of interface NetworkGroup is changed from SystemData to SystemDataAutoGenerated
  - Type of parameter systemData of interface NetworkManager is changed from SystemData to SystemDataAutoGenerated
  - Type of parameter systemData of interface NetworkManagerConnection is changed from SystemData to SystemDataAutoGenerated
  - Type of parameter systemData of interface ScopeConnection is changed from SystemData to SystemDataAutoGenerated
  - Type of parameter systemData of interface SecurityAdminConfiguration is changed from SystemData to SystemDataAutoGenerated
  - Type of parameter systemData of interface StaticMember is changed from SystemData to SystemDataAutoGenerated
