...
**Features**
  ...
  - Added operation VpnLinkConnections.beginResetSharedKey
  - Added operation VpnLinkConnections.beginResetSharedKeyAndWait
  - Added operation VpnLinkConnections.sharedKeyGet
  - Added Interface ConnectionResetSharedKeyAutoGenerated
  - Added Interface ConnectionSharedKeyAutoGenerated
  - Added Interface VpnLinkConnectionsPutSharedKeyOptionalParams
  - Added Interface VpnLinkConnectionsResetSharedKeyOptionalParams
  - Added Interface VpnLinkConnectionsSharedKeyGetOptionalParams
  - Added Type Alias VpnLinkConnectionsPutSharedKeyResponse
  - Added Type Alias VpnLinkConnectionsResetSharedKeyResponse
