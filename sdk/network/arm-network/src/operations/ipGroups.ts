...
export class IpGroupsImpl implements IpGroups {
   ...
   * @param options The options parameters.
   */
  public list(options?: IpGroupsListOptionalParams): PagedAsyncIterableIterator<IpGroup> {
   ...
   * @param options The options parameters.
   */
  private _list(options?: IpGroupsListOptionalParams): Promise<IpGroupsListResponse> {
