...
const resetOperationSpec: coreClient.OperationSpec = {
  ...
  queryParameters: [Parameters.apiVersion1, Parameters.gatewayVip],
  urlParameters: [
    Parameters.$host,
    Parameters.subscriptionId,
    Parameters.resourceGroupName,
...
const getBgpPeerStatusOperationSpec: coreClient.OperationSpec = {
  ...
  queryParameters: [Parameters.apiVersion1, Parameters.peer],
  urlParameters: [
    Parameters.$host,
    Parameters.subscriptionId,
    Parameters.resourceGroupName,
...
const getAdvertisedRoutesOperationSpec: coreClient.OperationSpec = {
  ...
  queryParameters: [Parameters.apiVersion1, Parameters.peer1],
  urlParameters: [
    Parameters.$host,
    Parameters.subscriptionId,
    Parameters.resourceGroupName,
...
const startExpressRouteSiteFailoverSimulationOperationSpec: coreClient.OperationSpec =
  {
    ...
    queryParameters: [Parameters.apiVersion1, Parameters.peeringLocation],
    urlParameters: [
      Parameters.$host,
      Parameters.subscriptionId,
      Parameters.resourceGroupName,
