...
export class NetworkSecurityPerimetersImpl implements NetworkSecurityPerimeters {
  ...
  async beginDeleteAndWait(
    ...
    const poller = await this.beginDelete(resourceGroupName, networkSecurityPerimeterName, options);
