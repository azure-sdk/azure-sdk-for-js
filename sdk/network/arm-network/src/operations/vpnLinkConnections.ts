...
export class VpnLinkConnectionsImpl implements VpnLinkConnections {
  ...
  > {
    ...
    const lro = createLroSpec({
      ...
      spec: putSharedKeyOperationSpec,
    });
   ...
   * @param options The options parameters.
   */
  async beginPutSharedKeyAndWait(
    resourceGroupName: string,
    gatewayName: string,
    connectionName: string,
    linkConnectionName: string,
    ...
    const poller = await this.beginPutSharedKey(
      resourceGroupName,
      gatewayName,
      connectionName,
      linkConnectionName,
...
const sharedKeyGetOperationSpec: coreClient.OperationSpec = {
  path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnGateways/{gatewayName}/vpnConnections/{connectionName}/vpnLinkConnections/{linkConnectionName}/sharedKey",
  httpMethod: "GET",
  responses: {
    200: {
      bodyMapper: Mappers.ConnectionSharedKeyAutoGenerated,
    },
    default: {
...
const putSharedKeyOperationSpec: coreClient.OperationSpec = {
  path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnGateways/{gatewayName}/vpnConnections/{connectionName}/vpnLinkConnections/{linkConnectionName}/sharedKey",
  httpMethod: "POST",
  responses: {
    200: {
...
const resetSharedKeyOperationSpec: coreClient.OperationSpec = {
  path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnGateways/{gatewayName}/vpnConnections/{connectionName}/vpnLinkConnections/{linkConnectionName}/sharedKey/reset",
  httpMethod: "POST",
  responses: {
    200: {
      bodyMapper: Mappers.ConnectionResetSharedKeyAutoGenerated,
    },
    201: {
      bodyMapper: Mappers.ConnectionResetSharedKeyAutoGenerated,
    },
