...
export class NetworkSecurityPerimeterLinksImpl implements NetworkSecurityPerimeterLinks {
  ...
  public list(
    ...
    const iter = this.listPagingAll(resourceGroupName, networkSecurityPerimeterName, options);
    return {
      next() {
        return iter.next();
      },
  ...
  private async *listPagingPage(
    ...
    if (!continuationToken) {
      result = await this._list(resourceGroupName, networkSecurityPerimeterName, options);
