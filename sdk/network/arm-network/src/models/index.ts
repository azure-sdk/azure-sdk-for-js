...
/** Result of the request to list VpnLink connection shared keys. It contains a list of VpnLink connection shared keys and a URL nextLink to get the next set of results. */
...
/** Optional parameters. */
export interface VpnLinkConnectionsSharedKeyGetOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the sharedKeyGet operation. */
export type VpnLinkConnectionsSharedKeyGetResponse = SharedKey;

/** Optional parameters. */
export interface VpnLinkConnectionsPutSharedKeyOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Contains response data for the putSharedKey operation. */
...
/** Optional parameters. */
export interface ListVpnLinkConnectionsSharedKeyOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the vpnLinkConnectionsSharedKey operation. */
export type ListVpnLinkConnectionsSharedKeyResponse =
