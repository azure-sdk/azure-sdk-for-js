...
export interface Probe extends SubResource {
  ...
  /** The number of consecutive successful or failed probes in order to allow or deny traffic from being delivered to this endpoint. After failing the number of consecutive probes equal to this value, the endpoint will be taken out of rotation and require the same number of successful consecutive probes to be placed back in rotation. This property is non-functional for any values apart from 1. Leverage numberOfProbes if you need this capability. */
