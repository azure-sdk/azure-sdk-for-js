...
export interface EffectiveConnectivityConfiguration {
  ...
  connectivityCapabilities?: Record<string, unknown>;
...
export interface ConnectivityCapabilitiesItem {
  /** Option indicating the scale of private endpoints allowed in the connected group of the connectivity configuration. */
  connectedGroupPrivateEndpointScale?: ConnectedGroupPrivateEndpointScale;
...
/** Known values of {@link AdvertisedPublicPrefixPropertiesValidationState} that the service accepts. */
 ...
 * {@link KnownAdvertisedPublicPrefixPropertiesValidationState} can be used interchangeably with AdvertisedPublicPrefixPropertiesValidationState,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **NotConfigured** \
 * **Configuring** \
...
/** Known values of {@link ConnectedGroupPrivateEndpointScale} that the service accepts. */
 ...
 * {@link KnownConnectedGroupPrivateEndpointScale} can be used interchangeably with ConnectedGroupPrivateEndpointScale,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Standard**: Default. Allows for up to 2K private endpoints in the connected group. \
 * **HighScale**: Allows for up to 20K private endpoints in the connected group.
 */
export type ConnectedGroupPrivateEndpointScale = string;

/** Known values of {@link ConnectedGroupAddressOverlap} that the service accepts. */
 ...
 * {@link KnownConnectedGroupAddressOverlap} can be used interchangeably with ConnectedGroupAddressOverlap,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
...
/** Known values of {@link PeeringEnforcement} that the service accepts. */
 ...
 * {@link KnownPeeringEnforcement} can be used interchangeably with PeeringEnforcement,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Unenforced**: Default. Peerings created by the connectivity configuration may be modified or deleted outside of the network manager. \
 * **Enforced**: Peerings created by the connectivity configuration will not be modifiable or deletable outside of the network manager.
 */
