...
export interface SetSessionRecordingSasUrlResponse {
...
/** Defines headers for NetworkManagementClient_setSessionRecordingSasUrl operation. */
export interface NetworkManagementClientSetSessionRecordingSasUrlHeaders {
  location?: string;
}

/** Defines headers for NetworkManagementClient_getSessionRecordingSasUrl operation. */
export interface NetworkManagementClientGetSessionRecordingSasUrlHeaders {
  location?: string;
}
...
/** Optional parameters. */
export interface SetSessionRecordingSasUrlOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Contains response data for the setSessionRecordingSasUrl operation. */
export type SetSessionRecordingSasUrlOperationResponse =
  SetSessionRecordingSasUrlResponse;

/** Optional parameters. */
export interface GetSessionRecordingSasUrlOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Contains response data for the getSessionRecordingSasUrl operation. */
export type GetSessionRecordingSasUrlResponse = {
  /** The parsed response body. */
  body: string;
};
