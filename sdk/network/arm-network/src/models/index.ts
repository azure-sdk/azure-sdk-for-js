...
/** FirewallPolicy Resource. */
export interface FirewallPolicyDraft extends ResourceAutoGenerated {
  /** The parent firewall policy from which rules are inherited. */
  basePolicy?: SubResource;
  /** The operation mode for Threat Intelligence. */
  threatIntelMode?: AzureFirewallThreatIntelMode;
...
export interface SecurityAdminConfiguration extends ProxyResource {
...
export interface AdminRuleCollection extends ProxyResource {
