...
export interface ConnectionResetSharedKeyAutoGenerated {
...
export interface ConnectionSharedKeyAutoGenerated extends SubResource {
...
export type VpnLinkConnectionsSharedKeyGetResponse =
...
export type VpnLinkConnectionsPutSharedKeyResponse =
  ConnectionSharedKeyAutoGenerated;

/** Optional parameters. */
export interface VpnLinkConnectionsResetSharedKeyOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Contains response data for the resetSharedKey operation. */
export type VpnLinkConnectionsResetSharedKeyResponse =
