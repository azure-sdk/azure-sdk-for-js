...
/** Defines headers for NetworkManagementClient_getActiveSessions operation. */
export interface NetworkManagementClientGetActiveSessionsHeaders {
  location?: string;
}

/** Defines headers for NetworkManagementClient_disconnectActiveSessions operation. */
export interface NetworkManagementClientDisconnectActiveSessionsHeaders {
  location?: string;
}

/** Defines headers for NetworkManagementClient_getActiveSessionsNext operation. */
export interface NetworkManagementClientGetActiveSessionsNextHeaders {
  location?: string;
}

/** Defines headers for NetworkManagementClient_disconnectActiveSessionsNext operation. */
export interface NetworkManagementClientDisconnectActiveSessionsNextHeaders {
  location?: string;
}
