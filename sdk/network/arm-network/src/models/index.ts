...
/** Known values of {@link OwaspCrsExclusionEntryExclude} that the service accepts. */
...
/**
 * Defines values for OwaspCrsExclusionEntryExclude. \
 * {@link KnownOwaspCrsExclusionEntryExclude} can be used interchangeably with OwaspCrsExclusionEntryExclude,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **MatchVariable** \
 * **Request**
...
/** Known values of {@link OwaspCrsExclusionEntryValueMatchOperator} that the service accepts. */
...
/**
 * Defines values for OwaspCrsExclusionEntryValueMatchOperator. \
 * {@link KnownOwaspCrsExclusionEntryValueMatchOperator} can be used interchangeably with OwaspCrsExclusionEntryValueMatchOperator,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Equals** \
 * **Contains** \
