...
/** Defines headers for FirewallPolicies_deployDraft operation. */
export interface FirewallPoliciesDeployDraftHeaders {
  location?: string;
}
...
/** Contains response data for the deployDraft operation. */
export type FirewallPoliciesDeployDraftResponse = FirewallPolicyDraft;
