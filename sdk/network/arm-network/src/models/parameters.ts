...
export const cloudServiceName1: OperationURLParameter = {
  parameterPath: "cloudServiceName",
  mapper: {
    constraints: {
      Pattern: new RegExp("^[A-Za-z0-9][A-Za-z0-9_\\.-]*[A-Za-z0-9_]$"),
      MaxLength: 80,
      MinLength: 2
    },
    serializedName: "cloudServiceName",
...
export const roleInstanceName1: OperationURLParameter = {
  parameterPath: "roleInstanceName",
  mapper: {
    constraints: {
      Pattern: new RegExp("^[A-Za-z0-9][A-Za-z0-9_\\.-]*[A-Za-z0-9_]$"),
...
export const networkInterfaceName1: OperationURLParameter = {
  parameterPath: "networkInterfaceName",
  mapper: {
    constraints: {
      Pattern: new RegExp("^[A-Za-z0-9][A-Za-z0-9_\\.-]*[A-Za-z0-9_]$"),
...
export const ipConfigurationName1: OperationURLParameter = {
  parameterPath: "ipConfigurationName",
  mapper: {
    constraints: {
      Pattern: new RegExp("^[A-Za-z0-9][A-Za-z0-9_\\.-]*[A-Za-z0-9_]$"),
...
export const publicIpAddressName1: OperationURLParameter = {
  parameterPath: "publicIpAddressName",
  mapper: {
    constraints: {
      Pattern: new RegExp("^[A-Za-z0-9][A-Za-z0-9_\\.-]*[A-Za-z0-9_]$"),
