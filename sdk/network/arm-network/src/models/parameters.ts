...
import {
  ...
  SharedKeyProperties as SharedKeyPropertiesMapper,
...
export const sharedKeyName: OperationURLParameter = {
  parameterPath: "sharedKeyName",
  mapper: {
    serializedName: "sharedKeyName",
    required: true,
    type: {
      name: "String",
    },
...
export const parameters87: OperationParameter = {
  parameterPath: "parameters",
  mapper: SharedKeyPropertiesMapper,
};
