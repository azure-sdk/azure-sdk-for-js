...
export const NNetworkSecurityPerimeterLinkReferencesDeleteHeaders: coreClient.CompositeMapper =
  {
    type: {
      name: "Composite",
      className: "NNetworkSecurityPerimeterLinkReferencesDeleteHeaders",
      modelProperties: {
        location: {
          serializedName: "location",
          type: {
