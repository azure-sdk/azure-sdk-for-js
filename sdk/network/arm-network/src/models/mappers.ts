...
export const ConnectionResetSharedKeyAutoGenerated: coreClient.CompositeMapper =
  {
    type: {
      name: "Composite",
      className: "ConnectionResetSharedKeyAutoGenerated",
      modelProperties: {
        keyLength: {
          constraints: {
            InclusiveMaximum: 128,
...
export const ConnectionSharedKeyAutoGenerated: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ConnectionSharedKeyAutoGenerated",
    modelProperties: {
      ...SubResource.type.modelProperties,
      value: {
        serializedName: "value",
