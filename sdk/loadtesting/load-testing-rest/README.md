# AzureLoadTestingForTesting REST client library for JavaScript
...
Install the AzureLoadTestingForTesting REST client REST client library for JavaScript with `npm`:
