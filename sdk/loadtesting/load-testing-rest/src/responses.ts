...
/** The request has succeeded. */
export interface TestProfileRunAdministrationStopTestProfileRun200Response
  extends HttpResponse {
  status: "200";
  body: TestProfileRunOutput;
}

export interface TestProfileRunAdministrationStopTestProfileRunDefaultHeaders {
  /** String error code indicating what went wrong. */
  "x-ms-error-code"?: string;
}

export interface TestProfileRunAdministrationStopTestProfileRunDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponse;
  headers: RawHttpHeaders &
    TestProfileRunAdministrationStopTestProfileRunDefaultHeaders;
}
