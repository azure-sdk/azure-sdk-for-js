...
export interface OperationsGetOperationStatus200Response extends HttpResponse {
  status: "200";
  body: OperationStatusOutput;
}

export interface OperationsGetOperationStatusDefaultHeaders {
  /** String error code indicating what went wrong. */
  "x-ms-error-code"?: string;
}

export interface OperationsGetOperationStatusDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponse;
  headers: RawHttpHeaders & OperationsGetOperationStatusDefaultHeaders;
}
...
export interface LoadTestAdministrationCloneTest202Response
  extends HttpResponse {
  status: "202";
...
export interface LoadTestAdministrationCloneTestDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponse;
...
export interface LoadTestAdministrationCloneTestLogicalResponse
  extends HttpResponse {
  status: "200";
  body: ResourceOperationStatusTestErrorOutput;
}
