...
export interface NotificationRuleOutputParent {
  ...
  /** The event of the notification rule */
  events: Array<NotificationEventOutput>;
  /** The creation datetime(RFC 3339 literal format). */
  readonly createdDateTime?: string;
  /** The user that created. */
  readonly createdBy?: string;
...
export interface NotificationEventOutputParent {
...
export interface TestRunEndedNotificationEventOutput
  extends NotificationEventOutputParent {
