...
export interface TestOutput {
  ...
  /** Id of the test run to be used as the baseline reference for results trends. */
...
export interface AutoStopCriteriaOutput {
  /** Auto stop is enabled or not */
  autoStopEnabled?: boolean;
  /** Value of auto stop criteria metric */
  errorRate?: number;
  /** Time window in seconds for auto stop metric */
...
export interface LoadTestConfigurationOutput {
  ...
  /**
   * Type of test. e.g. Url or JMX
   *
   * Possible values: URL, JMX
   */
  testType?: string;
}
...
export interface OptionalLoadTestConfigOutput {
  ...
  rps?: number;
  /** Maximum response time of the API/endpoint */
...
export interface TestInputArtifactsOutput {
  ...
  urlTestsConfigFileInfo?: TestFileInfoOutput;
  /** Additional supported files for the test run */
  readonly additionalFileInfo?: Array<TestFileInfoOutput>;
}

/** File info. */
export interface TestFileInfoOutput extends FileInfoOutput {
  /** Name of the file. */
  fileName: string;
}
...
export interface FileInfoOutput {
   ...
   * File type
   *
   * Possible values: JMX_FILE, USER_PROPERTIES, ADDITIONAL_ARTIFACTS, ZIPPED_ARTIFACTS, URL_TEST_CONFIG
   */
  fileType?: string;
...
/** File info. */
export interface TestRunFileInfoOutput extends FileInfoOutput {
  /** Name of the file. */
  fileName: string;
}
...
export interface TestRunInputArtifactsOutput {
  ...
  /** The config json file for url based test */
  urlTestsConfigFileInfo?: TestRunFileInfoOutput;
  /** Additional supported files for the test run */
