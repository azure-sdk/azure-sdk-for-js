...
export interface TestsNotificationRuleOutput
  ...
  /** Scope of type Tests. */
  scope: "Tests";
  /** The test ids to include. If not provided, the notification will be sent for all testIds. */
  testIds?: string[];
  /** The events to send notifications for. */
  events: Record<string, TestsNotificationEventOutput>;
}

/** The notification event for tests. */
export interface TestsNotificationEventOutputParent {
  name: NotificationEventTypeOutput;
}

/** The notification event when the event type is TestRunEnded. */
export interface TestRunEndedNotificationEventOutput
  extends TestsNotificationEventOutputParent {
...
export interface TestRunEndedEventConditionOutput {
  ...
  /** The types of entities that created the test run to send notification for. */
  createdByTypes?: CreateByTypesOutput[];
}

/** The notification event when the event type is TestRunStarted. */
export interface TestRunStartedNotificationEventOutput
  extends TestsNotificationEventOutputParent {
  /** Event type for test run started event. */
  name: "TestRunStarted";
  /** Event filtering condition. */
  condition?: TestRunStartedEventConditionOutput;
}

/** TestRunStarted Event condition. */
export interface TestRunStartedEventConditionOutput {
  /** The creator types to send notification for. */
  createdByTypes?: string[];
}

/** The notification event when the event type is TriggerEnded. */
export interface TriggerEndedNotificationEventOutput
  extends TestsNotificationEventOutputParent {
  /** Event type for trigger ended event. */
  name: "TriggerEnded";
}

/** The notification event when the event type is TriggerDisabled. */
export interface TriggerDisabledNotificationEventOutput
  extends TestsNotificationEventOutputParent {
...
/** The notification event for tests. */
export type TestsNotificationEventOutput =
  | TestsNotificationEventOutputParent
  | TestRunEndedNotificationEventOutput
  | TestRunStartedNotificationEventOutput
  | TriggerEndedNotificationEventOutput
  | TriggerDisabledNotificationEventOutput;
...
export type PagedTriggerOutput = Paged<TriggerOutput>;
...
export type PagedNotificationRuleOutput = Paged<NotificationRuleOutput>;
