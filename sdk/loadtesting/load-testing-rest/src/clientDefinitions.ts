...
import {
  ...
  TestProfileRunAdministrationStopTestProfileRunParameters,
...
import {
  ...
  TestProfileRunAdministrationStopTestProfileRun200Response,
  TestProfileRunAdministrationStopTestProfileRunDefaultResponse,
...
export interface TestProfileRunAdministrationStopTestProfileRun {
  /** Stop test profile run for the given test profile run Id. */
  post(
    options?: TestProfileRunAdministrationStopTestProfileRunParameters,
  ): StreamableMethod<
    | TestProfileRunAdministrationStopTestProfileRun200Response
    | TestProfileRunAdministrationStopTestProfileRunDefaultResponse
  >;
...
export interface Routes {
  ...
  (
    ...
    testProfileRunId: string,
  ): TestProfileRunAdministrationStopTestProfileRun;
