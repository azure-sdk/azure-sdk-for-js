...
export interface TestsNotificationRule extends NotificationRuleParent {
  ...
  events: Record<string, TestsNotificationEvent>;
}

/** The notification event for tests. */
export interface TestsNotificationEventParent {
  name: NotificationEventType;
}

/** The notification event when the event type is TestRunEnded. */
export interface TestRunEndedNotificationEvent
  extends TestsNotificationEventParent {
...
export interface TestRunEndedEventCondition {
  ...
  createdByTypes?: CreateByTypes[];
}

/** The notification event when the event type is TestRunStarted. */
export interface TestRunStartedNotificationEvent
  extends TestsNotificationEventParent {
  /** Event type for test run started event. */
  name: "TestRunStarted";
  /** Event filtering condition. */
  condition?: TestRunStartedEventCondition;
}

/** TestRunStarted Event condition. */
export interface TestRunStartedEventCondition {
...
export interface TriggerEndedNotificationEvent
  extends TestsNotificationEventParent {
...
export interface TriggerDisabledNotificationEvent
  extends TestsNotificationEventParent {
...
/** The notification event for tests. */
export type TestsNotificationEvent =
  | TestsNotificationEventParent
  | TestRunEndedNotificationEvent
  | TestRunStartedNotificationEvent
  | TriggerEndedNotificationEvent
  | TriggerDisabledNotificationEvent;
/** Alias for PFMetrics */
