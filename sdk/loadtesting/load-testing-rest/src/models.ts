...
export interface NotificationEventParent {
  name: NotificationEventType;
}

/** The notification event when the event type is TestRunEnded. */
export interface TestRunEndedNotificationEvent extends NotificationEventParent {
...
export interface TestRunStartedNotificationEvent
  extends NotificationEventParent {
...
export interface TriggerEndedNotificationEvent extends NotificationEventParent {
