...
export class LoadTestClientForTesting extends coreClient.ServiceClient {
    // (undocumented)
    $host: string;
    constructor(credentials: coreAuth.TokenCredential, subscriptionId: string, options?: LoadTestClientForTestingOptionalParams);
    // (undocumented)
    apiVersion: string;
    // (undocumented)
    loadTests: LoadTests;
...
// @public
export interface LoadTestClientForTestingOptionalParams extends coreClient.ServiceClientOptions {
    $host?: string;
    apiVersion?: string;
    endpoint?: string;
}
