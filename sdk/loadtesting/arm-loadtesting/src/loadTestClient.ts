...
import { OperationsImpl, LoadTestsImpl, QuotasImpl } from "./operations/index.js";
import { Operations, LoadTests, Quotas } from "./operationsInterfaces/index.js";
...
export class LoadTestClient extends coreClient.ServiceClient {
  ...
  constructor(
    ...
    const packageDetails = `azsdk-js-arm-loadtesting/2.0.0`;
