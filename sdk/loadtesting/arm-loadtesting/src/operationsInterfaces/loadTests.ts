...
export interface LoadTests {
  ...
  ): Promise<SimplePollerLike<OperationState<LoadTestsUpdateResponse>, LoadTestsUpdateResponse>>;
  /**
   * Update a LoadTestResource
   * @param resourceGroupName The name of the resource group. The name is case insensitive.
   * @param loadTestName Load Test name
  ...
  ): Promise<SimplePollerLike<OperationState<LoadTestsDeleteResponse>, LoadTestsDeleteResponse>>;
  /**
   * Delete a LoadTestResource
   * @param resourceGroupName The name of the resource group. The name is case insensitive.
   * @param loadTestName Load Test name
