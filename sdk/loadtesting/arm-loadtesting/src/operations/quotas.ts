...
import { LoadTestClientForTesting } from "../loadTestClientForTesting";
import {
  QuotaResource,
...
export class QuotasImpl implements Quotas {
  private readonly client: LoadTestClientForTesting;

  /**
   * Initialize a new instance of the class Quotas class.
   * @param client Reference to the service client
   */
  constructor(client: LoadTestClientForTesting) {
    this.client = client;
  }
