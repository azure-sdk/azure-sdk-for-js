...
export function _loadTestResourceListResultDeserializer(
  item: any,
...
export function loadTestResourceArraySerializer(
  result: Array<LoadTestResource>,
): any[] {
...
export function encryptionPropertiesIdentityDeserializer(
  item: any,
...
export function quotaResourcePropertiesDeserializer(
  item: any,
...
export function _quotaResourceListResultDeserializer(
  item: any,
...
export function quotaResourceArrayDeserializer(
  result: Array<QuotaResource>,
): any[] {
  return result.map((item) => {
...
export function checkQuotaAvailabilityResponseDeserializer(
  ...
  return {
    ...
    properties: !item["properties"]
      ? item["properties"]
      : checkQuotaAvailabilityResponsePropertiesDeserializer(
          item["properties"],
        ),
  };
}
