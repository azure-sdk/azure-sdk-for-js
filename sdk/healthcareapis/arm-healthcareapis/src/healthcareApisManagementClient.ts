...
import {
  ...
  AnalyticsConnectorOperationsImpl,
  OperationsImpl,
...
export class HealthcareApisManagementClient extends coreClient.ServiceClient {
  ...
  constructor(
    ...
    this.analyticsConnectorOperations = new AnalyticsConnectorOperationsImpl(
      this
    );
  ...
  analyticsConnectorOperations: AnalyticsConnectorOperations;
