...
## 3.2.0-beta.1 (2025-02-14)
Compared with version 3.1.0
    
### Features Added

  - Added Interface StorageMonitorConfiguration
  - Interface StorageConfiguration has a new optional parameter storageMonitorConfiguration
