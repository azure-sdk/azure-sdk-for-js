...
// @public
export interface ListStaticSiteRegionsNextOptionalParams extends coreClient.OperationOptions {
}

// @public
export type ListStaticSiteRegionsNextResponse = StaticSiteRegionCollection;

// @public
export interface ListStaticSiteRegionsOptionalParams extends coreClient.OperationOptions {
    sku?: SkuName;
}

// @public
export type ListStaticSiteRegionsResponse = StaticSiteRegionCollection;
...
// @public
export interface StaticSiteRegion extends ProxyOnlyResource {
    readonly displayName?: string;
}

// @public
export interface StaticSiteRegionCollection {
    readonly nextLink?: string;
    value: StaticSiteRegion[];
}
...
export class WebSiteManagementClient extends coreClient.ServiceClient {
    ...
    listStaticSiteRegions(options?: ListStaticSiteRegionsOptionalParams): PagedAsyncIterableIterator<StaticSiteRegion>;
