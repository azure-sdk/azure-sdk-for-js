...
export interface AppServiceEnvironments {
    ...
    testUpgradeNotification(resourceGroupName: string, name: string, options?: AppServiceEnvironmentsTestUpgradeNotificationOptionalParams): Promise<void>;
...
// @public
export interface AppServiceEnvironmentsTestUpgradeNotificationOptionalParams extends coreClient.OperationOptions {
}
