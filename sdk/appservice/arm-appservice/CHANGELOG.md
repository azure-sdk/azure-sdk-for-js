...
**Features**
  ...
  - Added operation StaticSites.beginCreateOrUpdateTrafficSplitting
  - Added operation StaticSites.beginCreateOrUpdateTrafficSplittingAndWait
  ...
  - Added operation StaticSites.deleteTrafficSplitting
  ...
  - Added operation StaticSites.getTrafficSplitting
  ...
  - Added Interface StaticSitesCreateOrUpdateTrafficSplittingOptionalParams
  ...
  - Added Interface StaticSitesDeleteTrafficSplittingOptionalParams
  ...
  - Added Interface StaticSitesGetTrafficSplittingOptionalParams
  ...
  - Added Interface StaticSiteTrafficSplittingProperties
  - Added Interface StaticSiteTrafficSplittingPropertiesARMResource
  - Added Interface StaticSiteTrafficSplittingPropertiesCollection
  ...
  - Added Type Alias StaticSitesCreateOrUpdateTrafficSplittingResponse
  ...
  - Added Type Alias StaticSitesGetTrafficSplittingResponse
  ...
  - Added Type Alias TrafficSplittingName
  ...
  - Interface StaticSiteARMResource has a new optional parameter trafficSplitting
  ...
  - Interface StaticSitePatchResource has a new optional parameter trafficSplitting
  ...
  - Added Enum KnownTrafficSplittingName
