...
### Features Added
  ...
  - Added operation AppServicePlans.listByVirtualNetworkIntegrations
  - Added operation WebApps.updateMachineKey
  - Added Interface AppServicePlansGetVirtualNetworkIntegrationOptionalParams
  - Added Interface AppServicePlansListByVirtualNetworkIntegrationsNextOptionalParams
  - Added Interface AppServicePlansListByVirtualNetworkIntegrationsOptionalParams
  - Added Interface CipherSuites
  - Added Interface ListVirtualNetworkIntegrationsOptionalParams
  ...
  - Added Interface SwiftVirtualNetworkPropertiesResourceAllocation
  - Added Interface SwiftVirtualNetworkPropertiesSubnetIpAllocation
  - Added Interface SwiftVirtualNetworkPropertiesVnetConnectionAllocation
  - Added Interface VirtualNetworkIntegrationRequest
  - Added Interface VirtualNetworkIntegrationResponse
  ...
  - Added Type Alias AppServicePlansListByVirtualNetworkIntegrationsNextResponse
  - Added Type Alias AppServicePlansListByVirtualNetworkIntegrationsResponse
  - Added Type Alias AutoGeneratedDomainNameLabelScope
  - Added Type Alias IPMode
  - Added Type Alias ListVirtualNetworkIntegrationsResponse
  - Added Type Alias PurgeUnusedVirtualNetworkIntegrationsResponse
  - Added Type Alias VirtualNetworkIntegrationResponseMessage
  ...
  - Interface SwiftVirtualNetwork has a new optional parameter properties
  - Interface WebSiteInstanceStatus has a new optional parameter physicalZone
  - Added Enum KnownVirtualNetworkIntegrationResponseMessage

### Breaking Changes

  - Interface SwiftVirtualNetwork no longer has parameter subnetResourceId
  - Interface SwiftVirtualNetwork no longer has parameter swiftSupported
