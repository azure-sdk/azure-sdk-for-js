...
### Features Added
  ...
  - Added operation StaticSites.beginZipDeploy
  - Added operation StaticSites.beginZipDeployAndWait
  - Added operation StaticSites.beginZipDeployStaging
  - Added operation StaticSites.beginZipDeployStagingAndWait
  - Added operation WebApps.updateMachineKey
  - Added Interface CipherSuites
  - Added Interface ErrorAdditionalInfo
  - Added Interface ErrorDetail
  - Added Interface ErrorResponseAutoGenerated
  - Added Interface StaticSitesZipDeployHeaders
  - Added Interface StaticSitesZipDeployOptionalParams
  - Added Interface StaticSitesZipDeployStagingHeaders
  - Added Interface StaticSitesZipDeployStagingOptionalParams
  - Added Interface StaticSiteZipDeployARMResource
  ...
  - Added Type Alias StaticSitesZipDeployResponse
  - Added Type Alias StaticSitesZipDeployStagingResponse
...
### Breaking Changes
  ...
  - Type of parameter error of interface RetryHistory is changed from ErrorResponse to ErrorResponseAutoGenerated
