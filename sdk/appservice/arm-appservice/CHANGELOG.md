...
**Features**
  ...
  - Added operation AppServiceEnvironments.migrate
  ...
  - Added Interface AppServiceEnvironmentsMigrateOptionalParams
  ...
  - Added Type Alias AppServiceEnvironmentsMigrateResponse
  - Added Type Alias AseMigrationOptions
