...
export const StaticSiteRegionCollection: coreClient.CompositeMapper = {
  serializedName: "StaticSiteRegionCollection",
  type: {
    name: "Composite",
    className: "StaticSiteRegionCollection",
    modelProperties: {
      value: {
        serializedName: "value",
        required: true,
        xmlName: "value",
        xmlElementName: "StaticSiteRegion",
        type: {
          name: "Sequence",
          element: {
            type: {
              name: "Composite",
              className: "StaticSiteRegion",
            },
          },
        },
      },
...
export const StaticSiteRegion: coreClient.CompositeMapper = {
  serializedName: "StaticSiteRegion",
  type: {
    name: "Composite",
    className: "StaticSiteRegion",
    modelProperties: {
