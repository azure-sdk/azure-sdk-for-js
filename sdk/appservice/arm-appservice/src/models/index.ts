...
/** Optional parameters. */
export interface StaticSitesGetStaticSiteBasicAuthOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the getStaticSiteBasicAuth operation. */
export type StaticSitesGetStaticSiteBasicAuthResponse = StaticSiteBasicAuthPropertiesARMResource;

/** Optional parameters. */
export interface StaticSitesCreateOrUpdateStaticSiteBasicAuthOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the createOrUpdateStaticSiteBasicAuth operation. */
