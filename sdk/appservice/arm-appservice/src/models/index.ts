...
/** Optional parameters. */
export interface StaticSitesListFreeTrialStaticWebAppsOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the listFreeTrialStaticWebApps operation. */
export type StaticSitesListFreeTrialStaticWebAppsResponse = FreeTrialStaticWebAppsProxyEntityCollection;

/** Optional parameters. */
export interface StaticSitesGetFreeTrialStaticWebAppOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the getFreeTrialStaticWebApp operation. */
export type StaticSitesGetFreeTrialStaticWebAppResponse = FreeTrialStaticWebAppsProxyEntity;

/** Optional parameters. */
export interface StaticSitesCreateFreeTrialStaticWebAppOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the createFreeTrialStaticWebApp operation. */
export type StaticSitesCreateFreeTrialStaticWebAppResponse = FreeTrialStaticWebAppsProxyEntity;

/** Optional parameters. */
export interface StaticSitesDeleteFreeTrialStaticWebAppOptionalParams
  extends coreClient.OperationOptions {}

/** Optional parameters. */
export interface StaticSitesUpgradeFreeTrialStaticWebAppOptionalParams
  extends coreClient.OperationOptions {}
