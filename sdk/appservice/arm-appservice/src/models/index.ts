...
export interface CustomDnsSuffixConfiguration {
  ...
  /**
   * The user-assigned identity to use for resolving the key vault certificate reference.
   * If not specified, the system-assigned ASE identity will be used if available.
   */
  keyVaultReferenceIdentity?: string;
}
...
/** Optional parameters. */
export interface AppServiceEnvironmentsMigrateOptionalParams
  extends coreClient.OperationOptions {}
