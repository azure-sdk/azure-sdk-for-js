...
/** Defines headers for WebApps_delete operation. */
export interface WebAppsDeleteHeaders {
  /** location header */
  location?: string;
}

/** Defines headers for WebApps_updateApplicationSettings operation. */
export interface WebAppsUpdateApplicationSettingsHeaders {
  /** location header */
  location?: string;
}

/** Defines headers for WebApps_updateConnectionStrings operation. */
export interface WebAppsUpdateConnectionStringsHeaders {
  /** location header */
  location?: string;
}

/** Defines headers for WebApps_createOrUpdateConfiguration operation. */
export interface WebAppsCreateOrUpdateConfigurationHeaders {
  /** location header */
  location?: string;
}

/** Defines headers for WebApps_updateConfiguration operation. */
...
/** Known values of {@link PurgedUnusedVirtualNetworkSuccessResponse} that the service accepts. */
export enum KnownPurgedUnusedVirtualNetworkSuccessResponse {
  ...
  /** NoUnusedVirtualNetworkIntegration */
  NoUnusedVirtualNetworkIntegration = "No unused virtual network integration.",
}

/**
 * Defines values for PurgedUnusedVirtualNetworkSuccessResponse. \
 * {@link KnownPurgedUnusedVirtualNetworkSuccessResponse} can be used interchangeably with PurgedUnusedVirtualNetworkSuccessResponse,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Purged unused virtual network integration.** \
 * **No unused virtual network integration.**
 */
...
/** Optional parameters. */
export interface AppServicePlansGetVirtualNetworkIntegrationsOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the getVirtualNetworkIntegrations operation. */
export type AppServicePlansGetVirtualNetworkIntegrationsResponse =
...
/** Optional parameters. */
export interface AppServicePlansGetVirtualNetworkIntegrationsNextOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the getVirtualNetworkIntegrationsNext operation. */
export type AppServicePlansGetVirtualNetworkIntegrationsNextResponse =
  SwiftVirtualNetworkCollection;
...
/** Optional parameters. */
export interface VirtualNetworkIntegrationsOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the virtualNetworkIntegrations operation. */
