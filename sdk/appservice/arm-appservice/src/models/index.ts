...
/** Optional parameters. */
export interface ListStaticSiteRegionsOptionalParams
  extends coreClient.OperationOptions {
  /** Name of SKU used to filter the regions. */
  sku?: SkuName;
}

/** Contains response data for the listStaticSiteRegions operation. */
...
/** Optional parameters. */
export interface ListStaticSiteRegionsNextOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the listStaticSiteRegionsNext operation. */
