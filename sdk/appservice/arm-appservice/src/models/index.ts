...
export interface StaticSiteTrafficSplittingProperties
  extends ProxyOnlyResource {
  /** Dictionary of <integer> */
  environmentDistribution?: { [propertyName: string]: number };
}
...
export interface StaticSiteTrafficSplittingPropertiesARMResource
  extends ProxyOnlyResource {
  /** Dictionary of <integer> */
  environmentDistribution?: { [propertyName: string]: number };
}
...
/** Known values of {@link TrafficSplittingName} that the service accepts. */
 ...
 * {@link KnownTrafficSplittingName} can be used interchangeably with TrafficSplittingName,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **default**
 */
...
/** Optional parameters. */
export interface StaticSitesGetTrafficSplittingOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the getTrafficSplitting operation. */
export type StaticSitesGetTrafficSplittingResponse = StaticSiteTrafficSplittingPropertiesARMResource;

/** Optional parameters. */
export interface StaticSitesCreateOrUpdateTrafficSplittingOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Contains response data for the createOrUpdateTrafficSplitting operation. */
export type StaticSitesCreateOrUpdateTrafficSplittingResponse = StaticSiteTrafficSplittingPropertiesARMResource;

/** Optional parameters. */
export interface StaticSitesDeleteTrafficSplittingOptionalParams
  extends coreClient.OperationOptions {}
