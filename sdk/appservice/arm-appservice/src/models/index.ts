...
/** Optional parameters. */
export interface AppServiceCertificateOrdersRetrieveCertificateOrderContactOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the retrieveCertificateOrderContact operation. */
