...
/** Defines headers for StaticSites_zipDeployStaging operation. */
export interface StaticSitesZipDeployStagingHeaders {
  /** The Azure Async Operation URI where the status of the request can be checked. */
  location?: string;
}

/** Defines headers for StaticSites_zipDeploy operation. */
...
/** Optional parameters. */
export interface StaticSitesZipDeployStagingOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Contains response data for the zipDeployStaging operation. */
export type StaticSitesZipDeployStagingResponse =
  StaticSitesZipDeployStagingHeaders;
...
/** Optional parameters. */
export interface StaticSitesZipDeployOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Contains response data for the zipDeploy operation. */
