...
import {
  ...
  AppServiceEnvironmentsTestUpgradeNotificationOptionalParams,
...
export class AppServiceEnvironmentsImpl implements AppServiceEnvironments {
  ...
  testUpgradeNotification(
    resourceGroupName: string,
    name: string,
    options?: AppServiceEnvironmentsTestUpgradeNotificationOptionalParams
  ): Promise<void> {
    return this.client.sendOperationRequest(
      { resourceGroupName, name, options },
      testUpgradeNotificationOperationSpec
    );
  }
...
const testUpgradeNotificationOperationSpec: coreClient.OperationSpec = {
  path:
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/hostingEnvironments/{name}/testUpgradeNotification",
  httpMethod: "POST",
  responses: {
    200: {},
    default: {
