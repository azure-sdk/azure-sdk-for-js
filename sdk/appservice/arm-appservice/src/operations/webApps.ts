...
export class WebAppsImpl implements WebApps {
  ...
  listInstanceWorkflowsConfigurationConnectionsSlot(
    ...
    return this.client.sendOperationRequest(
      { resourceGroupName, name, slot, configurationName, options },
  ...
  listWorkflowsConfiguration(
    ...
    return this.client.sendOperationRequest(
      { resourceGroupName, name, configurationName, options },
...
const listInstanceWorkflowsConfigurationConnectionsSlotOperationSpec: coreClient.OperationSpec = {
  path:
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot}/workflowConfigurations/{configurationName}",
  httpMethod: "GET",
  responses: {
    200: {
      bodyMapper: Mappers.WorkflowEnvelope
...
const listWorkflowsConfigurationOperationSpec: coreClient.OperationSpec = {
  path:
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/workflowConfigurations/{configurationName}",
  httpMethod: "GET",
  responses: {
    200: {
      bodyMapper: Mappers.WorkflowEnvelope
