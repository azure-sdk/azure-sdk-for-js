...
import {
  ...
  DatabaseAccountsListNextOptionalParams,
  DatabaseAccountsListOptionalParams,
  DatabaseAccountsListResponse,
  DatabaseAccountsListByResourceGroupNextOptionalParams,
  ...
  DatabaseAccountsListNextResponse,
  DatabaseAccountsListByResourceGroupNextResponse,
} from "../models";
...
export class DatabaseAccountsImpl implements DatabaseAccounts {
  ...
  private _listNext(
    nextLink: string,
    options?: DatabaseAccountsListNextOptionalParams,
  ): Promise<DatabaseAccountsListNextResponse> {
    return this.client.sendOperationRequest(
      { nextLink, options },
  ...
  private _listByResourceGroupNext(
    resourceGroupName: string,
    nextLink: string,
    options?: DatabaseAccountsListByResourceGroupNextOptionalParams,
  ): Promise<DatabaseAccountsListByResourceGroupNextResponse> {
    return this.client.sendOperationRequest(
