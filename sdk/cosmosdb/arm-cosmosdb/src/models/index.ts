...
export interface CassandraClusterRestoreResult {
  ...
  nodes?: CassandraClusterNodeRestoreResult[];
}

export interface CassandraClusterNodeRestoreResult {
  /** Address of the node. */
  address?: string;
  /** The status of the command. */
  state?: string;
...
export type CassandraClustersGetRestoreResponse = CassandraClusterRestoreResult;
