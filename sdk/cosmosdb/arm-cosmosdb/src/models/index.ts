...
export interface DataTransferServiceResourceCreateUpdateParameters
...
export interface SqlDedicatedGatewayServiceResourceCreateUpdateParameters
  extends ServiceResourceCreateUpdateProperties {
  /** Polymorphic discriminator, which specifies the different types this object can be */
  serviceType: "SqlDedicatedGateway";
  /** DedicatedGatewayType for the service. */
...
export interface GraphAPIComputeServiceResourceCreateUpdateParameters
  extends ServiceResourceCreateUpdateProperties {
  /** Polymorphic discriminator, which specifies the different types this object can be */
  serviceType: "GraphAPICompute";
}
 ...
 * **ConfigurationPropagationFailure**: An error occurred while applying the configuration.
 */
