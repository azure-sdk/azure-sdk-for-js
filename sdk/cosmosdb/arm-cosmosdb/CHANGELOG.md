...
## 17.0.0-beta.1 (2024-06-27)
Compared with version 16.0.0
...
**Features**
  ...
  - Added Interface CassandraClusterNodeRestoreResult
  ...
  - Interface ServiceResourceCreateUpdateParameters has a new optional parameter instanceCount
  - Interface ServiceResourceCreateUpdateParameters has a new optional parameter instanceSize
  - Interface ServiceResourceCreateUpdateParameters has a new optional parameter serviceType
...
**Breaking Changes**
  ...
  - Interface ServiceResourceCreateUpdateParameters no longer has parameter properties
  - Interface SqlDedicatedGatewayServiceResourceProperties no longer has parameter dedicatedGatewayType
  - Type of parameter arguments of interface CommandPostBody is changed from {
        [propertyName: string]: string;
    } to Record<string, unknown>
  - Removed Enum KnownDedicatedGatewayType
  - Enum KnownServerVersion no longer has value Five0
  - Enum KnownServerVersion no longer has value Six0
