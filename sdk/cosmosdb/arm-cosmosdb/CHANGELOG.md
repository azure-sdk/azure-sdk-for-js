...
### Features Added
  ...
  - Added Interface AzureBlobDataTransferDataSourceSinkDetails
  - Added Interface AzureBlobStorageContainerEntity
  - Added Interface BackupResource
  - Added Interface BackupSchedule
  - Added Interface BaseDataTransferTask
  ...
  - Added Interface CosmosCassandraContainerEntity
  - Added Interface CosmosDataTransferDataSourceSinkDetails
  - Added Interface CosmosMongoContainerEntity
  - Added Interface CosmosMongoVCoreContainerEntity
  - Added Interface CosmosSqlContainerEntity
  ...
  - Added Interface MongoVCoreDataTransferDataSourceSinkDetails
  ...
  - Added Interface SourceBlobDestinationCassandraDataTransferProperties
  - Added Interface SourceBlobDestinationCassandraDataTransferPropertiesTasksItem
  - Added Interface SourceCassandraDestinationBlobDataTransferProperties
  - Added Interface SourceCassandraDestinationBlobDataTransferPropertiesTasksItem
  - Added Interface SourceCassandraDestinationCassandraDataTransferProperties
  - Added Interface SourceCassandraDestinationCassandraDataTransferPropertiesTasksItem
  - Added Interface SourceMongoDestinationMongoDataTransferProperties
  - Added Interface SourceMongoDestinationMongoDataTransferPropertiesTasksItem
  - Added Interface SourceMongoDestinationMongoVCoreDataTransferProperties
  - Added Interface SourceMongoDestinationMongoVCoreDataTransferPropertiesTasksItem
  - Added Interface SourceSqlDestinationSqlDataTransferProperties
  - Added Interface SourceSqlDestinationSqlDataTransferPropertiesTasksItem
  ...
  - Added Type Alias DataTransferJobPropertiesDataTransferType
  - Added Type Alias DataTransferJobPropertiesUnion
  ...
  - Added Enum KnownDataTransferJobPropertiesDataTransferType
