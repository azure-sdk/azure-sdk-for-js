...
export interface Databases {
    ...
    beginFlush(resourceGroupName: string, clusterName: string, databaseName: string, options?: DatabasesFlushOptionalParams): Promise<PollerLike<PollOperationState<void>, void>>;
