# Azure DocumentIntelligence(formerlyFormRecognizer)Test REST client library for JavaScript
...
Install the Azure DocumentIntelligence(formerlyFormRecognizer)Test REST client REST client library for JavaScript with `npm`:
