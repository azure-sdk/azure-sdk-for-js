# Azure DocumentIntelligenceFormerlyFormRecognizerTesting REST client library for JavaScript
...
Install the Azure DocumentIntelligenceFormerlyFormRecognizerTesting REST client REST client library for JavaScript with `npm`:
