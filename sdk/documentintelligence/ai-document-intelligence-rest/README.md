# Azure DocumentIntelligence(formerlyFormRecognizer)ForTesting REST client library for JavaScript
...
Install the Azure DocumentIntelligence(formerlyFormRecognizer)ForTesting REST client REST client library for JavaScript with `npm`:
