...
export const dataSubnet: OperationParameter = {
  parameterPath: ["options", "dataSubnet"],
  mapper: AzureTrafficCollectorMapper,
};

export const managementSubnet: OperationParameter = {
  parameterPath: ["options", "managementSubnet"],
  mapper: AzureTrafficCollectorMapper,
};
