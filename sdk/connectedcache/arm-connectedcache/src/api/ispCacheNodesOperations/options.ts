...
/** Optional parameters. */
export interface IspCacheNodesOperationsGetCacheNodeMccIssueDetailsHistoryOptionalParams
  extends OperationOptions {}

/** Optional parameters. */
export interface IspCacheNodesOperationsGetCacheNodeAutoUpdateHistoryOptionalParams
  extends OperationOptions {}
