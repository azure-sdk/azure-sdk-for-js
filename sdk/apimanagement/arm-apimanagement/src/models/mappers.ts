...
export const WikiContractProperties: coreClient.CompositeMapper = {
  serializedName: "WikiContractProperties",
  type: {
    name: "Composite",
    className: "WikiContractProperties",
    modelProperties: {
      documents: {
...
export const DocumentationContractProperties: coreClient.CompositeMapper = {
  serializedName: "DocumentationContractProperties",
  type: {
    name: "Composite",
    className: "DocumentationContractProperties",
    modelProperties: {
      title: {
        serializedName: "title",
        xmlName: "title",
