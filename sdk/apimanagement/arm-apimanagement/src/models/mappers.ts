...
export const PolicyStatusCollection: coreClient.CompositeMapper = {
  serializedName: "PolicyStatusCollection",
  type: {
    name: "Composite",
    className: "PolicyStatusCollection",
    modelProperties: {
      value: {
        serializedName: "value",
        xmlName: "value",
        xmlElementName: "PolicyStatusContract",
        type: {
          name: "Sequence",
          element: {
            type: {
              name: "Composite",
              className: "PolicyStatusContract"
            }
          }
        }
      },
...
export const PolicyStatusContract: coreClient.CompositeMapper = {
  serializedName: "PolicyStatusContract",
  type: {
    name: "Composite",
    className: "PolicyStatusContract",
    modelProperties: {
