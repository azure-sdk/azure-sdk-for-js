...
/** Defines headers for AuthorizationConfirmConsentCode_confirm operation. */
...
/** Optional parameters. */
export interface AuthorizationConfirmConsentCodeConfirmOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the confirm operation. */
