...
/** API details. */
export interface ApiContract extends ProxyResourceAutoGenerated {
  /** Description of the API. May include HTML formatting tags. */
  description?: string;
  /** Collection of authentication settings included into this API. */
  authenticationSettings?: AuthenticationSettingsContract;
...
/** ApiRelease details. */
export interface ApiReleaseContract extends ProxyResourceAutoGenerated {
...
export interface OperationContract extends ProxyResourceAutoGenerated {
  /** Collection of URL template parameters. */
  templateParameters?: ParameterContract[];
  /** Description of the operation. May include HTML formatting tags. */
  description?: string;
...
export interface TagContract extends ProxyResourceAutoGenerated {
  /** Tag name. */
  displayName?: string;
}

/** GraphQL API Resolver details. */
export interface ResolverContract extends ProxyResourceAutoGenerated {
  /** Resolver Name. */
  displayName?: string;
  /** Path is type/field being resolved. */
  path?: string;
...
/** Product details. */
export interface ProductContract extends ProxyResourceAutoGenerated {
  /** Product description. May include HTML formatting tags. */
  description?: string;
  /** Product terms of use. Developers trying to subscribe to the product will be presented and required to accept these terms before they can complete the subscription process. */
  terms?: string;
...
export interface SchemaContract extends ProxyResourceAutoGenerated {
...
/** Diagnostic details. */
export interface DiagnosticContract extends ProxyResourceAutoGenerated {
...
export interface IssueContract extends ProxyResourceAutoGenerated {
  /** Date and time when the issue was created. */
  createdDate?: Date;
  /** Status of the issue. */
  state?: State;
...
export interface IssueCommentContract extends ProxyResourceAutoGenerated {
  /** Comment text. */
  text?: string;
...
export interface IssueAttachmentContract extends ProxyResourceAutoGenerated {
...
/** Contract details. */
export interface TagDescriptionContract extends ProxyResourceAutoGenerated {
  /** Description of the Tag. */
  description?: string;
  /** Absolute URL of external resources describing the tag. */
  externalDocsUrl?: string;
...
/** Wiki properties */
export interface WikiContract extends ProxyResourceAutoGenerated {
  /** Collection wiki documents included into this wiki. */
  documents?: WikiDocumentationContract[];
}

/** API Version Set Contract details. */
export interface ApiVersionSetContract extends ProxyResourceAutoGenerated {
  /** Description of API Version Set. */
  description?: string;
  /** Name of query parameter that indicates the API Version if versioningScheme is set to `query`. */
  versionQueryName?: string;
...
export interface AuthorizationProviderContract
...
export interface AuthorizationContract extends ProxyResourceAutoGenerated {
...
export interface AuthorizationAccessPolicyContract
  extends ProxyResourceAutoGenerated {
...
/** External OAuth authorization server settings. */
export interface AuthorizationServerUpdateContract
  extends ProxyResourceAutoGenerated {
  /** Description of the authorization server. Can contain HTML formatting tags. */
  description?: string;
  /** HTTP verbs supported by the authorization endpoint. GET must be always present. POST is optional. */
...
/** Backend details. */
export interface BackendContract extends ProxyResourceAutoGenerated {
  /** Backend Title. */
  title?: string;
  /** Backend Description. */
  description?: string;
...
export interface BackendReconnectContract extends ProxyResourceAutoGenerated {
  /** Duration in ISO8601 format after which reconnect will be initiated. Minimum duration of the Reconnect is PT2M. */
  after?: string;
}

/** Cache details. */
export interface CacheContract extends ProxyResourceAutoGenerated {
  /** Cache description */
  description?: string;
  /** Runtime connection string to cache */
  connectionString?: string;
...
/** Certificate details. */
export interface CertificateContract extends ProxyResourceAutoGenerated {
...
export interface ContentTypeContract extends ProxyResourceAutoGenerated {
...
/** Content type contract details. */
export interface ContentItemContract extends ProxyResourceAutoGenerated {
  /** Properties of the content item. */
  properties?: { [propertyName: string]: any };
}

/** Deleted API Management Service information. */
export interface DeletedServiceContract extends ProxyResourceAutoGenerated {
  /**
...
export interface DocumentationContract extends ProxyResourceAutoGenerated {
  /** documentation title. */
  title?: string;
  /** Markdown documentation content. */
  content?: string;
...
export interface EmailTemplateContract extends ProxyResourceAutoGenerated {
  /** Subject of the Template. */
  subject?: string;
  /** Email Template Body. This should be a valid XDocument */
  body?: string;
...
/** Gateway details. */
export interface GatewayContract extends ProxyResourceAutoGenerated {
  /** Gateway location. */
...
export interface GatewayHostnameConfigurationContract
  extends ProxyResourceAutoGenerated {
...
export interface AssociationContract extends ProxyResourceAutoGenerated {
  /** Provisioning state. */
  provisioningState?: "created";
}

/** Gateway certificate authority details. */
export interface GatewayCertificateAuthorityContract
  extends ProxyResourceAutoGenerated {
...
/** Contract details. */
export interface GroupContract extends ProxyResourceAutoGenerated {
  /** Group name. */
  displayName?: string;
  /** Group description. Can contain HTML formatting tags. */
  description?: string;
...
/** User details. */
export interface UserContract extends ProxyResourceAutoGenerated {
  /** Account state. Specifies whether the user is active or not. Blocked users are unable to sign into the developer portal or call any APIs of subscribed products. Default state is Active. */
  state?: UserState;
  /** Optional note about a user set by the administrator. */
  note?: string;
...
export interface IdentityProviderContract extends ProxyResourceAutoGenerated {
  /** Identity Provider Type identifier. */
...
/** Identity Provider details. */
export interface IdentityProviderCreateContract
  extends ProxyResourceAutoGenerated {
  /** Identity Provider Type identifier. */
  typePropertiesType?: IdentityProviderType;
  /** The TenantId to use instead of Common when logging into Active Directory */
...
/** Logger details. */
export interface LoggerContract extends ProxyResourceAutoGenerated {
  /** Logger type. */
  loggerType?: LoggerType;
  /** Logger description. */
  description?: string;
...
/** NamedValue details. */
export interface NamedValueContract extends ProxyResourceAutoGenerated {
  /** Optional tags that when provided can be used to filter the NamedValue list. */
  tags?: string[];
  /** Determines whether the value is a secret and should be encrypted or not. Default value is false. */
  secret?: boolean;
...
/** NamedValue details. */
export interface NamedValueCreateContract extends ProxyResourceAutoGenerated {
  /** Optional tags that when provided can be used to filter the NamedValue list. */
  tags?: string[];
  /** Determines whether the value is a secret and should be encrypted or not. Default value is false. */
  secret?: boolean;
...
export interface NotificationContract extends ProxyResourceAutoGenerated {
...
export interface RecipientUserContract extends ProxyResourceAutoGenerated {
  /** API Management UserId subscribed to notification. */
  userId?: string;
}

/** Recipient Email details. */
export interface RecipientEmailContract extends ProxyResourceAutoGenerated {
...
export interface PolicyDescriptionContract extends ProxyResourceAutoGenerated {
  /**
   * Policy description.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
...
export interface PolicyFragmentContract extends ProxyResourceAutoGenerated {
...
export interface ResourceCollectionValueItem
  extends ProxyResourceAutoGenerated {}

/** Long Running Git Operation Results. */
export interface OperationResultContract extends ProxyResourceAutoGenerated {
...
export interface PortalConfigContract extends ProxyResourceAutoGenerated {
...
export interface PortalRevisionContract extends ProxyResourceAutoGenerated {
...
export interface PortalSettingsContract extends ProxyResourceAutoGenerated {
  /** A delegation Url. */
  url?: string;
...
export interface PortalSigninSettings extends ProxyResourceAutoGenerated {
  /** Redirect Anonymous users to the Sign-In page. */
  enabled?: boolean;
}

/** Sign-Up settings for a developer portal. */
export interface PortalSignupSettings extends ProxyResourceAutoGenerated {
...
export interface PortalDelegationSettings extends ProxyResourceAutoGenerated {
  /** A delegation Url. */
  url?: string;
  /** A base64-encoded validation key to validate, that a request is coming from Azure API Management. */
  validationKey?: string;
...
export interface SubscriptionContract extends ProxyResourceAutoGenerated {
...
export interface ProductApiLinkContract extends ProxyResourceAutoGenerated {
  /** Full resource Id of an API. */
  apiId?: string;
}

/** Product-group link details. */
export interface ProductGroupLinkContract extends ProxyResourceAutoGenerated {
  /** Full resource Id of a group. */
  groupId?: string;
}

/** Global Schema Contract details. */
export interface GlobalSchemaContract extends ProxyResourceAutoGenerated {
...
/** Tenant Settings. */
export interface TenantSettingsContract extends ProxyResourceAutoGenerated {
  /** Tenant settings */
  settings?: { [propertyName: string]: string };
}

/** Tag-API link details. */
export interface TagApiLinkContract extends ProxyResourceAutoGenerated {
  /** Full resource Id of an API. */
  apiId?: string;
}

/** Tag-operation link details. */
export interface TagOperationLinkContract extends ProxyResourceAutoGenerated {
  /** Full resource Id of an API operation. */
  operationId?: string;
}

/** Tag-product link details. */
export interface TagProductLinkContract extends ProxyResourceAutoGenerated {
  /** Full resource Id of a product. */
  productId?: string;
}

/** Tenant Settings. */
export interface AccessInformationContract extends ProxyResourceAutoGenerated {
  /** Access Information type ('access' or 'gitAccess') */
  idPropertiesId?: string;
  /** Principal (User) Identifier. */
  principalId?: string;
...
/** Workspace details. */
export interface WorkspaceContract extends ProxyResourceAutoGenerated {
...
export interface ResolverResultContract extends ProxyResourceAutoGenerated {
...
/** Contains response data for the createOrUpdate operation. */
export type PolicyRestrictionCreateOrUpdateResponse = PolicyRestrictionCreateOrUpdateHeaders &
  PolicyRestrictionContract;
...
/** Contains response data for the createOrUpdate operation. */
export type WorkspaceNamedValueCreateOrUpdateResponse = WorkspaceNamedValueCreateOrUpdateHeaders &
  NamedValueContract;
...
/** Contains response data for the update operation. */
export type WorkspaceNamedValueUpdateResponse = WorkspaceNamedValueUpdateHeaders &
  NamedValueContract;
...
/** Contains response data for the listValue operation. */
export type WorkspaceNamedValueListValueResponse = WorkspaceNamedValueListValueHeaders &
  NamedValueSecretContract;
...
/** Contains response data for the refreshSecret operation. */
export type WorkspaceNamedValueRefreshSecretResponse = WorkspaceNamedValueRefreshSecretHeaders &
  NamedValueContract;
...
/** Contains response data for the get operation. */
export type WorkspacePolicyFragmentGetResponse = WorkspacePolicyFragmentGetHeaders &
  PolicyFragmentContract;
...
/** Contains response data for the createOrUpdate operation. */
export type WorkspacePolicyFragmentCreateOrUpdateResponse = WorkspacePolicyFragmentCreateOrUpdateHeaders &
  PolicyFragmentContract;
...
/** Contains response data for the createOrUpdate operation. */
export type WorkspaceGroupCreateOrUpdateResponse = WorkspaceGroupCreateOrUpdateHeaders &
  GroupContract;
...
/** Contains response data for the createOrUpdate operation. */
export type WorkspaceSubscriptionCreateOrUpdateResponse = WorkspaceSubscriptionCreateOrUpdateHeaders &
  SubscriptionContract;
...
/** Contains response data for the update operation. */
export type WorkspaceSubscriptionUpdateResponse = WorkspaceSubscriptionUpdateHeaders &
  SubscriptionContract;
...
/** Contains response data for the listSecrets operation. */
export type WorkspaceSubscriptionListSecretsResponse = WorkspaceSubscriptionListSecretsHeaders &
  SubscriptionKeysContract;
...
/** Contains response data for the get operation. */
export type WorkspaceApiVersionSetGetResponse = WorkspaceApiVersionSetGetHeaders &
  ApiVersionSetContract;
...
/** Contains response data for the createOrUpdate operation. */
export type WorkspaceApiVersionSetCreateOrUpdateResponse = WorkspaceApiVersionSetCreateOrUpdateHeaders &
  ApiVersionSetContract;
...
/** Contains response data for the update operation. */
export type WorkspaceApiVersionSetUpdateResponse = WorkspaceApiVersionSetUpdateHeaders &
  ApiVersionSetContract;
...
/** Contains response data for the createOrUpdate operation. */
export type WorkspaceApiCreateOrUpdateResponse = WorkspaceApiCreateOrUpdateHeaders &
  ApiContract;
...
/** Contains response data for the createOrUpdate operation. */
export type WorkspaceApiReleaseCreateOrUpdateResponse = WorkspaceApiReleaseCreateOrUpdateHeaders &
  ApiReleaseContract;
...
/** Contains response data for the update operation. */
export type WorkspaceApiReleaseUpdateResponse = WorkspaceApiReleaseUpdateHeaders &
  ApiReleaseContract;
...
/** Contains response data for the createOrUpdate operation. */
export type WorkspaceApiOperationCreateOrUpdateResponse = WorkspaceApiOperationCreateOrUpdateHeaders &
  OperationContract;
...
/** Contains response data for the update operation. */
export type WorkspaceApiOperationUpdateResponse = WorkspaceApiOperationUpdateHeaders &
  OperationContract;
...
/** Contains response data for the get operation. */
export type WorkspaceApiOperationPolicyGetResponse = WorkspaceApiOperationPolicyGetHeaders &
  PolicyContract;
...
/** Contains response data for the createOrUpdate operation. */
export type WorkspaceApiOperationPolicyCreateOrUpdateResponse = WorkspaceApiOperationPolicyCreateOrUpdateHeaders &
  PolicyContract;
...
/** Contains response data for the createOrUpdate operation. */
export type WorkspaceApiPolicyCreateOrUpdateResponse = WorkspaceApiPolicyCreateOrUpdateHeaders &
  PolicyContract;
...
/** Contains response data for the createOrUpdate operation. */
export type WorkspaceApiSchemaCreateOrUpdateResponse = WorkspaceApiSchemaCreateOrUpdateHeaders &
  SchemaContract;
...
/** Contains response data for the createOrUpdate operation. */
export type WorkspaceProductCreateOrUpdateResponse = WorkspaceProductCreateOrUpdateHeaders &
  ProductContract;
...
/** Contains response data for the get operation. */
export type WorkspaceProductApiLinkGetResponse = WorkspaceProductApiLinkGetHeaders &
  ProductApiLinkContract;
...
/** Contains response data for the get operation. */
export type WorkspaceProductGroupLinkGetResponse = WorkspaceProductGroupLinkGetHeaders &
  ProductGroupLinkContract;
...
/** Contains response data for the get operation. */
export type WorkspaceProductPolicyGetResponse = WorkspaceProductPolicyGetHeaders &
  PolicyContract;
...
/** Contains response data for the createOrUpdate operation. */
export type WorkspaceProductPolicyCreateOrUpdateResponse = WorkspaceProductPolicyCreateOrUpdateHeaders &
  PolicyContract;
...
/** Contains response data for the createOrUpdate operation. */
export type WorkspaceTagCreateOrUpdateResponse = WorkspaceTagCreateOrUpdateHeaders &
  TagContract;
...
/** Contains response data for the get operation. */
export type WorkspaceTagOperationLinkGetResponse = WorkspaceTagOperationLinkGetHeaders &
  TagOperationLinkContract;
...
/** Contains response data for the get operation. */
export type WorkspaceTagProductLinkGetResponse = WorkspaceTagProductLinkGetHeaders &
  TagProductLinkContract;
