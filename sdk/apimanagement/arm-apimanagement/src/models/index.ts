...
/** The response of the list policy status. */
export interface PolicyStatusCollection {
  /** Policy Status Contract value. */
  value?: PolicyStatusContract[];
  /** Next page link if any. */
  nextLink?: string;
}
...
/** Policy Status Contract details. */
export interface PolicyStatusContract extends ProxyResource {
  /** Policy Identifier */
