...
export interface BackendBaseParameters {
  ...
  type?: BackendBaseParametersType;
}
...
export interface BackendPoolItem {
  /** The unique id of the backend entity. The ID should refer to an already existing backend entity. */
  id?: string;
}
...
export interface ApiManagementServiceBaseProperties {
  ...
  /** Enable legacy portal for this API Management service. */
  legacyPortalEnabled?: boolean;
  /** Enable developer portal for this API Management service. */
...
export interface BackendContract extends ProxyResource {
  ...
  pool?: BackendBaseParametersPool;
  /** Type of the backend. A backend can be either Single or Pool. */
  typePropertiesType?: BackendBaseParametersType;
  /** Runtime Url of the Backend. */
  url?: string;
  /** Backend communication protocol. */
  protocol?: BackendProtocol;
...
/** Known values of {@link BackendBaseParametersType} that the service accepts. */
export enum KnownBackendBaseParametersType {
  /** Single */
  Single = "single",
  /** Pool */
  Pool = "pool"
...
/**
 * Defines values for BackendBaseParametersType. \
 * {@link KnownBackendBaseParametersType} can be used interchangeably with BackendBaseParametersType,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **single** \
 * **pool**
 */
export type BackendBaseParametersType = string;
