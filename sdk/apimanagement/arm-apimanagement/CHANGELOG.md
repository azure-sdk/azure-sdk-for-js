...
**Features**
  ...
  - Added Type Alias IdentityProviderContractPropertiesSecretType
  - Added Type Alias IdentityProviderCreateContractPropertiesSecretType
  - Added Type Alias IdentityProviderUpdatePropertiesSecretType
  ...
  - Interface IdentityProviderContract has a new optional parameter secretType
  - Interface IdentityProviderContractProperties has a new optional parameter secretType
  - Interface IdentityProviderCreateContract has a new optional parameter secretType
  - Interface IdentityProviderUpdateParameters has a new optional parameter secretType
  - Interface IdentityProviderUpdateProperties has a new optional parameter secretType
  ...
  - Added Enum KnownIdentityProviderContractPropertiesSecretType
  - Added Enum KnownIdentityProviderCreateContractPropertiesSecretType
  - Added Enum KnownIdentityProviderUpdatePropertiesSecretType
...
**Breaking Changes**
  ...
  - Interface IdentityProviderCreateContractProperties has a new required parameter secretType
