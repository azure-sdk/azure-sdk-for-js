...
**Breaking Changes**
  ...
  - Interface AccessInformationCollection no longer has parameter count
  - Interface ApiCollection no longer has parameter count
  - Interface ApiReleaseCollection no longer has parameter count
  - Interface ApiRevisionCollection no longer has parameter count
  - Interface ApiVersionSetCollection no longer has parameter count
  - Interface AuthorizationServerCollection no longer has parameter count
  - Interface BackendCollection no longer has parameter count
  - Interface CacheCollection no longer has parameter count
  - Interface CertificateCollection no longer has parameter count
  - Interface DiagnosticCollection no longer has parameter count
  - Interface EmailTemplateCollection no longer has parameter count
  - Interface GatewayCollection no longer has parameter count
  - Interface GlobalSchemaCollection no longer has parameter count
  - Interface GroupCollection no longer has parameter count
  - Interface IdentityProviderList no longer has parameter count
  - Interface IssueAttachmentCollection no longer has parameter count
  - Interface IssueCollection no longer has parameter count
  - Interface IssueCommentCollection no longer has parameter count
  - Interface LoggerCollection no longer has parameter count
  - Interface NamedValueCollection no longer has parameter count
  - Interface NotificationCollection no longer has parameter count
  - Interface OpenIdConnectProviderCollection no longer has parameter count
  - Interface OperationCollection no longer has parameter count
  - Interface PolicyCollection no longer has parameter count
  - Interface PolicyDescriptionCollection no longer has parameter count
  - Interface PortalSettingsCollection no longer has parameter count
  - Interface ProductCollection no longer has parameter count
  - Interface QuotaCounterCollection no longer has parameter count
  - Interface RecipientEmailCollection no longer has parameter count
  - Interface RecipientUserCollection no longer has parameter count
  - Interface RegionListResult no longer has parameter count
  - Interface ReportCollection no longer has parameter count
  - Interface RequestReportCollection no longer has parameter count
  - Interface SchemaCollection no longer has parameter count
  - Interface SubscriptionCollection no longer has parameter count
  - Interface TagCollection no longer has parameter count
  - Interface TagDescriptionCollection no longer has parameter count
  - Interface TagResourceCollection no longer has parameter count
  - Interface UserCollection no longer has parameter count
  - Interface UserIdentityCollection no longer has parameter count
