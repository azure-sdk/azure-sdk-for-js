...
// @public
export function virtualMachinesSubmitCreate(context: ComputeScheduleContext, locationparameter: string, requestBody: SubmitCreateRequest, options?: ScheduledActionsVirtualMachinesSubmitCreateOptionalParams): Promise<CreateResourceOperationResponse>;
...
// @public
export function virtualMachinesSubmitDelete(context: ComputeScheduleContext, locationparameter: string, requestBody: SubmitDeleteRequest, options?: ScheduledActionsVirtualMachinesSubmitDeleteOptionalParams): Promise<DeleteResourceOperationResponse>;
