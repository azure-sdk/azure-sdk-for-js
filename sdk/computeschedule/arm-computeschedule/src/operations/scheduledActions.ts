...
import { MicrosoftComputeScheduleManagementService } from "../microsoftComputeScheduleManagementService";
import {
...
export class ScheduledActionsImpl implements ScheduledActions {
  private readonly client: MicrosoftComputeScheduleManagementService;

  /**
   * Initialize a new instance of the class ScheduledActions class.
   * @param client Reference to the service client
   */
  constructor(client: MicrosoftComputeScheduleManagementService) {
    this.client = client;
  }
...
const virtualMachinesCancelOperationsOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    ...
    default: {
      bodyMapper: Mappers.RequestLevelError,
    },
  },
