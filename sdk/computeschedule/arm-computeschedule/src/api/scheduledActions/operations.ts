...
import {
  ...
  SubmitCreateRequest,
  submitCreateRequestSerializer,
  SubmitDeleteRequest,
  submitDeleteRequestSerializer,
...
export function _virtualMachinesSubmitDeleteSend(
  context: Client,
  locationparameter: string,
  ...
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/providers/Microsoft.ComputeSchedule/locations/{locationparameter}/virtualMachinesSubmitDelete{?api%2Dversion}",
    {
      subscriptionId: context.subscriptionId,
      locationparameter: locationparameter,
      "api%2Dversion": context.apiVersion,
  ...
  return context.path(path).post({
    ...
    body: submitDeleteRequestSerializer(requestBody),
  });
}

export async function _virtualMachinesSubmitDeleteDeserialize(
  result: PathUncheckedResponse,
...
export async function virtualMachinesSubmitDelete(
  context: Client,
  locationparameter: string,
  requestBody: SubmitDeleteRequest,
  options: ScheduledActionsVirtualMachinesSubmitDeleteOptionalParams = {
  ...
  const result = await _virtualMachinesSubmitDeleteSend(
    context,
    locationparameter,
    requestBody,
    options,
  );
  return _virtualMachinesSubmitDeleteDeserialize(result);
}

export function _virtualMachinesSubmitCreateSend(
  context: Client,
  locationparameter: string,
  ...
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/providers/Microsoft.ComputeSchedule/locations/{locationparameter}/virtualMachinesSubmitCreate{?api%2Dversion}",
    {
      subscriptionId: context.subscriptionId,
      locationparameter: locationparameter,
      "api%2Dversion": context.apiVersion,
  ...
  return context.path(path).post({
    ...
    body: submitCreateRequestSerializer(requestBody),
  });
}

export async function _virtualMachinesSubmitCreateDeserialize(
  result: PathUncheckedResponse,
...
export async function virtualMachinesSubmitCreate(
  context: Client,
  locationparameter: string,
  requestBody: SubmitCreateRequest,
  options: ScheduledActionsVirtualMachinesSubmitCreateOptionalParams = {
  ...
  const result = await _virtualMachinesSubmitCreateSend(
    context,
    locationparameter,
    requestBody,
    options,
  );
  return _virtualMachinesSubmitCreateDeserialize(result);
}
