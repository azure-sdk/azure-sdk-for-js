...
export function resourceProvisionPayloadSerializer(item: ResourceProvisionPayload): any {
  return {
    ...
    vmExtensions: !item["vmExtensions"]
      ? item["vmExtensions"]
      : virtualMachineExtensionDataArraySerializer(item["vmExtensions"]),
    resourceCount: item["resourceCount"],
    resourcePrefix: item["resourcePrefix"],
  };
}

export function virtualMachineExtensionDataArraySerializer(
  result: Array<VirtualMachineExtensionData>,
): any[] {
  return result.map((item) => {
    return virtualMachineExtensionDataSerializer(item);
  });
}
...
export function virtualMachineExtensionDataSerializer(item: VirtualMachineExtensionData): any {
  return {
    name: item["name"],
    location: item["location"],
...
export function submitCreateRequestSerializer(item: SubmitCreateRequest): any {
  return {
    schedule: scheduleSerializer(item["schedule"]),
    resourceConfigParameters: resourceProvisionPayloadSerializer(item["resourceConfigParameters"]),
...
export function submitDeleteRequestSerializer(item: SubmitDeleteRequest): any {
  return {
    schedule: scheduleSerializer(item["schedule"]),
    executionParameters: executionParametersSerializer(item["executionParameters"]),
    resources: resourcesSerializer(item["resources"]),
