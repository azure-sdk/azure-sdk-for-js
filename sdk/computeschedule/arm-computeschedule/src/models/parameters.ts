...
import {
  ...
  ExecuteCreateRequest as ExecuteCreateRequestMapper,
  ExecuteDeallocateRequest as ExecuteDeallocateRequestMapper,
  ExecuteDeleteRequest as ExecuteDeleteRequestMapper,
  ...
  SubmitCreateRequest as SubmitCreateRequestMapper,
  SubmitDeallocateRequest as SubmitDeallocateRequestMapper,
  SubmitDeleteRequest as SubmitDeleteRequestMapper,
...
export const requestBody1: OperationParameter = {
  parameterPath: "requestBody",
  mapper: ExecuteCreateRequestMapper,
};
...
export const requestBody3: OperationParameter = {
  parameterPath: "requestBody",
  mapper: ExecuteDeleteRequestMapper,
};
...
export const requestBody8: OperationParameter = {
  parameterPath: "requestBody",
  mapper: SubmitCreateRequestMapper,
};

export const requestBody9: OperationParameter = {
  parameterPath: "requestBody",
  mapper: SubmitDeallocateRequestMapper,
};

export const requestBody10: OperationParameter = {
  parameterPath: "requestBody",
  mapper: SubmitDeleteRequestMapper,
};

export const requestBody11: OperationParameter = {
  parameterPath: "requestBody",
  mapper: SubmitHibernateRequestMapper,
};

export const requestBody12: OperationParameter = {
  parameterPath: "requestBody",
