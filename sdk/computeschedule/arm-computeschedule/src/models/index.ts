...
/** This is the default error for requests made with ScheduledActions */
export interface RequestLevelError {
  /** Description of the request that failed, ie SubmitDeallocateRequest/SubmitStartRequest/SubmitHibernateRequest */
  description: string;
  /** The type of resources used in the request */
  type: string;
  /** The location of the resource used in the request */
  location: string;
  /** The error details */
  error: RequestError;
}

/** These describe errors that occur at the request level */
...
/** Optional parameters. */
export interface MicrosoftComputeScheduleManagementServiceOptionalParams
