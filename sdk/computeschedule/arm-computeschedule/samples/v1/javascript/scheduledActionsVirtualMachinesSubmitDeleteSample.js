 ...
 */
async function scheduledActionsVirtualMachinesSubmitDelete() {
  const credential = new DefaultAzureCredential();
  const subscriptionId = "0505D8E4-D41A-48FB-9CA5-4AF8D93BE75F";
  const client = new ComputeScheduleClient(credential, subscriptionId);
  const result = await client.scheduledActions.virtualMachinesSubmitDelete("lnfkgjvzsjztcid", {
    schedule: {
 ...
 */
async function scheduledActionsVirtualMachinesSubmitDeleteGeneratedByMinimumSetRule() {
  const credential = new DefaultAzureCredential();
  const subscriptionId = "0505D8E4-D41A-48FB-9CA5-4AF8D93BE75F";
  const client = new ComputeScheduleClient(credential, subscriptionId);
  const result = await client.scheduledActions.virtualMachinesSubmitDelete(
    "qtxgqgslyhbqmxbncupmychhpvur",
    {
...
async function main() {
  await scheduledActionsVirtualMachinesSubmitDelete();
