...
// @public (undocumented)
export class DataReplicationClient {
    constructor(credential: TokenCredential, subscriptionId: string, options?: DataReplicationClientOptionalParams);
...
// @public
export function restorePoller<TResponse extends PathUncheckedResponse, TResult>(client: DataReplicationClient, serializedState: string, sourceOperation: (...args: any[]) => PollerLike<OperationState<TResult>, TResult>, options?: RestorePollerOptions<TResult>): PollerLike<OperationState<TResult>, TResult>;
