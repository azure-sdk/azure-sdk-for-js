# Azure Site Recovery Management client library for JavaScript
...
[API reference documentation](https://learn.microsoft.com/javascript/api/@azure/arm-recoveryservicesdatareplication) |
