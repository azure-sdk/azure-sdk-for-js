...
import { StorageTaskManagementClient } from "../storageTaskManagementClient";
import {
  SimplePollerLike,
  OperationState,
  createHttpPoller
...
export class StorageTasksImpl implements StorageTasks {
  private readonly client: StorageTaskManagementClient;

  /**
   * Initialize a new instance of the class StorageTasks class.
   * @param client Reference to the service client
   */
  constructor(client: StorageTaskManagementClient) {
    this.client = client;
  }
