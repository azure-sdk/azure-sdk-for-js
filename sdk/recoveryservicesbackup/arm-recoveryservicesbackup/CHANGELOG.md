...
## 14.0.0-beta.1 (2025-03-21)
Compared with version 13.1.0
    
### Features Added

  - Added operation RecoveryPoints.update
  - Added Interface AzureVmWorkloadAnyDatabaseProtectableItem
  - Added Interface AzureVmWorkloadAnyDatabaseProtectedItem
  - Added Interface AzureVmWorkloadAnyDatabaseWorkloadItem
  - Added Interface AzureVmWorkloadOracleDatabaseProtectableItem
  - Added Interface AzureVmWorkloadOracleDatabaseProtectedItem
  - Added Interface AzureVmWorkloadOracleDatabaseWorkloadItem
  - Added Interface AzureVmWorkloadSAPHanaScaleoutProtectableItem
  - Added Interface AzureWorkloadAnyDatabasePointInTimeRecoveryPoint
  - Added Interface AzureWorkloadAnyDatabasePointInTimeRestoreRequest
  - Added Interface AzureWorkloadAnyDatabasePointInTimeRestoreWithRehydrateRequest
  - Added Interface AzureWorkloadAnyDatabaseRecoveryPoint
  - Added Interface AzureWorkloadAnyDatabaseRestoreRequest
  - Added Interface AzureWorkloadAnyDatabaseRestoreWithRehydrateRequest
  - Added Interface AzureWorkloadOraclePointInTimeRecoveryPoint
  - Added Interface AzureWorkloadOraclePointInTimeRestoreRequest
  - Added Interface AzureWorkloadOraclePointInTimeRestoreWithRehydrateRequest
  - Added Interface AzureWorkloadOracleRecoveryPoint
  - Added Interface AzureWorkloadOracleRestoreRequest
  - Added Interface AzureWorkloadOracleRestoreWithRehydrateRequest
  - Added Interface AzureWorkloadSAPAsePointInTimeRecoveryPoint
  - Added Interface AzureWorkloadSAPAsePointInTimeRestoreRequest
  - Added Interface AzureWorkloadSAPAsePointInTimeRestoreWithRehydrateRequest
  - Added Interface AzureWorkloadSAPAseRecoveryPoint
  - Added Interface AzureWorkloadSAPAseRestoreRequest
  - Added Interface AzureWorkloadSAPAseRestoreWithRehydrateRequest
  ...
  - Added Type Alias AzureWorkloadAnyDatabasePointInTimeRestoreRequestUnion
  - Added Type Alias AzureWorkloadAnyDatabaseRestoreRequestUnion
  - Added Type Alias AzureWorkloadOraclePointInTimeRestoreRequestUnion
  - Added Type Alias AzureWorkloadOracleRestoreRequestUnion
  - Added Type Alias AzureWorkloadSAPAsePointInTimeRestoreRequestUnion
  - Added Type Alias AzureWorkloadSAPAseRestoreRequestUnion
  - Added Type Alias DataSourceTypeAutoGenerated
  - Added Type Alias DataSourceTypeAutoGenerated2
  - Added Type Alias DataSourceTypeAutoGenerated3
  ...
  - Type of parameter workloadItemType of interface AzureVmWorkloadItem is changed from "AzureVmWorkloadItem" | "SAPAseDatabase" | "SAPAseSystem" | "SAPHanaDatabase" | "SAPHanaSystem" | "SQLDataBase" | "SQLInstance" to "AzureVmWorkloadItem" | "SAPAseDatabase" | "SAPAseSystem" | "OracleDataBase" | "AnyDataBase" | "SAPHanaDatabase" | "SAPHanaSystem" | "SQLDataBase" | "SQLInstance"
  ...
  - Type of parameter workloadItemType of interface WorkloadItem is changed from "AzureVmWorkloadItem" | "SAPAseDatabase" | "SAPAseSystem" | "SAPHanaDatabase" | "SAPHanaSystem" | "SQLDataBase" | "SQLInstance" to "AzureVmWorkloadItem" | "SAPAseDatabase" | "SAPAseSystem" | "OracleDataBase" | "AnyDataBase" | "SAPHanaDatabase" | "SAPHanaSystem" | "SQLDataBase" | "SQLInstance"
  ...
  - Added Enum KnownDataSourceTypeAutoGenerated
  - Added Enum KnownDataSourceTypeAutoGenerated2
  - Added Enum KnownDataSourceTypeAutoGenerated3
  - Added Enum KnownVMWorkloadPolicyType
  - Enum KnownContainerType has a new value AsehaContainer
  - Enum KnownContainerType has a new value HanaScaleoutContainer
  - Enum KnownContainerType has a new value OracleContainer
  - Enum KnownDataSourceType has a new value AnyDatabase
  - Enum KnownDataSourceType has a new value OracleDatabase
  - Enum KnownWorkloadItemType has a new value AnyDatabase
  - Enum KnownWorkloadItemType has a new value AnyDBSystem
  - Enum KnownWorkloadItemType has a new value OracleDatabase
  - Enum KnownWorkloadItemType has a new value OracleSystem

### Breaking Changes

  - Type of parameter resourceType of interface BackupStatusRequest is changed from DataSourceType to DataSourceTypeAutoGenerated2
  - Type of parameter resourceType of interface PreValidateEnableBackupRequest is changed from DataSourceType to DataSourceTypeAutoGenerated
  - Type of parameter workloadType of interface ProtectedItem is changed from DataSourceType to DataSourceTypeAutoGenerated3
  - Type of parameter itemType of interface ProtectedItemQueryObject is changed from DataSourceType to DataSourceTypeAutoGenerated3
