...
export type AzureWorkloadRestoreRequestUnion =
  ...
  | AzureWorkloadOracleRestoreRequestUnion
  | AzureWorkloadAnyDatabaseRestoreRequestUnion
...
export type AzureVmWorkloadItemUnion =
  ...
  | AzureVmWorkloadAnyDatabaseWorkloadItem
...
export type AzureWorkloadSAPAseRestoreRequestUnion =
  ...
  | AzureWorkloadSAPAsePointInTimeRestoreRequestUnion
  | AzureWorkloadSAPAseRestoreWithRehydrateRequest;
export type AzureWorkloadOracleRestoreRequestUnion =
  | AzureWorkloadOracleRestoreRequest
  | AzureWorkloadOraclePointInTimeRestoreRequestUnion
  | AzureWorkloadOracleRestoreWithRehydrateRequest;
export type AzureWorkloadAnyDatabaseRestoreRequestUnion =
  | AzureWorkloadAnyDatabaseRestoreRequest
  | AzureWorkloadAnyDatabasePointInTimeRestoreRequestUnion
...
export interface AzureVmWorkloadOracleDatabaseProtectedItem
  extends AzureVmWorkloadProtectedItem {
  /** Polymorphic discriminator, which specifies the different types this object can be */
...
export interface AzureVmWorkloadAnyDatabaseProtectedItem
  extends AzureVmWorkloadProtectedItem {
  /** Polymorphic discriminator, which specifies the different types this object can be */
...
export interface AzureWorkloadOracleRecoveryPoint
  extends AzureWorkloadRecoveryPoint {
  /** Polymorphic discriminator, which specifies the different types this object can be */
...
export interface AzureWorkloadAnyDatabaseRecoveryPoint
  extends AzureWorkloadRecoveryPoint {
  /** Polymorphic discriminator, which specifies the different types this object can be */
...
export interface AzureWorkloadOracleRestoreRequest
  extends AzureWorkloadRestoreRequest {
  /** Polymorphic discriminator, which specifies the different types this object can be */
  objectType:
    | "AzureWorkloadOracleRestoreRequest"
...
export interface AzureWorkloadAnyDatabaseRestoreRequest
  extends AzureWorkloadRestoreRequest {
  /** Polymorphic discriminator, which specifies the different types this object can be */
  objectType:
    | "AzureWorkloadAnyDatabaseRestoreRequest"
...
export interface AzureVmWorkloadOracleDatabaseWorkloadItem
  extends AzureVmWorkloadItem {
  /** Polymorphic discriminator, which specifies the different types this object can be */
...
export interface AzureVmWorkloadAnyDatabaseWorkloadItem
  extends AzureVmWorkloadItem {
  /** Polymorphic discriminator, which specifies the different types this object can be */
...
export interface AzureVmWorkloadOracleDatabaseProtectableItem
  extends AzureVmWorkloadProtectableItem {
  /** Polymorphic discriminator, which specifies the different types this object can be */
...
export interface AzureVmWorkloadAnyDatabaseProtectableItem
  extends AzureVmWorkloadProtectableItem {
  /** Polymorphic discriminator, which specifies the different types this object can be */
...
export interface AzureWorkloadOraclePointInTimeRecoveryPoint
  extends AzureWorkloadPointInTimeRecoveryPoint {
  /** Polymorphic discriminator, which specifies the different types this object can be */
...
export interface AzureWorkloadAnyDatabasePointInTimeRecoveryPoint
  extends AzureWorkloadPointInTimeRecoveryPoint {
  /** Polymorphic discriminator, which specifies the different types this object can be */
...
export interface AzureWorkloadSAPAseRestoreWithRehydrateRequest
  extends AzureWorkloadSAPAseRestoreRequest {
  /** Polymorphic discriminator, which specifies the different types this object can be */
...
export interface AzureWorkloadOraclePointInTimeRestoreRequest
  extends AzureWorkloadOracleRestoreRequest {
  /** Polymorphic discriminator, which specifies the different types this object can be */
  objectType:
    | "AzureWorkloadOraclePointInTimeRestoreRequest"
    | "AzureWorkloadOraclePointInTimeRestoreWithRehydrateRequest";
...
export interface AzureWorkloadOracleRestoreWithRehydrateRequest
  extends AzureWorkloadOracleRestoreRequest {
  /** Polymorphic discriminator, which specifies the different types this object can be */
...
export interface AzureWorkloadAnyDatabasePointInTimeRestoreRequest
  extends AzureWorkloadAnyDatabaseRestoreRequest {
  /** Polymorphic discriminator, which specifies the different types this object can be */
  objectType:
    | "AzureWorkloadAnyDatabasePointInTimeRestoreRequest"
    | "AzureWorkloadAnyDatabasePointInTimeRestoreWithRehydrateRequest";
...
export interface AzureWorkloadAnyDatabaseRestoreWithRehydrateRequest
  extends AzureWorkloadAnyDatabaseRestoreRequest {
  /** Polymorphic discriminator, which specifies the different types this object can be */
...
/** AzureWorkload SAP Ase-specific restore with integrated rehydration of recovery point. */
export interface AzureWorkloadSAPAsePointInTimeRestoreWithRehydrateRequest
  extends AzureWorkloadSAPAsePointInTimeRestoreRequest {
  /** Polymorphic discriminator, which specifies the different types this object can be */
...
/** AzureWorkload Oracle-specific restore with integrated rehydration of recovery point. */
export interface AzureWorkloadOraclePointInTimeRestoreWithRehydrateRequest
...
/** AzureWorkload AnyDatabase-specific restore with integrated rehydration of recovery point. */
export interface AzureWorkloadAnyDatabasePointInTimeRestoreWithRehydrateRequest
...
/** Known values of {@link DataSourceTypeAutoGenerated} that the service accepts. */
...
/**
 * Defines values for DataSourceTypeAutoGenerated. \
 * {@link KnownDataSourceTypeAutoGenerated} can be used interchangeably with DataSourceTypeAutoGenerated,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Invalid** \
 * **VM** \
...
/** Known values of {@link DataSourceTypeAutoGenerated2} that the service accepts. */
...
/**
 * Defines values for DataSourceTypeAutoGenerated2. \
 * {@link KnownDataSourceTypeAutoGenerated2} can be used interchangeably with DataSourceTypeAutoGenerated2,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Invalid** \
 * **VM** \
...
/** Known values of {@link DataSourceTypeAutoGenerated3} that the service accepts. */
...
/**
 * Defines values for DataSourceTypeAutoGenerated3. \
 * {@link KnownDataSourceTypeAutoGenerated3} can be used interchangeably with DataSourceTypeAutoGenerated3,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Invalid** \
 * **VM** \
...
/** Known values of {@link VMWorkloadPolicyType} that the service accepts. */
...
/**
 * Defines values for VMWorkloadPolicyType. \
