...
import { ExtensionsImpl, OperationStatusImpl } from "./operations";
import { Extensions, OperationStatus } from "./operationsInterfaces";
import { ExtensionsClientOptionalParams } from "./models";
...
export class ExtensionsClient extends coreClient.ServiceClient {
  ...
  constructor(
    ...
    const packageDetails = `azsdk-js-arm-kubernetesconfiguration-extensions/1.0.0`;
