    ...
    type: {
      ...
      modelProperties: {
        ...
        type: {
          ...
          type: {
            name: "Enum",
            allowedValues: ["SystemAssigned", "UserAssigned", "Workload"],
          },
        },
      },
    },
...
export const ManagementDetails: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
      ...
      accessDetails: {
        ...
        type: {
          ...
          element: {
            type: {
              name: "Composite",
              className: "ManagementDetailsAccessDetailsItem",
            },
          },
        },
      },
...
export const ManagementDetailsAccessDetailsItem: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ManagementDetailsAccessDetailsItem",
    modelProperties: {
...
export const AdditionalDetails: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
  ...
  type: {
    ...
    modelProperties: {
      ...
      type: {
        ...
        type: {
          name: "Enum",
          allowedValues: ["UserAssigned", "SystemAssigned"],
        },
      },
      userAssignedIdentities: {
        ...
        type: {
          ...
          value: {
            type: {
              name: "Composite",
              className: "UserAssignedIdentitiesAdditionalProperties",
            },
          },
        },
      },
...
export const UserAssignedIdentitiesAdditionalProperties: coreClient.CompositeMapper =
  {
    type: {
      name: "Composite",
      className: "UserAssignedIdentitiesAdditionalProperties",
...
export const Extension: coreClient.CompositeMapper = {
  type: {
    ...
    modelProperties: {
      ...
      managementDetails: {
        serializedName: "properties.managementDetails",
        type: {
          name: "Composite",
          className: "ManagementDetails",
        },
