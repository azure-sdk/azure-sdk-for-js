...
export function _refreshSend(
  ...
  options: ManagedGrafanasRefreshOptionalParams = { requestOptions: {} },
): StreamableMethod {
...
export function _listSend(
  context: Client,
  options: ManagedGrafanasListOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
...
export function _$deleteSend(
  ...
  resourceGroupName: string,
  workspaceName: string,
  options: ManagedGrafanasDeleteOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
...
export function _updateSend(
  ...
  options: ManagedGrafanasUpdateOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Dashboard/grafana/{workspaceName}{?api%2Dversion}",
    {
...
export function _createSend(
  ...
  options: ManagedGrafanasCreateOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Dashboard/grafana/{workspaceName}{?api%2Dversion}",
    {
...
export function _getSend(
  ...
  resourceGroupName: string,
  workspaceName: string,
  options: ManagedGrafanasGetOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Dashboard/grafana/{workspaceName}{?api%2Dversion}",
    {
