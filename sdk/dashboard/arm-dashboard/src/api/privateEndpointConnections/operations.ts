...
import { DashboardContext as Client } from "../index.js";
import {
...
export function _approveSend(
  ...
  return context.path(path).put({
    ...
    body: privateEndpointConnectionSerializer(body),
  });
}
...
export function approve(
  ...
  return getLongRunningPoller(context, _approveDeserialize, ["201", "200"], {
    updateIntervalInMs: options?.updateIntervalInMs,
    abortSignal: options?.abortSignal,
    getInitialResponse: () =>
      _approveSend(
