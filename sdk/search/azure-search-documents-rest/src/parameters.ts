...
export type IndexersOperationsResetDocsParameters =
  IndexersOperationsResetDocsQueryParam &
...
export type SkillsetsOperationsResetSkillsParameters =
  SkillsetsOperationsResetSkillsHeaderParam &
...
export type AliasesOperationsCreateParameters =
  AliasesOperationsCreateHeaderParam &
...
export type AliasesOperationsListParameters = AliasesOperationsListHeaderParam &
  RequestParameters;
...
export type AliasesOperationsCreateOrUpdateParameters =
  AliasesOperationsCreateOrUpdateHeaderParam &
...
export type AliasesOperationsDeleteParameters =
  AliasesOperationsDeleteHeaderParam & RequestParameters;
...
export type AliasesOperationsGetParameters = AliasesOperationsGetHeaderParam &
  RequestParameters;
...
export interface DocumentsOperationsSearchGetQueryParamProperties {
  ...
  semanticFields?:
    | string[]
    | DocumentsOperationsSearchGetSemanticFieldsQueryParam;
}
