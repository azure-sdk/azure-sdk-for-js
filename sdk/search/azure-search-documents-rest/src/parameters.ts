...
export interface DocumentsOperationsSearchGetQueryParamProperties {
   ...
   * of name:value pairs. This parameter needs to be formatted as multi collection, we provide buildMultiCollection from serializeHelper.ts to help, you will probably need to set skipUrlEncoding as true when sending the request
   */
  facet?: string;
   ...
   * parameter string would be "mylocation--122.2,44.8" (without the quotes). This parameter needs to be formatted as multi collection, we provide buildMultiCollection from serializeHelper.ts to help, you will probably need to set skipUrlEncoding as true when sending the request
   */
