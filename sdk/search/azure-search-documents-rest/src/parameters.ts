...
export type DataSourcesCreateOrUpdateParameters = DataSourcesCreateOrUpdateQueryParam &
  DataSourcesCreateOrUpdateHeaderParam &
...
export type IndexersResetDocsParameters = IndexersResetDocsQueryParam &
  IndexersResetDocsHeaderParam &
  IndexersResetDocsBodyParam &
  RequestParameters;
...
export type IndexersCreateOrUpdateParameters = IndexersCreateOrUpdateQueryParam &
  IndexersCreateOrUpdateHeaderParam &
...
export type SkillsetsCreateOrUpdateParameters = SkillsetsCreateOrUpdateQueryParam &
  SkillsetsCreateOrUpdateHeaderParam &
...
export type SkillsetsResetSkillsParameters = SkillsetsResetSkillsHeaderParam &
  SkillsetsResetSkillsBodyParam &
  RequestParameters;
...
export type AliasesCreateParameters = AliasesCreateHeaderParam &
  AliasesCreateBodyParam &
  RequestParameters;
...
export type AliasesCreateOrUpdateParameters = AliasesCreateOrUpdateHeaderParam &
  AliasesCreateOrUpdateBodyParam &
  RequestParameters;
...
export interface DocumentsSearchGet$orderbyQueryParam {
  /** Value of the parameter */
  value: string[];
  /** Should we explode the value? */
  explode: false;
...
export interface DocumentsSearchGet$selectQueryParam {
  /** Value of the parameter */
  value: string[];
  /** Should we explode the value? */
  explode: false;
...
export interface DocumentsSearchGetQueryParamProperties {
   ...
   */
  $orderby?: string[] | DocumentsSearchGet$orderbyQueryParam;
  /**
   ...
   */
  $select?: string[] | DocumentsSearchGet$selectQueryParam;
  /**
...
/** This is the wrapper object for the parameter `$select` with explode set to false and style set to form. */
export interface DocumentsGet$selectQueryParam {
  /** Value of the parameter */
  value: string[];
  /** Should we explode the value? */
  explode: false;
...
export interface DocumentsGetQueryParamProperties {
   ...
   */
  $select?: string[] | DocumentsGet$selectQueryParam;
}
...
/** This is the wrapper object for the parameter `$orderby` with explode set to false and style set to form. */
export interface DocumentsSuggestGet$orderbyQueryParam {
  /** Value of the parameter */
  value: string[];
  /** Should we explode the value? */
  explode: false;
...
/** This is the wrapper object for the parameter `$select` with explode set to false and style set to form. */
export interface DocumentsSuggestGet$selectQueryParam {
  /** Value of the parameter */
  value: string[];
  /** Should we explode the value? */
  explode: false;
...
export interface DocumentsSuggestGetQueryParamProperties {
   ...
   * can be at most 32 $orderby clauses.
   */
  $orderby?: string[] | DocumentsSuggestGet$orderbyQueryParam;
  /**
   ...
   */
  $select?: string[] | DocumentsSuggestGet$selectQueryParam;
  /**
