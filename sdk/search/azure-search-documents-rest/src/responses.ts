...
export interface IndexersOperationsResetDocsDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponseOutput;
}
...
/** There is no content to send for this request, but the headers may be useful. */
export interface SkillsetsOperationsResetSkills204Response
  extends HttpResponse {
  status: "204";
}

export interface SkillsetsOperationsResetSkillsDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponseOutput;
}
...
/** The request has succeeded. */
export interface AliasesOperationsCreateOrUpdate200Response
  extends HttpResponse {
  status: "200";
  body: SearchAliasOutput;
}
...
/** The request has succeeded and a new resource has been created as a result. */
export interface AliasesOperationsCreateOrUpdate201Response
  extends HttpResponse {
  status: "201";
  body: SearchAliasOutput;
}

export interface AliasesOperationsCreateOrUpdateDefaultResponse
  extends HttpResponse {
  status: string;
  body: ErrorResponseOutput;
}
