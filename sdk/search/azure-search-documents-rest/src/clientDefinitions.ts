...
export interface IndexersOperationsRun {
  ...
  post(
    ...
    IndexersOperationsRun202Response | IndexersOperationsRunDefaultResponse
  >;
}
...
export interface IndexersOperationsCreateOrUpdate {
  ...
  get(
    ...
    IndexersOperationsGet200Response | IndexersOperationsGetDefaultResponse
  >;
}
...
export interface SkillsetsOperationsCreateOrUpdate {
  ...
  get(
    ...
    SkillsetsOperationsGet200Response | SkillsetsOperationsGetDefaultResponse
  >;
}
...
export interface IndexesOperationsCreate {
  ...
  post(
    ...
    IndexesOperationsCreate201Response | IndexesOperationsCreateDefaultResponse
  >;
...
export interface IndexesOperationsCreateOrUpdate {
  ...
  get(
    ...
    IndexesOperationsGet200Response | IndexesOperationsGetDefaultResponse
  >;
}
...
export interface AliasesOperationsCreate {
  ...
  post(
    ...
    AliasesOperationsCreate201Response | AliasesOperationsCreateDefaultResponse
  >;
  /** Lists all aliases available for a search service. */
  get(
    options?: AliasesOperationsListParameters,
  ): StreamableMethod<
    AliasesOperationsList200Response | AliasesOperationsListDefaultResponse
  >;
}
...
export interface AliasesOperationsCreateOrUpdate {
  ...
  get(
    ...
    AliasesOperationsGet200Response | AliasesOperationsGetDefaultResponse
  >;
}
...
export interface Routes {
  ...
  (
    ...
    aliasName: string,
  ): AliasesOperationsCreateOrUpdate;
