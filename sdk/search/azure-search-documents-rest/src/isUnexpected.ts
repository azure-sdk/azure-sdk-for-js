...
export function isUnexpected(
  response: DataSourcesOperationsGet200Response | DataSourcesOperationsGetDefaultResponse,
): response is DataSourcesOperationsGetDefaultResponse;
export function isUnexpected(
  response: DataSourcesOperationsList200Response | DataSourcesOperationsListDefaultResponse,
): response is DataSourcesOperationsListDefaultResponse;
export function isUnexpected(
  response: DataSourcesOperationsCreate201Response | DataSourcesOperationsCreateDefaultResponse,
): response is DataSourcesOperationsCreateDefaultResponse;
export function isUnexpected(
  response: IndexersOperationsReset204Response | IndexersOperationsResetDefaultResponse,
): response is IndexersOperationsResetDefaultResponse;
export function isUnexpected(
  response: IndexersOperationsResetDocs204Response | IndexersOperationsResetDocsDefaultResponse,
): response is IndexersOperationsResetDocsDefaultResponse;
export function isUnexpected(
  response: IndexersOperationsRun202Response | IndexersOperationsRunDefaultResponse,
...
export function isUnexpected(
  response: IndexersOperationsGet200Response | IndexersOperationsGetDefaultResponse,
): response is IndexersOperationsGetDefaultResponse;
export function isUnexpected(
  response: IndexersOperationsList200Response | IndexersOperationsListDefaultResponse,
): response is IndexersOperationsListDefaultResponse;
export function isUnexpected(
  response: IndexersOperationsCreate201Response | IndexersOperationsCreateDefaultResponse,
): response is IndexersOperationsCreateDefaultResponse;
export function isUnexpected(
  response: IndexersOperationsGetStatus200Response | IndexersOperationsGetStatusDefaultResponse,
...
export function isUnexpected(
  response: SkillsetsOperationsGet200Response | SkillsetsOperationsGetDefaultResponse,
): response is SkillsetsOperationsGetDefaultResponse;
export function isUnexpected(
  response: SkillsetsOperationsList200Response | SkillsetsOperationsListDefaultResponse,
): response is SkillsetsOperationsListDefaultResponse;
export function isUnexpected(
  response: SkillsetsOperationsCreate201Response | SkillsetsOperationsCreateDefaultResponse,
): response is SkillsetsOperationsCreateDefaultResponse;
export function isUnexpected(
  response:
    | SkillsetsOperationsResetSkills204Response
    | SkillsetsOperationsResetSkillsDefaultResponse,
): response is SkillsetsOperationsResetSkillsDefaultResponse;
export function isUnexpected(
  response:
    | SynonymMapsOperationsCreateOrUpdate200Response
    | SynonymMapsOperationsCreateOrUpdate201Response
...
export function isUnexpected(
  response: SynonymMapsOperationsGet200Response | SynonymMapsOperationsGetDefaultResponse,
): response is SynonymMapsOperationsGetDefaultResponse;
export function isUnexpected(
  response: SynonymMapsOperationsList200Response | SynonymMapsOperationsListDefaultResponse,
): response is SynonymMapsOperationsListDefaultResponse;
export function isUnexpected(
  response: SynonymMapsOperationsCreate201Response | SynonymMapsOperationsCreateDefaultResponse,
): response is SynonymMapsOperationsCreateDefaultResponse;
export function isUnexpected(
  response: IndexesOperationsCreate201Response | IndexesOperationsCreateDefaultResponse,
): response is IndexesOperationsCreateDefaultResponse;
export function isUnexpected(
  response: IndexesOperationsList200Response | IndexesOperationsListDefaultResponse,
...
export function isUnexpected(
  response: IndexesOperationsGet200Response | IndexesOperationsGetDefaultResponse,
...
export function isUnexpected(
  response: IndexesOperationsAnalyze200Response | IndexesOperationsAnalyzeDefaultResponse,
): response is IndexesOperationsAnalyzeDefaultResponse;
export function isUnexpected(
  response: AliasesOperationsCreate201Response | AliasesOperationsCreateDefaultResponse,
): response is AliasesOperationsCreateDefaultResponse;
export function isUnexpected(
  response: AliasesOperationsList200Response | AliasesOperationsListDefaultResponse,
): response is AliasesOperationsListDefaultResponse;
export function isUnexpected(
  response:
    | AliasesOperationsCreateOrUpdate200Response
    | AliasesOperationsCreateOrUpdate201Response
    | AliasesOperationsCreateOrUpdateDefaultResponse,
): response is AliasesOperationsCreateOrUpdateDefaultResponse;
export function isUnexpected(
  response:
    | AliasesOperationsDelete204Response
    | AliasesOperationsDelete404Response
    | AliasesOperationsDeleteDefaultResponse,
): response is AliasesOperationsDeleteDefaultResponse;
export function isUnexpected(
  response: AliasesOperationsGet200Response | AliasesOperationsGetDefaultResponse,
): response is AliasesOperationsGetDefaultResponse;
export function isUnexpected(
  response: DocumentsOperationsCount200Response | DocumentsOperationsCountDefaultResponse,
): response is DocumentsOperationsCountDefaultResponse;
export function isUnexpected(
  response: DocumentsOperationsSearchGet200Response | DocumentsOperationsSearchGetDefaultResponse,
): response is DocumentsOperationsSearchGetDefaultResponse;
export function isUnexpected(
  response: DocumentsOperationsSearchPost200Response | DocumentsOperationsSearchPostDefaultResponse,
): response is DocumentsOperationsSearchPostDefaultResponse;
export function isUnexpected(
  response: DocumentsOperationsGet200Response | DocumentsOperationsGetDefaultResponse,
): response is DocumentsOperationsGetDefaultResponse;
export function isUnexpected(
  response: DocumentsOperationsSuggestGet200Response | DocumentsOperationsSuggestGetDefaultResponse,
