...
import {
  MonitoringInstance as MonitoringInstanceMapper,
...
export const apiVersion: OperationQueryParameter = {
  ...
  mapper: {
    defaultValue: "2022-09-13-preview",
    isConstant: true,
...
export const monitoringInstance: OperationParameter = {
  parameterPath: "monitoringInstance",
  mapper: MonitoringInstanceMapper
};
...
export const monitoringInstance1: OperationParameter = {
  parameterPath: ["options", "monitoringInstance"],
