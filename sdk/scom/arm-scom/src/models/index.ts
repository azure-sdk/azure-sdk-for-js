...
export interface FilteredResourcesResponseProperties {
  ...
  resourceAdditionalProperties?: { [propertyName: string]: string };
}
...
/** Defines headers for Onboard_gateway operation. */
...
/** Defines headers for Offboard_gateway operation. */
...
/** Defines headers for Offboard_monitoredResource operation. */
...
/** Known values of {@link OnboardingStatusValues} that the service accepts. */
...
/**
 * Defines values for OnboardingStatusValues. \
 * {@link KnownOnboardingStatusValues} can be used interchangeably with OnboardingStatusValues,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Failed** \
 * **Succeeded**
...
/** Known values of {@link AutoUpgrade} that the service accepts. */
 ...
 * {@link KnownAutoUpgrade} can be used interchangeably with AutoUpgrade,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Enabled** \
 * **Disabled**
...
/** Known values of {@link InstallType} that the service accepts. */
...
/**
 * Defines values for InstallType. \
 * {@link KnownInstallType} can be used interchangeably with InstallType,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Invalid** \
 * **RPManaged** \
...
/** Optional parameters. */
export interface ResourceSummaryOptionalParams
  extends coreClient.OperationOptions {}
...
/** Optional parameters. */
export interface ResourceListOptionalParams
  extends coreClient.OperationOptions {}
...
/** Optional parameters. */
export interface OnboardGatewayOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Contains response data for the gateway operation. */
export type OnboardGatewayResponse = CommonResponseProperties;

/** Optional parameters. */
export interface OffboardGatewayOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Optional parameters. */
export interface OffboardMonitoredResourceOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Contains response data for the monitoredResource operation. */
