...
/** Employee resource */
export interface EmployeeOutput extends TrackedResourceOutput {
  /** The resource-specific properties for this resource. */
  properties?: EmployeePropertiesOutput;
}

/** Employee properties */
export interface EmployeePropertiesOutput {
  /** Age of employee */
  age?: number;
  /** City of employee */
  city?: string;
...
export type EmployeeListResultOutput = Paged<EmployeeOutput>;
