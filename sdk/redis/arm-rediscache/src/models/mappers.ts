      ...
      value: {
        ...
        type: {
          ...
          element: {
            type: {
              name: "Composite",
              className: "RedisCacheAccessPolicyAssignmentSet"
            }
          }
        }
      },
...
export const RedisCacheAccessPolicyAssignmentSet: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "RedisCacheAccessPolicyAssignmentSet",
    modelProperties: {
      ...
      assignments: {
        serializedName: "properties.assignments",
        type: {
          name: "Sequence",
          element: {
            type: {
