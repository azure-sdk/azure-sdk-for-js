...
export const OperationStatusResultAutoGenerated: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "OperationStatusResultAutoGenerated",
    modelProperties: {
      id: {
        serializedName: "id",
        type: {
...
export const OperationStatus: coreClient.CompositeMapper = {
  type: {
    ...
    modelProperties: {
      ...OperationStatusResultAutoGenerated.type.modelProperties,
      properties: {
