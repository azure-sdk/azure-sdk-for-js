...
// @public
export interface OperationStatus extends OperationStatusResultAutoGenerated {
    properties?: {
...
// @public
export interface OperationStatusResultAutoGenerated {
    endTime?: Date;
    error?: ErrorDetailAutoGenerated2;
    id?: string;
    name?: string;
    operations?: OperationStatusResultAutoGenerated[];
    percentComplete?: number;
    startTime?: Date;
    status: string;
}
