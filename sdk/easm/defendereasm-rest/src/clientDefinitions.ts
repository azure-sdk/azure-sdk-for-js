...
export interface Routes {
  ...
  /** Resource for '/dataConnections/\{dataConnectionName\}:validate' has methods for the following verbs: post */
  (
    path: "/dataConnections/{dataConnectionName}:validate",
  ...
  /** Resource for '/discoGroups/\{groupName\}:validate' has methods for the following verbs: post */
  (
    path: "/discoGroups/{groupName}:validate",
    groupName: string,
  ): ValidateDiscoGroup;
