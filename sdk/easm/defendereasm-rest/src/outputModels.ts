...
/** This is an object that exists to provide a common schema definition for the priority response. */
...
export interface ActionParametersOutput {
  /** The value parameter that is used by the policy action.. */
  value?: string;
  /** The optional name parameter that can be used by the policy action. */
  name?: string;
}
