...
export interface LiftrBaseStorageManagedServiceIdentityUpdate {
  ...
  userAssignedIdentities?: {
    [
      propertyName: string
    ]: Components1QrezbwSchemasLiftrbaseStorageManagedserviceidentityupdatePropertiesUserassignedidentitiesAdditionalproperties | null;
  };
}
...
export interface Components1QrezbwSchemasLiftrbaseStorageManagedserviceidentityupdatePropertiesUserassignedidentitiesAdditionalproperties
...
/** Known values of {@link ResourceEncryptionType} that the service accepts. */
...
/**
 * Defines values for ResourceEncryptionType. \
 * {@link KnownResourceEncryptionType} can be used interchangeably with ResourceEncryptionType,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **ENCRYPTION_AT_REST_WITH_MICROSOFT_KEY**: Microsoft Managed key \
 * **ENCRYPTION_AT_REST_WITH_CUSTOMER_KEY**: Customer Managed key
 */
export type ResourceEncryptionType = string;

/** Known values of {@link EncryptionIdentityType} that the service accepts. */
...
/** Optional parameters. */
export interface DellStorageOptionalParams
