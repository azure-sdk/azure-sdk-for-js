      ...
      return {
        ...
        completedAt:
          p["completed_at"] !== undefined
            ...
            : undefined,
        failedAt:
          p["failed_at"] !== undefined ? new Date(p["failed_at"]) : undefined,
        expiredAt:
          p["expired_at"] !== undefined ? new Date(p["expired_at"]) : undefined,
        cancellingAt:
...
export async function createBatch(
  ...
  const result = await _createBatchSend(
    context,
    endpoint,
    inputFileId,
    completionWindow,
...
): StreamableMethod<GetBatch200Response> {
  return context
