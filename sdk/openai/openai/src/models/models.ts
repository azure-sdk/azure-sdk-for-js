      ...
      : [
          {
            ...
            body: !item["timestampGranularities"]
...
export function chatCompletionStreamOptionsSerializer(
  item: ChatCompletionStreamOptions,
): any {
...
export function completionsDeserializer(item: any): Completions {
  return {
    ...
    usage: !item["usage"]
      ? item["usage"]
      : completionsUsageDeserializer(item["usage"]),
...
export function contentFilterResultsForChoiceDeserializer(
  ...
  return {
    ...
    ungroundedMaterial: !item["ungrounded_material"]
      ...
      : contentFilterCompletionTextSpanResultDeserializer(
          item["ungrounded_material"],
        ),
  };
}
...
export function completionsUsageDeserializer(item: any): CompletionsUsage {
  return {
    ...
    promptTokensDetails: !item["prompt_tokens_details"]
      ...
      : _completionsUsagePromptTokensDetailsDeserializer(
          item["prompt_tokens_details"],
        ),
    completionTokensDetails: !item["completion_tokens_details"]
      ? item["completion_tokens_details"]
      : _completionsUsageCompletionTokensDetailsDeserializer(
          item["completion_tokens_details"],
        ),
  };
}
...
export function chatCompletionsOptionsSerializer(
  ...
  return {
    ...
    audio: !item["audio"]
      ? item["audio"]
      : audioOutputParametersSerializer(item["audio"]),
  };
}
...
export function chatRequestMessageUnionSerializer(
  ...
  switch (item.role) {
    ...
    case "developer":
      return chatRequestDeveloperMessageSerializer(
        item as ChatRequestDeveloperMessage,
      );
...
export type _ChatRequestSystemMessageContent =
  | string
...
export function chatRequestDeveloperMessageSerializer(
  item: ChatRequestDeveloperMessage,
): any {
  return {
    role: item["role"],
...
export type _ChatRequestDeveloperMessageContent =
  | string
  | ChatMessageTextContentItem[];
...
export function chatMessageAudioContentItemSerializer(
  item: ChatMessageAudioContentItem,
): any {
  return {
    type: item["type"],
...
export interface ChatRequestAssistantMessage extends ChatRequestMessage {
  ...
  /** The content of the message. */
  content:
    | (string | ChatMessageTextContentItem[] | ChatMessageRefusalContentItem[])
    | null;
  /** An optional name for the participant. */
  name?: string;
  /**
...
export function chatMessageRefusalContentItemSerializer(
  item: ChatMessageRefusalContentItem,
): any {
...
export type _ChatRequestToolMessageContent =
  | string
  | ChatMessageTextContentItem[];
...
export function azureChatExtensionConfigurationUnionSerializer(
  ...
  switch (item.type) {
    ...
    case "mongo_db":
      return mongoDBChatExtensionConfigurationSerializer(
        item as MongoDBChatExtensionConfiguration,
      );
...
export interface MongoDBChatExtensionConfiguration
  extends AzureChatExtensionConfiguration {
...
export function mongoDBChatExtensionParametersSerializer(
  ...
  return {
    ...
    authentication: !item["authentication"]
      ? item["authentication"]
      : onYourDataUsernameAndPasswordAuthenticationOptionsSerializer(
          item["authentication"],
        ),
    endpoint: item["endpoint"],
    ...
    index_name: item["indexName"],
    fields_mapping: _mongoDBChatExtensionParametersFieldsMappingSerializer(
      item["fieldsMapping"],
    ),
    embedding_dependency:
      _mongoDBChatExtensionParametersEmbeddingDependencySerializer(
        item["embeddingDependency"],
      ),
  };
}
 ...
 */
export interface ChatCompletionsJsonSchemaResponseFormat
  extends ChatCompletionsResponseFormat {
...
export function chatCompletionsJsonSchemaResponseFormatSerializer(
  ...
  return {
    type: item["type"],
    json_schema: _chatCompletionsJsonSchemaResponseFormatJsonSchemaSerializer(
      item["jsonSchema"],
    ),
  };
}
...
export function chatCompletionsFunctionToolDefinitionSerializer(
  ...
  return {
    type: item["type"],
    function: _chatCompletionsFunctionToolDefinitionFunctionSerializer(
      item["function"],
    ),
  };
}
...
export function _predictionContentContentSerializer(
  item: _PredictionContentContent,
): any {
  return item;
}
...
export function audioOutputParametersSerializer(
  item: AudioOutputParameters,
): any {
...
export function chatMessageContentItemUnionSerializer(
  ...
  switch (item.type) {
    ...
    case "refusal":
      return chatMessageRefusalContentItemSerializer(
        item as ChatMessageRefusalContentItem,
      );
    ...
    case "input_audio":
      return chatMessageAudioContentItemSerializer(
        item as ChatMessageAudioContentItem,
      );
...
export function chatResponseMessageDeserializer(
  ...
  return {
    ...
    audio: !item["audio"]
      ? item["audio"]
      : audioResponseDataDeserializer(item["audio"]),
...
export function openAIPageableListOfBatchDeserializer(
  item: any,
...
export function batchDeserializer(item: any): Batch {
  return {
    ...
    errors: !item["errors"]
      ? item["errors"]
      : batchErrorListDeserializer(item["errors"]),
...
export function batchErrorListDeserializer(item: any): BatchErrorList {
  return {
    ...
    data: !item["data"]
      ? item["data"]
      : batchErrorDatumArrayDeserializer(item["data"]),
  };
}

export function batchErrorDatumArrayDeserializer(
  result: Array<BatchErrorDatum>,
): any[] {
  return result.map((item) => {
...
export function _batchRequestCountsDeserializer(
  item: any,
): _BatchRequestCounts {
  return {
    total: item["total"],
...
export function addUploadPartRequestSerializer(
  item: AddUploadPartRequest,
): any {
  return [
    createFilePartDescriptor("data", item["data"], "application/octet-stream"),
  ];
}
...
export function completeUploadRequestSerializer(
  item: CompleteUploadRequest,
): any {
  return {
