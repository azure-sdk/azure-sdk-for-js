...
export function chatCompletionStreamOptionsSerializer(
  ...
  return {
    include_usage: item["includeUsage"],
  };
}
...
export function mongoDBChatExtensionParametersSerializer(
  ...
  return {
    ...
    index_name: item["indexName"],
    fields_mapping: {
      content_fields: item.fieldsMapping["contentFields"],
      vector_fields: item.fieldsMapping["vectorFields"],
      title_field: item.fieldsMapping["titleField"],
      url_field: item.fieldsMapping["urlField"],
      filepath_field: item.fieldsMapping["filepathField"],
      content_fields_separator: item.fieldsMapping["contentFieldsSeparator"],
    },
    embedding_dependency: item["embeddingDependency"] as any,
  };
}
...
export function chatCompletionsResponseFormatSerializer(
  ...
  return {
    ...chatCompletionsResponseFormatUnionSerializer(item),
  };
}
...
export function chatCompletionsJsonSchemaResponseFormatSerializer(
  ...
  return {
    type: item["type"],
    json_schema: {
      description: item.jsonSchema["description"],
      name: item.jsonSchema["name"],
      schema: item.jsonSchema["schema"],
      strict: item.jsonSchema["strict"],
    },
  };
}
...
export function createUploadRequestSerializer(
  item: CreateUploadRequest,
): Record<string, unknown> {
  return {
    filename: item["filename"],
