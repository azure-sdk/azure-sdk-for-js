...
export type AssistantsApiResponseFormatOption =
  ...
  | AssistantsApiResponseFormatUnion;
...
export type AssistantsApiResponseFormatMode = "auto";
...
/** Alias for AssistantsApiResponseFormatUnion */
export type AssistantsApiResponseFormatUnion =
  | AssistantsApiResponseFormatText
  | AssistantsApiResponseFormatJsonObject
  | AssistantsApiResponseFormatJsonSchema
  | AssistantsApiResponseFormat;

export function assistantsApiResponseFormatUnionSerializer(
  item: AssistantsApiResponseFormatUnion,
): any {
  switch (item.type) {
    case "text":
      return assistantsApiResponseFormatTextSerializer(
        item as AssistantsApiResponseFormatText,
      );

    case "json_object":
      return assistantsApiResponseFormatJsonObjectSerializer(
        item as AssistantsApiResponseFormatJsonObject,
      );

    case "json_schema":
      return assistantsApiResponseFormatJsonSchemaSerializer(
        item as AssistantsApiResponseFormatJsonSchema,
      );

    default:
      return assistantsApiResponseFormatSerializer(item);
  }
}

export function assistantsApiResponseFormatUnionDeserializer(
  item: any,
): AssistantsApiResponseFormatUnion {
  switch (item.type) {
    case "text":
      return assistantsApiResponseFormatTextDeserializer(
        item as AssistantsApiResponseFormatText,
      );

    case "json_object":
      return assistantsApiResponseFormatJsonObjectDeserializer(
        item as AssistantsApiResponseFormatJsonObject,
      );

    case "json_schema":
      return assistantsApiResponseFormatJsonSchemaDeserializer(
        item as AssistantsApiResponseFormatJsonSchema,
      );

    default:
      return assistantsApiResponseFormatDeserializer(item);
  }
}

/** Possible API response formats. */
export type ApiResponseFormat = "text" | "json_object" | "json_schema";

/** An object describing expected output of the model as text. */
export interface AssistantsApiResponseFormatText
  extends AssistantsApiResponseFormat {
  /** The type of response format being defined: `text` */
  type: "text";
}

export function assistantsApiResponseFormatTextSerializer(
  item: AssistantsApiResponseFormatText,
): any {
  return { type: item["type"] };
}

export function assistantsApiResponseFormatTextDeserializer(
  item: any,
): AssistantsApiResponseFormatText {
  return {
    type: item["type"],
...
export interface AssistantsApiResponseFormatJsonObject
  extends AssistantsApiResponseFormat {
  /** The type of response format being defined: `json_object` */
  type: "json_object";
}

export function assistantsApiResponseFormatJsonObjectSerializer(
  item: AssistantsApiResponseFormatJsonObject,
): any {
  return { type: item["type"] };
}

export function assistantsApiResponseFormatJsonObjectDeserializer(
  item: any,
): AssistantsApiResponseFormatJsonObject {
  return {
    type: item["type"],
...
export interface AssistantsApiResponseFormatJsonSchema
  extends AssistantsApiResponseFormat {
...
export function assistantsApiResponseFormatJsonSchemaSerializer(
  item: AssistantsApiResponseFormatJsonSchema,
): any {
  return {
    type: item["type"],
    json_schema: _assistantsApiResponseFormatJsonSchemaJsonSchemaSerializer(
      item["jsonSchema"],
    ),
  };
}

export function assistantsApiResponseFormatJsonSchemaDeserializer(
  item: any,
): AssistantsApiResponseFormatJsonSchema {
  return {
    type: item["type"],
    jsonSchema: _assistantsApiResponseFormatJsonSchemaJsonSchemaDeserializer(
      item["json_schema"],
    ),
  };
}

/** model interface _AssistantsApiResponseFormatJsonSchemaJsonSchema */
export interface _AssistantsApiResponseFormatJsonSchemaJsonSchema {
...
export function _assistantsApiResponseFormatJsonSchemaJsonSchemaSerializer(
  item: _AssistantsApiResponseFormatJsonSchemaJsonSchema,
): any {
  return {
    description: item["description"],
    name: item["name"],
...
export function _assistantsApiResponseFormatJsonSchemaJsonSchemaDeserializer(
  item: any,
): _AssistantsApiResponseFormatJsonSchemaJsonSchema {
  return {
    description: item["description"],
    name: item["name"],
    schema: item["schema"],
...
export function runStepFileSearchToolCallDeserializer(
  ...
  return {
    type: item["type"],
    id: item["id"],
    fileSearch: fileSearchToolCallResultArrayDeserializer(item["file_search"]),
  };
}

export function fileSearchToolCallResultArrayDeserializer(
  result: Array<FileSearchToolCallResult>,
): any[] {
  return result.map((item) => {
    return fileSearchToolCallResultDeserializer(item);
  });
}
...
export function fileSearchToolCallResultDeserializer(
  item: any,
  ...
  return {
    ...
    content: !item["content"]
      ? item["content"]
      : fileSearchToolCallResultContentItemArrayDeserializer(item["content"]),
  };
}

export function fileSearchToolCallResultContentItemArrayDeserializer(
  result: Array<FileSearchToolCallResultContentItem>,
): any[] {
  return result.map((item) => {
    return fileSearchToolCallResultContentItemDeserializer(item);
  });
}

/** Content item in a file search result */
export interface FileSearchToolCallResultContentItem {
...
export function fileSearchToolCallResultContentItemDeserializer(
  item: any,
): FileSearchToolCallResultContentItem {
  return {
    type: item["type"],
    text: item["text"],
  };
...
export enum KnownServiceApiVersions {
  ...
  /** The December 2024 preview release for Azure OpenAI. */
