...
import {
  AssistantCreationOptions as AssistantCreationOptionsRest,
  ToolDefinition as ToolDefinitionRest,
  CodeInterpreterToolDefinition as CodeInterpreterToolDefinitionRest,
  FileSearchToolDefinition as FileSearchToolDefinitionRest,
  FunctionToolDefinition as FunctionToolDefinitionRest,
  FunctionDefinition as FunctionDefinitionRest,
  CreateToolResourcesOptions as CreateToolResourcesOptionsRest,
  CreateCodeInterpreterToolResourceOptions as CreateCodeInterpreterToolResourceOptionsRest,
  CreateFileSearchToolResourceVectorStoreOptions as CreateFileSearchToolResourceVectorStoreOptionsRest,
  AssistantsApiResponseFormat as AssistantsApiResponseFormatRest,
  UpdateAssistantOptions as UpdateAssistantOptionsRest,
  UpdateToolResourcesOptions as UpdateToolResourcesOptionsRest,
  UpdateCodeInterpreterToolResourceOptions as UpdateCodeInterpreterToolResourceOptionsRest,
  UpdateFileSearchToolResourceOptions as UpdateFileSearchToolResourceOptionsRest,
  AssistantThreadCreationOptions as AssistantThreadCreationOptionsRest,
  ThreadMessageOptions as ThreadMessageOptionsRest,
  MessageAttachment as MessageAttachmentRest,
  UpdateAssistantThreadOptions as UpdateAssistantThreadOptionsRest,
  ThreadMessage as ThreadMessageRest,
  MessageIncompleteDetails as MessageIncompleteDetailsRest,
  MessageContent as MessageContentRest,
  MessageTextContent as MessageTextContentRest,
  MessageTextDetails as MessageTextDetailsRest,
  MessageTextAnnotation as MessageTextAnnotationRest,
  MessageTextFileCitationAnnotation as MessageTextFileCitationAnnotationRest,
  MessageTextFileCitationDetails as MessageTextFileCitationDetailsRest,
  MessageTextFilePathAnnotation as MessageTextFilePathAnnotationRest,
  MessageTextFilePathDetails as MessageTextFilePathDetailsRest,
  MessageImageFileContent as MessageImageFileContentRest,
  MessageImageFileDetails as MessageImageFileDetailsRest,
  CreateRunOptions as CreateRunOptionsRest,
  TruncationObject as TruncationObjectRest,
  AssistantsNamedToolChoice as AssistantsNamedToolChoiceRest,
  FunctionName as FunctionNameRest,
  ToolOutput as ToolOutputRest,
  CreateAndRunThreadOptions as CreateAndRunThreadOptionsRest,
  VectorStoreExpirationPolicy as VectorStoreExpirationPolicyRest,
  VectorStoreOptions as VectorStoreOptionsRest,
  VectorStoreUpdateOptions as VectorStoreUpdateOptionsRest,
} from "../rest/index.js";
...
export function assistantCreationOptionsSerializer(
  ...
  return {
    ...
    top_p: item["topP"],
    response_format: item["responseFormat"] as any,
...
): CreateCodeInterpreterToolResourceOptionsRest {
  return {
...
): CreateFileSearchToolResourceVectorStoreOptionsRest {
  return {
    file_ids: item["fileIds"],
    metadata: !item.metadata
      ? item.metadata
...
): AssistantsApiResponseFormatRest {
  return {
    type: item["type"],
  };
}
...
): UpdateToolResourcesOptionsRest {
  return {
    code_interpreter: !item.codeInterpreter
      ? item.codeInterpreter
...
): UpdateCodeInterpreterToolResourceOptionsRest {
  return {
    file_ids: item["fileIds"],
  };
}
...
): UpdateFileSearchToolResourceOptionsRest {
  return {
...
): AssistantThreadCreationOptionsRest {
  return {
    messages:
...
): UpdateAssistantThreadOptionsRest {
  return {
    tool_resources: !item.toolResources
      ? item.toolResources
      : updateToolResourcesOptionsSerializer(item.toolResources),
...
): MessageTextFileCitationAnnotationRest {
  return {
    type: item["type"],
    text: item["text"],
...
): MessageTextFileCitationDetailsRest {
  return {
    file_id: item["fileId"],
    quote: item["quote"],
  };
...
): MessageTextFilePathAnnotationRest {
  return {
    type: item["type"],
    text: item["text"],
...
): MessageTextFilePathDetailsRest {
  return {
    file_id: item["fileId"],
  };
}
...
export function truncationObjectSerializer(item: TruncationObject) {
  return {
    type: item["type"],
...
export function toolOutputSerializer(item: ToolOutput): ToolOutputRest {
  return {
...
): VectorStoreExpirationPolicyRest {
  return {
    anchor: item["anchor"],
    days: item["days"],
  };
...
export type ServiceApiVersions = "2024-02-15-preview" | "2024-05-01-preview";
