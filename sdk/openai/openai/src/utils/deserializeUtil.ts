...
import {
  ...
  RunStepDeltaRetrievalToolCallOutput,
  ...
  return {
    ...
    toolCalls:
      obj["tool_calls"] === undefined
        ? obj["tool_calls"]
        : obj["tool_calls"].map((p) => deserializeRunStepDeltaToolCallUnion(p)),
  };
}
...
/** deserialize function for RunStepDeltaRetrievalToolCall */
function deserializeRunStepDeltaRetrievalToolCall(
  obj: RunStepDeltaRetrievalToolCallOutput,
): RunStepDeltaRetrievalToolCall {
  return {
    index: obj["index"],
    id: obj["id"],
      ...
      : {
          ...
          outputs:
            obj.code_interpreter?.["outputs"] === undefined
              ...
              : obj.code_interpreter?.["outputs"].map((p) =>
...
export function deserializeRunStepDeltaToolCallUnion(
  ...
  switch (obj.type) {
    case "retrieval":
      return deserializeRunStepDeltaRetrievalToolCall(
        obj as RunStepDeltaRetrievalToolCall,
      );
    case "code_interpreter":
