...
export interface ListBatchesResponseOutput {
  /** A human-readable error message. */
  data: Array<BatchOutput>;
  /** A human-readable error message. */
  first_id?: string;
  /** A human-readable error message. */
  last_id?: string;
...
export interface BatchErrorListOutput {
  /** The object type, which is always `list`. */
  object?: "list";
  /** The list of Batch error data. */
  data?: Array<BatchErrorDatumOutput>;
}

/** A Datum containing information about a Batch Error. */
export interface BatchErrorDatumOutput {
...
export type AzureChatExtensionRetrieveDocumentFilterReasonOutput =
  | "score"
  | "rerank";
/** Alias for BatchStatusOutput */
export type BatchStatusOutput = string;
