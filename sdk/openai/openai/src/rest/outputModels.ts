...
export interface AssistantsNamedToolChoiceOutput {
  /**
...
export interface ThreadRunOutput {
  ...
  tool_choice: AssistantsApiToolChoiceOptionOutput | null;
...
/** Alias for AssistantsApiResponseFormatModeOutput */
export type AssistantsApiResponseFormatModeOutput = string;
...
export type AssistantsApiResponseFormatOptionOutput =
  | string
  | AssistantsApiResponseFormatModeOutput
...
/** Alias for AssistantsApiToolChoiceOptionModeOutput */
export type AssistantsApiToolChoiceOptionModeOutput = string;
/** Alias for AssistantsNamedToolChoiceTypeOutput */
export type AssistantsNamedToolChoiceTypeOutput = string;
/** Alias for AssistantsApiToolChoiceOptionOutput */
export type AssistantsApiToolChoiceOptionOutput =
  | string
  | AssistantsApiToolChoiceOptionModeOutput
  | AssistantsNamedToolChoiceOutput;
