...
/** The input definition information for a fie search tool as used to configure an assistant. */
export interface BrowseToolDefinition extends ToolDefinitionParent {
...
export type ListSortOrder = string | "asc" | "desc";
/** Alias for MessageRole */
export type MessageRole = string | "user" | "assistant";
...
export type VectorStoreExpirationPolicyAnchor = string | "last_active_at";
