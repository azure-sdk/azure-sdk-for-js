...
export interface ListBatches200Response extends HttpResponse {
  status: "200";
  body: OpenAIPageableListOfOutput;
}

/** The requested new batch job. */
export interface CreateBatch201Response extends HttpResponse {
  status: "201";
  body: BatchOutput;
}

/** The requested existing batch job. */
export interface GetBatch200Response extends HttpResponse {
  status: "200";
  body: BatchOutput;
}

/** The updated batch job that was canceled. */
export interface CancelBatch200Response extends HttpResponse {
  status: "200";
  body: BatchOutput;
}
