...
/** The requested list of batches. */
export interface BatchList200Response extends HttpResponse {
  status: "200";
  body: ListBatchesResponseOutput;
}

/** The requested list of files. */
export interface BatchCreate200Response extends HttpResponse {
  status: "200";
  body: BatchOutput;
}

/** The requested batch. */
export interface BatchGet200Response extends HttpResponse {
  status: "200";
  body: BatchOutput;
}

/** The Batch that was canceled. */
export interface BatchCancel200Response extends HttpResponse {
  status: "200";
  body: BatchOutput;
}
