...
export interface ListBatches {
  ...
  get(
    options?: ListBatchesParameters,
  ): StreamableMethod<ListBatches200Response>;
  /**
   ...
   */
  post(
    options?: CreateBatchParameters,
  ): StreamableMethod<CreateBatch201Response>;
}

export interface GetBatch {
  /** Gets details for a single batch specified by the given batchID. */
  get(options?: GetBatchParameters): StreamableMethod<GetBatch200Response>;
}

export interface CancelBatch {
  /** Gets details for a single batch specified by the given batchID. */
  get(
    options?: CancelBatchParameters,
  ): StreamableMethod<CancelBatch200Response>;
}
