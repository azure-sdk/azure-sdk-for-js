...
export interface ListBatchesQueryParamProperties {
...
export interface ListBatchesQueryParam {
  queryParameters?: ListBatchesQueryParamProperties;
}

export type ListBatchesParameters = ListBatchesQueryParam & RequestParameters;

export interface CreateBatchBodyParam {
  body?: BatchCreateRequest;
}

export type CreateBatchParameters = CreateBatchBodyParam & RequestParameters;
export type GetBatchParameters = RequestParameters;
export type CancelBatchParameters = RequestParameters;
