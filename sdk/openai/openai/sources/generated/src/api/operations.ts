...
export async function _getImageGenerationsDeserialize(
  ...
  return {
    ...
    data: result.body["data"].map((p) => ({
      ...
      promptFilterResults: !p.promptFilterResults
        ? undefined
        : {
            sexual: !p.promptFilterResults?.sexual
              ? undefined
              : {
                  severity: p.promptFilterResults?.sexual?.["severity"],
                  filtered: p.promptFilterResults?.sexual?.["filtered"],
                },
            violence: !p.promptFilterResults?.violence
              ? undefined
              : {
                  severity: p.promptFilterResults?.violence?.["severity"],
                  filtered: p.promptFilterResults?.violence?.["filtered"],
                },
            hate: !p.promptFilterResults?.hate
              ? undefined
              : {
                  severity: p.promptFilterResults?.hate?.["severity"],
                  filtered: p.promptFilterResults?.hate?.["filtered"],
                },
            selfHarm: !p.promptFilterResults?.selfHarm
              ? undefined
              : {
                  severity: p.promptFilterResults?.selfHarm?.["severity"],
                  filtered: p.promptFilterResults?.selfHarm?.["filtered"],
                },
            profanity: !p.promptFilterResults?.profanity
              ? undefined
              : {
                  filtered: p.promptFilterResults?.profanity?.["filtered"],
                  detected: p.promptFilterResults?.profanity?.["detected"],
                },
            jailbreak: !p.promptFilterResults?.jailbreak
              ? undefined
              : {
                  filtered: p.promptFilterResults?.jailbreak?.["filtered"],
                  detected: p.promptFilterResults?.jailbreak?.["detected"],
                },
          },
    })),
  };
