  ...
  return {
    ...
    incompleteDetails:
      result.body.incomplete_details === null
        ? null
        : { reason: result.body.incomplete_details["reason"] },
    completedAt:
      ...
      return {
        ...
        incompleteDetails:
          p.incomplete_details === null
            ? null
            : { reason: p.incomplete_details["reason"] },
        completedAt:
  ...
  return {
    ...
    truncationStrategy:
      result.body.truncation_strategy === null
        ? null
        : {
            type: result.body.truncation_strategy["type"],
      ...
      return {
        ...
        truncationStrategy:
          p.truncation_strategy === null
            ? null
            : {
                type: p.truncation_strategy["type"],
...
export async function _createVectorStoreDeserialize(
  ...
  return {
    ...
    expiresAfter: !result.body.expires_after
      ? undefined
      : {
          anchor: result.body.expires_after?.["anchor"],
