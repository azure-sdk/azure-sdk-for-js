...
import type {
  ...
  FileOperationsDownload204Response,
  ...
  SolutionsOperationsCreateJob200Response,
...
const responseMap: Record<string, string[]> = {
  ...
  "POST /file:download": ["204"],
  "POST /file:upload": ["200"],
  "POST /catalogs/{catalogId}/collections/{collectionId}/items:create": ["200"],
  ...
  "POST /external/solutions:create-job": ["200"],
...
export function isUnexpected(
  response: FileOperationsDownload204Response | FileOperationsDownloadDefaultResponse,
...
export function isUnexpected(
  response: ItemsOperationsCreate200Response | ItemsOperationsCreateDefaultResponse,
...
export function isUnexpected(
  response: SolutionsOperationsCreateJob200Response | SolutionsOperationsCreateJobDefaultResponse,
