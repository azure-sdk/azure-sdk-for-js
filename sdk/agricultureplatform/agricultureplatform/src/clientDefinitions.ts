...
export interface FileOperationsDownload {
  ...
  ): StreamableMethod<FileOperationsDownload204Response | FileOperationsDownloadDefaultResponse>;
}
...
export interface ItemsOperationsCreate {
  ...
  ): StreamableMethod<ItemsOperationsCreate200Response | ItemsOperationsCreateDefaultResponse>;
}
...
export interface SolutionsOperationsCreateJob {
  ...
  post(
    ...
    SolutionsOperationsCreateJob200Response | SolutionsOperationsCreateJobDefaultResponse
  >;
}
