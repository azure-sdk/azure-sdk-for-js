...
import { AgriService } from "../operationsInterfaces/index.js";
import * as coreClient from "@azure/core-client";
import * as Mappers from "../models/mappers.js";
import * as Parameters from "../models/parameters.js";
import { MicrosoftAgriculturePlatform } from "../microsoftAgriculturePlatform.js";
...
export class AgriServiceImpl implements AgriService {
  ...
  async beginDeleteAndWait(
    ...
    const poller = await this.beginDelete(resourceGroupName, agriServiceResourceName, options);
    return poller.pollUntilDone();
  }
  ...
  listAvailableSolutions(
    ...
    return this.client.sendOperationRequest(
      { resourceGroupName, agriServiceResourceName, options },
      listAvailableSolutionsOperationSpec,
    );
  }
...
const listAvailableSolutionsOperationSpec: coreClient.OperationSpec = {
  path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AgriculturePlatform/agriServices/{agriServiceResourceName}/listAvailableSolutions",
  httpMethod: "POST",
  responses: {
    200: {
      bodyMapper: Mappers.AvailableAgriSolutionListResult,
    },
    default: {
      bodyMapper: Mappers.ErrorResponse,
    },
