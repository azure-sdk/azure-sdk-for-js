...
[Source code](https://github.com/Azure/azure-sdk-for-js/tree/main/sdk/Qumulo.Storage/arm-Qumulo.Storage) |
[Package (NPM)](https://www.npmjs.com/package/@azure/arm-Qumulo.Storage) |
[API reference documentation](https://docs.microsoft.com/javascript/api/@azure/arm-Qumulo.Storage) |
...
### Install the `@azure/arm-Qumulo.Storage` package

Install the Azure QumuloStorage client library for JavaScript with `npm`:

```bash
npm install @azure/arm-Qumulo.Storage
```
...
![Impressions](https://azure-sdk-impressions.azurewebsites.net/api/impressions/azure-sdk-for-js%2Fsdk%2FQumulo.Storage%2Farm-Qumulo.Storage%2FREADME.png)
