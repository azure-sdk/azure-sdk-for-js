...
/** Known values of {@link ImpalaThriftTransportProtocol} that the service accepts. */
export enum KnownImpalaThriftTransportProtocol {
  /** Binary */
  Binary = "Binary",
  /** Http */
  Http = "HTTP",
 ...
 * {@link KnownImpalaThriftTransportProtocol} can be used interchangeably with ImpalaThriftTransportProtocol,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Binary** \
 * **HTTP**
 */
export type ImpalaThriftTransportProtocol = string;
