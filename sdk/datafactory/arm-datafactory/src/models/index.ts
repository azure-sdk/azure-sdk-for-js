...
export interface AzurePostgreSqlSink extends CopySink {
  ...
  writeMethod?: AzurePostgreSqlSinkWriteMethod;
  /** Azure Database for PostgreSQL upsert option settings */
...
/** Known values of {@link AzurePostgreSqlSinkWriteMethod} that the service accepts. */
export enum KnownAzurePostgreSqlSinkWriteMethod {
  /** BulkInsert */
...
/**
 * Defines values for AzurePostgreSqlSinkWriteMethod. \
 * {@link KnownAzurePostgreSqlSinkWriteMethod} can be used interchangeably with AzurePostgreSqlSinkWriteMethod,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **BulkInsert** \
 * **CopyCommand** \
 * **Upsert**
 */
export type AzurePostgreSqlSinkWriteMethod = string;
