...
export const AzurePostgreSqlSinkUpsertSettings: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
...
export const DatabricksJobActivity: coreClient.CompositeMapper = {
  serializedName: "DatabricksJob",
  type: {
    name: "Composite",
    className: "DatabricksJobActivity",
    uberParent: "ExecutionActivity",
    additionalProperties: { type: { name: "Object" } },
    polymorphicDiscriminator: ExecutionActivity.type.polymorphicDiscriminator,
    modelProperties: {
      ...ExecutionActivity.type.modelProperties,
      jobId: {
        serializedName: "typeProperties.jobId",
        required: true,
        type: {
          name: "any",
        },
      ...
      jobParameters: {
        serializedName: "typeProperties.jobParameters",
        type: {
          name: "Dictionary",
          value: { type: { name: "any" } },
        },
...
export let discriminators = {
  ...
  "ExecutionActivity.DatabricksJob": DatabricksJobActivity,
