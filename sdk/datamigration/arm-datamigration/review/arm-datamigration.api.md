...
export interface DatabaseMigrationsSqlDb {
    ...
    retry(resourceGroupName: string, sqlDbInstanceName: string, targetDbName: string, migrationOperationInput: MigrationOperationInput, options?: DatabaseMigrationsSqlDbRetryOptionalParams): Promise<DatabaseMigrationsSqlDbRetryResponse>;
}
...
export interface DatabaseMigrationsSqlMi {
    ...
    beginDelete(resourceGroupName: string, managedInstanceName: string, targetDbName: string, options?: DatabaseMigrationsSqlMiDeleteOptionalParams): Promise<PollerLike<PollOperationState<void>, void>>;
    beginDeleteAndWait(resourceGroupName: string, managedInstanceName: string, targetDbName: string, options?: DatabaseMigrationsSqlMiDeleteOptionalParams): Promise<void>;
...
export interface DatabaseMigrationsSqlVm {
    ...
    beginDelete(resourceGroupName: string, sqlVirtualMachineName: string, targetDbName: string, options?: DatabaseMigrationsSqlVmDeleteOptionalParams): Promise<PollerLike<PollOperationState<void>, void>>;
    beginDeleteAndWait(resourceGroupName: string, sqlVirtualMachineName: string, targetDbName: string, options?: DatabaseMigrationsSqlVmDeleteOptionalParams): Promise<void>;
...
export interface KeyVaultProperties {
    fileSharePasswordSecretName?: string;
    fileShareUsernameSecretName?: string;
    name?: string;
    sourcePasswordSecretName?: string;
    sourceUsernameSecretName?: string;
}
...
// @public
export enum KnownValidateIRKind {
    SqlDb = "SqlDb",
    SqlMi = "SqlMi",
    SqlVm = "SqlVm"
}
...
export interface SqlMigrationServices {
    ...
    validateIR(resourceGroupName: string, sqlMigrationServiceName: string, parameters: ValidateIR, options?: SqlMigrationServicesValidateIROptionalParams): Promise<SqlMigrationServicesValidateIRResponse>;
}
...
// @public
export interface SqlMigrationServicesValidateIROptionalParams extends coreClient.OperationOptions {
}

// @public
export type SqlMigrationServicesValidateIRResponse = ValidateIR;
...
// @public (undocumented)
export interface TestConnectivityData {
    // (undocumented)
    code?: string;
    // (undocumented)
    message?: string;
...
// @public
export type ValidateIRKind = string;
