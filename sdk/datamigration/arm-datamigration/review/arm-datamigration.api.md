...
export interface DatabaseMigrationsSqlDb {
    beginCancel(resourceGroupName: string, sqlDbInstanceName: string, targetDbName: string, parameters: MigrationOperationInput, options?: DatabaseMigrationsSqlDbCancelOptionalParams): Promise<PollerLike<PollOperationState<void>, void>>;
    ...
    beginCreateOrUpdate(resourceGroupName: string, sqlDbInstanceName: string, targetDbName: string, parameters: DatabaseMigrationSqlDb, options?: DatabaseMigrationsSqlDbCreateOrUpdateOptionalParams): Promise<PollerLike<PollOperationState<DatabaseMigrationsSqlDbCreateOrUpdateResponse>, DatabaseMigrationsSqlDbCreateOrUpdateResponse>>;
    ...
    beginDelete(resourceGroupName: string, sqlDbInstanceName: string, targetDbName: string, options?: DatabaseMigrationsSqlDbDeleteOptionalParams): Promise<PollerLike<PollOperationState<void>, void>>;
...
// @public
export interface MigrateMySqlAzureDbForMySqlOfflineTaskInput extends MySqlSchemaMigrationOptions {
    encryptedKeyForSecureFields?: string;
...
// @public
export interface MigrateMySqlAzureDbForMySqlOfflineTaskOutput extends MigrateMySqlAzureDbForMySqlTaskResult {
    resultType: "MigrateMySqlAzureDbForMySqlOfflineTaskOutput" | "MigrationLevelOutput" | "DatabaseLevelOutput" | "TableLevelOutput" | "ErrorOutput";
}
...
// @public
export interface MigrateMySqlAzureDbForMySqlReplicateChangesTaskOutput extends MigrateMySqlAzureDbForMySqlTaskResult {
    resultType: "MigrateMySqlAzureDbForMySqlReplicateChangesTaskOutput" | "ErrorOutput" | "MigrationLevelOutput";
}

// @public (undocumented)
export interface MigrateMySqlAzureDbForMySqlReplicateChangesTaskOutputError extends MigrateMySqlAzureDbForMySqlReplicateChangesTaskOutput {
    readonly error?: ReportableException;
    resultType: "ErrorOutput";
}

// @public (undocumented)
export interface MigrateMySqlAzureDbForMySqlReplicateChangesTaskOutputMigrationLevel extends MigrateMySqlAzureDbForMySqlReplicateChangesTaskOutput {
...
// @public (undocumented)
export type MigrateMySqlAzureDbForMySqlReplicateChangesTaskOutputUnion = MigrateMySqlAzureDbForMySqlReplicateChangesTaskOutput | MigrateMySqlAzureDbForMySqlReplicateChangesTaskOutputError | MigrateMySqlAzureDbForMySqlReplicateChangesTaskOutputMigrationLevel;

// @public
export interface MigrateMySqlAzureDbForMySqlReplicateChangesTaskProperties extends ProjectTaskProperties {
...
// @public
export interface MigrateMySqlAzureDbForMySqlSyncTaskInput extends MySqlSchemaMigrationOptions {
    encryptedKeyForSecureFields?: string;
    optionalAgentSettings?: {
        [propertyName: string]: string;
    };
...
// @public
export interface MigrateMySqlAzureDbForMySqlSyncTaskOutput extends MigrateMySqlAzureDbForMySqlTaskResult {
...
export interface MigrateMySqlAzureDbForMySqlSyncTaskProperties extends ProjectTaskProperties {
    ...
    readonly output?: MigrateMySqlAzureDbForMySqlTaskResultUnion[];
    taskType: "Migrate.MySql.AzureDbForMySql.Sync";
}

// @public
export interface MigrateMySqlAzureDbForMySqlTaskResult {
    readonly id?: string;
    resultType: "MigrateMySqlAzureDbForMySqlSyncTaskOutput" | "MigrateMySqlAzureDbForMySqlReplicateChangesTaskOutput" | "MigrateMySqlAzureDbForMySqlOfflineTaskOutput" | "ErrorOutput" | "MigrationLevelOutput" | "MigrationLevelOutput" | "DatabaseLevelOutput" | "TableLevelOutput" | "ErrorOutput";
}

// @public (undocumented)
export type MigrateMySqlAzureDbForMySqlTaskResultUnion = MigrateMySqlAzureDbForMySqlTaskResult | MigrateMySqlAzureDbForMySqlSyncTaskOutput | MigrateMySqlAzureDbForMySqlReplicateChangesTaskOutputUnion | MigrateMySqlAzureDbForMySqlOfflineTaskOutputUnion;
