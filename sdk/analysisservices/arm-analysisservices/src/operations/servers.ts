...
export class ServersImpl implements Servers {
  ...
  async beginCreateAndWait(
    ...
    const poller = await this.beginCreate(resourceGroupName, serverName, serverParameters, options);
  ...
  async beginSuspendAndWait(
    ...
    const poller = await this.beginSuspend(resourceGroupName, serverName, options);
    return poller.pollUntilDone();
  }
  ...
  async beginResumeAndWait(
    ...
    const poller = await this.beginResume(resourceGroupName, serverName, options);
    return poller.pollUntilDone();
  }
