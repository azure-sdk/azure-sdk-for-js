 ...
 */
async function createAPipelineGroupInstanceUsingASyslogReceiver(): Promise<void> {
  const credential = new DefaultAzureCredential();
  const subscriptionId = "00000000-0000-0000-0000-000000000000";
  const client = new MonitorClient(credential, subscriptionId);
  const result = await client.pipelineGroups.createOrUpdate("myResourceGroup", "plGroup1", {
    location: "eastus2",
    extendedLocation: {
 ...
 */
async function createAPipelineGroupInstanceUsingASyslogReceiverAndCache(): Promise<void> {
  const credential = new DefaultAzureCredential();
  const subscriptionId = "00000000-0000-0000-0000-000000000000";
  const client = new MonitorClient(credential, subscriptionId);
  const result = await client.pipelineGroups.createOrUpdate("myResourceGroup", "plGroup1", {
 ...
 */
async function createAPipelineGroupInstanceUsingASyslogReceiverAndNetworkingConfigurations(): Promise<void> {
  const credential = new DefaultAzureCredential();
  const subscriptionId = "00000000-0000-0000-0000-000000000000";
  const client = new MonitorClient(credential, subscriptionId);
  const result = await client.pipelineGroups.createOrUpdate("myResourceGroup", "plGroup1", {
 ...
 */
async function createAPipelineGroupInstanceUsingUDPReceiver(): Promise<void> {
  const credential = new DefaultAzureCredential();
  const subscriptionId = "00000000-0000-0000-0000-000000000000";
  const client = new MonitorClient(credential, subscriptionId);
  const result = await client.pipelineGroups.createOrUpdate("myResourceGroup", "plGroup1", {
...
async function main(): Promise<void> {
  await createAPipelineGroupInstanceUsingASyslogReceiver();
  await createAPipelineGroupInstanceUsingASyslogReceiverAndCache();
  await createAPipelineGroupInstanceUsingASyslogReceiverAndNetworkingConfigurations();
  await createAPipelineGroupInstanceUsingUDPReceiver();
}
