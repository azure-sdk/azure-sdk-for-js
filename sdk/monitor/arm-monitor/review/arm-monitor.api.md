...
// @public (undocumented)
export interface ErrorResponseAdditionalInfoItem {
...
export interface ErrorResponseAutoGenerated3 {
    additionalInfo?: ErrorResponseAdditionalInfoItem[];
    code?: string;
    message?: string;
    target?: string;
}
...
// @public
export interface ProxyResource extends ResourceAutoGenerated5 {
}
