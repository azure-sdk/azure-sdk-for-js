...
export interface Monitor {
    listOperationsList(options?: MonitorOperationsListOptionalParams): PagedAsyncIterableIterator<OperationAutoGenerated>;
}
...
// @public
export interface MonitoringAccountDefaultIngestionSettings extends IngestionSettings {
}

// @public
export interface MonitoringAccountMetrics extends Metrics {
}

// @public
export interface MonitoringAccountResource extends TrackedResourceAutoGenerated {
    readonly accountId?: string;
    readonly defaultIngestionSettings?: MonitoringAccountDefaultIngestionSettings;
    readonly etag?: string;
    readonly metrics?: MonitoringAccountMetrics;
...
// @public
export interface MonitoringAccountResourceForUpdate {
    tags?: {
        [propertyName: string]: string;
    };
}
...
// @public
export interface MonitoringAccountResourceListResult {
    nextLink?: string;
    value: MonitoringAccountResource[];
}

// @public
export interface MonitoringAccountResourceProperties extends MonitoringAccount {
}

// @public
export interface MonitoringAccounts {
    create(resourceGroupName: string, monitoringAccountName: string, monitoringAccountProperties: MonitoringAccountResource, options?: MonitoringAccountsCreateOptionalParams): Promise<MonitoringAccountsCreateResponse>;
    delete(resourceGroupName: string, monitoringAccountName: string, options?: MonitoringAccountsDeleteOptionalParams): Promise<void>;
    get(resourceGroupName: string, monitoringAccountName: string, options?: MonitoringAccountsGetOptionalParams): Promise<MonitoringAccountsGetResponse>;
    listByResourceGroup(resourceGroupName: string, options?: MonitoringAccountsListByResourceGroupOptionalParams): PagedAsyncIterableIterator<MonitoringAccountResource>;
    listBySubscription(options?: MonitoringAccountsListBySubscriptionOptionalParams): PagedAsyncIterableIterator<MonitoringAccountResource>;
    update(resourceGroupName: string, monitoringAccountName: string, options?: MonitoringAccountsUpdateOptionalParams): Promise<MonitoringAccountsUpdateResponse>;
}

// @public
export interface MonitoringAccountsCreateOptionalParams extends coreClient.OperationOptions {
}

// @public
export type MonitoringAccountsCreateResponse = MonitoringAccountResource;

// @public
export interface MonitoringAccountsDeleteOptionalParams extends coreClient.OperationOptions {
}

// @public
export interface MonitoringAccountsGetOptionalParams extends coreClient.OperationOptions {
}

// @public
export type MonitoringAccountsGetResponse = MonitoringAccountResource;

// @public
export interface MonitoringAccountsListByResourceGroupNextOptionalParams extends coreClient.OperationOptions {
}

// @public
export type MonitoringAccountsListByResourceGroupNextResponse = MonitoringAccountResourceListResult;

// @public
export interface MonitoringAccountsListByResourceGroupOptionalParams extends coreClient.OperationOptions {
}

// @public
export type MonitoringAccountsListByResourceGroupResponse = MonitoringAccountResourceListResult;

// @public
export interface MonitoringAccountsListBySubscriptionNextOptionalParams extends coreClient.OperationOptions {
}

// @public
export type MonitoringAccountsListBySubscriptionNextResponse = MonitoringAccountResourceListResult;

// @public
export interface MonitoringAccountsListBySubscriptionOptionalParams extends coreClient.OperationOptions {
}

// @public
export type MonitoringAccountsListBySubscriptionResponse = MonitoringAccountResourceListResult;

// @public
export interface MonitoringAccountsUpdateOptionalParams extends coreClient.OperationOptions {
    monitoringAccountProperties?: MonitoringAccountResourceForUpdate;
}

// @public
export type MonitoringAccountsUpdateResponse = MonitoringAccountResource;
