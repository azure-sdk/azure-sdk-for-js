...
// @public
export interface ActionGroupForActivityLogAlerts {
...
export interface ActionList {
    actionGroups?: ActionGroupForActivityLogAlerts[];
}
...
// @public
export interface AutoscaleSettingResource extends ResourceForAutoscale {
    enabled?: boolean;
    namePropertiesName?: string;
...
// @public
export interface DiagnosticSettingsCategoryResource extends ResourceAutoGenerated {
...
// @public
export interface DiagnosticSettingsResource extends ResourceAutoGenerated {
...
// @public
export enum KnownOperatorForCondition {
    Equals = "Equals",
    GreaterThan = "GreaterThan",
    GreaterThanOrEqual = "GreaterThanOrEqual",
    LessThan = "LessThan",
...
// @public
export type OperatorForCondition = string;
...
export interface PredictiveMetric {
    get(resourceGroupName: string, autoscaleSettingName: string, aggregation: string, options?: PredictiveMetricGetOptionalParams): Promise<PredictiveMetricGetResponse>;
}
...
// @public
export interface ResourceForAutoscale {
    readonly id?: string;
    location: string;
    readonly name?: string;
    readonly systemData?: SystemData;
