...
**Features**
  ...
  - Added Interface ErrorContractAutoGenerated
  ...
  - Interface MetricDefinitionCollection has a new optional parameter nextLink
...
**Breaking Changes**
  ...
  - Type of parameter error of interface ErrorContract is changed from ErrorResponse to ErrorDetail
