...
## 8.0.0-beta.3 (2022-11-01)
    
**Features**

  - Added operation group MetricsOperations
  - Added operation group Monitor
  - Added operation group MonitoringAccounts
  ...
  - Added Interface MonitoringAccount
  - Added Interface MonitoringAccountDefaultIngestionSettings
  - Added Interface MonitoringAccountMetrics
  - Added Interface MonitoringAccountResource
  - Added Interface MonitoringAccountResourceForUpdate
  - Added Interface MonitoringAccountResourceListResult
  - Added Interface MonitoringAccountResourceProperties
  - Added Interface MonitoringAccountsCreateOptionalParams
  - Added Interface MonitoringAccountsDeleteOptionalParams
  - Added Interface MonitoringAccountsGetOptionalParams
  - Added Interface MonitoringAccountsListByResourceGroupNextOptionalParams
  - Added Interface MonitoringAccountsListByResourceGroupOptionalParams
  - Added Interface MonitoringAccountsListBySubscriptionNextOptionalParams
  - Added Interface MonitoringAccountsListBySubscriptionOptionalParams
  - Added Interface MonitoringAccountsUpdateOptionalParams
  ...
  - Added Type Alias MonitoringAccountsCreateResponse
  - Added Type Alias MonitoringAccountsGetResponse
  - Added Type Alias MonitoringAccountsListByResourceGroupNextResponse
  - Added Type Alias MonitoringAccountsListByResourceGroupResponse
  - Added Type Alias MonitoringAccountsListBySubscriptionNextResponse
  - Added Type Alias MonitoringAccountsListBySubscriptionResponse
  - Added Type Alias MonitoringAccountsUpdateResponse
  ...
  - Class MonitorClient has a new parameter metricsOperations
  - Class MonitorClient has a new parameter monitor
  - Class MonitorClient has a new parameter monitoringAccounts
