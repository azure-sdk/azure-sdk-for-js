...
### Features Added
  ...
  - Added Interface MetricAlertResourcePatchProperties
  - Added Interface MetricAlertRuleAction
  - Added Interface MetricAlertRuleCriteria
  - Added Interface MetricAlertsMetricProperties
  - Added Interface MetricAlertsPropertiesBase
  ...
  - Added Type Alias MetricAlertResourceKind
  - Added Type Alias MetricAlertRuleCriteriaOperator
  ...
  - Interface MetricAlertResourcePatch has a new optional parameter properties
  ...
  - Added Enum KnownMetricAlertResourceKind
  - Added Enum KnownMetricAlertRuleCriteriaOperator
...
### Breaking Changes
  ...
  - Interface MetricAlertResourcePatch no longer has parameter description
  - Interface MetricAlertResourcePatch no longer has parameter enabled
  ...
  - Interface MetricAlertResourcePatch no longer has parameter scopes
  - Interface MetricAlertResourcePatch no longer has parameter severity
