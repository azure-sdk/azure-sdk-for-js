...
export const ResourceForAutoscale: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ResourceForAutoscale",
    modelProperties: {
      id: {
        serializedName: "id",
        readOnly: true,
      ...
      actionGroups: {
        ...
        type: {
          ...
          element: {
            type: {
              name: "Composite",
              className: "ActionGroupForActivityLogAlerts"
            }
          }
        }
      }
...
export const ActionGroupForActivityLogAlerts: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ActionGroupForActivityLogAlerts",
    modelProperties: {
...
export const AutoscaleSettingResource: coreClient.CompositeMapper = {
  type: {
    ...
    className: "AutoscaleSettingResource",
    modelProperties: {
      ...ResourceForAutoscale.type.modelProperties,
      profiles: {
        constraints: {
          MaxItems: 20
        },
