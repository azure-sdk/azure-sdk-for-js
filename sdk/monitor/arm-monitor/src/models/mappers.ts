  ...
  type: {
    ...
    modelProperties: {
      ...
      properties: {
        ...
        type: {
          name: "Composite",
          className: "MetricAlertsPropertiesBase",
        },
      },
    },
  },
...
export const MetricAlertsPropertiesBase: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "MetricAlertsPropertiesBase",
    modelProperties: {
      ...
      actions: {
        ...
        type: {
          ...
          element: {
            type: {
              name: "Composite",
              className: "MetricAlertRuleAction",
            },
          },
        },
      },
...
export const MetricAlertRuleAction: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "MetricAlertRuleAction",
    modelProperties: {
  ...
  type: {
    ...
    modelProperties: {
      ...
      properties: {
        ...
        type: {
          name: "Composite",
          className: "MetricAlertResourcePatchProperties",
        },
      },
    },
  },
...
export const MetricAlertResourcePatchProperties: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "MetricAlertResourcePatchProperties",
    modelProperties: {
...
export const MetricAlertRuleCriteria: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "MetricAlertRuleCriteria",
    modelProperties: {
      threshold: {
        serializedName: "threshold",
        type: {
...
export const MetricAlertsMetricProperties: coreClient.CompositeMapper = {
  ...
  type: {
    ...
    modelProperties: {
      ...MetricAlertsPropertiesBase.type.modelProperties,
      windowSize: {
