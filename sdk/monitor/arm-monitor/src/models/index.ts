...
/** Known values of {@link OperatorForCondition} that the service accepts. */
...
/**
 * Defines values for OperatorForCondition. \
 * {@link KnownOperatorForCondition} can be used interchangeably with OperatorForCondition,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Equals** \
 * **GreaterThan** \
