...
export interface MetricAlertsPropertiesBase {
  ...
  description?: string;
  /** The severity of the metric alert */
  severity: number;
  /** Indicates whether this alert rule is enabled */
  enabled: boolean;
  /** The list of resource id's being monitored */
  scopes: string[];
  /** The frequency with which the metric alert is evaluated */
...
export interface MetricAlertsMetricProperties
  extends MetricAlertsPropertiesBase {
  /** The period of time that is used to monitor alert activity */
  windowSize: string;
  criteria: MetricAlertRuleCriteria;
}

export interface MetricAlertsQueryProperties
  extends MetricAlertsPropertiesBase {
...
/** Known values of {@link MetricAlertResourceKind} that the service accepts. */
...
/**
 * Defines values for MetricAlertResourceKind. \
 * {@link KnownMetricAlertResourceKind} can be used interchangeably with MetricAlertResourceKind,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Metric** \
 * **Query**
...
/** Known values of {@link MetricAlertRuleCriteriaOperator} that the service accepts. */
...
/**
 * Defines values for MetricAlertRuleCriteriaOperator. \
 * {@link KnownMetricAlertRuleCriteriaOperator} can be used interchangeably with MetricAlertRuleCriteriaOperator,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Equals** \
 * **NotEquals** \
