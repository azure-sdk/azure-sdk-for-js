...
export function azureMonitorWorkspaceArraySerializer(result: Array<AzureMonitorWorkspace>): any[] {
  return result.map((item) => {
...
export function pipelineGroupPropertiesSerializer(item: PipelineGroupProperties): any {
  return {
    ...
    networkingConfigurations: !item["networkingConfigurations"]
      ...
      : networkingConfigurationArraySerializer(item["networkingConfigurations"]),
  };
}

export function pipelineGroupPropertiesDeserializer(item: any): PipelineGroupProperties {
  return {
    replicas: item["replicas"],
    ...
    networkingConfigurations: !item["networkingConfigurations"]
      ? item["networkingConfigurations"]
      : networkingConfigurationArrayDeserializer(item["networkingConfigurations"]),
    provisioningState: item["provisioningState"],
  };
}
...
export function receiverDeserializer(item: any): Receiver {
  return {
    type: item["type"],
    name: item["name"],
    syslog: !item["syslog"] ? item["syslog"] : syslogReceiverDeserializer(item["syslog"]),
...
export function processorDeserializer(item: any): Processor {
  return {
    type: item["type"],
    name: item["name"],
    batch: !item["batch"] ? item["batch"] : batchProcessorDeserializer(item["batch"]),
  };
}
...
export function exporterSerializer(item: Exporter): any {
  return {
    ...
    azureMonitorWorkspaceLogs: !item["azureMonitorWorkspaceLogs"]
      ...
      : azureMonitorWorkspaceLogsExporterSerializer(item["azureMonitorWorkspaceLogs"]),
...
export function exporterDeserializer(item: any): Exporter {
  return {
    ...
    azureMonitorWorkspaceLogs: !item["azureMonitorWorkspaceLogs"]
      ? item["azureMonitorWorkspaceLogs"]
      : azureMonitorWorkspaceLogsExporterDeserializer(item["azureMonitorWorkspaceLogs"]),
...
export function azureMonitorWorkspaceLogsExporterDeserializer(
  ...
  return {
    ...
    cache: !item["cache"] ? item["cache"] : cacheConfigurationDeserializer(item["cache"]),
  };
}
...
export function schemaMapSerializer(item: SchemaMap): any {
  return {
    ...
    scopeMap: !item["scopeMap"] ? item["scopeMap"] : scopeMapArraySerializer(item["scopeMap"]),
  };
}
...
export function schemaMapDeserializer(item: any): SchemaMap {
  return {
    ...
    scopeMap: !item["scopeMap"] ? item["scopeMap"] : scopeMapArrayDeserializer(item["scopeMap"]),
  };
}
...
export function resourceMapArrayDeserializer(result: Array<ResourceMap>): any[] {
  return result.map((item) => {
...
export function concurrencyConfigurationSerializer(item: ConcurrencyConfiguration): any {
  return {
...
export function concurrencyConfigurationDeserializer(item: any): ConcurrencyConfiguration {
  return {
    workerCount: item["workerCount"],
    batchQueueSize: item["batchQueueSize"],
  };
...
export function persistenceConfigurationsSerializer(item: PersistenceConfigurations): any {
  return { persistentVolumeName: item["persistentVolumeName"] };
}

export function persistenceConfigurationsDeserializer(item: any): PersistenceConfigurations {
  return {
...
export function networkingConfigurationSerializer(item: NetworkingConfiguration): any {
  return {
...
export function networkingConfigurationDeserializer(item: any): NetworkingConfiguration {
  return {
    externalNetworkingMode: item["externalNetworkingMode"],
    host: item["host"],
...
export function networkingRouteArraySerializer(result: Array<NetworkingRoute>): any[] {
  return result.map((item) => {
    return networkingRouteSerializer(item);
  });
}

export function networkingRouteArrayDeserializer(result: Array<NetworkingRoute>): any[] {
  return result.map((item) => {
...
export function pipelineGroupUpdatePropertiesSerializer(item: PipelineGroupUpdateProperties): any {
  return {
    replicas: item["replicas"],
    receivers: !item["receivers"] ? item["receivers"] : receiverArraySerializer(item["receivers"]),
    processors: !item["processors"]
      ? item["processors"]
      : processorArraySerializer(item["processors"]),
    exporters: !item["exporters"] ? item["exporters"] : exporterArraySerializer(item["exporters"]),
...
export function _pipelineGroupListResultDeserializer(item: any): _PipelineGroupListResult {
  return {
...
export function pipelineGroupArraySerializer(result: Array<PipelineGroup>): any[] {
  return result.map((item) => {
    return pipelineGroupSerializer(item);
  });
}

export function pipelineGroupArrayDeserializer(result: Array<PipelineGroup>): any[] {
  return result.map((item) => {
