...
import { ActionGroupsImpl, ScheduledQueryRulesImpl } from "./operations";
import { ActionGroups, ScheduledQueryRules } from "./operationsInterfaces";
...
export class MonitorClient extends coreClient.ServiceClient {
  ...
  constructor(
    ...
    const packageDetails = `azsdk-js-arm-monitor/1.0.0-beta.1`;
