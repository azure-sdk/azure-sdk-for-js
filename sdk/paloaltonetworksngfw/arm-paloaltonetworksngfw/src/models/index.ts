...
export interface CloudManagerTenant {
...
/** Optional parameters. */
export interface CreateProductSerialNumberOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the createProductSerialNumber operation. */
export type CreateProductSerialNumberResponse =
  ProductSerialNumberRequestStatus;

/** Optional parameters. */
export interface ListCloudManagerTenantsOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the listCloudManagerTenants operation. */
export type ListCloudManagerTenantsResponse = CloudManagerTenant[];

/** Optional parameters. */
export interface ListProductSerialNumberStatusOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the listProductSerialNumberStatus operation. */
export type ListProductSerialNumberStatusResponse = ProductSerialNumberStatus;

/** Optional parameters. */
export interface ListSupportInfoOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the listSupportInfo operation. */
export type ListSupportInfoResponse = SupportInfoModel;
