...
export class PaloAltoNetworksCloudngfw extends coreClient.ServiceClient {
  ...
  constructor(
    ...
    this.apiVersion = options.apiVersion || "2025-02-06-preview";
    ...
    this.paloAltoNetworksCloudngfw = new PaloAltoNetworksCloudngfwImpl(this);
  ...
  paloAltoNetworksCloudngfw: PaloAltoNetworksCloudngfw;
  firewalls: Firewalls;
